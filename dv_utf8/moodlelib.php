...
/// (because it's impossible to specify UTF-8 to fetch locale info in Win32)
   ...
   if (current_language()=='di_utf8'){
		$datestring= str_replace('January','ޖެނުއަރީ',$datestring);
		$datestring= str_replace('February','ފެބްރުއަރީ',$datestring);
		$datestring= str_replace('March','މާޗް',$datestring);
		$datestring= str_replace('April','އޭޕްރީލް',$datestring);
		$datestring= str_replace('May','މެއި',$datestring);
		$datestring= str_replace('June','ޖޫން',$datestring);
		$datestring= str_replace('July','ޖުލައި',$datestring);
		$datestring= str_replace('August','އޯގަސްޓް',$datestring);
		$datestring= str_replace('September','ސެޕްޓެމްބަރ',$datestring);
		$datestring= str_replace('October','އޮކްޓޯބަރ',$datestring);
		$datestring= str_replace('November','ނޮވެމްބަރ',$datestring);
		$datestring= str_replace('December','ޑިސެމްބަރ',$datestring);

		$datestring= str_replace('Sunday','އާދީއްތަ',$datestring);
		$datestring= str_replace('Monday','ހޯމަ',$datestring);
		$datestring= str_replace('Tuesday','އަންގާރަ',$datestring);
		$datestring= str_replace('Wednesday','ބުދަ',$datestring);
		$datestring= str_replace('Thursday','ބުރާސްފަރި',$datestring);
		$datestring= str_replace('Friday','ހުކުރު',$datestring);
		$datestring= str_replace('Saturday','ހޮނިހިރު',$datestring);
   }
