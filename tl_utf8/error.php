...
$string['cannotdownloadzipfile'] = 'Hindi mailusong ang ZIP file.';
...
$string['downloadedfilecheckfailed'] = 'Bigo ang  pagsusuri  sa inilusong na file.';
...
$string['groupalready'] = 'Miyembro na ng pangkat $a ang tao';
...
$string['unknownuseraction'] = 'Paumanhin, nguni\'t hindi ko maintindihan ang aksiyong ito ng tao';
$string['usernotaddederror'] = 'Hindi idinagdag ang taong \"$a\" - dikilalang error';
$string['usernotaddedregistered'] = 'Hindi idinagdag ang taong \"$a\" - nakarehistro na ';
$string['usernotavailable'] = 'Hindi mo maaaring makita ang mga detalye hinggil sa tao na ito.';
$string['usernotrenamedexists'] = 'Hindi binago ang pangalan ng tao -- may gumagamit na ng bagong bansag.';
$string['usernotrenamedmissing'] = 'Hindi binago ang pangalan ng tao -- hindi makita ang lumang bansag.';
$string['wrongdestpath'] = 'Mali ang patutunguhang landas';
$string['wrongsourcebase'] = 'Mali ang URL base ng source.';
$string['wrongzipfilename'] = 'Mali ang ngalan ng file na ZIP';
