...
$string['err_maxlength'] = 'Kailangan mong magpasok ng hindi hihigit sa $a->format titik dito.';
$string['err_minlength'] = 'Kailangan mong magpasok ng hindi bababa sa $a->format titik dito.';
$string['err_nonzero'] = 'Kailangan mong magpasok ng bilang na hindi nagsisimula sa 0 dito.';
$string['err_nopunctuation'] = 'Hindi ka dapat magpasok ng bantas dito.';
$string['err_numeric'] = 'Kailangan mong magpasok ng bilang dito.';
$string['err_rangelength'] = 'Kailangan mong magpasok ng titik na nasa pagitan ng {$a->format[0]} at {$a->format[1]} dito.';
$string['err_required'] = 'Kailangan mong magbigay ng halaga dito.';
$string['general'] = 'Pangkalahatang Kaayusan';
$string['hideadvanced'] = 'Itago ang Abante';
$string['hour'] = 'Oras';
$string['minute'] = 'Minuto';
$string['miscellaneoussettings'] = 'Atbp. Kaayusan';
$string['modstandardels'] = 'Pinagsasaluhang Kaayusan ng mga Modyul';
$string['month'] = 'Buwan';
