...
$string['configmaxbytes'] = 'Umiiral na maksimum na laki ng takdang-aralin para sa lahat ng takdang-aralin na nasa site (alinsunod sa limitasyon sa kurso at iba pang lokal na kaayusan)';
...
$string['existingfiledeleted'] = 'Ang kasalukuyang sako ay binura na: $a';
$string['failedupdatefeedback'] = 'Nabigong baguhin ang puna sa ipinasa ng tagagamit na si $a';
...
$string['guestnosubmit'] = 'Paumanhin, nguni\'t ang mga bisita ay hindi pinapahintulutang magpasa ng takdang-aralin.  Kailangan mo munang lumagda/magrehistro bago mo maipasa ang sagot mo.';
$string['guestnoupload'] = 'Paumanhin nguni\'t hindi pinapahintulutang mag-ahon ang bisita.';
$string['helpoffline'] = '<p>Kapakipakinabang ito kapag ang takdang-aralin ay ginagawa sa labas ng Moodle.  Maaari itong isang bagay sa iba pang lugar sa web o harapan.</p><p>Maaaring makakita ng deskripsyon ng takdang-aralin ang mga mag-aaral, nguni hindi puwedeng mag-ahon ng sako o anupaman.  Gumagana ng normal ang pagmamarka, at tatanggap ng patalastas hinggil sa marka nila ang mga mag-aaral</p>';
$string['helponline'] = '<p>Ang uri ng takdang-aralin na ito ay humihiling sa mga tagagamit na mag-edit ng teksto, gamit ang mga normal na kasangkapan sa pag-eedit.  Maaari itong markahan ng mga guro nang online, at puwede ring magdagdag ng inline na puna o pagbabago.</p><p>(Kung pamilyar ka sa mga lumang bersiyon ng Moodle, pareho ang silbi ng uri ng Takdang-aralin na ito sa lumang diyornal na modyul.)</p>';
$string['helpuploadsingle'] = '<p>Ang uri ng takdang-aralin na ito ay pinapahintulutan ang bawat kalahok na mag-ahon ng isang sako, anuman ang uri.</p><p>Maaari itong maging Word processor na dokumento, o isang larawan, isang nakazip na web site, o anumang bagay na hilingin mong ipasa nila.</p>';
...
$string['overwritewarning'] = 'Babala: kung mag-aahon kang mulî, MAPAPALITAN nito ang kasalukuyan mong ipinasa';
...
$string['saveallfeedback'] = 'Isilid ang lahat ng aking puna';
$string['submission'] = 'Ipinasa';
$string['submissionfeedback'] = 'Puna sa ipinasa';
$string['submissions'] = 'Mga ipinasa';
$string['submissionsaved'] = 'Naisilid na ang mga pagbabago mo';
$string['submissionsnotgraded'] = '$a ipinasa ang hindi namamarkahan';
$string['submitassignment'] = 'Ipasa ang iyong takdang-aralin sa pamamagitan ng porma na ito';
$string['submitted'] = 'Naipasa na';
$string['typeoffline'] = 'Offline na aktibidad';
$string['typeonline'] = 'Online na teksto';
$string['typeuploadsingle'] = 'Mag-ahon ng isang sako lamang';
$string['uploadbadname'] = 'May mga kakaibang titik ang ngalan ng sako na ito at hindi puwedeng maiahon';
$string['uploadedfiles'] = 'mga naiahon nang sako';
$string['uploaderror'] = 'May error na naganap habang isinisilid ang sako sa server';
$string['uploadfailnoupdate'] = 'OK ang pagkakaahon ng sako pero hindi mabago ang ipinasa mo!';
$string['uploadfiletoobig'] = 'Paumanhin, pero masyadong malaki ang sako na iyan (ang limitasyon ay $a bytes)';
$string['uploadnofilefound'] = 'Wala pong makitang sako - sigurado ba kayong may pinili kayong sako para iahon?';
$string['uploadnotregistered'] = 'OK ang pagkakaahon ng \'$a\' pero hindi rumehistro ang ipinasa!';
$string['uploadsuccess'] = 'Matagumpay na naiahon ang \'$a\' ';
