...
$string['failedupdatefeedback'] = 'Nabigong baguhin ang puna sa ipinasa ng taong si $a';
...
$string['typeuploadsingle'] = 'Mag-ahon ng isang file lamang';
$string['uploadbadname'] = 'May mga kakaibang titik ang filename na ito at hindi puwedeng maiahon';
$string['uploadedfiles'] = 'mga naiahon nang file';
$string['uploaderror'] = 'May error na naganap habang isinisave ang file sa server';
$string['uploadfailnoupdate'] = 'OK ang pagkakaahon ng file pero hindi mabago ang ipinasa mo!';
$string['uploadfiletoobig'] = 'Paumanhin, pero masyadong malaki ang file na iyan (ang limitasyon ay $a bytes)';
$string['uploadnofilefound'] = 'Wala pong makitang file - sigurado ba kayong may pinili kayong file para iahon?';
