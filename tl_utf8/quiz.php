...
$string['answerswithacceptederrormarginmustbenumeric'] = 'Dapat ay numero ang mga sagot na may pinalagpas na malî';
$string['answertoolong'] = 'Labis ang haba ng sagot pagkatapos ng ika- $a na linya (255 titik maks)';
$string['aon'] = 'Anyong AON';
...
$string['attemptselection'] = 'Piliin kung aling mga pagkuha ang susuriin sa bawat tagagamit:';
$string['attemptsexist'] = 'Hindi ka na maaaring magdagdag o magtanggal ng mga tanong.';
...
$string['backtoquestionlist'] = 'Bumalik sa Listahan ng Tanong';
...
$string['cannotcreatepath'] = 'Hindi malikha ang landas ($a)';
$string['cannotinsert'] = 'Hindi maisingit ang tanong';
$string['cannotopen'] = 'Hindi mabuksan ang sako na panluwas ($a)';
$string['cannotread'] = 'Hindi mabasa ang sako na pang-angkat (o walang laman ang sako)';
$string['cannotwrite'] = 'Hindi masulatan ang sako na panluwas ($a)';
...
$string['categorymove'] = 'Ang kategoriyang \'$a->name\' ay naglalaman ng $a->count tanong (marahil ang ilan dito ay luma na, nakatago, o tanong na ginagamit pa rin sa isang pagsusulit).  <br />Mamilì po ng iba pang kategoriya na paglilipatan ng mga iyon.';
$string['categorymoveto'] = 'Ilipat ang mga iyon sa kategoriyang ito';
$string['categorynamecantbeblank'] = 'Hindi puwedeng blangko ang pangalan ng kategoriya';
...
$string['changessaved'] = 'Naisilid na ang mga Pagbabago sa Marka';
$string['checkanswer'] = 'Tsekan';
$string['choice'] = 'Pagpipilian';
$string['choices'] = 'Magagamit na mga pagpipilian';
$string['choosedatasetproperties'] = 'Pumili ng mga katangian ng datosset';
$string['choosefile'] = 'Pumili ng isang sako';
$string['close'] = 'Isara ang bintana';
$string['closebeforeopen'] = 'Hindi magawang bago ang pagsusulit.  Itinakda mo ang petsa ng pagsasara na una sa petsa ng pagbubukas.';
$string['closepreview'] = 'Isara ang pansilip';
$string['closereview'] = 'Isara ang rebyu';
$string['comment'] = 'Opinyon';
$string['commentorgrade'] = 'Gumawa ng opinyon o panaigan ang marka';
...
$string['confirmserverdelete'] = 'Talaga bang nais mong alisin ang server na <b>$a</b> sa listahan?';
$string['confirmstartattemptlimit'] = 'Ang pagsusulit na ito ay nilimitahan sa $a na pagkuha.  Ang pagpasok sa pagsusulit ay ituturing na isang pagkuha.  Nais mo bang magpatuloy?';
$string['confirmstartattempttimelimit'] = 'Ang pagsusulit na ito ay may taning na oras at limitado sa $a na pagkuha.  Ang pagpasok sa pagsusulit ay ituturing na isang pagkuha.  Nais mo bang magpatuloy?';
$string['confirmstarttimelimit'] = 'Ang Pagsusulit ay may taning na oras.  Talaga bang nais mong mag-umpisa?';
$string['containercategorycreated'] = 'Nilikha ang kategoriyang ito upang maimbak ang lahat ng orihinal na kategoriyang inilipat sa antas site bunga ng mga dahilang babangitin sa ibaba.';
...
$string['correctansweris'] = 'Wastong sagot: $a';
...
$string['coursetestmanager'] = 'Anyong Course Test Manager';
...
$string['decimaldigits'] = 'Desimal na numero sa marka';
$string['decimalformat'] = 'mga desimal';
$string['decimalpoints'] = 'Mga desimal na puntos';
$string['decimals'] = 'may $a';
$string['default'] = 'Umiiral';
$string['defaultgrade'] = 'Umiiral na marka ng tanong';
$string['defaultinfo'] = 'Ang umiiral na kategoriya ng mga tanong.';
$string['delay1'] = 'Palugit na oras sa una at ikalawang pagkuha';
$string['delay2'] = 'Palugit na oras sa mga susunod na pagkuha';
...
$string['download'] = 'Iklik upang mailusong ang mga iniluwas na sako ng kategoriya';
$string['downloadextra'] = '(ang sako ay nakaimbak din sa mga sako ng kurso sa /backupdata/quiz na bugsok)';
...
$string['editqcats'] = 'Iedit ang mga kategoriya ng mga tanong';
$string['editquestions'] = 'Iedit ang mga tanong';
$string['editquiz'] = 'Iedit ang Pagsusulit';
$string['editquizquestions'] = 'Iedit ang mga Tanong sa Pagsusulit';
$string['errorinquestion'] = 'May error sa tanong';
...
$string['errorsdetected'] = 'nakita ang $a error';
$string['essay'] = 'Sanaysay';
$string['essayquestions'] = 'Mga tanong';
$string['event1'] = 'Kusang-isilid';
$string['event2'] = 'Isilid';
$string['event3'] = 'Markahan';
$string['event5'] = 'Tingnan kung Tanggap';
$string['event6'] = 'Isara&Markahan';
$string['event7'] = 'Ipása';
$string['event8'] = 'Isara';
$string['event9'] = 'Mano-manong marka';
$string['examview'] = 'Anyong Examview';
$string['export'] = 'Iluwas';
$string['exporterror'] = 'May naganap na error habang ipinoproseso ang pagluluwas';
$string['exportingquestions'] = 'Iniluluwas ang mga tanong sa sako';
$string['exportname'] = 'Pangalan ng sako';
$string['exportquestions'] = 'Iluwas ang mga tanong sa isang sako';
$string['false'] = 'Mali';
$string['feedback'] = 'Puna';
$string['feedbackerrorboundaryformat'] = 'Ang mga hangganan ng mga marka para sa puna ay kailangang porsiyento o bilang.  Ang halagang ipinasok mo sa hangganang $a ay dikilalala.';
$string['feedbackerrorboundaryoutofrange'] = 'Ang mga hangganan ng mga marka para sa puna ay dapat nasa pagitan ng 0%% at 100%%.  Ang halagang ipinasok mo sa hangganang $a ay lagpas na dito.';
$string['feedbackerrorjunkinboundary'] = 'Kailangan mong punan ang mga kahon ng hangganan ng marka para sa puna, at hindi ka dapat mag-iwan ng puwang.';
$string['feedbackerrorjunkinfeedback'] = 'Kailangan mong punan ang mga kahon ng puna nang hindi nag-iiwan ng anumang puwang.';
$string['feedbackerrororder'] = 'Ang mga hangganan ng marka ng puna ay dapat dapat pinakamataas muna pababa.  Ang halagang ipinasok mo sa hangganang $a ay wala sa wastong pagkakasunod-sunod.';
$string['file'] = 'Sako';
$string['fileformat'] = 'Anyo ng sako';
$string['fillcorrect'] = 'Punan ng wasto';
$string['filloutnumericalanswer'] = 'Dapat ay magbigay ka ng hindi bababa sa isang posibleng sagot at tolerans.  Ang unang tutugmang sagot ay gagamitin sa pagbibigay ng iskor at puna.  Kapag nagbigay ka ng puna na walang sagot sa dulo, ito ay ipapakita sa mga mag-aaral na ang itinugon ay hindi tumutugma sa alinman sa iba pang sagot.';
$string['filloutoneanswer'] = 'Dapat mong lagyan ng kahit isang posibleng sagot.  Ang mga puwang na iniwang blangko ay hindi gagamitin.  Ang \'*\' ay magagamit bilang wildcard upang tumugma sa anumang titik.  Ang unang tutugmang sagot ang gagamitin sa pagbigay ng iskor at puna.';
$string['filloutthreequestions'] = 'Dapat mong lagyan ng hindi bababa sa tatlong tanong na may katugmang sagot. Maaari kang magbigay ng dagdag na maling sagot sa pamamagitan ng pagbibigay ng sagot na may blangkong tanong.  Ang mga talâ na ang tanong at sagot ay blangko ay hindi gagamitin.';
...
$string['finishattempt'] = 'Ipása lahat at magtapos';
$string['finishreview'] = 'Tapusin ang pagbabalik-aral';
$string['forceregeneration'] = 'ipilit ang muling pagbuo';
$string['formatnotfound'] = 'Hindi natagpuan ang anyong $a na pag-aangkat/pagluluwas';
$string['formatnotimplemented'] = 'Hindi wasto ang implementasyon ng anyong ito, magpaskil po ng ulat ng bug';
...
$string['generalfeedback'] = 'Pangkalahatang puna';
$string['generatevalue'] = 'Bumuo ng isang bagong halaga sa pagitan ng';
$string['geometric'] = 'Heyometriko';
$string['gift'] = 'Anyong GIFT';
$string['giftleftbraceerror'] = 'Hindi makita ang {';
$string['giftmatchingformat'] = 'Hindi wasto ang anyo ng mga sagot sa tugmaang tanong.';
$string['giftnonumericalanswers'] = 'Walang natagpuang sagot para sa denumerong tanong';
$string['giftnovalidquestion'] = 'Walang natagpuang tanggap na tanong';
$string['giftqtypenotset'] = 'Hindi itinakda ang uri ng tanong';
$string['giftrightbraceerror'] = 'Hindi makita ang }';
$string['grade'] = 'Marka';
$string['gradeall'] = 'Markahan Lahat';
$string['gradeaverage'] = 'Katamtamang marka';
$string['gradeboundary'] = 'Hangganan ng marka';
$string['gradeessays'] = 'Markahan ang mga Sanaysay';
...
$string['gradingdetailspenalty'] = 'Ang pagpapása na ito ay nagkaroon ng parusa na $a.';
$string['gradingdetailszeropenalty'] = 'Hindi ka pinarusahan sa pagpapása na ito.';
$string['guestsno'] = 'Paumanhin, ang mga bisita ay hindi maaring makita o makuha ang pagsusulit';
$string['history'] = 'Kasaysayan ng mga Tugon:';
$string['hotpot'] = 'Anyong Hot Potatoes';
$string['illegalformulasyntax'] = 'Ditanggap na sintaks ng pormula na nagsisimula sa \'$a\'';
$string['imagedisplay'] = 'Larawang ipapakita';
$string['imagemissing'] = 'Wala ang larawan sa linyang $a.  Hindi gagamitn ang ngalan ng sako';
$string['import'] = 'Angkatin';
$string['importcategory'] = 'angkatin ang kategoriya';
$string['importerror'] = 'May naganap na error habang ipinoproseso ang pag-aangkat';
$string['importerrorquestion'] = 'Nagka-error sa pag-angkat ng tanong';
$string['importfilearea'] = 'Angkatin mula sa sako na nasa lagayan ng mga sako  ng kurso...';
$string['importfileupload'] = 'Angkatin mula sa iaahon na sako...';
$string['importfromthisfile'] = 'Angkatin mula sa sako na ito';
$string['importingquestions'] = 'Inaangkat ang $a tanong mula sa sako';
$string['importmax10error'] = 'May error sa tanong.  Hindi ka maaaring magkaroon ng mahigit sa sampung sagot';
$string['importmaxerror'] = 'May error sa tanong. Masyadong maraming sagot.';
$string['importminerror'] = 'May error sa tanong.  Hindi sapat ang dami ng sagot para sa uri ng tanong na ito';
$string['importquestions'] = 'Angkatin ang mga tanong mula sa sako';
$string['incorrect'] = 'Malî';
$string['indivresp'] = 'Mga Tugon ng mga Indibidwal sa Bawat Aytem';
$string['info'] = 'Impo';
$string['introduction'] = 'Panimula';
$string['invalidcategory'] = 'Di tanggap ang ID ng kategoriya';
$string['invalidnumericanswer'] = 'Ang isa sa mga sagot na ipinasok mo ay di tanggap na bilang.';
$string['invalidnumerictolerance'] = 'Ang isa sa mga tolerans na ipinasok mo ay di tanggap na bilang';
$string['invalidsource'] = 'Hindi tanggap ang pinagmulan';
$string['invalidsourcetype'] = 'Di tanggap na uri ng pinagmulan';
$string['itemanal'] = 'Pagsusuri ng Tugon sa Aytem';
$string['itemdefinition'] = 'Depinisyon';
$string['itemsource'] = 'Pinagmulan ng Aytem';
$string['itemsourceformat'] = 'Anyo ng Pinagmulan ng Aytem';
$string['itemtypes'] = 'Mga Uri ng Tanong mula sa Malayo';
$string['lastanswer'] = 'Ang huli mong sagot ay';
$string['learnwise'] = 'Anyong Learnwise';
...
$string['makecopy'] = 'Isilid bilang bagong tanong';
$string['managetypes'] = 'Pamahalaan ang mga uri ng tanong at server';
$string['manualgrading'] = 'Pagmamarka';
$string['mark'] = 'Ipasa';
$string['markall'] = 'Pahina para sa pagpapasa';
$string['marks'] = 'Marka';
$string['match'] = 'Tugmaan';
$string['matchanswer'] = 'Katugmâ na sagot';
$string['matchanswerno'] = 'Katugmâ na sagot $a';
$string['matcherror'] = 'Hindi tumutugma ang mga marka sa opsiyon ng marka--nilaktawan ang tanong';
$string['matchgrades'] = 'Pagtugmain ang mga marka';
$string['matchgradeserror'] = 'Error kung hindi nakalista ang marka';
$string['matchgradesnearest'] = 'Pinakamalapit na marka kung hindi nakalista';
$string['max'] = 'Maks';
...
$string['missingword'] = 'Nawawala ang anyo ng salita';
...
$string['multipleanswers'] = 'Pumili ng isa man lamang na sagot.';
...
$string['nocategory'] = 'Mali ang o walang kategoriyang itinakda';
$string['nocommentsyet'] = 'Wala pang opinyon.';
$string['noconnection'] = 'Walang koneksiyon sa isang web service sa kasalukuyan, na makapagpoproseso ng tanong na ito.  Pakikontak ang administrador mo';
$string['nodataset'] = 'wala - hindi ito wild card';
$string['noessayquestionsfound'] = 'Walang natagpuang tanong na mano-manong minarkahan';
$string['nomatchinganswer'] = 'Kailangan mong magtakda ng sagot na katugma ng tanong na \'$a\'.';
$string['nomoreattempts'] = 'Hindi na pinapahintulutan ang pagkuha';
$string['none'] = 'Wala';
$string['nopossibledatasets'] = 'Walang posibleng datosset';
...
$string['noquestionsinfile'] = 'Walang tanong sa aangkating sako';
$string['noresponse'] = 'Walang Tugon';
$string['noreview'] = 'Hindi ka pinapahintulutang magbalik-aral sa pagsusulit na ito';
$string['noreviewuntil'] = 'Hindi ka pinapahintulutang magbalik-aral sa pagsusulit na ito hanggang $a';
...
$string['numattempts'] = '$a->studentnum $a->studentstring ay gumawa ng $a->attemptnum pagkuha';
$string['numerical'] = 'Denumero';
$string['onlyteachersexport'] = 'Tanging guro ang makapagluluwas ng tanong';
$string['onlyteachersimport'] = 'Tanging guro na may karapatang mag-edit ang makapag-aangkat ng mga tanong';
$string['optional'] = 'opsiyonal';
$string['outof'] = '$a->grade mula sa isang maksimum na $a->maxgrade';
$string['overallfeedback'] = 'Pangkabuuang Puna';
...
$string['parsingquestions'] = 'Pina-parse ang mga tanong mula sa sakong pang-angkat.';
$string['partiallycorrect'] = 'Medyo wasto';
$string['passworderror'] = 'Hindi tamà ang kontrasenyas na ipinasok';
...
$string['popupblockerwarning'] = 'Ang seksiyon ng pagsusulit na ito ay nasa modong ligtas, ibig sabihin ay kailangan mong kunin ang pagsusulit sa isang ligtas na bintana.  Pakipatay po ang popup blocker ninyo.  Salamat po.';
...
$string['qti'] = 'Anyong IMS QTI';
$string['qti2'] = 'Anyong IMS QTI 2.0';
$string['question'] = 'Tanong';
$string['questioncats'] = 'Mga Kategoriya ng Tanong';
$string['questiondeleted'] = 'Nabura na ang tanong na ito. Pakikontak ang guro mo.';
...
$string['questionno'] = 'Tanong $a';
$string['questions'] = 'Mga Tanong';
$string['questionsinclhidden'] = 'Mga Tanong (kasama ang nakatago)';
$string['questionsinthisquiz'] = 'Mga tanong sa pagsusulit na ito';
$string['questionsinuse'] = '(* Ang mga Tanong na may tanda na asterisk ay ginagamit na sa ilang pagsusulit.  Ang mga tanong na ito ay hindi buburahin sa mga pagsusulit na ito kundi sa listahan lamang ng kategoriya.)';
$string['questionsperpage'] = 'Tanong bawat pahina';
$string['questiontext'] = 'Teksto ng tanong';
$string['questiontype'] = 'Uri ng tanong na $a';
$string['questiontypesetupoptions'] = 'Mga opsiyon na kaayusan para sa mga uri ng tanong:';
$string['quiz:attempt'] = 'Kuhanin ang pagsusulit';
$string['quiz:deleteattempts'] = 'Burahin ang mga pagkuha ng tanong';
$string['quiz:grade'] = 'Mano-manong markahan ang mga tanong';
$string['quiz:ignoretimelimits'] = 'Balewalain ang taning na oras ng pagsusulit';
$string['quiz:manage'] = 'Pamahalaan ang mga pagsusulit';
$string['quiz:preview'] = 'Silipin ang mga pagsusulit';
$string['quiz:view'] = 'Tingnan ang impormasyon hinggil sa pagsusulit';
$string['quiz:viewreports'] = 'Tingnan ang mga ulat sa pagsusulit';
...
$string['quizcloses'] = 'Pagsasara ng Pagsusulit';
$string['quiznotavailable'] = 'Hindi maaaring kunin ang pagsusulit hanggang: $a';
$string['quizopen'] = 'Buksan ang pagsusulit';
$string['quizopens'] = 'Pagbubukás ng Pagsusulit';
$string['quizsettings'] = 'Kaayusan ng pagsusulit';
...
$string['reordertool'] = 'Ipakita ang gámit sa pagbabago ng pagkakasunod-sunod';
...
$string['requirepassword'] = 'Kailangan ng kontrasenyas';
$string['requirepasswordmessage'] = 'Upang makuha ang pagsusulit na ito kailangan ay alam mo ang kontrasenyas ng pagsusulit';
$string['requiresubnet'] = 'Kailangan ng network address';
$string['response'] = 'Tugon';
$string['responses'] = 'Mga tugon';
$string['results'] = 'Mga resulta';
...
$string['save'] = 'Isilid';
$string['saveandedit'] = 'Isilid ang mga pagbabago at iedit ang mga tanong';
$string['savedfromdeletedcourse'] = 'Isinilid mula sa binurang kurso na \"$a\"';
$string['savegrades'] = 'Isilid ang mga marka';
$string['savemyanswers'] = 'Isilid ang aking mga sagot';
$string['savenosubmit'] = 'Isilid nang hindi ipinapasa';
$string['savequiz'] = 'Isilid ang buong pagsusulit na ito';
...
$string['shownoattemptsonly'] = 'Tanging ang mga mag-aaral na walang kinuha ang ipakita';
$string['showquestiontext'] = 'Ipakita ang teksto ng tanong sa listahan ng tanong';
$string['showteacherattempts'] = 'Ipakita ang mga pagkuha ng guro';
$string['shuffle'] = 'Balasahin';
$string['shuffleanswers'] = 'Balasahin ang mga sagot';
$string['shufflequestions'] = 'Balasahin ang mga tanong';
$string['shufflewithin'] = 'Balasahin sa loob ng mga tanong';
$string['significantfigures'] = 'may $a';
$string['significantfiguresformat'] = 'mga makabuluhang numero';
$string['singleanswer'] = 'Pumili ng isang sagot.';
...
$string['sorttypealpha'] = 'Pagsunudsunurin alinsunod sa uri, pangalan';
$string['startagain'] = 'Magsimula mulî';
$string['startedon'] = 'Sinimulan noong';
$string['stoponerror'] = 'Huminto kapag nagka-error';
...
$string['temporaryblocked'] = 'Pansamantala kang hindi pinapahintulutang muling kuhanin ang pagsusulit. <br />  Maari kang kumuha muli sa:';
$string['time'] = 'Oras';
$string['timecompleted'] = 'Nakumpleto';
$string['timedelay'] = 'Hindi ka pinapahintulutan na kunin ang pagsusulit dahil hindi pa nauubos ang palugit na oras bago ka pahintulutang makakuha muli';
...
$string['tofile'] = 'sa sako na';
$string['tolerance'] = 'Tolerans';
$string['tolerancetype'] = 'Uri ng Tolerans';
...
$string['uniform'] = 'mga desimal, mula sa isang uniform distribution';
$string['unit'] = 'Yunit';
...
$string['unusedcategorydeleted'] = 'Binura ang kategoriyang ito, dahil pagkatapos mabura ang kurso ay hindi na ginagamit ang mga tanong nito.';
$string['updatesettings'] = 'Gawing bago ang mga kaayusan ng pagsusulit';
$string['upgradesure'] = '<div style=\"color: red;\">Sa partikular, ang modyul na pagsusulit ay gagawa ng malawakang pagbabago ng mga teybol ng pagsusulit at ang upgrade na ito ay hindi pa lubusang nasusubok.  Mahigpit ka naming pinapayuhan na ibak-ap ang mga teybol ng datosan mo bago ka magpatuloy.</div>';
...
$string['warningmissingtype'] = '<p><b>Ang tanong na ito ay may uri na hindi pa iniluluklok sa Moodle.<br />Pakiabisuhan ang administrador ninyo ng Moodle.</b></p>';
$string['warningsdetected'] = '$a babala ang nakita';
$string['webct'] = 'Anyong WebCT';
$string['wheregrade'] = 'Nasan ang marka ko?';
$string['wildcard'] = 'Wild card (kuwan)';
...
$string['xhtml'] = 'Anyong XHTML';
$string['xml'] = 'Anyong Moodle XML';
$string['xmlimportnoname'] = 'Nawawala ang pangalan ng tanong sa sakong xml';
$string['xmlimportnoquestion'] = 'Nawawala ang teksto ng tanong sa sakong xml';
...
$string['existingcategory1'] = 'isang salita mula sa isang kasalukuyang set ng mga salita na ginagamit din ng iba pang tanong sa kategoriyang ito'; // ORPHANED
$string['existingcategory2'] = 'isang sako mula sa isang kasalukuyang set ng mga sako na ginagamit din ng iba pang tanong sa kategoriyang ito'; // ORPHANED
$string['existingcategory3'] = 'isang link mula sa isang kasalukuyang set ng mga link na ginagamit din ng ibang tanong sa kategoriyang ito'; // ORPHANED
$string['keptcategory1'] = 'isang salita mula sa parehong magagamit mulî na set ng mga salita ng kategoriya tulad ng nauna'; // ORPHANED
$string['keptcategory2'] = 'isang sako mula sa parehong magagamit mulî na set ng mga sako ng kategoriya tulad ng nauna'; // ORPHANED
$string['keptcategory3'] = 'isang link mula sa parehong magagamit muli na set ng mga link na kategoriya tulad ng nauna'; // ORPHANED
$string['keptlocal1'] = 'isang salita mula sa parehong pribadong set ng mga salita ng tanong tulad ng nauna'; // ORPHANED
$string['keptlocal2'] = 'isang sako mula sa parehong pribadong set ng mga sako ng tanong tulad ng nauna'; // ORPHANED
$string['keptlocal3'] = 'isang link mula sa parehong pribadong set ng mga link ng tanong tulad ng nauna'; // ORPHANED
$string['newcategory1'] = 'isang salita mula sa isang bagong set ng mga salita na maaaring ginagamit din ng iba pang tanong sa kategoriyang ito'; // ORPHANED
$string['newcategory2'] = 'isang sako mula sa isang bagong set ng mga sako na maaaring ginagamit din ng iba pang tanong sa kategoriyang ito'; // ORPHANED
$string['newcategory3'] = 'isang link mula sa isang bagong set ng link na maaaring ginagamit din ng iba pang tanong sa kategoriyang ito'; // ORPHANED
$string['newlocal1'] = 'isang salita mula sa isang bagong set ng salita na tanging ang tanong na ito ang gagamit'; // ORPHANED
$string['newlocal2'] = 'isang sako mula sa isang bagong set ng sako na tanging ang tanong na ito ang gagamit'; // ORPHANED
$string['newlocal3'] = 'isang link mula sa isang bagong set ng link na tanging ang tanong na ito ang gagamit'; // ORPHANED
