<?PHP // $Id$ 
      // appointment.php - created with Moodle 1.7 dev (2006050500)
...
$string['failedupdatefeedback'] = 'Nabigô ang pagbabago sa puna sa ipinasa para sa taong si $a';
...
$string['uploadbadname'] = 'Naglalaman ang pangalan ng file na ito ng mga dikilalang titik at hindi ito maiahon';
$string['uploadedfiles'] = 'mga inahon na file';
$string['uploaderror'] = 'May error na naganap habang isinisave ang file sa server';
$string['uploadfailnoupdate'] = 'OK ang pagkaka-ahon ng file pero hindi mabago ang ipinasa!';
$string['uploadfiletoobig'] = 'Paumanhin, nguni\'t labis ang laki ng file na iyan (ang limitasyon ay $a byte)';
$string['uploadnofilefound'] = 'Walang natagpuang file - tiyak mo bang may pinilì ka para iahon?';
