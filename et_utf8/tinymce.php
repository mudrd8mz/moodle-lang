...
$string['main/common:edit_confirm'] = 'Kas soovite kasutada WYSIWYG režiimi sellel tekstialal?';
$string['main/common:apply'] = 'Rakenda';
$string['main/common:insert'] = 'Sisesta';
$string['main/common:update'] = 'Uuenda';
$string['main/common:cancel'] = 'Tühista';
$string['main/common:close'] = 'Sule';
$string['main/common:browse'] = 'Sirvi';
$string['main/common:class_name'] = 'Klass';
$string['main/common:not_set'] = '-- Seadmata --';
$string['main/common:clipboard_msg'] = 'Kopeeri/Lõika/Kleebi ei ole saadaval Mozillas ja Firefoxis.\nKas soovite rohkem infot selle probleemi kohta?';
$string['main/common:clipboard_no_support'] = 'Hetkel ei ole toetatud Teie lehitseja poolt, kasutage klaviatuuri otseteid selle asemel.';
$string['main/common:popup_blocked'] = 'Vabandust, aga Teie hüpikakna tõkestaja on blokeerinud akna, mis varustab rakenduse funktsionaalsust. Palun lubage hüpikaknad sellel kodulehel, et täielikult kasutada seda vahendit.';
$string['main/common:invalid_data'] = 'Viga: Kehtetud väärtused sisestatud, need on märgitud punasega.';
$string['main/common:more_colors'] = 'Rohkem värve';
$string['main/contextmenu:align'] = 'Joondus';
$string['main/contextmenu:left'] = 'Vasak';
$string['main/contextmenu:center'] = 'Kesk';
$string['main/contextmenu:right'] = 'Parem';
$string['main/contextmenu:full'] = 'Täis';
$string['main/insertdatetime:date_fmt'] = '%%A-%%k-%%p';
$string['main/insertdatetime:time_fmt'] = '%%T:%%M:%%S';
$string['main/insertdatetime:insertdate_desc'] = 'Sisesta kuupäev';
$string['main/insertdatetime:inserttime_desc'] = 'Sisesta aeg';
$string['main/insertdatetime:months_long'] = 'Jaanuar,Veebruar,Märts,Aprill,Mai,Juuni,Juuli,August,September,Oktoober,November,Detsember';
$string['main/insertdatetime:months_short'] = 'Jaan,Veeb,Märts,Apr,Mai,Juuni,Juuli,Aug,Sept,Okt,Nov,Dets';
$string['main/insertdatetime:day_long'] = 'Pühapäev,Esmaspäev,Teisipäev,Kolmapäev,Neljapäev,Reede,Laupäev,Pühapäev';
$string['main/insertdatetime:day_short'] = 'P,E,T,K,N,R,L,P';
$string['main/print:print_desc'] = 'Print';
$string['main/preview:preview_desc'] = 'Eelvaade';
$string['main/directionality:ltr_desc'] = 'Suund vasakult paremale';
$string['main/directionality:rtl_desc'] = 'Suund paremalt vasakule';
$string['main/layer:insertlayer_desc'] = 'Sisesta uus kiht';
$string['main/layer:forward_desc'] = 'Liiguta edasi';
$string['main/layer:backward_desc'] = 'Liiguta tagasi';
$string['main/layer:absolute_desc'] = 'Lülita ümber absoluutne positsioneerimine';
$string['main/layer:content'] = 'Uus kiht...';
$string['main/save:save_desc'] = 'Salvesta';
$string['main/save:cancel_desc'] = 'Tühista kõik muudatused';
$string['main/nonbreaking:nonbreaking_desc'] = 'Sisesta mittekatkestav tühik';
$string['main/iespell:iespell_desc'] = 'Õigekirja kontroll';
$string['main/iespell:download'] = 'ieÕigekiri tuvastamata. Kas soovite paigaldada nüüd?';
$string['main/advhr:advhr_desc'] = 'Horisontaalne joonlaud';
$string['main/emotions:emotions_desc'] = 'Emotsioonid';
$string['main/searchreplace:search_desc'] = 'Otsi';
$string['main/searchreplace:replace_desc'] = 'Otsi/Asenda';
$string['main/advimage:image_desc'] = 'Sisesta/redigeeri pilt';
$string['main/advlink:link_desc'] = 'Sisesta/redigeeri link';
...
$string['main/style:desc'] = 'Redigeeri CSS stiili';
$string['main/paste:paste_text_desc'] = 'Kleebi tavalise tekstina';
$string['main/paste:paste_word_desc'] = 'Kleebi Wordist';
$string['main/paste:selectall_desc'] = 'Vali kõik';
$string['main/paste_dlg:text_title'] = 'Vajuta CTRL+V oma klaviatuuril teksti aknasse kleepimiseks.';
$string['main/paste_dlg:text_linebreaks'] = 'Jäta reavahetused';
$string['main/paste_dlg:word_title'] = 'Vajuta CTRL+V oma klaviatuuril teksti aknasse kleepimiseks.';
$string['main/table:desc'] = 'Sisestab uue tabeli';
$string['main/table:row_before_desc'] = 'Sisesta rida ette';
$string['main/table:row_after_desc'] = 'Sisesta rida järgi';
$string['main/table:delete_row_desc'] = 'Kustuta rida';
$string['main/table:col_before_desc'] = 'Sisesta veerg ette';
$string['main/table:col_after_desc'] = 'Sisesta veerg järgi';
$string['main/table:delete_col_desc'] = 'Kustuta veerg';
$string['main/table:split_cells_desc'] = 'Eralda ühendatud tabeli lahtrid';
$string['main/table:merge_cells_desc'] = 'Ühenda tabeli lahtrid';
$string['main/table:row_desc'] = 'Tabeli rea omadused';
$string['main/table:cell_desc'] = 'Tabeli lahtri omadused';
$string['main/table:props_desc'] = 'Tabeli omadused';
$string['main/table:paste_row_before_desc'] = 'Kleebi tabeli rida ette';
$string['main/table:paste_row_after_desc'] = 'Kleebi tabeli rida järgi';
$string['main/table:cut_row_desc'] = 'Lõika tabeli rida';
$string['main/table:copy_row_desc'] = 'Kopeeri tabeli rida';
$string['main/table:del'] = 'Kustuta tabel';
$string['main/table:row'] = 'Rida';
$string['main/table:col'] = 'Veerg';
$string['main/table:cell'] = 'Lahter';
$string['main/autosave:unload_msg'] = 'Tehtud muudatused kaovad, kui lahkute siit lehelt.';
$string['main/fullscreen:desc'] = 'Lülita ümber täisekraani režiim';
$string['main/media:desc'] = 'Sisesta / redigeeri manustatud meedia';
$string['main/media:edit'] = 'Redigeeri manustatud meedia';
$string['main/fullpage:desc'] = 'Dokumendi omadused';
$string['main/template:desc'] = 'Sisesta eeldefineeritud šablooni sisu';
$string['main/visualchars:desc'] = 'Visuaalsed kontrolltähemärgid sisse/välja';
$string['main/spellchecker:desc'] = 'Lülita ümber õigekirja kontroll';
$string['main/spellchecker:menu'] = 'Õigekirja kontrolli seaded';
$string['main/spellchecker:ignore_word'] = 'Jäta sõna vahele';
$string['main/spellchecker:ignore_words'] = 'Jära kõik vahele';
$string['main/spellchecker:langs'] = 'Keeled';
$string['main/spellchecker:wait'] = 'Palun oota...';
$string['main/spellchecker:sug'] = 'Soovitused';
$string['main/spellchecker:no_sug'] = 'Soovitusi pole';
$string['main/spellchecker:no_mpell'] = 'Valesti kirjutamisi ei leitud.';
$string['main/pagebreak:desc'] = 'Sisesta lehevahetus.';
$string['plugins/advhr_dlg:width'] = 'Laius';
$string['plugins/advhr_dlg:size'] = 'Kõrgus';
$string['plugins/advhr_dlg:noshade'] = 'Ilma varjuta';
...
$string['plugins/emotions_dlg:title'] = 'Sisesta emotsioon';
$string['plugins/emotions_dlg:desc'] = 'Emotsioonid';
$string['plugins/emotions_dlg:cool'] = 'Lahe';
$string['plugins/emotions_dlg:cry'] = 'Nutt';
$string['plugins/emotions_dlg:embarassed'] = 'Häbitunne';
$string['plugins/emotions_dlg:foot_in_mouth'] = 'Jalg suus';
$string['plugins/emotions_dlg:frown'] = 'Kulmu kortsutamine';
$string['plugins/emotions_dlg:innocent'] = 'Süütu';
$string['plugins/emotions_dlg:kiss'] = 'Suudlus';
$string['plugins/emotions_dlg:laughing'] = 'Naermine';
$string['plugins/emotions_dlg:money_mouth'] = 'Rahasuu';
$string['plugins/emotions_dlg:sealed'] = 'Suletud';
$string['plugins/emotions_dlg:smile'] = 'Naeratus';
$string['plugins/emotions_dlg:surprised'] = 'Üllatunud';
$string['plugins/emotions_dlg:tongue_out'] = 'Keel väljas';
$string['plugins/emotions_dlg:undecided'] = 'Kõhklev';
$string['plugins/emotions_dlg:wink'] = 'Silmapilgutus';
$string['plugins/emotions_dlg:yell'] = 'Karje';
...
$string['plugins/paste_dlg:text_title'] = 'Vajuta CTRL+V oma klaviatuuril teksti aknasse kleepimiseks.';
$string['plugins/paste_dlg:text_linebreaks'] = 'Jäta reavahetused';
$string['plugins/paste_dlg:word_title'] = 'Vajuta CTRL+V oma klaviatuuril teksti aknasse kleepimiseks.';
$string['plugins/searchreplace_dlg:searchnext_desc'] = 'Otsi uuesti';
$string['plugins/searchreplace_dlg:notfound'] = 'Otsing on lõpetatud. Otsisõna ei leitud.';
$string['plugins/searchreplace_dlg:search_title'] = 'Otsi';
$string['plugins/searchreplace_dlg:replace_title'] = 'Otsi/Asenda';
$string['plugins/searchreplace_dlg:allreplaced'] = 'Kõik otsisõna ilmingud on asendatud.';
$string['plugins/searchreplace_dlg:findwhat'] = 'Otsi mida';
$string['plugins/searchreplace_dlg:replacewith'] = 'Asenda millega';
$string['plugins/searchreplace_dlg:direction'] = 'Suund';
$string['plugins/searchreplace_dlg:up'] = 'Üles';
$string['plugins/searchreplace_dlg:down'] = 'Alla';
$string['plugins/searchreplace_dlg:mcase'] = 'Vasta suurusele';
$string['plugins/searchreplace_dlg:findnext'] = 'Otsi järgmine';
$string['plugins/searchreplace_dlg:replace'] = 'Asenda';
$string['plugins/searchreplace_dlg:replaceall'] = 'Asenda kõik';
...
$string['plugins/template_dlg:title'] = 'Šabloonid';
$string['plugins/template_dlg:label'] = 'Šabloon';
$string['plugins/template_dlg:desc_label'] = 'Kirjeldus';
$string['plugins/template_dlg:desc'] = 'Sisesta eeldefineeritud šablooni sisu';
$string['plugins/template_dlg:select'] = 'Vali šabloon';
$string['plugins/template_dlg:preview'] = 'Eelvaade';
$string['plugins/template_dlg:warning'] = 'Hoiatus: Šablooni uuendamine teistsugusega võib kaasa tuua andmete kaotsiminemist.';
$string['plugins/template_dlg:mdate_format'] = '%%Y-%%m-%%d %%H:%%M:%%S';
$string['plugins/template_dlg:cdate_format'] = '%%Y-%%m-%%d %%H:%%M:%%S';
$string['plugins/template_dlg:months_long'] = 'Jaanuar,Veebruar,Märts,Aprill,Mai,Juuni,Juuli,August,September,Oktoober,November,Detsember';
$string['plugins/template_dlg:months_short'] = 'Jaan,Veeb,Märts,Apr,Mai,Juuni,Juuli,Aug,Sep,Okt,Nov,Dets';
$string['plugins/template_dlg:day_long'] = 'Pühapäev,Esmaspäev,Teisipäev,Kolmapäev,Neljapäev,reede,Laupäev,Pühapäev';
$string['plugins/template_dlg:day_short'] = 'P,E,T,K,N,R,L,P';
...
$string['themes/advanced:bold_desc'] = 'Rasvane (Ctrl+B)';
$string['themes/advanced:italic_desc'] = 'Kursiiv (Ctrl+I)';
$string['themes/advanced:underline_desc'] = 'Allajoonitud (Ctrl+U)';
$string['themes/advanced:striketrough_desc'] = 'Läbijoonitud';
$string['themes/advanced:justifyleft_desc'] = 'Vasak joondus';
$string['themes/advanced:justifycenter_desc'] = 'Keskjoondus';
$string['themes/advanced:justifyright_desc'] = 'Parem joondus';
$string['themes/advanced:justifyfull_desc'] = 'Täisjoondus';
$string['themes/advanced:bullist_desc'] = 'Ebakorrapärane loetelu';
$string['themes/advanced:numlist_desc'] = 'Korrapärane loetelu';
$string['themes/advanced:outdent_desc'] = 'Taanda välja';
$string['themes/advanced:indent_desc'] = 'Taanda sisse';
$string['themes/advanced:undo_desc'] = 'Võta tagasi (Ctrl+Z)';
$string['themes/advanced:redo_desc'] = 'Tee uuesti (Ctrl+Y)';
$string['themes/advanced:link_desc'] = 'Sisesta/redigeeri link';
$string['themes/advanced:unlink_desc'] = 'Eemalda link';
$string['themes/advanced:image_desc'] = 'Sisesta/redigeeri pilt';
$string['themes/advanced:cleanup_desc'] = 'Puhasta segane kood';
$string['themes/advanced:code_desc'] = 'Redigeeri HTML lähtekoodi';
$string['themes/advanced:sub_desc'] = 'Alaindeks';
$string['themes/advanced:sup_desc'] = 'Ülaindeks';
$string['themes/advanced:hr_desc'] = 'Sisesta horisontaalne joonlaud';
$string['themes/advanced:removeformat_desc'] = 'Eemalda vormindus';
$string['themes/advanced:custom1_desc'] = 'Teie kohandatud kirjeldus siia';
$string['themes/advanced:forecolor_desc'] = 'Vali teksti värv';
$string['themes/advanced:backcolor_desc'] = 'Vali tausta värv';
$string['themes/advanced:charmap_desc'] = 'Sisesta kohandatud kirjamärk';
$string['themes/advanced:visualaid_desc'] = 'Lülita ümber juhtjooned/nähtamatud elemendid';
$string['themes/advanced:anchor_desc'] = 'Sisesta/redigeeri ankur';
$string['themes/advanced:cut_desc'] = 'Lõika';
$string['themes/advanced:copy_desc'] = 'Kopeeri';
$string['themes/advanced:paste_desc'] = 'Kleebi';
$string['themes/advanced:image_props_desc'] = 'Pildi kirjeldus';
$string['themes/advanced:newdocument_desc'] = 'Uus dokument';
$string['themes/advanced:help_desc'] = 'Abi';
$string['themes/advanced:blockquote_desc'] = 'Plokkviide';
$string['themes/advanced:clipboard_msg'] = 'Kopeeri/Lõika/Kleebi ei ole Mozillas ja Firefoxis saadaval.\r\nKas soovid rohkem infot selle probleemi kohta?';
$string['themes/advanced:path'] = 'Tee';
$string['themes/advanced:newdocument'] = 'Oled sa kindel, et tahad kustutada kõik sisud?';
$string['themes/advanced:toolbar_focus'] = 'Hüppa tööriista nuppudele - Alt+Q, Hüppa redigeerijale - Alt-Z, Hüppa elemendi teele - Alt-X';
$string['themes/advanced:more_colors'] = 'Rohkem värve';
...
$string['themes/advanced_dlg:anchor_title'] = 'Sisesta/redigeeri ankur';
$string['themes/advanced_dlg:anchor_name'] = 'Ankru nimi';
$string['themes/advanced_dlg:code_title'] = 'HTML Source Editor';
$string['themes/advanced_dlg:code_wordwrap'] = 'Word wrap';
$string['themes/advanced_dlg:colorpicker_title'] = 'Vali värv';
$string['themes/advanced_dlg:colorpicker_picker_tab'] = 'Korjaja';
$string['themes/advanced_dlg:colorpicker_picker_title'] = 'Värvi korjaja';
$string['themes/advanced_dlg:colorpicker_palette_tab'] = 'Palett';
$string['themes/advanced_dlg:colorpicker_palette_title'] = 'Palett värvid';
$string['themes/advanced_dlg:colorpicker_named_tab'] = 'Nimetatud';
$string['themes/advanced_dlg:colorpicker_named_title'] = 'Nimetatud värvid';
$string['themes/advanced_dlg:colorpicker_color'] = 'Värv:';
$string['themes/advanced_dlg:colorpicker_name'] = 'Nimi:';
$string['themes/advanced_dlg:charmap_title'] = 'Vali kohandatud tähemärk';
$string['themes/advanced_dlg:image_title'] = 'Sisestal/redigeeri pilt';
$string['themes/advanced_dlg:image_src'] = 'Pildi URL';
$string['themes/advanced_dlg:image_alt'] = 'Pildi kirjeldus';
$string['themes/advanced_dlg:image_list'] = 'Pildi loend';
$string['themes/advanced_dlg:image_border'] = 'Raam';
$string['themes/advanced_dlg:image_dimensions'] = 'Dimensioonid';
$string['themes/advanced_dlg:image_vspace'] = 'Vertikaalne vahe';
$string['themes/advanced_dlg:image_hspace'] = 'Horisontaalne vahe';
$string['themes/advanced_dlg:image_align'] = 'Reastus';
$string['themes/advanced_dlg:image_align_baseline'] = 'Kirjajoondus';
$string['themes/advanced_dlg:image_align_top'] = 'Ülemine';
$string['themes/advanced_dlg:image_align_middle'] = 'Keskmine';
$string['themes/advanced_dlg:image_align_bottom'] = 'Alumine';
$string['themes/advanced_dlg:image_align_texttop'] = 'Teksti tipp';
$string['themes/advanced_dlg:image_align_textbottom'] = 'Teksti põhi';
$string['themes/advanced_dlg:image_align_left'] = 'Vasak';
$string['themes/advanced_dlg:image_align_right'] = 'Parem';
$string['themes/advanced_dlg:link_title'] = 'Sisesta/redigeeri link';
$string['themes/advanced_dlg:link_url'] = 'Link URL';
$string['themes/advanced_dlg:link_target'] = 'Sihtala';
$string['themes/advanced_dlg:link_target_same'] = 'Ava link samas aknas';
$string['themes/advanced_dlg:link_target_blank'] = 'Ava link uues aknas';
$string['themes/advanced_dlg:link_titlefield'] = 'Tiitel';
$string['themes/advanced_dlg:link_is_email'] = 'URL, mille te sisestasite, tundub olevat emaili aadress, kas soovite, et lisataks mailto: eesliite?';
$string['themes/advanced_dlg:link_is_external'] = 'URL, mille sisestasite, tundub olevat väline link, kas soovite, et lisataks http:// eesliite?';
$string['themes/advanced_dlg:link_list'] = 'Lingi loetelu';
$string['themes/simple:bold_desc'] = 'Rasvane (Ctrl+B)';
$string['themes/simple:italic_desc'] = 'Kursiiv (Ctrl+I)';
$string['themes/simple:underline_desc'] = 'Allajoonitud (Ctrl+U)';
$string['themes/simple:striketrough_desc'] = 'Läbijoonitud';
$string['themes/simple:bullist_desc'] = 'Ebakorrapärane loetelu';
$string['themes/simple:numlist_desc'] = 'Korrapärane loetelu';
$string['themes/simple:undo_desc'] = 'Võta tagasi (Ctrl+Z)';
$string['themes/simple:redo_desc'] = 'Tee uuesti (Ctrl+Y)';
$string['themes/simple:cleanup_desc'] = 'Puhasta segane kood';
