...
$string['addedrecips']='Lisatud $a uust vastuvõtjat';
...
$string['addnewcategory']='Lisa uus rubriik';
...
$string['adminbookmarks']='Administraatori järjehoidjad';
$string['adminhelpaddnewuser']='Loo käsitsi uus kasutajakonto';
...
$string['adminhelpassignteachers']='Vali kursus ja kasuta õpetajate määramiseks vastavat ikooni';
$string['adminhelpauthentication']='Sa saad kasutada süsteemisiseseid kasutajakontosid või väliseid andmebaase';
$string['adminhelpbackup']='Seadista automaatne varukoopia tegemineja ajasta see';
...
$string['adminhelpfailurelogs']='Otsi ebaõnnestunud sisenemisi';
$string['adminhelphealthcenter']='Õpikeskkonna probleemide automaatne tuvastamine';
$string['adminhelplanguage']='Keelefailide kontroll ja muutmine';
$string['adminhelplogs']='Sirvi logisid õpikeskkonna kõigist tegevustest';
...
$string['allow']='Luba';
$string['allowguests']='Sellele kursusele lubatakse külalisi';
...
$string['assignstudents']='Registreeri õppijad kursusele';
$string['assignstudentsnote']='Märkus: selle lehe kasutamine ei ole vajalik, kuna õppijad saavad ise kursusele registreeruda.';
$string['assignstudentspass']='Te peate õppijatele teada andma kursusele registreerumise võtme, mis on hetkel \'$a\'';
...
$string['backupdetails']='Varukoopia detailid';
...
$string['backupfinished']='Varukoopia edukalt tehtud';
$string['backupincludemoduleshelp']='Valige, kas soovite kursuse mooduleid (koos kasutajainfoga või ilma) lisada automaatsesse varukoopiasse';
$string['backupkeephelp']='Kui mitu viimatist varukoopiat iga kursuse kohta soovite talletada? (vanemad kustutatakse automaatselt)';
$string['backuplogdetailed']='Detailne täitmislogi';
$string['backuploglaststatus']='Viimane täitmislogi';
$string['backuplogshelp']='Kui lubatud, siis kursuse logid lisatakse automaatsele varukoopiale';
$string['backupmetacoursehelp']='Kui lubatud, siis metakursuse info lisatakse automaatsele varukoopiale';
$string['backupnameformat']='%%Y%%m%%d-%%H%%M';
$string['backupnoneusersinfo']='Märge: Olete valinud varukoopia tegemisel kasutajate arvuks \"mite ühtegi\", seega kõigi moodulite varundamine on lülitatud \"ilma kasutaja andmeteta\" režiimi. Palun pange tähele, et sellise varundamise tüübiga ei ole võimalik varundada harjutuse ja õpikoja mooduleid, seega need moodulid on varundamiselt täielikult välja jäetud.';
...
$string['backuptakealook']='Palun vaadake oma varunduse logisid $a seest';
$string['backupuserfileshelp']='Kas kasutajate failid (nt. kasutajate fotod) lisatakse automaatsele varukoopiale?';
$string['backupusershelp']='Kas soovite lisada kõiki kasutajaid serveris või ainult iga kursuse jaoks vajalikke kasutajaid?';
$string['backupversion']='Varukoopia versioon';
$string['block']='Blokk';
$string['blockconfiga']='Seadista blokki $a';
$string['blockconfigbad']='See blokk ei ole veel korralikult realiseeritud ja seetõttu pole veel kasutajaliidest seadistuste tegemiseks.';
$string['blockdeleteconfirm']='Olete kustutamas blokki $a\'. Seega kustutatakse andmebaasist kõik, mis selle blokiga seotud on. Kas olete  KINDEL, et soovite jätkata?';
$string['blockdeletefiles']='Kõik andmed, mis on seotud blokiga\'$a->block\'  on andmebaasist kustutatud. Kustutamise lõpetamiseks peaksite  kustutama serverist kataloogi $a->directory';
$string['blocks']='Blokid';
$string['blocksaddedit']='Lisa/muuda blokke';
$string['blockseditoff']='Blokkide muutmine keelatud';
$string['blocksediton']='Blokkide muutmine lubatud';
$string['blocksetup']='Blokkide tabelite seadistamine';
...
$string['categories']='Kursuste rubriigid';
$string['category']='Rubriik';
$string['categoryadded']='Rubriik \'$a\' lisati';
$string['categorydeleted']='Rubriik \'$a\' kustutati';
$string['categoryduplicate']='Rubriik nimega \'$a\' on juba olemas!';
...
$string['clamquarantinedirfailed']='Faili ei õnnestunud tõsta Teie poolt määratud karantiinikataloogi, $a. Te peate kataloogi asukoha ära parandama või vastasel korral failid kustutatakse, kui avastatakse, et nad on nakatunud.';
...
$string['configuration']='Seadidtus';
...
$string['convertingwikitomarkdown']='Koverteerin Wiki märgenditega formaati';
$string['cookiesenabled']='Teie veebilehitseja peab lubama \"küpsised\"';
$string['cookiesnotenabled']='Kahjuks ei ole \"küpsised\" Teie veebilehitsejas lubatud';
$string['copy']='kopeeri';
...
$string['courserequestdisabled']='Vabandust, kursuse taotlemine on administraatori poolt suletud';
$string['courserestore']='Kuruse taastamine';
$string['courses']='Kursused';
$string['coursescategory']='Kursused samas rubriigis';
$string['coursestaught']='Kursused, mida ma olen õpetanud';
$string['courseupdates']='Kursuse uuendused';
$string['courseuploadlimit']='Kursusele üleslaadimise limiit';
$string['create']='Loo';
$string['createaccount']='Loo uus kasutajatunnus';
$string['createfolder']='Loo uus kaust asukohta $a';
$string['createuserandpass']='Loo endale kasutajanimi ja salasõna';
$string['createziparchive']='Loo pakitud arhiiv';
$string['creatingblocks']='Blokkide  loomine';
...
$string['creatinggradebook']='Loon päeviku';
$string['creatinggroups']='Loon rühmi';
$string['creatinglogentries']='Loon logi sisestusi';
$string['creatingmessagesinfo']='Loon sõnumi info';
$string['creatingmetacoursedata']='Loon metakursuse info';
$string['creatingnewcourse']='Loon uue õppeaine';
$string['creatingrolesdefinitions']='Loon rollide definitsioonid';
...
$string['currentcourseadding']='Käesolev kursus, lisan andmeid sellele';
$string['currentcoursedeleting']='Käesolev kursus, kustutan selle esmalt';
...
$string['databasechecking']='Moodle\'i andmebaasi uuendus versioonist $a->oldversion versiooniks $a->newversion...';
...
$string['defaultcoursefullname']='Kursuse täisnimi';
$string['defaultcourseshortname']='KTN101';
$string['defaultcoursestudent']='Õppija';
$string['defaultcoursestudentdescription']='Õppurid omavad üldiselt vähem õigusi kursuse tegevustes';
...
$string['deletecategorycheck']='Kas olete täiesti kindel, et soovite kustatada seda rubriiki <b>\'$a\'</b>?<br /> Kõik kursused liigutatakse peakataloogi (kui see eksisteerib), või kategooriasse \"Muud\".';
$string['deletecheck']='Kustuta $a ?';
$string['deletecheckfiles']='Kas olete täiesti kindel, et soovite neid faile kustutada?';
$string['deletecheckfull']='Kas olete täiesti veendunud, et soovite lõplikult kustutada $a ?';
$string['deletecheckwarning']='Olete kustutamas neid faile';
$string['deletecompletely']='Kustuta lõplikult';
$string['deletecourse']='Kustuta kursus';
$string['deletecoursecheck']='Kas olete täiesti veendunud, et soovite lõplikult kustutada selle kursuse ja kõik selles sisalduvad andmed?';
...
$string['duplicatingain']='Dubleerin: $a->what asukohas $a->in';
...
$string['emaildisplay']='Näita e-posti';
...
$string['emailformat']='E-posti formaat';
...
$string['enroldate']='Registreeumise ajavahemik';
$string['enrolenddate']='Lõppkuupäev';
$string['enrolenddaterror']='Registreerumise lõppkuupäev ei saa olla varasem kui alguskuupäev';
$string['enrollable']='Registreeritav kursus';
$string['enrolledincourse']='Registreeritud kursusele $a';
$string['enrolledincoursenot']='Ei  ole registreeritud kursusele $a';
$string['enrollfirst']='Selleks, et kasutada õpikeskkonna tegevusi, pead enne registreeruma mõnele kursusele';
$string['enrolme']='Registreeri mind antud kursusele';
...
$string['enrolmentnotyet']='Vabandust, sul ei ole ligipääsu kursusele kuni <br /> $a';
$string['enrolmentplugins']='Registreerumise viis';
$string['enrolments']='Registreerumised';
$string['enrolperiod']='Registreerumise periood';
$string['enrolstartdate']='Alguskuupäev';
...
$string['error']='Viga';
$string['errortoomanylogins']='Kahjuks oled ületanud oma sisenemiskatsete limiidi. Taaskäivita oma veebilehitseja.';
...
$string['existingcourseadding']='Olemasolev kursus, lisan andmeid sinna';
$string['existingcoursedeleting']='Olemasolev kursus, kustutan selle esmalt';
...
$string['expirynotify']='Registreerumise lõpptähtaja teadaanne';
$string['expirynotifystudents']='Teata õppuritele';
$string['expirythreshold']='Registreerumise lõpptähtajani:';
...
$string['findmorecourses']='Otsi veel kursuseid...';
...
$string['forcepasswordchangehelp']='Paku kasutajale salasõna vahetust järgmise sisenemise ajal';
$string['forcetheme']='Sunni teema';
...
$string['formattopicsajax']='Teemade formaat-AJAX';
$string['formatweeks']='Nädalakava formaat';
$string['formatweekscss']='Nädalakava formaat-CSS/Ei tabeleid';
$string['formatwiki']='Wiki formaat';
$string['from']='Alates';
$string['frontpagecategorycombo']='Combo-leht';
$string['frontpagecategorynames']='Näita rubriikide nimekirja';
...
$string['frontpagetopiconly']='Näita suvalist HTML\'i või tegevusi (teema sektsioon)';
...
$string['gdneed']='Selle graafiku nägemiseks tuleb installeerida GD.';
...
$string['healthcenter']='Funktsioneerimiskeskus';
$string['healthproblemsdetected']='Avastati funktsioneerimisprobleem!';
$string['healthproblemsolution']='Funktsioneerimisprobleemi lahendus';
$string['healthreturntomain']='Jätka';
$string['healthsolution']='Lahendus';
$string['help']='Abi';
$string['helpemoticons']='Kasuta emotikone';
$string['helpformatting']='Teksti formaatimisest';
$string['helphtml']='Kuidas kirjutada HTML\'i';
$string['helpindex']='Kõikide abifailide indeks';
$string['helppicture']='Kuidas pilti üles laadida?';
$string['helpprefix']='Abi, $a';
$string['helpquestions']='Esita asjalikke küsimusi';
$string['helpreading']='Loe hoolikalt';
$string['helprichtext']='HTML toimetist';
...
$string['htmleditor']='Kasuta HTML toimetit (ainult IE, 5.5 või hilisem)';
...
$string['importmetacoursenote']='Kasutge seda vormi, kui soovite oma metakursusele kursusi lisada (impordib ka registreerumised).';
...
$string['lastlogin']='Viimati sisenetud';
...
$string['list']='Loend';
$string['listfiles']='Failide loend kataloogis $a';
$string['listofallpeople']='Kõigi inimeste loend';
$string['livelogs']='Viimase tunni logid';
$string['locale']='et_EE';
...
$string['login']='Sisene';
$string['login_failure_logs']='Ebaõnnestunud sisenemiste logi';
...
$string['makeeditable']='Kui Te teete \'$a\' muudetavaks veebiserveri protsessi jaoks (nt apache), siis saate seda faili muuta otse sellelt leheküljelt';
...
$string['managemeta']='Kas see on metakursus?';
$string['managemetadisabled']='See on välja lülitatud, kuna antud kursus on juba metakursus';
$string['managemetaexplan']='(See tähendab, et registreerumised on päritud teistelt kursustelt)';
...
$string['messageselectadd']='Lisa/saada sõnum';
$string['metaaddcourse']='Lisa see kursus';
$string['metaalreadycourses']='Kursused juba määratud';
$string['metaalreadyhascourses']='Metakursus omab juba järeltulijaid kursuseid';
$string['metaalreadyhasenrolments']='Metakursus omab juba normaalseid registreerumisi';
$string['metaalreadyinmeta']='See kursus on juba osa metakursusest';
...
$string['metaremovecourse']='Kustuta see kursus';
$string['min']='minut';
$string['mins']='minutit';
...
$string['moduledeleteconfirm']='Olete lõplikult kustutamas moodulit \'$a\'. Seega kustutatakse andmebaasist kõik, mis on seotud antud mooduliga.  Kas soovite TÕEPOOLEST jätkata?';
$string['moduledeletefiles']='Kõik mooduliga \'$a->module\' seotud andmed on andmebaasist kustutatud. Et kustutamist lõpule viia (ja vältida mooduli taasinstalleerumist), peaksite nüüd kustutama oma serverist selle kataloogi: $a->directory';
$string['modulesetup']='Mooduli tabelite seadistamine';
$string['modulesuccess']='$a tabelid on korrektselt seadistatud';
$string['moodledocs']='Moodle dokumendid';
$string['moodledocslink']='Moodle dokumendid käesoleva lehe kohta';
$string['moodleversion']='Moodle Versioon';
$string['more']='Veel';
$string['moreinformation']='Rohkem informatsiooni tekkinud vea kohta';
$string['mostrecently']='kõige viimane';
$string['move']='Liiguta';
$string['movecategoryto']='Liiguta rubriik asukohta:';
$string['movecourseto']='Liiguta kursus asukohta:';
...
$string['moveselectedcoursesto']='Liiguta valitud kursused...';
...
$string['new']='Uus';
$string['newaccount']='Uus kasutajatunnus';
...
$string['noexistingcreators']='Disainereid pole';
$string['noexistingstudents']='Õppijaid pole';
...
$string['noimagesyet']='Teie kursusele pole üles laetud veel ühtegi pilti.';
...
$string['notenrollable']='Sellele kursusele ei saa momendil registreeruda.';
...
$string['outlinereport']='Liigenduse aruanne';
$string['page']='Leht';
$string['pageheaderconfigablock']='Konfigureerin blokki %%fullname%%';
$string['parentcoursenotfound']='Põhikursust ei leitud!';
$string['parentcoursenotmetacourse']='Põhikursus ei ole metakursus!';
$string['parentfolder']='Peakaustad';
$string['participants']='Osalejad';
$string['participationreport']='Osalemise ülevaade';
...
$string['pathnotexists']='Antud tee ei eksisteeri Teie serveris!';
...
$string['pleaseclose']='Palun sule see aken praegu.';
...
$string['preferences']='Seaded';
$string['preferredlanguage']='Eelistatud keel';
$string['preferredtheme']='Eelistatud teema';
...
$string['publicdirectory']='Avalik kaust';
$string['publicdirectory0']='Palun ära avalikusta seda õpikeskkonda';
$string['publicdirectory1']='Avalikusta ainult õpikeskkonna nimi';
$string['publicdirectory2']='Avalikusta õpikeskkonna  nimi koos lingiga';
...
$string['registrationemail']='E-posti teated';
...
$string['requireskey']='See kursus nõuab kursusele registreerumise võtit';
$string['requirespayment']='Sellele kursusele juurdepääs on tasuline';
$string['reset']='Taasta kursus';
$string['resetcourse']='Taasta kursus';
...
$string['sitepartlist0']='Peate olema õppikeskkonna õpetaja, et näha osalejate nimekirja';
$string['sitepartlist1']='Peate olema õpetaja, et näha õpikeskkonna osalejate nimekirja';
...
$string['specifyname']='Peate täpsustama nme';
$string['startdate']='Kursuse alguskuupäev';
$string['startsignup']='Alusta avalduse täitmist!';
...
$string['statsstudentwrites']='Õppijate postitused';
$string['statsteacherwrites']='Õpetajate postitused';
...
$string['stringsnotset']='Järgnevad stringid pole defineeritud asukohas $a';
...
$string['studentviewoff']='Lülita õppuri vaade välja';
$string['studentviewon']='Lülita õppuri vaade sisse';
$string['subcategories']='Alamkategooriad';
$string['submit']='Esita';
$string['success']='Edu';
$string['summary']='Kokkuvõte';
$string['summaryof']='$a kokkuvõte';
$string['supplyinfo']='Sinu andmed';
...
$string['textediting']='Teksti muutes';
...
$string['trackforumsyes']='Jah: tõsta esile uued postitused';
...
$string['unenrolallstudents']='Kustuta kõik õppijad osalejate nimekirjast';
$string['unenrolallstudentssure']='Kas olete kindel, et soovite kustutada kõik õppijad selle kursuse osalejate nimekirjast?';
$string['unenrolme']='Kustuta mind kursuselt $a';
$string['unenrolsure']='Kas olete veendunud, et soovite kustutada $a sellel kursusel osalejate hulgast?';
...
$string['unusedaccounts']='Kasutajatunnused, mida pole kasutatud rohkem kui $a päeva, kustutatakse automaatselt nimekirjast';
$string['unzip']='Paki lahti';
$string['unzippingbackup']='Paki lahti varukoopia';
$string['up']='Üles';
$string['update']='Uuenda';
$string['updated']='$a uuendatud';
$string['updatemymoodleoff']='Normaalvaade';
...
$string['updatethis']='Uuenda see $a';
...
$string['uploadfilelog']='Lae üles logi  faili $a jaoks';
$string['uploadformlimit']='Üleslaetud fail ületas sellele vormile seatud maksimaalse suuruse limiidi';
...
$string['uploadusers']='Lae kasutajad';
...
$string['userdeleted']='See kasutajanimi on kustutatud';
...
$string['userprofilefor']='Kasutaja $a andmed';
...
$string['visible']='Kas õppuritele nähtav?';
...
$string['youaregoingtorestorefrom']='Te  taastate:';
$string['yourlastlogin']='Teie viimane sisenemine toimus';
