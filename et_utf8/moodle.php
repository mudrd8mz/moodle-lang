<?PHP // $Id$ 
      // moodle.php - created with Moodle 1.5.4 + (2005060242)
...
$string['addinganewto'] = 'Lisan uue $a->what asukohta $a->to';
...
$string['adminhelpbackup'] = 'Seadista automaatne varundus ja ajasta see';
...
$string['adminhelpcourses'] = 'Määratle kursused ja kursuste kategooriad ning määra nende osalejad';
$string['adminhelpeditorsettings'] = 'Määratle  HTML-toimetaja sätted';
...
$string['adminhelpmanageblocks'] = 'Halda installeeritud plokke ja nende seadeid';
...
$string['adminhelpsitesettings'] = 'Määra esilehe välimus';
$string['adminhelpthemes'] = 'Määra õpikeskkonna välimus (värvid, tähestiilid jne)';
...
$string['advancedsettings'] = 'Täpsemad sätted';
$string['again'] = 'uuesti';
$string['aimid'] = 'AIM ID';
$string['all'] = 'Kõik';
...
$string['areyousuretorestorethisinfo'] = 'Hiljem avaneb võimalus lisada see varundus olemasolevale kursusele või luua täiesti uus kursus.';
...
$string['assignstudentspass'] = 'Sa pead õppijatele teada andma kursusele registreerimise võtme, mis on hetkel \'$a\'';
...
$string['backupcancelled'] = 'Varundamine katkestatud';
...
$string['backupfinished'] = 'Varundamine edukalt lõpetatud.';
$string['backupincludemoduleshelp'] = 'Vali, kas soovid kursuse mooduleid (koos kasutajainfoga või ilma) lisada automaatsesse varundusse.';
$string['backupkeephelp'] = 'Kui mitu viimatist varundust iga kursuse kohta soovid talletada? (vanemad kustutatakse automaatselt)';
...
$string['backupmetacoursehelp'] = 'Kui lubatud, siis metakursuse info lisatakse automaatsele varundusele.';
$string['backupnameformat'] = '%%Y%%m%%d-%%H%%M';
$string['backupnoneusersinfo'] = 'Märge: Sa oled valinud varundamisel kasutajate arvuks \"mite ühtegi\", seega kõigi moodulite varundamine on lülitatud \"ilma kasutaja andmeteta\" reiimi. Palun pane tähele, et sellise varundamise tüübiga ei ole võimalik varundada harjutuse ja õpikoja mooduleid, seega need moodulid on varundamiselt täielikult välja jäetud.';
$string['backuporiginalname'] = 'Varunduse nimi';
$string['backupsavetohelp'] = 'Varundusfailide salvestuskoha täisaadress <br /> (jäta tühjaks, kui soovid salvestada vaikimisi määratud kataloogi)';
$string['backuptakealook'] = 'Palun vaadake oma varunduse logisid $a seest';
$string['backupuserfileshelp'] = 'Kas kasutajate failid (nt. kasutajate fotod) lisatakse automaatsele varundusele?';
$string['backupusershelp'] = 'Kas soovid lisada kõiki kasutajaid serveris või ainult iga kursuse jaoks vajalikke kasutajaid?';
$string['backupversion'] = 'Varunduse versioon';
$string['blockconfiga'] = 'Seadista sektsiooni $a';
$string['blockconfigbad'] = 'See sektsioon ei veel korralikult realiseeritud ja seetõttu pole veel kasutajaliidest seadistuste tegemiseks.';
$string['blockdeleteconfirm'] = 'Sa oled kustutamas seksiooni\'$a\'. Seega kustutatakse andmebaasist kõik, mis selle sektsiooniga seotud on. Oled sa KINDEL, et soovid jätkata?';
$string['blockdeletefiles'] = 'Kõik andmed, mis on seotud sektsiooniga \'$a->block\'  on andmebaasist kustutatud. Kustutamise lõpetamiseks peaksid sa kustutama serverist kataloogi $a->directory';
$string['blocks'] = 'Sektsioonid';
$string['blocksaddedit'] = 'Lisa/muuda sektsioone';
$string['blockseditoff'] = 'Sektsioonide muutmine keelatud ';
$string['blocksediton'] = 'Sektsioonide muutmine lubatud';
$string['blocksetup'] = 'Sektsiooni tabelite seadistamine';
...
$string['clambroken'] = 'Sinu administraator on üles laetud failide jaoks viiruste kontrollimise sisse lülitanud, aga on midagi valesti konfigureerinud. <br/> Sinu faili üleslaadimine EBAÕNNESTUS. Sinu administraatorit on veast teavitatud.<br/> Sa võid proovida hiljem seda faili uuesti üles laadida.';
...
$string['clamlost'] = 'Moodle on konfigureeritud käivitama Clam\'i failide üleslaadimise ajal, aga Clam AV asukoht, $a, on vigane.';
$string['clamlostandactinglikevirus'] = 'Moodle on konfigureeritud nii, et kui Clam\'i käivitamine ebaõnnestub, siis koheldakse faile kui viiruseid. See tähendab, et ükski õppija ei saa faile üles laadida, kuni probleem on lahendatud.';
$string['clammovedfile'] = 'Fail on tõstetud sinu määratud karantiinikataloogi, mille uus asukoht on $a';
$string['clammovedfilebasic'] = 'Fail tõsteti karantiinikataloogi.';
$string['clamquarantinedirfailed'] = 'Faili ei saanud tõsta sinu poolt määratud karantiinikataloogi, $a. Sa pead kataloogi asukoha ära parandama või vastasel korral failid kustutatakse, kui avastatakse, et nad on nakatunud.';
...
$string['createuserandpass'] = 'Loo omale kasutajanimi ja salasõna';
$string['createziparchive'] = 'Loo pakitud arhiiv';
$string['creatingblocks'] = 'Sektsioonide  loomine';
...
$string['databaseupgradeblocks'] = 'Sektsioonide versioon on $a';
...
$string['deletecategorycheck'] = 'Oled sa täiesti kindel, et soovid kustatada seda kategooriat <b>\'$a\'</b>?<br /> Kõik kursused liigutatakse vanemkataloogi (kui see eksisteerib), või kategooriasse \"Muud\". ';
...
$string['displayingfirst'] = 'Ainult esimesed $a->count $a->things on kuvatud';
$string['displayingrecords'] = 'Kuvan $a salvestust';
$string['displayingusers'] = 'Kuvan kasutajad $a->start kuni $a->end';
...
$string['edhelpaspellpath'] = 'Et kasutada selles toimetis õigekirja kontrolli, PEAB sul serverisse olema installeeritud <strong>aspell 0.50</strong> või uuem versioon ja sa pead määrama korrektse juurdepääsutee aspell\'ile. Unixis ja Linuxis on see tee tavaliselt <strong>/usr/bin/aspell</strong>, aga võib olla ka teistsugune. ';
...
$string['editorcleanonpaste'] = 'Kleepimisel eemalda Wordi HTML';
$string['editorcommonsettings'] = 'Üldised sätted';
...
$string['editorsettings'] = 'Toimetaja sätted';
...
\'$a->sitename\' õpikeskkonnas on taotletud uus kasutajatunnus, kasutades antud e-posti aadressi.
...
$string['emaildisplay'] = 'Kuva e-posti ';
...
$string['failedloginattempts'] = '$a->attempts ebaõnnestunud sisenemist peale sinu viimast sisenemist.';
...
$string['filloutallfields'] = 'Palun täida kõik väljad ';
...
$string['forgotaccount'] = 'Salasõna kadunud?';
...
$string['groupinfoedit'] = 'Muuda rühma sätteid';
...
$string['groupmode'] = 'Rühma reiim';
$string['groupmodeforce'] = 'Sunni rühmareiim';
...
$string['hide'] = 'Peida';
$string['hideadvancedsettings'] = 'Peida laiendatud sätted';
$string['hidepicture'] = 'Peida pilt';
$string['hidesettings'] = 'Peida sätted';
$string['hits'] = 'Klikid';
...
$string['makeeditable'] = 'Kui sa teed \'$a\' muudetavaks veebiserveri protsessi jaoks (nt apache), siis saad seda faili muuta otse sellelt leheküljelt';
$string['manageblocks'] = 'Sektsioonid';
...
$string['moduledeleteconfirm'] = 'Sa oled lõplikult kustutamas moodulit \'$a\'. Seega kustutatakse andmebaasist kõik, mis on seotud antud mooduliga.  Kas soovid TÕEPOOLEST jätkata?';
...
$string['move'] = 'Liiguta';
$string['movecategoryto'] = 'Liiguta kategooria:';
$string['movecourseto'] = 'Liiguta kursus:';
...
$string['nocoursesyet'] = 'Selles kategoorias kursusi ei ole';
...
$string['nofilesyet'] = 'Sinu kursusele pole üles laetud ühtegi faili';
...
$string['noticenewerbackup'] = 'See varundusfail on loodud Moodle versiooniga 
...
$string['page'] = 'Leht';
$string['pageheaderconfigablock'] = 'Konfigureerin sektsiooni %%fullname%%';
$string['parentcoursenotfound'] = 'Vanemkursust ei leitud!';
$string['parentcoursenotmetacourse'] = 'Vanemkursus ei ole metakursus!';
$string['parentfolder'] = 'Vanemkaustad';
...
$string['restorefinished'] = 'Taastamine edukalt lõpule viidud';
...
$string['scalescustomno'] = 'Omatehtud skaalasid ei ole veel loodud';
...
$string['searchhelp'] = 'Sa saad otsida mitmeid sõnu korraga. <br />sõna: otsi igat vastet sellele sõnale teksti seest.<br />+sõna: leitakse ainult täpne vaste otsitavale sõnale.<br />-sõna: ei lisata tulemusi, mis sisaldavad seda sõna.';
...
$string['show'] = 'Näita';
$string['showadvancedsettings'] = 'Näita laiendatud sätteid';
...
$string['showonlytopic'] = 'Näita  ainult teema $a';
...
$string['showsettings'] = 'Näita sätteid';
...
$string['sitelogs'] = 'Õpikeskkonna logid';
$string['sitenews'] = 'Õpikeskkonna uudised';
$string['sitepartlist0'] = 'Sa pead olema õppikeskkonnas õpetajana, et näha osalejate nimekirja';
$string['sitepartlist1'] = 'Sa pead olema õpetaja, et näha õpikeskkonna osalejate nimekirja';
...
$string['unenrolallstudentssure'] = 'Kas oled kindel, et soovid kustutada kõik õppijad selle kursuse osalejate nimekirjast?';
...
$string['updatingain'] = 'Värskendan objekti $a->what asukohas $a->in';
$string['upload'] = 'Lae üles';
$string['uploadafile'] = 'Lae fail üles';
$string['uploadedfile'] = 'Fail edukalt üles laetud';
...
$string['uploadnofilefound'] = 'Ühtegi faili ei leitud - kas oled veendunud, et ikka valisid mõne üleslaadimiseks?';
...
$string['usernotconfirmed'] = 'Ei saanud kinnitada $a';
...
$string['weeklyoutline'] = 'Nädala vaade';
