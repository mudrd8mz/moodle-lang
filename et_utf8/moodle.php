...
$string['adminhelpcourses']='Määratle kursused ja kursuste rubriigid ning määra nendes osalejad';
...
$string['adminhelpmanageblocks']='Installeeritud blokkide ja nende seadete haldamine';
...
$string['adminhelpmymoodle']='Seadista MINU MOODLE blokk kasutajatele';
...
$string['adminprimarynoedit']='Sa ei või muuta primaarse admin\'i parooli?';
...
$string['backupnoneusersinfo']='Märkus: oled valinud varukoopia tegemisel kasutajate arvuks \"mite ühtegi\", seega kõigi moodulite varundamine on lülitatud \"ilma kasutaja andmeteta\" režiimi. Pane tähele, et sellise varundamise viisiga ei ole võimalik varundada harjutuse ja õpikoja mooduleid, seega need moodulid on varundamiselt täielikult välja jäetud.';
...
$string['backupschedulehelp']='Vali, millistel nädalapäevadel luua automaatsed varukoopiad.';
...
$string['backupusershelp']='Märgi, kas soovid lisada kõiki kasutajaid serveris või ainult iga kursuse jaoks vajalikke kasutajaid?';
...
$string['blockdeleteconfirm']='Oled kustutamas blokki $a\'. Seega kustutatakse andmebaasist kõik, mis selle blokiga seotud on. Kas oled  KINDEL, et soovid jätkata?';
...
$string['blockseditoff']='Lülita blokkide muutmine välja';
$string['blocksediton']='Lülita blokkide muutmine sisse';
...
$string['categorycontents']='Alamrubriigid ja kursused';
...
$string['categorymodifiedcancel']='Rubriiki on modifitseeritud! Palun tühista ja proovi uuesti.';
$string['categoryname']='Rubriigi nimi';
$string['categoryupdated']='Rubriik \'$a\' on uuendatud';
...
$string['coursecategories']='Kursuste rubriigid';
$string['coursecategory']='Kursuse rubriik';
$string['coursecategorydeleted']='Kustutati kursuse rubriik $a';
...
$string['courseenrolend']='Kursusele registreerumise lõpp';
$string['courseenrolenddate']='Kursusele registreerumise lõppdaatum';
$string['courseenrolstart']='Kursusele registreerumise algus';
$string['courseenrolstartdate']='Kursusele registreerumise algus';
...
$string['coursehelpnumberweeks']='Mitu nädalat/teemat kuvatakse kursuse põhilehel.';
...
$string['creatinggradebook']='Päeviku koostamine';
...
$string['creatingmetacoursedata']='Metakursuse info esitamine';
...
$string['databaseupgradeblocks']='Blokkide versioon on praegu $a';
...
$string['deletecategory']='Kustuta rubriik: $a';
$string['deletecategorycheck']='Kas oled täiesti kindel, et soovid kustatada seda rubriiki <b>\'$a\'</b>?<br /> Kõik kursused liigutatakse peakataloogi (kui see eksisteerib), või kategooriasse \"Varia\".';
$string['deletecategorycheck2']='Kui sa kustutad selle rubriigi, sa pead valima mida teha kursustega ja alamrubriikidega mida ta sisaldas';
$string['deletecategoryempty']='See rubriik on tühi';
...
$string['editcategorysettings']='Muuda rubriigi seadeid';
$string['editcategorythis']='Muuda seda rubriiki';
...
$string['editremoteprofile']='Redigeeri välisprofiili';
$string['editsummary']='Muuda kokkuvõtet';
$string['editthisactivity']='Muuda tegevust';
$string['editthiscategory']='Muuda rubriiki';
...
$string['emailpasswordchangeinfo']='Tere $a->firstname, Keegi (tõenäoliselt Teie ise) on soovinud uut salasõna Teie kasutajatunnusele õpikeskkonnas \'$a->sitename\'. Selle kinnitamiseks ja uue salasõna saamiseks e-kirjana minge järgmisele veebiaadressile: $a->link Enamikus meiliprogrammides peaks veebiaadress kuvatama lingi kujul, millele võite lihtsalt klikkida. Kui see ei tööta, siis kopeerige aadress veebilehitseja aadressiribale. Probleemide korral kontakteeruge õpikeskkonna adimistraatoriga, $a->admin';
$string['emailpasswordconfirmation']='Tere $a->firstname, Keegi (tõenäoliselt Teie ise) on soovinud uut salasõna Sinu kasutajatunnusele õpikeskkonnas \'$a->sitename\'. Selle kinnitamiseks ja uue salasõna saamiseks e-kirjana mine järgmisele veebiaadressile: $a->link Enamikus meiliprogrammides peaks veebiaadress kuvatama lingi kujul, millele võid lihtsalt klikkida. Kui see ei tööta, siis kopeeri aadress veebilehitseja aadressiribale. Probleemide korral kontakteeru õpikeskkonna adimistraatoriga, $a->admin';
$string['emailpasswordconfirmationsubject']='$a: muuda salasõna kinnitus';
$string['emailpasswordconfirmmaybesent']='<p>Kui sisestasid sobiva kasutajanime või e-mailiaadressi, siis peaks e-mail olema Sulle saadetud.</p><p>See e-mail sisaldab edasisi instruktsioone, mismoodi viia lõpule parooli muutmine. Kui tekib raskusi, siis palun kontakteeru oma õpikeskkonna administraatoriga.</p>';
...
$string['enroldetails']='Registreerumiste detailid';
...
$string['enrolmentconfirmation']='Oled registreerumas antud kursusele. <br />Kas oled kindel, et soovid seda teha?';
$string['enrolmentend']='Registreerumise lõpp';
$string['enrolmentkey']='Kursusele sisenemise võti';
$string['enrolmentkeyfrom']='Selle kursusega liitumiseks on vajalik kursusele registreerumise võti - salasõna,<br />
mille andis sulle $a';
$string['enrolmentkeyfromguest']='Selle kursusega liitumiseks on vajalik kursusele registreerumise võti - salasõna,<br />
mille andis Sulle $a';
...
$string['enrolmentstart']='Registreerumise algus';
...
$string['expirynotifystudents']='Teata õppijatele';
...
$string['forcepasswordchangenotice']='Edasi minemisks pead muutma oma parooli.';
...
$string['forgottenduplicate']='See e-mailiaadress on kasutusel mitmel kontol, palun anna kasutajanimi.';
...
$string['formattopicscss']='Teemade formaat - CSS/ilma tabeliteta';
...
$string['gd1']='GD 1.x on paigaldatud';
$string['gd2']='GD 2.x on paigaldatud';
$string['gdneed']='Selle graafiku nägemiseks tuleb installeerida GD.';
$string['gdnot']='GD pole paigaldatud';
...
$string['helpinterestslist']='Eralda sisestatud märksõnad komadega';
...
$string['importactivities']='Impordi tegevusi teiselt kursuselt';
...
$string['importmetacoursenote']='Kasuta seda vormi, kui soovid oma metakursusele kursusi lisada (impordib ka registreerumised';
...
$string['livelogs']='Viimase tunni sisenemised';
$string['locale']='et_EE';
...
$string['metaalreadyhascourses']='Metakursus omab juba  allkursusi';
...
$string['moduledeleteconfirm']='Oled lõplikult kustutamas moodulit \'$a\'. Seega kustutatakse andmebaasist kõik, mis on seotud antud mooduliga.  Kas soovid TÕEPOOLEST jätkata?';
...
$string['movecategoryto']='Teisalda rubriik asukohta:';
$string['movecontentstoanothercategory']='Teisalda sisu mingisse muusse rubriiki';
...
$string['nocoursesyet']='Selles rubriigis pole kursusi';
...
$string['parentcategory']='Ülemrubriik';
$string['parentcoursenotfound']='Ülemkursust ei leitud!';
$string['parentcoursenotmetacourse']='Ülemkursus ei ole metakursus!';
...
$string['publicdirectory0']='Ära avalikusta seda õpikeskkonda';
$string['publicdirectory1']='Avalikusta ainult õpikeskkonna nimi';
$string['publicdirectory2']='Avalikusta õpikeskkonna  nimi koos viitega';
...
$string['recreatedcategory']='Uuesti loodud rubriik  $a';
...
$string['requestcourse']='Kursuse taotlemine';
...
$string['restrictmodules']='Kas piirata tegevusmooduleid';
...
$string['setcategorytheme']='Sea rubriigi kujundus';
...
$string['statsoff']='Statistika pole hetkel keelatud';
...
$string['studentviewoff']='Lülita õppija vaade välja';
$string['studentviewon']='Lülita õppija vaade sisse';
$string['subcategories']='Alamrubriigid';
$string['submit']='Esita';
$string['success']='Edu';
...
$string['thiscategorycontains']='See rubriik sisaldab';
...
$string['unenrolme']='Eemalda mind kursuselt $a';
$string['unenrolroleusers']='Eemalda kasutajad';
...
$string['unknowncategory']='Tundmatu rubriik';
...
$string['uploadextension']='Faili üleslaadimine katkestati laienduse poolt';
...
$string['writingcategoriesandquestions']='Rubriikide ja küsimuste kirjutamine';
...
$string['xmldbeditor']='XMLDB toimeti';
...
$string['activitymodules']='Tegevuste moodulid'; // ORPHANED
$string['backto']='Tagasi $a juurde'; // ORPHANED
$string['clicktohideshow']='Kliki avamiseks või sulgemiseks'; // ORPHANED
$string['courseenrolend']='Kursusele registreerumise lõpp'; // ORPHANED
$string['courseenrolstart']='Kursusele registreerumise algus'; // ORPHANED
$string['coursestart']='Kursuse algus'; // ORPHANED
$string['downloadfile']='Tõmba fail alla'; // ORPHANED
$string['english']='Inglise'; // ORPHANED
$string['enroldetails']='Registreerumiste detailid'; // ORPHANED
$string['filter']='Filter'; // ORPHANED
$string['fullnamecourse']='Kursuse täisnimi'; // ORPHANED
$string['fullnameuser']='Kasutaja täisnimi'; // ORPHANED
$string['hiddenfromstudents']='Õpilaste eest peidetud'; // ORPHANED
$string['maximumgradex']='Maksimaalne hinne: $a'; // ORPHANED
$string['moduleintro']='Kirjeldus'; // ORPHANED
$string['pleaseusesearch']='Palun kasuta otsingut'; // ORPHANED
$string['searchoptions']='Otsingu valikud'; // ORPHANED
$string['seconds']='sekundit'; // ORPHANED
$string['shortnamecourse']='Kursuse lühinimi'; // ORPHANED
$string['shortnameuser']='Kasutaja lühinimi'; // ORPHANED
$string['sortbyx']='Sorteeri $a järgi tõusvalt'; // ORPHANED
$string['sortbyxreverse']='Sorteeri $a järgi kahanevalt'; // ORPHANED
$string['toomanyuserstoshow']='Kuvamiseks liiga palju kasutajaid ($a)'; // ORPHANED
$string['userdetails']='Kasutaja detailid'; // ORPHANED
$string['viewfileinpopup']='Vaata faili hüpikaknas'; // ORPHANED
$string['windowclosing']='See aken peaks sulguma automaatselt. Kui mitte, siis palun sulge nüüd.'; // ORPHANED
