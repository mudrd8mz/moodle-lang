...
$string['actauthhdr']='Aktiivsed autentimispluginad';
...
$string['auth_changepasswordhelp']='Parooli muutmise spikker';
$string['auth_changepasswordurl']='Muuda parooli URL';
$string['auth_common_settings']='Üldised seaded';
$string['auth_data_mapping']='Andmete vastendamine';
$string['auth_dbchangepasswordurl_key']='Parooli muutmise URL';
...
$string['auth_dbname_key']='DB nimi';
$string['auth_dbpass']='Antud kasutajanimega kokkukäiv salasõna.';
$string['auth_dbpass_key']='Parool';
...
$string['auth_dbpasstype_key']='Parooli formaat';
...
$string['auth_dbuser_key']='DB kasutaja';
$string['auth_dbusernotexist']='Ei saa muuta mitteeksisteerivat kasutajat: $a';
...
$string['auth_emailrecaptcha_key']='Võimalda reCAPTCHA element';
$string['auth_emailsettings']='Seaded';
$string['auth_emailtitle']='E-postil põhinev autentimine';
$string['auth_emailupdatesuccess']='Kasutaja <em>$a->fullname</em> e-mailiaadress on edukalt uuendatud aadressiks <em>$a->email</em>.';
$string['auth_fcchangepasswordurl']='Parooli muutmise URL';
...
$string['auth_fccreators_key']='Loojad';
...
$string['auth_fcpasswd_key']='Parool';
...
$string['auth_fcuserid_key']='Kasutaja ID';
...
$string['auth_imapchangepasswordurl_key']='Parooli muutmise URL';
...
$string['auth_nntpchangepasswordurl_key']='Parooli muutmise URL';
...
$string['auth_nntpnotinstalled']='Ei saa kasutada NNTP autentimist. PHP IMAP moodul ei ole installeeritud.';
...
$string['auth_pop3changepasswordurl_key']='Parooli muutmise URL';
...
$string['auth_pop3mailbox_key']='Postkast';
$string['auth_pop3notinstalled']='Ei saa kasutada POP3 autentimist. PHP IMAP moodul ei ole installeeritud.';
...
$string['auth_pop3type_key']='Tüüp';
$string['auth_radiuschangepasswordurl_key']='Parooli muutmise URL';
...
$string['auth_radiushost']='RADIUS serveri aadress';
$string['auth_radiushost_key']='Host';
$string['auth_radiusnasport']='Ühendumiseks kasutatav port';
$string['auth_radiusnasport_key']='Port';
$string['auth_radiussecret']='Jagatud salavõti';
$string['auth_radiussecret_key']='Salavõti';
$string['auth_radiustitle']='RADIUS server';
$string['auth_radiustype_key']='Autentimine';
$string['auth_radiustypechapmd5']='CHAP MD5';
$string['auth_radiustypemschapv1']='Microsoft CHAP versioon 1';
$string['auth_radiustypemschapv2']='Microsoft CHAP versioon 2';
$string['auth_radiustypepap']='PAP';
$string['auth_shib_auth_method']='Autentimismeetodi nimi';
...
$string['auth_shib_integrated_wayf']='Moodle WAYF teenus';
...
$string['auth_shibboleth_errormsg']='Palun vali organisatsioon, mille liige Sa oled';
$string['auth_shibboleth_login']='Shibboleth\'iga sisenemine';
$string['auth_shibboleth_login_long']='Logi Moodle\'sse Shibboleth kaudu';
$string['auth_shibboleth_manual_login']='Käsitisi sisenemine';
$string['auth_shibboleth_select_member']='Ma olen järgnevate liige ...';
$string['auth_shibboleth_select_organization']='Shibboleth kaudu autentimiseks palun vali rippmenüüst oma organisatsioon:';
...
$string['auto_add_remote_users']='Automaatselt lisa kaug-kasutajad';
...
$string['createpasswordifneeded']='Loo parool, kui vajalik';
$string['enterthenumbersyouhear']='Sisesta numbrid, mida kuuled';
$string['errorminpassworddigits']='Paroolid peavad sisaldama vähemalt $a numbrit.';
$string['errorminpasswordlength']='Paroolid peavad olema vähemalt $a märki pikad.';
$string['errorminpasswordlower']='Paroolid peavad sisaldama vähemalt $a väiketähte.';
$string['errorminpasswordnonalphanum']='Paroolid peavad sisaldama vähemalt $a tähe-numbrilisi märke.';
$string['errorminpasswordupper']='Paroolid peavad sisaldama vähemalt $a suurtähte.';
$string['errorpasswordupdate']='Viga parooli muutmisel. Parooli ei muudetud';
...
$string['forgottenpasswordurl']='Unustatud parooli URL';
$string['getanaudiocaptcha']='Saa heli-CAPTCHA (robotilõks)';
$string['getanimagecaptcha']='Saa pilt-CAPTCHA (robotilõks)';
$string['getanothercaptcha']='Saa muu CAPTCHA (robotilõks)';
$string['guestloginbutton']='Külaliskasutajana sisenemise nupp';
$string['incorrectpleasetryagain']='Vigane. Palun proovi uuesti';
$string['infilefield']='Failis nõutav väli';
$string['instructions']='Juhised';
$string['internal']='Sisemine';
...
$string['rpc_negotiation_timeout']='RPC kätlemise aegumine';
