...
$string['confirmclosure'] = 'Oled sulgemas dialoogi kasutajaga $a. Suletud dialooge ei saa uuesti avada. Kui suled selle dialoogi, siis saad seda küll vaadata, aga mitte sinna juurde kirjutada, ja pead avama uue dialoogi, et jätkata selle inimesega rääkimist.<br /><br />Oled kindel, et soovid dialoogi sulgeda?';
...
$string['maildefault'] = 'E-posti vaikeseade';
$string['mailnotification'] = 'E-postiga teavitamine ';
$string['modulename'] = 'Dialoog';
$string['modulenameplural'] = 'Dialoogid';
$string['namehascloseddialogue'] = '$a sulges dialoogi';
$string['newdialogueentries'] = 'Uued dialoogikirjed';
...
$string['opendialogueentries'] = 'Ava dialoogikirjed';
...
$string['sendmailmessages'] = 'Saada e-kirjad minu uute kirjete kohta';
...
$string['viewallentries'] = 'Vaata $a dialoogikirjet';
