...
$string['configintrotimezones'] = 'See leht otsib uut infot maailma ajatsoonide kohta (kaasa arvatud suveajale kasutamise reeglid) ja uuendab sinu andmebaasi leitud infoga. Otsitakse kohtadest $a . See protseduur on reeglina väga ohutu ja ei saa lõhkuda tavapäraseid installatsioone. Kas soovid ajatsoone praegu uuendada? ';
...
$string['editstrings'] = 'Muuda stringe';
...
$string['importtimezones'] = 'Uuenda kogu ajatsoonide nimekiri';
...
$string['sitemaintenancemode'] = 'Hooldusreiim';
$string['sitemaintenanceoff'] = 'Hooldusreiim on välja lülitatud ja õpikeskkond töötab jälle normaalselt';
$string['sitemaintenanceon'] = 'Sinu õpikeskkond on hetkel hooldusreiimis (ainult administraatorid saavad siseneda ja keskkonda kasutada)';
$string['sitemaintenancewarning'] = 'Sinu õpikeskkond on hetkel hooldusreiimis(ainult administraatorid saavad siseneda). Et pöörduda tagasi normaalsesse olekusse, <a href=\"maintenance.php\">lülita hooldusreiim välja</a>. ';
