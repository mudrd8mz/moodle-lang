<?php
$string['autoscroll']='Automaatne kerimine';
$string['beep']='signaal';
$string['chat:chat']='Ligi pääseda jututubadesse';
...
$string['normalstream']='Voog';
$string['notallowenter']='Sa ei ole lubatud siseneda sellesse vestlusruumi.';
$string['refreshroom']='Värskenda ruumi';
$string['refreshuserlist']='Värskenda kasutajate nimekirja';
$string['removemessages']='Eelamda kõik teated';
...
$string['serverhost']='Serveri nimi';
$string['serverip']='Serveri IP-aadress';
$string['servermax']='Maks. kasutajaid';
$string['serverport']='Serveri port';
$string['sessions']='Jututoa sessioonid';
$string['strftimemessage']='%%H:%%M';
$string['studentseereports']='Kõik saavad vaadata vanu sessioone';
$string['updatemethod']='Uuendamise meetod';
