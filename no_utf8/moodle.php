...
$string['admin'] = 'Admin';
$string['adminbookmarks'] = 'Admin bokmerker';
...
$string['adminhelpassignsiteroles'] = 'Tildel roller til spesifikke brukere';
...
$string['adminhelpmanageroles'] = 'Lag og definer roller som kan gis til brukere';
...
$string['adminhelpxmldbeditor'] = 'Brukergrensesnitt for å redigere XMLDB-filer. Bare for systemutviklere';
$string['administration'] = 'Administrasjon';
$string['administrationsite'] = 'Nettstedsadministrasjon';
$string['administrator'] = 'Administrator';
$string['administratordescription'] = 'Administratorer kan vanligvis gjøre hva som helst på hjemmesiden, på alle kurs';
...
$string['again'] = 'igjen';
$string['aimid'] = 'AIM ID';
$string['ajaxno'] = 'Nei: bruk vanlige webegenskaper';
$string['ajaxuse'] = 'AJAX og Javascript';
$string['ajaxyes'] = 'Ja: bruk avanserte webegenskaper';
$string['all'] = 'Alle';
...
$string['assignsiteroles'] = 'Tildel roller på nettstedsnivå';
...
$string['backupactivehelp'] = 'Velg om du vil slå på automatisert sikkerhetslagring';
...
$string['backupexecuteathelp'] = 'Velg tidspunkt som automatisert backup skal kjøres.';
...
$string['backupincludemoduleuserdatahelp'] = 'Velg om du vil inkludere modulen brukerdata i automatisert backup.';
...
$string['backupschedulehelp'] = 'Velg hvilke dager i uken en skal kjøre automatisert backup';
...
$string['coursecreatorsdescription'] = 'Kursprodusenter kan lage nye kurs og undervise i dem.';
...
$string['creatingblocksroles'] = 'Lager rolletillatelser og overstyringer på boksnivå';
$string['creatingcategoriesandquestions'] = 'Lager kategorier og spørsmål';
$string['creatingcoursemodules'] = 'Lager kursmoduler';
$string['creatingcourseroles'] = 'Lager rolletillatelser og overstyringer på kursnivå';
...
$string['creatingmodroles'] = 'Lager rolletillatelser og overstyringer på aktivitetsnivå';
$string['creatingnewcourse'] = 'Lager nytt kurs';
$string['creatingrolesdefinitions'] = 'Lager rolledefinisjoner';
...
$string['creatinguserroles'] = 'Lager rolletillatelser og overstyringer på brukernivå';
...
$string['defaultcoursestudentdescription'] = 'Studenter har vanligvis mindre rettigheter i et kurs.';
...
$string['defaultcourseteacherdescription'] = 'Lærere har alle rettigheter i et kurs, inkludert å forandre aktiviteter og gi studenter karakterer.';
...
$string['folderopened'] = 'Åpnet mappe';
...
$string['forgotteninvalidurl'] = 'Ugyldig passord, resett URL';
...
$string['frontpagedescriptionhelp'] = 'Nettstedsbeskrivelsen vil vises på framsiden';
...
$string['guest'] = 'Gjest';
$string['guestdescription'] = 'Gjester har minimale rettigheter og kan vanligvis ikke skrive noe sted.';
...
$string['notenrolledprofile'] = 'Profilen er ikke tilgjengelig fordi brukeren er ikke innmeldt i dette kurset.';
...
$string['notifications'] = 'Beskjeder';
...
$string['pleaseclose'] = 'Vær vennlig og lukk dette vinudet nå.';
...
$string['sitepartlist'] = 'Du har ikke nødvendige tillatelser til å se deltakerlisten';
...
$string['switchrolereturn'] = 'Gå tilbake til min vanlige rolle';
...
$string['youneedtoenrol'] = 'For å gjennomføre den handlingen må du være meldt på kurset.';
