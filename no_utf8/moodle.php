...
$string['activityweighted'] = 'Aktivitet per bruker';
$string['add'] = 'Legg til';
...
$string['addedrecip'] = 'La til $a ny bruker';
$string['addedrecips'] = 'La til $a nye brukere';
...
$string['adminhelpenvironment'] = 'Sjekk hvor godt tjenermaskinen tilfredstiller installasjonskravene til gjeldende versjon og senere versjoner.';
...
$string['adminhelpreports'] = 'Rapporter på nettstednivå';
...
$string['assignstudentsnote'] = 'OBS: Du trenger egentlig ikke å bruke denne siden, da studentene kan registrere seg selv i denne klassen.';
...
$string['backtoparticipants'] = 'Tilbake til deltakerlista ';
...
$string['chooselivelogs'] = 'eller se gjeldende aktivitet';
...
$string['courseapprovedemail'] = 'Klassen du ba om, $a->name, har blitt godkjent, og du er nå en $a->teacher. Den nye klassen din finner du her: $a->url';
$string['courseapprovedfailed'] = 'Klassen din er ikke godkjent';
$string['courseapprovedsubject'] = 'Klassen din har blitt godkjent';
...
$string['courseimportnotaught'] = 'Det ser ikke ut til at du er lærer med redigeringsrettigheter i noen andre klasser, så det finnes ingen klasser du kan hente inn data fra.';
$string['courseinfo'] = 'Klasseinformasjon';
$string['coursemessage'] = 'Melding til kursbrukere';
$string['coursenotaccessible'] = 'Denne klassen er ikke åpen for allmenheten ';
$string['courseoverview'] = 'Klasseoversikt';
$string['coursereject'] = 'Avslå søknad om ny klasse';
$string['courserejected'] = 'Søknaden om ny klasse ble avslått, og søkeren har fått beskjed.';
$string['courserejectemail'] = 'Beklager, men søknaden om å opprette en ny klasse ble ikke innvilget. Begrunnelsen for avslaget er som følger: $a';
$string['courserejectreason'] = 'Skisser opp hovedgrunnene til at klassen ikke ble opprettet<br/>(Dette blir sendt til søkeren)';
$string['courserejectsubject'] = 'Søknaden om å få opprette en klasse bla avsått';
$string['courserequest'] = 'Klassesøknad';
$string['courserequestdisabled'] = 'Beklager, men administrator har skrudd av funksjonen for å søke om opprettelse av nye klasser.';
$string['courserequestfailed'] = 'Av en eller annen grunn ble ikke klassesøknaden lagret';
$string['courserequestintro'] = 'Bruk dette skjemaet for å søke om å få opprettet en klasse. <br> Fyll inn så mye informasjon som mulig, slik at administratorene kan forstå hvorfor du ønsker denne klassen';
$string['courserequestreason'] = 'Grunner til å ha en slik klasse';
$string['courserequestsuccess'] = 'Klassesøknaden ble lagret uten feil. Du vil få svar på e-post i løpet av et par dager.';
$string['courserestore'] = 'Gjenopprett klasse';
$string['courses'] = 'Klasser';
$string['coursescategory'] = 'Klasse i samme kategori';
$string['coursespending'] = 'Klasser som venter på godkjenning';
...
$string['emailcharset'] = 'Tegnkoding i e-post';
...
$string['enrolmentend'] = 'Innmelding slutter';
...
$string['enrolmentnew'] = 'Ny innmelding til $a';
...
$string['expirythreshold'] = 'Terskel';
...
$string['import'] = 'Hent';
$string['importactivities'] = 'Hent aktiviteter fra en annen klasse';
...
$string['memberincourse'] = 'Deltakere i klassen';
...
$string['none'] = 'Ingen';
$string['nopendingcourses'] = 'Det er ingen klasser som venter på godkjenning';
...
$string['parentcoursenotmetacourse'] = 'Overordnet klasse er ikke en metaklasse.';
...
$string['paymentinstant'] = 'Bruk knappen under for å betale og melde deg inn i klassen.';
$string['paymentrequired'] = 'Dette er en klasse som krever betaling';
$string['payments'] = 'Betalinger';
...
$string['requestcourse'] = 'Søk om oppretting av klasse';
$string['requestedby'] = 'Søknad fra';
$string['requestreason'] = 'Grunn for klassesøknaden';
...
$string['resetcourse'] = 'tilbakestill klassen';
...
$string['shortnamecollisionwarning'] = '[*]= Kortnavnet er allerede brukt av en annen klasse og må endres når/hvis klasssen blir godkjent';
...
$string['starpending'] = '([*] =klasse som venter på godkjenning)';
...
$string['statsreport1'] = 'Innogginger';
$string['statsreport10'] = 'Brukeraktivitet';
$string['statsreport11'] = 'Mest aktive brukere';
$string['statsreport12'] = 'Mest aktive klasser (i forhold til antall brukere)';
$string['statsreport13'] = 'Klasser med flest deltakere';
$string['statsreport14'] = 'Klasser med flest visninger og innlegg';
