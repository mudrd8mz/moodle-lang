<?PHP // $Id$ 
      // lesson.php - created with Moodle 1.6.3 (2006050530)
...
$string['displayleftif'] = 'og vis kun hvis $a har en karakter større enn:';
...
$string['firstwrong'] = 'Dessverre kan du ikke få poeng på dette spørsmålet, for svaret ditt var ikke riktig. Vil du fortsette å gjette, bare for gleden ved å lære (men uten å få noen poeng)?';
