<?PHP // $Id$ 
      // scorm.php - created with Moodle 1.9.10 (Build: 20101025) (2007101591)
...
$string['contents'] = '<h3>Leksjonsinnhold<h3>';
$string['coursepacket'] = 'Leksjonspakke';
$string['coursestruct'] = 'Leksjonstruktur';
$string['datadir'] = 'leksjonsdata';
...
$string['hidetocdesc'] = 'Denne innstillingen bestemmer om brukeren skal  få se innholdsfortegnelsen eller ikke.';
$string['highestattempt'] = 'Høyeste forsøk';
$string['identifier'] = 'Spøsmåls ID';
...
$string['location'] = 'Vis navigeringslinjen';
...
$string['menubar'] = 'Vis menylinjen';
$string['min'] = 'Min score';
$string['missing_attribute'] = 'Manglende attributt $a->attr i taggen $a->tag';
$string['missing_tag'] = 'Manglende tagg $a->tag';
...
$string['no_children'] = 'Taggen $a->tag må ha undertagger';
$string['noactivity'] = 'Ingenting å rapportere';
$string['nolimit'] = 'Ubegrensede forsøk';
$string['nomanifest'] = 'Manifest ikke funnet';
...
$string['onchanges'] = 'Hver gang den endres';
$string['options'] = 'Valg';
...
$string['packagefile'] = 'Ingen pakkefil angitt';
$string['passed'] = 'Bestått';
$string['php5'] = 'PHP 5 (DOMXML native library)';
$string['popup'] = 'Nytt vindu';
$string['popupblockmessage'] = 'Dersom det ikke åpner seg et nytt vindu må du slå på/tillate popup-vinduer fra dette nettstedet.';
$string['popupmenu'] = 'I en rullegardinmeny';
$string['popupopen'] = 'Åpne leksjonen i nytt vindu';
$string['position_error'] = '$a->tag taggen kan ikke være en undertagg av $a->parent taggen';
$string['prev'] = 'Forrige';
$string['raw'] = 'Rå score';
$string['regular'] = 'Vanlig manifest';
...
$string['scorm:viewscores'] = 'Vis resultater';
$string['scormcourse'] = 'SCORM-leksjon';
...
$string['scrollbars'] = 'Tillat å rulle i vinduet (scrolling)';
$string['sided'] = 'På venstre side';
$string['skipview'] = 'Skjul innholdsoversikten';
$string['skipviewdesc'] = 'Denne innstillingen bestemmer om en skal skjule pakkens innholdsstruktur';
...
$string['stagesize'] = 'Visningstørrelse';
...
$string['tag_error'] = 'Ukjent tagg ($a->tag) med innhold: $a->value';
$string['time'] = 'Tid';
$string['title'] = 'Tittel';
