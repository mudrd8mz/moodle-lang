...
$string['addsomecontacts'] = 'For å sende ei melding til noen, eller for å lage en snarvei til dem på denne siden, kan du bruke <a href=\"$a\">søkefanen</a> over.';
$string['addsomecontactsincoming'] = 'Disse beskjedene er fra folk som ikke er i kontaktlisten din. For å legge dem til blant dine kontakter, kan du klikke på \"Legg til kontakt\"-ikonet  ved siden av navnet deres.';
$string['ago'] = 'for $a siden';
$string['allmine'] = 'Alle beskjeder fra eller til meg';
$string['allstudents'] = 'Alle beskjeder mellom studenter i kurset';
$string['allusers'] = 'Alle beskjeder fra alle brukere';
$string['backupmessageshelp'] = 'Hvis denne er slått på, vil meldinger bli inkludert i de automatiske sikkerhetskopiene av nettstedet.';
$string['beepnewmessage'] = 'Gi lyd når det kommer en ny beskjed (kan kreve plugin i nettleseren din som kan spille av lyd, som f.eks. Quicktime)';
$string['blockcontact'] = 'Blokker kontakten';
$string['blockedmessages'] = '$a beskjed(er) til/fra bokkerte brukere';
$string['blocknoncontacts'] = 'Blokker alle beskjeder fra folk som ikke er på kontaklisten min';
$string['contactlistempty'] = 'Kontaktlisten din er for tiden tom';
...
$string['emailmessages'] = 'E-postbeskjeder når jeg ikke er på nett';
$string['emailtagline'] = 'Denne e-posten er en kopi av en melding sendt til deg på \"$a\"';
...
$string['onlymycourses'] = 'Bare i mine kurs';
...
$string['unblockcontact'] = 'Opphev blokkering av kontakt';
...
$string['userisblockingyounoncontact'] = 'Denne brukeren aksepterer bare meldinger fra folk i kontaktlisten sin. Du står ikke der.';
