...
$string['calendarexportsalt'] = 'Krypteringsfrase for eksport av kalender (SALT)';
...
$string['configcalendarexportsalt'] = 'Denne tilfeldige teksten brukes for å forbedre sikkerheten av autentiseringen ved eksportering av kalendre. Merk at alle nåværende godkjennelser blir ugyldige hvis du forandrer denne salt-koden.';
...
$string['configcourserequestnotify2'] = 'Brukere som vil bli meddelt når et nytt kurs ønskes opprettet. Bare brukere som kan gi godkjennelse til å opprette nytt kurs skal listes opp her.';
...
$string['configgetremoteaddrconf'] = 'Dersom serveren er bak en revers proxy, kan du bruke denne innstillingen til å sette opp hvilke http-headere som skal tillates å inneholde innkommende IP-adresser. Headerne blir lest i oppgitt rekkefølge og bruker første treff.';
