...
$string['confeditorhidebuttons'] = 'Velg de knappene som skal skjules i tekstredigeringsverktøyet.';
...
$string['configextendedusernamechars'] = 'Slå på denne for å la studenter bruke alle tegn i sine brukernavn (merk at dette ikke påvirker deres virkelige navn). Standard er \"Nei\" som avgrenser brukernavn til å bestå av kun alfanumeriske tegn';
...
$string['confightmleditor'] = 'Velg hvorvidt den innebygde tekstredigeringsverktøyet skal kunne brukes. Selv om du velger å tillate dette, så vil tekstredigeringsverktøyet kun vises når det brukes en kompatibel nettleser. Brukere kan også velge å ikke bruke den.';
...
$string['editordictionary'] = 'Ordliste for tekstredigeringsverktøyet';
...
$string['hidefromall'] = 'Skjul for alle brukere';
$string['hidefromnone'] = 'Ikke skjul for noen';
$string['hidefromstudents'] = 'Skjul for studenter';
$string['htmleditor'] = 'Tekstredigeringsverktøy';
...
$string['usehtmleditor'] = 'Bruk tekstredigeringsverktøyet';
$string['user'] = 'Bruker';
...
$string['configfilteraddthemecssandjs'] = 'Legger til design CSS og JavaScript når \"filteruploadedfiles\" er aktiv. Design CSS og JavaScript kan ofte komme i konflikt med egne filers CSS og JS. Standard er Nei.'; // ORPHANED
$string['filteraddthemecssandjs'] = 'Aktiver designets CSS og JS'; // ORPHANED
