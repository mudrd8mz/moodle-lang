...
$string['bestgrades'] = 'De $a beste resultatene:';
$string['bestgroupgrade'] = 'Gruppen med høyest gjennomsnitt';
$string['bestgroupgrades'] = 'De $a gruppene med høyest gjennomsnitt';
$string['config_format_absolute'] = 'Absolutte verdier';
$string['config_format_fraction'] = 'Fraksjoner';
$string['config_format_percentage'] = 'Prosenter';
$string['config_grade_format'] = 'Vis vurderingen som:';
$string['config_name_format'] = 'Resultatene skal være synlige for:';
$string['config_names_anon'] = 'Anonyme resultater';
$string['config_names_full'] = 'Vis fulle navn';
$string['config_names_id'] = 'Vis bare ID-numrene';
$string['config_no_quizzes_in_course'] = 'Dette kurset inneholder ingen QUIZ-aktiviteter. Du må legge til minst en før denne blokken er til nytte.';
$string['config_select_quiz'] = 'Hvilken Quiz skal blokken vise resultater fra?';
$string['config_show_best'] = 'Hvor mange av de beste resultatene skal vises? (0 er det samme som inaktiv)';
