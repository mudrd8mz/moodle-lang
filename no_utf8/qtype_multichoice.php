...
$string['answernumberingnone'] = 'Ingen nummerering';
$string['answersingleno'] = 'Flere mulige  svaralternativer tillatt';
$string['answersingleyes'] = 'Bare ett alternativ er korrekt';
$string['choiceno'] = 'Alternativ $a';
$string['choices'] = 'Tilgjengelige alternativer';
$string['clozeaid'] = 'Fyll inn det manglende ordet';
$string['correctfeedback'] = 'For alle korrekte svar';
$string['editingmultichoice'] = 'Rediger et flervalg spørsmål';
$string['errfractionsaddwrong'] = 'De positive karakterene du har valgt går ikke opp i 100%%<br/>Istedet blr det $a%%';
$string['errfractionsnomax'] = 'Et av valgene bør være 100%%, så det er<BR/> mulighet til å full karakter for dette spørsmålet.';
...
$string['overallincorrectfeedback'] = 'Tilbakemelding for feil svar';
