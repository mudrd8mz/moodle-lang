<?PHP // $Id$ 
      // grades.php - created with Moodle 1.9.4+ (Build: 20090311) (2007101541)
...
$string['addoutcome'] = 'Legg til læringsmål'; // ORPHANED
$string['addscale'] = 'Legg til en skala'; // ORPHANED
$string['aggregationsvisible'] = 'Tilgjengelige samlingstyper'; // ORPHANED
$string['aggregationsvisiblehelp'] = 'Velg hvilke samlingstyper som skal være tilgjengelige. Hold nede Ctrl-tasten for å velge mer enn ett element.'; // ORPHANED
$string['badlyformattedscale'] = 'Vennligst bruk en komma-separert liste av verdier. Det må være minst to verdier i listen.'; // ORPHANED
$string['calculatedgrade'] = 'Beregnet karakter'; // ORPHANED
$string['cannotaccessgroup'] = 'Desverre ingen tilgang til karakterer for valgte gruppe.'; // ORPHANED
$string['categorytotalfull'] = '$a->category totalt'; // ORPHANED
$string['combo'] = 'Flik- og listeboks meny'; // ORPHANED
$string['configfixedstudents'] = 'Frys kolonnen med studentnavn slik at en kan scrolle horisontalt i karaktene.'; // ORPHANED
$string['configunlimitedgrades'] = 'Som standard avgrenses karakterer av en minimums- og maksimumsverdi for den karakteren. Ved aktivering overstyrer du denne grensen og tillater at karakterer over 100%%%% kan skrives inn manuelt. Vi anbefaler at denne innstillingen gjøres på en rolig tid på døgnet, da den medfører omberegning av karakterer og høy serverbelastning.'; // ORPHANED
$string['coursescales'] = 'Kurs-skalaer'; // ORPHANED
$string['coursesettingsexplanation'] = 'Innstillingen bestemmer om karakterboken skal vises for alle deltakere i dette kurset.'; // ORPHANED
$string['currentparentaggregation'] = 'Gjeldende overordnet posisjon'; // ORPHANED
$string['dropdown'] = 'Listeboks-meny'; // ORPHANED
$string['editgradeletters'] = 'Rediger bokstavkarakterer'; // ORPHANED
$string['editoutcome'] = 'Rediger læringsmål'; // ORPHANED
$string['editscale'] = 'Rediger skala'; // ORPHANED
$string['fixedstudents'] = 'Lås studentnavn-kolonnen'; // ORPHANED
$string['fullview'] = 'Full visning'; // ORPHANED
$string['gradeforstudent'] = '$a->student<br />$a->item$a->feedback'; // ORPHANED
$string['intersectioninfo'] = 'Student/Karakter info'; // ORPHANED
$string['linktoactivity'] = 'Lenke til $a->name aktivitet'; // ORPHANED
$string['moveselectedto'] = 'Flytt valgte elementer til'; // ORPHANED
$string['mypreferences'] = 'Mine innstillinger'; // ORPHANED
$string['navmethod'] = 'Navigasjonsinnstillinger'; // ORPHANED
$string['newitem'] = 'Nytt element for karaktersetting'; // ORPHANED
$string['newoutcomeitem'] = 'Nytt element for læringsmål'; // ORPHANED
$string['selectauser'] = 'Velg en bruker'; // ORPHANED
$string['simpleview'] = 'Forenklet visning'; // ORPHANED
$string['switchtofullview'] = 'Bytt til full visning'; // ORPHANED
$string['switchtosimpleview'] = 'Bytt til forenklet visning'; // ORPHANED
$string['tabs'] = 'Fliker'; // ORPHANED
$string['unlimitedgrades'] = 'Ingen karakterbegrensning'; // ORPHANED
$string['weightorextracredit'] = 'Vekting eller tilleggspoeng'; // ORPHANED
$string['weights'] = 'Vekting'; // ORPHANED
$string['weightsedit'] = 'Rediger vekting og tilleggspoeng'; // ORPHANED
$string['weightuc'] = 'Vekt'; // ORPHANED
