...
$string['configincludescalesinaggregation'] = 'Du kan velge om skalaer skal inkluderes som tall i alle oppsamlede karakterer i alle karakterbøker i alle kurs. ADVARSEL: hvis du forandre denne innstillinger vil alle summerte karakterer bli rekalkulert.';
...
$string['configshowcalculations'] = 'Om en skal vise kalkulatorikon nær hver karakterenhet og kategori, verktøytips over kalkulerte verdier og en visuell markering som viser at kolonnen er kalkulert.';
...
$string['errornocalculationallowed'] = 'Kalkulasjon er ikke tillatt for denne enheten';
...
$string['idnumberhelp'] = 'Å sette et idnummer gir en måte å identifisere aktiviteten for karakterkalkulasjon. Hvis aktiviteten ikke er inkludert i noen form for karakterkalkulasjon kan idnummeret være blankt. Idnummer er en aktivtetsbasert karakterenhet som kan settes på Oppdater Aktivitets-siden.';
