...
$string['common:apply'] = 'এপ্ল্যাই';
$string['common:browse'] = 'ব্রাউজ';
$string['common:cancel'] = 'ক্যানসেল';
$string['common:class_name'] = 'ক্লাস';
$string['common:clipboard_msg'] = 'কপি/কাট/পেষ্ট মজিলা এবং ফায়ারফক্স এ সম্ভব নয়\\nআপনি কি এই বিষয়টির সম্বন্ধে আরও বেশি তথ্য চান';
$string['common:clipboard_no_support'] = 'আপনার ব্রাউজারের দ্বারা বর্তমানে সমর্থিত না, পরিবর্তে কীবোর্ড শর্টকাট  ব্যবহার করুন।';
$string['common:close'] = 'বন্ধ';
$string['common:edit_confirm'] = 'আপনি কি এই textareaটির জন্য WYSIWYG মোড ব্যবহার করতে চান?';
$string['common:insert'] = 'ইনসার্ট';
$string['common:invalid_data'] = 'ত্রুটি: বেঠিক মান ঢুকানো হয়েছে, এইগুলি লাল চিহ্নিত করা হল।';
$string['common:more_colors'] = 'আরও বেশি রং';
$string['common:not_set'] = '-- সেট নয় --';
$string['common:popup_blocked'] = 'দুঃখিত, কিন্তু আমরা লক্ষ্য করেছি যে আপনার পপ-আপ ব্লকার একটি উইন্ডো নিষ্ক্রিয় করেছে যা অ্যাপলিকেশন এর ফাংশনালিটির জন্য প্রয়োজনীয়।আপনি এই টুলটি সম্পূর্ণভাবে ব্যাবহার করতে চাইলে এই সাইটটি থেকে পপ-আপ ব্লকিং নিষ্ক্রিয় করতে হবে।';
$string['common:update'] = 'আপডেট';
...
$string['simple:striketrough_desc'] = 'মাঝ বরাবর রেখাঙ্কন';
$string['simple:underline_desc'] = 'আন্ডারলাইন (Ctrl+U)';
$string['simple:undo_desc'] = 'আনডু (Ctrl+Z)';
