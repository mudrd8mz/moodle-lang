...
$string['adminprimarynoedit'] = 'Ne smete spreminjati gesla glavnega skrbnika';
...
$string['adminhelpconfiguration'] = 'Konfiguriraj kako naj stran zgleda in deluje';
...
$string['adminhelpenrolments'] = 'Izberi notranje ali zunanje načine nadzora vpisovanja';
...
$string['backupnonisowarning'] = 'Opozorilo: ta varnostna kopija izvira iz različice Moodle brez podpore Unicode (pred 1.6).  Če ta varnostna kopija vsebuje besedilo, ki ni v kodni tabeli ISO-8850-1, se besedilo lahko POŠKODUJE, če ga boste poskušali obnoviti v to različico Moodle s podporo Unicode.  Oglejte si <a href=\"http://docs.moodle.org/sl/Backup_FAQ\">Pogosta vprašanja o varnostnem kopiranju</a> za več informacij o tem kako pravilno obnoviti to varnostno kopijo.';
...
$string['blockdeletefiles'] = 'Vsi podatki povezani z blokom \'$a->block\' so bili izbrisani iz podatkovne zbirke.  Za dokončanje brisanja (in preprečitev ponovne namestitve samega bloka), morate zdaj izbrisati sledeč imenik na vašem strežniku: $a->directory';
$string['blocks'] = 'Bloki';
...
$string['courseapprovedfailed'] = 'Shranjevanje predmeta kot je bil odobren ni uspelo!';
...
$string['enrolmentnewuser'] = '$a->user se je vpisal v predmet \"$a->course\"';
...
$string['formatlams'] = 'Zapis predmeta LAMS';
...
$string['frontpageformatloggedin'] = 'Oblika naslovnice po prijavi';
$string['frontpagenews'] = 'Elementi novic';
$string['frontpagetopiconly'] = 'Odsek poglavij';
...
$string['loginalready'] = 'Prijavljeni ste že';
...
$string['notenrollable'] = 'V ta predmet trenutno vpis ni možen.';
...
$string['passwordnohelp'] = 'Pomoč ni na voljo za iskanje vašega izgubljenega gesla. Če želite več pomoči, povprašajte skrbnika.';
...
$string['statsreportreads'] = 'Pogledi (izvajalec in udeleženec)';
$string['statsreportwrites'] = 'Objave (izvajalec in udeleženec)';
$string['statsreportactivity'] = 'Vse dejavnosti (izvajalec in udeleženec)';
$string['statsreportstudentactivity'] = 'Vse dejavnosti udeleženca (ogledi in objave)';
$string['statsreportteacheractivity'] = 'Vse dejavnosti izvajalca (ogledi in objave)';
$string['statsreport1'] = 'Prijave';
$string['statsreport2'] = 'Pogledi (izvajalec in udeleženec)';
$string['statsreport3'] = 'Objave (izvajalec in udeleženec)';
$string['statsreport4'] = 'Vse dejavnosti (izvajalec in udeleženec)';
$string['statsreport5'] = 'Vse dejavnosti udeleženca (ogledi in objave)';
$string['statsreport6'] = 'Vse dejavnosti izvajalca (ogledi in objave)';
$string['statsreport7'] = 'Vse dejavnosti (ogledi in objave)';
$string['statsreport8'] = 'Vse uporabniške dejavnosti';
...
$string['statsreport13'] = 'Predmeti z največ sodelujočimi (vpisi)';
$string['statsreport14'] = 'Predmeti z največ sodelujočimi (ogledi in objave)';
...
$string['usernamenotfound'] = 'Tega uporabniškega imena ni bilo najti v podatkovni zbirki';
