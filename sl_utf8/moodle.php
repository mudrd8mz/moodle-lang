...
$string['activitymodule'] = 'Moduli dejavnosti';
...
$string['admin'] = 'Admin';
$string['adminbookmarks'] = 'Zaznamki administratorja';
...
$string['adminhelphealthcenter'] = 'Samodejno odkrivanje težav strani';
...
$string['administratordescription'] = 'Skrbniki lahko upravljajo s stranjo, pri vseh predmetih.';
...
$string['adminprimarynoedit'] = 'Ne morete spremeniti gesla primarnega administratorja';
...
$string['authenticateduser'] = 'Avtentikacija uporabnika';
$string['authenticateduserdescription'] = 'Vsi prijavljeni uporabniki';
$string['authentication'] = 'Avtentikacija';
$string['authenticationplugins'] = 'Avtevtikacija vtičnikov';
...
$string['backupsitefileshelp'] = 'Če je omogočeno, bodo dokumenti uporabljeni na strani predmeta vključeni v avtomatsko varnoste kopije.';
...
$string['blockdeletefiles'] = 'Vsi podatki povezani z blokom &#039;$a->block&#039; so bili izbrisani iz podatkovne zbirke.  Za dokončanje brisanja (in preprečitev ponovne namestitve samega bloka), morate sedaj izbrisati sledeč imenik na vašem strežniku: $a->directory';
$string['blocks'] = 'Bloki';
...
$string['coursecreatorsdescription'] = 'Ustvarjalci predmtov lahko ustvarijo nove predmete in se z njimi učijo.';
...
$string['courseimportnotaught'] = 'Kot kaže niste izvajalec s pravico urejanja v nobenem drugem predmetu. Ni predmetov iz katerih bi lahko uvažali.';
...
$string['creatingblocksroles'] = 'Ustvari blokirane stopnje naloge in razveljavitve';
$string['creatingblocksroles'] = 'Ustvarjanje blokirane stopnje naloge in razveljavitve';
...
$string['creatingcourseroles'] = 'Ustvarjanje nalog predmeta in razveljavitve';
...
$string['creatingmodroles'] = 'Ustvarjanje modulov stopenj naloge in razveljavitve';
...
$string['creatinguserroles'] = 'Ustarjanje dodeljevanja nalog uporabnikov in razveljavitve';
...
$string['defaultcoursestudentdescription'] = 'Študentje imajo načeloma manj privilegijev znotraj predmeta.';
...
$string['defaultcourseteacherdescription'] = 'Učitelji lahko naredijo karkoli znotraj predmeta, vključno s spreminjanjem aktivnosti in ocenjevanjem študentov.';
...
$string['deleteselectedkey'] = 'Izbriši izbrani kjluč';
...
$string['editorcleanonpaste'] = 'Počisti Word HTUreML ob lepljenju';
...
ČE potrebujete pomoč, kontaktirajte skrbinka sistema, $a->admin';
$string['emailpasswordchangeinfodisabled'] = 'Pozdravljeni $a->firstname,
nekdo (verjetno vi) je zahteval novo geslo za vaš račun na &#039;$a->sitename&#039;.
Nažalost je vaš račun onemogočen in ga ni mogoče restirati, ČE potrebujete pomoč, kontaktirajte skrbinka sistema, $a->admin';
$string['emailpasswordchangeinfofail'] = 'Pozdravljeni $a->firstname,
nekdo (verjetno vi) je zahteval novo geslo za vaš račun na &#039;$a->sitename&#039;.
Nažalost geslo ne more biti ponovno nastavljeno na tej strani, če potrebujete pomoč, kontaktirajte skrbinka sistema, $a->admin';
...
<p>Pošta vsebuje lahka navodila za potrditev in dokončanje spremembe gesla. Če se bodo pojavile težave, prosim kontaktirajete skrbnika sistema.</p>';
...
$string['forgottenduplicate'] = 'Ta elektronski naslov je uporabljen v večih računih, prosim vnesite uporabniško ime namesto tega.';
$string['forgotteninvalidurl'] = 'Napačno gelslo ponastavljanja URL';
...
$string['formattopicsajax'] = 'Oblika poglavij - AJAX';
$string['formattopicscss'] = 'Oblika poglavij - CSS/No tables';
...
$string['framesetinfo'] = 'Ta okvirjen dokumet vsebuje:';
$string['from'] = 'Od';
...
$string['frontpagetopiconly'] = 'Odsek poglavja';
...
$string['helpinterestslist'] = 'Vnesite svoje interese ločene z vejicami';
$string['helppicture'] = 'kako naložiti sliko';
$string['helpprefix'] = 'Pomoč, $a';
$string['helpprefix2'] = 'Pomoč z $a';
...
$string['hiddenassign'] = 'Skirte naloge';
...
$string['importmetacoursenote'] = 'Uporabite ta obrazec za dodajanje predmetov v vaš meta predmet (to bo uvozilo vpise)';
...
$string['layouttable'] = 'Izgled tabele';
...
$string['managemetaexplan'] = '(To pomeni, da so vpisi podedovani iz drugih predmetov)';
...
$string['messageselect'] = 'Izberite tega uporabnika kot prejemnika e-pošte';
$string['messageselectadd'] = 'Dodaj / pošlji sporočilo';
...
$string['noneditingteacherdescription'] = 'Učitelji brez pravic urejanja, lahko učijo  predmet in ocenjujejo študente, ampak ne smejo spreminjati dejavnosti.';
...
$string['notingroup'] = 'Žal, biti morate član skupine, da bi videli to aktivnost.';
...
$string['olduserdirectory'] = 'To je STARA uporabniška mapa, in ni več v uporabi. Lahko jo varno izbrišete. Dokumete ki jih vsebuje so kopirani v NOVO uporabniško mapo.';
...
$string['participants'] = 'Udeleženec';
...
Prikazujejo kateri vtišniki so osnovni, in kateri niso. Vsi nestandardni vtičniki morajo biti pregledani do zadnje verzije, pred nadaljevanjem nadgraditve Moodle.';
...
$string['previoussection'] = 'Preejšnja';
...
$string['remotemaharauser'] = 'Upravljanje Mahara uporabnika';
...
$string['restrictmodules'] = 'Omejitev modulov dejavnosti?';
...
$string['saveandnext'] = 'Shrani in pokaži naslednje';
...
$string['screenreaderuse'] = 'Čitalec ekrana';
...
$string['showblockcourse'] = 'Pokaži seznam predmetov, ki vsebujejo blok';
...
$string['statisticsgraph'] = 'Grafikovna statistika';
...
$string['tag'] = 'Značka';
$string['tagalready'] = 'Ta tag že obstaja';
...
$string['thereareno'] = 'Tukaj ni  $a pri tem predmetu';
...
$string['usersnoaccesssince'] = 'Prikaži uporabnike, ki so neaktivni več kot';
