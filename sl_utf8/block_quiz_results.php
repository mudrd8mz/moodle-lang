<?PHP // $Id:block_quiz_results.php from block_quiz_results.xml
...
$string['worstgroupgrade'] = 'Skupina z najnižnjim povprečjem:';
$string['worstgroupgrades'] = '$a skupin z najnižjim povprečjem:';
$string['formaltitle'] = 'Rezultati kviza';
$string['config_select_quiz'] = 'Rezultate katerega kviza naj prikazuje ta blok?';
...
$string['config_name_format'] = 'Raven zasebnosti za prikazane rezultate:';
...
$string['config_names_full'] = 'Prikaži cela imena';
$string['config_names_id'] = 'Prikaži samo identifikacijske številke';
$string['config_names_anon'] = 'Anonimni rezultati';
$string['config_no_quizzes_in_course'] = 'Ta predmet ne vsebuje dejavnosti kviza. Dodati morate vsaj enega, če želite pravilno uporabljati ta blok.';
...
$string['error_nogroupsexist'] = 'Trenutno je napaka tega bloka: nastavlje je naj prikazuje ocene po skupinah, a predmet nima določenih skupin.';
