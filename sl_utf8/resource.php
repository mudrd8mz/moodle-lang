<?PHP // $Id$ 
      // resource.php - created with Moodle 1.9.4+ (Build: 20090204) (2007101540)


$string['addresource'] = 'Dodaj vir...';
$string['affectedresources'] = 'Prizadeti viri';
$string['allowlocalfiles'] = 'Dovoli loka';
$string['autofilerename'] = 'Posodobi povezavo, če se datoteka preimenuje';
$string['back'] = 'Nazaj';
$string['blockdeletingfile'] = 'Prepreči brisanje datotek v rabi';
...
$string['clicktoopen'] = 'Če želite odpreti dokument, kliknite na to povezavo:';
...
$string['configautofilerenamesettings'] = 'Samodejno posodobi sklice na datoteke in mape ob preimenovanju v upravniku datotek.';
$string['configblockdeletingfilesettings'] = 'Prepreči izbris datotek in map, na katere se sklicujejo viri. Pazite na to, da slike in ostale datoteke, na katere se sklicuje HTML zapis, niso zaščitene.';
...
$string['forcedownload'] = 'Vsili prenos';
...
$string['keepnavigationvisible'] = 'Obdrži vidno navigacijo strani na isti strani';
$string['keepnavigationvisibleno'] = 'Ne';
$string['keepnavigationvisibleyesframe'] = 'Da, z okvirjem';
$string['keepnavigationvisibleyesobject'] = 'Da, brez okvirja';
...
$string['repository'] = 'Shramba IMS';
$string['resource:view'] = 'Ogled vira';
...
$string['viewims'] = 'Poglej paket vsebine IMS';
$string['vol'] = 'Glasnost';
$string['warningblockingdelete'] = 'Opozorilo: Dejanje brisanje preprečuje obstoječ vir. Bodisi najprej posodobite vir ali prosite skrbnika, naj onemogoči ta varnostni mehanizem v globalni konfiguraciji virov.';
$string['warningdisabledrename'] = 'Opozorilo: Samodejno preimenovanje sklicev na vire je onemogočeno. Če je potrebno, prosimo ročno popravite prizadete vire. Skrbniki lahko samodejno preimenovanje omogočijo v globalni konfiguraciji virov.';
$string['websearchdefault'] = 'Privzet spletni iskalnik';
