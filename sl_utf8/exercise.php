...
$string['numberofcriterionelements'] = 'Število elementov kriterija mora biti večje od ena.';
...
$string['pleasemakeyourownassessment'] = 'Prosimo, ovrednotite delo $a.<br />Vedite, da je obrazec za vrednotenje na začetku prikazan z udeleženčevim lastnim vrednotenjem.<br /> Spremenite vse, kar je potrebno in nato kliknite na enega<br />izmed gumbov na dnu strani.';
...
$string['resubmitnote'] = '* pomeni, da sme $a preklicati to oddajo. <br /> To oznako je možno dati vsaki oddaji z njenim ponovnim vrednotenjem in klikom <br /> na gumb <b>$a sme ponovno oddati</b>. <br />Udeleženec lahko ponovno odda, če je ta oznaka prisotna na <b>katerikoli</b> njegovi oddaji.';
...
$string['scaleexcellent7'] = '7 točkovna lestvica Izvrstno / Zelo slabo';
$string['scalegood3'] = '3 točkovna lestvica Dobro / Slabo';
$string['scalepresent'] = '2 točkovna lestvica Prisoten / Odsoten';
...
$string['thereisfeedbackfromthe'] = 'Obstaja odziv od $a';
$string['thisisaresubmission'] = 'To je ponovna oddaja od $a.<br />Prikazano je vaše vrednotenje predhodne oddaje. <br />Po pregledu nove oddaje, prosimo, popravite to vrednotenje<br /> in kliknite na enega izmed gumbov na dnu strani.';
$string['title'] = 'Naslov';
