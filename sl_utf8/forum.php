...
$string['aggregatenone'] = 'Brez';
$string['aggregatesum'] = 'Vsota ocen';
$string['aggregatetype'] = 'Način vrednotenja';
...
$string['allowsallsubscribe'] = 'Ta forum vsem omogoča svobodno izbiro (naročen/nenaročen)';
...
$string['cannotadddiscussionall'] = 'Nimate pravic za dodajanje novih razprav za vse udeležence.';
$string['cannotviewpostyet'] = 'Ne morete brati vprašanj ostalih udeležencev v tej razpravi, ker še niste ničesar objavili';
...
$string['configdisplaymode'] = 'Privzet način prikaza za razprave, če le-ta ni nastavljen.';
$string['configenablerssfeeds'] = 'To stikalo bo omogočilo možnost virov RSS pri vseh forumih. Še vedno pa boste morali vire RSS omogočiti ročno za vsak forum posebej.';
$string['configenabletimedposts'] = 'Če želite dovoliti nastavitev period prikaza pri objavljanju nove razprave v forumu, izberite \"da\" (ta možnost je še v fazi testiranja).';
$string['configlogblocked'] = 'Forumov cron lahko beleži blokirane poskuse pošiljanja elektronske pošte uporabnikom z onemogočenim naslovom.';
...
$string['configmaxbytes'] = 'Privzeta največja velikost vseh prilog na forumih na tej strani (odvisna je od omejitev predmeta in ostalih lokalnih nastavitev).';
...
$string['configshortpost'] = 'Vsaka objava, krajša od te vrednosti (v znakih brez HTML),Sledenje prebranih objav za ta forum je obravnavana kot kratka (glej spodaj).';
...
$string['discussionmovedpost'] = 'Ta razprava je bila premaknjena <a href=\"$a->discusshref\">semkaj</a> v forumu <a href=\"$a->forumhref\">$a->forumname</a>';
...
$string['forum:viewdiscussion'] = 'Prikaži razprave';
$string['forum:viewhiddentimedposts'] = 'Prikaži skrite tempirane objave';
...
$string['nodiscussionsstartedby'] = 'Ni razprav tega uporabnika';
...
$string['ratingtime'] = 'Omeji ocenjevanje na objave iz tega časovnega obdobja:';
$string['re'] = 'Odg:';
...
$string['trackingoptional'] = 'Izbirno';
...
$string['unsubscribealldone'] = 'Vsa naročila na forume so bila odstranjena. Morda boste še prejemali sporočila iz forumov z vsiljeno naročnino. Če ne želite prejemati nobene e-pošte s tega strežnika, onemogočite e-naslov v svojem profilu.';
$string['unsubscribeallempty'] = 'Žal, niste naročeni na noben forum. Če ne želite prejemati nobene e-pošte s tega strežnika, onemogočite e-naslov v svojem profilu.';
