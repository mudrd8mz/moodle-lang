<?PHP // $Id$ 
      // enrol_database.php - created with Moodle 1.9.3+ (Build: 20081112) (2007101531)
...
$string['category'] = 'Kategorija za avtomatsko generirane predmete';
...
$string['dbhost'] = 'Ime strežnika ali IP številka';
$string['dbname'] = 'Ime baze';
$string['dbpass'] = 'Geslo strežnika';
$string['dbtable'] = 'Tabela v bazi';
$string['dbtype'] = 'Tip baze';
$string['dbuser'] = 'Uporabnik strežnika';
$string['defaultcourseroleid'] = 'Vloga, ki bo dodeljena po privzetem, v kolikor ne bo izbrana nobena druga.';
$string['description'] = 'Za kontrolo nad vpisi lahko uporabljate (skoraj katerokoli) zunanjo podatkovno bazo. Privzema se, da vaša baza vsebuje polje z ID predmeta ter polje z ID uporabnika. Le-te se primerjajo s polji, ki jih izberete v lokalnih tabelah predmetov in uporabnikov.';
$string['disableunenrol'] = 'Če je nastavitev \"DA\", predhodno vpisani uporabniki (preko vtičnika zunanje podatkovne zbirke) ne bodo izpisani iz predmeta, ne glede na vsebino podatkovne zbirke.';
$string['enrol_database_autocreation_settings'] = 'Avtomatsko kreiranje novih predmetov';
$string['enrolname'] = 'Zunanja podatkovna baza';
$string['general_options'] = 'Splošne možnosti';
$string['host'] = 'Naslov strežnika podatkovne baze';
$string['ignorehiddencourse'] = 'Če je nastavitev \"DA\", uporabniki ne bodo vpisani v predmete, ki niso dostopni udeležencem.';
$string['local_fields_mapping'] = 'Polja podatkovne zbirke Moodle (lokalno)';
$string['localcoursefield'] = 'Ime polja v tabeli predmetov, ki ga uporabljamo za povezovanje z zapisi v (oddaljeni) podatkovni zbirki (npr. idnumber).';
$string['localrolefield'] = 'Ime polja v tabeli pravil, ki ga uporabljamo za povezovanje z zapisi v (oddaljeni) podatkovni zbirki (npr. shortname).';
$string['localuserfield'] = 'Ime polja v tabeli uporabnikov, ki ga uporabljamo za povezovanje z zapisi v (oddaljeni) podatkovni zbirki (npr. idnumber).';
$string['name'] = 'Izbrana podatkovna baza za uporabo';
$string['pass'] = 'Geslo za dostop do strežnika';
$string['remote_fields_mapping'] = 'Polja vpisa (oddaljene) podatkovne zbirke.';
$string['remotecoursefield'] = 'Ime polja v oddaljeni tabeli, ki ga uporabljamo za povezovanje z zapisi v tabeli predmetov.';
$string['remoterolefield'] = 'Ime polja v oddaljeni tabeli, ki ga uporabljamo za povezovanje z zapisi v tabeli pravil.';
$string['remoteuserfield'] = 'Ime polja v oddaljeni tabeli, ki ga uporabljamo za povezovanje z zapisi v tabeli uporabnikov.';
...
$string['type'] = 'Vrsta strežnika podatkovne baze';
