<?PHP // $Id$ 
      // auth_mnet.php - created with Moodle 1.9 + (Build: 20080402) (2007101509)
      // local modifications from http://193.2.123.15/moodle


$string['sso_idp_description'] = 'Aktiviraj to storitev, da bo uporabnikom omogočen dostop do strani $a Moodle brez ponovne prijave. <ul><li><em>Odvisnost</em>: Prav tako se moraš <strong>registrirati</strong> v SSO (Storitveni Ponudnik) storitev na $a.</li></ul><br />S to storitvijo omogoči avtenticiranim uporabnikom iz $a dostop do vaše strani, ne da bi se morali ponovno prijaviti.<ul><li><em>Odvisnost</em>:Prav tako moraš <strong>objaviti</strong> SSO (Storitveni Ponudnik) storitev $a.</li></ul><br />';
...
$string['sso_sp_name'] = 'SSO (Storitveni Ponudnik)';
