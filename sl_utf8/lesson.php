<?PHP // $Id$ 
      // lesson.php - created with Moodle 1.9.3+ (Build: 20081112) (2007101531)
...
$string['attemptsdeleted'] = 'Zbrisani poskusi';
...
$string['canretake'] = '$a lahko lekcijo ponovi';
...
$string['flowcontrol'] = 'Nadzor poteka lekcije';
...
$string['handlingofretakes'] = 'Obravnava ponovitve';
$string['havenotgradedyet'] = 'Še niso ocenjeni.';
$string['here'] = 'tukaj';
...
$string['importppt'] = 'Uvozi predstavitev';
...
$string['lessonattempted'] = 'Povzeta lekcija';
$string['lessonclosed'] = 'Ta lekcija zaprta dne $a.';
$string['lessoncloses'] = 'Lekcija se zapre';
$string['lessoncloseson'] = 'Lekcija se zapre na $a';
...
$string['mediaclose'] = 'Prikaži gumb Zapri okno:';
$string['mediafile'] = 'Pojavno v datoteko ali spletno stran';
$string['mediafilepopup'] = 'Kliknite tukaj za ogled večpredstavnostne datoteke te lekcije';
$string['mediaheight'] = 'Višina okna:';
$string['mediawidth'] = 'Širina okna:';
...
$string['noessayquestionsfound'] = 'V tej lekciji ni najdenih vprašanj tipa Esej.';
...
$string['numberofpagesviewednotice'] = 'Število odgovorjenih vprašanj:$a->nquestions;Odgovorite vsaj na:a->minquestions)';
...
$string['other'] = 'Ostale nastavitve';
...
$string['response'] = 'Povratna informacija za odgovor';
...
$string['teacherjumpwarning'] = 'V tej lekciji je uporabljen skok na $a->cluster ali $a->unseen. Za vas bo uporabljen skok na na naslednjo stran.<br> Prijavite se kot udeleženec za preizkus teh skokov.';
$string['teacherongoingwarning'] = 'Trenutni rezultat je prikazan samo udeležencem. Prijavite se kot udeleženec če želite videti trenutni rezultat.';
...
$string['usemaximum'] = 'Uporabi najboljšo oceno';
