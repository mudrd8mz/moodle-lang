<?PHP // $Id$ 
      // wiki.php - created with Moodle 1.9.4+ (Build: 20090204) (2007101540)
...
$string['downloadtimes'] = 'Preneseno $a-krat';
...
$string['lockcancelled'] = 'Vaša zapora urejanja je bila preklicana. Nekdo drug trenutno ureja to stran. Če želite shraniti svoje spremembe, jih označite in kopirajte v odložišče, preden kliknete Prekliči. Potem ponovno poskusite urejati stran.';
...
$string['nojslockwarning'] = 'Ker imate v brskalniku onemogočen Javascript, obstaja možnost, da bo nekdo drug urejal to stran. Če se to zgodi, ne boste mogli shraniti sprememb. Poskušajte spremembe hitro narediti ali vklopiti Javascript in ponovno naložiti to stran.';
...
$string['overridebutton'] = 'Preklic zapore';
$string['overrideinfo'] = 'Lahko prekličete zaporo urejanja tega uporabnika, vendar pa to lahko pomeni izgubo podatkov za tega uporabnika! Prosimo, postopajte pazljivo.';
...
$string['pagelocked'] = '<p><strong>To stran trenutno ureja $a->name.</strong> Oseba je urejanje pričela ob $a->since in ima okno še vedno odprto ob $a->seen.</p><p>Pred urejanjem te strani boste morali počakati, da oseba zaključi svoje delo na strani.</p>';
...
$string['reloadlinkdescription'] = 'Ponovno naloži stran, tako da se prikaže nova vsebina.';
...
$string['save'] = 'Shrani';
$string['savenolock'] = 'Strani ni moč shraniti, ker nimate zapore urejanja. To se lahko zgodi, če vaš brskalnik ne podpira ali ima onemogočen JavaScript, ali pa v primeru, da drug uporabnik prekliče vašo zaporo urejanja.<br/><br/>Na prejšnji zaslon se lahko vrnete z gumbom Back. Nato kopirajte spremembe, ki ste jih naredili, in ponovno poskusite urejati stran.';
...
$string['wiki:manage'] = 'Upravljanje wiki nastavitev';
$string['wiki:overridelock'] = 'Preklic zapore urejanja';
$string['wiki:participate'] = 'Urejanje wiki strani';
