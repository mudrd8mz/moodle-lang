...
$string['noguestchoose'] = 'Oprostite, gosti ne smejo odgovarjati na vprašanja';
$string['noresultsviewable'] = 'Rezultati trenutno niso na vpogled';
$string['notanswered'] = 'Še ni odgovorjeno';
$string['notopenyet'] = 'Žal ta dejavnost ni na voljo do $a';
$string['privacy'] = 'Zasebnost rezultatov';
$string['publish'] = 'Objavi rezultate';
$string['publishafteranswer'] = 'Pokaži rezultate udeležencem, ko oddajo svoj odgovor';
...
$string['removemychoice'] = 'Odstrani moje odgovore';
$string['removeresponses'] = 'Odstrani vse odgovore';
