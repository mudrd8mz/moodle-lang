<?PHP // $Id$ 
      // lesson.php - created with Moodle 1.9.5+ (Build: 20091014) (2007101553)
...
$string['outoftime'] = 'przekroczony czas'; // ORPHANED
$string['studentoutoftime'] = 'Uwaga: Czas lekcji minął. Ostatnia odpowiedź nie została zaliczona, ponieważ została przesłana po czasie. Kliknij przycisk żeby przejść do lekcji.'; // ORPHANED
