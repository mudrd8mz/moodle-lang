...
$string['deleteattempts'] = 'Usuń próby tego studenta (wprowadź id użytkownika)';
...
$string['movingtonextpage'] = 'Do następnej strony';
...
$string['viewallpages'] = 'Pokaż wszystkie strony';
$string['viewgrades'] = 'Pokaż oceny';
$string['viewhighscores'] = 'Pokaż listę najwyżej ocenionych';
$string['viewlessonstats'] = 'Pokaż statystykę lekcji ($a->users $a->usersname)';
