<?PHP // $Id$ 
      // auth.php - created with Moodle 1.9.5+ (Build: 20091014) (2007101553)
...
$string['auth_fchost_key'] = 'Serwer';
$string['auth_fcpasswd'] = 'Hasło do powyższego konta.';
...
$string['auth_ldap_graceattr_desc'] = 'Opcjonalnie: Unieważnij atrybut gracelogin (jak często użytkownik może odmawiać zmiany wygasłego hasła)';
...
$string['auth_nologintitle'] = 'Brak loginu';
