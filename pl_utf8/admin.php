...
$string['cfgwwwrootslashwarning'] = 'Zdefiniowałeś &#36;CFG->wwwroot niewłaściwie w pliku config.php. Wstawiłeś znak \'/\' na końcu. Usuń ten znak, albo doświadczysz dziwnych zachowań jak <a href=\'http://tracker.moodle.org/browse/MDL-11061\'>MDL-11061</a>.';
$string['cfgwwwrootwarning'] = 'Zdefiniowałeś &#36;CFG->wwwroot niewłaściwie w pliku config.php. Adres URL nie pasuje z tym którego używasz aby otworzyć tą stronę. Popraw ustawienia, albo doświadczysz dziwnych zachowań jak <a href=\'http://tracker.moodle.org/browse/MDL-11061\'>MDL-11061</a>.';
...
$string['configallowcoursethemes'] = 'Jeśli włączysz tą opcję, użytkownicy będą mieli możliwość użycia swoich własnych kompozycji. Kompozycje kursu nadpisują wszystkie inne wybrane kompozycje (strony, użytkownika, sesji)';
$string['configallowemailaddresses'] = 'Jeśli chcesz dopuścić adresy email tylko z pewnych domen, dodaj te domeny do listy, oddzielając je spacją. Wszystkie inne domeny nie znajdujące się na liście zostaną odrzucone. Aby dodać subdomenę, rozpocznij ją od znaku \'.\', np. <strong>ourcollege.edu.au .gov.au</strong>';
...
$string['configcoursemanager'] = 'To ustawienie pozwala na kontrolowanie kto jest wyświetlany w opisie kursu.';
...
$string['configerrorlevel'] = 'Wybierz ile ostrzeżeń PHP ma być wyświetlanych. Zazwyczaj najlepszy w tym miejscu wybór to \'Normal\'.';
...
$string['configiplookup'] = 'Po kliknięciu na adres IP (taki jak 34.12.222.93), taki jak w dzienniku zdarzeń, zostaje pokazana mapa z miejscem, gdzie prawdopodobnie znajduje się adres IP. Istnieją różne pluginy z których można wybierać, każdy z nich ma swoje zalety i wady.';
...
$string['configlongtimenosee'] = 'Jeśli studenci nie logują się do kursu przez długi czas, zostaną automatycznie wypisani z kursów. Ten parametr określa limit czasu nieobecności po którym następuje automatyczne wypisanie.';
$string['configlookahead'] = 'Wyświetl naprzód do .. dni';
...
$string['configminpassworddigits'] = 'Hasło musi zawierać co najmniej tyle cyfr.';
$string['configminpasswordlength'] = 'Hasło musi być co najmniej tak długie.';
$string['configminpasswordlower'] = 'Hasło musi zawierać co najmniej tyle małych liter.';
$string['configminpasswordnonalphanum'] = 'Hasło musi zawierać co najmniej tyle znaków nie znajdujących się w alfabecie.';
$string['configminpasswordupper'] = 'Hasło musi zawierać co najmniej tyle wielkich liter.';
...
$string['configsendcoursewelcomemessage'] = 'Jeśli włączysz, użytkownicy będą otrzymywali powitania przez email w momencie samodzielnego zapisania się do kursu.';
...
$string['cronwarning'] = 'Skrypt <a href=\"cron.php\">cron.php</a> nie był uruchamiany od conajmniej 24 godzin.';
...
$string['helpforcetimezone'] = 'Możesz pozwolić użytkownikom na indywidualny wybór strefy czasowej, lub wymusić strefę czasową dla wszystkich.';
...
$string['lang16notify'] = 'Moodle 1.6 i nowsze wersje pozwalają na instalowanie i uaktualnianie pakietów językowych bezpośrednio z download.moodle.org przy pomocy poniższego linku';
...
$string['maxeditingtime'] = 'Maksymalny czas edycji postów';
...
$string['nonmetacoursesyncroleids'] = 'Role które nie są synchronizowane z metakrusem';
...
$string['pleaserefreshregistration'] = 'Twoja strona została zarejestrowana na moodle.org. Rozważ uaktualnienie danych rejestracyjnych jeśli zostały dokonane jakieś znaczące zmiany od ostatniej rejestracji dla $a';
$string['pleaseregister'] = 'Zarejestruj swoją stronę aby usunąć ten przycisk';
...
$string['profilecommonsettings'] = 'Ustawienia podstawowe';
...
$string['remotelangnotavailable'] = 'Moodle nie może połączyć się z download.moodle.org i niemożna automatycznie zainstalować paczki językowej. Pobierz właściwy plik zip pakietu językowego, skopiuj do katalogi $a i rozpakuj go ręcznie.';
...
$string['restrictbydefault'] = 'Standardowo ogranicz moduły';
...
$string['statscatdepth'] = 'Maksymalnie nadrzędnych kategorii';
...
$string['upgradeforumread'] = 'Nowa funkcjonalność została dodana w Moodle 1.5 aby śledzić przeczytane/nieprzeczytane wątki na forum. <br /> Aby użyć tej funkcji musisz <a href=\"$a\">uaktualnić tabele w bazie danych</a>.';
