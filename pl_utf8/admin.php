...
$string['allowcategorythemes'] = 'Zezwól na kompozycję kategorii';
$string['allowdeletes'] = 'Zezwól na usówanie';
$string['allowvisiblecoursesinhiddencategories'] = 'Zezwalaj na widoczność kursów w ukrytych kategoriach';
$string['authsettings'] = 'Zarządzaj autoryzacją';
$string['autolang'] = 'Autowykrywanie języka';
...
$string['commonsettings'] = 'Pospolite ustawienia';
$string['configallowcategorythemes'] = 'Jeśli włączysz tą opcję, będziesz mógł ustawić kompozycje dla kategorii. Ustawienie to będzie miało wpływ na wszystkie podrzędne kategorie. OSTRZERZENIE: Włączenie kompozycji dla kategorii może mieć wpływ na wydajność.';
...
$string['configallowusermailcharset'] = 'Włanczając tą opcję zezwolisz użytkownikom na wybór własnej strony kodowej dla email-i';
...
$string['configwarning'] = 'Bądź ostrożny zmieniając te ustawienia - błędne wartości mogą powodować probelmy.';
...
$string['profiledeletecategory'] = 'Usówanie kategorii';
$string['profiledeletefield'] = 'Usówanie pola';
...
$string['smtpmaxbulk'] = 'SMTP limit sesji';
