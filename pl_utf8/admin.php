...
$string['configenrolmentplugins'] = 'Wybierz wtyczki zapisu na zajęcia, których chcesz używać. Nie zapomnij skonfigurować odpowiednich ustawień. Musisz ustawić które wtyczni są uruchomione <strong>to</strong> wtyczka będzie ustawiona jako domyślna dla interaktywnych zapisów.
Żeby wyłączyć te interaktywne zapisywanie sie ustaw pole na \"nie\" w odpowiednim kursie.';
...
$string['configpathtoclam'] = 'To jest ścieżka  do clam AV. Prawdopodobnie coś jak /usr/bin/clamscan lub /usr/bin/clamdscan. Potrzebujesz tego żeby clam AV działało.';
$string['configpathtodu'] = 'To jest ścieżka do du. Prawdopodobnie coś jak /usr/bin/du. Jeśli to wpiszesz, strony które wyświetlają zawartość katalogów będą chodzić znacznie szybciej dla katalogów z dużą ilością plików';
$string['configperfdebug'] = 'Jeśli włączysz to, informacje o działaniu programu będą wyświetlane w stopce w standardowym temacie.';
...
$string['dbmigratewarning2'] = '<b>Ostrzeżenie: Rozpoczniesz procesz przenoszenia bazy danych. Prosze sie dwukrotnie upewnić że cała baza danych jest zapisana.';
...
$string['filtermatchoneperpage'] = 'filtrować jeden raz na stronę';
$string['filtermatchonepertext'] = 'filtrować jeden raz na tekst';
...
$string['helpupcominglookahead'] = 'Na ile dni w przyszłość jest ustawiony kalendarz?';
...
$string['install'] = 'Instaluj wybrany pakiet językowy';
$string['installedlangs'] = 'Zainstalowano wybrane pakiety językowe';
$string['invaliduserchangeme'] = 'Nazwa użytkownika \"changeme\" jest zarezerwowana - nie możesz utworzyć takiego konta';
$string['lang16notify'] = 'Moodle 1.6 i wersje wyższe umożliwiają instalacje i uaktualnianie pakietów jezykowych bezpośrednio z download.moodle.org poprzez kliknięcie w poniższy link';
$string['langimport'] = 'Importuj narzędzia językowe';
$string['langimportsuccess'] = 'Pakiet językowy został poprawnie zaktualizowany';
$string['langpackremoved'] = 'Pakiet językowy odinstalowano';
$string['langpackupdated'] = 'Pakiet językowy $a zaostał poprawnie zainstalowany';
$string['langupdatecomplete'] = 'Pobieranie pakiety językowego zakończono';
$string['latexpreamble'] = 'LaTeX wstęp';
$string['latexsettings'] = 'LaTeX Parametry';
$string['maintfileopenerror'] = 'Bład otwarcia plików konserwacji';
...
$string['mediapluginmpg'] = 'Włącz filtr .mpg';
$string['mediapluginram'] = 'Włącz filtr .ram';
...
$string['nolangupdateneeded'] = 'Twój pakiet językowy jest aktualny i nie potrzeba żadnego uaktualnienia';
...
$string['renameerrors'] = 'Błędy w nowych nazwach';
$string['sitelangchanged'] = 'Ustawienie językowe zostało porawnie zmienione';
...
$string['sitemaintenanceoff'] = 'Trym konserwacji został wyłączony, strona działa w normalny trybie.';
...
$string['stickyblocks'] = 'Defioniowalne bloki';
...
$string['stickyblockspagetype'] = 'Wybór konfiguracji';
...
$string['unicodeupgradenotice'] = 'W Moodle 1.6 wszystkie języki zostały przeniesione do Unicode. Aby zakończyć uaktualnianie swojej wersji musisz zmienić wszystkie dane w swojej bazie na unicode, używając naszego skryptu konwersji. a href=\"utfdbmigrate.php\">Kliknij aby uruchomić skrypt teraz</a>!';
$string['uninstall'] = 'Odinstaluj pakiet językowy';
$string['uninstallconfirm'] = 'Zamierzasz usunąć pakiet językowy czy jesteś pewien?';
$string['updateaccounts'] = 'Uaktualnij istniejące konto';
$string['updatecomponent'] = 'Uaktualnij komponent';
$string['updatelangs'] = 'Uaktualnij wszystkie lokalne pakiety językowe';
