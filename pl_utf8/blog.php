...
$string['blockmenutitle'] = 'Menu bloga';
$string['blocktagstitle'] = 'Tagi bloga';
...
$string['addotags'] = 'Dodaj oficjalne znaczniki'; // ORPHANED
$string['addptags'] = 'Dodaj znaczniki definiowane przez użytkownika'; // ORPHANED
$string['otags'] = 'Oficialne znaczniki'; // ORPHANED
$string['ptags'] = 'Znaczniki definiowane przez użytkownika'; // ORPHANED
