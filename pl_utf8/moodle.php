...
$string['backupmetacoursehelp'] = 'Jeśli włączone, informacje o kursie nadrzędnym \"metakursie\" (odziedziczone uczestnictwa) będą zawarte w automatycznych kopiach zapasowych';
...
$string['healthcenter'] = 'Centrum Bezpieczeństwa';
...
$string['liketologin'] = 'Czy chcesz się zalogować z pełnymi prawami użytkownika?';
$string['list'] = 'Lista';
...
$string['loginaspasswordexplain'] = '<p>Wprowadź specjalny \"loginas password\", aby uzyskać dostęp do tego ustawienia.<br/>';
