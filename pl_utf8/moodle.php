...
$string['addnousersrecip'] = 'dodaj użytkowników, którzy nie uzyskali dostępu to tego $a dostępu do listy odbiorców';
...
$string['adminhelpenvironment'] = 'sprawdź jak Twój serwer odpowiada wymaganiom bieżącej i przyszłej instalacji';
...
$string['adminhelpmymoodle'] = 'konfiguruj bloki moodle dla użytkowników';
...
$string['adminhelpstickyblocks'] = 'Skonfiguruj kłopotliwe bloki Moodle';
...
$string['all'] = 'Wszyscy';
$string['allactions'] = 'Wszystkie składowe';
...
$string['allownone'] = 'Nie pozwalaj nikomu';
...
$string['backupnonisowarning'] = 'Uwaga: Ta kopia pochodzi z innej niż Unicode wersji Moodle (przed 1.6). Jeżeli kopia zawiera jakieś teksty o innym kodowaniu niż ISO-8859-...
mogą one zostać USZKODZONE podczas próby odtwarzania ich w obecnej Unicode wersji Moodle. Zobacz <a href=\"http://docs.moodle.org/en/Backup_FAQ\">Backup FAQ</a>  dla uzyskania więksej ilości informacji o odtwarzaniu poprwnym dla tej wersji.';
...
$string['country'] = 'Kraj';
$string['course'] = 'Kurs';
$string['courseapprovedemail'] = 'Twój wybrany kurs $a-> został zatwierdzony a Ty zostałeś $a-> prowadzącym. Aby uzyskać dostęp do Twojego nowego kursu idź do $a->url\";';
...
$string['courseimportnotaught'] = 'ie stwierdzono, abyś był nauczycielem z możliwością edytowania w jakimkolwiek kursie, brak kursów z których możesz importować.';
...
$string['coursereject'] = 'Odrzucenie wybranego kursu.';
$string['courserejected'] = 'Kurs został odrzucony a wnioskodawca został zanotowany.';
$string['courserejectemail'] = 'Przepraszam, lecz kurs który wybrałeś został odrzucony. Przyczyną jest następujący powód:

$a;';
$string['courserejectreason'] = 'ytłumaczenie powodów dla których zostałeś odrzucony z kursu <br /> (zostanie to wysłane e-mail’em do wnioskodawcy).';
$string['courserejectsubject'] = 'Twój kurs został odrzucony.';
$string['courserequest'] = 'Zapytanie kursu';
$string['courserequestdisabled'] = 'Przepraszam, lecz wybrane kursy zostały zablokowane przez administratora.';
$string['courserequestfailed'] = 'Z jakichś powodów, twoja prośba dotycząca kursu nie została zapisana.';
$string['courserequestintro'] = 'Użyj tej formy w celu stworzenia kursu dla ciebie. <br />Spróbuj zawrzeć tak wiele informacji, jak to tylko możliwe w celu <br />zrozumienia przez administratorów twoich powodów stworzenia tego kursu.';
$string['courserequestreason'] = 'Powody przemawiające za tym kursem.';
$string['courserequestsuccess'] = 'Twoja prośba dotycząca kursu została zapisana pomyślnie. W przeciągu kilku dni oczekuj e-mail’a z wynikami.';
...
$string['currentlyselectedusers'] = 'ktualnie wybrani użytkownicy.';
...
$string['deselectall'] = 'Odznacz wszystko';
...
$string['enrolenddaterror'] = 'Zgłoszenie i dane nie mogą być wcześniejsze niż data startu';
...
$string['enrolmentplugins'] = 'Rejestrownanie wtyczek';
...
$string['expirynotify'] = 'Zgłoszenie o wygaśnięciu notatek.';
...
$string['extendperiod'] = 'Rozszerz okres';
...
$string['formatlams'] = 'Dorma kursu LAMS';
...
$string['formatweekscss'] = 'Co tygodniowy format -CSS/bez tablic';
$string['formatwiki'] = 'Format wiki';
$string['from'] = 'Od';
$string['frontpagecategorycombo'] = 'List wyboru';
...
$string['importactivities'] = 'Import skałdowych z innego kursu';
...
$string['instudentview'] = 'w widoku studenta';
...
$string['missingreqreason'] = 'Przyczyna zagubienia';
...
$string['newpasswordfromlost'] = '<strong>NOTICE:</strong> Twój <strong>Current Password</strong> zostanie wysłany do Ciebie w dwóch 
e-mail’ach wysłanych jako część procesy odzyskiwania straconego hasła. Upewnij się, że otrzymałeś nowe hasło przed rozpoczęciem kontynuacji na tym ekranie.';
...
$string['none'] = 'Żaden';
$string['nopendingcourses'] = 'Brak dostępnych kursów oczekujących.';
...
$string['norecentactivity'] = 'Nie było aktywności';
...
$string['nostatstodisplay'] = 'rzykro nam, lecz brak dostępnych danych możliwych do wyświetlenia.';
...
$string['passwordextlink'] = 'Ten link służy do odzyskiwania straconego hasła. Oznacza to wyjście z Moodle.';
$string['passwordforgotten'] = 'Zapomniane hasło';
$string['passwordforgotteninstructions'] = 'Twoje dane charakterystyczne muszą być najpierw znalezione w bazie danych użytkowników. Proszę wprowadzić swoją nazwę użytkownika w Moodle  <strong>albo</strong> zarejestrowany adres e-mail w odpowiednią pole. Nie ma konieczności wprowadzania obu.';
...
$string['people'] = 'Osoby';
$string['periodending'] = 'Koniez okresu';
...
$string['preferences'] = 'Ustawieenia';
...
$string['requestreason'] = 'Powód złożenia wniosku na kurs.';
...
$string['resetinfo'] = 'Ta strona pozwala Ci wyczyścić kurs z danych użytkowników z zachowaniem składowych kursu i innych ustawień. Uwaga - po wybraniu i zatwierdzeniu tej strony nie ma możliwości odzyskania danych użytkowników.';
...
$string['starpending'] = '([*] = Zgoda na kurs oczekujący)';
...
$string['statsnodatauser'] = 'rak możliwości stworzenia takiej kombinacji kursu, użytkownika i przedziału czasowego.';
...
$string['usemessageform'] = 'Lub użyj poniższą formę w celu wysłania wiadomości do zaznaczonych uczniów.';
...
$string['usernameemailmatch'] = 'Nazwa użytkownika i adres e-mail’owy nie pasują do tego samego użytkownika.';
...
$string['usersnoaccesssince'] = 'okaż użytkowników którzy nie byli aktywnie przez więcej niż.';
