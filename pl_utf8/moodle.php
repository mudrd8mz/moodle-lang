...
$string['backupschedulehelp'] = 'Określ, w jakie dni tygodnia mają być tworzone automatyczne kopie zapasowe';
...
$string['courserejectemail'] = 'Przepraszamy, ale kurs, na który złożyłeś zamówienie, został odrzucony z powodu 

$a;';
$string['courserejectreason'] = 'Wytłumaczenie powodów, dla których twoje zamówienie zostało odrzucone<br />(kopia zostanie wysłana e-mailem do wnioskodawcy).';
...
$string['emaildisable'] = 'Ten email jest dezaktywowany';
...
$string['enrolmentplugins'] = 'Rejestrowanie wtyczek';
