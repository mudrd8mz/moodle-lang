<?PHP // $Id$ 
      // journal.php - created with Moodle 1.9 Beta 3 (2007101505)
...
$string['journalmail'] = '$a->teacher umieścił komentarz na temat twojego wpisu do dziennika \'$a->journal\' 

Możesz go zobaczyć przy Twoim wpisie pod adresem : $a->url';
$string['journalmailhtml'] = '$a->teacher umieścił komentarz na temat twojego wpisu do dziennika \'<i>$a->journal</i>\'<br /><br /> Możesz go zobaczyć przy Twoim wpisie  <a href=\"$a->url\"> do dziennika</a>.';
