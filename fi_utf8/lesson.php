...
$string['dependencyon'] = 'Riippuvuus';
...
$string['displayleftif'] = 'vain jos $a-käyttäjän arvosana on korkeampi kuin:';
...
$string['displayscorewithessays'] = 'Sait automaattisesti arvostelluista kysymyksistä yhteensä $a->score / $a->tempmaxgrade oikein.<br /> Vastaamistasi esseekysymyksistä $a->essayquestions arvioidaan ja sen pistemäärä lisätään<br/> lopulliseen tulokseesi myöhemmin.<br /> <br />Tämänhetkinen tuloksesi ilman esseekysymyksiä on $a->score / $a->grade.';
...
$string['full'] = 'Yksityiskohtainen näkymä';
$string['general'] = 'Yleistä';
$string['grade'] = 'Arvosana';
$string['gradebetterthan'] = 'Arvosana korkeampi kuin (%%)';
...
$string['manualgrading'] = 'Arvostele esseetehtäviä';
...
$string['maximumnumberofattemptsreached'] = 'Vastausyritysten maksimimäärä tuli täyteen. Siirrytään seuraavaan sivuun.';
$string['maxtime'] = 'Aikaraja (minuuteissa)';
$string['maxtimewarning'] = 'Sinulla on $a minuutti(a) viimeistellä oppitunti.';
$string['mediaclose'] = 'Näytä sulkemispainike';
$string['mediafile'] = 'Ponnahdusikkuna tiedostoon tai websivuun';
...
$string['noessayquestionsfound'] = 'Ei essee kysymyksiä tässä tehtävässä.';
$string['nohighscores'] = 'Ei parhaita tuloksia';
$string['nolessonattempts'] = 'Tälle oppitunnille ei ole yrityksiä';
...
$string['timespentminutes'] = 'Käytetty aika (minuuttia)';
$string['timetaken'] = 'Aikaa kulunut';
$string['topscorestitle'] = 'Parhaat $a tulosta oppitunnilla.';
