...
$string['addsomecontactsincoming'] = 'Nämä viestit ovat henkilöiltä, jotka eivät ole kontaktilistallasi. Lisätäksesi heidät kontakteihin klikkaa \"Lisää kontakti\" -ikonia nimen perässä.';
$string['ago'] = '$a sitten';
...
$string['noframesjs'] = 'Ilman kehyksiä ja javascriptiä';
