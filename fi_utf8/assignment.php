...
$string['alreadygraded'] = 'Tehtävän palautuksesi on jo arvioitu, eikä uudelleenpalautus ole sallittu.';
...
$string['cannotdeletefiles'] = 'Virhe: Tiedostoja ei voitu poistaa';
...
$string['finalizeerror'] = 'Virhe: Tehtävän lopullinen palautus ei onnistunut';
...
$string['nomoresubmissions'] = 'Palautuksia ei enää sallita.';
...
$string['unfinalizeerror'] = 'Virhe: Tehtävän palautusta ei voitu merkitä luonnokseksi';
