...
$string['guestnosubmit'] = 'Vieraat eivät voi palauttaa tehtäviä. Sinun pitää kirjautua tunnuksellasi ennen kuin voit tehdä tämän';
$string['guestnoupload'] = 'Valitan, vieraat eivät saa lähettää tiedostoja palvelimelle';
$string['helpoffline'] = '<p>Tehtävä suoritetaan Moodlen ulkopuolella. Kyseessä saattaa olla esim. tehtävä jossain muualla verkossa, esitelmä tai tapaaminen.</p>

<p>Opiskelijat voivat nähdä tehtävän kuvauksen, mutta eivät voi palauttaa tiedostoja tai muutakaan. Arviointi tapahtuu normaalisti ja opiskelijat saavat ilmoituksen arvosanoistaan.</p>';
...
$string['onceassignmentsent'] = 'Kun tehtävä on palautettu arvioitavaksi, et voi enää poistaa tai lisätä tiedostoja.';
...
$string['submitformarking'] = 'Palauta tehtävä arvioitavaksi';
