...
$string['delay1'] = 'Aikaväli ensimmäisen ja toisen yrityksen välillä';
$string['delay2'] = 'Aikaväli myöhäisempien yritysten välillä';
...
$string['shownoattemptsonly'] = 'Näytä vain oppilaat, loilla ei ole yrityksiä';
