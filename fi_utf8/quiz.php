...
$string['addingcalculated'] = 'Lisätään lasku-tyypin kysymys';
$string['addingdescription'] = 'Lisätään kuvaus';
$string['addingessay'] = 'Lisätään essee';
$string['addingmatch'] = 'Lisätään Yhteensopivat vastaukset -kysymys';
...
$string['attemptsdeleted'] = 'Palautetut yritykset poistettu';
...
$string['confirmstartattemptlimit'] = 'Tentin yrityskerrat on rajoitettu, sallittujen yrityskertojen lukumäärä on $a. Olet aloittamassa uutta yritystä. Haluatko jatkaa?';
$string['confirmstartattempttimelimit'] = 'Tentissä on aikaraja ja sallittujen yrityskertojen lukumäärä on $a. Olet aloittamassa uutta yritystä. Haluatko jatkaa?';
$string['confirmstarttimelimit'] = 'Tentissä on aikaraja. Oletko varma, että haluat aloittaa?';
...
$string['continuepreview'] = 'Jatka viimeisintä yrityksen esikatselua';
...
$string['decimaldigits'] = 'Kuinka monen desimaalin tarkkuudella arvosanat näytetään';
...
$string['finishreview'] = 'Sulje katselu';
...
$string['gradeboundary'] = 'Arvosanaraja';
...
$string['importmaxerror'] = 'Kysymyksessä on virhe. Vastauksia on liikaa.';
...
$string['matchgrades'] = 'Arvosanojen yhteensovittaminen';
$string['matchgradeserror'] = 'Merkitse virheeksi, jos arvosanaa ei löydy listalta';
$string['matchgradesnearest'] = 'Valitse lähinnä oleva arvo, jos arvosanaa ei löydy listalta';
$string['max'] = 'Max';
$string['min'] = 'Min';
...
$string['noessayquestionsfound'] = 'Manuaalisesti arvioitavia kysymyksiä ei löytynyt.';
...
$string['noquestionsinfile'] = 'Tuontitiedostossa ei ole kysymyksiä.';
...
$string['numattempts'] = 'Kurssin $a->studentstring-jäsenistä $a->studentnum on tehnyt $a->attemptnum yritystä';
$string['numerical'] = 'Numeerinen';
$string['onlyteachersexport'] = 'Vain opettajat voivat viedä kysymyksiä.';
$string['onlyteachersimport'] = 'Vain opettajat, joilla on muokkausoikeus, voivat tuoda kysymyksiä.';
$string['optional'] = 'valinnainen';
$string['outof'] = '$a->grade pistettä, täydet pisteet $a->maxgrade';
$string['outofpercent'] = '$a->grade pistettä, täydet pisteet $a->maxgrade ($a->percent%%%%)';
$string['outofshort'] = '$a->grade/$a->maxgrade';
$string['overallfeedback'] = 'Kokonaisuuden palaute';
...
$string['previewquiznow'] = 'Näytä tentin esikatselu';
...
$string['questiondeleted'] = 'Tämä kysymys on poistettu.';
...
$string['summaryofattempts'] = 'Aikaisempien yritystesi yhteenveto';
$string['temporaryblocked'] = 'Et voi vielä yrittää tenttiä uudelleen.<br />Voit yrittää uudelleen';
$string['time'] = 'Aika';
$string['timecompleted'] = 'Suoritettu';
$string['timedelay'] = 'Et voi yrittää tenttiä uudelleen, yrityskertojen välille määritelty aika ei ole vielä täyttynyt';
$string['timeleft'] = 'Aikaa jäljellä';
$string['timelimit'] = 'Aikaraja';
$string['timelimitexeeded'] = 'Aikaraja umpeutui!';
$string['timelimitmin'] = 'Aikaraja (minuuteissa)';
