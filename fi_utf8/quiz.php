...
$string['answerhowmany'] = 'Yksi vai useampia vastauksia?';
...
$string['reordertool'] = 'Näytä uudelleenjärjestelytyökalu';
...
$string['reviewoptionsheading'] = 'Tarkastelun optiot';
...
$string['shownoattemptsonly'] = 'Näytä vain opiskelijat, joilla ei ole yrityksiä';
$string['showquestiontext'] = 'Näytä kysymysteksti kysymysluettelossa';
...
$string['temporaryblocked'] = 'Uusi yritys on sallittu vasta:';
$string['time'] = 'Aika';
$string['timecompleted'] = 'Suoritettu';
$string['timedelay'] = 'Voit tehdä tentin vasta kun aikaraja yrityskertojen välillä on umpeutunut.';
$string['timeleft'] = 'Aikaa jäljellä';
$string['timelimit'] = 'Aikaraja';
$string['timelimitexeeded'] = 'Aikarajoitus umpeutui!';
