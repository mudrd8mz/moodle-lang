...
$string['addnousersrecip'] = 'Lisää koyttäjät jotka eivät ole käsitelleet tätä $a vastaanottajiksi.';
...
$string['enrolenddaterror'] = 'Rekisteröitymisjakson loopumisaika ei voi olla ennen alkamisaikaa';
$string['enrollable'] = 'Kurssille rekistöröityminen';
...
$string['expirythreshold'] = 'Rajaarvo';
...
$string['import'] = 'Tuo';
$string['importactivities'] = 'Tuo aktiviteeteja toiselta kurssilta';
...
$string['loginaspasswordexplain'] = '<p>Sinun antaa erityinen \"Kirjaannu toisena salasana\".<br />Ellet tiedä sitä, kysy ohjeita järjestelmän ylläpitäjältä..</p>';
...
$string['messageselect'] = 'Valitse tämä kayttäjä vastaanottajaksi';
...
$string['notenrollable'] = 'Kursille ei voi rekisteröityä tällä hetkellä';
...
$string['restrictmodules'] = 'Rajaa aktiviteetti moduleita?';
...
$string['statslogins'] = 'Kirjaantumiset';
$string['statsmodedetailed'] = 'Tarkennettu (kayttäjän) näkymä';
$string['statsmodegeneral'] = 'Yleisnäkymä';
$string['statsnodata'] = 'Ei tietoja valitulle kursille ja ajanjaksolle.';
$string['statsnodatauser'] = 'Ei tietoja valitulle kurssin, käyttäjän ja ajanjakson yhdistelmälle.';
$string['statsoff'] = 'Tilastot eivät ole tällähetkellä käytössä';
$string['statsreport1'] = 'Kirjaantumiset';
$string['statsreport10'] = 'Käyttäjäaktivitetti';
...
$string['statsreport5'] = 'Kaikki opiskejoiden aktiivisuus (lataukset ja viestit)';
