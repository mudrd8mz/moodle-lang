...
$string['backupincludemoduleshelp'] = 'Valitse, haluatko sisällyttää kurssimodulit, käyttäjätietojen kanssa tai ilman, automaattiseen varmuuskopiointiin';
...
$string['backupnoneusersinfo'] = 'Huomaa: Et ole valinnut käyttäjiä varmuuskopioitavaksi, täten kaikki modulivarmuuskopiot on muutettu \"Ilman käyttäjien tiedostoja\" -muotoon. Huomaa, että oppimistehtävä- ja työryhmä-modulit eivät ole yhteensopivia tämäntyyppisen varmuuskopioinnin kanssa eikä kyseisiä moduleita varmuuskopioida.';
...
$string['categorymodifiedcancel'] = 'Kategorian tietoja muokattiin! Valitse Peruuta ja yritä uudelleen.';
...
$string['coursedeleted'] = 'Kurssi $a poistettiin';
...
$string['creatingblogsinfo'] = 'Luodaan blogin tietoja';
...
$string['deletecategorycheck2'] = 'Jos poistat tämän kategorian, sinun on määriteltävä, mitä kategorian sisältämille kursseille ja alikategorioille tehdään.';
...
$string['migratinggrades'] = 'Siirretään arviointeja';
$string['min'] = 'min';
$string['mins'] = 'min';
...
$string['moreprofileinfoneeded'] = 'Kerro jotakin itsestäsi';
$string['mostrecently'] = 'viimeisimmät';
$string['move'] = 'Siirrä';
$string['movecategorycontentto'] = 'Siirrä kohtaan';
...
$string['rolerenaming'] = 'Roolien nimet';
$string['roles'] = 'Roolit';
$string['rss'] = 'RSS';
...
$string['writingblogsinfo'] = 'Kirjoitetaan blogin tietoja';
