...
$string['allowsallsubscribe'] = 'Keskustelualueen viestien tilaaminen on valinnaista';
...
$string['everyonecannowchoose'] = 'Kaikki voivat nyt tilata tämän keskustelualueen';
$string['everyoneissubscribed'] = 'Kaikki tilaavat tämän keskustelualueen';
$string['existingsubscribers'] = 'Nykyiset tilaajat';
$string['forcessubscribe'] = 'Tämän keskustelualueen viestien tilaaminen on pakollista';
...
$string['forum:addnews'] = 'Uutisten lisääminen';
...
$string['forum:initialsubscriptions'] = 'Oletustilaus';
...
$string['nameteacher'] = 'Opettajien keskustelu';
