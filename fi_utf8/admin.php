...
$string['configiplookup'] = 'Kun napsautat IP-osoitetta (kuten 34.12.222.93), esim lokeissa teille näytetään kartta  siitä, missä tuo IP sijaitsee. Tätä omainaisuutta  varten on olemassa erilaisia lisäosia, joista voit valita, kullakin on etuja ja haittoja.';
...
$string['remotelangnotavailable'] = 'Koska Moodle ei voi yhdistää download.moodle.orgiin, me emme pysty asentamaan kieltä  automaattisesti. Ole hyvä ja  imuroi asianmukainen zip-tiedosto alla olevasta luettelosta, kopioi se $a-hakemistoon ja pura se käsin.';
