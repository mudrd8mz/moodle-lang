<?PHP // $Id$ 
      // wiki.php - created with Moodle 1.9 dev (2007021401)
...
$string['disabledpage'] = 'Esta página atualmente não é disponível';
...
$string['errversionsave'] = 'Infelizmente outra pessoa estava editando a página ao mesmo tempo e gravou uma nova versão. Use o botão BACK do navegador para visualizar a página de edição, copie o texto modificado e use-o para editar uma nova versão da página.';
...
$string['linkdead'] = 'ERRADO';
$string['linkok'] = 'OK';
$string['linkschecked'] = 'Links verificados';
$string['listall'] = 'Mostrar todos';
$string['listcandidates'] = 'Listar candidatos';
$string['lockcancelled'] = 'O bloqueio de edição que você definiu foi superado por alguém que está editando esta página. Para não perder o texto que você criou é necessário selecionar e copiar o texto antes de clicar o botão para cancelar a ação e depois tentar uma nova edição, usando o texto copiado.';
...
$string['pagelocked'] = '<p><strong>O(s) usuário(s) $a->name estão editando esta página.</strong> A edição iniciou em $a->since e a janela ainda estava aberta em $a->seen.</p><p>Por enquanto a edição desta página está bloqueada.</p>';
...
$string['save'] = 'Gravar';
$string['savenolock'] = 'Você não pode salvar a página porquê alguém salvou uma nova versão enquanto você estava modificando o texto. Isto acontece quando alguém com autorização para ignorar o bloqueio da página faz a alteração ou quando você usa um navegador com Javascript desabilitado.<br/><br/>para não perder o texto use o botão de retorno do seu navegator e copie o texto antes de tentar novamente.';
