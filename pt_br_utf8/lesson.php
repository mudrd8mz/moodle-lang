<?PHP // $Id$ 
      // lesson.php - created with Moodle 1.9 dev (2007021401)
...
$string['addanendofbranch'] = 'Inserir fim da seção';
...
$string['attemptsdeleted'] = 'Cancelar tentativas';
...
$string['clicktodownload'] = 'Clique o seguinte link para baixar o arquivo.';
...
$string['deletedefaults'] = 'Canceladas $a x padrão';
...
$string['essayemailmessage'] = '<p>Dissertação:<blockquote>$a->question</blockquote></p><p>Resposta:<blockquote><em>$a->response</em></blockquote></p><p>$a->comentário:<blockquote><em>$a->comment</em></blockquote></p><p>Nota igual a $a->earned sobre $a->outof .</p><p>A sua nota foi modificada para $a->newgrade&#37;.</p>';
...
$string['linkedmedia'] = 'Arquivo multimedial linkado';
...
$string['maximumnumberofattemptsreached'] = 'Número máximo de tentaivas atingido - indo para a próxima página';
...
$string['mediafilepopup'] = 'Clique aqui para ver o arquivo multimédia desta lição';
...
$string['nobranchtablefound'] = 'Nenhum ramo encontrado';
...
$string['nolessonattempts'] = 'Nenuma tentativa feita nesta lição';
...
$string['progressbar'] = 'Barra de avançamento';
$string['progressbarteacherwarning'] = 'Barra de avançamento não é mostrada para $a';
