...
$string['configexcelencodings'] = 'Lista de codificações, separada por vírgolas, a serem usadas para forçar os valôres do relatório em planilhas eletrônicas específicas. Por exemplo, Excel exige o \"SJIS\" para codificação em japonês';
$string['configshowtimes'] = 'O tempo de processamento deve ser incluido nos relatórios? Isto é útil apenas em caso de necessidade de controle da velocidade do servidor.';
...
$string['updatequizchain'] = 'Atualizar série de quiz';
