<?PHP // $Id$ 
      // forum.php - created with Moodle 1.6 development (2006031600)
...
$string['allsubscribe'] = 'Fazer assinatura de todos os fóruns';
$string['allunsubscribe'] = 'Cancelar assinatura de todos os fóruns';
$string['anyfile'] = 'Qualquer arquivo';
$string['attachment'] = 'Anexo';
$string['blockafter'] = 'Limite de mensagem para bloqueio';
...
$string['forum'] = 'Fórum';
$string['forumauthorhidden'] = 'Autor (escondido)';
$string['forumblockingalmosttoomanyposts'] = 'Você está atingindo o limite máximo de mensagens. Você publicou $a->numposts vêzes nos últimos $a->blockperiod e o limite é de $a->blockafter mensagens.';
$string['forumbodyhidden'] = 'Você não pode ver esta mensagem provavelmente porquê ainda não publicou nada nesta discussão.';
...
$string['forumsubjecthidden'] = 'Assunto (escondido)';
...
$string['nowallsubscribed'] = 'Assinatura de todos os fóruns em $a ativa';
$string['nowallunsubscribed'] = 'Assinatura de todos os fóruns em $a não é ativa';
...
$string['postmailnow'] = '<p>Esta mensagem será enviada imediatamente s todos os assinantes deste fórum</p>';
...
$string['qandaforum'] = 'Fórum Q e A (perguntas e respostas)';
$string['qandanotify'] = 'Este é um fórum Q e A (perguntas e respostas). Você poderá ler as respostas dadas por outros participantes a partir do momento em que publicar a sua resposta.';
$string['rate'] = 'Avaliar';
...
$string['timestartenderror'] = 'A data final não pode ser anterios à data inicial';
