<?PHP // $Id$ 
      // forum.php - created with Moodle 1.9.2+ (Build: 20080903) (2007101522)
...
$string['configlogblocked'] = 'O cron di fórum pode logar tentativas bloqueadas de envio de emails a usuários com endereços de email desabilitados';
...
$string['discussionmovedpost'] = 'Esta discussão foi movida para <a href=\"$a->discusshref\">aqui</a> no fórum <a href=\"$a->forumhref\">$a->forumname</a>';
...
$string['everyoneisnowsubscribed'] = 'Agota todos são assinantes deste fórum';
...
$string['nopostforum'] = 'Sinto uito, você não pode escrever mensagnes neste fórum';
...
$string['resetforums'] = 'Remover todas as mensagens destes tipos de fórum';
$string['resetforumsall'] = 'Apagar todas as mensagens';
$string['resetsubscriptions'] = 'Remover as assinaturas';
$string['resettrackprefs'] = 'Apagar todas as preferências de rastreamento';
...
$string['unsubscribeallempty'] = 'Sinto muito mas você é assinante de nenhum fórum. Para evitar totalmente o recebimento de emails deste server é necessario desabilitar o endereço email no seu perfil de usuário.';
