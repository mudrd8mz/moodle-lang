<?PHP // $Id$ 
      // chat.php - created with Moodle 1.6 development (2006031600)
...
$string['configrefreshroom'] = 'Qual é o intervalo de atualização da sala de chat (em segundos)? Um intervalo breve faz com que a chat pareça mais veloz mas isto pode aumentar muito a carga de trabalho do servidor quando muitas pessoas estiverem participando.';
