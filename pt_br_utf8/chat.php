<?PHP // $Id$ 
      // chat.php - created with Moodle 1.9 dev (2007021401)
...
$string['configrefreshroom'] = 'Qual é o intervalo de atualização da sala de chat (em segundos)? Um intervalo breve faz com que a chat pareça mais veloz mas isto pode aumentar muito a carga de trabalho do servidor quando muitas pessoas estiverem participando. Se você estiver usando atualizações <em>Stream</em>, você pode aumentar a freqüência de atualização escolhendo, por exemplo, o valor 2.';
