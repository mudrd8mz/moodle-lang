<?PHP // $Id$ 
      // calendar.php - created with Moodle 1.6 development (2006031600)
...
$string['explain_lookahead'] = 'Define um número máximo de dias correspondente ao intervallo em que um evento futuro será considerado com Evento Próximo. Os eventos che iniciam depois deste período não serão considerados como eventos próximos. Se o número de eventos próximos for muito grande, o número de eventos visualizados será limitado em função da configuração do Número máximo de eventos próximos.';
