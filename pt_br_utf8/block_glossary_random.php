<?PHP // $Id$ 
      // block_glossary_random.php - created with Moodle 1.6 development (2006031600)
...
$string['askviewglossary'] = 'Quando os usuários podem ver o glossário mas não podem adicionar, mostrar este texto';
...
$string['whichfooter'] = 'Você pode mostrar links a ações do glossário associado a este box se estas ações forem habilitadas na configuração deste glossário.';
