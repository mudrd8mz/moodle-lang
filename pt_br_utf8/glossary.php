<?PHP // $Id$ 
      // glossary.php - created with Moodle 1.9.2+ (Build: 20080903) (2007101522)
...
$string['current'] = 'Ordenado atualmente por $a';
...
$string['errconceptalreadyexists'] = 'Este conceito já existe. Não são permitidos conceitos duplicados';
$string['erredittimeexpired'] = 'O tempo de edição deste conceito terminou.';
$string['errorparsingxml'] = 'Ocorreram erros enquanto verificava o arquivo. Certifique-se que contém XML válido.';
