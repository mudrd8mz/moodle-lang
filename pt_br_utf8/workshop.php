<?PHP // $Id$ 
      // workshop.php - created with Moodle 1.6 development (2006031600)
...
$string['info'] = 'Info';
$string['invaliddates'] = 'As datas que você inseriu não são possíveis.<br />Volte à página anterior com o uso do menú de navegação do browser e corrija as datas inseridas no formulário.';
...
$string['workshopagreedassessments'] = 'Avaliações dos trabalhos aceitos';
