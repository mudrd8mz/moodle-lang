...
$string['blockdeleteconfirm'] = 'Você está prestes a remover o bloco \'$a\'. Todas as informações e dados associados a este bloco serão removidos da base de dados. Continuar?';
$string['blockdeletefiles'] = 'Os dados associados ao bloco \'$a->block\' foram removidos da base de dados. Para completar a remoção e evitar que o bloco reapareça, você deve remover o seguinte diretório no servidor: $a->directory';
...
$string['clamdeletedfile'] = 'Este arquivo foi removido';
$string['clamdeletedfilefailed'] = 'Não foi possível remover este arquivo';
...
$string['clamquarantinedirfailed'] = 'O arquivo não pôde ser transferido para o diretório de quarentena,$a. Você precisa corrigir a configuração pois os arquivos infectados estão sendo removidos se for verificado que eles estão infectados.';
...
$string['currentcoursedeleting'] = 'Curso corrente, após remover seus dados';
...
$string['deletecategory'] = 'Remover categoria: $a';
$string['deletecategorycheck'] = 'Você tem certeza que deseja remover definitivamente esta categoria <b>\'$a\'</b>?<br />Os cursos serão transferidos para a categoria superior, se presente, ou para a categoria padrão';
$string['deletecategorycheck2'] = 'Se você remover esta categoria, escolha o que fazer com seus cursos e subcategorias.';
...
$string['existingcoursedeleting'] = 'Curso existente, após remover seus dados';
...
$string['nopotentialcreators'] = 'Nenhum potencial autor de curso';
$string['nopotentialstudents'] = 'Nenhum potencial estudante';
$string['nopotentialteachers'] = 'Nenhum potencial tutor';
...
$string['potentialcreators'] = 'Potenciais autores de curso';
$string['potentialstudents'] = 'Potenciais participantes';
$string['potentialteachers'] = 'Potenciais tutores';
...
$string['virusplaceholder'] = 'Foi diagnosticado um vírus neste arquivo. O usuário que enviou o arquivo ao servidor foi avisado e o arquivo foi removido ou transferido para o diretório de quarentena.';
