...
$string['adminhelpenvironment'] = 'Controlar a compatibilidade do seu servidor com os pré-requisitos da instalção atual e futura';
...
$string['adminhelpmymoodle'] = 'Configurar o box My Moodle de usuários';
$string['adminhelpreports'] = 'Relatórios anível de site';
...
$string['adminprimarynoedit'] = 'Não é possível alterar a senha do administrador primário';
...
$string['childcourses'] = 'Cursos filhos';
...
$string['expirynotify'] = 'Aviso de enceramento de inscrição';
$string['expirynotifyemail'] = 'Os seguintes alunos deste curso tem a data de expiração em exatos $a->threshold dias:

$a->current

Os seguintes alunos deste curso tem a data de expiração em menos de $a->threshold dias:

$a->past

Você pode extender o período de participação destes alunos na seguinte página:
...
$string['extendenrol'] = 'Prolongar inscrição';
$string['extendperiod'] = 'Periodo prolongado';
...
$string['forcepasswordchangenotice'] = 'Você tem que mudas a senha antes de continuar';
...
$string['instudentview'] = 'em modalidade aluno';
...
$string['newpasswordfromlost'] = '<strong>AVISO:</strong> A sua <strong>Senha Atual</strong> na segunda mensagem email enviada durante este processo de recuperação da senha. Confira o recebimento da nova senha antes de continuar.';
...
Na maio parte dos programas de email a frase anterior aparece como um link azul que você pode clicar. Se este não é o seu caso, copie o endereço de acesso na barra de endereços do seu navegador.
...
$string['nostatstodisplay'] = 'Nenhuma data disponível a ser mostrada';
...
$string['notenrollable'] = 'Não é possével fazer a inscrição neste curso neste momento';
...
$string['participationratio'] = 'Participação proporcional';
...
$string['statsreportreads'] = 'Vistas (docentes e alunos)';
...
$string['statsuniquelogins'] = 'Logins exclusivos';
...
$string['untilcomplete'] = 'Até o completamento';
...
$string['usernameemailmatch'] = 'O nome de usuário e o endereço email não são correspondentes';
...
$string['usersnoaccesssince'] = 'Mostrar usuários que não são ativos por mais de ';
