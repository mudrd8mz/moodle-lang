...
$string['createnewcategories'] = 'Criar novas (escondidas)categorias de cursos se não forem encontradas em Moodle';
$string['createnewcourses'] = 'Criar novos (escondido) cursos se não forem encontrados em Moodle';
$string['createnewusers'] = 'Criar novas contas de usuários se ainda não forem registrados em Moodle';
...
$string['fixcasepersonalnames'] = 'Mudar nomes pessoais em Título Caixa';
$string['fixcaseusernames'] = 'Mudar nomes de usuários em minúsculas';
...
$string['truncatecoursecodes'] = 'Reduzir códigos de curso a este tamanho';
...
$string['zeroisnotruncation'] = '0 indica ausência de redução';
