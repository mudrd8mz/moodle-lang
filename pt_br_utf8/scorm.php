...
$string['noscriptnoscorm'] = 'O seu navegador não é compatível com javascript ou o javascript não está habilitado. Não serão feitos registros.';
...
$string['popupmenu'] = 'Em um menu drop down';
