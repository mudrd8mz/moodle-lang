...
$string['confirmloosetracks'] = 'Atenção: provavelmente este pacote foi modificado. Se a estrutura for mudada, o registros das interações dos usuários pode ser perdido durante a atualização';
...
$string['skipview'] = 'O estudante salta a página de menú';
