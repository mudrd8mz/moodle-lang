...
$string['allowusermailcharset'] = 'Permitir que usuários escolham set de carcteres';
...
$string['choosefiletoedit'] = 'Escolher o arquivo a ser editado na lista acima';
...
$string['configfrontpage'] = 'Os itens selecionados acima serão visualizados na página iical do site.';
...
$string['configguestroleid'] = 'Esta função é dsignada automaticamente ao usuário visitante. Também é designada temporariamente aos usuários que acessam um curso em que não são inscritos. Por favor controle se a função tem ações autorizadas em moodle/legacy:guest e moodle/course:view.';
...
$string['configlongtimenosee'] = 'Se os alunos não tiverem feito o login por muito tempo, são automaticamente excluídos dos cursos. Este parâmetro especifica este limite de tempo.';
...
$string['configsmtphosts'] = 'Indique o endereço completo de um ou mais servidores SMTP locais que o Moodle deve utilizar para o envio de correio eletrônico (por exemplo: \'mail.a.com\' or \'mail.a.com;mail.b.com\'). Se deixar em branco, o Moodle usará o método PHP padrão de envio de email.';
...
$string['configstatsuserthreshold'] = 'Se você inserir um valor inteiro diferente de zero neste campo, os cursos com número de usuários inferior a este valôr serão ignorados para fins de classificação. Os usuários compreendem professores e alunos.';
...
$string['dbmigrate'] = 'Migração de Base de Dados';
...
$string['dbmigrationdeprecateddb'] = '<font color=\"#ff0000\">Esta base de dados migrou para uma nova base de dados UTF8 e está superada. Edite o seu config.php e use a nova base de dados neste Moodle.</font>';
...
$string['helpupcominglookahead'] = 'Quandos dias consecutivos compõem o arco de tempo a ser considerado para a indicação dos Próximos Eventos?';
...
$string['importlangreminder'] = 'A migração da base de dados está iniciando. Você precisa fazer <b>um novo login</b> para que a atualização seja completada. Instale os pacotes de idioma unicode assim que for possível em Admin->Idioma->Instalação de Idioma <b>depois</b> que a migração dos dados tiver sido completada.';
...
$string['langpackremoved'] = 'Desinstalação do idioma completada';
$string['langpacks'] = 'Pacotes de idiomas';
$string['langpackupdated'] = 'Idioma $a Atualizado';
$string['languagesettings'] = 'Configurações de idiomas';
$string['langupdatecomplete'] = 'Atualização de idioma completada';
...
$string['stickyblocksduplicatenotice'] = 'Se os blocos que você acrescenta aqui já são presentes em uma página específica, será duplicado.<br />O bloco duplicado pode ser editado mas não é possível editar o bloco fixo.';
