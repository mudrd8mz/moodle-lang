...
$string['configstatsuserthreshold'] = 'Se você inserir um valôr inteiro diferente de zero neste campo, os cursos com número de usuários inferior a este valôr serão ignorados para fins de classificação. Os usuários compreendem professores e alunos';
...
$string['dbmigratewarning2'] = '<b>Atenção: você está para iniciar o processo de migração da base de dados. Não continue sem verificar que a base de dados tenha sido totalmente salvada em um backup.</b>';
...
$string['installedlangs'] = 'Pcotes de Idioma instalados';
...
$string['langpackremoved'] = 'Desisnstalação do idioma completada';
...
$string['unicodeupgradenotice'] = 'Em Moodle 1.6 todos os idiomas foram convertidos em Unicode. Para atualizar este site você precisa converter todos os dados da sua base de dados para o Unicode utilizando o nosso script de migração. <a href=\"utfdbmigrate.php\">Clique aqui para iniciar agora</a>!';
