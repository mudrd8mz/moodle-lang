...
$string['addotags'] = 'Acrescentar etiquetas oficiais';
$string['addptags'] = 'Acrescentar etiquetas definidas pelo usuário';
$string['blockmenutitle'] = 'Menu do Blog';
$string['blocktagstitle'] = 'Etiquetas do Blog';
$string['blocktitle'] = 'Título do box de Etiquetas do Blog';
$string['blog'] = 'Blog';
...
$string['norighttodeletetag'] = 'Você não tem permissão para cancelar esta etiqueta - $a';
$string['notallowedtoedit'] = 'Você não tem permissão para editar este texto';
$string['numberofentries'] = 'Itens: $a';
$string['numberoftags'] = 'Número de etiquetas mostradas';
...
$string['ptags'] = 'Etiquetas definidas pelos usuários';
...
$string['worldblogs'] = 'Qualquer pessoa, mesmo se não for usuário do site, pode ler os textos configurados como acessíveis por Todo o Mundo';
