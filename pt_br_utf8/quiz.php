...
$string['cannotopen'] = 'Impossível abrir arquivo de exportação';
...
$string['confirmstartattemptnotimelimit'] = 'Este questionário não tem limites de tempo. Você quer continuar?';
$string['confirmstartlimit'] = 'Este quiz tem um limite de tempo e podem ser feitas $a tentativas. O acesso ao quiz será contado como uma tentativa. Você quer continuar?';
$string['confirmstartnolimit'] = 'Este quiz tem um limite de $a tentativas. O acesso ao quiz será contado como uma tentativa. Você quer continuar?';
...
$string['delay1'] = 'Lapso temporal entre a primeira e a segunda tentativa';
$string['delay2'] = 'lapso temporal entre a segunda e outras tentativas';
...
$string['formatnotfound'] = 'Formato format $a não foi encontrado';
...
$string['invalidsourcetype'] = 'Tipo de recurso não inválido';
...
$string['questincats'] = 'Categorias de questões';
...
$string['reportmulti_percent'] = 'Multi-Porcentuais';
...
$string['timedelay'] = 'Você ainda não pode resolver este quiz porque existe um tempo de espera definido entre a realização de duas tentativas.';
...
$string['updatesettings'] = 'Atualizar configuração do quiz';
...
$string['url'] = 'URL';
$string['usedcategorymoved'] = 'Esta categoria foi transferida ao nível do site porque depois do cancelamento do curso as questões continuavam a serem utilizadas em outros questionários deste servidor.';
