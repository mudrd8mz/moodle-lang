...
$string['attemptsonly'] = 'Mostrar apenas alunos com tentativas';
...
$string['timedelay'] = 'Você ainda não pode resolver este quiz porquê existe um tempo de espera definido entre a realização de duas tentativas.';
