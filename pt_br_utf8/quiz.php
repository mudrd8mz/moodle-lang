<?PHP // $Id$ 
      // quiz.php - created with Moodle 1.9.2+ (Build: 20080903) (2007101522)
...
$a->studentname completed o questionário
...
$string['popupblockerwarning'] = 'A seçssão desse teste está em modo de segurança, o que significa que você precisa fazer o questionário numa janela segura. Por favor desligue o bloqueador de popups. Obrigado.';
...
$string['quizcloseson'] = 'O questuionário será fechado em: $a';
...
$string['stoponerror'] = 'Interromper no erro';
...
$string['url'] = 'URL';
$string['usedcategorymoved'] = 'Esta categoria foi transferida ao nível do site porque depois do cancelamento do curso as questões continuavam a ser utilizadas em outros questionários deste servidor.';
