<?PHP // $Id$ 
      // group.php - created with Moodle 1.8.4+ (2007021541)
...
$string['defaultgroupdescription'] = 'Описание группы по умолчанию';
$string['defaultgroupname'] = 'Группа';
$string['defaultgroupprefix'] = 'Группа';
...
$string['erroraddremoveuser'] = 'Ошибка добавления/удаления пользователей для группы $a';
$string['erroreditgroup'] = 'Ошибка создания/удаления группы $a';
$string['errorinvalidgroup'] = 'Ошибка, недопустимая группа $a';
$string['existingmembers'] = 'Участники группы: $a';
$string['group'] = 'Группа';
...
$string['groupnameexists'] = 'Группа с названием \'$a\' уже существует в курсе, пожалуйста, выберите другое название.';
...
$string['newpicture'] = 'Новая картинка';
