...
$string['attemptsonly'] = 'Показывать только студентов, пытавшихся пройти тест';
...
$string['categorynamecantbeblank'] = 'Название категории не может быть пустым';
...
$string['commentorgrade'] = 'Прокомментировать или установить оценку';
...
$string['confirmstartattemptlimit'] = 'Прохождение этого теста ограничено $a попытками (ой). Вы собираетесь предпринять новую попытку. Продолжить?';
$string['confirmstartattempttimelimit'] = 'Прохождение теста ограничено по времени и ограничено $a попытками (ой). Вы собираетесь предпринять новую попытку. Продолжить?';
$string['confirmstarttimelimit'] = 'Прохождение теста ограничено по времени. Вы уверены, что хотите начать тестирование?';
...
$string['decimaldigits'] = 'Десятичных разрядов в оценке';
...
$string['importfileupload'] = 'Импорт путём загрузки файла...';
$string['importfromthisfile'] = 'Импорт данного файла';
...
$string['multipleanswers'] = 'Выберите как минимум один ответ';
$string['multiplier'] = 'Множитель';
$string['name'] = 'Название';
$string['newattemptfail'] = 'Ошибка: Нельзя начать новую попытку';
$string['newcategory1'] = 'переменная из нового набора, которая также может использоваться другими вопросами данной категории';
$string['newcategory2'] = 'файл из нового набора, который также может использоваться другими вопросами данной категории';
$string['newcategory3'] = 'ссылка из нового набора, которая также может использоваться другими вопросами данной категории';
$string['newlocal1'] = 'переменная из нового набора, которая может использоваться только данным вопросом';
$string['newlocal2'] = 'файл из нового набора, который может использоваться только данным вопросом';
$string['newlocal3'] = 'ссылка из нового набора, которая может использоваться только данным вопросом';
...
$string['popupblockerwarning'] = 'Этот раздел теста отображается в безопасном режиме. Это значит, что тест будет показан в защищённом окне. Пожалуйста, отключите блокировку всплывающих окон. Спасибо.';
...
$string['reordertool'] = 'Показать инструмент перестановки';
...
$string['sorttypealpha'] = 'Сортировать по типу, имени';
