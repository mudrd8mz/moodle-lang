...
$string['addingmultianswer'] = 'Добавление вопроса \"Вложенные ответы\"';
$string['addingmultichoice'] = 'Добавление вопроса \"В закрытой форме (множественный выбор)\"';
$string['addingnumerical'] = 'Добавление \"Числового вопроса\"';
...
$string['addingrandomsamatch'] = 'Добавление случайного вопроса с коротким ответом';
$string['addingshortanswer'] = 'Добавление вопроса \"Короткий ответ\"';
$string['addingtruefalse'] = 'Добавление вопроса \"Верно/неверно\"';
$string['addmoreoverallfeedbacks'] = 'Добавить (не)больше полей обратной связи';
...
$string['attemptsdeleted'] = 'Попытка ответа удалена';
...
$string['attemptsnumthisgroup'] = 'Попыток: $a->total ($a->group в вашей группе)';
$string['attemptsnumyourgroups'] = 'Попыток: $a->total ($a->group в ваших группах)';
...
$string['closebeforeopen'] = 'Не могу обновить опрос. Вы указали дату закрытия раньше даты открытия';
...
Спасибо за отправку Ваших ответов на \'$a->quizname\' в курсе \'$a->coursename\' в $a->submissiontime.

Это сообщение подтверждает, что мы полностью получили Ваши ответы.';
$string['emailconfirmsubject'] = 'Подтверждение доставки опроса $a->quizname';
...
$string['emailnotifysubject'] = '$a->studentname завершил опрос $a->quizname';
...
$string['feedbackerrorboundaryformat'] = 'Оценки должны являться числом или процентами. Введённое Вами значение $a не обработано.';
...
$string['feedbackerrorjunkinfeedback'] = 'Вы должны заполнить все поля ответа.';
$string['feedbackerrororder'] = 'Границы оценок должны быть в порядке убывания. Значение, введённое в границах $a лежит вне последовательности';
$string['file'] = 'Файл';
$string['fileformat'] = 'Формат файла';
$string['fillcorrect'] = 'Отобразить ответы';
$string['filloutnumericalanswer'] = 'Вы отмечаете в списке один возможный вариант ответа и погрешность.Первый отмеченный ответ будет использован для определения счёта и комментариев.Если вы применяете некоторые комментарии без ответа в конце,они будут показаны студентам которые не подобрали любой другой ответ.';
...
$string['giftleftbraceerror'] = 'Не могу найти {';
$string['giftmatchingformat'] = 'Ответы на вопросы некорректно отформатированы';
$string['giftnonumericalanswers'] = 'Не найдено ответов для численных вопросов';
$string['giftnovalidquestion'] = 'Не найдено корректных вопросов';
$string['giftqtypenotset'] = 'Тип вопроса не задан';
$string['giftrightbraceerror'] = 'Не могу найти }';
$string['grade'] = 'Оценка';
...
$string['importcategory'] = 'импоритровать категорию';
...
$string['popupblockerwarning'] = 'Этот отдел теста в безопасном режиме, это значит что вы должны запустить  quiz в защищенном окне. Пожалуйста выключите ваш блокировщик всплывающих окон.Спасибо';
...
$string['quiz:ignoretimelimits'] = 'Убрать лимит времени для тестирования';
...
$string['truefalseimporterror'] = '<b>Предупреждение</b>: Вопрос типа верно/неверно \'$a->questiontext\' не может быть  импортирован корректно.
Он не может быть удалён пока ответ не будет Верно или Неверно. Вопрос будет импортирован, предполагая, что ответ : \'$a->answer\'.Если он не корректен, вам необходимо изменить вопрос';
$string['type'] = 'Тип';
...
$string['xmlimportnoname'] = 'Неверное имя вопроса в  xml файле';
$string['xmlimportnoquestion'] = 'Неверный текст вопроса в  xml файле';
$string['xmltypeunsupported'] = 'Тип вопроса $a не поддерживается XML-импортом';
$string['youneedtoenrol'] = 'Вам необходимо получить права в этом курсе прежде чем пройти этот тест';
