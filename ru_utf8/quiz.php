...
$string['addingmultianswer'] = 'Вопрос с вложенными ответами';
...
$string['cannoteditafterattempts'] = 'Вы не можете добавлять или удалять вопросы, т.к. в тесте уже есть попытки.';
...
$string['finishreview'] = 'Закончить просмотр';
$string['nocommentsyet'] = 'Комментариев еще нет';
$string['outofpercent'] = '$a->grade от максимума $a->maxgrade ($a->percent%%)';
$string['overallfeedback'] = 'Комментарий к тесту';
$string['requirepassword'] = 'Необходим пароль';
$string['responses'] = 'Свои ответы';
$string['reviewofpreview'] = 'Обзор попытки просмотра';
$string['reviewoptions'] = 'Учащиеся могут просматривать';
$string['reviewoptionsheading'] = 'Учащиеся могут просматривать';
$string['summaryofattempts'] = 'Обзор ваших предыдущих попыток';
$string['timelimitmin'] = 'Ограничение времени (минут)';
