...
$string['deleteattempts'] = 'Удалить попытки студента пройти эту лекцию (введите логин студента)';
...
$string['gobacktolesson'] = 'Вернуться к лекции';
$string['grade'] = 'Оценка';
...
$string['viewlessonstats'] = 'Показать статистику лекции ($a->users $a->usersname)';
