...
$string['essay'] = 'Эссе';
$string['essayemailmessage'] = '<p>Задание на эссе: <blockquote>$a->question</blockquote></p><p>Ваш ответ:<blockquote><em>$a->response</em></blockquote></p><p>$a->Комментарии тьютера:<blockquote><em>$a->comment</em></blockquote></p><p>Вы получили $a->earned из $a->outof за это эссе.</p><p>Ваша оценка за урок была изменена на $a->newgrade&#37;.</p>';
