...
$string['addmoreunitblanks'] = 'Добавить $a единицы измерения';
...
$string['nosharedwildcard'] = 'нет общих шаблонов в этой категории';
$string['possiblehdr'] = 'Возможные шаблоны, представленные только в тексте вопроса';
