<?PHP // $Id$ 
      // auth.php - created with Moodle 1.9.7+ (Build: 20100224) (2007101571.04)
...
$string['informminpassworddigits'] = 'не менее $a цифр(ы)';
$string['informminpasswordlength'] = 'не менее $a символов';
$string['informminpasswordlower'] = 'не менее $a строчных(ой) букв(ы)';
$string['informminpasswordnonalphanum'] = 'не менее $a не буквенно-цифровых(ого) символов(а)';
$string['informminpasswordupper'] = 'не менее $a прописных(ой) букв(ы)';
$string['informpasswordpolicy'] = 'В пароле должно быть $a';
