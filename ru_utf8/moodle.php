...
$string['enrollable'] = 'Курс доступен для студентов';
...
$string['enrolmentend'] = 'Запись закончена';
...
$string['enrolmentstart'] = 'Запись начата';
...
$string['markedthistopic'] = 'Этот модуль выделен как текущий';
$string['markthistopic'] = 'Выделить модуль как текущий';
...
$string['tagmanagement'] = 'Добавить/удалить тэги...';
$string['tags'] = 'Тэги';
