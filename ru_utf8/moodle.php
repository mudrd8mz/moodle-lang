<?PHP // $Id$ 
      // moodle.php - created with Moodle 1.9.7+ (Build: 20100224) (2007101571.04)
...
$string['adminhelpassignsiteroles'] = 'Применить определённые роли к указанным пользователям';
...
$string['adminhelpenvironment'] = 'Проверьте,удовлетворяет ли ваш сервер текущими будующим инсталляционным требованиям';
...
$string['administratordescription'] = 'Администраторы обычно могут делать всё что угодно на сайте, на всех курсах';
...
$string['authenticateduser'] = 'Авторизованный пользователь';
$string['authenticateduserdescription'] = 'Все авторизованые пользователи';
...
$string['back'] = 'Назад';
$string['backtocourselisting'] = 'Назад к списку курсов';
$string['backtoparticipants'] = 'Назад к списку участников';
$string['backup'] = 'Резервное копирование';
$string['backupactivehelp'] = 'Делать ли резервные копии автоматически.';
...
$string['backupexecuteathelp'] = 'Выберите, в какое время должно запускаться автоматическое резервирование';
...
$string['backupfromthissite'] = 'Для этого сайта была создана резервная копия';
...
$string['backuproleassignments'] = 'Сохранять назначенние ролей для этих ролей';
...
$string['backupschedulehelp'] = 'Выбрать день недели для выполнения резервирования';
...
$string['cachecontrols'] = 'Управление кешированием';
...
$string['categorycurrentcontents'] = 'Комментнарии $a';
$string['categorydeleted'] = 'Категория \'$a\' была удалена';
$string['categoryduplicate'] = 'Категория с именем \'$a\' уже существует!';
$string['categorymodifiedcancel'] = 'Категория была изменена! Пожалуйста отмените и попробуйте ещё раз.';
$string['categoryname'] = 'Имя категории';
$string['categoryupdated'] = 'Категория $a была обновлена';
...
$string['deletecategoryempty'] = 'Пустая категория';
...
$string['editcategorysettings'] = 'Редактировать категорию';
...
$string['pictureof'] = 'Картинка участника $a';
