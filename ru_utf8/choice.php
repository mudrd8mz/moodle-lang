...
$string['havetologin'] = 'Для того, чтобы Вы могли участвовать в опросе, Вам необходимо войти под Вашей учетной записью, либо <a title=\"Создать новую учетную запись в системе\" href=\"../../login/signup.php\">создать новую</a>, если у Вас ее нет.';$string['havetologin'] = 'Для того, чтобы Вы могли участвовать в опросе, Вам необходимо войти под Вашей учетной записью, либо <a title=\"Создать новую учетную запись в системе\" href=\"http://www.cdp.tsure.ru/moodle/login/signup.php\">создать новую</a>, если у Вас ее нет.';
