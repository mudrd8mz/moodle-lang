...
$string['guestnosubmit'] = 'Извините, гость не может отправлять ответ на задание. Вам необходимо <a href=\"../../login/\" title=\"Перейти на страницу входа в систему\">войти под своей учетной записью</a> (или <a href=\"../../login/signup.php\" title=\"Перейти на страницу создания новой учетной записи\">создать новую</a>, если у вас ее нет), чтобы вы могли отправить ответ';$string['guestnoupload'] = 'Извините, гости не могут отвечать на задания';
