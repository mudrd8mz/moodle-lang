...
$string['guestnosubmit'] = 'Извините, гость не может отправлять ответ на задание. Вам необходимо <a href=\"http://www.cdp.tsure.ru/moodle/login/\" title=\"Перейти на страницу входа в систему\">войти под своей учетной записью</a> (<a href=\"http://www.cdp.tsure.ru/moodle/login/signup.php\" title=\"Перейти на страницу создания новой учетной записи\">создать новую</a>, если у вас ее нет), чтобы вы могли отправить ответ';
