...
$string['adminprimarynoedit'] = 'Профиль первичного администратора не может редактироваться другими пользователями';
...
$string['iplookupfailed'] = 'Невозможно определить географическую информацию для этого IP адерса';
$string['iplookupprivate'] = 'Не могу отобразить поиск приватного IP адреса';
...
$string['noinstances'] = 'Нет экземпляров $a в этом курсе';
$string['nologinas'] = 'Вам не разрешено заходить под именем этого пользователя';
$string['nonmeaningfulcontent'] = 'Не значимое содержимое';
...
$string['usernotaddederror'] = 'Пользователь не добавлен - неизвестная ошибка';
$string['usernotaddedregistered'] = 'Пользователь не добавлен - уже зарегистрирован';
