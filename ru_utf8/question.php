<?PHP // $Id$ 
      // question.php - created with Moodle 1.9.6 (Build: 20091021) (2007101560)
...
$string['categorydoesnotexist'] = 'Данная категория не существует';
$string['categorymoveto'] = 'Сохранить в категорию';
$string['changepublishstatuscat'] = '<a href=\"$a->caturl\">Категория \"$a->name\"</a> в курсе \"$a->coursename\" will have it\'s sharing status changed from <strong>$a->changefrom to $a->changeto</strong>.';
$string['copy'] = 'Скопировать из $a и изменить ссылки';
$string['created'] = 'Создан:';
$string['createdmodifiedheader'] = 'Создан / последний раз сохранен';
$string['cwrqpfs'] = 'Случайным образом выбирающиеся вопросы из подкатегорий';
$string['defaultfor'] = 'По умолчанию для $a';
$string['defaultinfofor'] = 'Категория по умолчанию для вопросов, опубликованных в контексте \'$a\'.';
$string['deletecoursecategorywithquestions'] = 'Вопросы из базы связаны с категорией этого курса.Если продолжить, то они будут удалены.начала вы можете переместить их используя интерфейс банка вопросов';
...
$string['exportcategory'] = 'Экспорт категории';
$string['filesareacourse'] = 'область файлов курса';
$string['filesareasite'] = 'область файлов сайта';
$string['filestomove'] = 'Переместить/копировать файлы в $a?';
...
$string['makechildof'] = 'Сделать подкатегорией для \'$a\'';
...
$string['modified'] = 'Последний раз сохранен:';
...
$string['movingcategory'] = 'Пеместить категории';
...
$string['nopermissionadd'] = 'У вас не достаточно прав для добавления вопроса сюда';
...
$string['questionaffected'] = '<a href=\"$a->qurl\">Вопрос \"$a->name\" ($a->qtype)</a> находится в этой категоии вопросов, но так же используется в <a href=\"$a->qurl\">тесте \"$a->quizname\"</a> в курсе \"$a->coursename\".';
...
$string['cannotcopybackup'] = 'Невозможно скопировать резервный файл'; // ORPHANED
$string['cannotcreatepath'] = 'Невозможно найти путь'; // ORPHANED
$string['cannotunzip'] = 'Невозможно распаковать файл.'; // ORPHANED
