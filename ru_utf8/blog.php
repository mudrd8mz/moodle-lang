...
$string['addotags'] = 'Добавить официальные теги';
$string['addptags'] = 'Добавить пользовательские теги';
...
$string['pagesize'] = 'Число записей блога на странице';
$string['personalblogs'] = 'Пользователям доступен только собственный блог';
$string['ptags'] = 'Теги пользователя';
$string['publishto'] = 'Опубликовать';
$string['publishtonoone'] = 'для Вас (черновик)';
$string['publishtosite'] = 'для всех пользователи сайта';
$string['publishtoworld'] = 'для всех';
$string['settingsupdatederror'] = 'Произошла ошибка, не удалось обновить настройки блога';
$string['siteblog'] = 'блог сайта $a';
$string['siteblogs'] = 'Все пользователи видят все записи блогов';
