...
$string['adminseesownevents'] = 'Администраторы просто как обычные пользователи';
...
$string['allowuserswitchrolestheycantassign'] = 'Позволить менять роли пользователям без возможности присвоения ролей';
...
$string['authsettings'] = 'Управление аутентификацией';
$string['autolang'] = 'Автоопределение языка';
$string['autologinguests'] = 'Авто-вход гостя';
$string['availablelangs'] = 'Доступные языковые пакеты';
$string['backgroundcolour'] = 'Прозрачный цвет';
...
$string['configallowassign'] = 'Вы можете  позволять людям, которые имеют роли с  левой стороны назначать  другим людям некоторые роли из колонки';
...
$string['defaultsettinginfo'] = 'По умолчанию: $a';
...
$string['denyemailaddresses'] = 'Запрещённые email домены';
...
$string['gotofirst'] = 'Перейти к первой пустой строке';
...
$string['localstringcustomization'] = 'Настройка локальных строк';
...
$string['numberofmissingstrings'] = 'Количество отсутствующих строк: $a';
$string['numberofstrings'] = 'Всего строк: $a->strings<br />Не хватает: $a->missing ($a->missingpercent&nbsp;%%)';
...
$string['pleaseregister'] = 'Пожалуйста, зарегистрируйте Ваш сайт, чтобы удалить эту кнопку';
