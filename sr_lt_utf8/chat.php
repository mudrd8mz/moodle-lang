...
$string['configmethod'] = 'Normalan režim rada pričaonice podrazumeva da korisnici konstantno komuniciraju sa serverom zbog osvežavanja sadržaja. Ovaj režim ne zahteva posebna podešavanja i funkcioniše u svim okruženjima, ali može jako da optereti server ako je broj korisnika veliki. Sa druge strane, korišćenje IRC servera zahteva tzv. <i>shell</i> pristup Unix-u, ali zato pruža brzo i lako podesivo <i>chat</i> okruženje.';
