...
$string['courseenrolend'] = 'Kraj upisa na kurs';
$string['courseenrolenddate'] = 'Datum isteka upisa za kurs';
$string['courseenrolstart'] = 'Početak upisa na kurs';
...
$string['coursehelpenrollable'] = 'Da li studenti mogu sami da se upišu na kurs koristeći podrazumevani dodatak za interaktivni upis.';
$string['coursehelpenrolmentkey'] = 'Ako je postavljena, studentima će biti potrebna ova lozinka kako bi se upisali na kurs.';
$string['coursehelpenrolmentplugins'] = 'Podrazumevani dodatak za interaktivni upis';
$string['coursehelpexpirynotifystudents'] = 'Ukoliko je naveden upisni period, onda ovo podešavanje određuje da li će studenti dobiti obaveštenje e-poštom pre nego što budu ispisani sa kursa.';
$string['coursehelpexpirythreshold'] = 'Ukoliko je naveden upisni period, onda ovo podešavanje određuje koliko dana 
ranije, pre ispisivanje sa kursa, će studenti dobiti obaveštenje o tome.';
...
$string['enroldetails'] = 'Detalji upisa';
...
$string['hidetopicfromothers'] = 'Sakrij temu od ostalih';
$string['hideweekfromothers'] = 'Sakrij nedelju od drugih';
$string['hits'] = 'Posete';
...
$string['shortnamecourse'] = 'Kraći naziv kursa';
...
$string['showtopicfromothers'] = 'Prikaži teme drugih';
$string['showweekfromothers'] = 'Prikaži nedelje drugih';
$string['since'] = 'Od';
...
$string['sortbyx'] = 'Sortiraj prema $a u ushodnom nizu';
$string['sortbyxreverse'] = 'Sortiraj prema $a u nishodnom nizu';
...
$string['userselectorautoselectunique'] = 'Ako se samo jedan korisnik poklapa sa kriterijumima pretraga neka automatski bude odabran';
$string['userselectorpreserveselected'] = 'Zadrži izabrene korisnike, čak i ako se više ne poklapaju sa kriterijumima pretrahe';
$string['userselectorsearchanywhere'] = 'Pronađi traženi tekst bilo gde u korisnikovom imenu';
...
$string['courserequestdisabled'] = 'Žao nam je, ali zahtevane kurseve je administrator učinio nedostupnim'; // ORPHANED
$string['remotemaharauser'] = 'Udaljeni Mahara korisnik'; // ORPHANED
$string['nostatstodisplay'] = 'Nažalost, nema raspoloživih podataka za prikaz.'; // ORPHANED
