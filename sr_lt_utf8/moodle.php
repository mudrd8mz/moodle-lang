...
$string['activityreport'] = 'Izveštaj aktivnosti';
$string['activityreports'] = 'Izveštaji aktivnosti';
...
$string['added'] = '$a dodat';
$string['addedrecip'] = 'Dodat $a novi primalac';
$string['addedrecips'] = 'Dodati $a novi primaoci';
$string['addedtogroup'] = 'Dodat(a) u grupu $a';
$string['addedtogroupnot'] = 'Nije dodat(a) u grupu $a';
$string['addedtogroupnotenrolled'] = 'Nije dodat(a) u grupu $a, jer nije upisan(a) na kurs';
...
$string['adminhelpaddnewuser'] = 'Ručno dodavanje novog korisničkog naloga';
$string['adminhelpassignadmins'] = 'Administratori mogu sve raditi i kretati se svuda po sajtu';
...
$string['adminhelpauthentication'] = 'Možete koristiti interne korisničke račune ili spoljašnje baze podataka';
...
$string['adminhelpconfigvariables'] = 'Podesite promenljive koje utiču na opštu funkcionalnost sajta';
$string['adminhelpcourses'] = 'Odredite kurseve i kategorije i upišite polaznike u njih, uređite kurseve na čekanju';
$string['adminhelpeditorsettings'] = 'Odredite osnovna podešavanja HTML editora';
$string['adminhelpedituser'] = 'Prikaz liste korisničkih naloga i njihovo uređivanje';
$string['adminhelpenrolments'] = 'Odaberite interne ili spoljašnje načine kontrole upisa u sistem';
$string['adminhelpenvironment'] = 'Proverite kako Vaš server zadovoljava trenutne i buduće preduslove za uspešnu instalaciju';
$string['adminhelpfailurelogs'] = 'Pregled zapisa o neuspešnim pristupima sistemu';
$string['adminhelphealthcenter'] = 'Automatsko otkrivanje problema na sajtu';
$string['adminhelplanguage'] = 'Provera i uređivanje trenutnog jezičkog paketa';
...
$string['adminhelpsitefiles'] = 'Služi za objavljivanje datoteka opšteg sadržaja ili učitavanje datoteka s rezervnim kopijama';
$string['adminhelpsitesettings'] = 'Definišite kako će izgledati početna stranica';
$string['adminhelpstickyblocks'] = 'Podešavanje fiksnih blokova na čitavom sajtu';
$string['adminhelpthemes'] = 'Podešavanje izgleda sajta (boje, fontovi i sl.)';
$string['adminhelpuploadusers'] = 'Uvezite nove korisničke naloge iz tekstualne datoteke';
$string['adminhelpusers'] = 'Odredite svoje korisnike i podesite autentikaciju';
...
$string['alllogs'] = 'Svi zapisi o posetama';
$string['allow'] = 'Dozvoli';
$string['allowguests'] = 'Ovaj kurs dozvoljava pristup gostima (anonimnim korisnicima)';
$string['allowinternal'] = 'Dozvoli i interne načine autorizacije';
$string['allownone'] = 'Ne dozvoli ništa';
...
$string['backup'] = 'Rezervne kopije podataka';
$string['backupcancelled'] = 'Prekinuto kreiranje rezervne kopije';
$string['backupcoursefileshelp'] = 'Ako je omogućeno, datoteke kursa će biti uključene u automatski kreirane rezervne kopije podataka';
$string['backupdate'] = 'Datum kreiranja rezervne kopije podataka';
$string['backupdetails'] = 'Detalji o rezervnoj kopiji podataka';
$string['backupfailed'] = 'Neki od vaših kurseva NISU sačuvani!';
$string['backupfilename'] = 'rezervna kopija podataka';
$string['backupfinished'] = 'Uspešno je izvršeno kreiranje rezervne kopije podataka';
$string['backupincludemoduleshelp'] = 'Odaberite želite li u automatsku proceduru kreiranja rezervnih kopija podataka da uključite i module kursa, sa ili bez korisničkih podataka';
$string['backupkeephelp'] = 'Koliki broj skorijih rezervnih kopija podataka za svaki kurs želite da čuvate? (Starije kopije biće automatski obrisane po isteku navedenog roka)';
$string['backuplogdetailed'] = 'Detaljni zapisi o izvršavanju';
$string['backuploglaststatus'] = 'Zapisi o poslednjem izvršavanju';
$string['backuplogshelp'] = 'Ako omogućite ovu opciju, zapisi o posetama kursu biće uključeni u automatski kreirane rezervne kopije podataka';
$string['backupmetacoursehelp'] = 'Ako uključite ovu postavku, informacije o meta-kursu (nasleđeni upisi) će takođe biti uključeni u automatsku proceduru za kreiranje rezervnih kopija';
$string['backupnameformat'] = '%%d.%%m.%%Y.-%%H.%%M';
$string['backupnoneusersinfo'] = 'Napomena: Označili ste opciju koja kaže kako ne želite kreiranje rezervnih kopija korisničkih podataka, tako da su rezervne kopije svih modula prebačene u oblik \"bez korisničkih podataka\". Uzmite u obzir i to da moduli \"vežba\" i \"radionica\" nisu kompatibilni sa ovom opcijom za kreiranje rezervnih podataka, tako da su u potpunosti isključeni iz ove procedure.';
$string['backupnonisowarning'] = 'Upozorenje: ova rezervna kopija podataka je kreirana u verziji Moodle sistema koja nije podržavala Unicode (pre verzije 1.6). Ako ova rezervna kopija sadrži tektove koji se ne slažu sa ISO-8859-1 može biti OŠTEĆENA ako pokušate da preuzmete sadržaj iz nje u ovoj Unicode Moodle verziji. Pogledajte <a href=\"http://docs.moodle.org/en/Backup_FAQ\">Backup FAQ</a>za više informacija o tome kako da pravilno uradite oporavak ove rezervne kopije.';
$string['backuporiginalname'] = 'Naziv rezervne kopije podataka';
$string['backupsavetohelp'] = 'Puna putanja do direktorijuma u kojem želite da sačuvate datoteke sa rezervnim kopijama podataka<br /> (ostavite ovo polje prazno kako biste podatke sačuvali u podrazumevani direktorijum za čuvanje svih podataka vezanih za ovaj kurs)';
$string['backuptakealook'] = 'Molimo pregledajte vaše zapise o kreiranju rezervnih kopija u: $a';
$string['backupuserfileshelp'] = 'Odaberite da li bi trebalo da se korisničke datoteke (npr. slike za lične profile korisnika)uključe u automatski kreirane rezervne kopije podataka';
...
$string['changedpassword'] = 'Promenjena lozinka';
...
$string['checkingbackup'] = 'Provera rezervne kopije podataka';
...
$string['chooselogs'] = 'Izbor zapisa o posetama koje želite da vidite';
$string['choosereportfilter'] = 'Izbor filtera za izveštaj';
$string['choosetheme'] = 'Izbor teme';
...
$string['clamunknownerror'] = 'Clam je prijavio nepoznatu grešku.';
...
$string['configuration'] = 'Podešavanja';
...
$string['continuetocourse'] = 'Kliknite ovde za ulazak na Vaš kurs';
...
$string['course'] = 'Kurs';
$string['courseapprovedemail'] = 'Zahtev za kursom, $a->name, koji ste podneli je odobren, kurs je kreiran i Vama je dodeljena sledeča uloga na njemu: $a->teacher. Da biste pristupili svom novom kursu, idite na $a->url';
...
$string['courseformats'] = 'Oblik kursa';
...
$string['courserestore'] = 'Preuzimanje sadržaja iz rezervne kopije kursa';
...
$string['courseupdates'] = 'Nadogradnje kursa';
...
$string['createfolder'] = 'Kreiraj direktorijum u $a';
$string['createuserandpass'] = 'Kreiraj novo korisničko ime i lozinku za pristup sistemu';
...
$string['creatinggradebook'] = 'Kreiranje zapisa o ocenama';
$string['creatinggroups'] = 'Kreiranje grupa';
$string['creatinglogentries'] = 'Kreiranje zapisa o pristupu sistemu';
$string['creatingmessagesinfo'] = 'Kreiranje informacija o porukama';
$string['creatingmetacoursedata'] = 'Kreiranje informacija o meta-kursevima';
...
$string['currentcourseadding'] = 'Trenutni kurs, dodavanje podataka postojećima';
$string['currentcoursedeleting'] = 'Trenutni kurs, uz prethodno brisanje postojećih podataka';
$string['currentlanguage'] = 'Trenutno odabrani jezik';
...
$string['databasechecking'] = 'Nadogradnja Moodle baze podataka $a->oldversion na $a->newversion...';
$string['databaseperformance'] = 'Performanse baze podataka';
$string['databasesetup'] = 'Podešavanje baze podataka';
$string['databasesuccess'] = 'Baza podataka je uspešno nadogradjena';
$string['databaseupgradebackups'] = 'Važeća verzija rezervne kopije podataka je $a';
$string['databaseupgradeblocks'] = 'Važeća verzija blokova je $a';
...
$string['deletecoursecheck'] = 'Jeste li u potpunosti sigurni da želite potpuno da obrišete ovaj kurs i sve podatke sadržane u njemu?';
...
$string['deletingexistingcoursedata'] = 'Brisanje postojećih podatke unutar kursa';
$string['deletingolddata'] = 'Brisanje starih podataka';
$string['department'] = 'Odsek';
...
$string['down'] = 'Dole';
$string['downloadexcel'] = 'Preuzmite u Excel formatu';
$string['downloadtext'] = 'Preuzmite u tekstualnom formatu';
...
$string['edhelpfontsize'] = 'Podrazumevana veličina veličina fonta. <br />Primer vrednosti koje se mogu zadati su: medium, large, smaller, larger, 10pt, 11px.';
...
$string['editorcommonsettings'] = 'Zajednička podešavanja';
...
U većini programa za e-poštu, u redu iznad ovog biste trebali videti plavo obojeni link na koji možete kliknuti. Ako ta funkcija ne radi, onda samo kopirajte navedenu adresu u liniju za adrese
na vrhu Vašeg web čitača.
...
$string['emaildigest'] = 'Oblik obaveštenja putem e-poruka';
$string['emaildigestcomplete'] = 'Kompletno (jedna poruka dnevno sa svim forum postovima)';
$string['emaildigestoff'] = 'Pune (po jedna poruka za svaki forum post)';
$string['emaildigestsubjects'] = 'Naslovi (jedna poruka dnevno samo sa naslovima)';
...
$string['emailnotallowed'] = 'Adrese e-pošte s navedenog domena nisu dozvoljene ($a)';
...
$string['enrollfirst'] = 'Morate upisati barem jedan od kurseva kako biste mogli koristiti modul aktivnosti';
...
$string['error'] = 'Greška';
$string['errortoomanylogins'] = 'Žalimo, prekoračili ste dopušteni broj pogrešnih pristupa sistemu. Restartujte svoj web čitač i pokušajte ponovo.';
$string['errorwhenconfirming'] = 'Vaš korisnički nalog još nije još potvrđen zbog greške koja se dogodila. Ako ste kliknuli na link koji ste dobili u e-poruci, molimo proverite je li linija u kojoj se nalazi navedeni link ispravna (odnosno, je da je nije Vaš e-mail klijent možda formatirao u dva reda, čime je deo linka završio u drugom redu). Postoji mogućnost da ćete morati ručnim kopiranjem i unosom rekonstruisati originalni link.';
...
$string['existingcourseadding'] = 'Postojeći kurs, dodavanje podataka u isti';
$string['existingcoursedeleting'] = 'Postojeći kurs, brisanje istog';
...
$string['forcepasswordchange'] = 'Obavezna promenu lozinke';
...
$string['forcetheme'] = 'Obavezna tema';
...
$string['formattpicwtrck'] = 'Tematski format sa praćenjem aktivnosti';
...
Ovaj program je besplatan softver; možete vršiti njegovu distribuciju i/ili menjati ga samo pod uslovima GNU General Public License koju je objavila Free Software Foundation, verzija 2 ili (po Vašem izboru) bilo koja novija verziju.
...
$string['hiddensectionscollapsed'] = 'Skriveni odeljci su prikazani u minimalnom obliku';
...
$string['hour'] = 'sat';
$string['hours'] = 'sati';
$string['howtomakethemes'] = 'Kako napraviti nove teme';
$string['htmleditor'] = 'Upotreba HTML editora (samo neki web čitači)';
...
$string['htmleditordisabledbrowser'] = 'Upotreba HTML editora nije moguća jer Vaš web čitač nije kompatibilan s istim';
...
$string['import'] = 'Uvezi';
$string['importactivities'] = 'Uvezi aktivnosti iz drugog kursa';
$string['importdata'] = 'Uvezi podatke kursa';
...
$string['importdatafrom'] = 'Pronađite kurs iz kog želite uvesti podatke:';
$string['importgroups'] = 'Uvezi grupe';
$string['importmetacoursenote'] = 'Koristeći ovaj obrazac dodajte kurseve unutar Vašeg meta-kursa (pri čemu ćete uvesti i upisane studente)';
...
$string['lastmodified'] = 'Poslednji put izmenjeno';
...
$string['livelogs'] = 'Izveštaj o posetama u poslednjih sat vremena';
$string['locale'] = 'sr_CS.UTF-8';
$string['location'] = 'Lokacija';
$string['loggedinas'] = 'Prijavljeni ste kao $a';
$string['loggedinasguest'] = 'Trenutno koristite anonimni pristup sistemu';
$string['loggedinnot'] = 'Niste prijavljeni.';
$string['login'] = 'Pristup sistemu';
$string['login_failure_logs'] = 'Zapisi o greškama pri pristupu sistemu';
...
$string['logs'] = 'Izveštaji o posetama';
...
$string['managemeta'] = 'Je li ovo meta-kurs?';
$string['managemetadisabled'] = 'Ovaj kurs je isključen jer već pripada meta-kursu';
...
$string['maximumupload'] = 'Maksimalna veličina za učitavanje datoteka';
...
$string['metaalreadycourses'] = 'Kursevi su već dodati';
$string['metaalreadyhascourses'] = 'Ovaj meta-kurs već ima podređene kurseve.';
$string['metaalreadyhasenrolments'] = 'Ovaj kurs već ima normalno upisane studente.';
$string['metaalreadyinmeta'] = 'Ovaj kurs je već deo meta-kursa.';
$string['metaassigncourses'] = 'Dodeli kurseve';
$string['metacourse'] = 'Meta-kurs';
...
$string['modulesuccess'] = '$ tabela je ispravno podešeno';
...
$string['movefull'] = 'Premesti $a na ovo mesto';
...
$string['msnid'] = 'MSN ID';
$string['mustchangepassword'] = 'Nova lozinka mora biti različita od tekuće';
...
$string['nametpicwtrck'] = 'Tema';
$string['nameweeks'] = 'sedmica';
$string['nameweekscss'] = 'sedmica';
$string['needed'] = 'Potrebno';
$string['never'] = 'Nikad';
$string['neverdeletelogs'] = 'Nikad ne brisati zapise o posetama';
$string['new'] = 'Novo';
...
Vaši trenutni podaci za pristup sistemu su:
   korisničko ime (username): $a->username
...
U slučaju da Vam treba tehničku pomoć, molimo kontaktirajte administratora sistema,
$a->admin
...
(moraćete da promenite Vaču lozinku kada prvi put pristupite sistemu)
...
$string['nodstpresets'] = 'Administrator sistema nije omogućio Daylight Savings Time.';
$string['noexistingadmins'] = 'Ne postoji nijedan administratorski nalog, što predstavlja ozbiljnu pogrešku, a Vi ovu poruku ne biste trebali nikada videti.';
...
$string['nofilesselected'] = 'Nije izabrana nijedna datoteka za preuzimanje sadržaja.';
...
$string['noreplybouncesubject'] = '$a - vraćene e-poruke.';
$string['noreplyname'] = 'Nemojte odgovarati na ovaj e-mail';
...
$string['noteuserschangednonetocourse'] = 'Napomena: podatke o korisnicima kursa treba preuzeti iz rezervne kopije pri preuzimanju korisničkih podataka (u aktivnostima, datotekama ili porukama). Ovo podešavanje je promenjeno za Vas.';
$string['nothingnew'] = 'Nema novosti od Vaše poslednje posete';
$string['nothingtodisplay'] = 'Ništa za prikazati';
$string['noticenewerbackup'] = 'Ova datoteka sa rezervnim podacima je napravljena sa Moodle $a->backuprelease ($a->backupversion) i novija je od Vašeg trenutno instaliranog sistema Moodle $a->serverrelease ($a->serverversion). Ovo bi moglo uzrokovati određene nedoslednosti zbog toga što kompatibilnost sistema sa rezervnim kopijama kreiranim pomoću ranijih verzija ne može biti garantovana.';
$string['notifyloginfailuresmessage'] = '$a->time, IP: $a->ip, Korisnik: $a->info';
$string['notifyloginfailuresmessageend'] = 'Ove zapise o posetama možete videti na adresi  $a/course/log.php?id=1&chooselog=1&modid=site_errors.';
...
$string['now'] = 'sada';
$string['numattempts'] = '$a grešaka pri pristupu sistemu';
...
$string['outlinereport'] = 'Izveštaj u vidu kratkog pregleda';
...
$string['parentcoursenotmetacourse'] = 'Nadređeni kurs nije meta-kurs!';
...
$string['paymentrequired'] = 'Ovaj kurs zahteva plaćanje za pristup.';
...
$string['policyagree'] = 'Morate se složiti s ovim ugovorom o korišćenju da biste nastavili da koristite sajt. Da li se slažete?';
$string['policyagreement'] = 'Ugovor o korišćenju sajta';
$string['policyagreementclick'] = 'Kliknite ovde da pročitate ugovor o korišćenju sajta';
$string['popupwindow'] = 'Otvaranje datoteke u novom prozoru';
$string['post'] = 'Poruka';
$string['posts'] = 'Poruke';
$string['potentialadmins'] = 'Raspoloživi administratori';
$string['potentialcreators'] = 'Raspoloživi kreatori kursa';
$string['potentialstudents'] = 'Raspoloživi studenti';
$string['potentialteachers'] = 'Raspoloživi predavači';
$string['preferences'] = 'Preferencije';
$string['preferredlanguage'] = 'Preferirani jezik';
$string['preferredtheme'] = 'Preferirana tema';
$string['preview'] = 'Pregled';
$string['previewhtml'] = 'Pregled u HTML formatu';
$string['previeworchoose'] = 'Pregled ili izbor teme';
...
$string['readinginfofrombackup'] = 'Učitavanje informacija iz rezervne kopije podataka';
...
$string['registrationcontactno'] = 'Ne, ne želim kontaktni obrazac na popisu sajtova';
$string['registrationcontactyes'] = 'Da, prikažite obrazac kako biste me potencijalni Moodleri mogli kontaktirati';
...
$string['requestreason'] = 'Razlog za zahtev za kursom';
...
$string['restore'] = 'Preuzimanje podataka iz rezervnih kopija';
$string['restorecancelled'] = 'Preuzimanje podataka je otkazano';
$string['restorecoursenow'] = 'Preuzmite podatke za ovaj kurs upravo sada!';
$string['restorefinished'] = 'Preuzimanje podataka je uspešno završeno';
$string['restoreto'] = 'Preuzete podatke smestiti u';
...
$string['rsstype'] = 'RSS za ovu aktivnost';
...
$string['scale'] = 'Skala';
$string['scales'] = 'Skale';
$string['scalescustom'] = 'Sopstvene skale';
$string['scalescustomcreate'] = 'Dodavanje nove skale';
$string['scalescustomno'] = 'Nisu još kreirane korisničke skale za ocenjivanje';
$string['scalesstandard'] = 'Standardne skale';
$string['scalestip'] = 'Kako biste kreirali sopstvene skale za ocenjivanje, upotrebite link \'Skale...\' u Vašem meniju za administraciju kursa.';
$string['schedule'] = 'Raspored';
$string['scheduledbackupstatus'] = 'Status rasporeda kreiranja rezervnih kopija podataka';
...
$string['showtheselogs'] = 'Prikaz ovih poseta';
$string['since'] = 'Od';
...
$string['sitelogs'] = 'Zapisi o posetama';
...
$string['statsreport14'] = 'Kursevi sa najviše učešća (prikaza/postova)';
$string['statsreport2'] = 'Prikazi (predavača i studenata)';
$string['statsreport3'] = 'Postovi (predavača i studenata)';
$string['statsreport4'] = 'Ukupna aktivnost (predavača i studenata)';
$string['statsreport5'] = 'Ukupna studentska aktivnost (prikazi i postovi)';
$string['statsreport6'] = 'Ukupna aktivnost predavača (prikazi i postovi)';
$string['statsreport7'] = 'Studentska aktivnost (prikazi i postovi)';
...
$string['statsreportstudentactivity'] = 'Ukupna aktivnost studenta (prikazi i postovi)';
$string['statsreportteacheractivity'] = 'Ukupna aktivnost predavača (prikazi i postovi)';
$string['statsreporttype'] = 'Tip izveštaja';
$string['statsreportwrites'] = 'Postovi (predavača i studenata)';
$string['statsstudentactivity'] = 'Studentska aktivnost';
$string['statsstudentreads'] = 'Studentski prikazi';
$string['statsstudentwrites'] = 'Studentski postovi';
$string['statsteacheractivity'] = 'Aktivnost predavača';
$string['statsteacherreads'] = 'Prikazi predavača';
$string['statsteacherwrites'] = 'Postovi predavača';
...
$string['statsuserwrites'] = 'Postovi';
...
$string['texteditor'] = 'Koristi standardne web forme';
$string['textformat'] = 'Običan tekstualni format';
$string['thanks'] = 'Hvala';
$string['theme'] = 'Tema';
$string['themes'] = 'Teme';
$string['themesaved'] = 'Nova tema je sačuvana';
...
$string['to'] = 'Do';
$string['today'] = 'Danas';
$string['todaylogs'] = 'Današnji zapisi o posetama';
$string['toeveryone'] = 'svima';
$string['toomanybounces'] = 'Navedena adresa e-pošte je vratila previše poruka o greškama. <b>MORATE</b> je promeniti kako biste nastavili.';
...
$string['unzippingbackup'] = 'Raspakuje se rezervna kopija podataka';
$string['up'] = 'Gore';
...
$string['uploadfailednotrecovering'] = 'Učitavanje Vaših datoteka nije uspelo jer je uočen problem sa jednom od datoteka, $a->name.<br /> Ovde su zapisi o uočenim problemima:<br />$a->problem<br />Nema oporavka.';
...
$string['usemessageform'] = 'ili koristite fomu ispod da pošaljete poruku izabranim studentima';
...
$string['writingloginfo'] = 'Zapisivanje informacija o posetama';
...
$string['youaregoingtorestorefrom'] = 'Upravo ćete započeti preuzimanje podataka iz rezervne kopije za';
$string['yourlastlogin'] = 'Vaš poslednji pristup sistemu';
$string['yourself'] = 'Vi';
$string['yourteacher'] = 'Vaš $a';
$string['zippingbackup'] = 'Kreira se arhiva sa rezervnom kopijom podataka';
