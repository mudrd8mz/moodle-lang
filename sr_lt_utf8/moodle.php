...
$string['adminhelpconfiguration'] = 'Podešavanje izgleda i funkcija sajta';
$string['adminhelpconfigvariables'] = 'Podešavanje promenljivih koje utiču na opštu funkcionalnost sajta';
$string['adminhelpcourses'] = 'Odredite kurseve i kategorije i upišite polaznike u njih, uredite kurseve na čekanju';
$string['adminhelpeditorsettings'] = 'Podešavanje osnovnih opcija HTML editora';
...
$string['adminhelpsitesettings'] = 'Podešavanje izgleda početne stranice sajta';
...
$string['backupcancelled'] = 'Kreiranje rezervne kopija podataka je poništeno';
...
$string['backupfinished'] = 'Kreiranje rezervne kopije podataka je uspešno završeno';
...
$string['backupkeephelp'] = 'Koliki broj skorašnjih rezervnih kopija podataka za svaki kurs želite da čuvate? (Starije kopije biće automatski obrisane po isteku navedenog roka)';
...
$string['backupmetacoursehelp'] = 'Ako omogućite ovu opciju, informacije o meta-kursu (nasleđeni upisi) će takođe biti uključeni u automatski kreirane rezervne kopije podataka';
...
$string['backupnonisowarning'] = 'Upozorenje: ova rezervna kopija podataka je kreirana u verziji Moodle sistema koja nije podržavala Unicode (pre verzije 1.6). Ako ova rezervna kopija sadrži tekstove koji se ne slažu sa ISO-8859-1 može biti OŠTEĆENA ako pokušate da preuzmete sadržaj iz nje u ovoj Unicode Moodle verziji. Pogledajte <a href=\"http://docs.moodle.org/en/Backup_FAQ\">Backup FAQ</a>za više informacija o tome kako da pravilno uradite oporavak ove rezervne kopije.';
...
$string['noticenewerbackup'] = 'Ova datoteka sa rezervnim podacima je napravljena sa Moodle verzijom $a->backuprelease ($a->backupversion) i novija je od Vašeg trenutno instaliranog sistema Moodle $a->serverrelease ($a->serverversion). Ovo bi moglo uzrokovati određene nedoslednosti zbog toga što kompatibilnost sistema sa rezervnim kopijama kreiranim pomoću ranijih verzija ne može biti garantovana.';
