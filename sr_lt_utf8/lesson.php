...
$string['progressbarteacherwarning2'] = 'Nećete moći da vidite traku napredovanja zato što uređujete ovu lekciju';
...
$string['cannotupdateessayscore'] = 'Nije moguće ažurirati rezultat za esej'; // ORPHANED
$string['cannotdeleteanswer'] = 'Ažuriranje strane: nije moguće obrisati zapis odgovora'; // ORPHANED
$string['cannotdeleteattempt'] = 'Greška: nije moguće obrisati stare pokušaje'; // ORPHANED
$string['cannotdeletebranch'] = 'Greška: nije moguće obrisati stare viđene ogranke'; // ORPHANED
$string['cannotinsertanswer'] = 'Ne može se uneti zapis o odgovoru'; // ORPHANED
$string['cannotinsertgrade'] = 'Ne može se uneti ocena'; // ORPHANED
$string['cannotinserthighscore'] = 'Unos novog najboljeg rezultata nije uspeo!'; // ORPHANED
$string['cannotinsertpage'] = 'Ne može se uneti nova strana'; // ORPHANED
$string['cannotinserttimer'] = 'Greška: nije moguće uneti red u tabelu lesson_timer'; // ORPHANED
$string['cannotresetjump'] = 'Lesson restorelib: nije moguće resetovati skok'; // ORPHANED
$string['cannotupdateanswer'] = 'Ažuriranje strane: odgovor nije ažuriran'; // ORPHANED
$string['cannotupdatebook'] = 'Nije moguće ažurirati Vašu knjigu'; // ORPHANED
$string['cannotupdategrade'] = 'Ne može se ažurirati ocena'; // ORPHANED
$string['cannotupdatelink'] = 'Ne može se ažurirati link'; // ORPHANED
$string['cannotupdatepage'] = 'Ažuriranje strane: strana nije ažurirana'; // ORPHANED
$string['cannotupdatetimer'] = 'Greška: nije moguće ažuriranje tabele lesson_timer'; // ORPHANED
