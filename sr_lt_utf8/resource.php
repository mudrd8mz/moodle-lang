...
$string['configfilterexternalpages'] = 'Ukoliko omogućite ovo podešavanje, ono će uticati na to da svi spoljašnji resursi (veb stranice, učitane HTML datoteke) budu procesirani pomoću trenutno odabranih filtera sajta (kao što je npr. automatsko linkovanje pojmova iz rečnika). Uključivanje ove opcije može izazvati značajno usporavanje stranica Vašeg kursa - koristite ovu opciju sa oprezom i jedino ako Vam je zaista potrebna.';
$string['configframesize'] = 'Kada se učitana veb stranica ili datoteka prikaže unutar okvira, ovo će biti veličina (u pikselima) gornjeg okvira (koji sadrži navigaciju).';
...
$string['configwebsearch'] = 'Kad dodajete URL poput veb stranice ili linka na neki spoljašnji izvor informacija, ova lokacija je ponuđena kao sajt pretraživača za pomoć korisniku u potrazi za željenim URL-om.';
...
$string['fetchclienterror'] = 'Došlo je do greške u Vašem veb čitaču prilikom pokušaja učitavanja veb stranice (verovatno pogrešan URL).';
$string['fetcherror'] = 'Došlo je do greške prilikom pokušaja učitavanja veb stranice.';
$string['fetchservererror'] = 'Došlo je do greške kada je udaljeni server pokušao da učita veb stranicu (verovatno programska greška).';
...
$string['localfileinfo'] = '<p>Izaberite lokalnu datoteku Vašeg računara. Ova datoteka neće biti dodata veb sajtu, ali će <em>Moodle</em> dotičnu datoteku potražiti na računaru onoga koji posmatra resurs.</p>
...
$string['resourcetypefile'] = 'Link ka datoteci ili veb sajtu';
$string['resourcetypehtml'] = 'Veb stranica';
...
$string['searchweb'] = 'Traži veb stranicu';
