<?PHP // $Id$ 
      // block_course_contacts.php - created with Moodle 1.7 beta (2006101000)
...
$string['leaveblanktohide'] = 'ostavite prazno da biste sakrili naslov';
$string['newcontactsblock'] = '(Novi blok za kontakte kursa)';
