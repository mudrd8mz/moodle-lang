...
$string['completion-alt-auto-enabled'] = 'Sistem označava ovu stavku završenom prema uslovima';
$string['completion-alt-auto-fail'] = 'Završeno (ne zaslužuje prelaznu ocenu)';
$string['completion-alt-auto-n'] = 'Nije završeno';
...
$string['completion_manual'] = 'Korisnici mogu ručno označiti ovu stavku završenom.';
$string['completion_none'] = 'Ne prikazuj završenost aktivnosti';
$string['completiondisabled'] = 'Onemogućeno, nije prikazano u podešavanjima za aktivnost';
$string['completionenabled'] = 'Uključeno, upravlja se preko podešavanja za aktivnost';
$string['completionexpected'] = 'Očekuje se da je završeno dana';
$string['completionicons'] = 'ikone za prikaz napredovanja';
$string['completionreport'] = 'Izveštaj o napredovanju u završetku aktivnosti';
...
$string['enablecompletion'] = 'Uključi praćenje napredovanja';
$string['err_noactivities'] = 'Informacije o završetku nisu uključene za ovu aktivnost, tako da se ništa ne može prikazati. Možete uključiti informacije o završetku izmenom podešavanja za aktivnost.';
$string['err_nousers'] = 'Nema korisnika na ovom kursu ili grupe korisnika za koje se prikazuje informacija o završetku aktivnosti. (Podrazumevano, informacija o završetku prikazuje se samo za studente, tako da ako nema studenata, dobijate ovu grešku. Administratori mogu promeniti ovu opciju preko administratorskog interfejsa.)';
$string['err_system'] = 'Nastala je interna greška u sistemu. (Sistem administratori mogu uključiti prikaz informacija o programskim greškama da vide više detalja)';
$string['excelcsvdownload'] = 'Preuzmi u Excel-kompatibilnom formatu (.csv)';
$string['help_completion'] = 'Praćenje napredovanja';
$string['help_completionexpected'] = 'Datum do kog se očekuje završetak aktivnosti';
$string['help_completionlocked'] = 'zaključane opcije za završetak';
$string['help_completionview'] = 'zahteva se da pregledaju da bi završili';
