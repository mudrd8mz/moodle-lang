...
$string['allowtypeimsrepository'] = 'Omogući IMS tip paketa';
...
$string['displaycoursestructure'] = 'Prikaži strukturu kursa';
...
$string['time'] = 'Vreme';
$string['timerestrict'] = 'Ograniči davanje odgovora na ovaj vremenski period';
$string['title'] = 'Naslov';
...
$string['typeimsrepository'] = 'Lokalni repozitorijum IMS sadržaja';
$string['typelocal'] = 'Postavnjeni paket';
...
$string['updatetime'] = 'Vreme sinhronizacije';
$string['url'] = 'URL';
...
$string['zlibwarning'] = 'Upozorenje: PHP Zlib kompresija je omogućena na ovom sajtu, neki korisnici mogu mogu imati problema sa učitavanjem SCORM objekata u određenim Web čitačima.';
