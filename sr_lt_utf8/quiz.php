...
$string['attemptsallowedn'] = 'Dozvoljen broj pokušaja: $a';
...
$string['configadaptive'] = 'Ukoliko izaberete Da ѕa ovu opciju onda će studentu biti dozvoljeno da više puta odgovori na pitanja čak u okviru istog pokušaja rešavanja testa.';
$string['configattemptsallowed'] = 'Ograničenje u broju pokušaja koji su studentima dozvoljeni na testu';
...
$string['configdecimalplacesquestion'] = 'Broj cifara nakon decimalne tačke koje treba prikazati kada se pokazuju ocene za pojedinačna potanja.';
$string['configdelay1'] = 'Ukoliko podesite vremenski razmak, onda će student nakon prvog pokušaja morati toliko vremena da sačeka pre nego što bude mogao ponovo da pokuša da uradi test.';
$string['configdelay1st2nd'] = 'Ukoliko ovde podesite vremenski razmak, studenti ne mogu da drugi put urade test pre nego što ne protekne toliko vremene od njihovog prvog pokušaja.';
$string['configdelay2'] = 'Ukoliko ovde podesite vremenski razmak, onda student mora da sačeka toliko vremene da prođe pre nego što započne svoj treći (i svaki naredni) pokušaj rešavanja testa.';
$string['configdelaylater'] = 'Ukoliko ovde podesite vremenski razmak, onda student ne može da započne treći, četvrti,... pokušaj pre nego toliko vremena ne prođe od kraja prethodnog pokušaja rešavanja testa.';
...
$string['configgrademethod'] = 'Kada su višestruki pokušaji dozvoljeni koji metod treba koristiti za izračunavanje studentove završne ocene za test.';
...
$string['configrequirepassword'] = 'Studenti moraju da unese ovu lozinku pre nego što pokušaju da reši test.';
$string['configrequiresubnet'] = 'Studenti mogu da pokušaju da reše test samo sa ovih računara.';
...
$string['configshufflequestions'] = 'Ukoliko omogućite ovu opciju, onda će redosled pitanja u testu će nasumično izmešan svaki put kada student pokuša da reši test.';
$string['configshufflewithin'] = 'Ako omogućote ovu opciju, onda će delovi koji sačinjavaju pojedinačno pitanje biti nasumočno izmešani svaki put kada student započne da rešava ovaj test. Ponuđena opcija je takođe uključenlj u podešavaljima pitanja.';
$string['configtimelimit'] = 'Podraumevano vremensko ograničenje za testove u minutima. 0 znači da nema vremenskog ograničenja.';
...
$string['createcategoryfornewrandomquestion'] = 'Kreiraj novu kategoriju pitanja za novo nasumično odabrano pitanje';
...
$string['qti_two'] = 'MS QTI 2.0 format';
...
$string['subnetwrong'] = 'Ovom testu moguće je pristupiti samo sa određenih lokacija, a ovaj računar nije na spisku dozvoljenih lokacija.';
...
$string['totalpointsx'] = 'Ukupno ocena: $a';
...
$string['youcannotwait'] = 'Ovaj test se zatvara pre nego što će Vam biti dozvoljeno da počnete novi pokušaj.';
$string['youmustwait'] = 'Morate sačekati pre nego što budete mogli da ponovo pokušate rešavanje testa. Biće Vam dozvoljeno da započnete novi pokušaj posle $a.';
...
$string['qti2'] = 'IMS QTI 2.0 format'; // ORPHANED
