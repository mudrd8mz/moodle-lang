...
$string['configallowcoursethemes'] = 'Ukoliko omogućite ovo podešavanje, kursevima će biti dozvoljeno da podese sopstveni opšti izgled. Opšti izgled kursa ima prvenstvo u odnosu na sve ostale podešene izglede (sajta, korisnika itd.).';
...
$string['configallowuserthemes'] = 'Ukoliko omogućite ovo podešavanje, korisnicima će biti dozvoljeno da sami podese opšti izgled sajta po želji. Podešavanja opšteg izgleda sajta pojedinačnog korisnika imaju prednost u odnosu na podrazumevani opšti izgled sajta (ali ne i u odnosu na eventualno podešeni opšti izgled kurseva).';
...
$string['configclamfailureonupload'] = 'Kako da se ponaša Clam AV, konfigurisan da skenira učitane datoteke, kada zbog loše konfiguracije ili iz nekog nepoznatog razloga ne uspe da se pokrene? Ako izaberete opciju \"Tretiraj datoteke viruse\" datoteke će biti premeštene u \"karantin\" ili obrisane. Ukoliko izaberete opciju \"Tretiraj datoteke normalno\" datoteke će biti premeštene u odredišni direktorijum na uobičajen način U oba slučaja administrator će biti obavešten da je Clam prijavio grešku prilikom startovanja. Ukoliko izaberete opciju \"Tretiraj datoteke kao viruse\", u slučaju da iz bilo kog razloga Clam ne bude pokrenut (obično zbog pogrešno podešene putanje do njega), SVE učitane datoteke biće premeštene u \"karantin\" ili obrisane. Budite obazrivi sa ovim podešavanjem.';
...
$string['configenablerssfeeds'] = 'Ova opcija omogućava korišćenje RSS servisa na čitavom sajtu. Da bi ste mogli stvarno da koristite RSS neophodno je, takođe, da njegovo korišćenje omogućite u pojedinačnim modulima - idite na podešavanjа modula u okviru administratorske konfiguracije.';
$string['configenablerssfeedsdisabled'] = 'RSS servis nije dostupan, zato što njegovo korišćenje nije omogućeno na nivou celog sajta. Da bi ste omogućili korišćenje RSS-a, idite na podešavanja promenljivih u okviru administratorske konfiguracije.';
...
$string['configperfdebug'] = 'Ako ovo uključite, informacije o performansama biće prikazane u podnožju standardnog opšteg izgleda sajta';
...
$string['configthemelist'] = 'Ostavite ovo polje prazno da biste dozvolili upotrebu bilo kog opšteg izgleda sajta. Ukoliko želite da skratite listu opštih izgleda, navedite ovde željene nazive razdvojene zarezima (Nemojte koristiti razmake!). 
...
$string['helpcalendarsettings'] = 'Konfigurišite različite aspekte Moodle sistema koji se odnose na kalendar i datum/vreme';
...
$string['mediapluginswfnote'] = 'Prema podrazumevanoj meri sigurnosti, običnim korisnicima se ne dozvoljava da prilažu swf flash datoteke.';
