...
$string['configcachetype'] = 'Odaberite vrstu keša koju koristi Mudle. Ovo će samo podesiti keš, ne treba zaboraviti uključiti rcache tako da je omogućeno korišćenje keša. Koristite <strong>samo</strong> ukoliko želite da smanjite učitavanje sistema baze podataka -- inače, Mudle će raditi sporije. Sajtovi sa srednjim protokom mogu dobiti poboljšanje upotrebom \'internal\'. Vebserveri sa instaliranim eAcceleratorom ili Turckmmcacheom <em>sa uključenom opcijom za deljenje memorije</em> treba da probaju \'eaccelerator\'. Ukoliko imate više-serversku radnu stanicu, posedujete jedan ili više pokrenutih memkeš demona i PHP-memkeš ekstenziju, selektujte \'memcached\' i konfigurišite njegove opcije. <br /><strong>Zapazite:</strong> obratite pažnju da testirate performanse pod opterećenjem i podešavate opcije u hodu -- keš može usporiti vaš sajt. U situacijama gde postoji veliki protok, eAccelerator i memcached mogu dovesti do poboljšanja, ali će CPU biti opterećeniji.';
...
$string['configcronclionly'] = 'Ukoliko je ovo uključeno, onda se cron skripta može pokrenuti samo iz komandne linije umesto preko veba. Ovo će zameniti cron password podešavanje.';
$string['configcronremotepassword'] = 'Ovo znači da se cron.php skripta ne može pokrenuti iz veb čitača bez dostavljanja šifre koristeći datu URL formu:<pre> http://site.example.com/admin/cron.php?password=opensesame</pre>. Ukoliko je ovo ostavljeno prazno, šifra nije potrebna.';
...
$string['configsupportname'] = 'Ovo je ime osobe/organizacije zadužene za pružanje opšte pomoći korisnicima putem elektronske pošte ili veb sajta.';
$string['configsupportpage'] = 'Ova veb adresa će se prikazivati korisnicima sajta kao ona koju treba posetiti u slučaju da im zatreba neka opšta pomoć (na primer kad novi korisnici kreiraju svoje naloge). Ako se ne popuni ovo polje, takav link neće biti dostupan.';
...
$string['supportpage'] = 'Veb stranica za podršku';
