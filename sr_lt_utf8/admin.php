<?PHP // $Id$ 
      // admin.php - created with Moodle 1.9 Beta 4 (2007101508.05)
...
$string['configcachetype'] = 'Odaberite vrstu keša koju koristi Mudle. Ovo će samo podesiti keš, ne treba zaboraviti uključiti rcache tako da je omogućeno korišćenje keša. Koristite <strong>samo</strong> ukoliko želite da smanjite učitavanje sistema baze podataka -- inače, Mudle će raditi sporije. Sajtovi sa srednjim protokom mogu dobiti poboljšanje upotrebom \'internal\'. Webserveri sa instaliranim eAcceleratorom ili Turckmmcacheom <em>sa uključenom opcijom za deljenje memorije</em> treba da probaju \'eaccelerator\'. Ukoliko imate više-serversku radnu stanicu, posedujete jedan ili više pokrenutih memkeš demona i PHP-memkeš ekstenziju, selektujte \'memcached\' i konfigurišite njegove opcije. <br /><strong>Zapazite:</strong> obratite pažnju da testirate performanse pod opterećenjem i podešavate opcije u hodu -- keš može usporiti vaš sajt. U situacijama gde postoji veliki protok, eAccelerator i memcached mogu dovesti do poboljšanja, ali će CPU biti opterećeniji.';
