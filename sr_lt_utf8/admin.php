...
$string['badwordsconfig'] = 'Unesi listu ružnih reči odvojenih zarezima.';
$string['badwordsdefault'] = 'Ako je Vaša lista prazna, biće korišćena standardna lista jezičkog paketa.';
...
$string['configallowcoursethemes'] = 'Ukoliko omogućite ovo podešavanje, kursevima će biti dozvoljeno da podese sopstveni vizuelni izgled (temu). Tema kursa ima prvenstvo u odnosu na sve ostale podešene teme (sajta, korisnika itd.).';
...
$string['configallowobjectembed'] = 'Kao podrazumevana mera sigurnosti, krajnjim korisnicima nije dozvoljeno umetanje multimedijalnih sadržaja (poput Flash animacija) unutar teksta eksplicitno korišćenjem oznaka EMBED i OBJECT unutar HTML koda (iako je to i dalje moguće izvesti na sigurniji način putem mediaplugins filtera). Želite li ipak dozvoliti upotrebu ovih oznaka, uključite ovu opciju.';
$string['configallowunenroll'] = 'Ukoliko je ovo podešavanje postavljeno na \"Da\", onda će studentima biti omogućeno da se sami ispisuju sa kurseva po svom nahođenju. U suprotnom to im neće biti dozvoljeno i ovaj proces kontrolisaće isključivo predavači i administratori.';
$string['configallowuserblockhiding'] = 'Da li želite da korisnicima omogućite da sami  skrivaju/prikazuju blokove na ovom sajtu? Ovo svojstvo koristi Java skript i \"kolačiće\" kako bi se zapamtilo trenutno stanje blokova, i utiče jedino na izgled sajta pojedinačnog korisnika.';
$string['configallowusermailcharset'] = 'Aktiviranjem ove opcije svaki korisnik će dobiti mogućnost definisanja sopstvenog seta karaktera za elektronsku poštu.';
$string['configallowuserthemes'] = 'Ukoliko omogućite ovo podešavanje, korisnicima će biti dozvoljeno da sami podese temu po želji. Teme korisnika imaju prvenstvo u odnosu na temu sajta (ali ne i u odnosu na teme kurseva).';
$string['configallusersaresitestudents'] = 'Za aktivnosti na početnoj stranici sajta, da li se SVI korisnici smatraju studentima? Ukoliko je odgovor \"Da\", onda će svakom korisniku sa otvorenim nalogom biti dozvoljeno da kao student učestvuje u tim aktivnostima. Ukoliko je odgovor \"Ne\", onda će samo oni korisnici koji su upisani na najmanje jedan kurs moći da učestvuju u aktivnostima na početnoj strani. Samo administratori i posebno određeni predavači mogu da budu moderatori tih aktivnosti.';
...
$string['configcachetext'] = 'Za obimnije sajtove, odnosno sajtove koje koriste tekstualne filtere ovo podešavanje može da ubrza rad. Kopije tekstova biće zadržane u svom obrađenom obliku u vremenskom intervalu koji ovde odredite. Zadavanje premale vrednosti ovoj postavci bi moglo donekle usporiti rad, a zadavanje prevelike vrednosti bi moglo rezultirati time da tekstovima treba previše vremena za osvežavanje (npr. s novim linkovima).';
$string['configclamactlikevirus'] = 'Tretiraj datoteke kao viruse';
$string['configclamdonothing'] = 'Tretiraj datoteke normalno';
$string['configclamfailureonupload'] = 'Kako da se ponaša Clam AV, podešen da skenira učitane datoteke, kada zbog loše konfiguracije ili iz nekog nepoznatog razloga ne uspe da se pokrene? Ako izaberete opciju \"Tretiraj datoteke viruse\" datoteke će biti premeštene u \"karantin\" ili obrisane. Ukoliko izaberete opciju \"Tretiraj datoteke normalno\" datoteke će biti premeštene u odredišni direktorijum na uobičajen način U oba slučaja administrator će biti obavešten da je Clam prijavio grešku prilikom startovanja. Ukoliko izaberete opciju \"Tretiraj datoteke kao viruse\", u slučaju da iz bilo kog razloga Clam ne bude pokrenut (obično zbog pogrešno zadate putanje do njega), SVE učitane datoteke biće premeštene u \"karantin\" ili obrisane. Budite obazrivi sa ovim podešavanjem.';
...
$string['configdeleteunconfirmed'] = 'Ukoliko koristite potvrdu autentičnosti putem elektronske pošte, ovo je vremenski rok unutar kog će biti prihvaćena potvrda od strane korisnika. Nakon tog perioda svi nepotvrđeni nalozi biće obrisani.';
...
$string['configdisplayloginfailures'] = 'Koji korisnici mogu da vide informacije o prethodnim neuspešnim pristupima sistemu.';
...
$string['configenablerssfeeds'] = 'Ova opcija omogućava korišćenje RSS servisa na čitavom sajtu. Da bi ste mogli stvarno da koristite RSS neophodno je, takođe, da njegovo korišćenje omogućite u pojedinačnim modulima - idite na stranicu za administraciju i pronađite opciju za podešavanje modula.';
$string['configenablerssfeedsdisabled'] = 'RSS servis nije dostupan, zato što njegovo korišćenje nije omogućeno na nivou celog sajta. Da bi ste omogućili korišćenje RSS-a, idite na stranicu za podešavanje promenljivih u okviru administracije sajta.';
$string['configenablestats'] = 'Ako ovde izaberete opciju \"Da\", cronjob Vašeg Moodle sistema će procesirati zapise o posetama i prikupiti neke statističke informacije. U zavisnosti od količine saobraćaja na Vašem sajtu, to može prilično da potraje. Ako ovo omogućite, moći ćete da vidite neke zanimljive grafikone i statističke izveštaje o svakom od Vaših kurseva, ili pak na nivou celog sajta.';
$string['configenrolmentplugins'] = 'Molimo izaberite dodatke za upis koje želite da koristite. Nemojte zaboraviti da pravilno podesite sve opcije.<br /><br />Morate da navedete koji su dodaci omogućeni, i <strong>jedan</strong> od njih može biti podešen kao podrazumevani dodatak za <em>interaktivne</em> upise. Da biste onemogućili interaktivne upise, podesite opciju koja određuje da li su mogući upisi na \"Ne\" u kursevima za koje to želite.';
...
$string['configfilteruploadedfiles'] = 'Procesiranje svih učitanih HTML i tekstualnih datoteka filterima pre njihovog prikazivanja, procesiranje samo učitanih HTML datoteka ili bez procesiranja.';
...
$string['configforceloginforprofiles'] = 'Omogućite ovo podešavanje kako bi se primorali korisnike da se prijave sa pravim nalozima (ne kao gosti) pre nego što vide stranice sa korisničkim profilima. Ova opcija je obično onemogućena (podrazumevana vrednost je \"netačno\") kako bi potencijalni studenti mogli da pročitaju nešto više o predavačima svakog kursa. Ovo, u isto vreme znači, da će ove strane moći da vide i pretraživači.';
...
$string['configintroadmin'] = 'Na ovoj strani bi trebalo da konfigurišite Vaš glavni administratorski nalog koji će imati potpunu kontrolu nad čitavim sajtom. Uverite se da ste nalogu dodelili pouzdano korisničko ime i lozinku, kao i ispravnu elektronsku adresu. Kasnije možete kreirati dodatne administratorske naloge.';
$string['configintrosite'] = 'Putem ove stranice možete podesiti izgled početne stranice i naziv sajta. Na nju se možete vratiti kasnije kako biste promenili ta podešavanja tako što ćete koristiti link za podešavanje sajta sa naslovne stranice.';
...
$string['configloglifetime'] = 'Ovo podešavanje određuje koliko dugo želite da čuvate zapise o aktivnostima korisnika. Zapisi koji su stariji biće automatski obrisani. Najbolje je da zapise čuvate što je moguće duže, u slučaju da Vam zatrebaju, ali ukoliko imate jako opterećen server i ukoliko iskusite probleme sa njegovim performansama možete skratiti vremenski period čuvanja zapisa.';
...
$string['configmaxbytes'] = 'Određuje maksimalnu veličinu učitanih datoteka na nivou celog sajta. Vrednosti ovog podešavanja su ograničene PHP podešavanjima post_max_size i upload_max_filesize, kao i Apache podešavanjem LimitRequestBody. Za uzvrat, maxbytes ograničava opseg veličina koje se mogu birati na nivou kursa ili modula.';
...
$string['configperfdebug'] = 'Ako ovo uključite, informacije o performansama biće prikazane u podnožju standardne teme';
...
$string['configrestrictmodulesfor'] = 'Koji kursevi bi trebali imati <b>podešavanje</b> za onemogućavanje nekih modula aktivnosti? Primetite da se to odnosi samo na akcije predavača, administratori će još uvek moći da dodaju bilo koju aktivnost tim kursevima.';
$string['configrunclamonupload'] = 'Koristiti Clam AV pri učitavanju datoteka? Da bi ovo  podešavanje uspešno radilo, morate navesti tačnu putanju do direktorijuma u kojem se nalazi Clam AV. (Clam AV je BESPLATNI antivirusni softver koji možete preuzeti sa http://www.clamav.net/)';
...
$string['configsecureforms'] = 'Moodle može da koristi dodatni nivo zaštite kada prima podatke iz web formi. Ukoliko je to omogućeno, onda se HTTP_REFERER promenljiva web čitača upoređuje sa tekućom adresom forme. U veoma malom broju slučajeva to može prouzrokavati probleme ako korisnik upotrebljava \"zaštitni zid\" (npr. Zonealarm) konfigurisan tako da uklanja HTTP_REFERER promenljivu iz web saobraćaja. Posledica toga je tzv. \"zaglavljivanje u formi\". Ukoliko Vaši korisnici imaju problema, na primer, sa stranicom za prijavu, možda ćete želeti da onemogućite ovo podešavanje, iako će to Vaš sajt učiniti daleko osetljivijim na hakerske napade razbijanja lozinki grubom silom. Ukoliko ste u dilemi, omogućite ovu opciju.';
$string['configsessioncookie'] = 'Ovo podešavanje prilagođava ime \"kolačića\" za Moodle sesije. Podešavanje je opciono i korisno je samo da bi se izbegla mešanje \"kolačića\", u situaciji kada je u okviru istog web sajta pokrenuto više od jedne kopije Moodle-a.';
$string['configsessioncookiepath'] = 'Ako treba da promenite lokaciju na koju Moodle šalje \"kolačiće\", možete promeniti ovo podešavanje tako da specificira neki od poddirektorijuma na Vašem sajtu. U suprotnom, podrazumevana vrednost \'/\' bi trebala biti sasvim prihvatljiva.';
...
$string['configshowsiteparticipantslist'] = 'Svi studenti i svi predavači biće na listi korisnika sajta. Kome će biti dozvoljeno da vidi tu listu?';
...
$string['configthemelist'] = 'Ostavite ovo polje prazno da biste dozvolili da bilo koja tema bude upotrebljena. Ukoliko želite da skratite listu tema, navedite ovde željene nazive razdvojene zarezima (Nemojte koristiti razmake!).
...
$string['upgradelogs'] = 'Zbog potpune fukcionalnosti, Vaši stari zapisi o pristupima moraju biti nadograđeni. <a href=\"$a\">Više informacija</a>';
$string['upgradelogsinfo'] = 'Nedavno su napravljene određene promene u pogledu čuvanja zapisa o posetama sajtu. Da biste mogli videti sve Vaše stare zapise na bazi aktivnosti, treba da ih ažurirate. Zavisno od sajta, takva akcija može trajati dugo (i do nekoliko sati) i može opteretiti bazu podataka na velikim sajtovima. Ako započnete ovaj proces, onda treba da ga pustite da se završi (tako što ćete prozor web čitača ostaviti otvoren). Ne brinite - Vaš sajt će i dalje dobro raditi za korisnike u momentu dok se zapisi ažuriraju.<br /><br />Da li želite da ažurirate zapise o posetama?';
...
$string['upgradinglogs'] = 'Ažuriranje zapisa o posetama je u toku';
