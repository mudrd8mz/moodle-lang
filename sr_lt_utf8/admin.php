...
$string['allowthemechangeonurl'] = 'Dozvoli promenu šeme izgleda u URL adresi';
...
$string['cannotdeletemissingqtype'] = 'Ne možete da obrišete nedostajući tip pitanja. Ovaj tip je potreban sistemu.';
...
$string['commonfiltersettings'] = 'Zajednička podešnjvanja filtera';
...
$string['configallowthemechangeonurl'] = 'Ukoliko uključite ovo podešavanje, onda šema izgleda može biti promenjena dodavanjem theme={themename}&amp;sesskey={sesskey} bilo kojoj Moodle URL adresi.';
...
$string['configdebugstringids'] = 'Ova opcija je dizajnirana da pomogne prevodiocima. Ona pokazuje jezičku datoteku i id izraza pored svakog ispisanog izraza (Menjanje ovog podešavanja će imati efekta jedino kada se učita naredns stranica.)';
...
$string['configmaxconsecutiveidentchars'] = 'Loѕinke ne smeju imati više od ovog broja istotvetnih karaktera za redom. Upotrebite 0 kako biste isključiki ovu opciju';
...
$string['configuseexternalyui'] = 'Umesto korišćenja lokalnih datoteka, koristite datoteke na mreži dostupne na Yahoo&#145;s serverima. UPOZORENJE: Ovo zahteva Internt konekciju, ili uopšte neće raditi AJAX na Vašem sajtu.';
...
$string['defaulthtmleditor'] = 'Podrazumevani HTML editor';
...
$string['deletefilterareyousure'] = 'Da li ste sigurni da želite da obrišete filter \'$a\'';
$string['deletefilterareyousuremessage'] = 'Spremni ste da u potpunosti obrišete filter \'$a\'. Da li ste sigurni da želite da ga deinstalirate.';
$string['deletefilterfiles'] = 'Svi podaci asocirani sa filterom \'$a->filter\' su izbrisani iz baze podataka. Da bi se zavšili brisanje (i sprečili ponovno instaliranje samog filter), morate sada da obrišete sa servera ovaj direktorijum: $a->directory';
$string['deleteincompleteusers'] = 'Brisanje nepotpunih korisnika posle';
$string['deleteqtypeareyousure'] = 'Da li ste sigurni da želite da obrišete tip pitanja\'$a\'';
$string['deleteqtypeareyousuremessage'] = 'Spremate se da kompletno obrišete tip pitanja \'$a\'. Da li ste sigurni da deinstalirate ovaj tip pitanja?';
$string['deleteunconfirmed'] = 'Obrisati nepotvrđene korisnike nakon';
$string['deleteuser'] = 'Brisanje korisnika';
$string['deletingfilter'] = 'Brisanje filtera \'$a\'';
...
$string['frontpageoverrides'] = 'Promena ovlašćenja na naslovnoj stranici';
...
$string['helpprofilefieldlink'] = 'Kreiraj link od podataka korisnika.';
...
$string['invalidlangpack'] = 'kako bi uredili jezički paket, potrebno je da ga postavite u direktorijum za jezike.';
...
$string['ipblocker'] = 'Bloker IP adresâ';
...
$string['ipwhitelist'] = 'IP bela lista';
$string['ipwhitelistdesc'] = 'Kada je prazna, samo je IP adresi koja je ovde podešena dozvoljeno da koristi Web servise sa korisničkim imenom: <strong>$a->username</strong>';
...
$string['managews'] = 'Upravljanje Web servisima';
...
$string['qtypedeletefiles'] = 'Svi podaci pridruženi tipu pitanja \'$a->qtype\' su obrisani iz baze podataka. Da biste završili brisanje (i sprečili da se taj tip pitanja sam reinstalira), morate da obrišete ovaj direktorijum sa Vašeg servera: $a->directory';
...
<br/><br/>Ova promena utiče na sledeće baze podatak u Vašem sistemu: (Molimo Bas da sada sačuvate ovaj spisak i, nakon završene nadogradnje sistema, proverite da li ove aktivnosti i dalje rade onako kako su to predavači planirali.)<br/><strong>$a->text</strong><br/>';
...
$string['webserviceprotocols'] = 'Web server servisa';
$string['webservices'] = 'Web servisi';
$string['webservicesystemsettings'] = 'opšra podešavanja';
$string['webserviceusersettings'] = 'Korisnička podešavanja Web servisa';
