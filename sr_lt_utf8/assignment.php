<?PHP // $Id$ 
      // assignment.php - created with Moodle 1.9.2+ (Build: 20080806) (2007101521)


$string['allowdeleting'] = 'Dozvoliti brisanje';
$string['allowmaxfiles'] = 'Maksimalan broj postavljenih datoteka';
$string['allownotes'] = 'Dozvoliti beleške';
$string['allowresubmit'] = 'Dozvoliti ponovno predavanje zadatka';
$string['alreadygraded'] = 'Vaš zadatak je već ocenjen i ponovno rešavanje zadatka nije dozvoljeno.';
$string['assignment:exportownsubmission'] = 'Izvezi sopstvena rešenja';
...
$string['cannotinsertempty'] = 'Nije se moglo uneti novo prazno rešenje';
...
$string['configshowrecentsubmissions'] = 'Svi mogu da vide obaveštenje o predatim zadacima u izveštaju o skorašnjim aktivnostima.';
$string['confirmdeletefile'] = 'Da li ste potpuno sigurni da želite da obrišete ovu datoteku?<br /><strong>$a</strong>';
$string['coursemisconf'] = 'Kurs je loše podešen';
$string['deleteallsubmissions'] = 'Obriši sva predata rešenja zadatka';
...
$string['enableemailnotification'] = 'Pošalji obaveštenje putem e-pošte';
...
$string['finalize'] = 'Nema više rešenja';
$string['finalizeerror'] = 'Došlo je do greške i to rešenje se nije moglo dovršiti';
...
$string['invalidid'] = 'ID zadatka je bio neispravan';
...
$string['nomoresubmissions'] = 'Nije moguća dalja predaja zadatka.';
$string['nosubmitusers'] = 'Nema korisnika kojima je dozvoljeno da predaju ovaj zadatak';
$string['notavailableyet'] = 'Žao nam je, ali ovaj zadatak još nije dostupan.<br />Uputstva za njegovo rešavanje će biti prikazana na ovom mestu od datuma navedenog ispod.';
...
$string['overwritewarning'] = 'Upozorenje: postavljanje nove datoteke će ZAMENITI Vaše prethodno predato rešenje';
$string['pagesize'] = 'Predatih rešenja po strani';
$string['preventlate'] = 'Zabraniti kašnjenje';
...
$string['showrecentsubmissions'] = 'Prikaži skoro predate zadatke';
$string['submission'] = 'Rešenje';
$string['submissiondraft'] = 'Nacrt rešenja';
...
$string['submitedformarking'] = 'Rešenje zadatka je već predato na ocenjivanje i ne može biti ažurirano';
...
$string['trackdrafts'] = 'Uključi Pošalji za ocenjivanje';
...
$string['unfinalize'] = 'Vratiti na status nacrta';
$string['unfinalizeerror'] = 'Došlo je do greške i to rešenje se nije moglo vratiti na privremeno zapamćeni sadržaj';
...
$string['uploadfailnoupdate'] = 'Postavljanje datoteke je prošlo uspešno, ali nije bilo moguće zameniti Vaše prethodno rešenje!';
...
$string['uploadnotregistered'] = 'Postavljanje datoteke \'$a\' je uspešno obavljeno, ali rešenje nije registrovano!';
$string['uploadsuccess'] = 'Postavljanje datoteke \'$a\' je uspešno obavljeno';
$string['usermisconf'] = 'Korisnik je loše podešen';
$string['viewfeedback'] = 'Prikaz ocena i povratnih informacija';
$string['viewsubmissions'] = 'Pregled predatih rešenja (trenutno: $a)';
