...
$string['configenablenotes'] = 'Omogućite pohranjivanje beleški o individualnim korisnicima';
...
$string['enablenotes'] = 'Omoguću beleške';
...
$string['notesdisabled'] = 'Oprostite, belešle nisu omogućene';
$string['notesnotvisible'] = 'Nije vam dozvoljeno da vidite beleške';
$string['nouser'] = 'Morate da odaberete korisnika';
$string['personal'] = 'lično';
$string['personalnotes'] = 'Lične poruke';
$string['publishstate'] = 'Status';
$string['site'] = 'sajt';
$string['sitenotes'] = 'Beleške sa sajta';
$string['unknown'] = 'nepoznato';
$string['abovenormal'] = 'iznad proseka'; // ORPHANED
$string['belownormal'] = 'ispod proseka'; // ORPHANED
$string['high'] = 'visok'; // ORPHANED
$string['low'] = 'nizak'; // ORPHANED
$string['normal'] = 'normalno'; // ORPHANED
$string['rating'] = 'Ocena'; // ORPHANED
