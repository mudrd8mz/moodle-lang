...
$string['appointmentlocation'] = 'Mesto sastanka';
$string['appointmentname'] = 'Tema sastanka';
$string['date'] = 'Datum sastanka';
$string['description'] = 'Opis';
$string['early'] = '$a ranije';
$string['failedupdatefeedback'] = 'Ažuriranje povratnih informacija za predati sastanak korisnika $a nije uspelo';
$string['feedback'] = 'Povratne informacije';
$string['feedbackupdated'] = 'Povratne informacije predatih sastanaka ažurirane su za $a korisnika';
