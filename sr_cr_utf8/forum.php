...
$string['configenabletimedposts'] = 'Изаберите \"да\" ако желите да дозволите подешавање периода за приказ приликом постављања нове форумске дискусије (експериментално, пошто још увек није потпуно тестирано).';
