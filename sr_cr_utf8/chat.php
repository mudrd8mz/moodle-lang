...
$string['configrefreshroom'] = 'Колико често би се причаоница требала освежавати? (у секундама) Подешавање на низак ниво омогућава да причаоница изгледа брже, али може представљати веће оптерећење за Ваш web сервер кад је у причаоницама присутан већи број људи. Ако користите <em>Stream</em> ажурирање, можете изабрати више френквенције освежавања -- пробајте са 2 секунде.';
...
$string['messagebeepseveryone'] = '$a сигнализира свима!';
$string['messagebeepsyou'] = '$a Вам је управо послао звучни сигнал!';
