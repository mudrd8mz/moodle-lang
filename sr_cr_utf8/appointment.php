...
$string['appointmentdetails'] = 'Детаљи о састанку';
$string['appointmentlocation'] = 'Место састанка';
$string['appointmentname'] = 'Тема састанка';
$string['date'] = 'Датум састанка';
$string['description'] = 'Опис';
$string['early'] = '$a раније';
$string['failedupdatefeedback'] = 'Ажурирање повратних информација за предати састанак корисника $a није успело';
$string['feedback'] = 'Повратне информације';
$string['feedbackupdated'] = 'Повратне информације предатих састанака ажуриране су за $a корисника';
$string['late'] = '$a касније';
$string['maximumgrade'] = 'Максимална оцена';
$string['maximumsize'] = 'Максимална величина';
$string['modulename'] = 'Састанак';
$string['modulenameplural'] = 'Састанци';
...
$string['submitappointment'] = 'Предајтe свој састанак користећи ову форму';
...
$string['uploadfiletoobig'] = 'Жао нам је, али датотека је превелика (лимит је $a бајта)';
