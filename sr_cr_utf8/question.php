...
$string['cannotimportformat'] = 'Опростите, уноз овог формата још није имплементиран!';
$string['cannotinsertquestion'] = 'Није могуће убацити ново питање!';
$string['cannotloadquestion'] = 'Није могуће учитати питање';
$string['cannotmovequestion'] = 'Не можете да користите овај скрипт за пребацивање питања која са собом имају придружене датотеке из различитих подручја.';
$string['cannotopenforwriting'] = 'Није могуће отворити за уписивање: $a';
$string['cannotpreview'] = 'Не можете да прегледате ова питања!';
$string['cannotretrieveqcat'] = 'Можете повратити ову категорију питања';
...
$string['clicktoflag'] = 'Обележи ово питање индикаторпм (заставицом)';
...
$string['emptyxml'] = 'Непозната грешја - празна imsmanifest.xml датотека';
...
$string['errorduringpost'] = 'Појавила се грешка у току пост-процесирања!';
$string['errorduringpre'] = 'Појавила се грешка у току пре-процесирања!';
$string['errorduringproc'] = 'Појавила се грешка у току процесирања!';
...
$string['errorpostprocess'] = 'Појавила се грешка у току пост-процесирања!';
$string['errorpreprocess'] = 'Појавила се грешка у току пре-процесирања!';
$string['errorprocess'] = 'Појавила се грешка у току процесирања!';
...
$string['impossiblechar'] = 'Откривен је немогући карактер $a као знак за заграде';
...
$string['notflagged'] = 'Није обележено';
$string['parenthesisinproperclose'] = 'заграде пре ** нису правилно затворене у $a*';
$string['parenthesisinproperstart'] = 'заграде пре ** нису правилно отворене у $a*';
...
$string['saveflags'] = 'Сачувај стање индиткатора (заставица)';
