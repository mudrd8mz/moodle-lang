<?PHP // $Id$ 
      // enrol_authorize.php - created with Moodle 1.9.2 (Build: 20080711) (2007101520)
...
$string['adminauthcode'] = 'Уколико кредитна картица корисника не може';
...
$string['allpendingorders'] = 'Нарџбине које су у току.';
$string['amount'] = 'Износ';
...
$string['logininfo'] = 'Корисничко име, шифра и кључ ѕа трансакцију нису приказани током мера предострожности.Нема потребе да их уносите опет ако сте их унели раније.Видите зелено обојен текст уколико су нека поља већ попуњена.Ако попуњавате ова поља по први пут, корисничко име (*) је обавезно и морате унети <strong>either</strong> кључ трансакције (#1) <strong>or</strong> шифра  (#2)у одговарајућем пољу.Препоручујемо вам да унесете кључ трансакције током мера предострожности.Ако желите да обришете тренутну шифру, обележите поље ѕа потврду.';
...
$string['verifyaccountresult'] = 'Резултат провере: $a';
$string['void'] = 'Ништа';
