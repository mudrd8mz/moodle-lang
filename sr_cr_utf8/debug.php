...
$string['cannotupdateversion'] = 'Ажурирање НИЈЕ УСПЕЛО! (Не може се ажурирати верзија у конфигурационој табели)';
$string['cannotupgradecapabilities'] = 'Било је проблема у ажурирању главних могућности Система улога.';
$string['cannotupgradedbcustom'] = 'Ажурирање прилагођавања локалне базе података није успело! (Не може се ажурирати верзија у конфигурационој табели)';
$string['configmoodle'] = 'Moodle још увек није конфигурисан. Морате уредити прво config.php.';
$string['dbnotinsert'] = 'Грешка у бази података - унос није могућ ($a)';
$string['dbnotsetup'] = 'Грешка: Главне базе података НИСУ успешно постављене.';
$string['dbnotsupport'] = 'Грешка: Ваша база података ($a) још увек није потпуно подржана у Moodle-у или није присутна датотека install.xml. Видети директоријум lib/db.';
...
$string['noblockbase'] = 'Класа block_base није дефинисана или датотека није пронађена за /blocks/moodleblock.class.php';
$string['noblocks'] = 'Нема инсталираних блокова!';
$string['nocaps'] = 'Грешка: нема дефинисаних могућности!';
...
$string['prefixcannotbeempty'] = 'Префикс имена табеле \"$a[0]\" не сме бити празан за Вашу одредишну базу података ($a[1])';
$string['prefixlimit'] = 'Максимална дозвољена дужина префикса имена табеле \"$a\" за Oracle базе података је 2cc.';
