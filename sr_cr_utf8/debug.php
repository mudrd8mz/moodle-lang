...
$string['codingerror'] = 'Откривена је грешка у коду коју мора да исправи програмер: $a';
$string['configmoodle'] = 'Moodle још увек није конфигурисан. Морате уредити прво config.php.';
...
$string['noactivityname'] = 'Објект странице добијен из page_generic_activity, али није дефинисано  \$this->activityname';
$string['noadminrole'] = 'Не може се наћи улога администратора';
$string['noblocks'] = 'Нема инсталираних блокова!';
$string['nocate'] = 'Нема категорија!';
$string['nomodules'] = 'Није пронађен ниједан модул!';
...
$string['cannotupdateversion'] = 'Ажурирање НИЈЕ УСПЕЛО! (Не може се ажурирати верзија у конфигурационој табели)'; // ORPHANED
$string['cannotupgradecapabilities'] = 'Било је проблема у ажурирању главних могућности Система улога.'; // ORPHANED
$string['cannotupgradedbcustom'] = 'Ажурирање прилагођавања локалне базе података није успело! (Не може се ажурирати верзија у конфигурационој табели)'; // ORPHANED
$string['dbnotinsert'] = 'Грешка у бази података - унос није могућ ($a)'; // ORPHANED
$string['dbnotsetup'] = 'Грешка: Главне базе података НИСУ успешно постављене.'; // ORPHANED
$string['dbnotsupport'] = 'Грешка: Ваша база података ($a) још увек није потпуно подржана у Moodle-у или није присутна датотека install.xml. Видети директоријум lib/db.'; // ORPHANED
$string['dbnotupdate'] = 'Грешка у бази података - ажурирање није могуће ($a)'; // ORPHANED
$string['doesnotworkwitholdversion'] = 'Овај скрипт не ради са овом старијом верзијом Moodle-а'; // ORPHANED
$string['noblockbase'] = 'Класа block_base није дефинисана или датотека није пронађена за /blocks/moodleblock.class.php'; // ORPHANED
$string['nocaps'] = 'Грешка: нема дефинисаних могућности!'; // ORPHANED
$string['upgradefail'] = 'Ажурирање није успело! видети: $a'; // ORPHANED
