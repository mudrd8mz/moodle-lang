...
$string['addedrecip'] = 'Додат $а нови прималац';
$string['addedrecips'] = 'Додати $а нови примаоци';
$string['addedtogroup'] = 'Додат(а) групи $а';
$string['addedtogroupnot'] = 'Није додат(а) групи $a';
$string['addedtogroupnotenrolled'] = 'Није додат(а) групи $а, јер није уписан(а) на курс';
$string['addinganew'] = 'Додавање нове активности $a';
$string['addinganewto'] = 'Додавање новог $a->what у $a->to';
...
$string['addnousersrecip'] = 'Додавање корисника који није приступио овоме $а на листу прималаца';
...
$string['adminhelpconfiguration'] = 'Подешавање изгледа и функција сајта';
$string['adminhelpconfigvariables'] = 'Подешавање променљивих које утичу на општу функционалност сајта';
$string['adminhelpcourses'] = 'Одредите курсеве и категорије и упишите полазнике у њих, уредите курсеве на чекању';
$string['adminhelpeditorsettings'] = 'Подешавање основних опција HTML едитора';
...
$string['adminhelpfailurelogs'] = 'Преглед записа о неуспешним приступима систему';
...
$string['adminhelpsitefiles'] = 'Служи за објављивање општих датотека или учитавање резервних копија';
$string['adminhelpsitesettings'] = 'Подешавање изгледа почетне странице сајта';
$string['adminhelpstickyblocks'] = 'Подешавање фиксних блокова на читавом сајту';
$string['adminhelpthemes'] = 'Подешавање изгледа сајта (боје, фонтови и сл.)';
$string['adminhelpuploadusers'] = 'Увезите нове корисничке налоге из текстуалне датотеке';
$string['adminhelpusers'] = 'Одредите своје кориснике и подесите начин провере њихових података';
...
$string['alllogs'] = 'Сви записи о посетама';
...
$string['assignstudentspass'] = 'Све што треба да учините је да обавестите студенте да је лозинка за приступ овом курсу: \'$а\'. Наведену лозинку је потребно унети само једном, при упису на курс.';
...
$string['backupcancelled'] = 'Креирање резервне копија података је поништено';
$string['backupcoursefileshelp'] = 'Ако је омогућено, датотеке курса ће бити укључене у аутоматски креиране резервне копије података';
$string['backupdate'] = 'Датум креирања резервне копије података';
$string['backupdetails'] = 'Детаљи о резервној копији података';
$string['backupfailed'] = 'Неки од Ваших курсева нису сачувани!';
$string['backupfilename'] = 'резервна копија података';
$string['backupfinished'] = 'Креирање резервне копије података је успешно завршено';
$string['backupincludemoduleshelp'] = 'Одаберите желите ли у аутоматску процедуру креирања резервних копија података да укључите и модуле курса, са или без корисничких података';
$string['backupkeephelp'] = 'Колики број скорашњих резервних копија података за сваки курс желите да чувате? (Старије копије биће аутоматски обрисане по истеку наведеног рока)';
$string['backuplogdetailed'] = 'Детаљни записи о извршавању';
$string['backuploglaststatus'] = 'Записи о последњем извршавању';
$string['backuplogshelp'] = 'Ако омогућите ову опцију, записи о посетама курсу биће укључени у аутоматски креиране резервне копије података';
$string['backupmetacoursehelp'] = 'Ако омогућите ову опцију, информације о мета-курсу (наслеђени уписи) ће такође бити укључени у аутоматски креиране резервне копије података';
$string['backupnameformat'] = '%%d.%%m.%%Y.-%%H.%%M';
$string['backupnoneusersinfo'] = 'Напомена: Означили сте опцију која каже како не желите креирање резервних копија корисничких података, тако да су резервне копије свих модула пребачене у облик \"без корисничких података\". Узмите у обзир и то да модули \"вежба\" и \"радионица\" нису компатибилни са овом опцијом за креирање резервних података, тако да су у потпуности искључени из ове процедуре.';
$string['backupnonisowarning'] = 'Упозорење: ова резервна копија података је креирана у верзији Moodle система која није подржавала Unicode (пре верзије 1.6). Ако ова резервна копија садржи текстове који се не слажу са ISO-8859-1 може бити ОШТЕЋЕНА ако покушате да преузмете садржај из ње у овој Unicode Moodle верзији. Погледајте <a href=\"http://docs.moodle.org/en/Backup_FAQ\">Backup FAQ</a>за више информација о томе како да правилно урадите опоравак ове резервне копије.';
$string['backuporiginalname'] = 'Назив резервне копије података';
$string['backupsavetohelp'] = 'Пуна путања до директоријума у којем желите да сачувате датотеке са резервним копијама података<br /> (оставите ово поље празно како бисте податке сачували у подразумевани директоријум за чување свих података везаних за овај курс)';
$string['backuptakealook'] = 'Молимо прегледајте Ваше записе о креирању резервних копија у: $а';
$string['backupuserfileshelp'] = 'Одаберите да ли би требало да се корисничке датотеке (нпр. слике за личне профиле корисника) укључе у аутоматски креиране резервне копије података';
...
$string['blockconfiga'] = 'Конфигурисање блока $а';
$string['blockconfigbad'] = 'Овај блок није правилно имплементиран и зато не можете користити конфигурациони интерфејс';
$string['blockdeleteconfirm'] = 'Управо ћете потпуно обрисати блок \'$а\'. Наведена акција ће у потпуности обрисати СВЕ податке у бази везане за овај блок. Јесте ли СИГУРНИ да желите да наставите?';
...
$string['chooselogs'] = 'Избор записа о посетама које желите да видите';
$string['choosereportfilter'] = 'Избор филтера за извештај';
$string['choosetheme'] = 'Избор теме';
$string['chooseuser'] = 'Избор корисника';
$string['city'] = 'Насеље/Град';
$string['clambroken'] = 'Ваш администратор је укључио антивирусну проверу при учитавању датотека, али је нажалост нешто погрешно конфигурисао.<br /> Учитавање Ваше датотеке НИЈЕ било успешно. Администратору је упућена аутоматска е-порука од стране система и очекујемо негове исправке подешавања. <br /> Молимо покушајте учитавање те датотеке нешто касније.';
...
$string['clamfailed'] = 'Clam AV се није могао покренути. Обавештење о грешци је следеће: $а. Следи Clam AV излаз:';
$string['clamlost'] = 'Moodle је конфигурисан тако да проверава учитавање датотека с Clam AV алатом, али је подешена путања ($а) до Clam AV алата нетачна.';
$string['clamlostandactinglikevirus'] = 'Додатно, Moodle је конфигурисан на начин да ако се Clam AV не успе извршити, СВЕ учитаване датотеке се сматрају вирусима. Ово у пракси значи да НИЈЕДАН студент не може пребацити датотеку на сервер док год не средите наведени проблем.';
$string['clammovedfile'] = 'Датотека је премештена у специфицирани карантински директоријум, нова локација је $а';
$string['clammovedfilebasic'] = 'Датотека је премештена у карантински директоријум.';
$string['clamquarantinedirfailed'] = 'Није било могуће преместити датотеку у специфицирани карантински директоријум $а. Требали бисте ово поправити јер се датотеке аутоматски бришу ако се пронађу као заражене.';
...
$string['configuration'] = 'Подешавања';
...
$string['courserejectemail'] = 'Жао нам је, али Ваш захтев за курс је одбијен. Ево датог образложења: $а';
...
$string['courserestore'] = 'Преузимање садржаја из резервне копије курса';
...
$string['courseuploadlimit'] = 'Лимит за величину датотека при учитавању у оквиру овог курса';
$string['create'] = 'Креирање';
$string['createaccount'] = 'Креирање мог новог корисничког налога';
$string['createfolder'] = 'Креирање директоријума у $а';
...
$string['creatinglogentries'] = 'Креирање записа о посетама';
...
$string['databaseupgradebackups'] = 'Важећа верзија резервне копије података је $а';
$string['databaseupgradeblocks'] = 'Тренутна верзија блокова је $а';
$string['databaseupgradelocal'] = 'Тренутна верзија прилагођавања локалне базе података је $а';
...
$string['deletecheck'] = 'Обрисати $а ?';
$string['deletecheckfiles'] = 'Јесте ли у потпуности сигурни да желите да обришете ове датотеке?';
$string['deletecheckfull'] = 'Јесте ли у потпуности сигурни да желите да потпуно обришете $а?';
...
$string['displayingrecords'] = 'Приказ $а записа';
...
У већини програма за е-пошту, у реду изнад овог бисте требали видети плаво обојени линк на који можете кликнути. Ако та функција не ради, онда само копирајте наведену адресу у линију за адресе на врху Вашег web читача.
...
$string['emailnotallowed'] = 'Електронске адресе које припадају овим доменима нису дозвољене ($а)';
$string['emailnotfound'] = 'Адреса е-поште није нађена у бази података';
$string['emailonlyallowed'] = 'Ова адресе е-поште није једна од дозвољених ($а)';
$string['emailpasswordconfirmation'] = 'Постована/и $a->firstname,

Нетко (најверојатније Ви) је затражио нову лозинку за Ваш кориснички налог у систему \'$a->sitename\'.

Како бисте потврдили потребу за новом лозинком и добили нову лозинку путем е-поште, посетите ову wеб адресу:
...
означите и копирајте адресу у адресну линију Вашег web читача.
...
$string['enrolmentnew'] = 'Нови полазник курса $а';
...
$string['forcetheme'] = 'Обавезна тема';
...
$string['formattpicwtrck'] = 'Тематски формат са праћењем активности';
...
$string['guestsnotallowed'] = 'Нажалост, курс \'$а\' не дозвољава приступ гостима.';
...
$string['hour'] = 'сат';
$string['hours'] = 'сати';
$string['howtomakethemes'] = 'Како направити нове теме';
...
$string['htmleditordisabledbrowser'] = 'Употреба HTML едитора није могућа јер Ваш web читач није компатибилан с њим';
...
$string['includelogentries'] = 'Укључујући записе о посетама';
...
$string['list'] = 'Списак';
$string['listfiles'] = 'Списак датотека у $а';
...
$string['loggedinas'] = 'Пријављени сте као $а';
...
$string['loginsteps'] = 'Добродошли! Како бисте имали пуни приступ курсевима на овом сајту, морате креирати нови кориснички налог.
...
$string['makeeditable'] = 'Ако подесите \'$а\' да се може уредити процесом web сервера, онда можете мењати ову датотеку директно са ове странице';
...
$string['maximumchars'] = 'Максимално $а карактера';
$string['maximumgrade'] = 'Максимална оцена';
$string['maximumshort'] = 'Макс.';
$string['maximumupload'] = 'Максимална величина датотека за учитавање';
$string['maxsize'] = 'Макс. величина: $а';
...
$string['moduledeleteconfirm'] = 'Управо ћете потпуно обрисати модул \'$а\'. То ће довести до комплетног брисања свих података у бази података који се односе на овај модул активности. Да ли сте СИГУРНИ да желите да наставите?';
...
$string['modulesuccess'] = '$ табела је исправно подешено';
...
$string['movefull'] = 'Премести $а на ову локацију';
...
У већини програма за читање е-поште, у реду изнад овог бисте требали видети плави линк на који мозете кликнути. У случају да то не ради, 
означите и копирајте адресу у адресну линију Вашег web читача (Firefox, Mozilla, Internet Explorer, Opera).
...
У већини програма за електронску пошту појавиће се плаво обојени линк изнад овог текста на који је потребно само кликнути. Ако та опција не буде радила, копирајте наведену адресу у адресну линију на врху прозора Вашег web читача.';
...
$string['nofilesselected'] = 'Није изабрана ниједна датотека за преузимање садржаја.';
$string['nofilesyet'] = 'Унутар овог курса још није учитана ниједна датотека';
$string['nograde'] = 'Нема оцене';
$string['noimagesyet'] = 'Унутар овог курса још није учитана ниједна слика';
...
$string['noreplybouncemessage'] = 'Одговорили сте на адресу електронске поште са које се само шаљу поруке. Ако сте покушавали да одговорите на поруку са форума, молимо да то учините директно користећи $а форуме.
...
$string['noteuserschangednonetocourse'] = 'Напомена: податке о корисницима курса треба преузети из резервне копије при преузимању корисничких података (у активностима, датотекама или порукама). Ово подешавање је промењено за Вас.';
$string['nothingnew'] = 'Нема новости од Ваше последње посете';
$string['nothingtodisplay'] = 'Нема ничега за приказ';
$string['noticenewerbackup'] = 'Ова датотека са резервним подацима је направљена са Moodle верзијом $a->backuprelease ($a->backupversion) и новија је од Вашег тренутно инсталираног система Moodle $a->serverrelease ($a->serverversion). Ово би могло узроковати одређене недоследности због тога што компатибилност система са резервним копијама креираним помоћу ранијих верзија не може бити гарантована.';
$string['notifyloginfailuresmessage'] = '$a->time, IP: $a->ip, Корисник: $a->info';
$string['notifyloginfailuresmessageend'] = 'Ове записе о посетама можете видети на адреси $a/course/log.php?id=1&chooselog=1&modid=site_errors.';
$string['notifyloginfailuresmessagestart'] = 'Ово је списак грешака при приступу систему на $а од последњег обавештења које сте примили';
...
$string['preferences'] = 'Преференције';
...
$string['previeworchoose'] = 'Преглед или избор теме';
...
$string['readinginfofrombackup'] = 'Учитавање информација из резервне копије података';
...
$string['recreatedcategory'] = 'Поновно креирана категорија $а';
...
$string['restore'] = 'Преузимање података из резервних копија';
$string['restorecancelled'] = 'Преузимање података је отказано';
$string['restorecoursenow'] = 'Преузмите податке за овај курс управо сада!';
$string['restorefinished'] = 'Преузимање података је успешно завршено';
$string['restoreto'] = 'Преузете податке сместити у';
...
$string['savepreferences'] = 'Сачувај подешавања';
...
$string['scheduledbackupstatus'] = 'Статус распореда креирања резервних копија података';
...
$string['shortnametaken'] = 'Наведена скраћеница је већ у употреби за неки други курс ($а)';
...
$string['showonlytopic'] = 'Приказ само теме $а';
$string['showonlyweek'] = 'Приказ само $а седмице';
$string['showperpage'] = 'Приказ $а по страници';
...
$string['showtheselogs'] = 'Приказ ових посета';
$string['since'] = 'Од';
...
$string['sitelogs'] = 'Записи о посетама';
$string['sitenews'] = 'Новости';
$string['sitepartlist0'] = 'Морате бити предавач сајта да би Вам било омогућено да видите списак учесника сајта';
$string['sitepartlist1'] = 'Морате бити предавач да би Вам било омогућено да видите списак учесника';
...
$string['statsreport6'] = 'Укупна активност предавача (прикази и поруке)';
...
$string['statsreportstudentactivity'] = 'Укупна активност студента (прикази и поруке)';
$string['statsreportteacheractivity'] = 'Укупна активност предавача (прикази и поруке)';
...
$string['textediting'] = 'Код уређивања текста';
$string['texteditor'] = 'Користити стандардне web форме';
$string['textformat'] = 'Обичан текстуални формат';
$string['thanks'] = 'Хвала';
$string['theme'] = 'Тема';
$string['themes'] = 'Теме';
$string['themesaved'] = 'Нова тема је сачувана';
...
$string['to'] = 'До';
$string['today'] = 'Данас';
$string['todaylogs'] = 'Данашњи записи о посетама';
...
$string['topicshow'] = 'Приказ ове теме за $а';
$string['total'] = 'Укупно';
...
$string['turneditingoff'] = 'Искључите уређивање';
$string['turneditingon'] = 'Укључите уређивање';
...
$string['unenrolsure'] = 'Јесте ли у потпуности сигурни да желите да испишете $а са курса?';
...
$string['unusedaccounts'] = 'Кориснички налози који се не користе $а дана се аутоматски исписују';
$string['unzip'] = 'Распакивање';
$string['unzippingbackup'] = 'Распакује се резервна копија података';
$string['up'] = 'Горе';
...
$string['updatesevery'] = 'Ажурирање на сваких $а секунди';
$string['updatethis'] = 'Ажурирање овог $а';
$string['updatethiscourse'] = 'Ажурирање овог курса';
$string['updatinga'] = 'Ажурирање: $а';
$string['updatingain'] = 'Ажурирање $a->what у $a->in';
$string['upload'] = 'Учитавање';
$string['uploadafile'] = 'Учитавање датотеке';
$string['uploadedfile'] = 'Датотека је успешно учитана';
$string['uploadedfileto'] = 'Учитана је датотека $a->file у директоријум $a->directory';
$string['uploadedfiletoobig'] = 'Нажалост, наведена датотека је превелика (ограничење износи $а бајта)';
$string['uploadfailednotrecovering'] = 'Учитавање Ваших датотека није успело јер је уочен проблем са једном од њих, $a->name.<br /> Овде су записи о уоченим проблемима:<br />$a->problem<br />Нема опоравка.';
$string['uploadfilelog'] = 'Записи о учитавању датотеке $a';
$string['uploadformlimit'] = 'Датотека која је учитана премашила је ограничење за максималну величину постављено овом формом';
$string['uploadlabel'] = 'Наслов:';
$string['uploadnofilefound'] = 'Датотека није пронађена - јесте ли сигурни да сте одабрали датотеку за учитавање?';
$string['uploadnotallowed'] = 'Учитавање није дозвољено';
$string['uploadoldfilesdeleted'] = 'Старе датотеке у Вашем одељку за учитавање су обрисане';
$string['uploadpartialfile'] = 'Учитавање датотеке није извршено у потпуности';
$string['uploadproblem'] = 'Приликом учитавање датотеке \'$а\' догодила се непозната грешка (можда је наведена датотека била превелика?)';
...
$string['uploadserverlimit'] = 'Датотека која је учитана је већа од максималне величине дозовољене ограничењем овог сервера';
$string['uploadthisfile'] = 'Учитавање ове датотеке';
$string['uploadusers'] = 'Учитавање корисника';
$string['usedinnplaces'] = 'Користи се на $а места';
...
$string['usernotconfirmed'] = 'Није се могло потврдити $а';
$string['userprofilefor'] = 'Кориснички профил за $а';
...
$string['virusfound'] = 'Упозорење за администратора! Clam AV је нашао вирус у датотеци коју је корисник $a->user учитао за курс $a->course. Овде је резултат Clam скенирања:

$a->action

Корисник који је учитао датотеку је такође обавештен о томе шта се догодило.';
$string['virusfoundlater'] = 'У датотеци која је учитана дана $a->date под именом $a->filename за курс $a->course је у међувремену пронађен вирус. Овде је сажети извештај о томе шта се током времена дешавало са датотеком:

$a->action

Ако је то био предати рад, можда желите поново да га предате да би га Ваш предавач могао прегледати.';
$string['virusfoundlateradmin'] = 'Упозорење за администратора! У датотеци коју је корисник $a->user учитао дана $a->date под именом $a->filename за курс $a->course је у међувремену пронађен вирус. Овде је сажети извештај о томе шта се током времена дешавало са датотеком:

$a->action

Корисник који је учитао датотеку је такође обавештен о томе шта се догодило.';
$string['virusfoundlateradminnolog'] = 'Упозорење за администратора! У датотеци која је раније учитана под именом $a->filename је у међувремену пронађен вирус. Moodle није успео да преправи ову датотеку у њену првобитну верзију у каквој ју је корисник учитао.

Овде је сажети извештај о томе шта се током времена дешавало са датотеком:

$a->action';
$string['virusfoundsubject'] = '$a: Пронађен вирус!';
$string['virusfounduser'] = 'Датотека који сте учитали, $a->filename, је скенирана антивирусним софтвером и пронађено је да је заражена! Учитавање Ваше датотеке НИЈЕ успело.';
$string['virusplaceholder'] = 'Пронађено је да је датотека која је учитана садржала вирус, те је премештена или обрисана и корисници су обавештени о томе.';
$string['visibletostudents'] = 'Видљиво за $a';
$string['warningdeleteresource'] = 'Упозорење: на $а се односи ресурс. Да ли желите да ажурирате тај ресурс?';
$string['webpage'] = 'Web страница';
$string['week'] = 'Седмица';
$string['weekhide'] = 'Сакриј ову седмицу од $а';
$string['weeklyoutline'] = 'Седмични преглед дешавања';
$string['weekshow'] = 'Приказ ове седмице до $а';
$string['welcometocourse'] = 'Добродошли на курс $а';
...
$string['youaregoingtorestorefrom'] = 'Управо ћете започети преузимање података из резервне копије за';
$string['yourlastlogin'] = 'Ваш последњи приступ систему';
$string['yourself'] = 'себе';
$string['yourteacher'] = 'Ваш $a';
$string['zippingbackup'] = 'Креира се архива са резервном копијом података';
