...
$string['backupmissinguserinfoperms'] = 'Ова резервна копија не садржи податке о корисницима. Активности Вежбање и Радионица неће бити обухваћене при формирању резервне копије, будући да ови модули нису усклађени са овим типом резервне копије.';
...
$string['flashlinkmessage'] = 'Молимо да сада унапредите свој Flash player';
$string['flashupgrademessage'] = 'Додатак за Flash је обавезан да бисте репродуковали овај садржај, али верзија коју имате је сувише застарела.';
...
$string['forcepasswordchangecheckfull'] = 'Да ли сте потпуно сигурни да желите приморати измену лозинке у $a ?';
$string['forcepasswordchangehelp'] = 'Опоменути корисника да промени лозинку при првом следећем приступу систему';
$string['forcepasswordchangenot'] = 'Није било могуће приморати измену лозинке у $a';
...
$string['noteusercannotrolldatesoncontext'] = '<strong>Напомена:</strong>Способност да се нижу датуми када се забрањује обнављање из ове резервне копије због недостатка тражених овлашћења.';
...
$string['publicsitefileswarning3'] = 'Напомена: Овде постављеним датотекама може свако приступити ко зна (или погоди) адресу (URL).<br />Из безбедносних разлога, датотеке резервних копија треба да се чувају само у безбедном фолдеру за резервне копије';
...
$string['restorecannotassignroles'] = 'За рестаурирање је потребно да се доделе улоге, а Ви немате овлашћења да то урадите';
$string['restorecannotcreateorassignroles'] = 'За рестаурирање је потребно да се креирају или доделе улоге, а Ви немате овлашћења да то урадите';
$string['restorecannotcreateuser'] = 'За рестаурирање је потребно да се креира корисник \'$a\' из датотеке резервне копије, а Ви немате овлашћења да то урадите';
$string['restorecannotoverrideperms'] = 'За рестаурирање је потребно да се преправе (пониште) овлашћења, а Ви немате овлашћења да то урадите';
$string['restorecoursenow'] = 'Рестаурирајте овај курс управо сада!';
$string['restoredaccount'] = 'Рестауриран налог';
$string['restoredaccountinfo'] = 'Овај налог је преузет са другог сервера а лозинка му је изгубљена. Да би поставили нову лозинку путем е-поште, молимо да кликнете на \"Наставак\"';
...
$string['restoreuserconflict'] = 'Покушај да се рестаурира корисник \'$a\' из датотеке резервне копије биће узрок сукоба';
$string['restoreuserinfofailed'] = 'Процес рестаурације је прекинут јер немате овлашћења да рестаурирате податке о корисницима.';
$string['restoreusersprecheck'] = 'Провера података корисника';
$string['restoreusersprecheckerror'] = 'Откривени су неки проблеми при провери података корисника';
...
$string['activitymodules'] = 'Модули активности'; // ORPHANED
$string['addblock'] = 'Додај блок'; // ORPHANED
$string['adddots'] = 'Додај...'; // ORPHANED
$string['backto'] = 'Назад на $a'; // ORPHANED
$string['brief'] = 'Укратко'; // ORPHANED
$string['choosedots'] = 'Изабери...'; // ORPHANED
$string['clear'] = 'Обриши'; // ORPHANED
$string['clicktohideshow'] = 'Кликните да бисте раширили или скупили'; // ORPHANED
$string['courseapprovedemail2'] = 'Курс који сте тражили, $a->name, је одобрен. Да бисте приступили Вашем новом курсу идите на $a->url'; // ORPHANED
$string['courseenrolend'] = 'Крај уписа на курс'; // ORPHANED
$string['courseenrolstart'] = 'Почетак уписа на курс'; // ORPHANED
$string['coursehelpenrollable'] = 'Да ли студенти могу сами да се упишу на курс користећи подразумевани додатак за интерактивни упис.'; // ORPHANED
$string['coursehelpenrolmentkey'] = 'Ако је постављена, студентима ће бити потребна ова лозинка како би се уписали на курс.'; // ORPHANED
$string['coursehelpenrolmentplugins'] = 'Подразумевани додатак за интерактивни упис'; // ORPHANED
$string['coursehelpexpirynotifystudents'] = 'Уколико је наведен уписни период, онда ово подешавање одређује да ли ће студенти добити обавештење е-поштом пре него што буду исписани са курса.'; // ORPHANED
$string['coursehelpexpirythreshold'] = 'Уколико је наведен уписни период, онда ово подешавање одређује колико дана 
раније, пре исписивање са курса, ће студенти добити обавештење о томе.'; // ORPHANED
$string['coursehelpforce'] = 'Обавезан групни мод за све активности на курсу'; // ORPHANED
$string['coursehelpnotify'] = 'Уколико је наведен уписни период, онда ово подешавање одређује да ли ће предавач 
добити обавештење е-поштом'; // ORPHANED
$string['coursesectionsummaries'] = 'Резиме секција курса'; // ORPHANED
$string['coursestart'] = 'Почетак курса'; // ORPHANED
$string['downloadfile'] = 'Преузми датотеку'; // ORPHANED
$string['english'] = 'Енглески'; // ORPHANED
$string['enroldetails'] = 'Детаљи уписа'; // ORPHANED
$string['filter'] = 'Филтер'; // ORPHANED
$string['fullnamecourse'] = 'Пун назив курса'; // ORPHANED
$string['fullnameuser'] = 'Пуно име корисника'; // ORPHANED
$string['hiddenfromstudents'] = 'Сакривено од студента'; // ORPHANED
$string['hidetopicfromothers'] = 'Сакриј тему од осталих'; // ORPHANED
$string['hideweekfromothers'] = 'Сакриј недељу од других'; // ORPHANED
$string['matchingsearchandrole'] = 'Спаривање \'$a->search\' и $a->role'; // ORPHANED
$string['maximumgradex'] = 'Највећа оцена: $a'; // ORPHANED
$string['messageprovider:errors'] = 'Важне грешке у вези са сајтом'; // ORPHANED
$string['messageprovider:notices'] = 'Обавештења о мањим проблемима'; // ORPHANED
$string['moduleintro'] = 'Опис'; // ORPHANED
$string['noblockstoaddhere'] = 'Не постоје блокови које можете додати овој страници.'; // ORPHANED
$string['nomatchingusers'] = 'Ниједан корисник се не поклапа са \'$a\''; // ORPHANED
$string['pageshouldredirect'] = 'Ова страница би требало да вас аутоматски преусмери. Уколико се ништа не догађа молимо Вас да за наставак употребите доњи линк.'; // ORPHANED
$string['pleasesearchmore'] = 'Наставите претрагу'; // ORPHANED
$string['pleaseusesearch'] = 'Употребите претрагу'; // ORPHANED
$string['previouslyselectedusers'] = 'Претходно изабрани корисник се не поклапа са \'$a\''; // ORPHANED
$string['redirect'] = 'Преусмери'; // ORPHANED
$string['repositories'] = 'Репозиторијум'; // ORPHANED
$string['searchoptions'] = 'Опције за претрагу'; // ORPHANED
$string['seconds'] = 'секунде'; // ORPHANED
$string['shortnamecourse'] = 'Краћи назив курса'; // ORPHANED
$string['shortnameuser'] = 'Краће име корисника'; // ORPHANED
$string['showtopicfromothers'] = 'Прикажи теме других'; // ORPHANED
$string['showweekfromothers'] = 'Прикажи недеље других'; // ORPHANED
$string['sortbyx'] = 'Сортирај према $a у усходном низу'; // ORPHANED
$string['sortbyxreverse'] = 'Сортирај према $a у нисходном низу'; // ORPHANED
$string['toomanyusersmatchsearch'] = 'Превише корисника ($a->count) се поклапа са\'$a->search\''; // ORPHANED
$string['toomanyuserstoshow'] = 'Превише корисника за приказ ($a) to show'; // ORPHANED
$string['url'] = 'URL'; // ORPHANED
$string['userdetails'] = 'Детаљи о кориснику'; // ORPHANED
$string['userselectorautoselectunique'] = 'Ако се само један корисник поклапа са критеријумима претрага нека аутоматски буде одабран'; // ORPHANED
$string['userselectorpreserveselected'] = 'Задржи изабрене кориснике, чак и ако се више не поклапају са критеријумима претрахе'; // ORPHANED
$string['userselectorsearchanywhere'] = 'Пронађи тражени текст било где у корисниковом имену'; // ORPHANED
$string['viewfileinpopup'] = 'Погледај датотеку у искачућем прозору'; // ORPHANED
$string['windowclosing'] = 'Овај прозор би требало да се аутоматски затвори. Ако се то није догодило молим вас да га сада затворите.'; // ORPHANED
$string['yourwordforx'] = 'Ваша реч за \'$a\''; // ORPHANED
