...
$string['clamlost'] = 'Moodle је конфигурисан тако да проверава постављање датотека с Clam AV алатом, али је подешена путања ($а) до Clam AV алата нетачна.';
...
$string['uploadfailednotrecovering'] = 'Постављање Ваших датотека није успело јер је уочен проблем са једном од њих, $a->name.<br /> Овде су записи о уоченим проблемима:<br />$a->problem<br />Нема опоравка.';
$string['uploadfilelog'] = 'Записи о постављању датотеке $a';
...
$string['uploadproblem'] = 'Приликом постављање датотеке \'$а\' догодила се непозната грешка (можда је наведена датотека била превелика?)';
...
Корисник који је учитао датотеку је такође обавештен о томе шта се догодило.';
$string['virusfoundlateradminnolog'] = 'Упозорење за администратора! У датотеци која је раније постављена под именом $a->filename је у међувремену пронађен вирус. Moodle није успео да преправи ову датотеку у њену првобитну верзију у каквој ју је корисник учитао.

Овде је сажети извештај о томе шта се током времена дешавало са датотеком:

$a->action';
$string['virusfoundsubject'] = '$a: Пронађен вирус!';
$string['virusfounduser'] = 'Датотека који сте поставили, $a->filename, је скенирана антивирусним софтвером и пронађено је да је заражена! Учитавање Ваше датотеке НИЈЕ успело.';
