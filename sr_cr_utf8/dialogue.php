...
$string['closeddialogues'] = 'Затворени дијалози';
$string['confirmclosure'] = 'Управо затварате дијалог са $а. Затворени дијалози не могу бити поново отворени. <br /><br /> Ако затворите овај дијалог можете га видети, али не и поново ући на њега. <br /><br /> Мораћете да започнете нови дијалог да наставите да &quot;причате&quot; са овом особом.<br /><br />Да ли сте сигурни да желите да затворите овај дијалог?';
...
$string['dialoguemail'] = '$a->userfrom је послао нову ставку у Ваш унос дијалога за \'$a->dijalog\' Можете је видети на Вашем уносу дијалога: $a->url';
$string['dialoguemailhtml'] = '$a->userfrom је послао нову ставку у Ваш унос дијалога за \'<i>$a->dialogue</i>\'<br /><br /> Можете је видети у Вашем <a href=\"$a->url\">дијалогу</a>.';
$string['dialoguename'] = 'Назив дијалога';
...
$string['lastentry'] = 'Последњи унос';
$string['maildefault'] = 'Подразумевана е-пошта';
$string['mailnotification'] = 'Нотификација е-поште';
...
$string['nosubject'] = 'Тема није унета';
$string['notavailable'] = 'Дијалози нису доступни гостима';
$string['notextentered'] = 'Текст није унет';
$string['notstarted'] = 'Још нисте започели овај дијалог';
$string['notyetseen'] = 'Још није виђено';
$string['numberofentries'] = 'Број уноса';
$string['numberofentriesadded'] = 'Број додатих уноса: $a';
$string['of'] = 'од';
$string['onwrote'] = '$a је написао';
$string['onyouwrote'] = 'У $а сте написали';
...
$string['opendialogues'] = 'Отворите дијалоге';
...
$string['seen'] = 'Виђено пре $a';
$string['sendmailmessages'] = 'Пошаљи е-поруке о мојим новим уносима';
$string['status'] = 'Статус';
$string['studenttostudent'] = 'Студент - Студент';
$string['subject'] = 'Тема';
$string['subjectadded'] = 'Тема додата';
$string['teachertostudent'] = 'Предавач - Студент';
$string['typefirstentry'] = 'Овде унесите први унос';
$string['typefollowup'] = 'Овде унесите наставак';
$string['typeofdialogue'] = 'Тип дијалога';
$string['typereply'] = 'Овде унесите одговор';
$string['viewallentries'] = 'Погледајте $а уноса дијалога';
