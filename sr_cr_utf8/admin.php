...
$string['requiredtemplate'] = 'Неопходно. Можете овде да користити синтаксу шаблона(%%l = презиме, %%f = име, %%u = корисничко име). Погледајте помоћ за више детања и примере.';
