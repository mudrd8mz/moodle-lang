<?PHP // $Id$ 
      // admin.php - created with Moodle 1.9.5 (Build: 20090515) (2007101550)
...
$string['allowthemechangeonurl'] = 'Дозволи промену шеме изгледа у УРЛ адреси';
...
$string['cannotdeletemissingqtype'] = 'Не можете да обришете недостајући тип питања. Овај тип је потребан систему.';
...
$string['commonfiltersettings'] = 'Заједничка подешњвања филтера';
...
$string['configallowthemechangeonurl'] = 'Уколико укључите ово подешавање, онда шема изгледа може бити промењена додавањем theme={themename}&amp;sesskey={sesskey} било којој Moodle УРЛ адреси.';
...
$string['configdebugstringids'] = 'Ова опција је дизајнирана да помогне преводиоцима. Она показује језичку датотеку и ид израза поред сваког исписаног израза (Мењање овог подешавања ће имати ефекта једино када се учита нареднс страница.)';
...
$string['configmaxconsecutiveidentchars'] = 'Лоѕинке не смеју имати више од овог броја истответних карактера за редом. Употребите 0 како бисте искључики ову опцију';
...
$string['configuseexternalyui'] = 'Уместо коришћења локалних датотека, користите датотеке на мрежи доступне на Yahoo&#145;s серверима. УПОЗОРЕЊЕ: Ово захтева Интернт конекцију, или уопште неће радити AJAX на Вашем сајту.';
...
$string['dbtest'] = 'Функционални тестови базе података';
...
$string['defaulthtmleditor'] = 'Подразумевани HTML едитор';
...
$string['deletefilterareyousure'] = 'Да ли сте сигурни да желите да обришете филтер \'$a\'';
$string['deletefilterareyousuremessage'] = 'Спремни сте да у потпуности обришете филтер \'$a\'. Да ли сте сигурни да желите да га деинсталирате.';
$string['deletefilterfiles'] = 'Сви подаци асоцирани са филтером \'$a->filter\' су избрисани из базе података. Да би се завшили брисање (и спречили поновно инсталирање самог филтер), морате сада да обришете са сервера овај директоријум: $a->directory';
$string['deleteincompleteusers'] = 'Брисање непотпуних корисника после';
$string['deleteqtypeareyousure'] = 'Да ли сте сигурни да желите да обришете тип питања\'$a\'';
$string['deleteqtypeareyousuremessage'] = 'Спремате се да комплетно обришете тип питања \'$a\'. Да ли сте сигурни да деинсталирате овај тип питања?';
$string['deleteunconfirmed'] = 'Обрисати непотврђене кориснике након';
$string['deleteuser'] = 'Брисање корисника';
$string['deletingfilter'] = 'Брисање филтера \'$a\'';
...
$string['experimentalsettings'] = 'Ексшериментална подешавања';
...
$string['frontpageoverrides'] = 'Промена овлашћења на насловној страници';
...
$string['helpprofilefieldlink'] = 'Креирај линк од података корисника.';
...
$string['installhijacked'] = 'Инсталација мора бити завршена са оригиналне ИП адресе';
...
$string['invalidlangpack'] = 'како би уредили језички пакет, потребно је да га поставите у директоријум за језике.';
...
$string['ipblocker'] = 'Блокер IP адресâ';
...
$string['ipwhitelist'] = 'ИП бела листа';
$string['ipwhitelistdesc'] = 'Када је празна, само је ИП адреси која је овде подешена дозвољено да користи веб сервисе са корисничким именом: <strong>$a->username</strong>';
...
$string['managews'] = 'Управљање веб сервисима';
...
$string['numquestionsandhidden'] = '$a->numquestions (+$a->numhidden скривен)';
...
$string['qtypedeletefiles'] = 'Сви подаци придружени типу питања \'$a->qtype\' су обрисани из базе података. Да бисте завршили брисање (и спречили да се тај тип питања сам реинсталира), морате да обришете овај директоријум са Вашег сервера: $a->directory';
...
<br/><br/>Ова промена утиче на следеће базе податак у Вашем систему: (Молимо Бас да сада сачувате овај списак и, након завршене надоградње система, проверите да ли ове активности и даље раде онако како су то предавачи планирали.)<br/><strong>$a->text</strong><br/>';
...
$string['webserviceprotocols'] = 'Веб сервер сервиса';
$string['webservices'] = 'Веб сервиси';
$string['webservicesystemsettings'] = 'опшра подешавања';
$string['webserviceusersettings'] = 'Корисничка подешавања веб сервиса';
