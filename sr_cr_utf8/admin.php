...
$string['configauthenticationplugins'] = 'Молимо одаберите додатке за аутентикацију које желите да користите и поређајте их у редоследу смењивања у случају неуспеха. Саморегистрацијом ће управљати додатак одабран у колони \'Регистрација\' (обично \'е-пошта\')';
...
$string['mnetrestore_extusers_mismatch'] = '<strong>Напомена:</strong> Ова резервна копија очигледно потиче са неке друге Moodle инсталације и садржи удаљене Moodle мрежне корисничке налоге који се можда неће истравно рестаурирати. Ова операција није подржана. Ако сте сигурни да је архива креирана на овој Moodle инсталацији, или можете да потврдите да су сви потребни хостови у Вашој Moodle мрежи  конфигурисани, можда ћете ипак желети да покушате рестаурацију.';
