...
$string['accessexception'] = 'Изузетак у контроли приступа';
...
$string['authmethod'] = 'Метод провере идентитета';
$string['configwebserviceplugins'] = 'Из разлога безбедности требало би да буду укључени само протоколи који се користе';
...
$string['deleteserviceconfirm'] = 'Да ли стварно желите да обришете спољашњи сервис \"$a\"?';
$string['deletetokenconfirm'] = 'Да ли стварно желите да обришете овај токен веб сервиса за корисника  <strong>\$a->$a->user</strong> за сервис <strong>$a->service</strong>?';
$string['disabledwarning'] = 'Сви протоколо веб сервиса су онемогућени. Подешавање \"Омогући веб сервисе\" можете наћи у Напредним својствима';
...
$string['enablewsdescription'] = 'Веб сервиси морају бити омогућени у Напредним својствима';
$string['entertoken'] = 'Унеси сигурносни кључ/токен';
$string['error'] = 'Грешка: $a';
$string['errorcodes'] = 'Порука о грешци';
$string['errorinvalidparamsapi'] = 'Неисправан спољашњи api парамаетар';
$string['errorinvalidparamsdesc'] = 'Неисправан опис спољашњег api';
$string['errorinvalidresponseapi'] = 'Неисправан спољашњи api одговор';
$string['execute'] = 'Изврши';
$string['externalservice'] = 'Спољашњи сервис';
$string['externalservicefunctions'] = 'Функције спољашњих сервиса';
$string['externalservices'] = 'Спољашњи сервиси';
$string['externalserviceusers'] = 'Корисници спољашњих сервиса';
$string['function'] = 'Функција';
$string['functions'] = 'Функције';
$string['generalstructure'] = 'Општа структура';
$string['information'] = 'Информација';
$string['invalidextparam'] = 'Неисправан спољашњи api парамаетар: $a';
$string['invalidiptoken'] = 'Неисправан токен - ваш ИП ниј подржан';
$string['invalidtimedtoken'] = 'Неисправан токен - токен је истекао';
$string['invalidtoken'] = 'Неисправан токен - токен није пронађен';
$string['iprestriction'] = 'ИП ограничења';
$string['key'] = 'Кључ';
...
$string['notoken'] = 'Листа токена је празна';
