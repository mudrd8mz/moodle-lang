...
Морате одредити место на ком ће Moodle чувати учитане датотеке. Корисник web сервера (обично \'нико\' или \'apache\') би морао имати могућност да чита податке из тог директоријума, али и да их у њега уписује, али они не би требали бити доступни директно преко web-a.</p>';
...
$string['fileuploadshelp'] = '<p>Каталог за учитавање датотека је изгледа недоступан на Вашем серверу.</p>
...
<p>Безбедни мод рада је обично једино дозвољен на параноичним јавним web серверима, тако да можете просто наћи web сервер код неке друге куће за Ваш Moodle сајт.</p>
