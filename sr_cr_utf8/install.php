...
<b>Префикси табела:</b> опциони префикс за имена свих табела';
...
$string['nativemysqlihelp'] = 'Сада је нопходно да конфигуришете базу податка где ће највећи део података из Moodlea бити похрањен. База података може бити креирана ако корисник има потребна овлашћења. Корисничко име и лозинка морају већ да постоје. Префикс табела је опциони.';
$string['nativeoci'] = 'Oracle (native/oci)';
$string['nativepgsql'] = 'PostgreSQL (native/pgsql)';
$string['nativepgsqlhelp'] = 'Сада је нопходно да конфигуришете базу податка где ће највећи део података из Moodlea бити похрањен. Ова база података претходно већ мора бити креирана, као и корисничко име и лозинка потребни за приступ бази. Префикс табеле је обавезан.';
