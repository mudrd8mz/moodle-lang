...
$string['cliadminpassword'] = 'Нова лозинка за администратора'; // ORPHANED
$string['clialreadyinstalled'] = 'Датотека config.php већ постоји. Употребите команду admin/cli/upgrade.php ако желите да ажурирате свој сајт.'; // ORPHANED
$string['cliinstallfinished'] = 'Инсталација је успешно завршена'; // ORPHANED
$string['cliinstallheader'] = 'Moodle $a програм за инсталацију из командне линије'; // ORPHANED
$string['climustagreelicense'] = 'У неинтерактивном моду морате прихватити лиценцу наводећи опцију --agree-license'; // ORPHANED
$string['clitablesexist'] = 'База подтака већ постоји. Није могуће наставити инсталацију из командне линије.'; // ORPHANED
$string['databasecreationsettingssub2'] = '<b>Тип:</b> фиксно \"mysqli\" <br />
<b>Хост:</b> фиксно \"localhost\" <br />
<b>Име:</b> име базе података, нпр. moodle<br />
<b>Корисник:</b> фиксно \"root\" од стране инсталационог програма<br />
<b>Лозинка:</b> лозинка Ваше базе података<br />
<b>Префикси табела:</b> опциони префикс за имена свих табела'; // ORPHANED
$string['databasehead'] = 'Подешавања базе података'; // ORPHANED
...
$string['databasesocket'] = 'Unix сокет'; // ORPHANED
$string['databasetypehead'] = 'Изабери драјвер базе података'; // ORPHANED
$string['databasetypesub'] = 'Moodle подржава неколико типова база података. Уколико не знате који тип да користите контактирајте администратора сервера.'; // ORPHANED
...
Пуна провера окружења се врши пре сваке инсталације или ажурирања постојеће верзије. Уколико не знате како да инсталирате нову верзију или омогућите PHP ектензије контактирајте Вашег сервер администратора.'; // ORPHANED
...
$string['nativemysqli'] = 'Унапређен MySQL(native/mysqli)'; // ORPHANED
$string['nativemysqlihelp'] = 'Сада је нопходно да конфигуришете базу податка где ће највећи део података из Moodlea бити похрањен. База података може бити креирана ако корисник има потребна овлашћења. Корисничко име и лозинка морају већ да постоје. Префикс табела је опциони.'; // ORPHANED
$string['nativeoci'] = 'Oracle (native/oci)'; // ORPHANED
$string['nativepgsql'] = 'PostgreSQL (native/pgsql)'; // ORPHANED
$string['nativepgsqlhelp'] = 'Сада је нопходно да конфигуришете базу податка где ће највећи део података из Moodlea бити похрањен. Ова база података претходно већ мора бити креирана, као и корисничко име и лозинка потребни за приступ бази. Префикс табеле је обавезан.'; // ORPHANED
$string['paths'] = 'Путање'; // ORPHANED
$string['pathserrcreatedataroot'] = 'Инсталциона процедура не може да креира директоријум базе података ($a->dataroot)'; // ORPHANED
$string['pathshead'] = 'Потврди путање'; // ORPHANED
$string['pathsrodataroot'] = 'У директоријум за податке није могућ упис'; // ORPHANED
$string['pathsroparentdataroot'] = 'У надређени директоријум ($a->parent) није могућ упис. Директоријум за податке ($a->dataroot) не може креирати инсталациони програм.'; // ORPHANED
$string['pathssubadmindir'] = 'Неколико сајтова за вебхостинг користи /admin као специјални УРЛ за приступ контролном панелу. На жалост, то може да да доведе до конфликта са стандардним директоријумом у којем су смештен Moodle администраторске странице. Овај проблем можете решити тако што ћете током инсталације преименовати admin директоријум у, на пример <em>moodleadmin</em>.'; // ORPHANED
$string['pathssubdataroot'] = 'Потребан вам је простор где ће Moodle чувати поставњене датотеке. Овај директоријум би требало да буде подешен тако да се може читати и у њега уписивати од стране корисника веб сервера (обично \'nobody\' или \'apache\'), али истовремено мора бити доступан директно преко веба. Уколико овај директоријум не постоји Moodle ће пикушати да га креира током инсталације,'; // ORPHANED
$string['pathssubdirroot'] = 'Пуна путања до директотијума за инсталацију Moodlea. Промените само уколико желите да користите синболичне линкове.'; // ORPHANED
$string['pathssubwwwroot'] = 'Пуна вер адреса преко које ће се приступати Moodleu. Није могуће приступати Moodleu користећи вишњ адреса. Уколико Ваш сајт има више јавних адреса онда на свима морате да подесите перманентну дирекцију ка једној адреси. Уколико је Ваш сајт доступам са Интернета али и из Интранет окружеања користите јавну адресу и подесите ДНС тако да и Интранет корисници могу да користе ту јавну адресу.'; // ORPHANED
$string['pathsunsecuredataroot'] = 'Dataroot локација није безбедна'; // ORPHANED
$string['pathswrongadmindir'] = 'Админ директоријум не постоји'; // ORPHANED
$string['pathswrongdirroot'] = 'Неисправна dirroot локација'; // ORPHANED
$string['phpextension'] = '$a PHP екстенѕија'; // ORPHANED
...
$string['pdosqlite3'] = 'SQLite 3 (PDO) <b><strong class=\"errormsg\">Експериментално! (није за коришћење на серверу на којем постоје активни курсеви)</strong></b>'; // ORPHANED
