<?PHP // $Id$ 
      // glossary.php - created with Moodle 1.6.2 (2006050520)


$string['addcomment'] = 'Додавање коментара';
$string['addentry'] = 'Додавање новог појма';
$string['addingcomment'] = 'Додајте коментар';
$string['aliases'] = 'Кључне речи';
$string['allcategories'] = 'Све категорије';
$string['allentries'] = 'СВЕ';
$string['allowcomments'] = 'Дозволите коментарисање појмова';
...
$string['deleteentry'] = 'Брисање појма';
...
$string['displayformats'] = 'Приказ формата';
...
$string['editentry'] = 'Уређивање појма';
...
$string['importentries'] = 'Увоз појмова';
...
$string['maxtimehaspassed'] = 'Нажалост, максимално допуштено време за уређивање/измену овог коментара ($а) је истекло!';
...
$string['ratingonlyteachers'] = 'Само $а може оцењивати појмове';
...
$string['rsssubscriberss'] = 'Приказати RSS подршку за \'$а\' концепте';
...
$string['withauthor'] = 'Концепти уз навођење аутора';
$string['withoutauthor'] = 'Концепти без навођења аутора';
$string['writtenby'] = 'од';
