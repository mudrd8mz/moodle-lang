...
<p>Да би се користили LDAP уписи, Ваши корисници <strong>морају</strong> имати валидно idnumber поље. LDAP групе морају имати тај idnumber у пољима чланова да би корисник био уписан на курс. Ово ће обично радити добро ако већ користите LDAP Ауторизацију.</p>
...
$string['enrol_ldap_course_settings'] = 'Подесите упис курса';
...
$string['enrol_ldap_student_settings'] = 'Подешавања уписа студената';
