<?PHP // $Id$ 
      // lesson.php - created with Moodle 1.9.5 (Build: 20090515) (2007101550)
...
$string['displayscorewithessays'] = 'Освојили сте $a->score од максималних $a->tempmaxgrade бодова за питања која се аутоматски оцењују.<br />Ваш $a->essayquestions одговор на питања  у форми есеја биће ускоро прегледан и оцењен а оцена ће бити додата<br />диналном резултату.<br /><br />Ваша тренутна оцена (без есеја) је $a->score од $a->grade';
...
$string['progressbarteacherwarning2'] = 'Нећете моћи да видите траку напредовања зато што уређујете ову лекцију';
...
$string['cannotdeleteanswer'] = 'Ажурирање стране: није могуће обрисати запис одговора'; // ORPHANED
$string['cannotdeleteattempt'] = 'Грешка: није могуће обрисати старе покушаје'; // ORPHANED
$string['cannotdeletebranch'] = 'Грешка: није могуће обрисати старе виђене огранке'; // ORPHANED
$string['cannotinsertanswer'] = 'Не може се унети запис о одговору'; // ORPHANED
$string['cannotinsertgrade'] = 'Не може се унети оцена'; // ORPHANED
$string['cannotinserthighscore'] = 'Унос новог најбољег резултата није успео!'; // ORPHANED
$string['cannotinsertpage'] = 'Не може се унети нова страна'; // ORPHANED
$string['cannotinserttimer'] = 'Грешка: није могуће унети ред у табелу lesson_timer'; // ORPHANED
$string['cannotresetjump'] = 'Lesson restorelib: није могуће ресетовати скок'; // ORPHANED
$string['cannotupdateanswer'] = 'Ажурирање стране: одговор није ажуриран'; // ORPHANED
$string['cannotupdatebook'] = 'Није могуће ажурирати Вашу књигу'; // ORPHANED
$string['cannotupdategrade'] = 'Не може се ажурирати оцена'; // ORPHANED
$string['cannotupdatelink'] = 'Не може се ажурирати линк'; // ORPHANED
$string['cannotupdatepage'] = 'Ажурирање стране: страна није ажурирана'; // ORPHANED
$string['cannotupdatetimer'] = 'Грешка: није могуће ажурирање табеле lesson_timer'; // ORPHANED
