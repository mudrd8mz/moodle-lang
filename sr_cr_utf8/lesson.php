...
$string['addabranchtable'] = 'Додај табелу гранања';
...
$string['cannotdeleteanswer'] = 'Ажурирање стране: није могуће обрисати запис одговора';
$string['cannotdeleteattempt'] = 'Грешка: није могуће обрисати старе покушаје';
$string['cannotdeletebranch'] = 'Грешка: није могуће обрисати старе виђене огранке';
...
$string['cannotinsertanswer'] = 'Не може се унети запис о одговору';
$string['cannotinsertgrade'] = 'Не може се унети оцена';
$string['cannotinserthighscore'] = 'Унос новог најбољег резултата није успео!';
$string['cannotinsertpage'] = 'Не може се унети нова страна';
$string['cannotinserttimer'] = 'Грешка: није могуће унети ред у табелу lesson_timer';
$string['cannotresetjump'] = 'Lesson restorelib: није могуће ресетовати скок';
$string['cannotupdateanswer'] = 'Ажурирање стране: одговор није ажуриран';
$string['cannotupdatebook'] = 'Није могуће ажурирати Вашу књигу';
$string['cannotupdateessayscore'] = 'Није могуће ажурирати резултат за есеј';
$string['cannotupdategrade'] = 'Не може се ажурирати оцена';
$string['cannotupdatelink'] = 'Не може се ажурирати линк';
$string['cannotupdatepage'] = 'Ажурирање стране: страна није ажурирана';
$string['cannotupdatetimer'] = 'Грешка: није могуће ажурирање табеле lesson_timer';
...
$string['checkedthisone'] = 'изабрало овај одговор';
...
$string['displaydefaultfeedback'] = 'Приказ подразумеваних повратних информација';
$string['displayhighscores'] = 'Приказ најбољих резултата';
$string['displayinleftmenu'] = 'Приказ у менију са леве стране?';
$string['displayleftif'] = 'и прикажи само ако $a има оцену већу од:';
...
$string['essay'] = 'Есеј';
$string['essayemailmessage'] = '<p>Тражени есеј:<blockquote>$a->question</blockquote></p><p>Ваш одговор:<blockquote><em>$a->response</em></blockquote></p><p>Коментар предавача ($a->teacher\'s):<blockquote><em>$a->comment</em></blockquote></p><p>Добили сте оцену $a->earned од максимално $a->outof за одговор у форми есеја дат на питање.</p><p>Ваша оцена за ову лекцију је промењена на $a->newgrade%%.</p>';
...
$string['gradebetterthanerror'] = 'Заслужите оцену вишу од $a процената';
...
$string['invalidid'] = 'Није прослеђен валидан идентификатор модула/лекције';
$string['invalidlessonid'] = 'Идентификатор лекције није био валидан';
$string['invalidpageid'] = 'Невалидан идентификатор странице';
$string['jump'] = 'Прелаз';
...
$string['mediafile'] = 'Искачући прозор за приказ датотеке или веб странице';
...
$string['nobranchtablefound'] = 'Није пронађена ниједна табела гранања';
...
$string['randombranch'] = 'Насумично одабрана табела гранања';
...
$string['outoftime'] = 'Време је истекло'; // ORPHANED
$string['studentoutoftime'] = 'Упозорење: Истекло Вам је време за ову лекцију. Ваш последњи одговор није урачунат зато што је дат након што је време истекло. Притисните дугме испод да бисте завршили лекцију.'; // ORPHANED
$string['editlesson'] = 'Уреди $a'; // ORPHANED
$string['mainmenu'] = 'Мени курса'; // ORPHANED
$string['returnmainmenu'] = 'Повратак на главни мени'; // ORPHANED
