...
$string['adminhelpmymoodle'] = 'הגדר את בלוקי ה-Moodle שלי עבור משתמשים';
...
$string['adminhelpstickyblocks'] = 'הגדר בלוקים דביקיים בכל אתר Moodle';
...
$string['authenticationplugins'] = 'התקנים מאושרים';
...
$string['backupnoneusersinfo'] = 'הודעה: בחרת לגבות \"אף אחד\" מהמשתמשים, כך שכל גיבויי המודולים שונו למצב \"ללא מידע משתמש\". אנא שים לב שמודולי ה\"תרגול\" וה\"סדנה\" אינם מתאימים לסוג זה של גיבוי, כך שהם נוטרלו לחלוטין.';
...
$string['cachecontrols'] = 'כלי בקרת מתמון';
$string['cancel'] = 'בטל';
...
$string['childcourses'] = 'קורסים נגזרים';
$string['choose'] = 'בחר';
$string['chooseauthmethod'] = 'בחר התקן אימות';
...
$string['convertingwikitomarkdown'] = 'המרת Wiki לשפת סימנים Markdown';
...
$string['courseformatdata'] = 'נתונים פורמט הקורס';
...
$string['createfolder'] = 'צור תיקיית ב$a';
...
$string['creatingmodroles'] = 'יצירת תפקיד למטלות ויכולת עקיפה לרמת המודול';
...
$string['edhelpcleanword'] = 'הגדרה זו מאפשרת או מנטרלת מסנני פורמט Word-specific.';
$string['edhelpenablespelling'] = 'מאפשרת או מנטרלת spell-checking. כאשר מאופשר, <strong> aspell </strong> מוכרח להיות מותקן בשרת. הערך השני הוא ה <strong> default dictionary </strong>. ערך זה יופעל אם ל-aspell אין מילון עבור משתמשים בשפה שלהם.';
...
$string['expirynotify'] = 'הודעת רישום אשר תוקפו תם.';
...
$string['formatlams'] = 'פורמט קורס LAMS';
...
$string['formattopicsajax'] = 'פורמט נושאים - AJAX';
$string['formatweeks'] = 'פורמט שבועי';
$string['formatweekscss'] = 'פורמט שבועי - CSS/No tables';
$string['formatwiki'] = 'פורמט Wiki';
$string['framesetinfo'] = 'סמך frameset זה מכיל:';
$string['from'] = 'מאת';
...
$string['hiddenassign'] = 'הסתר תרגיל';
$string['hiddensections'] = 'קטעים נסתרים';
$string['hiddensectionscollapsed'] = 'קטעים נסתרים מוראית בצורה מקובצת';
$string['hiddensectionsinvisible'] = 'קטעים נסתרים הינם בלתי נראים לחלוטין';
$string['hide'] = 'הסתר';
...
$string['importgroups'] = 'ייבוא קבוצות';
...
$string['newpasswordtext'] = 'שלום לך $a->firstname, סיסמת חשבונך באתר \'$a->sitename\' אופסה, והונפקה לך סיסמה זמנית חדשה. פרטי ההתחברות החדשים שלך הינם: שם משתמש: $a->username סיסמה: $a->newpassword אנא גש לעמוד זה כדי לשנות את סיסמאתך: $a->link ברוב תוכנות הדואר, כתובת האינטרנט אמורה להופיע כקישור כחול אשר אתה יכול פשוט ללחוץ עליו. אם זה לא עובד, גזור את הכתובת והדבק אותה בתוך פס הכתובות של דפדפן האינטרנט שלך. איחולי הצלחה מהמנהל של \'$a->sitename\'. $a->signoff';
...
$string['noticenewerbackup'] = 'קובץ גיבוי זה נוצר עם Moodle $a->backuprelease ($a->backupversion) וזוהי גרסה חדשה יותר מאשר הגרסה הנוכחית המותקנת אצלך ב-Moodle $a->serverrelease $a->serverversion). דבר זה יכול לגרום לחוסר עקביות מפני שתאימות אחורנית של קבצי גיבוי לא מובטחת.';
...
$string['page'] = 'עמוד';
$string['pageheaderconfigablock'] = 'הגדר בלוק ב-%%fullname%%';
...
$string['resetinfo'] = 'עמוד זה מאפשר לך לרוקן קורס של נתוני משתמש, כאשר פעילויות והגדרות אחרות נשמרות. אנא שים לב בבחירת פריטים אלו והשלמת עמוד זה נתוני המשתמש שבחרת בקורס זה ימחקו לעולם.';
...
$string['showblockcourse'] = 'הראה רשימת קורסים המכילים בלוק';
...
$string['to'] = 'ל';
$string['today'] = 'היום';
$string['todaylogs'] = 'יומני המעקב של היום';
...
$string['uploadformlimit'] = 'הקובץ המועלה עבר את תחום הגודל המקסימלי אשר הוגדר בטופס זה.';
...
$string['uploadserverlimit'] = 'הקובץ המועלה עבר את תחום הגודל המקסימלי אשר הוגדר בשרת.';
...
$string['withselectedusers'] = 'עם משתמשים נבחרים...';
