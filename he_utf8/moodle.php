...
$string['coursehelpformat'] = 'דף הבית של הקורס יוצג בתבנית זו.';
$string['coursehelphiddensections'] = 'כיצד קטעים מוסתרים בקורס מוצגים לסטודנטים.';
$string['coursehelpmaximumupload'] = 'הגדר את הגודל המקסימלי להעלאת קובץ ע\"י הסטודנטים בקורס זה, מוגבל ע\"י ההגדרות הנרחבות של האתר.';
$string['coursehelpmetacourse'] = 'הגדר את הקורס במטה-קורס. מטה קורס לוקח הרשמות ותפקידים מקורס או קורסי  \"בן\".';
$string['coursehelpnewsitemsnumber'] = 'מספר הפריטים האחרונים המוםיעים בדף הבית של הקורס, בבלוק חדשות בד\"כ מצד ימין למטה. 0 משמעותו כי הבלוק לא יופיע.';
...
$string['coursesettings'] = 'הגדרות ברירת המחדל של הקורס';
...
$string['formattexttype'] = 'פורמט';
$string['formattopics'] = 'פורמט נושאים';
$string['formattopicsajax'] = 'פורמט נושאים - AJAX';
$string['formattopicscss'] = 'תבנית נושאים - CSS/ללא טבלאות';
...
$string['hiddenassign'] = 'הסתר תפקיד';
$string['hiddensections'] = 'קטעים נסתרים';
$string['hiddensectionscollapsed'] = 'קטעים נסתרים נראים בצורה מקובצת';
...
$string['idnumbermod'] = 'מספר זיהוי';
$string['idnumbertaken'] = 'מספר זיהוי זה כבר נמצ בשימוש';
...
$string['interestslist'] = 'רשימת תחומי עניין';
...
$string['move'] = 'הזז';
$string['movecategorycontentto'] = 'הזז ל';
$string['movecategoryto'] = 'הזז קטגוריה ל:';
$string['movecontentstoanothercategory'] = 'הזז תכנים לקטגוריה אחרת';
...
$string['plugincheck'] = 'בדיקת התקנים';
$string['pluginchecknotice'] = 'הטבלאות הבאות מציגות את המודולים, בלוקים ומסננים אשר נמצאו בחבילת התקנת ה-Moodle שלך; הם מציינים אלו התקנים הם סטנדרטיים ואלו אינם סטנדרטיים. כל ההתקנים הלא-סטנדרטיים צריכים להיבדק והשתדרג לגירסה החדשה ביותר שלהם.';
...
$string['remoteappuser'] = 'הסר את המשתמש $a';
$string['remove'] = 'הסרה';
