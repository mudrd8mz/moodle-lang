...
$string['continuetocourse'] = 'חזרה לעמוד הראשי של הקורס';
...
$string['pluginchecknotice'] = 'הטבלאות הבאות מציגות את המודולים, בלוקים ומסננים אשר נמצאו בחבילת התקנת ה-Moodle שלך; הם מציינים אלו התקנים הם סטנדרטיים ואלו אינם סטנדרטיים. כל התוספים הלא-סטנדרטיים צריכים להיבדק והשתדרג לגירסה החדשה ביותר שלהם.';
