...
$string['adminhelpstickyblocks'] = 'הגדר משבצות דביקיים בכל אתר Moodle';
...
$string['backupincludemoduleuserdatahelp'] = 'בחר האם אתה רוצה לכלול רכיב נתוני משתמש בגיבויים הממוכנים.';
...
$string['backupmissinguserinfoperms'] = 'הערה: גיבוי זה לא מכיל אף מידע על משתמש. פעילויות תרגיל וסדנה לא יכללו בגיבוי זה מפני שרכיבים אלו לא תואמים סוג גיבוי זה.';
$string['backupnameformat'] = '%%Y%%m%%d-%%H%%M';
$string['backupnext'] = 'הגיבוי הבא';
$string['backupnoneusersinfo'] = 'הודעה: בחרת לגבות \"אף אחד\" מהמשתמשים, כך שכל גיבויי הרכיבים שונו למצב \"ללא מידע משתמש\". אנא שים לב שרכיבי ה\"תרגיל\" וה\"סדנה\" אינם מתאימים לסוג זה של גיבוי, כך שהם נוטרלו לחלוטין.';
...
$string['blockseditoff'] = 'נטרל עריכת משבצות';
$string['blocksediton'] = 'אפשר עריכת משבצות';
