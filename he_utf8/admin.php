...
$string['configallowobjectembed'] = 'כברירת המחדל של אמצעי האבטחה, משתמשים רגילים לא מורשים לשבץ קבצי מולטימדיה (כמו \"פלאש\") יחד עם טקסטים תוך שימוש מפורש ב EMBED ו OBJECT בתגי הHTML שלהם (אף על פי ש- הדבר יכול להיעשות בצורה בטוחה ע\"י שימוש במסננים של התקני המדיה).אם ברצונך להרשות את תגים אלו סמן את אפשרות זו.';
...
$string['configslasharguments'] = 'קבצים (תמונות, העלאות וכד\') מסופקים דרך תסריט (script) עם \'ארגומנטי לוכסנים\'. שיטה זו מאפשרת לקבצים להעלות בצורה קלה יותר לזכרון המטמון של דפדפני הרשת, שרתי proxy וכד\'. למרבה הצער, חלק משרתי ה-PHP לא מאפשרים שיטה זו, לכן אם אתה מתקשה לצפות בקבצים שהועלו או תמונות (למשל תמונות של משתמשים), נטרל אפשרות זו.';
...
$string['cronwarning'] = 'התסריט (script) <a href=\"cron.php\">cron.php maintenance script</a> לא רץ במשך 24 השעות האחרונות.';
