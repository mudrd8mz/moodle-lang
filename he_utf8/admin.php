...
$string['configgradeexport'] = 'בחר אלו פורמטים של גליון הציונים המיוצאים יהיו שיטות עיקריות בעבור יצוא ציונים. תוספים שנבחרו יוגדרו וישתמשו בשדה ה\"יצוא האחרון\" לכל ציון. לדוגמה, תוצאה יכולה להיות ברשומה מיוצאת תזוהה כ\"חדשה\" או \"מעודכנת\". אם אינך בטוח לגבי זה השאר הכל ריק.';
...
$string['gradebookroles'] = 'תפקידים להם ניתן לתת ציון';
