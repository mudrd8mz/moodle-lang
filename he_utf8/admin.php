...
$string['configauthenticationplugins'] = 'אנא בחר את אימותי ההתקנים אשר תרצה להשתמש ומיינם לפי סדר הכשלונות הצפוי. הרשמה עצמית תטופל ע\"י ההתקן הנבחר בעמודת ה-\'Registration\' (הרשמה בדר\"כ תתבצע ע\"י \'email\').';
...
$string['configenrolmentplugins'] = 'בחר את תוספות וידוא הרישום. אל תשכח להציב ערכים נכונים בהגדרות. </ br /> <br> עליך לציין אזי תוספים מאופשרים <strong>ואיזה אחד מהם <strong/> יהיה ברירת המחדל לרישום (strong> אינטאקטיבי. <strong/> בכדי לא לאפשר רישום אינטראקטיבי יש לציין \"לא\" בקורסים הנדרשים.';
...
$string['configintrotimezones'] = 'עמוד זה יחפש מידע חדש על איזורי זמן (כולל חוקי שעוני הקיץ) וישמור את מידע זה בבסיס הנתונים שלך. איזורים אילו יבדקו בסדר הבא: $a. בדרך כלל תהליך זה בטוח מאד ולא יפגום בהתקנות רגילות. <br /> <br /> האם ברצונך לעגן את איזור הזמן כעת?';
...
$string['configlocale'] = 'בחר הגדרות פרמטרים המשפיעות על כל האתר - הגדרות אלו יחליפו את הפןרמט והשפה של תאריכים לכל ערכות השפה (אם כי שמות הימים היומן לא משתנים). עליך החובה לדאוג כי הגדרות אלו מותקנות המערכת ההפעלה שלך. למשל: במערכת LINUX ערכים כגון en_US.UTF-8 או es_ES.UTF-8. ברוב המקרים שדה הגרה זה ישאר ריק.';
...
$string['configsmtpuser'] = 'אם ציינת למעלה שרת SMTP, ושרת זה מצריך אימות, אז הקש את שם המשתמש והססמה כאן.';
...
$string['dbmigrationdeprecateddb'] = 'למסד נתונים זה בוצעה הגירה למסד נתונים חדש בקידוד UTF8 ומחיקתו. אנא הגרד מחדש את קובץ config.php והשתמש במסד הנתונים החדש עבור ה-Moodle הנוכחי.';
...
$string['multilangforceold'] = 'הכרח תחביר ישן של שפות מרובות (multilang) : <span> ללא המחלקה : class=\"multilang\" and <lang>';
...
$string['stickyblocksduplicatenotice'] = 'באם הבלוק המוסף כאן כבר קיים בדף כל שהוא, אזי תתבצע הופעה נוספת שלו. רק בךוקים דביקים יהיו בלתי ניתנים לעריכה, הבלוק הנוסף יהיה בר עריכה';
