...
$string['configallowcategorythemes'] = 'כאשר תאפשר זאת, ערכת נושאים יכולה להיות מוגדרת ברמת הקטגוריה. דבר הישפיע על הבנים של הקטגוריות והקורסים אלא אם כן ערכת הנושאים מוגדרת בהם במפורש. אזהרה: איפשור ערכת נושאי קטגוריה עלולה להשפיע על ביצועי האתר.';
