...
$string['adminseesownevents'] = 'מנהלים רואים ארועים בדיוק כמו משתמשים רגילים';
...
$string['backgroundcolour'] = 'צבע המסמל שקיפות';
...
$string['confeditorhidebuttons'] = 'בחר את הכפתורים אשר יהיו מוסתרים בעורך ה-HTML';
...
$string['configclamfailureonupload'] = 'אם הגדרת את clam לסריקת קבצים מועלים לאתר, אך התוכנה אינה מוגדרת כראוי או היא אינה מצליחה לפעול מכל סיבה שהיא (לרוב בגלל הגדרת נתיב לא תקין לקובץ ההרצה של התוכנה), כיצד יש להתנהג? אם תבחר להתייחס לכל הקבצים כוירוסים, הקבצים יועברו לאיזור ההסגר או יימחקו. אם תבחר להתייחס לכל הקבצים כתקינים, הקבצים יועברו לספריית היעד כרגיל. בכל מקרה, המנבלים יקבלו הודעה שהפעלת clam נכשלה. מומלץ לנקוט משנה זהירות אם תבחר להתייחס לכל הקבצים כוירוסים.';
...
$string['configcronclionly'] = 'כאשר הגדרה זו מופעלת, סקריפט ה cron יוכל לפעול דרך שורת הפקודה במקום דרך הרשת. אפשרות זו למעשה רומסת את סיסמת ה cron.';
$string['configcronremotepassword'] = 'המשמעות היא שקוד סקריפט ה cron.php לא יוכל לפעול מהדפדפן מבלי לספק סיסמה ע\"י שימוש בתבנית ה URL שלהלן: :<pre> http://site.example.com/admin.cron.php?password=opensesame </pre> אם תיבה זו נשארת ריקה, אין דרישה לסיסמה.';
...
$string['configdocroot'] = 'מגדיר את הנתיב ל MOODLE DOCS. אתה יכול את תכונה זו אם תרצה ליצור תיעוד מקוונן ומותאם אישית. בכל אופן, אם תעשה כך דאג כי הנתיב בקבצי התיעוד שלך הוא באותו פורמט כמו http://docs.moodle.org .';
...
$string['configenabletrusttext'] = 'כברירת מחדל Moodle יאפשר ביסודיות ניקוי טקסט המגיע מהמשתמשים בכדי להסיר כל שגיאות אפשריות של סקריפט, מדיה וכד\' אשר יכולים להוות פריצת אבטחה. מערכת ה\"תוכן בטוח\" הנה אמצעי לאפשר למשתמשים מסוימים שאתה בוטח בהם את היכולת לכלול תכוהנות מתקדמות אלו במערכות התכנים שלהם ללא הפרעה. לשם כך עליך לאפשר, קודם כל, את ההגדרות ולאחר מכן להעניק את זכות ה\"תוכן הבטוח\" להגדרת תפקוד מסוים של Moodle. טקסטים הנוצרים או מועלים על ידי משתמשים אלו יסומנו כ\"בטוחים\" ולא ינוקו לפני הצגתם.';
...
$string['configfilteruploadedfiles'] = 'אפשור ערך זה תגרום ל-Moodle לעבד את כל קבצי הטקסט וקבצי HTML שהועלו בעזרת הפילטר לפני הצגתם.';
...
$string['configfullnamedisplay'] = 'אפשרות זו מגדירה כיצד שמות יופיעו כאשר הם מוצגים בצורה מלאה.עבור מרבית האתרים המתשמשים אך ורק בזפה אחת ההגרה היעילה ביותר היא הגדרת היסוד \"שם פרטי + שם משפחה\", אבל יש ביכולתך להעלים את שם השמפחה או להשאיר החלטה זאת להתקנה הנוכחית של ערכת השפה מכיוון ולחלק משפות יש מוסכמות שונות.';
...
$string['configgradeexport'] = 'בחר אלו פורמטים של פנקסי ציונים המיוצאים יהיו שיטות עיקריות בעבור יצוא ציונים. התקנים שנבחרו יוגדרו וישתמשו בשדה ה\"יצוא האחרון\" לכל ציון. לדוגמה, תוצאה יכולה להיות ברשומה מיוצאת תזוהה כ\"חדשה\" או \"מעודכנת\". אם אינך בטוח לגבי זה השאר הכל ריק.';
...
$string['confighiddenuserfields'] = 'בחר אילו שדות מידע של משתמשים תרצה להסתיר ממשתמשים אחרים מאשר ממורים/מנהלי מערכת של קורסים. דבר אשר יגדיל את אבטחת הסטודנט. החזק את מקש ה-CTRL לבחירת שדות מרובה.';
$string['confighideactivitytypenavlink'] = 'בחר ממי להסתיר את קישור סוג הפעילות (למשל בחנים) בניווט המוצג למודול הפעילות.';
$string['confightmleditor'] = 'בחר בין אם לאפשר או לא את השימוש בעורך המוכל של HTML. גם אם תאפשר זאת, העורך יופיע אך ורק כאשר המשתמש משתמש בדפדפן מתאים. ביכולת המשתמשים לא לבחור זאת.';
...
$string['configintcachemax'] = 'עבור מטמון פנימי בלבד. מספר מקסימלי של רשומות בכדי להחזיק במטמון. ערך מומלץ: 50. השתמש בערכים נמוכים להפחית את שימוש הזיכרון.';
...
$string['configkeeptagnamecase'] = 'בדוק זאת את אתה מעוניין ששמות התוויות ישמרו על ההבדלים בין אותיות קטנות ורישיות כפי שהוכנסו על ידי המשתמשים שיצרו אותן';
...
$string['configlatinexcelexport'] = 'השתמש בקידוד עבור ייצוא Exel';
$string['configlocale'] = 'בחר הגדרות פרמטרים המשפיעות על כל האתר - הגדרות אלו יחליפו את הפורמט והשפה של תאריכים לכל ערכות השפה (אם כי שמות הימים היומן לא משתנים). עליך החובה לדאוג כי הגדרות אלו מותקנות המערכת ההפעלה שלך. למשל: במערכת LINUX ערכים כגון en_US.UTF-8 או es_ES.UTF-8. ברוב המקרים שדה הגרה זה ישאר ריק.';
...
$string['configmaxbytes'] = 'הגדרה זו מציינת את הנפח המקסימלי של קבצים המועלים לרשת ברחבי האתר. הגדרה זו היא מוגבלת ע\"י הגדרת post_max_size ו-upload_max_filesize של ה-PHP , כמו כן הגדרת LimitRequestBody של Apache. לחילופין, maxbytes מגביל את הטווח של הגדלים שניתן לבחור בהם ברמת הקורס או ברמת המודול.';
...
$string['confignoreplyaddress'] = 'דוא\"לים לפעמים נשלחים כייצוג של המשתמש (למשל הודעות פורום). כתובת הדוא\"ל שתציין כאן ישומש ככתובת \"מוען\" במקרים כאלה כאשר המקבלים לא יוכלו להשיב ישירות למשתמש ששלח (למשך כאשר המשתמש בוחר לשמור על כתובת הדוא\"ל שלו כפרטית).';
...
$string['configrestrictmodulesfor'] = 'לאלו קורסים יש את ההוראה לנטרל פעיליות נבחרות במודלוים? שים לב שהגדרת זאת תופסת רק לגבי מורים, בעוד שמנהלים יוכלו עדיין להוסיף כל פעילות שהיא לקורס.';
...
$string['configsectionrequestedcourse'] = 'דרישות קורס';
$string['configsectionsecurity'] = 'אבטחה';
$string['configsectionstats'] = 'סטטיסטיקות';
$string['configsectionuser'] = 'משתמש';
$string['configsecureforms'] = 'מערכת Moodle תוכל להשתמש ברמה נוספת של אבטחה כאשר תקבל מידע מטפסי הרשת. באפשור הגדרה זו משתנה HTTP_REFERER של הדפדפן נבדק מול כתובת הטופס הנוכחי. במקרים מסויימים עלולות להיווצר בעיות אם משתמש המערכת משתמש בחומת מגן, למשל Zonealarm, ומורה לה למחוק את HTTP_REFERER מתעבורת רשת האינטרנט. סימנים לבעיות היא \"תקיעה\" בכת הצגת טופס. אם למשתמשים יש, למשל, תקלות בעמוד הרישום יתכן ותרצה לנטרל הגדרה זאת, גם אם היא תשאיר את האתר שלך יותר חשוף לנסיונות חוזרים ונשנים של שבירת הסיסמאות. אם אתה בספק השאר את הערך \"כן\".';
...
$string['configshowblocksonmodpages'] = 'מודלים אקטיביים מסויימים תומכים בבלוקים בדפים בהם הם נמצאים. אם תדליק אפשרות זו, מורים יוכלו להוסיף בלוקים צדדיים בדפים אלו, אחרת הממשק לא יראה את תכונה זו.';
...
$string['configslasharguments'] = 'קבצים (תמונות, העלאות וכד\') מסופקים דרך סקריפט עם \'ארגומנטי לוכסנים\' (האפשרות השניה כאן). שיטה זו מאפשרת לקבצים להעלות בצורה קלה יותר לזכרון המטמון של דפדפני הרשת, שרתי proxy וכד\'. למרבה הצער, חלק משרתי ה-PHP לא מאפשרים שיטה זו, לכן אם אתה מתקשה לצפות בקבצים שהועלו או תמונות (למשל תמונות של משתמשים), שנה את בחירת משתנה זה לאפשרות הראשונה.';
$string['configsmartpix'] = 'כאשר פועל, חיפוש הצלמיות מתחיל בסקריפט PHP אשר מחפש את ערכת הנושא הנוכחית, לאחר מכן חיפוש בכל ערכות הנושא המקוריות ולאחר מכן בתיקיית  Moodle/pix folder. תכונה זו מקטינה את הצורך בקבצי תמונות כפולות בתוך ערכות הנושא, אך גורם לתוספת זעומה בעלות הביצוע.';
...
$string['configsupportemail'] = 'כתובת דואל זה תופץ למשתמשים של אתר זה ככתובת שאליה יש לפנות לעזרה כללית (למשלף כאשר משתמישם חדשים יוצרים את החשבונות שלהם). את הכתובת נשארת ריקה אזי לא תסופק שום כתובת דואל למטרות עזרה.';
$string['configsupportname'] = 'זה שם האדם המציעים עזרה כללית באמצעות דואל התמיכה או באמצעות כתובת אתר.';
$string['configsupportpage'] = 'כתוהת אתר זה תןפץ למשתמשים של אתר זה ככתובת שאליה יש לפנות כאשר הם נזקקים לתמיכה כללית (למשל, כאשר משתמשים חדשים יוצרים את החשבונות שלהם). אם כתובת זאת נשארת ריקה לא יופץ כל קישור שהוא.';
...
$string['configusetags'] = 'האם יש לאפשר את פונקצונליות התווית באופן סוחף לכל האתר?';
...
$string['courserequests'] = 'דרישות הקורס';
...
$string['cronwarning'] = 'הסקריפט <a href=\"cron.php\">cron.php maintenance script</a> לא רץ במשך 24 השעות האחרונות.';
...
$string['defaultrequestcategory'] = 'ברירת המחדל לבקשות בקורס זה.';
...
$string['enablerecordcache'] = 'אשפר שימוש בזיכרון מטמון לרשומות.';
...
$string['filtersettings'] = 'סנן הגדרות';
...
$string['frontpage'] = 'עמוד שער';
$string['frontpagebackup'] = 'גיבוי העמוד הראשי';
$string['frontpageloggedin'] = 'תבנית עמוד השער כאשר מתחברים';
$string['frontpagerestore'] = 'שחזור העמוד הראשי';
$string['frontpageroles'] = 'תפקידי העמוד הראשי';
$string['frontpagesettings'] = 'הגדרות העמוד הראשי';
$string['fullnamedisplay'] = 'תבנית שם מלא';
...
$string['incompatibleblocks'] = 'בלוקים לא מתאימים';
$string['install'] = 'התקן';
$string['installedlangs'] = 'התקן חבילת שפה';
...
$string['keeptagnamecase'] = 'שמור את גדלי האותיות של שמות התוויות';
...
$string['langpackmaintaining'] = 'טיפול בחבילות שפה';
$string['langpackremoved'] = 'חבילת השפה לא הותקנה';
...
$string['maxbytes'] = 'גודל קבצים מועלים מקסימלי';
$string['maxeditingtime'] = 'זמן מקסימלי לעריכת הודעות';
...
$string['mediapluginswfnote'] = 'כאמצעי אבטחה כברירת מחדל, משתמשים לא יורשו לשבץ קבצי swf של flash';
...
$string['modulesecurity'] = 'אבטחת מודול';
...
$string['profilefieldmaxlength'] = 'אורך מקסימלי';
...
$string['profilefieldtypetext'] = 'קלט טקסט';
$string['profilefieldtypetextarea'] = 'איזור טקסט';
...
$string['profileshortname'] = 'שם קצר (חייב להיות ייחודי)';
...
$string['restrictmodulesfor'] = 'הגבלת מודולים ל';
...
$string['riskspamshort'] = 'כשלי spam';
$string['riskxss'] = 'משתמשים יכולים להוסיף קבצים וטקסטים אשר מאפשרים כתיבת סקריפט XSS- cross-site';
...
$string['sessionhandling'] = 'טיפול מושב (session)';
$string['sessiontimeout'] = 'חלוף הזמן';
$string['showblocksonmodpages'] = 'הראה בלוקים בדפי מודולים';
...
$string['statsfirstrun'] = 'רווח עיבוד מקסימלי';
$string['statsmaxruntime'] = 'זמן ריצה מקסימלי';
$string['statsruntimestart'] = 'ריצה ב';
$string['statsuserthreshold'] = 'סף משתמש';
$string['stickyblocks'] = 'בלוקים דביקים';
$string['stickyblockscourseview'] = 'דף קורס';
$string['stickyblocksduplicatenotice'] = 'באם הבלוק המוסף כאן כבר קיים בדף כל שהוא, אזי תתבצע הופעה נוספת שלו. רק בלוקים דביקים יהיו בלתי ניתנים לעריכה, הבלוק הנוסף יהיה בר עריכה';
$string['stickyblocksmymoodle'] = 'מוודל שלי (My moodle)';
$string['stickyblockspagetype'] = 'סוג דף לשם עיצוב';
$string['supportemail'] = 'דואך התמיכה';
...
$string['tabselectedtofronttext'] = 'הבא שורת לשונית נבחרת קדימה';
$string['themelist'] = 'רשימת נושא';
$string['themeselector'] = 'בחירת ערכת נושא';
$string['themesettings'] = 'הגדרות נושא';
...
$string['unbookmarkthispage'] = 'אל תסמן את דף זה';
...
$string['unicodeupgradenotice'] = 'ב-Moodle 1.6 שינינו את כל השפות לקידוד Unicode. בכדי להשלים את השדרוג לאתר זה, תצטרך להמיר את כל המידע במסדי הנתונים שלך ל- Unicode (UTF-8) ע\"י שימוש בסקריפט הבא: <a href=\"utfdbmigrate.php\">Click here to run the migration script now</a>!';
...
$string['usehtmleditor'] = 'השתמש בעורך HTML';
$string['useraccountupdated'] = 'משתמש עודכן';
$string['userbulk'] = 'פעולות חובקות כל ביחס למשתמשים';
$string['userlist'] = 'עיון ברשימת המשתמשים';
...
$string['usetags'] = 'אשפר פונקיונאליות של תוויות';
