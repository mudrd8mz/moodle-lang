...
$string['langpackwillbeupdated'] = 'הערה למתרגמים: במהלך השדרוגת Moodle ינסה לשדרג את חבילת השפה שלך. ההתאמות לתיקיות השפה הלא-מקומיות שלך יכתבו מחדש.';
...
$string['usetags'] = 'אפשר פונקיונאליות של תוויות';
