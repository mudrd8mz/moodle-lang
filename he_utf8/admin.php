...
$string['blocksettings'] = 'נהל בלוקים';
...
$string['commonsettings'] = 'הגדרות מצויות';
...
$string['configallowobjectembed'] = 'כברירת המחדל של אמצעי האבטחה, משתמשים רגילים לא מורשים לשבץ קבצי מולטימדיה (כמו Flash) יחד עם טקסטים תוך שימוש מפורש ב EMBED ו OBJECT בתגי הHTML שלהם (אף על פי ש- הדבר יכול להיעשות בצורה בטוחה ע\"י שימוש במסננים של התקני המדיה).אם ברצונך להרשות את תגים אלו סמן את אפשרות זו.';
...
$string['configcourserequestnotify2'] = 'משתמשים אשר יקבלו הודעה כאשר קורס נדרש. רק המשתמשים אשר יאשרו את בקשור הקורס יופיעו ברשימה זו.';
...
$string['configcronremotepassword'] = 'המשמעות היא שקוד סקריפט ה cron.php לא יוכל לפעול מהדפדפן מבלי לספק סיסמה ע\"י שימוש במבנה ה-URL שלהלן: :<pre> http://site.example.com/admin.cron.php?password=opensesame </pre> אם תיבה זו נשארת ריקה, אין דרישה לסיסמה.';
...
$string['configenablecalendarexport'] = 'אפשר ייצוא או הרשמה כמנוי ללוחות השנה.';
...
$string['configgradeexport'] = 'בחר אלו פורמטים של פנקסי הציונים המיוצאים יהיו שיטות עיקריות בעבור יצוא ציונים. התקנים שנבחרו יוגדרו וישתמשו בשדה ה\"יצוא האחרון\" לכל ציון. לדוגמה, תוצאה יכולה להיות ברשומה מיוצאת תזוהה כ\"חדשה\" או \"מעודכנת\". אם אינך בטוח לגבי זה השאר הכל ריק.';
...
$string['configsitemaxcategorydepth'] = 'עומק קטגוריה מקסימלי';
$string['configsitemaxcategorydepthhelp'] = 'הגדרה מציינת את העומק המקסימלי המוצג של בני הקטגוריה';
...
$string['configslasharguments'] = 'קבצים (תמונות, העלאות וכד\') מסופקים דרך סקריפט עם \'ארגומנטי לוכסנים\'. שיטה זו מאפשרת לקבצים להעלות בצורה קלה יותר לזכרון המטמון של דפדפני הרשת, שרתי proxy וכד\'. למרבה הצער, חלק משרתי ה-PHP לא מאפשרים שיטה זו, לכן אם אתה מתקשה לצפות בקבצים שהועלו או תמונות (למשל תמונות של משתמשים), נטרל אפשרות זו.';
...
$string['configsmtpmaxbulk'] = 'המספר המקסימלי של הודעות אשר נשלחות בכל מושב SMTP. הודעות מקובצות יכול להאיץ את שליחת ההודעות. ערך הקטן מ-2 מאלץ יצירת מושב SMTP חדש עבור כל דוא\"ל.';
...
$string['configstatsmaxruntime2'] = 'עיבוד סטטיסטיקות עלול להיות די אינטנסיבי. ציין את הזמן המקסימלי לאיפשור איסוף סטטיסטיקות עבור יום אחד. המספר המקסימלי של ימים אשר מעובדים בביצוע cron הוא 31.';
$string['configstatsmaxruntime3'] = 'ציין את הזמן המקסימלי לאיפשור חישוב הסטטיסיקות עבור יום אחד, נזכור כי עיבוד סטטיסטיקות עלול להכביד על השרת. המספר המקסימלי של ימים אשר מעובדים ב-cron אחד יכול מפורט כאן.';
$string['configstatsruntimedays'] = 'ציין את מספר הימים המקסימלי המעובדים בכל ביצוע של סטטיסטיקות. כאשר הסטטיסטיקות מעודכנות, רק יום אחד יעובד, ווסת את ערך זה בהתאם לעומס בשרת שלך, הקטן ערך זה אם bjumho ביצועים קצרים של ה-cron.';
...
$string['configverifychangedemail'] = 'אפשר אימות כתובות דוא\"ל ששונו ע\"י התרה ודחיית הגדרות התחומים של כתובות הדוא\"ל. אם הגדרה זו מנוטרלת, התחומים יואכפו רק ע\"י יצירת משתמשים חדשים.';
...
$string['defaultrequestcategory'] = 'ברירת המחדל לדרישות בקורס זה.';
...
$string['excludeoldflashclients'] = 'נדרשת גרסת נגן Flash';
...
$string['frontpagequestions'] = 'שאלות העמוד הראשי';
...
$string['langimportdisabled'] = 'תכונת יבוא שפה נוטרלה. עליךלעדכן את חבילות השפה באופן ידני ברמת המערכת.';
...
$string['mycoursesperpage'] = 'מספר מקסימלי של קורסים';
...
$string['statscatdepth'] = 'קטגוריות הורה מקסימליות';
...
$string['upgrade197notice'] = '<p>Moodle 1.9.7  מכיל מספר תיקוני אבטחה עבור סיסמאות משתמשים וגיבויים בכדי להגן על מידע המשתמש באתר שלך. כתוצאה מכך ייתכן כי הגדרות והרשאות מסויימות הנוגעים לגיבויים השתנו.<br />
<a href=\"http://docs.moodle.org/en/Moodle_1.9.7_release_notes\" target=\"_blank\">Moodle 1.9.7 release notes</a> לפרטים נוספים</p>';
...
$string['usetags'] = 'אפשר את פונקיונאליות התגים';
