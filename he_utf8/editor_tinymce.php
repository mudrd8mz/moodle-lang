...
$string['table_dlg:cell_limit'] = 'חריגה ממספר המקסימאלי של התאים בטבלה של {$cells}.';
...
$string['table_dlg:col_limit'] = 'חריגה ממספר העמודות המקסימאלי של {$cols}.';
...
$string['table_dlg:row_limit'] = 'חריגה ממספר המקסימאלי של השורות של {$rows}.';
