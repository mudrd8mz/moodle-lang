...
$string['addingdescription'] = 'הוספת שאלה קצרה פתוחה';
...
$string['cannotopen'] = 'לא ניתן לפתוח את קובץ הייצוא ($a)';
$string['cannotread'] = 'לא ניתן לקרוא את הקובץ המיובא (או שהקובץ ריק)';
$string['cannotwrite'] = 'לא ניתן לכתוב בקובץ הייצוא ($a)';
...
$string['defaultgrade'] = 'ציון ברירת המחדל לשאלה';
...
$string['description'] = 'שאלה פתוחה קצרה';
...
$string['editingdescription'] = 'עריכת שאלה פתוחה קצרה';
...
$string['exporterror'] = 'חלה שגיאה במהלך עיבוד הייצוא';
...
$string['formatnotfound'] = 'לא נמצא פורמט ייבוא-ייצוא $a';
$string['formatnotimplemented'] = 'פורמט זה לא יושם נכונה, אנא פרסם דוח באגים (שגיאות).';
...
$string['hotpot'] = 'פורמט תוכנת Hot Potatoes';
...
$string['importerror'] = 'חלה שגיאה במהלך עיבוד הייבוא.';
...
$string['importparseerror'] = 'שגיאות נמצאו לאחר ניתוח הקובץ המיובא. לא נימצא ייבוא של שאלות. בכדי לייבא שאלות תקינות נסה שוב ושנה את בחירת \"עצור בשגיאה\" ל \"לא\".';
...
$string['matchanswerno'] = '$a תשובה תואמת';
...
$string['missingname'] = 'חסר שם שאלה';
$string['missingquestion'] = 'חסרה תווית שאלה לאחר שורה $a';
$string['missingquestiontext'] = 'חסר טקסט השאלה';
$string['missingword'] = 'חסר פורמט המילים';
...
$string['noquestionsinfile'] = 'אין שאלות בקובץ הייבוא.';
...
$string['openclosedatesupdated'] = 'מועדי פתיחה וסגירת הבוחן עודכנו';
$string['optional'] = 'לבחירתכם';
$string['outof'] = '$a->grade מתוך מקסימום של $a->maxgrade';
$string['outofpercent'] = '$a->grade מחו. לערך המקסימלי המוגדר כ-  $a->maxgrade ($a->percent%%)';
...
$string['penalty'] = 'קנס';
$string['penaltyfactor'] = 'גורם הקנס';
...
$string['qti'] = 'פורמט IMS QTI';
$string['qti2'] = 'פורמט IMS QTI 2.0';
...
$string['quizclose'] = 'סגור את הבוחן';
$string['quizclosed'] = 'בוחן זה נסגר ב-$a';
$string['quizcloses'] = 'הבוחן נסגר';
$string['quizcloseson'] = 'בוחן זה יסגר ב';
$string['quiznotavailable'] = 'הבוחן לא יהיה זמין עד ל-$a';
$string['quizopen'] = 'פתח את הבוחן';
$string['quizopens'] = 'הבוחן נפתח';
...
$string['regradedisplayexplanation'] = 'ניסיונות מענה שמשתנים במהלך הבדיקה מחדש, מוצגים כקישורי היפר-טקסט לחלון העיון בשאלה.';
...
$string['reviewoptionsheading'] = 'סקירת אפשרויות';
...
$string['save'] = 'שמור';
$string['saveandedit'] = 'שמור שינויים וערוך את השאלות.';
...
$string['xml'] = 'פורמט XML של מוודל';
$string['xmlimportnoname'] = 'שם השאלה חסר בקובץ XML';
$string['xmlimportnoquestion'] = 'טקסט השאלה חסר בקובץ ה-XML';
$string['xmltypeunsupported'] = 'שאלות מסוג $a לא נתמכות על ידי ייבוא xml.';
