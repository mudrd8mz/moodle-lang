...
$string['formatnotfound'] = 'לא נמצא פורמט ייבואייצוא $a';
...
$string['missingword'] = 'פורמט \"מילים־חסרות\"';
...
$string['outofpercent'] = '$a->grade  לערך המקסימלי המוגדר כ  $a->maxgrade ($a->percent%%)';
