...
$string['aggregateextracreditmean'] = 'משמעות הציונים (עם קרדיט נוסף)';
$string['aggregatemax'] = 'הציון הגבוה ביותר';
$string['aggregatemean'] = 'תווך הציונים';
$string['aggregatemedian'] = 'חציון הציונים';
$string['aggregatemin'] = 'הציון הנמוך ביותר';
$string['aggregatemode'] = 'צורת הציונים';
$string['aggregateonlygraded'] = 'צבירת רק ציונים לא-ריקים';
$string['aggregateonlygradedhelp'] = 'ציונים אשר לא קיימים נחשבים כציונים מינימליים או שלא נחשבים בצבירה.';
...
$string['aggregatesubcats'] = 'צבירת תתי-קטגוריות נחשבת';
$string['aggregatesum'] = 'סכום הציונים';
$string['aggregateweightedmean'] = 'משקל תווך הציונים';
$string['aggregateweightedmean2'] = 'משקל תווך ציונים רגיל';
$string['aggregation'] = 'צבירה';
$string['aggregationcoef'] = 'מקדם הצבירה';
$string['aggregationcoefextra'] = 'קרדיט נוסף';
$string['aggregationcoefextrahelp'] = 'קרדיט נוסף לציון פריט ציון זה במהלך צבירה';
$string['aggregationcoefextrasum'] = 'סכום קרדיט נוסף';
$string['aggregationcoefextrasumhelp'] = 'סכום קרדיט נוסף לציון פריט ציון זה במהלך צבירה';
...
$string['combo'] = 'חוצצים תפריטים גולשים';
$string['compact'] = 'כווץ';
...
$string['configcoursegradedisplaytype'] = 'בחר את צורת התצוגה כברירת מחדל עבור הציונים לקורס זה. תוכל לבחור בערך ברירת המחדל של האתר. ציונים עשויים להיות מוצגים כציונים אמיתיים, אחוזים (בהתייחס לציונים מינימליים ומקסימליים) או כאותיות (A,B,C וכו\'). בחירה באותיות תאפשר לך לבחור את כל אות וגבול שתרצה.';
...
$string['configexportdecimalpoints'] = 'מספר נקודות העשרוניות להצגה עבור הייצוא.';
...
$string['configgradeexportdisplaytype'] = 'ציונים עשויים להיות מוצגים כציונים אמיתיים, אחוזים (בהתייחס לציונים מינימליים ומקסימליים) או כאותיות (A,B,C וכו\') במהלך הייצוא. ניתן לעקוף הגדרות אלו במהלך הייצוא.';
...
$string['configgradepublishing'] = 'איפשור פרסום לייצוא וייבוא:ניתן לגשת לציונים שעברו ייצוא ע\"י גישה ל URL , ללא צורך להתחבר לאתר. ציונים יכולים להיות מיובאים ע\"י גישה ל-URL כזה (משמע כי אתר Moodle יכול לייבא ציונים אשר פורסמו מאתר אחר). ברירת המחדל מקנה רק למנהלי האתר להשתמש בתכונה זו, אנא עדכן את המשתמשים לפני מתן יכולות אלו למשתמשים בתפקידים השונים באתר (זהירות מסמניות משותפות ומאיצי הורדות, הגבלות IP ועוד...).';
...
$string['configincludescalesinaggregation'] = 'תוכל לשנות, האם סולמות מוכללות כמספרים בכל הציונים אשר נכללו בצבירה בכל גליונות הציונים ובכל הקורסים. הזהרה: שינוי הגדרה זו יאלץ את כל ציוני הצבירה לערוך חישוב מחדש.';
...
$string['configshowhiddenitems'] = 'מציין כיצד פריטי ציון מוסתרים יראו (יוצגו). אם \"הסתר\" נבחר, הם יהיו מוסתרים לגמרי. אם \"הראה\" נבחר, שורת פריט הציון תוצג באפור יחד עם הסתרת הציון. אם \"מוסתרים עד\" נבחר, ציונים עם התאריך של הגדרת \"מוסתרים עד\" יוצגו באפור יחד עם הציונים המוסתרים עד לתאריך המוגדר, לאחר מכן כל פריט הציון יוצג.';
...
$string['coursescales'] = 'סולמות קורס';
$string['coursesettings'] = 'הגדרות הקורס';
$string['coursesettingsexplanation'] = 'הגדרות קורס קובעות איך גליון הציונים מופיע לכל המשתתפים בקורס';
...
$string['gradetype'] = 'סוג הבודק';
$string['gradetypehelp'] = 'סוג הציון שפריט זה משתמש בו. יתכנו 4 סוגים: אין כלל, ערך, סקאלה וטקסט. רק סוגיהערך והסקאלה ניתנים לצבירה.';
...
$string['importoutcomes'] = 'יבא תוצאות';
...
$string['importskippedoutcome'] = 'התוצאה עם השם המקוצר \"$a\" כבר קיימת בהקשר הזה, התוצאה בקובץ המיובא דולגה.';
$string['importstandard'] = 'יבא כמו תוצאות רגילות';
...
$string['intersectioninfo'] = 'סטודנטמידע על ציון';
$string['item'] = 'פריט';
...
$string['nooutcomes'] = 'רכיבי תוצאה חייבים להיות מקושרים לתוצאת קורס, אך אין תוצאות לקורס זה';
...
$string['overridesitedefaultgradedisplaytype'] = 'דריסת ברירות המחדל של האתר';
$string['overridesitedefaultgradedisplaytypehelp'] = 'סמן את התיבה לאפשר דריסת ברירות המחדל של האתר  להצגת הציונים בגליון הציונים. הדבר מפעיל אלמנטי טופס המאפשרים לך להגדיר אותיות ציון ואת גבולות בחירתך.';
$string['parentcategory'] = 'קטגורית הורה';
...
$string['removeallcourseitems'] = 'מחק את כל הרכיבים והקטגוריות';
$string['report'] = 'דוח';
...
$string['showhiddenuntilonly'] = 'יחידה מוסתרת בלבד';
$string['showlocks'] = 'הצג נעילות';
$string['shownohidden'] = 'ללא הסתרות';
$string['shownooutcomes'] = 'הסתר תוצאות';
$string['shownumberofgrades'] = 'הצג מספר ציונים בממוצעים';
...
$string['switchtofullview'] = 'החלף להצגה מלאה';
$string['switchtosimpleview'] = 'החלף להצגה פשוטה';
...
$string['weightsedit'] = 'ערוך משקלים וקרדיטים נוספים';
...
$string['exportletters'] = 'ייצא אותיות'; // ORPHANED
