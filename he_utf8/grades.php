...
$string['configgradeexportdisplaytype'] = 'ציונים עשויים להיות מוצגים כציונים אמיתיים, אחוזים (בהתייחס לציונים מיזעריים ומירביים) או כאותיות (A,B,C וכו\') במהלך הייצוא. ניתן לעקוף הגדרות אלו במהלך הייצוא.';
...
$string['outcomescourse'] = 'התוצאות שעושים בהם שימוש בקורס';
