...
$string['configshowhiddenitems'] = 'מציין כיצד פרטי ציון מוסתרים יוצגו. אם \"הסתר\" נבחר, הם יהיו מוסתרים לגמרי. אם \"הראה\" נבחר, שורת פריט הציון תוצג באפור יחד עם הסתרת הציון. אם \"מוסתרים עד\" נבחר, ציונים עם התאריך של הגדרת \"מוסתרים עד\" יוצגו באפור יחד עם הציונים המוסתרים עד לתאריך המוגדר, לאחר מכן כל פריט הציון יוצג.';
