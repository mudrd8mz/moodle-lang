...
$string['includeonlyvideosfromplaylist'] = 'כולל סרטי ווידאו רק מרשימת הנגינה עם הזיהוי בנוסף, סרטים המכילים את המילים...';
$string['music'] = 'מוזיקה';
$string['newspolitics'] = 'חדשות ופוליטיקה';
$string['numberofvideos'] = 'מספר פרטי הווידאו';
$string['peopleblogs'] = 'אנשים ובלוגים';
$string['petsanimals'] = 'חיות וחיות מחמד';
$string['scienceandtech'] = 'מדע וטכנולוגיה';
$string['sports'] = 'ספורט';
