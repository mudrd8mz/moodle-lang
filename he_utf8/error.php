...
$string['csvweirdcolumns'] = 'פורמט קובץ CSV פגום מספר העמודות לא קבוע';
...
$string['loginasnoenrol'] = 'אינך יכול להשתמש ב\'הירשם\' או \'ביטול הרשמה\' כשאתה נמצא במושב \"היכנסות למערכת\" של הקורס.';
