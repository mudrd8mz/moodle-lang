...
$string['cannotcustomizelocallang'] = 'אין לך רשות לבצע התאמה אישית לתרגום המחרוזות. הראשה זאת מבוקרת על ידי היכולת \"moodle/site:langeditlocal\". הפעל יכולת זאת בכדי לאפשר לך לערוך את חבילות השפה המקומיות במידה ואתה רוצה לשנות תרגומים עבור באתר דלך.';
...
$string['restorechecksumfailed'] = 'כמה בעיות התגלו עם המידע ששוחזר באחסון המושב שלך (session). אנא בדוק את זכרון ה-PHP שלך או הגבלות גודל חבילת  מסד הנתונים שלך. השחזור הופסק.';
...
$string['useremailduplicate'] = 'כתובת משוכפלת';
