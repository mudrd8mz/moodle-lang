...
$string['atmaxentry'] = 'השלמתם את מכסת הרשומות הנדרשות לפעילות זו. <br/>לא ניתן להזין רשומות נוספות, מעבר למספר הרשומות המירבי אשר הוגדר עבור פעילות זו.';
...
$string['entrieslefttoadd'] =' עליכם להזין $a->entriesleft  רשומה/ות בכדי להשלים את פעילות זו.';
$string['entrieslefttoaddtoview'] = 'עליכם להזין $a->entrieslefttoview רשומה/ות לפני שתוכל לראות את הרשומות של משתתפים אחרים.';
$string['entry'] = 'רשומה';
$string['entrysaved'] = 'הרשומה שלך נשמרה';
$string['errormustbeteacher'] = 'עליך להיות מורה כדי להשתמש בעמוד זה.';
...
$string['fieldname'] = 'שם שדה קצר (אותיות בלבד)';
