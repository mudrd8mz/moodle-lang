...
$string['chooseone'] = 'מלאו את אחד מהשדות הבאים, או את שניהם. הסיסמא לא מוצגת.';
...
$string['logininfo'] = 'שם ההתחברות, הסיסמא ומפתח העיסקה לא מוצגים עקב אמצעי זהירות ביטחוניים. אין צורך למלא את שדות אלה בשנית אם כבר הגדרת את התצורה של שדות אלה בעבר. במידה וכבר הוגדרה התצורה של שדות מסויימים בעבר, יופיע בצד השמאלי של הקופסא טקסט בצבע ירוק. במידה ואתה ממלא את השדות הללו בפעם הראשונה, חובה עליך לספק שם התחברות (*), ובנוסף <strong>או</strong> את מפתח העיסקה (#1) <strong>או</strong>  את הסיסמא (#2) בקופסא המתאימה. אנו ממליצים למלא את מפתח העיסקה עקב אמצעי זהירות בטחוניים. אם ברצונך למחוק את הסיסמא הנוכחית, סמן את תיבת הסימון.';
