...
$string['publishtoworld'] = 'כל אחד בעולם';
...
$string['addotags'] = 'הוסף תגים רשמיים'; // ORPHANED
$string['addptags'] = 'הוסף תגים שהוגדרו על ידי משתמשים'; // ORPHANED
$string['otags'] = 'תגים רשמיים'; // ORPHANED
$string['ptags'] = 'תגים שהוגדרו על ידי משתמשים (מופרדים על ידי פסיקים)'; // ORPHANED
