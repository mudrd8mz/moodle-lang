...
$string['allowcategorythemes'] = 'Kategóriatémák engedélyezése';
...
$string['allowvisiblecoursesinhiddencategories'] = 'Látható kurzusok engedélyezése rejtett kategóriákban';
...
$string['choosefiletoedit'] = 'A fenti mezőből válassza ki a szerkesztendő fájlt';
$string['clamfailureonupload'] = 'Hiba a clam vírusölőnél';
...
$string['configallowassign'] = 'Bal oldali szerepek bármely oszlophoz való hozzárendelésének engedélyezése';
$string['configallowcategorythemes'] = 'Bekapcsolása esetén a témákat kategóriaszinten állíthatja be. Ez minden lentebbi kategóriára és kurzusra érvényes lesz, hacsak azokhoz nincs külön téma beállítva. FIGYELEM: A kategóriatémák bekapcsolása befolyásolhatja a teljesítményt!';
...
$string['configauthenticationplugins'] = 'Válassza ki a használni kívánt beépülő hitelesítő programokat és rendezze el őket végrehajtási rend szerint. Az önregisztrációt a \'Registration\' oszlopban kiválasztott beépülő program fogja kezelni (rendszerint az \'email\').';
...
$string['configcachetype'] = 'Válasszon ki egy gyorsítótártípust a Moodle számára. Ezzel csak beállítja a gyorsítótárat. Ne feledje az rcache-t be is kapcsolni ahhoz, hogy a gyorsítótárat használatba tudja venni. <strong>Csak</strong> akkor vegye igénybe, ha csökkentenie kell az adatbázis terhelését -- ellenkező esetben ez a Moodle lassabb működését fogja eredményezni. Közepes forgalmú portálokon előnyös lehet az \'internal\' használata. Egyetlen, eAcceleratorral vagy Turckmmcache-sel rendelkező és <em>bekapcsolt osztott memóriával</em> telepített  webszerver esetén ajánlatos kipróbálni az \'eaccelerator\' opciót. Többszerveres kialakítás, egy vagy több futó memóriában gyorsított démon és memóriában gyorsított PHP kiterjesztés esetén válassza a \'memcached\' opciót és állítsa be az alábbi memóriában gyorsított lehetőségeket. <br /><strong>Megjegyzés:</strong> ellenőrizze a terhelés alatti teljesítményt és végezze el az ennek megfelelő finomhangolást -- a gyorsítótárak miatt portálja lelassulhat. Nagy forgalmat bonyolító portálokon az eAccelerator és a memcached használata lehet a legelőnyösebb, ugyanakkor nagyobb mértékben veszi igénybe a CPU-t a webszerveren.';
...
$string['configcreatornewroleid'] = 'Ezt a szerepet a kurzuskészítők automatikusan megkapják az általuk létrehozott új kurzusokban.';
$string['configcronclionly'] = 'Beállítása esetén a cron kód a webről nem, csak a parancssorból futtatható.  Felülírja a cron alább beállított jelszavát.';
$string['configcronremotepassword'] = 'Azt jelenti, hogy a cron.php kód nem futtatható böngészőből, ha nincs megadva a jelszó az alábbi formában: URL:<pre>
    http://site.example.com/admin/cron.php?password=opensesame
</pre>Ha üresen hagyja, nincs szükség jelszóra.';
...
$string['configdebugdisplay'] = 'Bekapcsolása esetén a hibajelentések a HTML-oldalra kerülnek. Noha ez egy praktikus megoldás, általában véve tönkreteszi az XHTML-t, a JS-t, a sütiket és a HTTP-fejléceket. Kikapcsolása esetén a hibajelentéseket a szervernaplóba küldi, így jobb hibaelhárítást tesz lehetővé. Az error_log PHP-beállítás határozza meg, melyik naplóba kerül.';
...
$string['configdisableuserimages'] = 'Felhasználói profil képei módosításának tiltása felhasználók számára.';
...
$string['configforceloginforprofiles'] = 'Ezzel a beállítással érhető el, hogy a bejelentkezőknek ne vendégként, hanem valódi felhasználónévvel kelljen belépni, mielőtt megtekinthetik a felhasználói profilt tartalmazó oldalt. Alaphelyzetben ez bekapcsolt (\"true\") állapotban van.';
...
$string['configgradeexport'] = 'Válassza ki, mely formátumú osztályozó naplók lesznek az osztályozások exportálására használt elsődleges módszerek. A kiválasztott segédprogramok minden jegy esetén a \"last exported\" mezőt fogják beállítani és használni. Az exportált rekordok azonosítója ennek alapján lehet például \"new\" vagy \"updated\". Ha bizonytalan, hagyjon mindent bejelöletlenül.';
$string['configguestroleid'] = 'Ezt a szerepet a vendégek automatikusan megkapják. A be nem iratkozott felhasználók is ideiglenesen ezt a szerepet kapják, ha olyan kurzusba lépnek be, amely jelszó nélkül vendégeket enged be. Ellenőrizze, hogy a szerep rendelkezik-e moodle/legacy:guest és moodle/course:view képességgel.';
$string['confighiddenuserfields'] = 'Válassza ki, milyen információt tartalmazó mezőket kíván elrejteni a tanárokon/rendszergazdákon kívül minden egyéb felhasználó elől. Ezzel növelheti a tanulók adatainak titkosságát. A CTRL-billentyű lenyomásával egyszerre több mezőt választhat.';
$string['confighideactivitytypenavlink'] = 'Válassza ki, ki elől kívánja elrejteni a tevékenység típusának (pl. tesztek) nyomvonalát a tevékenységmodulokkal megjelenő navigálási nyomvonalból.';
...
$string['configintcachemax'] = 'Csak beklső gyorsítótárhoz. A gyorsítótárba kerülő rekordok maximális száma. Ajánlott érték: 50. A memória igénybevételének csökkentéséhez adjon meg kisebb számot.';
...
$string['configmaxbytes'] = 'Itt adható meg a teljes portálra vonatkozóan a feltöltött állományok maximális száma. Ezt a beállítást a PHP upload_max_filesize beállítása és az Apache LimitRequestBody beállítása határolja be. Ugyanakkor a maxbytes a kurzusszinten vagy a modulszinten választható méreteket korlátozza. Ha a \'Server Limit\' lett kiválasztva, a rendszer a szerver által engedélyezett szervermaximumot fogja használni.';
...
$string['configmemcachedhosts'] = 'Memóriában való gyorsításhoz. A memóriában gyorsított démont futtató gazdagépek vesszővel elválasztott felsorolása. A DNS-látencia elkerülésére használjon IP-címeket. A memóriagyorsítás nem viselkedik megfelelően, ha fut beállításnál ad hozzá/távolít el gazdagépeket.';
...
$string['configmymoodleredirect'] = 'Ez a beállítás az átirányításokat a /my-ba tereli, ha nem rendszergazda jelentkezik be, és lecseréli a legfelső szintű portál navigálási nyomvonalát /my-ra';
...
$string['configsmartpix'] = 'Bekapcsolása esetén az ikonokat olyan PHP-kód biztosítja, amely az adott témát, majd az összes fölötte lévő témát, végül a Moodle /pix mappáját nézi végig. Ezáltal kevesebb ismétlődő képállományra lesz szükség a témákon belül, ugyanakkor némileg csökken a teljesítmény.';
...
$string['configthemelist'] = 'Ha ez üres, bármely érvényes téma használható. Ha a témamenüt rövidíteni kívánja, itt a nevekből megadhat egy vesszővel elválasztott felsorolást. Ne használjon szóközt! Például: szabványos,sárgásfehér.';
...
$string['cronclionly'] = 'Cron futtatása csak a parancssorból';
$string['cronerrorclionly'] = 'Az oldal internetes elérését a rendszergazda kikapcsolta.';
$string['cronerrorpassword'] = 'Az oldal eléréséhez nem kapott érvényes jelszót';
$string['cronremotepassword'] = 'Cron-jelszó távoli eléréshez';
...
$string['debugdisplay'] = 'Bibaszűrési üzenetek megjelenítése';
...
$string['debugsmtp'] = 'E-mail küldésének hibaszűrése';
...
$string['docroot'] = 'a Moodle Docs dokumentumok gyökérkönyvtára';
...
$string['editorspellinghelp'] = 'Helyesírás-ellenőrzés ki-/bekapcsolása. Bekapcsolása esetén az <strong>aspell</strong>-nek a szerveren telepítve kell lennie.';
$string['editstrings'] = 'Szövegsorok és szavak szerkesztése';
...
$string['extendedusernamechars'] = 'Kibővített karakterek engedélyezése a felhasználónevekben';
...
$string['forceloginforprofiles'] = 'Bejelentkezés a profilhoz kötelező';
$string['forcetimezone'] = 'Alapidőzóna megadása kötelező';
...
$string['frontpagerestore'] = 'A címoldal helyeállítása';
...
$string['guestroleid'] = 'Vendég szerepe';
...
$string['hideactivitytypenavlink'] = 'Tevékenység típusú nyomvonal elrejtése';
...
$string['langpackremoved'] = 'A nyelvi csomag eltávolítása befejeződött';
...
$string['maxbytes'] = 'Maximális feltölthető állományméret';
...
$string['minpassworddigits'] = 'Számjegy';
...
$string['mnetrestore_extusers_mismatch'] = '<strong>Megjegyzés:</strong> Ez a biztonsági mentés nyilvánvalóan egy másik Moodle-telepítésből való és benne a Moodle Network olyan távoli felhasználói fiókjai szerepelnek, amelyek helyreállítása esetleg sikertelen lesz. Ezt a műveletet a rendszer nem támogatja. Ha biztos benne, hogy a Moodle ezen telepítésével hozta létre, illetve ha gondoskodni tud arról, hogy a Moodle Network összes gazgdagépe konfigurálva legyen, úgy megpróbálkozhat a helyreállítással.';
$string['modulesecurity'] = 'Modulbiztonság';
$string['multilangforceold'] = 'Régi többnyelvű szintaxis használata: &lt;span&gt; a class=\"multilang\" és &lt;lang&gt; nélkül';
$string['multilangupgrade'] = 'Többnyelvű frissítés';
$string['multilangupgradeinfo'] = 'A többnyelvű szűrőt használó szintaxis az 1.8-ban módosult, a &lt;lang&gt; jelölő használatát a rendszer már nem támogatja . <br /><br />Példa: &lt;span lang=\"en\" class=\"multilang\">Hello!&lt;/span&gt;&lt;span lang=\"es\" class=\"multilang\">Jó napot!&lt;/span&gt;<br /><br /><strong>A szintaxist az összes szövegben frissíteni kívánja most?</strong>';
...
$string['nodefaultuserrolelists'] = 'Ne adja vissza az összes alapbeállított szerepű felhasználót';
...
$string['pathtoclam'] = 'A clam AV vírusölő útvonala';
...
$string['rcache'] = 'Rekord-gyorsítótár';
$string['rcachettl'] = 'Rekord-gyorsítótári TTL';
...
$string['runclamavonupload'] = 'clam vírusölő használata feltöltött állományokhoz';
...
$string['tokenizerrecommended'] = 'Ajánlott a PHP Tokenizer bővítés telepítése -- javítja a Moodle Networking használhatóságát.';
$string['unattendedoperation'] = 'Felügyelet nélküli működés';
