...
$string['allowobjectembed'] = 'EMBED és OBJECT címkék használatának engedélyezése';
...
$string['autologinguests'] = 'Vendégek automatikus bejelentkeztetése';
...
$string['configallowobjectembed'] = 'Alapvető biztonsági intézkedésként a felhasználók nem építhetnek be multimédiát (pl. flash-t) a HTML szövegébe az EMBED és az OBJECT címkékkel (jóllehet, erre módot ad a médiaprogramkódok biztonságos szűrője). Ezen címkék engedélyezéséhez az opciót be kell kapcsolni.';
...
$string['configallowuserblockhiding'] = 'A felhasználók az egész portálon elrejthetik/megjeleníthetik az oldalsó blokkokat? Ez a funkció javascript és sütik használatával emlékezik az egyes összecsukható blokkok állapotára, és csak a felhasználó saját nézetére van hatással.';
...
$string['configdefaultcourseroleid'] = 'Kurzusba beiratkozó felhasználók ezt a szerepet automatikusan megkapják.';
...
$string['configemailchangeconfirmation'] = 'E-mailes megerősítést ír elő, ha a felhasználók profiljukban módosítják e-mail címüket.';
...
$string['configextendedusernamechars'] = 'Ezt bekapcsolva a tanulók bármilyen karaktert használhatnak felhasználónevükben (ez nincs befolyással konkrét nevükre!). Az alapbeállítás \'hamis\', amely esetén a felhasználónév csak betűket és számokat tartalmazhat';
...
$string['configfiltermatchonepertext'] = 'Automatikusan kapcsoló szűrők esetén az oldalon csak az egyes szövegek (pl. forrás, blokk) első előfordulásához áll elő kapcsolat. Az összes többit a rendszer figyelmen kívül hagyja. Ezt a beállítást figyelmen kívül hagyja, ha az oldalankénti egy beállítása <i>igen</i>.';
...
$string['configforcelogin'] = 'A portál címoldalát és a kurzuslistákat (de nem a kurzusokat) bárki megtekintheti anélkül, hogy bejelentkezne a portálra. Ha azt szeretné, hogy a portálra látogatók MINDENEKELŐTT bejelentkezzenek, ezt a beállítást kell bekapcsolni.';
$string['configforceloginforprofiles'] = 'Ezzel a beállítással érhető el, hogy a bejelentkezőknek ne vendégként, hanem valódi felhasználónévvel kelljen belépni, mielőtt valamely felhasználói profilt megtekintenek. Ha ezt a beállítást kikapcsolta, előfordulhat, hogy egyes felhasználók hirdetést (levélszemetet) vagy egyéb, oda nem való tartalmat tesznek közzé profiljukban, amely így az egész világ számára láthatóvá válik.';
...
$string['configfullnamedisplay'] = 'Itt adható meg a teljesen megjelenő nevek száma. Az egynyelvű portálok esetén a legmegfelelőbb beállítás az alapértelmezett \'Vezetéknév + Utónév\', de dönthet úgy, hogy a vezetéknevek egyáltalán ne jelenjenek meg, vagy dönthet erről az adott nyelvi csomag alapján is (egyes nyelvekben ettől eltérő az elrendezés).';
...
$string['configmaxbytes'] = 'Itt adható meg a teljes portálra vonatkozóan a feltöltött állományok maximális száma. Ezt a beállítást a PHP upload_max_filesize és az Apache LimitRequestBody beállítása határolja be. Ugyanakkor a maxbytes a kurzusszinten vagy a modulszinten választható méreteket korlátozza. Ha a \'Server Limit\' lett kiválasztva, a rendszer a szerver által engedélyezett szervermaximumot fogja használni.';
...
$string['configopentogoogle'] = 'Ezen beállítás bekapcsolásakor a Google a portálra beléphet mint vendég. Emellett a Google keresésén keresztül a portálra eljutók automatikusan vendégként jelentkeznek be. Ne feledje, hogy ez csak azon kurzusokhoz biztosít követhető hozzáférést, amelyek engedélyezik a vendégek bekapcsolódását.';
...
$string['configperfdebug'] = 'Ha bekapcsolja, a teljesítményre vonatkozó információk megjelennek a standard téma lábrészében';
...
$string['configrestrictmodulesfor'] = 'Mely kurzusoknak legyen beállítva egyes modulok kikapcsolása? Ez a beállítás csak a tanárokra vonatkozik, a rendszergazdák továbbra is hozzáadhatnak tevékenységet egy kurzushoz.';
...
$string['configstatsruntimestart'] = 'A statisztikai feldolgozást végző cronjob mikor <b>kezdődjön</b>?';
...
$string['configxmlstrictheaders'] = 'Bekapcsolása esetén minden oldal előállítása az XML http-fejléce és bevezetője szerint történik, hogy a böngészők az XHTML-hibákat szövegsoron belül jelezzék. Csak fejlesztőknek hasznos.';
...
$string['helpforcetimezone'] = 'A felhasználók számára lehetővé tehetjük, hogy egyenként válasszák ki a saját időzónájukat, vagy dönthetünk úgy, hogy mindenkinek egyetlen időzóna álljon a rendelkezésére.';
...
$string['langmenu'] = 'A nyelv menü megjelenítése';
...
$string['minpasswordnonalphanum'] = 'Nemalfanumerikus karakterek';
...
$string['multilangforceold'] = 'Régi többnyelvű szintaxis előírása: &lt;span&gt; a class=\"multilang\" és a &lt;lang&gt; nélkül';
...
$string['notifyloginfailures'] = 'Sikertelen e-mailben történt bejelentkezések ide';
...
$string['restrictmodulesfor'] = 'Modulok korlátozása ennél:';
...
$string['timezone'] = 'Alapvető időzóna';
