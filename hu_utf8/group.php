...
$string['adduserstogroup'] = "Felhasználók kozzáadása/törlése";
...
$string['createorphangroup'] = "Árva csoport létrehozása";
$string['databaseupgradegroups'] = "A csopotok verziója most \$a";
$string['defaultgroupdescription'] = "Alapértelmezett csoportleírás";
...
$string['distributeevenly'] = "Fennmaradó tanulók egyenletes szétosztása";
$string['editgroupingpermissions'] = "Csoportosítás engedélyeinek szerkesztése";
...
$string['errorinvalidgroup'] = "Hiba, a(z) \$a csoport érvénytelen";
$string['errorinvalidgrouping'] = "Hiba, a(z) \$a csoportosítás érvénytelen";
$string['errornotingrouping'] = "\$a esetén nem hozhat létre csoportot";
$string['errornotingroupingedit'] = "\$a esetén nem hozhat létre csoportosítást";
...
$string['groupfor'] = "ezen csoporthoz";
$string['groupinfo'] = "Tájékoztatás a kiválasztott csoportról";
$string['groupinfomembers'] = "Tájékoztatás a kiválasztott tagokról";
$string['groupinfopeople'] = "Tájékoztatás a kiválasztott személyekről";
...
$string['showusersalreadyingroup'] = "A csoportosításon belül már csoportban lévő felhasználók megjelenítése";
$string['teachersgroupmark'] = 'Tanárok nem jelölhetnek meg tevékenységeket azon csoportok esetén, amelyekbe beletartoznak';
$string['teachersgroupview'] = 'Tanárok nem tekinthetnek meg tevékenységeket azon csoportok esetén, amelyekbe nem tartoznak bele';
$string['teachersoverride'] = 'A csoportokba nem tartozó tanárok minden csoport tevékenységét megtekinthetik és megjelölhetik (felülírja a fentit)';
$string['upgradeconfirm'] = 'Ezen frissítés esetén törölni kell a Moodle 1.8 DEV alatt létrehozott csoporttáblázatokat. Folytatja?';
$string['usestudentsonlyfromselectedgroup'] = "Csak a most kiválasztott csoportból vegyen tanulókat";
$string['viewallgroupsactivities'] = 'A tanulók megtekinthetik az összes csoport tevékenységét, de nem vehetnek részt bennük';
$string['viewallgroupsmembers'] = 'A tanulók megtekinthetik az összes csoport tagját';
$string['viewowngroup'] = 'A tanulók megtekinthetik az összes olyan csoport tagját, amelybe beletartoznak';
