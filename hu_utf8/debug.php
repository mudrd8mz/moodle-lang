...
$string['cannotcreateadminuser'] = 'SÚLYOS HIBA: nem sikerült létrehozni a rendszergazda felhasználói rekordját!!!';
...
$string['cannotsetupsite'] = 'Súlyos hiba: nem sikerült létrehozni a portált!';
$string['cannotsetuptable'] = 'A(z) $a táblázatokat  nem sikerült létrehozni!';
$string['cannotupdaterelease'] = 'HIBA: nem sikerült frissíteni a változatot az adatbázisban!';
$string['cannotupdateversion'] = 'A frissítés nem sikerült! (A konfigurációs táblázatban a verziót nem sikerült frissíteni.)';
$string['cannotupgradecapabilities'] = 'Gond volt a szereprendszer alapképességeinek frissítése során.';
$string['cannotupgradedbcustom'] = 'A helyi adatbázis testre szabása  nem sikerült! (A konfigurációs táblázatban a verziót nem sikerült frissíteni.)';
$string['configmoodle'] = 'Még nincs beállítva a Moodle. ELőbb szerkessze meg a config.php állományt.';
$string['dbnotinsert'] = 'Adatbázishiba - a(z) ($a) nem szúrható be.';
$string['dbnotsetup'] = 'Hiba: a fő adatbázisok beállítása NEM sikerült.';
$string['dbnotsupport'] = 'Hiba: adatbázisát ($a) a Moodle nem teljesen támogatja, vagy hiányzik az install.xml. Lásd a lib/db könyvtárat.';
...
$string['noblockbase'] = 'A block_base nincs definiálva, vagy nincs meg a /blocks/moodleblock.class.php-hez tartozó állomány.';
$string['noblocks'] = 'Nincsenek telepítve blokkok!';
$string['nocaps'] = 'Hiba: nincsenek megadva képességek!';
...
$string['siteisnotdefined'] = 'A portál nincs definiálva!';
...
$string['upgradefail'] = 'A frissítés nem sikerült, lásd: $a';
