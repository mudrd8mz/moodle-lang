...
$string['autonumbering'] = 'automatikus számok az egyes kérdésekhez';
...
$string['check_values'] = 'lehetséges viszontválaszok';
$string['checkbox'] = 'Feleletválasztós - több válasz lehetséges (jelölőnégyzetek)';
$string['choosefile'] = 'Válasszon állományt';
$string['chosen_feedback_response'] = 'kiválasztott visszajelző viszontválasz';
...
$string['feedback:receivemail'] = 'Értesítés kézhezvétele e-mailben';
...
$string['insufficient_responses_for_this_group'] = 'A csoporthoz nincs elég viszontválasz';
$string['item_name'] = 'Kérdés';
$string['items_are_required'] = 'A csillaggal ellátott kérdések választ igényelnek.';
$string['label'] = 'Címke';
$string['line_labels'] = 'Címke';
$string['line_values'] = 'Osztályozás';
$string['mapcourse'] = 'Kurzus illesztése';
...
$string['mapcoursenone'] = 'Nincs illesztett kurzus. A visszajelzés minden kruzusra érvényes.';
...
$string['multiple_submit'] = 'Többszörös leadás';
$string['name'] = 'Név';
...
$string['oldvalueswillbedeleted'] = 'A jelenlegi kérdések és minden felhasználói viszontválasz törlődik.';
...
$string['radio_values'] = 'Viszontválaszok';
...
$string['relateditemsdeleted'] = 'A kérdésre vonatkozó összes felhasználói viszontválasz is törlődik.';
$string['required'] = 'Kitöltendő';
$string['resetting_data'] = 'Visszajelzések viszontválaszainak visszaállítása';
$string['resetting_feedbacks'] = 'Visszajelzések visszaállítása';
$string['response_nr'] = 'Viszontválasz száma:';
$string['responses'] = 'Viszontválaszok';
$string['responsetime'] = 'Viszontválaszok ideje';
...
$string['show_entries'] = 'Viszontválaszok megjelenítése';
$string['show_entry'] = 'Viszontválasz megjelenítése';
