...
$string['cannotsaveconfig'] = 'Gond van a(z) \"$a->name\" \"$a->plugin\" segédprogramhoz \"$a->value\" konfigurációként való elmentésével';
...
$string['cannotunassigncap'] = 'A(z) $a->role szerep régi $a->cat képessége nem törölhető';
...
$string['filemismatch'] = 'Nem egyező másodlagos állománynevek. A(z) \"$a->current\" állománynak {$a->found}-nek kell lennie';
...
$string['usernotaddedadmin'] = 'Rendszergazdai fiókok nem törölhetők.';
...
$string['usernotrenamedadmin'] = 'Rendszergazdai fiókokat nem lehet átnevezni.';
...
$string['usernotupdatedadmin'] = 'Rendszergazdai fiókok nem frissíthetők.';
