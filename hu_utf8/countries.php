<?PHP // $Id$ 
      // countries.php - created with Moodle 1.8.4+ (2007021540)
...
$string['ZM'] = 'Zambia';
$string['ZW'] = 'Zimbabwe';
$string['CS'] = 'Szerbia és Montenegró'; // ORPHANED
$string['FX'] = 'Franciaország; Nagyvárosok'; // ORPHANED
$string['KO'] = 'Koszovó'; // ORPHANED
$string['TP'] = 'Kelet-Timor'; // ORPHANED
