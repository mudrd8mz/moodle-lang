...
$string['enrolledincourse'] = 'A(z) \"$a\" kurzusra felvéve';
$string['enrolledincourserole'] = 'A(z) \"$a->course\" kurzusra felvéve mint \"$a->role\"';
...
$string['skiptomaincontent'] = 'Tovább a fő tartalomra';
