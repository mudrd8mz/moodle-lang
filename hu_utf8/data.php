...
$string['configenablerssfeeds'] = 'Ezzel bekapcsolja az RSS-híreket minden adatbázis számára. Ettől függetlenül minden adatbázis beállításánál az üzeneteket kézzel be kell állítania.   ';
...
$string['data:approve'] = "Jóvá nem hagyott tételek jóváhagyása";
$string['data:comment'] = "Megjegyzések írása";
$string['data:managecomments'] = "Megjegyzések kezelése";
$string['data:manageentries'] = "Tételek kezelése";
$string['data:managetemplates'] = "Sablonok kezelése";
$string['data:manageuserpresets'] = "Összes előzetes sablonbeállítás kezelése";
$string['data:rate'] = "Tételek besorolása";
$string['data:readentry'] = "Tételek olvasása";
$string['data:viewalluserpresets'] = "Minden felhasználó előzetes beállításainak megtekintése";
$string['data:viewentry'] = "Tételek megtekintése";
$string['data:viewrating'] = "Besorolások megtekintése";
$string['data:writeentry'] = "Tételek írása";
$string['date'] = 'Dátum';
...
$string['directorynotapreset'] = '$a->directory nem előre beállított: hiányzó állományok: $a->missing_files';
...
$string['exportedtozip'] = "Exportálva ideiglenes ... zipállományba";
$string['failedpresetdelete'] = "Hiba egy előre beállított törlése közben!";
...
$string['fromfile'] = "zipállományból ";
...
$string['importsuccess'] = "Az előzetes beállítás alkalmazása sikerült.";
...
$string['latlongdownloadallhint'] = "Minden tételhez ugrópont letöltése KML-ként";
$string['latlongkmllabelling'] = "Hogyan címkézhetők az elemek a KML-fájlokban (Google Earth)";
...
$string['mappingwarning'] = "Minden új mezőhöz nem illesztett régi mező elvész és a mező adatai törlődnek.";
...
$string['nodefinedfields'] = "Az új előre beállítotthoz nincsenek megadva mezők!";
...
$string['picture'] = 'Kép';
$string['pleaseaddsome'] = "Hozzon létre néhányat alább vagy a kezdéshez <a href=\"\$a\">válasszon egy előre megadott készletet</a>.";
...
$string['undefinedprocessactionmethod'] = 'Nincs megadva tevékenységmódszer a Data_Preset-ben a(z) \"$a\" tevékenység kezeléséhez.'; 
...
$string['url'] = 'URL';
$string['usestandard'] = "használjon előzetes beállítást";
