...
$string['configenableavailability'] = 'Bekapcsolása esetén olyan (dátumon, osztályzaton vagy teljesítésen alapuló) feltételeket állíthat be, amelyek befolyásolják a tevékenység elérhetőségét.';
...
$string['help_conditiondates'] = 'elérhetőségi dátumok';
$string['help_showavailability'] = 'el nem érhető tevékenységek megjelenítése';
$string['none'] = '(egy sem)';
...
$string['requires_date'] = '$a-ig nem elérhető.';
$string['requires_date_before'] = '$a időponttól nem elérhető.';
...
$string['userrestriction_hidden'] = 'Tevékenység feltételesen korlátozva (teljesen elrejtve, üzenet nélkül): &lsquo;$a&rsquo;';
$string['userrestriction_visible'] = 'Tevékenység feltételesen korlátozva: &lsquo;$a&rsquo;';
