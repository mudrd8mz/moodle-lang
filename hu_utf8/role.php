...
$string['duplicaterolesure'] = 'Biztosan \"$a->name ($a->shortname)\" ismétlődő szerepre van szüksége?</p>'; 
...
$string['globalroleswarning'] = 'FIGYELMEZTETÉS! Az oldalon lévő bármely szerep hozzárendelése a teljes protál kijelölt felhasználóira vonatkozni fog, ideértve a címoldalt és az összes kurzust is.'; 
...
$string['resetrolesure'] = "Biztosan visszaállítja a \"\$a->name (\$a->s szerepet...";
$string['resetrolesurenolegacy'] = "Biztosan törli az összes meghatározott engedélyt ...";
...
$string['site:mnetloginfromremote'] = "Bejelentkezés távoli Moodle-ból";
