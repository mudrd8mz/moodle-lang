...
$string['cnfcasesensitive'] = 'Állítsa be, hogy egy kapcsolt fogalom esetén alapbeállítás szerint a kis- és nagybetűk különbözzenek-e';
$string['cnfdefaulthook'] = 'Válassza ki azt az alapbeállítás szerinti választást, amely a fogalomtár első megtekintésekor lesz használatos.';
$string['cnfdefaultmode'] = 'Válassza ki azt az alapbeállítás szerinti keretet, amely a fogalomtár első megtekintésekor lesz használatos.';
$string['cnffullmatch'] = 'Állítsa be, hogy egy kapcsolt fogalom alapbeállítás szerint egyezzen-e a célszöveggel kis- és nagybetűk tekintetében';
...
$string['configenablerssfeeds'] = 'Ezzel kapcsolható be az RSS-betöltés az összes fogalomtárhoz. Ettől függetlenül az egyes fogalomtárakhoz a betöltési beállításokat kézzel meg kell adni.';
...
$string['entryleveldefaultsettings'] = 'Fogalmi szintű alapbeállítások';
