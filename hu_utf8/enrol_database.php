...
$string['disableunenrol'] = 'Igenre állítva a korábban külső adatbázis-segédprogrammal beiratkozottak ugyanezzel a segédprogrammal nem iratkoznak ki, függetlenül az adatbázis tartalmától.';
...
$string['localcoursefield'] = 'A kurzustáblázatban a távoli adatbázisban lévő bejegyzések megfeleltetésére használt mező neve (pl. azonosítószám).';
...
$string['localuserfield'] = 'A felhasználói táblázatban a távoli adatbázisban lévő bejegyzések megfeleltetésére használt mező neve (pl. azonosítószám). ';
...
$string['student_l_userfield'] = 'A helyi felhasználói táblázatban a tanulók távoli rekordja alapján a felhasználó megfeleltetésére használt mező neve (pl. azonosítószám).';
...
$string['teacher_l_userfield'] = 'A helyi felhasználói táblázatban a tanárok távoli rekordja alapján a felhasználó megfeleltetésére használt mező neve (pl. azonosítószám).';
