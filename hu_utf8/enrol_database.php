...
$string['dbhost'] = 'A szerver IP-címe és -száma';
$string['dbuser'] = 'Szerverhasználó';
$string['dbpass'] = 'Szerverjelszó';
$string['dbname'] = 'Adatbázisnév';
$string['dbtable'] = 'Adatbázistábla';
$string['dbtype'] = 'Adatbázis típusa';   
$string['defaultcourseroleid'] = 'Alaphelyzetben, egyéb szerep megadása híján kiosztott szerep.'; 
...
$string['enrol_database_autocreation_settings'] = "Úk kurzusok automatikus létrehozása";
...
$string['localcoursefield'] = 'A kurzustáblázatban lévő azon mező neve, amelyet a távoli adatbázisban lévő bejegyzések megfeleltetésére használunk (pl. azonosítószám).';
$string['localrolefield'] = 'A felhasználói táblázatban lévő azon mező neve, amelyet a távoli adatbázisban lévő bejegyzések megfeleltetésére használunk (pl. rövid név).';
$string['localuserfield'] = 'A felhasználói táblázatban lévő azon mező neve, amelyet a távoli adatbázisban lévő bejegyzések megfeleltetésére használunk (pl. azonosítószám). '; 
...
$string['remotecoursefield'] = 'A távoli táblázatban lévő azon mező neve, amelyet a kurzustáblázatban lévő bejegyzések megfeleltetésére használunk.';
$string['remoterolefield'] = 'A távoli táblázatban lévő azon mező neve, amelyet a szerepek táblázatában lévő bejegyzések megfeleltetésére használunk.';
$string['remoteuserfield'] = 'A távoli táblázatban lévő azon mező neve, amelyet a felhasználói táblázatban lévő bejegyzések megfeleltetésére használunk.'; 
