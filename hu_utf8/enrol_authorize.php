...
$string['adminauthcode'] = "Ha egy felhasználó hitelkártyájáról nem lehet közvetlenül a neten leemelni az összeget, kérjen hitelesítési kódot telefonon az ügyfél bankjától.";
...
$string['adminhelpcapture'] = 'Nemcsak kézzel akarok elfogadni/elutasítani fizetést. Az ütemezett megterhelés használatával meg kívánom előzni a fizetés törlését. Mi a teendő? - Állítsa be a cron-t. - Jelölje be az an_review-t. - Az an_capture_day mezőhöz adjon meg egy 1 és 29 közötti számot. Megtörténik a kártya megterhelése és a felhasználó beiratkozik a kurzusra, ha nem rögzíti an_capture_day napon belül.';
$string['adminhelpcapturetitle'] = 'Ütemezett rögzítés napja';
$string['adminhelpreview'] = 'Hogy tudok kézzel elfogadni/elutasítani fizetést? - Jelölje be az an_review-t. - Az an_capture_day mezőhöz adjon meg \'0\'-t. Hogyan iratkoznak be kurzusokra a tanulók közvetlenül a kártyaszámuk megadása után? - Szüntesse meg az an_review bejelölését.';
