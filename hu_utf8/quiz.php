...
$string['attemptincomplete'] = 'A próbálkozás ($a által) még nem fejeződött be.';
...
$string['bothattempts'] = 'Próbálkozást tett és nem tett tanulók megjelenítése';
...
$string['cannotwrite'] = 'Nem lehet az exportálási fájlba írni ($a)';
$string['caseno'] = 'Nincs jelentősége a kis-/nagybetűnek';
$string['casesensitive'] = 'Kis-/nagybetű különböző';
$string['caseyes'] = 'Igen, a kis-/nagybetűk különbözőek';
...
$string['categorymove'] = 'A(z) \'$a->name\' kategória $a->count kérdést tartalmaz (egy részük lehet régi, rejtett, de még néhány tesztben előfordul). <br />Válassza ki, melyik kategóriába kerüljenek át.';
...
$string['commentorgrade'] = 'Megjegyzés írása vagy pontozás felülírása';
...
$string['confirmstartattempt'] = 'A teszt időkorlátos. Biztosan el akarja kezdeni?';
...
$string['confirmstartattemptnotimelimit'] = 'Ennek a tesztnek nincs időkorlátja. Kívánja folytatni?';
...
$string['confirmstartlimit'] = 'A teszt időkorlátos és $a próbálkozásra van maximálva. A teszt behívása egy próbálkozásnak számít. Kívánja folytatni?';
$string['confirmstartnolimit'] = 'A teszt $a próbálkozásra van maximálva. A teszt behívása egy próbálkozásnak számít. Kívánja folytatni?';
$string['confirmstarttimelimit'] = "Ezen a teszten időkorlát van. Biztonsan nekikezd?";
...
$string['delay2'] = 'A többi próbálkozás közötti időköz';
...
$string['editingmultianswer'] = 'Beépített válaszos (kitöltő) kérdés szerkesztése';
...
$string['editingrandomsamatch'] = 'Véletlenszerű kiegészítéses párosító kérdés szerkesztése';
...
$string['event8'] = 'Bezárás';
$string['event9'] = 'Kézi pontozás';
$string['examview'] = 'Vizsganézet';
$string['existingcategory1'] = 'érték egy meglévő, a kategórián belül más kérdésekben is használt értékhalmazból';
$string['existingcategory2'] = 'állomány egy meglévő, a kategórián belül más kérdésekben is használt fájlhalmazból';
$string['existingcategory3'] = 'ugrópont egy meglévő, a kategórián belül más kérdésekben is használt ugróponthalmazból';
$string['export'] = 'Exportálás';
$string['exporterror'] = 'Hiba az exportálás feldolgozása közben';
$string['exportfilename'] = 'teszt';
$string['exportingquestions'] = 'A kérdéseket a rendszer fájlba exportálja';
...
$string['fillcorrect'] = 'Jóként kitöltendő';
$string['filloutnumericalanswer'] = "Legalább egy lehetséges választ és tűrési értéket adjon meg. Az első megfelelő válasz határozza meg a pontszámot és a visszajelzést. Ha visszajelzést megad, de nincs a végén válasz, akkor azt azok a tanulók látják, akiknek a válasza egyik válaszhoz semm illik.";
...
$string['finishattempt'] = 'Az összes ellenőrzése és befejezés';
$string['forceregeneration'] = 'újrakészítés indítása';
$string['formatnotfound'] = 'Az importálási/exportálási $a formátum nem található';
$string['formatnotimplemented'] = 'A formátum hibás, küldjön hibajelentést';
...
$string['history'] = 'Válaszok története';	
...
$string['keptcategory1'] = 'egy érték ugyanabból az újrahasználható értékkészletből származik, mint korábban';	
$string['keptcategory2'] = 'egy állomány ugyanabból az újrahasználható készletből származik, mint korábban';	
$string['keptcategory3'] = 'egy ugrópont ugyanabból az újrahasználható készletből származik, mint korábban';	
$string['keptlocal1'] = 'egy érték ugyanabból a magánkérdéskészletből származik, mint korábban';	
$string['keptlocal2'] = 'egy állomány ugyanabból a magánkérdéskészletből származik, mint korábban';	
$string['keptlocal3'] = 'egy ugrópont ugyanabból a magánkérdéskészletből származik, mint korábban';	
...
$string['mark'] = 'Ellenőrzés';	
$string['markall'] = 'Oldal ellenőrzése';	
$string['marks'] = 'Jegyek';	
$string['match'] = 'Párosító';	
$string['matchanswer'] = 'Párosító válasz';	
$string['matchanswerno'] = "Hozzáillő válasz \$a";	
...
$string['multipleanswers'] = 'Válasszon legalább egy választ.';	
$string['multiplier'] = 'Szorzó';	
$string['name'] = 'Név';	
$string['newattemptfail'] = 'Hiba: a tesztben nem lehetett új próbálkozást indítani';	
$string['newcategory1'] = 'olyan új értékkészletből származó érték, amelyet a kategória más kérdései is használhatnak';	
$string['newcategory2'] = 'olyan új készletből származó állomány, amelyet a kategória más kérdései is használhatnak';	
$string['newcategory3'] = 'olyan új készletből származó ugrópont, amelyet a kategória más kérdései is használhatnak';	
$string['newlocal1'] = 'olyan új értékkészletből származó érték, amely csak ebben a kérdés fog szerepelni';	
$string['newlocal2'] = 'olyan új készletből származó állomány, amely csak ebben a kérdés fog szerepelni';	
$string['newlocal3'] = 'olyan új készletből származó ugrópont, amely csak ebben a kérdés fog szerepelni';	
...
$string['noquestionsinfile'] = 'Az importálási fájlban nincsenek kérdések';	
...
$string['numattempts'] = "\$a->studentnum \$a->studentstring \$a->attemptnum próbálkozást hajtott végre";	
$string['numberabbr'] = '#';	
...
$string['popupblockerwarning'] = "A dolgozat ezen része biztonságos üzemmódban van, vagy a tesztet biztonságos ablakban kell megoldania. Kapcsolja ki az előbukkanó ablakok tiltását. Köszönjük.";	
...
$string['questincats'] = 'Kérdéskategóriák';	
$string['question'] = 'Kérdés';	
$string['questioncats'] = "Kérdéskategóriák";	
$string['questiondeleted'] = "A kérdést törölték. Forduljon tanárához";	
$string['questioninuse'] = 'A(z) \'$a->questionname\' jelenleg a <br />$a->quiznames<br /> között szerepel. A kérdés csak a kategóriák jegyzékéből törlődik, a tesztekből nem.';	
...
$string['questionsinuse'] = '(* A csillaggal jelölt kérdéseket már tesztek használják. A kérdések csak a kategóriák jegyzékéből törlődnek, a tesztekből nem. ';	
...
$string['quiz:attempt'] = "Tesztek megoldása";	
$string['quiz:deleteattempts'] = "Teszt próbálkozásainak törlése";	
$string['quiz:grade'] = "Tesztek kézi osztályozása";	
...
$string['randomsamatch'] = 'Véletlen kiegészítő párosító';	
...
$string['reviewalways'] = 'Ellenőrzés bármikori engedélyezése';	
$string['reviewbefore'] = 'Ellenőrzés engedélyezése, amíg a teszt nyitva van ';	
...
$string['reviewofattempt'] = '$a próbálkozás ellenőrzése';	
$string['reviewopen'] = 'Később, amíg a teszt nyitva van';	
$string['reviewoptions'] = 'Tanulók ellenőrizhetik';	
$string['reviewresponse'] = 'Felelet ellenőrzése';	
...
$string['savenosubmit'] = 'Mentés ellenőrzés nélkül';	
...
$string['timedelay'] = 'Nem oldhatja meg a tesztet, mert még nem telt el az időköz a következő próbálkozásig';	
...
$string['upgradesure'] = '<div style=\"color: red;\">A tesztmodul nagyban módosítja a teszttáblázatokat, ez a frissítés pedig nincs még kellően ellenőrizve. Továbblépés előtt mindenképpen készítsen biztonsági másolatot az adatbázis táblázatairól.</div>';	
$string['url'] = 'URL';	
...
$string['warningmissingtype'] = "<b>Ez olyan kérdésfajat, amely Moodle-rendszerében még nincs telepítve.<br />Szóljon a Moodle rendszergazdájának.</b>";	
