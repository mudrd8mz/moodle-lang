...
$string['adminhelpmanageblocks'] = 'Atur blok yang terinstal serta pengaturannya';
$string['adminhelpmymoodle'] = 'Konfigurasi blok moodle saya untuk para pengguna';
...
$string['backupactivehelp'] = 'Pilih ya atau tidak untuk melakukan backup otomatis.';
$string['backupincludemoduleuserdatahelp'] = 'Pilih apakah Anda ingin memasukkan data pengguna modul dalam backup otomatis';
$string['backupschedulehelp'] = 'Pilih hari dalam seminggu untuk melakukan backup otomatis.';
$string['backupsitefileshelp'] = 'Jika diaktifkan maka file situs yang digunakan dalam kursus akan diikutkan dalam backup otomatis';
$string['backuptakealook'] = 'Harap lihat log backup anda dalam: $a';
$string['block'] = 'Blok';
$string['blockconfiga'] = 'Konfigurasi blok $a';
$string['blocks'] = 'Blok';
$string['blocksaddedit'] = 'Tambah/Edit blok';
$string['blockseditoff'] = 'Matikan pengeditan blok';
$string['blocksediton'] = 'Nyalakan pengeditan blok';
$string['blocksetup'] = 'Menset tabel blok';
$string['blocksuccess'] = '$a tabel telah diset secara benar';
$string['byname'] = 'oleh $a';
$string['bypassed'] = 'Bypass';
$string['cachecontrols'] = 'Kontrol Memori';
...
$string['chooseauthmethod'] = 'Pilih plugin otentikasi';
$string['chooseenrolmethod'] = 'Pilih plugin pendaftaran';
$string['clambroken'] = 'Administrator Anda telah mengaktifkan pemeriksaan virus untuk file yang akan-di upload tetapi telah salah menkonfigurasi sesuatuFile upload Anda TIDAK berhasil. Administrator Anda telah dikirimi email sehingga mereka dapat memperbaikinya.<br />Coba lagi lain kali.';
$string['clamdeletedfile'] = 'File telah terhapus';
$string['clamdeletedfilefailed'] = 'File tidak dapat dihapus';
$string['clamemailsubject'] = '$a :: Notifikasi Clam AV';
$string['clamfailed'] = 'Clam AV gagal beroperasi. Pesan kesalahannya adalah $a. Berikut output dari Clam:';
$string['clammovedfile'] = 'File telah dipindahkan dari direktori karantina Anda, lokasinya kini adalah $a';
$string['clammovedfilebasic'] = 'File telah dipindahkan ke direktori karantina.';
$string['clamunknownerror'] = 'Ada kesalahan dengan clam yang tidak diketahui';
...
$string['continuetocourse'] = 'Klik di sini untuk memasukkan kursus Anda';
...
$string['copyingsitefiles'] = 'Mengkopi file situs yang digunakan dalam kursus';
...
$string['coursecreatorsdescription'] = 'Pembuat kursus dapat membuat kursus baru dan mengajar di sana.';
$string['courseenrolenddate'] = 'Tanggal terakhir pendaftaran kursus';
$string['courseenrolstartdate'] = 'Tanggal memulai pendaftaran kursus';
$string['courseformatdata'] = 'Data format kursus';
$string['coursehidden'] = 'Kursus ini sedang tidak tersedia untuk siswa';
$string['coursemessage'] = 'Pengguna perpesanan kursus';
...
$string['courserequestdisabled'] = 'Maaf, tetapi Anda tidak dapat lagi meminta kursus karena fitur ini telah dinonaktifkan oleh administrator';
...
$string['coursescategory'] = 'Kursus dalam kategori yang sama';
$string['coursespending'] = 'Izin menunda kursus';
$string['coursestaught'] = 'Kursus yang telah saya ajar';
$string['creatingblocks'] = 'Membuat blok';
$string['creatinggradebook'] = 'Membuat bukunilai';
...
$string['currentlyselectedusers'] = 'Pengguna yang sedang terseleksi';
...
$string['default'] = 'Yang biasanya';
$string['defaultcoursestudentdescription'] = 'Siswa biasa memiliki hak yang sedikit di dalam kursus.';
...
$string['forgotaccount'] = 'Kehilangan password';
$string['formatlams'] = 'Format kursus LAMS';
$string['formatmarkdown'] = 'Format markdown';
$string['formatscorm'] = 'Format SCORM';
$string['formattopicsajax'] = 'Format topik- AJAX';
$string['formattopicscss'] = 'Format topik- CSS/Tanpa tabel';
$string['formatweekscss'] = 'Format mingguan- CSS/Tanpa tabel';
$string['functiondisabled'] = 'Fungsi ini telah dinonaktifkan';
$string['gettheselogs'] = 'Dapatkan log ini';
$string['go'] = 'Maju';
$string['gotoyourserver'] = '(Link kembali ke server Anda)';
...
$string['healthcenter'] = 'Pusat Kesehatan';
...
$string['helpinterestslist'] = 'Masukkan apa-apa saja yang Anda senangi dan dipisahkan dengan koma';
$string['helpprefix'] = 'Bantuan, $a';
...
$string['includenoneusers'] = 'Tidak Termasuk Pengguna';
$string['includesitefiles'] = 'Termasuk File Situs yang Telah Digunakan dalam Kursus Ini';
$string['info'] = 'Informasi';
$string['interestslist'] = 'Daftar apa-apa yang disukai';
$string['ip_address'] = 'Alamat IP';
$string['keepsearching'] = 'Tetap mencari';
...
$string['loginalready'] = 'Anda telah login';
$string['logoutconfirm'] = 'Apa Anda yakin untuk logout?';
...
$string['messageselectadd'] = 'Tambah/kirim pesan';
$string['metaaddcourse'] = 'Tambah kursus ini';
$string['metanopotentialcourses'] = 'Tidak ada kursus tersedia';
$string['metapotentialcourses'] = 'Kursus tersedia';
$string['metaremovecourse'] = 'Pindahkan kursus ini';
...
$string['oldpassword'] = 'Password sekarang';
...
$string['previewhtml'] = 'Pra-tampil Format HTML';
$string['previoussection'] = 'Bagian sebelumnya';
$string['primaryadminsetup'] = 'Atur akun admin';
$string['profile'] = 'Profil';
$string['publicdirectorytitle'] = 'Lihat daftar situs yang ada';
...
$string['requestreason'] = 'Alasan untuk meminta kursus';
$string['reset'] = 'Set ulang';
$string['resetcomponent'] = 'Komponen';
$string['resetcourse'] = 'Set ulang kursus';
$string['resetstartdate'] = 'Set ulang tanggal untuk memulai';
$string['resetstatus'] = 'Status';
$string['resettask'] = 'Tugas';
$string['resettodefaults'] = 'Set ulang ke biasanya';
...
$string['screenreaderno'] = 'Tidak';
$string['screenreaderyes'] = 'Ya';
...
$string['setcategorytheme'] = 'Set Tema Kategori';
...
$string['statsmodegeneral'] = 'Pandangan biasanya';
$string['statsoff'] = 'Statistik belum diaktifkan';
$string['statsreport8'] = 'Semua aktifitas Pengguna';
...
$string['statsstudentactivity'] = 'Aktifitas siswa';
$string['statsteacheractivity'] = 'Aktivitas pengajar';
$string['statsuserlogins'] = 'Login';
$string['studentviewoff'] = 'Matikan pandangan siswa';
$string['studentviewon'] = 'Nyalakan pandangan siswa';
$string['submit'] = 'Sampaikan';
$string['targetrole'] = 'Sasaran';
$string['unenrolallstudents'] = 'Hapus pendaftaran kursus semua siswa';
$string['uploadformlimit'] = 'File yang di-upload melawati batas ukuran yang diatur di dalam formulir';
$string['usemessageform'] = 'atau gunakan formulir di bawah ini untuk mengirim pesan ke siswa yang dipilih';
...
$string['addedrecip'] = 'Penerima baru $a ditambahkan';
$string['addedrecips'] = 'Penerima baru $a ditambahkan';
$string['addnousersrecip'] = 'Tambahkan pengguna yang belum mengakses $a ini ke daftar penerima';
$string['addresource'] = 'Tambahkan sumber';
$string['addsubcategory'] = 'Tambahkan sub-kategori';
$string['adminbookmarks'] = 'Bookmark admin';
$string['adminhelpassignstudents'] = 'Memasuki kursus dan menambahkan para siswa dari menu admin';
$string['adminhelpeditorsettings'] = 'Definisikan pengaturan dasar untuk editor HTML';
$string['adminhelpenrolments'] = 'Pilih jalur internal atau eksternal untuk mengontrol pendaftaran';
$string['adminhelphealthcenter'] = 'Deteksi otomatis dari masalah situs';
...
$string['adminprimarynoedit'] = 'Anda sebaiknya tidak merubah kata kunci pertama admin';
$string['advanced'] = 'Lanjutan';
$string['advancedsettings'] = 'Pengaturan tingkat lanjut';
$string['aimid'] = 'AIM ID';
$string['ajaxno'] = 'Tidak: menggunakan fitur web dasar';
$string['ajaxuse'] = 'AJAX dan Javascript';
$string['ajaxyes'] = 'Ya: menggunakan fitur web tingkat lanjut';
...
$string['back'] = 'Kembali';
$string['backtoparticipants'] = 'Kembali ke daftar partisipan';
$string['backupcancelled'] = 'Backup Dibatalkan';
...
$string['backupdetails'] = 'Rincian backup';
$string['backupexecuteathelp'] = 'Pilih waktu dijalankannya backup otomatis.';
...
$string['updatemymoodleon'] = 'Edit halaman ini';
...
$string['usethiscourse'] = 'Gunakan kursus ini';
$string['views'] = 'Lihat';
$string['viewsolution'] = 'lihat solusi';
$string['virusfoundsubject'] = '$a: Virus ditemukan!';
$string['virusfounduser'] = 'File yang Anda upload, $a->filename, telah diperiksa oleh antivirus dan ditemukan telah terinfeksi! File Anda GAGAL di-upload.';
$string['virusplaceholder'] = 'File yang telah di-upload ini ditemukan berisi virus dan telah dipindahkan atau dihapus.';
$string['visible'] = 'Terlihat';
$string['visibletostudents'] = 'Diperlihatkan ke $a';
$string['writingmessagesinfo'] = 'menuliskan info pesan';
$string['xmldbeditor'] = 'Pengedit XMLDB';
