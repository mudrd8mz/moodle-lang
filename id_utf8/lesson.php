...
$string['essay'] = 'Essai';
$string['essayemailmessage'] = '<p>Essai cepat:<blockquote>$a->question</blockquote></p><p>Respon Anda:<blockquote><em>$a->response</em></blockquote></p><p>$a->comment pengajar:<blockquote><em>$a->comment</em></blockquote></p><p>Anda telah mendapatkan $a->earned out soal essai dari $a->outof soal yang ada.</p><p>Nilai Anda dalam pelajaran ini telah berubah ke $a->newgrade&#37;.</p>';
