...
$string['namehome'] = 'Pagina principală';
...
$string['newsbuzzdetail'] = 'Publicaţii despre Moodle în lume';
$string['newscalendar'] = 'Calendar';
$string['newsofficial'] = 'Noutăţi despre Moodle';
...
$string['popularissues'] = 'Cele mai discutate probleme';
...
$string['supportforumsenglishname'] = 'Folosire Moodle';
$string['supportforumslang'] = 'Cel mai important forum în care utilizatorii Moodle pot socializa în limba engleză este accesibil aici:';
$string['supportforumslangname'] = 'Moodle Lounge';
$string['supportforumslangurl'] = 'http://moodle.org/course/view.php?id=55';
$string['supportforumslist'] = 'Avem de asemenea disponibile o mulţime de alte forumuri în alte limbi:';
$string['supportforumslistname'] = 'Listă toate forumurile';
$string['supportforumstitle'] = 'Forumuri';
