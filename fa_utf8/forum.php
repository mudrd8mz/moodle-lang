...
$string['aggregatecountformat'] = '$a->count (امتیاز: $a->grade)';
...
$string['ajaxrating'] = 'قابلیت ارزیابی توسط AJAX';
...
$string['configajaxrating'] = 'ارزیابی با استفاده از AJAX بهبودی در زمینهٔ کارآیی ارزیابی تالار گفتگو است. در صورت فعال بودن، کاربران می‌توانند مطالب تالارهای گفتگو را تقریباً بلافاصله و بدون نیاز به رفتن به انتهای صفحه و کلیک بر روی دکمهٔ «ارزیابی‌های من اعمال شود»، ارزیابی نمایند. این تنظیم همچنین نیاز به فعال بودن AJAX در سایت و در مشخصات فردی کاربران دارد.';
...
$string['forcessubscribe'] = 'همه بالاجبار در این تالار مشترک هستند'; 
$string['forcesubscribe'] = 'مشترک کردن اجباری همه';
$string['forcesubscribeq'] = 'اشتراک اجباری برای همه؟';
$string['forum'] = 'تالار گقتگو';
$string['forum:addnews'] = 'اضافه کردن خبر';
...
$string['forum:initialsubscriptions'] = 'اشتراک اولیه';
...
$string['inforum'] = 'در $a';
$string['intronews'] = 'آگهی‌ها و خبرهای عمومی';
...
$string['invalidrate'] = 'ارزیابی نامعتبر ($a)';
...
$string['noratinggiven'] = 'امتیازی داده نشده است';
...
$string['postmailnow'] = '<p>این نظر بلافاصله به همهٔ مشترکین تالار پست خواهد شد.</p>';
...
$string['unsubscribeallconfirm'] = 'شما هم‌اکنون در تالارهای $a مشترک هستید. آیا واقعاً می‌خواهید که اشتراک خود را در همهٔ تالارها لغو کرده و اشتراک خودکار در تالارها را غیرفعال نمائید؟';
$string['unsubscribealldone'] = 'همهٔ اشتراک‌های شما در تالارها حذف شدند، ممکن است همچنان ابلاغ‌هایی از تالارهایی که دارای اشتراک اجباری هستند دریافت نمائید. اگر نمی‌خواهید که از این کارگزار هرگونه نامه‌ای دریافت کنید لطفاً به صفحهٔ مشخصات فردی خود بروید و آدرس پست الکترونیک را غیرفعال نمائید.';
$string['unsubscribeallempty'] = 'شما در هیچ تالاری مشترک نیستید. اگر نمی‌خواهید که از این کارگزار هرگونه نامه‌ای دریافت کنید لطفاً به صفحهٔ مشخصات فردی خود بروید و آدرس پست الکترونیک را غیرفعال نمائید.';
