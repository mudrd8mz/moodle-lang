...
$string['admindirsetting'] = 'وب‌سایت‌های خیلی کمی از <span dir=\"ltr\">/admin</span> بعنوان پیوند ویژه‌ای برای دستیابی به یک
...
$string['databasecreationsettings'] = 'حال باید تنظیمات پایگاه داده که قسمت عمده‌ای از اطلاعات مودل در آن نگهداری
می‌شود را انجام دهید. این پایگاه داده به صورت خودکار توسط برنامهٔ نصب
با تنظیماتی که در این قسمت تعیین شده است ایجاد خواهد شد.<br />
    <br /> <br />
       <b>نوع:</b> توسط برنامهٔ نصب روی «mysql» ثابت شده است<br />
...
$string['databasecreationsettingssub'] = '<b>نوع:</b> توسط برنامهٔ نصب روی «mysql» ثابت شده است<br />
       ...
       <b>رمز اتصال:</b> رمز اتصال پایگاه دادهٔ شما<br />
       <b>پیشوند جدول‌ها:</b> پیشوند اختیاری مورد استفاده برای نام همهٔ جدول‌ها';
$string['databasesettings'] = 'حال باید پایگاه داده که قسمت عمده‌ای از اطلاعات مودل در آن نگهداری
می‌شود را پیکربندی نمائید. این پایگاه داده باید قبلاً ایجاد و همچنین
یک کاربر و رمز اتصال برای دستیابی به آن در نظر گرفته شده باشد.<br />
    <br /> <br />
       <b>نوع:</b> mysql یا postgres7<br />
