...
$string['deletingnoneemptycategory'] = 'حذف این دسته موجب حذف اصطلاحاتی که شامل شده است نمی‌شود - آن‌ها بعنوان دسته‌بندی نشده علامت‌گذاری می‌شوند.';
...
$string['glossary:approve'] = 'تایید اصطلاحات تایید نشده';
