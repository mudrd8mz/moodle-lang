...
$string['chatreport'] = 'Sessions de clavardage';
$string['configrefreshroom'] = 'Fréquence d\'actualisation du bavardoir (en secondes) ? Une valeur basse donnera une impression de rapidité, mais surchargera votre serveur web lorsque beaucoup de monde utilisera le chat.';
$string['donotusechattime'] = 'Ne pas publier les horaires de clavardage';
...
$string['helpchatting'] = 'Aide pour le clavardage';
