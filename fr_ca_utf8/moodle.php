...
$string['cookiesnotenabled'] = 'La gestion des témoins (cookies) n\'est malheureusement pas activée actuellement dans votre navigateur';
...
$string['uploadedfile'] = 'Le fichier a été téléversé avec succès';
$string['uploadedfileto'] = 'Téléverser $a->file dans $a->directory';
$string['uploadextension'] = 'Téléversement du fichier arrêté par l\'extension';
