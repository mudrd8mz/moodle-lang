...
$string['check_noauth_details'] = '<p>Das Plugin \'Keine Authentifizierung\' ist nicht für produktive Seiten gedacht. Deaktivieren Sie diese Funktion unbedingt, es sei denn Sie betreiben eine Testseite zu Entwicklungszwecken.</p>';
$string['check_noauth_error'] = 'Das Plugin \'Keine Authentifizierung\' darf auf produktiven Seiten nicht verwandt werden.';
$string['check_noauth_name'] = 'Keine Authentifizierung';
$string['check_noauth_ok'] = 'Das Plugin \'Keine Authentifizierung\' ist ausgeschaltet';
