<?PHP // $Id$ 
      // currencies.php - created with Moodle 1.6 development (2006032001)
...
$string['ESP'] = 'Spanische Peseta';
$string['ETB'] = 'Ethiopian Birr';
$string['EUR'] = 'Euro';
$string['FIM'] = 'Finnische Mark';
$string['FJD'] = 'Fiji Dollar';
$string['FKP'] = 'Falkland Islands Pound';
$string['FRF'] = 'Französische Francs';
...
$string['GRD'] = 'Griechische Drachmen';
...
$string['LUF'] = 'Luxemburgische Francs';
...
$string['PTE'] = 'Portugiesische Escudo';
