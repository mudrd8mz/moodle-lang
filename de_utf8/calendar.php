...
$string['explain_lookahead'] = 'Mit dieser Einstellung legen Sie fest, wie weit im Voraus Termine angezeigt werden. Späterliegende Termine werden nicht als bevorstehend angezeigt. Bitte beachten Sie: Es werden nur so viele Termine als bevorstehend angezeigt, wie Sie in der Einstellung \"Höchstzahl der bevorstehenden Termine\" festgelegt haben. Sie können also den Zeitraum, für den Termine angezeigt werden, und die Höchstzahl der in dieser Zeit dargestellten Termine festlegen.';
