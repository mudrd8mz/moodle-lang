...
$string['auth_ldap_ldap_encoding'] = 'Geben Sie die Codierung des LDAP-Servers an. Meistens ist dies utf-8, aber MS AD v2 verwendet eine andere Codierung, wie cp1252, cp1250, usw.';
...
$string['auth_ldap_user_type'] = 'Wählen Sie, wie Nutzerdaten in LDAP hinterlegt sind. (Anmerkung: Diese Einstellungen bestimmt auch die Art und Weise, wie die Gültigkeitsdauer für Kennworte, die GraceLogins und das Anlegen neuer Nutzer in LDAP funktionieren.)';
