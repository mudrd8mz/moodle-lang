<?PHP // $Id$ 
      // auth.php - created with Moodle 1.9.12+ (Build: 20110623) (2007101591.03)
...
$string['auth_cas_certificate_check'] = 'Setzen Sie den Wert auf \'Ja\' um das Server-Zertifikat zu validieren.';
$string['auth_cas_certificate_check_key'] = 'Server-Validierung';
$string['auth_cas_certificate_path'] = 'Pfad zur CA chain datei (PEM Format) zur Validierung des Server-Zertifikats';
$string['auth_cas_certificate_path_empty'] = 'Wenn Sie die Server-Validierung aktivieren ist die Eingabe eines Pfades zum Zertifikat erforderlich';
$string['auth_cas_certificate_path_key'] = 'Pfad zum Zertifikat';
