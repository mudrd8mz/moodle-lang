...
$string['pagesize'] = 'Zahl der Blogeinträge/Seite';
$string['personalblogs'] = 'Nutzer/innen können nur ihren eigenen Blog sehen';
$string['ptags'] = 'Nutzer definierte Schlagworte';
...
$string['timewithin'] = 'Anzeige der Schlagwörtern, die an so vielen Tagen gebraucht wurden';
