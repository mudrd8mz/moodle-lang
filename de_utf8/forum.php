...
$string['configreplytouser'] = 'Wenn ein Forumsbeitrag per E-Mail verschickt wird - soll er die E-Mail-Adresse des Teilnehmers/der Teilnehmerin enthalten, damit der Empfänger persönlich antworten kann (statt über das Forum)? Wenn Sie \"Ja\" auswählen, können die Teilnehmer/innen in ihrem Profil festlegen, ob die E-Mail-Adresse veröffentlicht werden soll oder nicht.';
...
$string['configusermarksread'] = 'Die \"Ja\"-Einstellung bewirkt, dass jede/r Nutzer/in eine Nachricht manuell als gelesen markieren muss. Bei \"Nein\" wird eine Nachricht automatisch dann als gelesen markiert, wenn sie aufgerufen wurde.';
...
$string['couldnotdeletereplies'] = 'Der Beitrag kann nicht gelöscht werden, weil dazu schon Anworten vorliegen.';
...
$string['forcesubscribeq'] = 'Alle zwingend in dieses Forum eintragen';
$string['forum'] = 'Forum';
...
$string['forum:nothrottling'] = 'Ohne Beschränkungen';
...
$string['forumblockingalmosttoomanyposts'] = 'Sie erreichen demnächst die Höchstzahl der zulässigen Beiträge. Sie haben $a->numposts Beiträge im Zeitraum\'$a->blockperiod veröffentlicht. Die Grenze ist bei $a->blockafter Beiträgen erreicht.';
...
$string['maxattachmentsize'] = 'Maximale Größe des Dateianhangs';
...
$string['ratingonlyteachers'] = 'Nur $a können Beiträge bewerten';
...
$string['showsubscribers'] = 'Teilnehmer anzeigen / Einträge bearbeiten';
...
$string['trackingtype'] = 'Markierung von gelesenen Beiträgen';
