...
$string['configmaxbytes'] = 'Maximale Größe für Anhänge, die zu den Beiträgen auf diese Seite hochgeladen werden können';
...
$string['digestsentusers'] = 'Die E-Mail-Zusammenfassungen wurden erfolgreich an $a Teilnehmer/innen versandt.';
...
$string['forum:nothrottling'] = 'Keine Beschränkungen';
...
$string['markunread'] = 'Ungelesen markieren';
...
$string['nameteacher'] = 'Kursleitungs-Forum';
...
$string['postadded'] = '<p>Ihr Eintrag wurde erfolgreich hinzugefügt. </p><p>Sie können den Beitrag $a bearbeiten, sofern Sie Änderungen vornehmen wollen.</p>';
...
$string['subscribestart'] = 'Bitte Beiträge per E-Mail an mich.';
$string['subscribestop'] = 'Bitte keine Beiträge mehr als E-Mail an mich.';
$string['subscription'] = 'Anmeldung';
$string['subscriptions'] = 'Anmeldungen';
$string['thisforumisthrottled'] = 'Für dieses Forum ist eine Höchstzahl von Beiträgen in einem Zeitraum festgelegt worden. Dies gilt nach $a->blockafter Beitrag/Beiträgen innerhalb von $a->blockperiod';
