<?PHP // $Id$ 
      // forum.php - created with Moodle 1.9.12+ (Build: 20110623) (2007101591.03)
...
$string['confirmsubscribe'] = 'Möchten Sie sich als Abonnent im Forum \'{$a}\' eintragen?';
$string['confirmunsubscribe'] = 'Möchten Sie sich als Abonnent aus dem Forum \'{$a}\' austragen?';
...
$string['completiondiscussions'] = 'Teilnehmer/in muss Themen neu beginnen'; // ORPHANED
$string['completiondiscussionsgroup'] = 'Diskussionen erforderlich'; // ORPHANED
$string['completiondiscussionshelp'] = 'Zum Beenden sind Diskussionen erforderlich'; // ORPHANED
$string['completionposts'] = 'Teilnehmer/in muss Diskussionen oder Antworten verfassen.'; // ORPHANED
$string['completionpostsgroup'] = 'Forumseinträge erforderlich'; // ORPHANED
$string['completionpostshelp'] = 'Zum Beenden sind Diskussionen oder Antworten erforderlich'; // ORPHANED
$string['completionreplies'] = 'Teilnehmer/in muss Antworten verfassen'; // ORPHANED
$string['completionrepliesgroup'] = 'Antworten erforderlich'; // ORPHANED
$string['completionreplieshelp'] = 'Zum Beenden sind Antworten erforderlich'; // ORPHANED
