...
$string['noteuserschangednonetocourse'] = '<strong>Hinweis: </strong>Bei der Wiederherstellung von Nutzerdaten (Aktivitäten, Dateien, Mitteilungen) müssen auch die Teilnehmer/innen wiederhergestellt werden. Diese Einstellung wurde für Sie geändert.';
...
$string['restoreuserinfofailed'] = '<strong>Achtung:</strong> Um Nutzerdaten (Aktivitäten, Dateien, Mitteilungen, ...) wiederherstellen zu dürfen, wird die Fähigkeit \"moodle/restore:userinfo\" vorausgesetzt, die Sie aber nicht besitzen. Die Wiederherstellung wurde abgebrochen.';
...
$string['userprofilefor'] = 'Nutzerprofil von $a'; // ORPHANED
...
$string['noteusercannotrolldatesoncontext'] = '<strong>Hinweis:</strong> Die Möglichkeit zum Datenimport wurde für diese Wiederherstellung deaktiviert, da Sie nicht über die nötigen Rechte verfügen.'; // ORPHANED
$string['restoredaccountinfo'] = 'Dieses Nutzerkonto wurde ohne Passwort von einem anderen Server importiert. Um ein neues Passwort per E-Mail zu vergeben, klicken Sie bitte auf \"Weiter\".'; // ORPHANED
$string['restoretositeadding'] = 'Warnung: Sie beabsichtigen, Daten zur Startseite hinzuzufügen.'; // ORPHANED
$string['restoretositedeleting'] = 'Warnung: Sie beabsichtigen, die Startseite wiederherzustellen und vorher Daten zu löschen.'; // ORPHANED
