...
$string['adminhelpstickyblocks'] = 'Feste Blöcke für die gesamte Moodle-Installation konfigurieren';
...
$string['adminhelpxmldbeditor'] = 'Interface zur Bearbeitugvon XMLDB-Dateien. Ausschließlich für Entwickler/innen!!';
...
$string['adminprimarynoedit'] = 'Sie können das Kennwort von Haupt-Administrator/innen nicht ändern.';
...
$string['autosubscribeno'] = 'Nein, keine Forenbeiträge per E-Mail bestellen';
$string['autosubscribeyes'] = 'Ja, sobald ich einen Forenbeitrag schreibe';
...
$string['blockseditoff'] = 'Blöcke bearbeiten ausschalten';
$string['blocksediton'] = 'Blöcke bearbeiten einschalten';
...
$string['coursecreatorsdescription'] = 'Kursersteller/innen dürfen neue Kurse erstellen und in ihnen unterrichten.';
...
$string['coursereject'] = 'Kursanfrage ablehnen';
...
$string['creatingblocksroles'] = 'Rollenzuweisungen und -überschreibungen auf Blockebene erstellen';
...
$string['creatingcourseroles'] = 'Rollenzuweisungen und -überschreibungen auf Kursebene erstellen';
...
$string['creatingmodroles'] = 'Rollenzuweisungen und -überschreibungen auf Modulebene erstellen';
...
$string['creatinguserroles'] = 'Rollenzuweisungen und -überschreibungen auf Nutzerebene erstellen';
...
$string['defaultcourseshortname'] = 'CF 101';
$string['defaultcoursestudent'] = 'Teilnehmer/in';
$string['defaultcoursestudentdescription'] = 'Teilnehmer/innen haben grundsätzlich geringere Rechte in einem Kurs.';
...
$string['editorcleanonpaste'] = 'Word-Texte beim Einfügen in sauberen HTML-Code umwandeln';
...
$string['emaildigestoff'] = 'Nein, jeden Forenbeitrag einzeln als E-Mail senden';
$string['emaildigestsubjects'] = 'Ja, täglich eine E-Mail mit den Betreffs aller Forenbeiträge senden';
$string['emaildisable'] = 'Nein, keine Nachrichten an diese Adresse senden';
...
$string['emaildisplaycourse'] = 'Ja, aber nur für Kursteilnehmer/innen sichtbar';
$string['emaildisplayno'] = 'Nein, für niemanden sichtbar';
$string['emaildisplayyes'] = 'Ja, für alle sichtbar';
$string['emailenable'] = 'Ja, alle Nachrichten an diese Adresse senden';
...
$string['enrolmentplugins'] = 'Anmeldeverfahren';
$string['enrolments'] = 'Kursanmeldung';
...
wir erinnern Sie daran, dass Ihre Teilnahmedauer für den Kurs $a->course in $a->threshold Tagen endet. Nehmen Sie mit der/dem Trainer/innen Kontakt auf, falls Sie weiterhin im Kurs eingeschrieben bleiben wollen.';
...
$string['forcepasswordchangehelp'] = 'Aufforderung beim nächsten Login';
...
$string['formatweekscss'] = 'Wochen-Format - CSS/Ohne Tabellen';
...
$string['frontpagedescription'] = 'Beschreibung der Website';
$string['frontpagedescriptionhelp'] = 'Diese Beschreibung der Website wird auf der Startseite angezeigt.';
...
$string['importdataexported'] = 'Die Daten wurden erfolgreich aus dem (Quell-)Kurs exportiert.<br />Jetzt erfolgt der Import in den von Ihnen ausgewählten Zielkurs.';
$string['importdatafinished'] = 'Import abgeschlossen! Weiter zu Ihrem Kurs';
$string['importdatafrom'] = 'Wählen Sie einen (Quell-)Kurs, aus dem Daten importiert werden sollen.';
...
<li>Für einige Kurse ist ein Zugangsschlüssel notwendig. Benutzen Sie dazu bitte den Zugangsschlüssel, den Ihnen Ihr/e Trainer/in mitgeteilt hat. Mit diesem Zugangsschlüssel können Sie sich in den entsprechenden Kurs einschreiben.</li>
...
$string['loginusing'] = 'Bitte geben Sie Ihren Anmeldenamen und das Kennwort ein';
...
$string['missingstrings'] = 'Fehlende Textpassagen suchen';
...
$string['none'] = '--';
$string['noneditingteacher'] = 'Trainer/in ohne Editorrecht';
$string['noneditingteacherdescription'] = 'Trainer/innen ohne Editorrecht dürfen in Kursen unterrichten und Teilnehmer/innen bewerten, aber sie können nichts verändern.';
...
$string['passwordnohelp'] = 'Leider ist keine Hilfe vorhanden, um das vergessene Kennwort wiederherzustellen. Bitte wenden Sie sich an Ihre Administration.';
...
$string['switchrolereturn'] = 'Zu meiner normalen Rolle zurückkehren';
$string['switchroleto'] = 'Rolle umschalten auf...';
$string['tag'] = 'Element';
