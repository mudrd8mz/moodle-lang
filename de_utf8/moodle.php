...
$string['adminhelpmanageblocks'] = 'Installierte Blöcke und ihre Einstellungen verwalten';
$string['adminhelpmanagedatabase'] = 'Direkt auf die Datenbank zugreifen (Vorsicht!)';
$string['adminhelpmanagefilters'] = 'Textfilter und ihre Einstellungen verwalten';
$string['adminhelpmanagemodules'] = 'Installierte Aktivitäten-Module und ihre Einstellungen verwalten';
...
$string['courseoverview'] = 'Kurs-Übersicht';
...
$string['courserequestintro'] = 'Mit diesem Formular können Sie die Einrichtung eines neuen Kurses beantragen.<br />Tragen Sie alle Informationen ein, damit die Administrator/innen Ihren Wunsch nachvollziehen und ihren Antrag bearbeiten kann.';
...
$string['createuserandpass'] = 'Anmeldename und Kennwort für die Anmeldung auf dieser Moodleseite. (Registrierung)';
...
$string['edhelpfontlist'] = 'Festlegung der Schriften, die im Dropdown-Menü des WYSIWYG-Texteditors angezeigt werden.';
...
$string['editorcleanonpaste'] = 'Word-Texte beim Einfügen als HTML-Code bereinigen';
...
<li>Für einige Kurse ist ein Zugangsschlüssel notwendig. Benutzen Sie dazu bitte den Zugangsschlüssel, den Ihnen Ihre Trainerin/Ihr Trainer mitgeteilt hat. Mit diesem Zugangsschlüssel können Sie sich in den entsprechenden Kurs einschreiben.</li>
...
$string['sitepartlist1'] = 'Sie müssen Trainer/in sein, um die vollständige Nutzerliste der Website sehen zu können.';
$string['sites'] = 'Seiten';
