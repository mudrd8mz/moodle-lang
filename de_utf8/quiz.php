...
$string['attemptselection'] = 'Auswahl, welche Versuche für alle Nutzer/innen  analysiert werden:';
$string['attemptsexist'] = 'Sie können jetzt keine Fragen mehr hinzufügen und entfernen.';
...
$string['confirmclose'] = 'Sie möchten diesen Versuch beenden. Wenn Sie den Versuch beenden, können Sie Ihre Antworten nicht mehr bearbeiten.';
...
$string['countdownfinished'] = 'Der Test wird gleich beendet, Sie sollten Ihre Antworten jetzt absenden.';
...
$string['decimaldigits'] = 'Dezimalziffern in Punktwerten';
$string['decimalformat'] = 'Dezimale';
$string['decimalpoints'] = 'Dezimalstellen';
$string['decimals'] = 'mit $a';
$string['default'] = 'Standard';
$string['defaultgrade'] = 'Standardbewertung der Frage';
$string['defaultinfo'] = 'Die Standardkategorie für Fragen';
$string['delay1'] = 'Zeitverzögerung zwischen erstem und zweiten Versuch';
$string['delay2'] = 'Zeitverzögerung zwischen späteren Versuchen';
...
$string['eachattemptbuildsonthelast'] = 'Jeder Versuch basiert auf dem vorherigen';
...
$string['editingcalculated'] = 'Eine Berechnungs-Frage bearbeiten';
$string['editingdescription'] = 'Eine Beschreibung bearbeiten';
$string['editingessay'] = 'Texte bearbeiten';
$string['editingmatch'] = 'Eine Zuordnungsfrage bearbeiten';
$string['editingmultianswer'] = 'Eine Lückentext-Frage bearbeiten';
$string['editingmultichoice'] = 'Eine Multiple-Choice-Frage bearbeiten';
...
$string['editingrandom'] = 'Eine Zufallsfrage bearbeiten';
$string['editingrandomsamatch'] = 'Eine zufällige Kurzantwort-Zuordnung bearbeiten';
$string['editingrqp'] = '$a: Eine Frage bearbeiten';
$string['editingshortanswer'] = 'Eine Kurzantwort-Frage bearbeiten';
...
$string['feedbackerrorboundaryformat'] = 'Die Bewertungsgrenzen für die Rückmeldung müssen entweder in Prozent oder als Zahl angegeben werden. Der von Ihnen eingegebene Grenzwert $a wurde nicht erkannt.';
$string['feedbackerrorboundaryoutofrange'] = 'Die Bewertungsgrenzen für die Rückmeldung müssen zwischen 0%% und 100%% liegen. Der von Ihnen eingegebene Grenzwert $a liegt außerhalb.';
$string['feedbackerrorjunkinboundary'] = 'Sie müssen die Bewertungsgrenzen in den Rückmeldefelder ausfüllen, ohne Lücken zu lassen.';
$string['feedbackerrorjunkinfeedback'] = 'Sie müssen die Rückmeldefelder ausfüllen, ohne Lücken zu lassen.';
$string['feedbackerrororder'] = 'Die Bewertungsgrenzen für die Rückmeldung müssen sortiert sein, u.z. der größte zuerst. Der von Ihnen eingegebene Grenzwert $a liegt nicht in der Reihe.';
$string['file'] = 'Datei';
$string['fileformat'] = 'Dateiformat';
$string['fillcorrect'] = 'Korrektur eintragen';
$string['filloutnumericalanswer'] = 'Sie geben eine mögliche Antwort und einen Toleranzwert an. Die erste passende Antwort wird benutzt, um Punktzahl und Rückmeldung zu bestimmen. Falls Sie sich entscheiden, am Ende eine Rückmeldung ohne vorherige Antwort zu geben, so wird diese allen Teilnehmer/innen gezeigt, deren Antworten auf keine der Vorgaben passen.';
...
$string['generalfeedback'] = 'Standardrückmeldung';
...
$string['gradeboundary'] = 'Bewertungsgrenzen';
$string['gradeessays'] = 'Texte bewerten';
$string['gradehighest'] = 'Höchste Punktzahl';
...
$string['indivresp'] = 'Individuelle Antworten zu jeder Frage';
$string['info'] = 'Info';
$string['introduction'] = 'Einführung';
$string['invalidnumericanswer'] = 'Eine der von Ihnen eingegebenen Antworten hat keine gültige Nummer.';
$string['invalidnumerictolerance'] = 'Eine der von Ihnen eingegebenen Toleranzen hat keine gültige Nummer.';
...
$string['multipleanswers'] = 'Wählen Sie mindestens eine Antwort aus.';
...
$string['noessayquestionsfound'] = 'Keine Textfragen gefunden';
...
$string['numattempts'] = '$a->studentnum $a->studentstring hat/haben $a->attemptnum Versuche durchgeführt.';
$string['numberabbr'] = '#';
...
$string['overallfeedback'] = 'Gesamtrückmeldung';
...
$string['popupblockerwarning'] = 'Dieser Bereich des Tests läuft im sicheren Modus ab, d.h. Sie müssen den Test in einem sichern Fenster bearbeiten. Bitte schalten Sie den Popup-Blocker Ihres Browsers aus.';
...
$string['questionnametoolong'] = 'Die Bezeichnung der Frage in Zeile $a ist zu lang (max 255 Zeichen). Sie wurde gekürzt.';
...
$string['quizcloses'] = 'Test wird beendet';
...
$string['reordertool'] = 'Umstellungs-Tool anzeigen.';
...
$string['reviewnever'] = 'Rückschau nicht zulassen';
...
$string['selectnone'] = 'Auswahl abwählen';
...
$string['timedelay'] = 'Bis zum nächsten Versuch bei diesem Test muss einige Zeit verstreichen.';
...
$string['unusedcategorydeleted'] = 'Nach dem Löschen des Kurses wurde diese Kategorie gelöscht. Die Fragen wurden nirgendwo genutzt.';
...
$string['warningmissingtype'] = '<p><b>Diese Frage ist von einem Typ, der bisher noch nicht in Ihrem Moodle installiert wurde.<br />Bitte fragen Sie Ihre Moodle-Administration.';
