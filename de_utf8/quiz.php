...
$string['attemptselection'] = 'Welche Versuche pro alle Nutzer/in analysieren:';
...
$string['editingcalculated'] = 'Eine Berechnungsfrage bearbeiten';
...
$string['filloutnumericalanswer'] = 'Sie geben eine mögliche Antwort und einen Toleranzwert an. Die erste passende Antwort wird benutzt, um Punktzahl und Rückmeldung zu bestimmen. Falls Sie sich entscheiden, am Ende ein Feedback ohne vorherige Antwort zu geben, so wird dies jenen Teilnehmenden gezeigt, deren Antworten auf keine der Vorgaben passen.';
...
$string['subneterror'] = 'Entschuldigung, der Zugang zum Test ist nur von bestimmten Rechnern möglich. Ihr Computer kann den Test zur Zeit nicht starten.';
$string['subnetnotice'] = 'Der Zugang zum Test ist für Studenten nur von bestimmten Rechnern möglich. Ihr Rechner hat dieses Recht nicht. Als Trainer/in können Sie jedoch von jedem Rechner aus zugreifen.';
