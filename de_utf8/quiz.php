...
$string['attemptsonly'] = 'Nur Teilnehmer/innen, die bereits Versuche durchgeführt haben, anzeigen';
...
$string['closebeforeopen'] = 'Der Test konnte nicht aktualisiert werden. Das Abschlußdatum liegt vor dem Startdatum.';
...
$string['countdownfinished'] = 'Der Test wird beendet, Sie sollten Ihre Antworten jetzt sofort absenden.';
...
$string['feedbackerrorboundaryformat'] = 'Der Feedbacknotengrenzwert muß entweder eine Zahl oder ein Prozentwert sein. Der Wert, der als Grenzwert $a eingetragen ist, wird nicht berücksichtigt.';
$string['feedbackerrorboundaryoutofrange'] = 'Der Feedbacknotengrenzwert muß zwiscehn 0%% und 100%% liegen. Der Wert, den Sie als Grenzwert eingetragen haben $a ist außerhalb dieser Werte.';
$string['feedbackerrorjunkinboundary'] = 'Der Feedbackbacknotengrenzwert in den Feldern muß so festgelegt werden, dass keine Lücken entstehen.';
$string['feedbackerrorjunkinfeedback'] = 'Die Feedbackfelder müssen lückenlos ausgefüllt werden.';
$string['feedbackerrororder'] = 'Die Feedbackgrenznotenwerte müssen in der richtigen Reihenfolge eingetragen werden. Der Wert im Feld $a liegt ausserhalb der Reihe.';
$string['file'] = 'Datei';
$string['fileformat'] = 'Dateiformat';
$string['fillcorrect'] = 'Korrektur eintragen';
$string['filloutnumericalanswer'] = 'Sie müssen mindestens eine mögliche Antwort und eine Bandbreite eingeben. Die erste passende Antwort wird zur Ermittlung des Punktwerts und des Feedbacks genutzt. Wenn Sie ein Feedback ohne passende Antwort eintragen, so wird dieses Teilnehmer/innen angezeigt, deren Antwort nicht zu den anderen passt (Wildcard).';
...
$string['formatnotfound'] = 'Das Import-/Exportformat $a wurde nicht gefunden';
...
$string['invalidnumericanswer'] = 'Eine der von Ihnen eingetragenen Antworten enthält einen ungültigen Wert.';
$string['invalidnumerictolerance'] = 'Eine der eingetragenen Toleranzen enthält einen ungültigen Wert.';
...
$string['matchanswerno'] = 'Zugeordnete Antwort $a';
...
$string['matchgradesnearest'] = 'Nächstliegende Bewertung wenn Note aufgelistet';
$string['max'] = 'Max';
$string['min'] = 'Min';
...
$string['nocategory'] = 'Sie keine oder eine falsche Kategorie ausgewählt.';
...
$string['nomatchinganswer'] = 'Sie müssen eine Antwort als passend zur Frage \'$a\' festlegen.';
...
$string['questionsinclhidden'] = 'Fragen (inkl. verborgenen)';
...
$string['quizsettings'] = 'Testeinstellungen';
...
$string['uniform'] = 'gleichmässige Verteilung der Werte';
$string['unit'] = 'Einheit';
...
$string['warningmissingtype'] = '<p><b>Diese Frage hat einen Type, der bisher noch nicht in Ihrem Moodle installiert wurde.<br />Bitte fragen Sie Ihre Moodle-Administration.';
