<?PHP // $Id$ 
      // enrol_database.php - created with Moodle 1.9 Beta + (2007100903)
...
$string['defaultcourseroleid'] = 'Diese Rolle wird standardmässig zugewiesen, falls keine Rolle ausgewählt. wird';
