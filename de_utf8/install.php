<?PHP // $Id$ 
      // install.php - created with Moodle 1.9.7+ (Build: 20091218) (2007101570)
...
<b>Kennwort:</b> Ihr Kennwort für die Datenbank<br />
<b>Tabellen-Prefix:</b> optionaler Prefix für alle Tabellennamen';
$string['databasesettings'] = 'Jetzt wird die Datenbank erstellt, in der die meisten Moodle-Daten gespeichert werden. Diese Datenbank muss bereits vorher angelegt sein und Sie müssen den Datenbankuser und das Kennwort kennen.<br />
 <br />
...
$string['cliadminpassword'] = 'Neues Admin-Passwort'; // ORPHANED
...
$string['databasehost'] = 'Datenbank-Server :'; // ORPHANED
$string['databasename'] = 'Datenbank-Name :'; // ORPHANED
$string['databasepass'] = 'Datenbank-Passwort :'; // ORPHANED
$string['databasesocket'] = 'Unix Socket'; // ORPHANED
$string['databasetypehead'] = 'Datenbank-Treiber wählen'; // ORPHANED
$string['databasetypesub'] = 'Moodle unterstützt mehrere Typen von Datenbank-Servern. Bitte fragen Sie Ihren Server-Administrator, welchen Typ Sie benutzen können.'; // ORPHANED
$string['databaseuser'] = 'Datenbank-Nutzer :'; // ORPHANED
$string['doyouagree'] = 'Stimmen Sie zu ? (ja/nein)'; // ORPHANED
...
$string['inputdatadirectory'] = 'Daten-Verzeichnis :'; // ORPHANED
$string['inputwebadress'] = 'Web-Adresse'; // ORPHANED
$string['inputwebdirectory'] = 'Moodle-Verzeichnis :'; // ORPHANED
$string['nativemysqli'] = 'Verbessertes MySQL (nativ/mysqli)'; // ORPHANED
$string['nativemysqlihelp'] = 'Jetzt müssen Sie die Einstellungen für die Datenbank vornehmen, wo die meisten Moodle-Daten gespeichert werden.
Die Datenbank wird angelegt, wenn der angegebene Datenbank-Nutzer die dafür nötigen Rechte besitzt. Ein Nutzername und das zugehörige Passwort für den Datenbank-Zugriff müssen bereits existieren. Das Tabellen-Prefix ist optional.'; // ORPHANED
$string['nativeoci'] = 'Oracle (native/oci)'; // ORPHANED
$string['nativepgsql'] = 'PostgreSQL (native/pgsql)'; // ORPHANED
$string['nativepgsqlhelp'] = 'Jetzt müssen Sie die Einstellungen für die Datenbank vornehmen, wo die meisten Moodle-Daten gespeichert werden.
Die Datenbank muss bereits angelegt sein. Ein Nutzername und das zugehörige Passwort  für den Datenbank-Zugriff müssen bereits existieren. Das Tabellen-Prefix ist verbindlich.'; // ORPHANED
...
$string['releasenoteslink'] = 'Um Informationen über diese Moodle-Version zu erhalten, schauen Sie bitte in die Release-Hinweise auf $a'; // ORPHANED
$string['sqliteextensionisnotpresentinphp'] = 'PHP ist für die Erweiterung SQLite nicht richtig konfiguriert. Bitte prüfen Sie Ihre php.ini oder übersetzen Sie PHP neu.'; // ORPHANED
$string['upgradingqtypeplugin'] = 'Plugin für Frage/Typ aktualisieren'; // ORPHANED
