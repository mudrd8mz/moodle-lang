...
$string['adminseesall'] = 'Administrator/in sieht alles';
$string['adminseesallevents'] = 'Administrator/in sieht alle Termine';
$string['adminseesownevents'] = 'Administrator/in sieht nur Termine eigener Kurse';
...
$string['configallowuserthemes'] = 'Die Einstellung erlaubt allen Nutzer/innen, ein Design auszuwählen. Damit wird das Design der Installation überschrieben, aber nicht die kursspezifische Design-Vorgabe.';
...
$string['configbloglevel'] = 'Die Einstellung erlaubt den Grad der Öffentlichkeit für Blog-Einträge zu beschränken. Beachten Sie: Die Einstellung legt den Wert für die Leser/innen fest, nicht Beitragsschreiber/innen oder den Blogtyp. Sie können auf Wunsch Blogs auch vollständig deaktivieren.';
...
$string['confighiddenuserfields'] = 'Markieren Sie die Felder, deren Inhalte vor anderen Nutzern/Nutzerinnen, nicht aber Trainern/Trainerinnen und Admins verborgen werden sollen. Dies schützt die Privatsphäre. Mit gedrückter CTRL-/Strg-Taste können Sie mehrere Felder markieren.';
...
$string['configintroadmin'] = 'Hier sollten Sie den Hauptadminstrator/die Hauptadminstratorin einrichten, der/die die vollständige Kontrolle über die Website hat. Achten Sie darauf, hier einen sicheren Benutzernamen samt Kennwort sowie eine gültige E-Mail-Adresse anzugeben. Weitere Administrator/innen können Sie später festlegen.';
