...
$string['authentication'] = 'Anmeldung';
...
$string['configallowcoursethemes'] = 'Mit der Aktivierung erlauben Sie die Auswahl kursspezifischer Designs. Das in der Moodle-Installation bestimmte Design und die von Nutzer/innen ausgewählten Designs werden in diesem Fall nicht berücksichtigt.';
...
$string['configallowuserthemes'] = 'Die Einstellung erlaubt Nutzer/innen, ein Design auszuwählen. Damit wird das Design der Installation überschrieben, aber keine kursspezifischen Design-Einstellungen.';
...
$string['configdefaultrequestcategory'] = 'Von Nutzer/innen beantragte Kurse werden automatisch in dieser Kategorie abgelegt.';
$string['configdefaultrequestedcategory'] = 'Standardkategorie, in der beantragte Kurse hinterlegt werden.';
...
$string['configfilterall'] = 'Filter über alle Begriffe (inkl. aller Überschriften, Titel, Navigationselemente usw.). Dies kann im Zusammenhang mit dem Multilang-Filter nützlich sein. Es erheblichen belastet den Server jedoch stark und kann zu einer Reduzierung der Arbeitsgeschwindigkeit führen.';
...
$string['configfrontpageloggedin'] = 'Die oben ausgewählten Elemente werden eingeloggten Nutzer/innen auf der Startseite angezeigt.';
...
$string['configlanglist'] = 'Lassen Sie dieses Feld leer, um allen Nutzer/inne/n zu erlauben, eine der installierten Sprachen auszuwählen. Sie können das Sprachmenü verkürzen, indem Sie eine durch Kommas getrennte Liste der Spachcodes angeben, z.B. de,en,es_es,fr,it';
...
$string['country'] = 'Land';
$string['coursemgmt'] = 'Kursverwaltung';
...
$string['datarootsecuritywarning'] = 'Ihre Einstellungen sind möglicherweise nicht sicher. Bitte überprüfen Sie, dass Ihr Datarootverzeichnis ($a) nicht direkt aus dem Web aufrufbar ist.';
...
$string['frontpageloggedin'] = 'Startseitenelemente nach der Anmeldung';
...
$string['helpcalendarsettings'] = 'Konfiguration des Kalenders sowie datums- und zeitbezogener Einstellungen';
...
$string['langedit'] = 'Sprachdateien bearbeiten';
...
$string['locationsettings'] = 'Lokale Einstellungen';
$string['log'] = 'Logdaten';
...
$string['sessioncookie'] = 'Cookie-Vorsilbe';
$string['sessioncookiepath'] = 'Cookie-Pfad';
$string['sessionhandling'] = 'Session-Behandlung';
