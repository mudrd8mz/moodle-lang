...
$string['configenrolmentplugins'] = 'Wählen Sie die Kurs-Anmeldeverfahren, die Sie verwenden wollen. Achten Sie darauf, die Einstellungen sorgfältig und richtig zu vorzunehmen.<br /><br />Legen Sie fest, welche Anmeldeverfahren (Plugins) verwendet werden sollen. <string>Ein</string> Plugin kann als <em>interaktives</em> Plugin vordefiniert werden.<br /><br />Um die interaktive Anmeldung (Einschreibung in den Kurs durch die Teilnehmer/innen) abzuschalten, setzen Sie \"Einschreiben in den Kurs ist möglich\" im jeweiligen Kurs auf \"Nein\".</p>';
...
$string['configmessaging'] = 'Soll das Messaging-System systemweit für alle aktiviert werden?';
...
$string['configpathtoclam'] = 'Pfad für Clam-AV, meistens /usr/bin/clamscan oder user/bin/clamdscan. Die Einstellung ist erforderlich, damit Clam-AV starten kann.';
...
$string['upgradesure'] = 'Die Moodle-Dateien wurden verändert. Ihre Moodle-Installation wird auf die Version <strong>$a</strong> aktualisiert.
