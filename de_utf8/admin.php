<?PHP // $Id$ 
      // admin.php - created with Moodle 2.0 dev (Build: 20080720) (2008070701)
...
$string['configforceloginforprofiles'] = 'Wenn diese Einstellung aktiviert ist, muss man sich erst wirklich anmelden (kein Gast), um die Nutzerprofile einsehen zu können. Die Grundeinstellung \"Ja\" schützt die Nutzerprofile vor externen Zugriffen (speziell auch vor Suchmaschinen).';
...
$string['forcelogin'] = 'Nutzeranmeldung notwendig';
$string['forceloginforprofiles'] = 'Nutzeranmeldung notwendig, um Profile sehen zu können';
...
$string['iplookupnetgeonote'] = 'Momentan wird der NetGeo-Server zur Anzeige der geografischen Informationen genutzt. Um zuverlässigere Ergebnisse zu erhalten, wird die Installation einer lokalen Kopie der GeoLite-Datenbank von MaxMind empfohlen.';
