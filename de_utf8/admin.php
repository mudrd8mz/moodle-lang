...
$string['configallowoverride'] = 'Die Rollen auf der linken Seite können die Rollen in jeder Spalte überschreiben.';
$string['configallowunenroll'] = 'Wenn Sie \'Ja\' wählen, haben Teilnehmer/innen die Möglichkeit, sich jederzeit selbst aus ihren Kursen auszutragen; andernfalls liegt das allein in der Hand der Trainer/innen oder Administrator/innen.';
$string['configallowuserblockhiding'] = 'Wollen Sie zulassen, dass Nutzer/innen selbst Blöcke ein-/ausblenden können. Das Feature verwendet Javascript und Cookies, um den Status zu speichern. Die Einstellung bezieht sich nur auf die Ansicht der Nutzer/innen.';
...
$string['configallowuserthemes'] = 'Die Einstellung erlaubt den Nutzern/Nutzerinnen, ein Design auszuwählen. Damit wird das Design der Installation überschrieben, aber nicht die kursspezifische Design-Vorgabe.';
...
$string['configbloglevel'] = 'Die Einstellung erlaubt den Grad der Öffentlichkeit für Blog-Einträge zu beschränken. Beachten Sie: Die Einstellung legt den Wert für die Leser/innen fest, nicht aber den Beitragsschreiber oder den Blogtyp. Sie können auf Wunsch Blogs auch vollständig deaktivieren.';
...
$string['configlang'] = 'Wählen Sie die Standardsprache für die gesamte Website. Die Benutzer können diese später überschreiben.';
...
$string['configlanglist'] = 'Lassen Sie dieses Feld leer, um jedem/r Nutzer/in zu erlauben, eine der installierten Sprachen auszuwählen. Sie können das Sprachmenü verkürzen, indem Sie eine durch Kommas getrennte Liste der Spachcodes angeben, z.B. de,en,es_es,fr,it.';
...
$string['configproxyport'] = 'Falls dieser Server notwendigerweise einen Proxyserver benutzt, geben Sie hier bitte den Proxyport an.';
...
$string['helpadminseesall'] = 'Sollen Admins alle  Kalendereinträge sehen oder nur die sie betreffenden?';
...
$string['mediapluginswfnote'] = 'Als Standard-Sicherheitseinstellung gilt, dass Teilnehmer/innen keine .swf Flashdateien einbetten dürfen.';
...
$string['noreplyaddress'] = 'Nicht-Antworten';
...
$string['sitemaintenancewarning'] = 'Die Website befindet sich zur Zeit im Wartungsmodus. Nur Admins können sie nutzen und sich einloggen. Um in den Normalmodus zurückzukehren, klicken Sie auf <a href=\"maintenance.php\">Wartungsmodus abschalten</a>.';
