...
$string['allowremovepages'] = 'Erlaube \"Seiten löschen\"';
$string['allowrevertchanges'] = 'Erlaube \"Änderungen zurücknehmen\"';
$string['allowsetpage'] = 'Erlaube \"Seiten markieren\"';
$string['allowstrippages'] = 'Erlaube \"Seiten aufteilen\" ???';
...
$string['filtername'] = 'Automatische Wiki-Seitenverlinkung';
$string['flagbin'] = 'BIN';
$string['flaghtm'] = 'HTM';
$string['flagoff'] = 'OFF';
$string['flagro'] = 'RO';
...
$string['lockcancelled'] = 'Ihre Seitenblockierung wurde übergangen und jemand anderes hat jetzt gerade diese Seite in Bearbeitung. Wenn Sie Ihre Änderungen behalten möchten, markieren und kopieren Sie die geänderten Teile, bevor Sie auf \"Abbrechen\" klicken. Danach probieren Sie Ihre Bearbeitung noch einmal.';
...
$string['pagelocked'] = '<p><strong>Diese Seite wird gerade von $a->name bearbeitet.</strong> Die Bearbeitung begann $a->since und das Fenster ist immernoch geöffnet ($a->seen).</p><p>Sie sollten auf die Fertigstellung warten und erst danach Ihre Änderungen beginnen.</p>';
...
$string['pagesstripped'] = 'Seiten aufgeteilt';
...
$string['strippagecheck'] = 'Sind Sie sicher, dass Sie ältere Versionen dieser Seite teilen möchen?';
$string['strippages'] = 'Seiten teilen (?? oder lösen?? oder leeren??)';
$string['studentadminoptions'] = 'Teilnehmereinstellungen';
