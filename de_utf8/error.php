...
$string['wscouldnotcreateecoursenopermission'] = 'WS - Kurs nicht erstellt -keine Berechtigung';
...
$string['cannotsaveconfig'] = 'Problem beim Speichern der Konfiguration \"$a->name\" als \"$->value\" für das Plugin \"$a->plugin\"'; // ORPHANED
