<?PHP // $Id$ 
      // error.php - created with Moodle 2.0 dev (Build: 20080720) (2008070701)
...
$string['blocknameconflict'] = 'Namenskonflikt: Block $a[0] hat den gleichen Titel wie ein existierender Block $a[1]!';
...
$string['cannotassignanthing'] = 'Auf moodle/site:irgendetwas kann nicht zugegriffen werden';
$string['cannotassignrole'] = 'Die Rolle kann im Kurs nicht zugewiesen werden';
$string['cannotassignselfasparent'] = 'Kann nicht sich selbst als übergeodnete Ebene zugewiesen werden.';
...
$string['cannotcreatecategory'] = 'Der Kursbereich wurde nicht eingefügt';
...
$string['cannotunassigncap'] = 'Abgelehnte Berechtigung $a[0] für Rolle $a[1] konnte nicht ausgetragen werden.';
...
$string['cannotupdatemodcap'] = '$a Berechtigungen konnten nicht upgedatet werden.';
...
$string['nocategorydelete'] = 'Der Kursbereich \"$a\" kann nicht gelöscht werden!';
...
$string['nopermissiontomkdir'] = 'Ein Verzeichnis kann nicht angelegt werden. Der Server-Administrator muss die Datei-Zugriffsrechte korrigieren.';
