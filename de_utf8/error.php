...
$string['cannotsaveconfig'] = 'Problem beim Speichern der Konfiguration \"$a->name\" als \"$->value\" für das Plugin \"$a->plugin\"';
...
$string['unknowncontext'] = 'Dies ist ein unbekannter Kontext.';
