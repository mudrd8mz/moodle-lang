...
$string['addaquestionpagehere'] = 'Fragenseite hier einfügen';
...
$string['attemptsdeleted'] = 'Versuche löschen';
$string['attemptsremaining'] = 'Sie haben noch $a weitere(n) Versuch(e)';
...
$string['completethefollowingconditions'] = 'Sie müssen die folgende(n) Bedingung(en) in der Lektion <b>$a</b> erst erfüllen, um fortfahren zu dürfen.';
...
$string['displaydefaultfeedback'] = 'Standardfeedback zeigen';
...
$string['essay'] = 'Text';
$string['essayemailmessage'] = '<p>Texthinweis: <blockquote>$a->question</blockquote></p>
<p>Ihre Antwort: <blockquote><em>$a->response</em></blockquote></p>
<p>$a->Trainerkommentar: <blockquote><em>$a->comment</em></blockquote></p>
<p>Sie haben $a->earned von $a->outof für diese Textfrage erreicht.</p>
<p>Ihre Bewertung für diese Lektion wurde geändert auf $a->newgrade%%.</p>';
...
$string['highscores'] = 'Höchste Punktzahlen';
...
$string['jumpsto'] = 'Sprünge zu <em>$a</em>';
...
$string['lesson:edit'] = 'Aktivität der Lektion bearbeiten';
$string['lesson:manage'] = 'Aktivität der Lektion verwalten';
...
$string['lessonmenu'] = 'Lektionenmenü';
...
$string['manualgrading'] = 'Texte bewerten';
...
$string['missingname'] = 'Bitte geben Sie einen Namen ein';
...
$string['nobranchtablefound'] = 'Keine Verzweigungstabelle gefunden';
$string['nocommentyet'] = 'Bisher keine Anmerkung';
$string['nocoursemods'] = 'Keine Aktivitäten gefunden';
$string['nocredit'] = 'Kein Guthaben';
$string['noessayquestionsfound'] = 'Es wurden keineTextfragen in dieser Lektion gefunden';
$string['nohighscores'] = 'Keine Höchstbewertungen';
$string['nolessonattempts'] = 'In dieser Lektion wurden noch keine Versuche durchgeführt';
...
$string['noonehasanswered'] = 'Bisher hat noch niemand Textfragen bearbeitet.';
...
$string['numberofpagesviewed'] = 'Anzahl der beantworteten Fragen: $a';
$string['numberofpagesviewednotice'] = 'Anzahl der beantworteten Fragen: $a->nquestions (Sie sollten mindestens $a->minquestions haben)';
...
$string['pleasecheckoneanswer'] = 'Antwort überprüfen';
$string['pleasecheckoneormoreanswers'] = 'Antwort(en) überprüfen';
...
$string['rank'] = 'Rang';
$string['rawgrade'] = 'Rohbewertung';
$string['receivedcredit'] = 'Erhaltenes Guthaben';
...
$string['unsupportedqtype'] = 'Der Fragentyp ($a) wird nicht unterstützt!';
...
$string['viewreports'] = '$a->attempts vollständige aus $a->student Versuchen anzeigen';
