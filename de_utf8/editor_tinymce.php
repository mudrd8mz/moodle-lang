...
$string['advanced:cleanup_desc'] = 'Quellcode aufräumen';
...
$string['advanced:justifycenter_desc'] = 'Mittig ausgerichtet';
$string['advanced:justifyfull_desc'] = 'Blocksatz';
$string['advanced:justifyleft_desc'] = 'Links ausgerichtet';
$string['advanced:justifyright_desc'] = 'Rechts ausgerichtet';
...
$string['advanced:newdocument'] = 'Wollen Sie wirklich den ganzen Inhalt löschen?';
...
$string['advanced:pre'] = 'Rohdaten';
$string['advanced:redo_desc'] = 'Wiederholen (Strg+Y)';
$string['advanced:removeformat_desc'] = 'Formatierungen zurücksetzen';
...
$string['advanced_dlg:about_author'] = 'Urheber';
...
$string['advanced_dlg:link_is_email'] = 'Diese Adresse scheint eine E-Mail-Adresse zu sein. M\\u00F6chten Sie das dazu ben\\u00F6tigte mailto: voranstellen?';
$string['advanced_dlg:link_is_external'] = 'Diese Adresse scheint ein externer Link zu sein. M\\u00F6chten Sie das dazu ben\\u00F6tigte http:// voranstellen?';
...
$string['advimage_dlg:missing_alt'] = 'Wollen Sie wirklich keine Beschreibung eingeben? Bestimmte Benutzer mit körperlichen Einschränkungen können so nicht darauf zugreifen, ebenso solche, die einen Textbrowser benutzen oder die Anzeige von Bildern deaktiviert haben.';
$string['advimage_dlg:mouseout'] = 'bei keinem Mauskontakt';
...
$string['advlink_dlg:general_props'] = 'Allemeine Eigenschaften';
...
$string['advlink_dlg:target_top'] = 'Im obersten Frame öffnen (sprengt das Frameset)';
$string['advlink_dlg:title'] = 'Link einfügen/bearbeiten';
$string['advlink_dlg:titlefield'] = 'Titel';
$string['advlink_dlg:url'] = 'Adresse';
$string['autosave:unload_msg'] = 'Ihre Änderungen werden verloren gehen, wenn Sie die Seite verlassen.';
...
$string['common:clipboard_msg'] = 'Kopieren, Ausschneiden und Einfügen sind im Mozilla Firefox nicht möglich.\\nMöchten Sie mehr über dieses Problem erfahren?';
...
$string['common:edit_confirm'] = 'Wollen Sie diesen Textbereich mit WYSIWYG bearbeiten?';
...
$string['common:popup_blocked'] = 'Leider hat Ihr Popup-Blocker ein Fenster unterbunden, das für den Betrieb dieses Programms nötig ist. Bitte deaktivieren Sie den Popup-Blocker f\\u00FCr diese Seite.';
...
$string['contextmenu:left'] = 'Linksb\\u00FCndig';
$string['contextmenu:right'] = 'Rechtsb\\u00FCndig';
...
$string['fullpage_dlg:meta_element'] = 'Meta_Element';
...
$string['iespell:download'] = 'ieSpell konnte nicht gefunden werden. Wollen Sie es installieren?';
...
$string['media_dlg:stretchtofit'] = 'Anzeigefläche an verfügbaren Platz anpassen';
...
$string['paste:paste_text_desc'] = 'Als normalen Text einfügen';
$string['paste:paste_word_desc'] = 'Mit Formatierungen (aus Word) einfügen';
...
$string['simple:cleanup_desc'] = 'Quellcode säubern';
...
$string['table_dlg:missing_scope'] = 'Wollen Sie wirklich keine Beziehung f\\u00FCr diese \\u00DCberschrift angeben? Benutzer mit k\\u00F6rperlichen Einschr\\u00E4nkungen k\\u00F6nnten Schwierigkeiten haben, den Inhalt der Tabelle zu verstehen.';
...
$string['template:desc'] = 'Vorgefertigter Vorlageninhalt einfügen';
...
$string['template_dlg:desc'] = 'Vorgefertigter Vorlageninhalt einfügen';
...
$string['template_dlg:warning'] = 'Warnung: Eine Vorlage mit einer anderen zu aktualisieren kann einen Datenverlust herbeiführen!';
...
$string['advanced_dlg:image_title'] = 'Bild einfügen/verändern';
...
$string['advimage:image_desc'] = 'Bild einfügen/verändern';
...
$string['advlink_dlg:target_top'] = 'Im obersten Frame öffnen (dies ersetzt alle Frames)';
...
$string['media_dlg:captioningid'] = 'Captioning ID';
$string['media_dlg:id'] = 'ID';
$string['media_dlg:qt_stream_warn'] = 'In den Erweiterten Einstellungen sollten im Feld \'QT Src\' gestreamte rtsp Resourcen hinzugefügt werden.<br />Zusätzlich sollten Sie aber dort auch eine nicht-gestreamte Resource angeben.';
$string['media_dlg:scriptcallbacks'] = 'Script Callbacks';
...
$string['paste:paste_word_desc'] = 'Mit Word-Formatierungen einfügen';
...
$string['table:merge_cells_desc'] = 'Zellen vereinen';
$string['table:split_cells_desc'] = 'Vereinte Zellen trennen';
