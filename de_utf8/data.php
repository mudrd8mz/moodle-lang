...
$string['data:manageuserpresets'] = 'Voreinstellungen für alle Vorlagen verwalten';
$string['data:rate'] = 'Einträge bewerten';
$string['data:readentry'] = 'Einträge lesen';
$string['data:viewalluserpresets'] = 'Voreinstellungen für alle Nutzer/innen sehen';
...
$string['deletewarning'] = 'Sind Sie sicher, dass Sie die Voreinstellung löschen möchten?';
...
$string['fieldmappings'] = 'Feldubersicht';
...
$string['headerjstemplate'] = 'Definiert allgemeines JavaScript für andere Vorlagen';
...
$string['importsuccess'] = 'Die Voreinstellung wurde erfolgreich übernommen.';
...
$string['latlongkmllabelling'] = 'Wie werden Ziele in KML-Dateien markiert? (Google Earth)';
$string['latlonglinkservicesdisplayed'] = 'Link-out Dienste zum Anzeigen';
...
$string['namelatlong'] = 'Feld für die geografische Breite und Länge';
...
$string['picture'] = 'Bild';
$string['pleaseaddsome'] = 'Bitte tragen Sie etwas ein oder <a href=\"$a\">wählen Sie eine Voreinstellung</a>, um zu beginnen';
$string['presetinfo'] = 'Das Sichern als Voreinstellung wird diese Vorlage veröffentlichen. Andere Nutzer/innen werden diese Vorlage in ihrer Datenbank anwenden können.';
...
$string['saveaspreset'] = 'Als Voreinstellung speichern';
$string['savesettings'] = 'Einstellungen speichern';
$string['savesuccess'] = 'Erfolgreich gespeichert. Ihre Voreinstellung wird ab sofort überall auf der Website nutzbar sein.';
...
$string['url'] = 'URL';
$string['usestandard'] = 'Voreinstellung benutzen';
