...
$string['addgradeletter'] = 'Buchstabenbewertung hinzufügen';
...
$string['aggregateonlygradedhelp'] = 'Nicht vergebene Bewertungen können entweder als Mindestnote in die Berechnung einbezogen werden oder ausgelassen werden.';
...
$string['aggregatesubcatshelp'] = 'Die Zusammenfassung wird üblicherweise nur mit den Noten der gleichen Kategorie vorgenommen.  Es ist jedoch auch möglich, die Bewertugen der Unterkategorien einzubeziehen. Die dort erstellten Zwischenbewertungen werden dann ausgelassen.';
...
$string['aggregationcoefweighthelp'] = 'Gewichting für diese Bewertung, die bei der Berechnung einer Gesamtnote mit anderen Bewertungen verwandt wird.';
...
$string['configgradeexportdisplaytype'] = 'Bewertungen können als Note, Prozentwert (in Relation zur niedrigsten/höchsten Note) oder als Buchstabenwert (A,B,C) beim Export gesetzt werden. Beim Export erfolgt dann  ein Überschreiben der vorliegenden Werte.';
...
$string['configgradepublishing'] = 'Aktiviert die Export und Importfunktion: Exportierte Bewertungen können für andere verlinkt werden, ohne dass sie sich im Moodle-System einloggen müssen.  Bewertungen könen auf die gleiche Art und Weise importiert werden. Damit können Bewertungen, die aus anderen Systemen stammen integriert werden.  Normalerweise können nur Admins diese Funktion nutzen. Falls dieses Recht weitergegeben wird, sind die entsprechenden Personen daruaf hinzuweisen, dass mit der entsprechenden Sorgfalt mit diesen persönlichen Daten umgegangen wird.';
...
$string['editcalculationverbose'] = 'Berechnung bearbeiten $a->category$a->itemmodule $a->itemname';
...
$string['editverbose'] = 'Bearbeite $a->category$a->itemmodule $a->itemname';
...
$string['gradecategorysettings'] = 'Bewertungskategorien';
$string['gradedisplay'] = 'Bewertungsanzeige';
$string['gradedisplaytype'] = 'Typ Bewertungsanzeige';
...
$string['hideverbose'] = 'Verberge $a->category$a->itemmodule $a->itemname';
...
$string['lockverbose'] = 'Sperren $a->category$a->itemmodule $a->itemname';
...
$string['missingscale'] = 'Eine Skala ausgewählten';
$string['mode'] = 'Modus';
...
$string['myreportpreferences'] = 'Meine Präferenzen für Berichte';
...
$string['unlockverbose'] = 'Entsperren $a->category$a->itemmodule $a->itemname';
$string['unused'] = 'Unbenutzt';
$string['updatedgradesonly'] = 'Nur neue oder aktualisierte Bewrtungen exportieren';
