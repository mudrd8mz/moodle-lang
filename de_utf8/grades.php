...
$string['configaveragesdecimalpoints'] = 'Anzahl der Nachkommastellen für die Anzeige der Durchschnittswerte unter den Bewertungsspalten (gesamt oder für die jeweilige Gruppe). Die Einstellung kann jeweils im Bewertungselement geändert werden.';
...
$string['editoutcomes'] = 'Resultate bearbeiten';
$string['edittree'] = 'Kategorien';
$string['enableajax'] = 'AJAX aktivieren';
$string['enableoutcomes'] = 'Resultate aktivieren';
...
$string['outcomename'] = 'Name des Resultats';
$string['outcomereport'] = 'Übersicht über die Resultate';
$string['outcomes'] = 'Resultate';
...
$string['usedgradeitem'] = 'Benutzte Bewertungselemente';
