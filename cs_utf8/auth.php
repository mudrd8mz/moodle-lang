...
$string['auth_cas_create_user'] = 'Zapněte tuto volbu, chcete-li vkládat uživatele ověřované pomocí CAS do vaší databáze uživatelů Moodlu. V opačném případě se budou moci přihlásit pouze uživatelé, kteří již mají záznam v databázi Moodlu.';
$string['auth_cas_enabled'] = 'Zapněte tuto volbu, chcete-li používat CAS ověřování.';
...
$string['auth_ldap_graceattr_desc'] = 'Volitelné: Přenastavuje atribut \'gracelogin\'';
...
$string['chooseauthmethod'] = 'Metoda ověřování';
