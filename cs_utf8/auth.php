...
$string['auth_imapnotinstalled'] = 'Nelze použít metodu IMAP. PHP rozšíření IMAP není nainstalováno.';
...
$string['auth_manualtitle'] = 'Ručně vytvářené účty';
...
$string['auth_mnetdescription'] = 'Uživatelé jsou ověřováni napříč různými servery zapojenými do tzv. sítě partnerských serverů nebo sítě důvěry. Tato síť se definuje v nastavení MNet';
...
$string['auth_nologintitle'] = 'Zákaz přihlášení';
...
$string['auth_nonetitle'] = 'Registrace bez ověření';
...
$string['auth_radiustitle'] = 'RADIUS';
