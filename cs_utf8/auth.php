...
$string['auth_cas_invalidcaslogin'telské jméno s právy číst externí databázi';
...
$string['auth_fcpasswd'] = 'Heslo pro účet uvedený h_fieldlock'] = 'Uzamknout hodnotu';
...
$string['auth_ldap_create_context'] = 'Povolíte-li vytváření uživatelů (po ověření e-mailem), určete kontext, ve kterém budou noví uživatelé vytvářeni. Tento kontext nné auth_ldap_contexts, Moodle automaticky hledá uživatele i v tomto kontextu.';
...
$string['auth_ldap_opt_deref'] = 'U\" (LDAP_DEREF_ALWAYS)';
...
$string['auth_pop3port'] = 'Číslo portu serveru POP3 (r používá zabezpečení pomocí certifikátů, zvolte pop3cert.';
...
$string['authinstructions'] = 'Zde můžete zadat instrukce pro uživatele s vycháte-li toto pole prázdné, nebudou zobrazeny žádné instrukce.';
...
$string['shispozici. Jedná se o následující údaje: $a<br />Obraťte se na administrátora těchto stránek nebo na vašeho poskytovatele identity.';
