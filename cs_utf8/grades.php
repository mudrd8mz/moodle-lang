...
$string['configgradedisplaytype'] = 'Určuje, jak budou zobrazeny známky v celkovém přehledu hodnocení a v přehledu hodnocení jednoho uživatele. Známky mohou být zobrazeny jako skutečně udělené známky (body), jako procenta (ve vztahu k nejmenší a největší možné hodnotě) nebo jako slovní známka.';
$string['configgradeexportdisplaytype'] = 'Během exportu mohou být známky zobrazeny jako skutečně získané známky (skutečná hodnota), jako procenta (relativně vůči nejmenší a největší možné) nebo jako slovní známky (např. písmena či slova). Toto nastavení lze pro každý export ještě měnit.';
...
$string['grademin'] = 'Nejmenší možná známka';
...
$string['incorrectminmax'] = 'Nejmenší musí být nižší než největší';
...
$string['lessthanmin'] = 'Známka z položky hodnocení \"$a->itemname\" u uživatele $a->username je menší než nejmenší povolená.';
...
$string['overridesitedefaultgradedisplaytype'] = 'Přenastavit výchozí hodnoty na serveru';
...
$string['synclegacygrades'] = 'Načíst známky z modulů';
