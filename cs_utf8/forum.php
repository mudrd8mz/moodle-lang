...
$string['configlogblocked'] = 'Služba cron může ve fóru do protokolu zaznamenávat pokusy o odeslání emailu uživatelům se zakázaným emailem.';
...
$string['unsubscribealldone'] = 'Všechna odebírání z diskusních fór byla odstraněna. Stále ještě můžete dostávat emaily s příspěvky z diskusních fór, u nichž je odebírání vynuceno. Tomu lze zabránit pouze tak, že ve vašem uživatelském profilu zakážete vaši emailovou adresu (pozor - v takovém případě vám Moodle nebude moci poslat žádný email, i kdyby byl vyžádaný).';
$string['unsubscribeallempty'] = 'Je nám líto, ale nemáte nastaveno žádné odebírání příspěvků z diskusních fór. Přesto můžete dostávat emaily z těch fór, u nichž je odebírání vynuceno. Tomu lze zabránit pouze tak, že ve vašem uživatelském profilu zakážete vaši emailovou adresu (pozor - v takovém případě vám Moodle nebude moci poslat žádný email, i kdyby byl vyžádaný).';
