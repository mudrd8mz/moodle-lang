...
$string['cannotviewpostyet'] = 'Nemůžete si prohlédnout otázky jiných studentů, protože jste ještě ';
...
$string['configenablerssfeeds'] = 'Tímto povolíte funkci RSS kanálů pro všechna diskusní fóra. Budete ještě muset zapnout RSS kanály v nastavení jednotlivých fór.';
...
$string['configreplytouser'] = 'Když je příspěvek odesílán odběratelům, má e-mail v poli \'Od:\' obsahovat adresu autora příspěvku? Příjemce tak může odpovídat přímo autorovi e-mailem, a ne prostřednictvím diskusního fóra. I když je zde zvolena hodnota \'Ano\', uživatelé si mohou ve svých profilech nastavit skrývání svém e-mailové adresy.';
...
$string['forumblockingalmosttoomanyposts'] = 'Blížíte se limitu vložených příspěvků. Za poslední $a->blockperiod jste do fóra vložili $a->numposts příspěvků, limit je přitom $a->blockafter.';
...
$string['noguesttracking'] = 'Bophužel, hosté si nemohou zapnout označování nepřečtených příspěvků';
...
$string['subscribeall'] = 'Nastavit všem odebírání příspěvku e-mailem';
$string['subscribed'] = 'Příspěvky odebírány e-mailem';
$string['subscribenone'] = 'Odebrat všem odebírání příspěvků e-mailem';
