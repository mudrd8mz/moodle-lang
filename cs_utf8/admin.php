...
$string['configauthenticationplugins'] = 'Zvolte způsoby ověřování uživatelů a pořadí, v jakém budou použity. Pokud se uživatelé registrují sami, bude použit způsob uvedený v poli Registrace uživatelů (většinou se používá ověření na základě emailu).';
...
$string['configcronremotepassword'] = 'Zde můžete nastavit heslo, které je pak potřeba při volání skriptu cron.php přes webové rozhraní předávat jako parametr podle vzoru: <pre>
...
$string['configenablerecordcache'] = 'Při hodnotě větší než 0 bude část informací z databáze ukládána v mezipaměti (cache). Tím může dojít k lepší propustnosti dat, ale na druhou stranu mírně vzrostou požadavky na paměť webového serveru. Obecně se doporučuje nastavit hodnotu kolem 50, pokud nemá webový server málo paměti. Některé procesy si pro sebe mohou tuto hodnotu změnit, pakliže si byl jejich vývojář jistý navýšením výkonu.';
...
$string['coursemanager'] = 'Správci kurzů';
...
$string['cronremotepassword'] = 'Heslo pro spuštění cron';
...
$string['sitepolicies'] = 'Pravdila provozu stránek';
