<?PHP // $Id$ 
      // survey.php - created with Moodle 1.9.2 (Build: 20080715) (2007101520)
...
$string['alreadysubmitted'] = 'V tomto průzkumu jste již odpovídali';
...
$string['attls11'] = 'Snažím se přemýšlet v souladu s dalšími lidmi, ne proti nim.';
...
$string['attls14'] = 'Poukazuji na slabá místa v myšlení jiných a snažím se jim tak pomoci, aby si sami ujasnili své argumenty.';
...
$string['attls16'] = 'Můj způsob analyzování věcí je podobný soudnímu přelíčení, protože pečlivě zvažuji všechny důkazy.';
...
$string['attls2'] = 'Rád si hraju na ďáblova advokáta &ndash; tvrdím opak toho, co říká ten druhý.';
...
$string['attls7'] = 'Zjišťuji, že svou vlastní pozici si můžu upevnit tím, že diskutuji s někým, kdo se mnou nesouhlasí.';
...
$string['attls9'] = 'Často se přistihnu, jak se dohaduji s autory knih, které čtu, a logicky vysvětluji, proč se mýlí.';
$string['attls9short'] = 'dohadování se s autory';
$string['attlsintro'] = 'Cílem tohoto dotazníku je pomoci nám vyhodnotit vaše postoje k myšlení a učení se.<p>Nejsou zde žádné \'správné\' nebo \'špatné\' odpovědi, zajímá nás pouze váš názor. Prosím, buďte si jistí, že s vašimi odpověďmi budeme nakládat důvěrně a žádným způsobem neovlivní vaše hodnocení.';
$string['attlsm1'] = 'Postoje k myšlení a učení se (ATTL)';
$string['attlsm2'] = 'Kolektivní učení se';
$string['attlsm3'] = 'Individuální učení se';
...
$string['ciq2short'] = 'Nejvíc nepříjemný';
...
$string['clicktocontinuecheck'] = 'Stiskněte pro odevzdání';
$string['colles1'] = 'se při učení zaměřuji na témata, která mě zajímají';
...
$string['customintro'] = 'Úvodní text';
$string['deleteallanswers'] = 'Smazat všechny odpovědi';
$string['deleteanalysis'] = 'Smazat poznámky k odpovědím';
$string['done'] = 'Hotovo';
...
$string['nobodyyet'] = 'Tohoto průzkumu se zatím nikdo nezúčastnil';
...
$string['peoplecompleted'] = 'Tohoto průzkumu se zatím zúčastnilo $a uživatelů';
...
$string['survey:download'] = 'Stáhnout odpovědi';
$string['survey:participate'] = 'Odpovídat v průzkumu';
$string['survey:readresponses'] = 'Vidět odpovědi';
