...
$string['authmnetautoadddisabled'] = '<em>Automatické přidávání uživatelů</em> v autentizačním modulu MNet <strong>není povoleno</strong>.';
...
$string['deleteuserrecord'] = 'SSO ACL: odstranit záznam uživatele  \'$a[0]\' z $a[1].';
...
$string['enrolcourseenrol_desc'] = 'Zapisovat do a vyškrtávat uživatele z tohoto kurzu použitím vzdáleného serveru v síti MNet. Všimněte si, že uživatelé mohou být do kurzu zapsáni pomocí jiné metody zápisu, pokud jim ji povolují vzdálení hostitelé. Takové zápisy jsou v seznamu označeny jako <em>Jinak zapsaní uživatelé</em>';
$string['enrolcourses_desc'] = 'Kurzy nabízené ke vzdálenému zapisování tímto hostitelem';
$string['enrollingincourse'] = 'Zápis do kurzu $a[0] na hostiteli $a[1]<br />';
...
$string['illegalchar-moodlehome'] = 'Umístění vaší instalace Moodle obsahuje nepovolené znaky';
...
$string['is_in_range'] = 'IP adresa &nbsp;<code>$a</code>&nbsp; odpovídá důveryhodnému hostiteli.';
...
$string['loginlinkmnetuser'] = '<br/>Pokud jste registrováni na některém ze partnerských serverů sítě MNet a můžete  <a href=\"$a\">zde potvrdit vaši emailovou adresu</a>, budete přesměrováni na přihlašovací formulář na vašem domovském serveru.<br />';
...
$string['not_in_range'] = 'IP adresa &nbsp;<code>$a</code>&nbsp; neodpovídá žádnému důveryhodnému hostiteli.';
$string['notpermittedtojump'] = 'Nemáte oprávnění zahájit vzdálenou relaci z tohoto Moodle Hub serveru.';
...
$string['registerallhosts'] = 'Automaticky registrovat všechny hostitele(<em>Moodle Hub režim</em>)';
...
$string['remoteenrolhosts_desc'] = 'Zapisovat a vyškrtávat vaše uživatele v kurzech na partnerských Moodle serverech, které vám to umožňují pomocí modulu \"Zápis přes MNet\".';
$string['remotehost'] = 'Vzdálený Hub';
$string['remotehosts'] = 'Vzdálení hostitelé';
$string['remotemoodles'] = 'Vzdálené servery';
