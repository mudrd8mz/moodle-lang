...
$string['emailteachermail'] = '$a->username upravil(a) sve vypracovani ukolu \'$a->assignment\'.

Aktualizovane reseni je dostupne na:
$a->url.';
$string['emailteachermailhtml'] = '$a->username upravil(a) své vypracování úkolu <em>\'$a->assignment\'</em>.<br /><br />
...
$string['responsefiles'] = 'Připojit k hodnocení soubor';
...
$string['submitedformarking'] = 'Řešení bylo již odevzdáno k oznámkování a nemůže být nadále upravováno';
