<?PHP // $Id$ 
      // lesson.php - created with Moodle 1.9.2+ (Build: 20080720) (2007101520)
...
$string['outoftime'] = 'Čas vypršel'; // ORPHANED
$string['studentoutoftime'] = 'Upozornění: Překročili jste čas určený pro tuto přednášku. Vaše poslední odpověď se nepočítá, protože byla odeslána až po vypršení časového limitu. Stiskněte prosím tlačítko \'Pokračovat\' k ukončení přednášky.'; // ORPHANED
