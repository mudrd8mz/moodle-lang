...
$string['clicktopost'] = 'Klikněte sem, chcete-li odeslat svou známku do žebříčku nejvyšších skóre';
...
$string['emailallgradedessays'] = 'Poslat VŠECHNY<br />oznámkované kompozice';
$string['emailgradedessays'] = 'Poslat oznámkované kompozice';
...
$string['firstwrong'] = 'Bohužel, vaše odpověď nebyla zcela správná, takže nezískáváte žádné body. Chcete se ještě pokusit odhadnout správnou odpověď aspoň sami pro sebe (bez bodového zisku)?';
...
$string['studentoutoftime'] = 'Upozornění: Překročili jste čas určený pro tuto přednášku. Vaše poslední odpověď se nepočítá, protože byla odeslána až po časovém limitu. Stiskněte prosím tlačítko \'Pokračovat\' k ukončení přednášky.';
