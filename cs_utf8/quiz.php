...
$string['addingessay'] = 'Přidávám úlohu s dlouhou odpovědí';
$string['addingmatch'] = 'Přidávám přiřazování';
$string['addingmultianswer'] = 'Přidávám doplňovací úlohu (Cloze)';
$string['addingmultichoice'] = 'Přidávám úlohu s výběrem odpovědí';
$string['addingnumerical'] = 'Přidávám numerickou úlohu';
...
$string['addingrandom'] = 'Přidávám náhodně vybranou úlohu';
$string['addingrandomsamatch'] = 'Přidávám přiřazování z krátkých odpovědí';
$string['addingshortanswer'] = 'Přidávám úlohu s krátkou odpovědí';
$string['addingtruefalse'] = 'Přidávám úlohu pravda/nepravda';
$string['addmoreoverallfeedbacks'] = 'Přidat další pole komentáře ({no})';
...
$string['cannoteditafterattempts'] = 'Již nelze přidávat nebo odebírat úlohy, někdo se již pokusil o zvládnutí testu.';
...
$string['changessavedwitherrors'] = 'Při ukládání změn ve známkování se objevily chyby.';
...
$string['emailconfirmbody'] = 'Zdravíčko, vy budete asi $a->username, že?

Děkujeme vám za odevzdání vašich odpovědí na test \'$a->quizname\' v kurzu \'$a->coursename\', ke kterému došlo $a->submissiontime.

Tento email potvrzuje, že jsme vaše odpovědi bezpečně obdrželi.
...
$string['emailnotifybody'] = 'Zdravíčko, vy budete asi $a->username, že?
...
$string['numattemptsmade'] = '$a uskutečněných pokusů';
$string['numberabbr'] = 'č.';
...
$string['openclosedatesupdated'] = 'Datumy zpřístupnění a uzavření kurzu byly aktualizovány';
...
$string['quiz:emailconfirmsubmission'] = 'Získávat emailové potvrzení o zdárném odevzdání';
$string['quiz:emailnotifysubmission'] = 'Získávat emailové upozornění na odevzdané úlohy';
...
$string['removeallquizattempts'] = 'Odstranit všechny pokusy';
...
$string['reviewofpreview'] = 'Prohlídka náhledu';
...
$string['summaryofattempts'] = 'Souhrn vašich předchozích pokusů';
...
$string['timelimitmin'] = 'Časový limit (minuty)';
...
$string['xmlimportnoname'] = 'Chybí název úlohy v XML souboru';
$string['xmlimportnoquestion'] = 'Chybí zadání úlohy v XML souboru';
