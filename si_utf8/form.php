...
$string['advancedelement'] = 'උසස් මූලිකාංශය';
$string['day'] = 'දිනය';
...
$string['err_rangelength'] = 'ඔබ මෙහි {$a->format[0]} හා {$a->format[1]} අතර අනුලකුණු ඇතුලත් කල යුතුය';
$string['err_required'] = 'ොබ මෙහි කිසියම් අගයක් සැපයිය යුතුය';
$string['general'] = 'පොදු';
$string['hideadvanced'] = 'උසස් සිටුවම් සඟවන්න';
$string['hour'] = 'පැය';
$string['minute'] = 'මිනිත්තු';
...
$string['othersettings'] = 'වෙනත් සිටුවම්';
...
$string['unmaskpassword'] = 'නිරාවරිත';
$string['year'] = 'වර්ශය';
