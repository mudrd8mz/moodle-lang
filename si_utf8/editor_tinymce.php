...
$string['advanced:h4'] = 'මාතෘකාව 4';
$string['advanced:h5'] = 'මාතෘකාව 5';
$string['advanced:h6'] = 'මාතෘකාව 6';
$string['advanced:help_desc'] = 'උපකාරය';
...
$string['advanced:justifycenter_desc'] = 'මැද පෙළට ගන්නවා';
$string['advanced:justifyfull_desc'] = 'පෙළට ගන්නවා';
$string['advanced:justifyleft_desc'] = 'වම් පෙළට ගන්නවා';
$string['advanced:justifyright_desc'] = 'දකුණු පෙළට ගන්නවා';
$string['advanced:link_delta_height'] = '';
$string['advanced:link_delta_width'] = '';
$string['advanced:link_desc'] = 'සම්බන්ධකය ඇතුළු/සංස්කරණය කරන්න';
$string['advanced:more_colors'] = 'තවත් වර්ණ';
$string['advanced:newdocument'] = 'ඔබට මෙම අන්තර්ගතය මකා දැමීමට අවශ්‍ය ම ද?';
$string['advanced:newdocument_desc'] = 'නව ලේඛනය';
$string['advanced:numlist_desc'] = 'ක්‍රමානුකූල ලැයිස්තුව';
$string['advanced:outdent_desc'] = 'Outdent';
$string['advanced:paragraph'] = '‍ඡේදය';
$string['advanced:paste_desc'] = '';
$string['advanced:path'] = 'මඟ';
$string['advanced:pre'] = 'පූර්ව නිර්මාණය';
$string['advanced:redo_desc'] = 'නැවත කරනවා  (Ctrl+Y)';
$string['advanced:removeformat_desc'] = 'ආකෘතිකරණය ඉවත්කරනවා';
$string['advanced:samp'] = 'කේත සාම්පල';
$string['advanced:striketrough_desc'] = 'Strikethrough';
$string['advanced:style_select'] = 'ශෛලිය';
$string['advanced:sub_desc'] = 'යටිලකුණු';
$string['advanced:sup_desc'] = 'උඩුලකුණ';
...
$string['advanced:undo_desc'] = 'නිශ්ප්‍රභ කරන්න(Ctrl+Z)';
$string['advanced:unlink_desc'] = 'Unlink';
$string['advanced:visualaid_desc'] = 'මාර්ගසූචක/අදෘශ්‍ය මූලිකාංග';
$string['advanced_dlg:about_author'] = 'කතෘ';
$string['advanced_dlg:about_general'] = 'සවිස්තරාත්මකව';
$string['advanced_dlg:about_help'] = 'උපකාරය';
$string['advanced_dlg:about_license'] = 'බලපත්‍රය';
...
$string['advanced_dlg:charmap_title'] = 'භාවිතාවන ගුණාංගය තෝරන්න';
$string['advanced_dlg:code_title'] = 'HTML කේත සංස්කාරකය';
$string['advanced_dlg:code_wordwrap'] = 'වාග් වෙලුම';
$string['advanced_dlg:colorpicker_color'] = 'වර්ණ:';
...
$string['advanced_dlg:image_align_baseline'] = 'මූලිකය';
$string['advanced_dlg:image_align_bottom'] = 'යට';
$string['advanced_dlg:image_align_left'] = 'වමට';
$string['advanced_dlg:image_align_middle'] = 'මැද';
$string['advanced_dlg:image_align_right'] = 'දකුණට';
$string['advanced_dlg:image_align_textbottom'] = 'පාඨය පහළ';
$string['advanced_dlg:image_align_texttop'] = 'පාඨය ඉහළ';
$string['advanced_dlg:image_align_top'] = 'ඉහළ';
$string['advanced_dlg:image_alt'] = 'අනුරූපයෙහි විස්තර';
$string['advanced_dlg:image_border'] = 'බෝඩරය';
$string['advanced_dlg:image_dimensions'] = 'මාන';
$string['advanced_dlg:image_hspace'] = 'තිරස් අවකාශය';
$string['advanced_dlg:image_list'] = 'අනුරූප ලැයිස්තුව';
$string['advanced_dlg:image_src'] = 'අනුරූපයෙහි URL';
$string['advanced_dlg:image_title'] = 'අනුරූපයෙහි ඇතුළු/සංස්කරණය කරන්න';
$string['advanced_dlg:image_vspace'] = 'සිරස් අවකාශය';
$string['advanced_dlg:link_is_email'] = 'ඔබ ඇතුළත් කළ URL ය විද්‍යුත් තැපැල ක් නම් ඔබට එයට ප්‍රවේශ වීමට අවශ්‍ය ද?';
$string['advanced_dlg:link_is_external'] = 'ඔබ ඇතුළත් කළ URL ය බාහිර ඇමිණුමක් නම්,ඔබට එයට ප්‍රවේශ වීමට අවශ්‍ය ද??';
$string['advanced_dlg:link_list'] = 'ඇමුණුම් ලයිස්තුව';
$string['advanced_dlg:link_target'] = 'ඉලක්කය';
$string['advanced_dlg:link_target_blank'] = 'ඇමුනුම වෙනම කවුලුවක විවෘත කරන්න';
$string['advanced_dlg:link_target_same'] = 'ඇමුනුම වෙනම කවුලුවක විවෘත කරන්න';
$string['advanced_dlg:link_title'] = 'ඇමුනුම ඇතුළු/සංස්කරණය කරන්න';
$string['advanced_dlg:link_titlefield'] = 'මාතෘකාව';
$string['advanced_dlg:link_url'] = 'ඇමුනුම URL';
...
$string['common:apply'] = 'යොදන්න';
$string['common:browse'] = 'Browse';
$string['common:cancel'] = 'අවලංගු කරන්න';
$string['common:class_name'] = 'සමූහය';
$string['common:clipboard_msg'] = 'පිටපත් කිරීම/ඉවත් කිරීම/ඇලවීම මොසිල්ලා හා ෆයර් ෆොක්ස් හි ඇතුළත් නොවේ.\\nඔබට මේ පිළිබඳව තචදුරටත් තොරතුරු අවශ්‍ය වේද?';
$string['common:clipboard_no_support'] = 'දැනට ප්‍රදර්ශකය මඟින් මෙම සේවය සපයා නැත,එබැවින් යතුරුපුවරුව භාවිතා කරන්න.';
$string['common:close'] = 'ඉවත්වන්න';
$string['common:edit_confirm'] = 'ඔබට මෙම පාඨයන් සඳහා WYSIWYG ආකාරය?';
$string['common:insert'] = 'ඇතුළත් කරන්න';
...
$string['contextmenu:full'] = 'පූර්ණව';
$string['contextmenu:left'] = 'වමට';
$string['contextmenu:right'] = 'දකුණට';
$string['directionality:ltr_desc'] = 'වමේ සිට දකුණට දිශාව';
$string['directionality:rtl_desc'] = 'දකුණේ සිට වමට දිශාව';
...
$string['iespell:download'] = 'ieSpell අනාවරනය වූයේ නැත. ඔබට එය පිහිටුවීමට අවශ්‍ය ද?';
$string['iespell:iespell_desc'] = 'අක්ෂර වින්‍යාසය පරීකෂා කරන්න';
$string['insertdatetime:date_fmt'] = '%%අවු-%%මාස-%%දින';
$string['insertdatetime:day_long'] = 'ඉරිදා,සඳුදා,අඟහරැවාදා,බදාදා,බ්‍රහස්පතින්දා,සිකුරාදා,සෙනසුරාදා';
$string['insertdatetime:day_short'] = 'ඉරිදා,සඳුදා,අඟ.,බදාදා,බ්‍රහස්.,සිකු.,සෙන.';
$string['insertdatetime:insertdate_desc'] = 'දිනය ඇතුළත් කරන්න';
$string['insertdatetime:inserttime_desc'] = 'වේලාව ඇතුළත් කරන්න';
$string['insertdatetime:months_long'] = 'ජනවාරි,පෙබරවාරි,මාර්තු,අප්‍රේල්,මැයි,ජූනි,ජූලි,අගෝස්තු,සැ්තැම්බර්,ඔක්තෝබර්,‍නොවැම්බර්,දෙසැම්බර්';
$string['insertdatetime:months_short'] = 'ජන.,පෙබ.,මාර්තු,අප්‍රේල්,මැයි,ජූනි,ජූලි,අගෝ.,සැ්.,ඔක්.,‍නොවැ.,දෙසැ.';
$string['insertdatetime:time_fmt'] = '%%පැය:%%මිස:%%තත්';
$string['layer:absolute_desc'] = 'Toggle absolute positioning';
$string['layer:backward_desc'] = 'පසුපසට ගෙනයන්න';
$string['layer:content'] = 'අලුත් ස්ථරයක්...';
$string['layer:forward_desc'] = 'ඉදිරියට ගෙනයන්න';
$string['layer:insertlayer_desc'] = 'අඵත් ස්ථරයක් ඇතුළත් කරන්න';
...
$string['preview:preview_desc'] = 'පූර්ව දර්ශනය';
$string['print:print_desc'] = 'මුද්‍රණය කරනවා';
$string['save:cancel_desc'] = 'අවලංගු කරන්න';
$string['save:save_desc'] = 'සුරකින්න';
...
$string['simple:bullist_desc'] = 'අක්‍රමානුකූල ලැයිස්තුව';
$string['simple:cleanup_desc'] = 'වැරදි කේත ඉවත් කරන්න';
$string['simple:italic_desc'] = 'Italic (Ctrl+I)';
$string['simple:numlist_desc'] = 'ක්‍රමානුකූල ලැයිස්තුව';
$string['simple:redo_desc'] = 'නැවත කරනවා (Ctrl+Y)';
$string['simple:striketrough_desc'] = 'Strikethrough';
$string['simple:underline_desc'] = 'Underline (Ctrl+U)';
$string['simple:undo_desc'] = 'නිශ්ප්‍රභ කරන්න (Ctrl+Z)';
