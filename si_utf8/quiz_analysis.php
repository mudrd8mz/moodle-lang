...
$string['analysistitle'] = 'අයිතමයන් විශ්ලේෂණ වගුව';
$string['attemptsall'] = 'සියලු උත්සාහයන්';
$string['attemptselection'] = 'භාවිතා කරන්නෙකුට උත්සාහයන් වන පරිදි විශ්ලේෂණය';
$string['attemptsfirst'] = 'පළමු උත්සාහය';
$string['attemptshighest'] = 'උපරිම ශ්‍රේණිය';
...
$string['rfractiontitle'] = 'පාර්ශවික<br />සම්මාන';
