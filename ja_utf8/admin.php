...
$string['configdbsessions'] = 'この設定を有効にした場合、現在のセッション情報はデータベースに保存されます。これは特に規模の大きい/アクセス数の多いサイト、またはクラスタサーバに構築されたサイトに向いています。ほとんどのサイトでは、セッションの保存をサーバディスクに行うよう、この設定を「No」のままにしてください。この設定を変更すると、現在のユーザ ( あなたも含めて ) がログアウトされます。';
...
$string['configstatsuserthreshold'] = 'コースランキングのため、ゼロ以外または数値以外の値をここに入力した場合、この値より少ない登録ユーザ ( すべてのロール ) のコースは無視されます。';
...
$string['longtimenosee'] = 'コースからユーザを削除する日数';
$string['mail'] = 'Eメール';
...
$string['mustenablestats'] = 'このサイトでは、統計が使用可能にされていません。';
