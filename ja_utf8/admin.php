...
$string['enableallowedip'] = 'これらのIPアドレスからのクライアントを許可する';
$string['enableallowedipdesc'] = 'このオプションを有効にした場合、「許可されたIPアドレスリスト」のIPアドレスのみアクセスを許可されます。同時に「ブロックIPアドレスリスト」のIPアドレスがブロックされます。';
...
$string['ipinblockedlist'] = '現在、このサイトは利用できません。';
...
$string['ipoutallowedlist'] = '現在、このサイトは利用できません。';
