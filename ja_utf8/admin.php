...
$string['configextrauserselectorfields'] = '例えば、ロールの割り当て、グループの割り当てに関してユーザを選択する場合、フルネームに加えて、どのフィールドを検索および表示するか選択します。セキュリティ上の理由から、ここでユーザ名フィールドを選択するのは賢明でないことに留意してください。';
...
$string['ipwhitelist'] = 'IPホワイトリスト';
$string['ipwhitelistdesc'] = '空白でない場合、ここに設定されたIPアドレスをユーザ名「<strong>$a->username</strong>」に使用することが許可されます。';
