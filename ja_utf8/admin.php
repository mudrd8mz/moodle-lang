...
$string['configintro'] = 'このページではサーバでMoodleが最適に動くための設定値を入力できます。設定値を過度に心配しないでください - 通常、初期値で最適に動作するよう設定されています。いつでもこのページに戻って再度設定することができます。';
...
$string['pgclusterdescription'] = '<pre>コマンドラインのためのPostgreSQLバージョン/クラスタパラメータです。あなたのシステムに1つのPostgreSQLのみある場合、またはこの設定が分からない場合は、空白にしてください。</pre>';
...
$string['stickyblocksduplicatenotice'] = 'ここで特定のページに追加したブロックがすでに存在する場合、重複することになります。<br />固定されたブロックのみ編集不可で、重複したブロックは編集することができます。';
