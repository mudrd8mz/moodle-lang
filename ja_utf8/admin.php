<?PHP // $Id$ 
      // admin.php - created with Moodle 2.0 dev (Build: 20080807) (2008080701)
...
$string['confignonmetacoursesyncroleids'] = '子コースからのすべての受講登録は、デフォルトでメタコースに同期されます。ここで選択されたロールは、同期化処理から除かれます。';
