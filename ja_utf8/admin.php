...
$string['configlocale'] = '全体に適用されるロケールを選択してください。これは日付の書式と言語に影響します。指定した言語が表示されるためには、OSに言語データがインストールされている必要があります。( 例 ja_JP.UTF-8、en_US.UTF-8、es_ES.UTF-8 ) もし分からない場合は、空白のままにしてください。';
