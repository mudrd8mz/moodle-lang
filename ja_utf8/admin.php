...
$string['configbloglevel'] = 'ここでは、どのユーザブログがこのサイトで閲覧可能か、アクセスレベルを制限することができます。ここで設定するのは、閲覧者に関する最大のコンテクストであり、投稿者やブログ投稿のタイプではないことに注意してください。不要な場合、ブログを完全に無効にすることもできます。';
...
$string['hideactivitytypecrumb'] = '活動タイプクラムを非表示にする';
