...
$string['navigationupgrade'] = 'このアップグレードでは、次のブロックに替えて、新しい2つのナビゲーションブロックが導入されます: 管理、コース活動および参加者です。これらのブロックに特別なパーミッションを設定している場合、あなたの希望するとおりに、すべてが動作するかどうか確認してください。<br /><br />また、新しいスタイルを読み込むため、あなたのブラウザを「最新の情報に更新」してください。そうでない場合、新しいブロックは正常に動作しません。';
