<?PHP // $Id$ 
      // admin.php - created with Moodle 1.9 dev (2007060100)
...
$string['configidnumber'] = 'このオプションでは次の内容を設定します。(a)ユーザがユーザIDの入力を求められない、(b)ユーザがユーザIDを空白にすることができる、(c)ユーザはユーザIDの入力を求められ、空白にできない。ユーザIDが入力された場合、プロフィールに表示されます。';
...
$string['configiplookup'] = 'あなたがログ等でIPアドレス (例 34.12.222.93) をクリックした場合、そのIPアドレスがどこから来たものか推量しやすいマップが表示されます。この機能には異なるプラグインがあり、それぞれに利点と不利点があります。';
