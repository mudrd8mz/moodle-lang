...
$string['configallusersaresitestudents'] = 'サイトのフロントページにある活動で、すべてのユーザを学生と考えてもよろしいですか? 答えが「Yes」の場合、承認されたユーザは学生として、これらの活動に参加することができます。答えが「No」の場合、少なくとも1つのコースに登録しているユーザのみがフロントページの活動に参加することができます。';
...
$string['configfilteruploadedfiles'] = '「すべてのファイル」はアップロードしたすべてのHTMLおよびテキストファイル、「HTMLファイルのみ」はアップロードしたHTMLファイルのみ、表示する前にフィルタをかけます。「無し」は全くフィルタをかけません。';
