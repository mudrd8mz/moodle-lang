<?PHP // $Id$ 
      // admin.php - created with Moodle 1.9 dev (2007071501)
...
$string['configauthenticationplugins'] = 'あなたが使用したい認証プラグインを選択して、フェイルスルーの順に並び替えてください。自己登録は「自己登録」カラムで選択されたプラグインにより処理されます (通常、Eメールによる自己登録)。';
