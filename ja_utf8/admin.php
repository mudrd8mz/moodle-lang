...
$string['configintro'] = 'このページではサーバでMoodleが最適に動くための設定値を入力できます。設定値を過度に心配しないでください - 通常、初期値で最適に動作するよう設定されています。いつでもこのページに戻って再度設定を行うことができます。';
...
$string['upgradesure'] = 'Moodleファイルが更新されました。あなたは、自動的にMoodleをこのバージョンにアップグレードしようとしています: <br /><br />
<strong>$a</strong> <br /><br />
一旦、この作業を行うと元に戻すことはできません。<br /><br />
