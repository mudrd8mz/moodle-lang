...
$string['configenablerssfeedsdisabled2'] = 'RSSフィードは、サーバレベルで無効にされています。最初にサーバ/RSSで有効にしてください。';
...
$string['configforceloginforprofiles'] = 'この設定を有効にした場合、ユーザプロファイルページを閲覧するには実際のアカウントでログインする必要があります。この設定はデフォルトで有効 (チェックした状態) にされています。';
...
$string['uploadpicture_invalidfilename'] = 'ピクチャファイル $a のファイル名に無効な文字があります。スキップします。';
$string['uploadpicture_overwrite'] = '既存のユーザピクチャを上書きしますか?';
$string['uploadpicture_userfield'] = 'ピクチャにマッチさせるユーザ属性';
$string['uploadpicture_usernotfound'] = '「 $a->userfield 」の値が「 $a->uservalue 」のユーザは存在しません。スキップします。';
$string['uploadpicture_userskipped'] = 'ユーザ $a をスキップします (写真登録済みです)。';
$string['uploadpicture_userupdated'] = 'ユーザ $a のピクチャが更新されました。';
$string['uploadpictures'] = 'ユーザピクチャのアップロード';
