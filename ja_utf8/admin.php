...
$string['configextrauserselectorfields'] = '例えばロールの割り当て、またはグループへのユーザ割り当て時にユーザを選択する場合、これらのフィールドがユーザ一覧に表示され、検索結果に含まれます。セキュリティの観点から、ここでユーザ名を選択するのは賢明でないことに留意してください。';
...
<li>プロファイルページの表示に関して、「コースIDが定義されていない (これはパブリックビューです)」「ユーザがコースに登録されていない」「この設定が有効にされている」場合、プロファイル詳細を表示しないようにします。</li>
