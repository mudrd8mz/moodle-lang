<?PHP // $Id$ 
      // hotpot.php - created with Moodle 1.7 dev (2006092409)
...
$string['configshowtimes'] = 'リストとレポートで表示するレコード処理に時間をかけますか? これは、なぜあなたのサーバの動作が遅いか調査するためだけに本当に必要な設定です。';
...
$string['reportshowlegend'] = '問題内容の表示';
