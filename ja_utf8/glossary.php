<?PHP // $Id$ 
      // glossary.php - created with Moodle 1.9.16 (Build: 20120109) (2007101591.1)
...
$string['alias'] = 'キーワード'; // ORPHANED
$string['errdeltimeexpired'] = 'あなたはこのエントリを削除できません。編集期限は終了しました!'; // ORPHANED
$string['glossary:exportentry'] = '単一エントリをエクスポートする'; // ORPHANED
$string['glossary:exportownentry'] = 'あなたの単一エントリをエクスポートする'; // ORPHANED
$string['glossaryadministration'] = '用語集管理'; // ORPHANED
$string['guestnoedit'] = 'ゲストは用語集を編集できません。'; // ORPHANED
$string['nopermissiontodelcomment'] = 'あなたは他のユーザのコメントを削除できません!'; // ORPHANED
$string['nopermissiontodelinglossary'] = 'あなたはこの用語集にコメントを追加できません!'; // ORPHANED
$string['nopermissiontoviewresult'] = 'あなたは自分のエントリの結果のみ閲覧できます。'; // ORPHANED
$string['ratingonlywithpermissions'] = 'パーミッションのあるユーザのみエントリを評価できる'; // ORPHANED
