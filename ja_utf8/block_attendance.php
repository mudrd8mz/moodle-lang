...
$string['newdate'] = '新セッション日';
$string['nodescription'] = 'このセッションに説明はありません。';
$string['noguest'] = 'ゲストは出欠を閲覧できません。';
$string['nosessionexists'] = 'このコースにはセッションがありません。';
$string['olddate'] = '旧セッション日';
$string['period'] = '期間';
$string['remarks'] = '備考';
$string['report'] = 'レポート';
...
$string['sessionalreadyexists'] = 'すでにこの日にセッションが設定されています。';
$string['sessiondate'] = 'セッション年月日';
$string['sessiondays'] = 'セッション日';
$string['sessiondeleted'] = 'セッションが正常に削除されました。';
$string['sessionenddate'] = 'セッション終了日';
$string['sessionexist'] = 'セッションは追加されませんでした ( すでに登録されています )!';
