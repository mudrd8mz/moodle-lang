...
$string['configoldping'] = 'ユーザの応答がなくなってから、どれくらいの時間 ( 秒数 ) で退室したと見なしますか? これは単に上限であり、通常退出は非常に速く検出されます。あなたのサーバに、更に小さな値を設定する必要があります。通常のメソッドを使用している場合、2* chat_refresh_room より小さな値を<strong>設定しないでください</strong>。';
