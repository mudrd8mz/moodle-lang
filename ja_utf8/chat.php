...
$string['configmethod'] = 'ノーマルチャットメソッドでは、クライアントは定期的にサーバにアクセスして、内容を更新します。このメソッドは設定を必要とせず、どこでも使うことができますが、チャット参加者が多くなれば、サーバに大きな負荷がかかる場合があります。Chatサーバデーモンを使用する場合、Unixのシェルアクセスが必要ですが、軽快なチャット環境を提供することができます。';
