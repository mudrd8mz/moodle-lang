...
$string['aggregationcoefhelp'] = '他の評定項目との総計時、この評定項目のすべての評点に適用される加重です。';
...
$string['confighiddenasdate'] = '隠された評定をユーザが閲覧できない場合、日付の代わりに「-」を表示します。';
...
$string['hidden'] = '隠す';
$string['hiddenasdate'] = '隠された評定の日付を表示する';
