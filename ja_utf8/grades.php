<?PHP // $Id$ 
      // grades.php - created with Moodle 1.9 dev (2007071601)
...
$string['configaveragesdisplaytype'] = '評定レポートのそれぞれのカラムにどのように平均を表示するか指定してください。デフォルトおよび推奨設定は継承です。継承では最初にそれぞれのカラムの表示タイプをチェックし、明確に設定されていない場合、より一般的な評定タイプを選択します。実データまたはパーセンテージが選択された場合、それぞれのカラムの個々の設定は無視され、選択されたタイプが排他的に使用されます。';
