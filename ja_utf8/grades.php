...
$string['configincludescalesinaggregation'] = 'あなたは、すべてのコースのすべての評定表を通して、評価尺度がすべての総合評点に数として含まれるかどうか変更することができます。注意: この設定を変更することで、すべての総合評点は強制的に再計算されます。';
...
$string['configstudentsperpage'] = '評定者レポーの1ページあたりに表示される学生数です。';
