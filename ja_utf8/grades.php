<?PHP // $Id$ 
      // grades.php - created with Moodle 1.9 dev (2007070902)
...
$string['configfeedbackformat'] = '評定に添付されるフィードバックノートのフォーマットです。この設定では、フィードバックを入力するインターフェース (HTMLフォーマットのHTMLエディタ) も決定します。';
$string['configgradedisplaytype'] = '評定を実データまたはパーセンテージで表示することができます (最小および最大評点に関して)。';
$string['configgrandtotalsdisplaytype'] = '総計を実データまたはパーセンテージで表示することができます (最小および最大評点に関して)。';
...
$string['configshoweyecons'] = '目のアイコンをそれぞれの評定の近くに表示するかどうか選択します (ユーザに対する可視性をコントロール)。';
$string['configshowfeedback'] = 'フィードバックアイコン (追加/編集) をそれぞれの評定の近くに表示するかどうか選択します。';
$string['configshowgrandtotals'] = '評定レポートに総計を表示します。';
...
$string['feedbackformat'] = 'フィードバックフォーマット';
...
$string['showeyecons'] = '目のアイコンを表示する';
$string['showfeedback'] = 'フィードバックを表示する';
$string['showgrandtotals'] = '総計を表示する';
