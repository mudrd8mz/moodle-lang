...
$string['configdecimalpoints'] = 'それぞれの評定に表示する小数点以下桁数を指定してください。この設定は、評定項目ごとにオーバーライドすることができます。';
...
$string['configexportdecimalpoints'] = 'エクスポートに表示する小数点以下桁数です。この値は、エクスポート時にオーバーライドすることができます。';
...
$string['configgradeexportdisplaytype'] = '評定を実データ、パーセンテージ (最小および最大評点に関して)、文字 (A、B、C等..) で表示することができます。この値は、エクスポート時にオーバーライドすることができます。';
...
$string['configrangesdecimalpoints'] = 'それぞれの範囲に表示する小数点以下桁数を指定してください。この設定は、評定項目ごとにオーバーライドすることができます。';
...
$string['configshowhiddenitems'] = 'どのように隠し評定項目を表示するか指定してください。「隠し評定項目なし」が選択された場合、隠し評定項目は完全に隠されます。「すべての隠し評定項目」が選択された場合、隠し評定項目行は評点が完全に隠されたかたちでグレーに表示されます。「期限のある隠し評定項目のみ」が選択された場合、「次の日時まで隠す」の日付が設定された評定項目が、評点が完全に隠されたかたちで設定日付までグレーに表示されます。設定日以降、すべての項目が表示されます。';
...
$string['configshowuserimage'] = '評定レポートで名前の隣にプロファイルイメージを表示するかどうか指定してください。';
...
$string['grademaxhelp'] = '「値」の評定タイプを使用する場合、最大評点を設定することができます。活動ベースの評定項目の最大評点は、活動の更新ページで設定します。';
...
$string['gradetypehelp'] = '使用する評定タイプを指定してください: なし (評定不可)、値 (最大および最小評点の設定を有効にします)、尺度 (評価尺度設定を有効にします)、テキスト (フィードバックのみ)。値および尺度評定タイプのみ合計することができます。活動ベースの評定項目は、活動の更新ページで設定します。';
...
$string['idnumberhelp'] = 'IDナンバーを設定することで、評定計算の目的で活動を識別する手段を提供します。評定計算に活動が含まれていない場合、IDナンバーフィールドは空白のままにすることができます。活動ベースの評定項目のIDナンバーは、活動の更新ページで設定することができます。';
...
$string['iteminfohelp'] = '評定項目に関する情報を入力するスペースです。入力されたテキストは、どこにも表示されることはありません。';
$string['itemname'] = '項目名';
