<?PHP // $Id$ 
      // grades.php - created with Moodle 2.0 dev (Build: 20090130) (2009012901)
...
$string['overriddenhelp'] = 'オーバーライド済みが有効にされた場合、将来的な受験の評点が自動的に調整されることをオーバーライド済みフラグが防ぎます。多くの場合、このフラグは評定表で内部的に設定されますが、このフォーム要素を使用して、手動で有効および無効に変更することができます。';
