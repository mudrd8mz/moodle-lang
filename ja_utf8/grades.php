...
$string['configdecimalpoints'] = 'それぞれの評定に表示する小数点以下桁数です。この値は評定項目ごとにオーバーライドすることができます。';
...
$string['configrangesdecimalpoints'] = '評点のカラムの上で、それずれの範囲 (グループまたは全体) に表示する小数点以下桁数です。この値は評定項目ごとにオーバーライドすることができます。';
