...
$string['courseblogs'] = 'ユーザは、コース内のみで読むことができるブログを作成可能';
...
$string['groupblogs'] = 'ユーザは、グループ内のみで読むことができるブログを作成する';
...
$string['worldblogs'] = 'ユーザは、世界中からアクセスできるブログを作成可能';
