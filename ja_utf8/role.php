...
$string['explainpermissionsdoanything'] = 'このユーザは、ケイパビリティ「moodle/site:doanything」を持っているため、上記テーブルで「has_capability」に関して「false」が返されたとしても、実際には、ほとんどの環境でケイパビリティ「 $a 」を持っていると見なされます。'; // ORPHANED
...
$string['highlightedcellsshowdefault'] = '下記ハイライトされたセルは、上記「レガシーロールタイプ」をベースに、このタイプのロールのデフォルトパーミッションを示してしています。'; // ORPHANED
$string['highlightedcellsshowinherit'] = '下記ハイライトされたセルは、継承されるパーミッションを示してしています。あなたが実際に変更したいパーミッションとは別にして、すべてを継承のままにしてください。'; // ORPHANED
...
$string['noroleassignments'] = 'このユーザに関して、このサイト内でのロール割り当ては、どこにもありません。'; // ORPHANED
$string['notabletoassignroleshere'] = 'あなたは、ここでロールを割り当てることはできません。'; // ORPHANED
$string['notabletooverrideroleshere'] = 'あなたは、ここでロールのパーミッションをオーバーライドすることはできません。'; // ORPHANED
...
$string['whydoesuserhavecap'] = 'なぜ $a->fullname は、コンテクスト $a->context でケイパビリティ $a->capability を持っているのですか?'; // ORPHANED
$string['whydoesusernothavecap'] = 'なぜ $a->fullname は、コンテクスト $a->context でケイパビリティ $a->capability を持っていないのですか?'; // ORPHANED
