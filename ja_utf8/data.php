<?PHP // $Id$ 
      // data.php - created with Moodle 2.0 dev (Build: 20091207) (2009112400)
...
$string['guestrate'] = 'ゲストは、このエントリの評価を許可されていません。'; // ORPHANED
$string['invalidaccess'] = 'このページは、正しくアクセスされていません。'; // ORPHANED
...
$string['invalidpreset'] = '$a は、プリセットではありません。'; // ORPHANED
$string['invalidratedata'] = '送信された評価データが正しくありません。'; // ORPHANED
$string['invalidrecord'] = 'レコードが正しくありません。'; // ORPHANED
$string['missingdata'] = 'フィールドクラスには、データIDまたはオブジェクトを提供してください。'; // ORPHANED
...
$string['norating'] = 'この活動は、評価を使用していません。'; // ORPHANED
$string['portfolionotfile'] = 'ファイル (csvのみ) ではなく、ポートフォリオにエクスポートする'; // ORPHANED
