<?PHP // $Id$ 
      // data.php - created with Moodle 2.0 dev (Build: 20100118) (2010011400)
...
$string['guestrate'] = 'ゲストはこのエントリの評価を許可されていません。';
$string['header'] = 'ヘッダ';
...
$string['norating'] = 'この活動は評価を使用していません。';
...
</p><p>この変更により、あなたのシステムの次のデータベースが影響を受けます: (このリストを保存して、アップグレード後、教師が意図するよう、これらの活動が動作するかどうか確認してくださ。)</p><strong style=\"color:red\">$a->text</strong><br/>'; // ORPHANED
