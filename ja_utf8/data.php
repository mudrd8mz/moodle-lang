...
$string['configenablerssfeeds'] = 'ここでは、すべてのデータベースに関するRSSフィードを有効にします。更に、手動で各データベースのRSSフィード設定を有効にする必要があります。';
...
$string['data:readentry'] = 'エントリを表示する';
...
$string['insufficiententries'] = 'このデータベースを見るには、更にエントリが必要です。';
...
$string['presetwarning'] = 'プリセットとして保存することで、このテンプレートをサイト全体に公開します。すべてのユーザは、このテンプレートを自分のデータベースで使用することができます。';
