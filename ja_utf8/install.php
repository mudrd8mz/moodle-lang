...
$string['chooselanguagesub'] = 'あなたが選択した言語設定は、インストール中のみ使用されます。後で、サイトおよびユーザ言語を選択する画面が表示されます。';
$string['compatibilitysettings'] = 'PHP設定を確認しています ...';
$string['compatibilitysettingshead'] = 'PHP設定を確認しています ...';
$string['compatibilitysettingssub'] = 'Moodleを適切に動作させるためには、あなたのサーバがこれら全てのテストに通る必要があります。';
