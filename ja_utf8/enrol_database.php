<?PHP // $Id$ 
      // enrol_database.php - created with Moodle 2.0 dev (Build: 20080620) (2008051203)
...
$string['course_id'] = 'コードIDが保存されるフィールド名です。このフィールドの値は、Moodleコーステーブル内の「enrol_db_l_coursefield」フィールドと一致させるため使用されます。';
...
$string['ignorehiddencourse'] = 'この設定を「Yes」にした場合、コース登録が無効にされているコースにユーザは受講登録されません。';
...
$string['template'] = '任意: 自動作成コースは、テンプレートコースから設定をコピーすることができます。テンプレートコースの省略名を入力してください。';
$string['type'] = 'データベースサーバタイプです。';
$string['user'] = 'サーバにアクセスするためのユーザ名です。';
$string['local_coursefield'] = 'リモートデータベースのエントリとマッチングさせるための、コーステーブルのフィールド名です (例 idnumber)。'; // TBD
