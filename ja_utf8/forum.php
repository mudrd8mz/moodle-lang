...
$string['cannotconvertteachertogeneral'] = '教師用フォーラムから一般フォーラムへフォーラムタイプを変更できませんでした。';
...
$string['configajaxrating'] = 'AJAX評価は、フォーラム評価ユーザビリティを改善します。有効にした場合、ユーザはページ最下部へスクロールせず、「私の評価を送信する」ボタンをクリックすることで、ほとんどすぐにフォーラム投稿を評価することができます。また、この設定では、サイトおよびユーザプロファイルでAJAXを有効にする必要があります。';
