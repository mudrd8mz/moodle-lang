...
$string['configlongpost'] = 'この文字長以上の長さ ( HTMLは含まない ) は長いと考えられます。サイトのフロントページ、ソーシャルフォーマット、ユーザプロフィールに表示される投稿内容の長さは、forum_shortpostとforum_longpostの値の間に短くされます。';
...
$string['resetforums'] = 'これらのタイプのフォーラムから全ての投稿を削除する';
