<?PHP // $Id$ 
      // forum.php - created with Moodle 1.9.16 (Build: 20120109) (2007101591.1)
...
$string['alreadyfirstpost'] = 'このディスカッションにはすでに最初の投稿があります。'; // ORPHANED
$string['attachmentnopost'] = 'あなたは投稿IDなしで添付ファイルをエクスポートできません。'; // ORPHANED
$string['attachments'] = '添付ファイル'; // ORPHANED
$string['cannotadd'] = 'このフォーラムにディスカッションを追加できませんでした。'; // ORPHANED
$string['cannotaddsubscriber'] = 'このフォーラムに、ID $a のメール購読ユーザを追加できませんでした!'; // ORPHANED
$string['cannotaddteacherforumto'] = 'コースのセクションゼロに対して、コンバートされた教師フォーラムインスタンスを追加できませんでした。'; // ORPHANED
$string['cannotcreatediscussion'] = '新しいディスカッションを作成できませんでした。'; // ORPHANED
$string['cannotcreateinstanceforteacher'] = '教師用フォーラムに対して、新しいコースモジュールインスタンスを作成できませんでした。'; // ORPHANED
$string['cannotdeleteforummodule'] = 'あなたはフォーラムモジュールを削除できません。'; // ORPHANED
$string['cannoteditposts'] = 'あなたは他のユーザの投稿を編集できません!'; // ORPHANED
$string['cannotfinddiscussion'] = 'このフォーラムのディスカッションが見つかりませんでした。'; // ORPHANED
$string['cannotfindfirstpost'] = 'このフォーラムの最初の投稿が見つかりませんでした。'; // ORPHANED
$string['cannotfindorcreateforum'] = 'サイトのメインニュースフォーラムが見つからないか、作成できません。'; // ORPHANED
$string['cannotfindparentpost'] = '記事 $a の先頭親記事が見つかりませんでした。'; // ORPHANED
$string['cannotmovefromsingleforum'] = '「トピック1件のシンプルなディスカッション」からディスカッションを移動できません。'; // ORPHANED
$string['cannotmovenotvisible'] = 'フォーラムは非表示です。'; // ORPHANED
$string['cannotmovetonotexist'] = 'あなたはこのフォーラムを移動できません - フォーラムが存在しません!'; // ORPHANED
$string['cannotmovetonotfound'] = 'このコースには対象のフォーラムが見つかりませんでした。'; // ORPHANED
$string['cannotpurgecachedrss'] = 'ソースまたは対象フォーラムに関して、キャッシュされたRSSフィードを削除できませんでした - あなたのファイルパーミッションを確認してください。'; // ORPHANED
$string['cannotremovesubscriber'] = 'このフォーラムから、ID $a のメール購読ユーザを削除できませんでした!'; // ORPHANED
$string['cannotreply'] = 'あなたはこの投稿に返信できません。'; // ORPHANED
$string['cannotsplit'] = 'このフォーラムのディスカッションは分割できません。'; // ORPHANED
$string['cannotsubscribe'] = '申し訳ございません、あなたがメール購読するには、グループメンバーである必要があります。'; // ORPHANED
$string['cannottrack'] = 'フォーラムの未読管理を停止できませんでした。'; // ORPHANED
$string['cannotunsubscribe'] = 'あなたをフォーラムからメール購読解除できませんでした。'; // ORPHANED
$string['cannotupdatepost'] = 'あなたはこの投稿を更新できません。'; // ORPHANED
$string['completiondiscussions'] = 'ユーザは次の件数のディスカッションを作成する必要があります:'; // ORPHANED
$string['completiondiscussionsgroup'] = 'ディスカッションを必要とする'; // ORPHANED
$string['completiondiscussionshelp'] = '完了するには、ディスカッションを必要とする'; // ORPHANED
$string['completionposts'] = 'ユーザは次の件数のディスカッションまたは返信を投稿する必要があります:'; // ORPHANED
$string['completionpostsgroup'] = '投稿を必要とする'; // ORPHANED
$string['completionpostshelp'] = '完了するには、ディスカッションまたは返信を必要とする'; // ORPHANED
$string['completionreplies'] = 'ユーザは次の件数の返信を投稿する必要があります:'; // ORPHANED
$string['completionrepliesgroup'] = '返信を必要とする'; // ORPHANED
$string['completionreplieshelp'] = '完了するには、返信を必要とする'; // ORPHANED
$string['configmaxattachments'] = '投稿ごとに許可されるデフォルトの最大添付ファイル数です。'; // ORPHANED
$string['errorwhiledelete'] = 'レコードの削除中にエラーが発生しました。'; // ORPHANED
$string['forum:exportdiscussion'] = 'すべてのディスカッションをエクスポートする'; // ORPHANED
$string['forum:exportownpost'] = '自分の投稿をエクスポートする'; // ORPHANED
$string['forum:exportpost'] = '投稿をエクスポートする'; // ORPHANED
$string['forumadministration'] = 'フォーラム管理'; // ORPHANED
$string['invalidaccess'] = 'このページは正しくアクセスされていません。'; // ORPHANED
$string['invaliddiscussionid'] = 'ディスカッションIDが正しくありません。'; // ORPHANED
$string['invalidforumid'] = 'フォーラムIDが正しくありません。'; // ORPHANED
$string['invalidparentpostid'] = '親記事のIDが正しくありません。'; // ORPHANED
$string['invalidpostid'] = '投稿ID ($a) が有効ではありません。'; // ORPHANED
$string['maxattachments'] = '最大添付ファイル数'; // ORPHANED
$string['messageprovider:digests'] = 'メール購読フォーラムダイジェスト'; // ORPHANED
$string['messageprovider:posts'] = 'メール購読フォーラム投稿'; // ORPHANED
$string['mustprovidediscussionorpost'] = 'あなたはディスカッションIDまたは投稿IDをエクスポートに提供する必要があります。'; // ORPHANED
$string['noattachments'] = 'このフォーラムには添付ファイルがありません。'; // ORPHANED
$string['noguestrate'] = 'ゲストはこのエントリを評価できません。'; // ORPHANED
$string['nopermissiontosubscribe'] = 'あなたにはメール購読ユーザを閲覧するパーミッションがありません。'; // ORPHANED
$string['nopermissiontoview'] = 'あなたにはこの投稿を閲覧するパーミッションがありません。'; // ORPHANED
$string['norate'] = 'アイテムの評価は許可されていません!'; // ORPHANED
$string['noresult'] = 'この投稿に関する評価はありません: $a'; // ORPHANED
$string['notexists'] = 'ディスカッションはすでに存在しません。'; // ORPHANED
$string['notinstalled'] = 'フォーラムモジュールがインストールされていません。'; // ORPHANED
$string['notpartofdiscussion'] = 'この投稿はディスカッションの一部ではありません。'; // ORPHANED
$string['noviewanyrate'] = 'あなたは自分の投稿に関する結果のみ閲覧できます。'; // ORPHANED
$string['noviewrate'] = 'あなたにはこの投稿評価を閲覧するケイパビリティがありません。'; // ORPHANED
$string['viewalldiscussions'] = 'すべてのディスカッションを表示する'; // ORPHANED
