...
$string['dateformat_info'] = 'あなたのデータがユーザプロファイルに保存されるときの日付フォーマットを選択してください。デフォルトの日付フォーマットはISO形式です。';
...
$string['user_info_field_shortname'] = 'ユーザの誕生日を含むユニークなユーザプロファイルフィールド省略名を入力してください (デフォルト省略名は「DOB」です)。';
