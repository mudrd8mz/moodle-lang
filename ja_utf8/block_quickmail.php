<?PHP // $Id$ 
      // block_quickmail.php - created with Moodle 1.7 dev (2006071800)
...
$string['check'] = 'すべてを選択';
$string['clearhistory'] = '履歴のクリア';
$string['composeemail'] = 'メールの作成';
$string['composenew'] = '新しいメールの作成';
$string['date'] = '日時';
$string['delete'] = '削除';
...
$string['emailhistory'] = 'クイックメール履歴';
$string['emailstop'] = 'メールアドレスが無効にされています:';
$string['messageerror'] = 'メッセージを入力してください!';
$string['nogroupmembers'] = 'グループメンバなし';
$string['notingroup'] = 'グループ外';
$string['pleasewait'] = 'お待ちください、メールを送信しています ...';
$string['sendemail'] = 'メールの送信';
$string['subjecterror'] = '題名を入力してくださ!';
