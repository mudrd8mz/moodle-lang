...
$string['err_invalidhost'] = 'このプラグインは、無効な (または削除された) mnetホストにアクセスするよう、誤って設定されています。このプラグインは、SSO IDP (アイデンティティプロバイダ) が公開されたMoodleネットワーキングピアおよび登録されたSSO SP (サービスプロバイダ) を信頼します。';
