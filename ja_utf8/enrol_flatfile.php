<?PHP // $Id$ 
      // enrol_flatfile.php - created with Moodle 1.8 dev (2007010404)
...
$string['filelockedmail'] = 'ファイルベースのユーザ登録で使用しているファイル ($a) は、cronプロセスにより削除されることはありません。通常、これはファイルパーミッションが違うことを意味します。Moodleが削除できるようファイルのパーミッションを変更してください。変更しない場合、この処理が繰り返し行われます。';
