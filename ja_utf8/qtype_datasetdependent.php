...
$string['keptcategory3'] = 'リンク - 同一カテゴリ内の再利用可能リンクセットより';
...
$string['newcategory2'] = 'ファイル - このカテゴリ内の他の問題でも使用される新しいファイルセットより';
$string['newcategory3'] = 'リンク - このカテゴリ内の他の問題でも使用される新しいリンクセットより';
