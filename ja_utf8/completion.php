...
$string['completion-alt-auto-enabled'] = 'システムはこのアイテムに対して、状態に応じて完了をマークします。';
...
$string['completion-alt-manual-enabled'] = 'ユーザはこのアイテムに対して、手動で完了をマークできます。';
$string['completion-alt-manual-n'] = '未完了、未完了をマークするには、選択してください。';
$string['completion-alt-manual-y'] = '完了、未完了をマークするには、選択してください。';
...
$string['completion_manual'] = 'ユーザが手動で活動完了をマークできる';
...
$string['help_completionexpected'] = '期待される完了日';
$string['help_completionlocked'] = '完了ロックオプション';
$string['help_completionview'] = '完了するには、閲覧を必要とする';
