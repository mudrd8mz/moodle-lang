...
$string['displaycoursestructuredesc'] = 'ここではコース構造の表示に関するデフォルト値を設定します。';
...
$string['zlibwarning'] = '警告: このサイトではPHP Zlib圧縮が有効にされています。一部のユーザが特定のブラウザでのSCORMオブジェクトのローディングに関して問題を経験することがあります。';
