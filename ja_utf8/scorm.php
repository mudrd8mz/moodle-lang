<?PHP // $Id$ 
      // scorm.php - created with Moodle 2.0 dev (Build: 20090119) (2009011900)
...
$string['apidebugmask'] = 'APIデバッグキャプチャマスク (&lt;username&gt;:&lt;activityname&gt; のシンプルなマスクです)';
...
$string['autocontinuedesc'] = 'ここでは、活動のデフォルト自動継続を設定します。';
...
$string['displayattemptstatusdesc'] = 'ここでは、受験状況の表示に関するデフォルト値を設定します。';
$string['displaycoursestructure'] = 'コース構造を表示する';
$string['displaycoursestructuredesc'] = 'ここでは、コース構造の表示に関するデフォルト値を設定します。';
$string['displaydesc'] = 'ここでは、活動に対してパッケージを表示するかどうか設定します。';
...
$string['exceededmaxattempts'] = 'あなたは、最大受験数に到達しました。';
...
$string['forcecompleteddesc'] = 'ここでは、完了の強制に関するデフォルト値を設定します。';
$string['forcenewattempt'] = '新しい受験を強制する';
$string['forcenewattemptdesc'] = 'ここでは、新しい受験の強制に関するデフォルト値を設定します。';
$string['found'] = 'マニフェストファイルが見つかりました。';
$string['frameheight'] = 'ここでは、ステージフレームまたはウィンドウのデフォルトの高さを設定します。';
$string['framewidth'] = 'ここでは、ステージフレームまたはウィンドウのデフォルトの幅を設定します。';
...
$string['hidebrowsedesc'] = 'ここでは、プレビューモードの無効または有効に関するデフォルトを設定します。';
$string['hideexit'] = 'コースから抜けるボタンを隠す';
$string['hidenav'] = 'ナビゲーションボタンを隠す';
$string['hidenavdesc'] = 'ここでは、ナビゲーションボタンの表示または非表示に関するデフォルトを設定します。';
$string['hidereview'] = 'レビューボタンを隠す';
$string['hidetoc'] = 'コース構造の表示 (TOC)';
$string['hidetocdesc'] = 'ここでは、コース構造の表示 (TOC) に関する表示または非表示に関するデフォルトを設定します。';
...
$string['lastattemptlockdesc'] = 'ここでは、最終受験後のロックに関するデフォルト値を設定します。';
$string['location'] = 'ロケーションバーを表示する';
$string['max'] = '最大評点';
$string['maximumattempts'] = '受験回数';
$string['maximumattemptsdesc'] = 'ここでは、活動に対するデフォルトの最大受験回数を設定します。';
...
$string['skipviewdesc'] = 'ここでは、ページに対するコンテンツ構造のスキップタイミングに関するデフォルトを設定します。';
...
$string['whatgradedesc'] = 'ここでは、複数回受験時の評点に関するデフォルトを設定します。';
$string['width'] = '幅';
