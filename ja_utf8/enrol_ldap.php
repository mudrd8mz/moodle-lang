<?PHP // $Id$ 
      // enrol_ldap.php - created with Moodle 2.0 dev (Build: 20080626) (2008051203)
...
$string['enrol_ldap_autocreate'] = 'Moodleに存在しないコースにユーザが登録された場合、自動的にコースを作成することができます。';
...
$string['enrol_ldap_search_sub'] = 'サブコンテクストよりグループメンバーを検索する。';
...
$string['enrol_ldap_template'] = '任意: 自動的に作成されるコースが設定をコピーすることのできるテンプレートコースです。';
