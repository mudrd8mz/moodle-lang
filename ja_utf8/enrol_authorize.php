...
$string['logininfo'] = 'ログイン名、パスワードおよびトランザクションキーはセキュリティ対策のため表示されません。あなたが、これらのフィールドに以前入力したことがある場合、再度入力する必要はありません。入力済みの場合、フィールドの近くに緑色のテキストが表示されます。これらのフィールドへの入力が初めての場合、ログイン名 (*) は必須入力です。また、適切な入力欄にトランザクションキー (#1) <strong>または</strong> パスワード (#2)を入力してください。更なるセキュリティ対策のため、トランザクションキーの入力をお勧めします。現在のパスワードを削除したい場合、チェックボックスをチェックしてください。';
