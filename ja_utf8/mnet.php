<?PHP // $Id$ 
      // mnet.php - created with Moodle 2.0 dev (Build: 20080910) (2008091000)
...
$string['error7026'] = 'あなたのメッセージが署名されたキーは、リモートホストがあなたのサーバのために保持しているキーとは異なります。さらにリモートホストがあなたの現在のキーの取得を試みましたが失敗しました。リモートホストのキーを手動で再作成して、再度お試しください。';
