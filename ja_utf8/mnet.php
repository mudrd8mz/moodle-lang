...
$string['authmnetautoadddisabled'] = 'Moodleネットワーキング認証プラグインの<em>ユーザ自動追加</em>が<strong>無効</strong>にされています。';
$string['authmnetdisabled'] = 'Moodleネットーワキング<em>認証プラグイン</em>が<strong>無効</strong>にされています。';
...
$string['mnetdisabled'] = 'Moodleネットワークは、<strong>無効にされています</strong>。';
$string['mnetenrol'] = '登録';
$string['mnetlog'] = 'ログ';
$string['mnetpeers'] = 'ピア';
...
$string['notBASE64'] = 'このストリングは、Base64エンコードフォーマットのストリングではありません。有効な公開鍵ではありません。';
$string['notPEM'] = 'この公開鍵はPEMフォーマットではありません。正常に動作しません。';
$string['not_in_range'] = 'IPアドレス　<code>$a</code>　は有効な信頼できるホストではありません。';
...
$string['remoteenrolhosts_desc'] = 'ユーザ登録および登録抹消が許可されているあなたのMoodleに対して、Moodleネットワークプラグイン経由でユーザ登録および登録抹消します。';
...
$string['ssoacldescr'] = 'このページは、リモートMoodleネットワークホストのユーザによるアクセスを許可/拒否するため使用してください。この機能は、あなたがリモートユーザにSSOサービスを提供するときに動作します。あなたのローカルユーザが他のMoodleネットーワークホストを散策できるような権限をコントロールする場合、ロールシステムにて、ユーザに「mnetlogintoremote」ケイパビリティを付与してください。';
