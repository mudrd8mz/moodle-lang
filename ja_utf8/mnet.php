...
$string['registerallhostsexplain'] = 'あなたのホストに接続を試みるすべてのホストの登録を選択することができます。これは、あなたのホストに接続し公開鍵を要求するあらゆるMoodleサイトが、あなたのホスト一覧に表示されることを意味します。<br />下記で「すべてのホストを登録する」を選択して、いくつかのサービスを有効にすることで、あらゆるMoodleサーバに対して無差別にサービスを提供することができます。';
...
$string['trustedhostsexplain'] = 'IPアドレスのリストまたはネットワークを入力してください、1行に１つ。例:<br />あなたのローカルホスト:<br />127.0.0.1<br />あなたのローカルホスト (CIDR表記、ネットワークブロック):<br />127.0.0.1/32<br />指定したIPアドレスのホストのみ 192.168.0.7:<br />192.168.0.7/32<br />IPアドレス 192.168.0.1 から 192.168.0.255 の間のホストはどれでも:<br />192.168.0.0/24<br />どのようなホストでも:<br />192.168.0.0/0<br />明らかに最後の例はお勧めできる設定ではありません。';
