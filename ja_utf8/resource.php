...
$string['keepnavigationvisiblewarning'] = '注意: いくつかのメディアファイルは、この設定を無視します。';
...
$string['configdisplayoptions'] = '利用可能にしたいオプションすべてを選択してください。既存の設定は、変更されません。複数のフィールドを選択するには、CTRLキーを押したままにしてください。'; // ORPHANED
...
$string['notmigrated'] = '申し訳ございません、このレガシーリソースタイプ ($a) は、まだ移行されていません。'; // ORPHANED
...
$string['portfolionotimplemented'] = 'あなたは、サポートされていないリソースタイプ ($a) からコンテンツをエクスポートしようと試みています!'; // ORPHANED
$string['printheading'] = 'ページ名を表示する'; // ORPHANED
$string['printheadingexplain'] = 'コンテンツの上にページ名を表示しますか? 有効にしても、いくつかの表示タイプでは、リソース名を表示することができません。'; // ORPHANED
$string['printintro'] = 'ページ説明を表示する'; // ORPHANED
$string['printintroexplain'] = 'コンテンツの上にページ説明を表示しますか? 有効にしても、いくつかの表示タイプでは、説明を表示することができません。'; // ORPHANED
