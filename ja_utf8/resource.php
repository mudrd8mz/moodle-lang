...
$string['configfilterexternalpages'] = 'この設定により、すべての外部リソース ( ウェブページ、アップロードしたHTMLファイル ) に現在設定されているフィルタ  ( 例えば用語集オートリンク ) が適用されます。「Yes」を選択することで、コースページの動作が著しく遅くなる恐れがあります。本当に必要がある場合のみ注意して使用してください。';
