...
$string['alreadygraded'] = 'あなたの提出課題はすでに評定されています。課題を再提出することはできません。';
...
$string['finalize'] = 'これ以上、提出課題はありません';
$string['finalizeerror'] = 'エラーが発生したため、課題の提出を終了することができませんでした。';
$string['graded'] = '評定済み';
$string['guestnosubmit'] = '申し訳ございません、ゲストは課題を提出できません。あなたの課題を提出するには、ログインまたはユーザ登録してください。';
$string['guestnoupload'] = '申し訳ございません、ゲストはアップロードできません。';
$string['helpoffline'] = '<p>このタイプの課題はMoodleの外で実施される課題に関して有用です。これはウェブサイト上での課題または対面により課される課題を考えることができます。</p>
<p>学生は課題説明を読むことはできますが、ファイル等をアップロードすることはできません。評定は通常どおり動作し、評定に関する通知メールが学生宛に送信されます。</p>';
$string['helponline'] = '<p>このタイプの課題では参加者に通常の編集ツールを使用したテキスト編集を求めます。教師はオンラインでこれらを評定でき、インラインコメントを追加および変更することもできます。</p>
...
<p>このタイプの課題では複数のレスポンスファイルをアップロードすることもできます。課題提出前にレスポンスファイルをアップロードして、各参加者に異なるファイルを提供することもできます。</p>
...
$string['helpuploadsingle'] = '<p>このタイプの課題では各参加者があらゆる種類の単一ファイルをアップロードすることができます。</p> <p>ワードプロセッサ文書、イメージ、ZIP圧縮したウェブサイト、その他あなたが参加者に提出するよう求めたファイルです。</p>';
...
$string['notavailableyet'] = '申し訳ございません、この課題はまだ利用できません。<br />課題のインストラクションは下記の開始日時以降、ここに表示されます。';
$string['notes'] = 'メモ';
$string['notesempty'] = 'エントリなし';
$string['notesupdateerror'] = 'メモの更新中にエラーが発生しました。';
$string['notgradedyet'] = '未評価';
$string['notsubmittedyet'] = '未提出';
$string['onceassignmentsent'] = '採点のために課題を提出した場合、あなたはファイルを削除または添付することができないようになります。本当に続けてもよろしいですか?';
...
$string['usernosubmit'] = '申し訳ございません、あなたは課題を提出できません。';
$string['viewfeedback'] = '提出課題の評価とフィードバックを確認する';
$string['viewsubmissions'] = '$a 件の提出課題を確認する';
$string['yoursubmission'] = 'あなたの提出課題';
$string['assignment:exportownsubmission'] = '自分の提出課題をエクスポートする'; // ORPHANED
$string['assignment:exportsubmission'] = '提出課題をエクスポートする'; // ORPHANED
$string['assignmentadministration'] = '課題管理'; // ORPHANED
$string['cannotviewassignment'] = 'あなたはこの課題を閲覧できません。'; // ORPHANED
$string['coursemisconf'] = 'コースの設定が正しくありません。'; // ORPHANED
$string['invalidassignment'] = '課題が正しくありません。'; // ORPHANED
$string['invalidid'] = '課題IDが正しくありません。'; // ORPHANED
$string['invalidtype'] = '課題タイプが正しくありません。'; // ORPHANED
$string['invaliduserid'] = 'ユーザIDが正しくありません。'; // ORPHANED
$string['maxpublishstate'] = '終了日時前のブログエントリに関する最大可視性'; // ORPHANED
$string['noblogs'] = 'あなたはブログエントリを投稿していません!'; // ORPHANED
$string['selectblog'] = 'あなたが提出したいブログエントリを選択する'; // ORPHANED
$string['typeblog'] = 'ブログ記事'; // ORPHANED
$string['usermisconf'] = 'ユーザの設定が正しくありません。'; // ORPHANED
$string['viewmysubmission'] = '私の提出課題を確認する'; // ORPHANED
