...
$string['emptysubmission'] = 'あなたは、まだ何も提出していません。';
...
<p>このタイプの課題では、複数のレスポンスファイルをアップロードすることもできます。課題提出前にレスポンスファイルをアップロードして、各参加者に異なるファイルを提供することもできます。</p>
<p>参加者は、提出したファイルに関して、進捗状況または他のテキスト情報を説明するメモを記述することができます。</p>
<p>このタイプの課題は、参加者により手動提出される必要があります。あなたは、現在の状況をいつでもレビューでき、未完成の課題には「下書き」と表示されます。あなたは、評定が終わっていない課題を「下書き」状態に戻すことができます。</p>';
