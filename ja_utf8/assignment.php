...
<p>このタイプの課題の提出は、参加者により手動で行われる必要があります。あなたは、現在の状況をいつでも確認でき、未完成の課題は「下書き」と表示されます。あなたは、評定が終わっていない課題を「下書き」状態に戻すことができます。</p>';
...
$string['submitedformarking'] = 'すでに課題は採点のため提出されているので、更新できません。';
