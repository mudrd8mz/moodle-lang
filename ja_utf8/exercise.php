...
$string['descriptionofexercise'] = 'エクササイズ課題では、説明資料または $a が行う作業は、WordドキュメントやHTMLファイルで作成します。このファイルは、エクササイズが $a に公開される前にアップロードしてください。同一のエクササイズまたはタスクに、一連のWordドキュメントやHTMLファイルを作成し、エクササイズが $a に公開される前にアップロードすることも可能です。';
...
$string['gradeforassessment'] = '評価に使用する評点';
$string['gradeforstudentsassessment'] = '$a が評価に使用する評点';
