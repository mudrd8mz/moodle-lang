...
$string['descriptionofexercise'] = 'エクササイズ課題では、説明資料または $a が行う作業は、WordドキュメントやHTMLファイルで作成します。エクササイズが $a に公開される前に、このファイルをアップロードしてください。同一のエクササイズまたはタスクに複数のWordドキュメントやHTMLファイルを作成し、エクササイズが $a に公開される前に、これらのファイルをアップロードすることも可能です。';
...
$string['specimenassessmentform'] = '評価実例';
