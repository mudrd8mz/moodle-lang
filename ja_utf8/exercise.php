...
$string['noteonassessmentelements'] = '評定は、いくつかの「評価要素」に分解されます。<br />このことは評定を簡単にし、さらにしっかりとしたものにします。学生が課題を受けることが<br />できるようにする前に、教師として、あなたはこれらの要素を追加する必要があります。<br />これは、コースの課題をクリックすることで設定できます。もし、評価要素が存在しない場合、評価要素を<br />追加するよう求められます。評価要素数は、エクササイズの更新画面で変更することができます。<br />評価要素自体は「評価要素の編集」画面で修正することができます。';
