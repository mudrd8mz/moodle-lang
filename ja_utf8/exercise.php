<?PHP // $Id$ 
      // exercise.php - created with Moodle 1.7 dev (2006050502)
...
$string['ago'] = '$ 日前';
$string['amend'] = '更新';
$string['amendassessmentelements'] = '評価要素の修正';
...
$string['descriptionofexercise'] = 'エクササイズ課題では、エクササイズまたは $a が行う作業の説明資料を、WordドキュメントやHTMLファイルで作成します。エクササイズが $a に公開される前に、このファイルをアップロードしてください。同一のエクササイズまたはタスクに複数のWordドキュメントやHTMLファイルを作成し、エクササイズが $a に公開される前に、これらのファイルをアップロードすることも可能です。';
$string['detailsofassessment'] = '評価詳細';
$string['displayoffinalgrades'] = '最終評点を表示';
$string['doubleupload'] = '警告: この提出課題は、おそらく2回送信されています。管理ページに移動して、このユーザによる短期間の2度の提出を確認してください。処理を行う前に、これらの提出課題から1つを削除してください。';
$string['duedate'] = '締切日';
$string['edit'] = '編集';
...
$string['fair'] = '公平';
$string['generalcomment'] = 'ジェネラルコメント';
$string['good'] = '良い';
...
$string['phase3'] = 'すべての成績および成績一覧表を表示';
...
$string['poor'] = '悪い';
$string['present'] = '出席';
$string['reasonforadjustment'] = 'ジェネラルコメント/調整の理由';
$string['reassess'] = '再評価';
$string['regradestudentassessments'] = '学生の評価を再評定する';
$string['resubmissionfor'] = '$a の再提出';
$string['resubmitnote'] = '* は、$a がこの課題を再提出できることを意味します。<br />各提出課題の処理欄にある編集をクリックし、<b>$a の課題再提出を許可する</b>ボタンを<br />クリックすることで、このフラグを設定できます。<br />学生は、このフラグが表示されている課題の<b>どれでも</b>再提出することができます。';
...
$string['warningonamendingelements'] = '警告: 実行された評価が存在します。<br />要素数、評価基準、評価要素の比重を変更しないでください。';
