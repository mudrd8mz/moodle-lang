...
$string['defaultgroupdescription'] = 'デフォルトグループ説明'; //TBD with Moodle 2.0 dev (2007101508)
$string['defaultgroupprefix'] = 'グループ'; //TBD with Moodle 2.0 dev (2007101508)
$string['displaygrouping'] = 'グルーピングを表示する'; //TBD with Moodle 2.0 dev (2007101508)
$string['distributealphabetically'] = '姓のアルファベット順にグループに割り当てる'; //TBD with Moodle 2.0 dev (2007101508)
$string['distributeevenly'] = '残りの学生を均一に割り当てる'; //TBD with Moodle 2.0 dev (2007101508)
$string['firstname'] = '名のアルファベット順'; //TBD with Moodle 2.0 dev (2007101508)
$string['lastname'] = '姓のアルファベット順'; //TBD with Moodle 2.0 dev (2007101508)
$string['membersingroup'] = 'メンバー'; //TBD with Moodle 2.0 dev (2007101508)
$string['numberofgroups'] = 'グループ数'; //TBD with Moodle 2.0 dev (2007101508)
$string['numberofstudents'] = '学生数'; //TBD with Moodle 2.0 dev (2007101508)
$string['prefixforgroupnames'] = 'グループ名の接頭辞'; //TBD with Moodle 2.0 dev (2007101508)
$string['selectnumberineachgroup'] = '各グループの学生数を選択する'; //TBD with Moodle 2.0 dev (2007101508)
$string['selectnumberofgroups'] = 'グループ数を選択する'; //TBD with Moodle 2.0 dev (2007101508)
$string['usestudentsonlyfromselectedgroup'] = '現在選択されているグループの学生のみ使用する。'; //TBD with Moodle 2.0 dev (2007101508)
$string['cancel'] = 'キャンセル'; //TBD with Moodle 2.0 dev (2007101508)
$string['editgroupingpermissions'] = 'グルーピングパーミッションを編集する'; //TBD with Moodle 2.0 dev (2007101508)
$string['errorinvalidgrouping'] = 'エラー、無効なグルーピングです: $a'; //TBD with Moodle 2.0 dev (2007101508)
$string['errornotingrouping'] = '申し訳ございません、あなたは $a にグループを作成できません。'; //TBD with Moodle 2.0 dev (2007101508)
$string['errornotingroupingedit'] = '申し訳ございません、あなたはグルーピング $a を編集できません。'; //TBD with Moodle 2.0 dev (2007101508)
$string['groupfor'] = 'グループ'; //TBD with Moodle 2.0 dev (2007101508)
$string['return'] = '戻る'; //TBD with Moodle 2.0 dev (2007101508)
$string['save'] = '保存'; //TBD with Moodle 2.0 dev (2007101508)
$string['showusersalreadyingroup'] = 'すでにグルーピングのグループに登録されているユーザを表示する。'; //TBD with Moodle 2.0 dev (2007101508)
$string['teachersgroupmark'] = '教師は自分が属していないグループの活動を評定できない。'; //TBD with Moodle 2.0 dev (2007101508)
$string['teachersgroupview'] = '教師は自分が属していないグループの活動を閲覧できない。'; //TBD with Moodle 2.0 dev (2007101508)
$string['teachersoverride'] = '教師は自分が属していないグループの活動を閲覧および評定できる (上記をオーバーライド)。'; //TBD with Moodle 2.0 dev (2007101508)
$string['upgradeconfirm'] = '申し訳ございません、このアップグレードではMoodle 1.8 DEVで作成されたグループテーブルを削除する必要があります。本当に続けてもよろしいですか?'; //TBD with Moodle 2.0 dev (2007101508)
$string['viewallgroupsactivities'] = '学生はすべてのグループの活動を閲覧のみできる。'; //TBD with Moodle 2.0 dev (2007101508)
$string['viewallgroupsmembers'] = '学生はすべてのグループのメンバーを閲覧できる。'; //TBD with Moodle 2.0 dev (2007101508)
$string['viewowngroup'] = '学生は自分が属しているすべてのグループのメンバーを閲覧できる。'; //TBD with Moodle 2.0 dev (2007101508)
$string['addexistinggroupstogrouping'] = '既存のグループをグルーピングに追加する'; //TBD with Moodle 2.0 dev (2007101508)
