...
$string['editform1'] = '文章のフォーマットを心配せずに書き込んでみてください。文章のフォーマットは、後からいつでも改良することができます。';
...
$string['thispageisntlinkedfromanywhereelse'] = 'このページは、どこからもリンクされていません。';
...
$string['wikistartederror'] = 'Wikiには、すでにエントリが存在します - 変更できません。';
$string['wikitype'] = 'タイプ';
