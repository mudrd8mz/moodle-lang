...
$string['expired'] = '期間終了';
$string['explain_lookahead'] = 'ここでは、イベントが直近のイベントとして表示されるための最大日数を設定します。この範囲より後に開催されるイベントは、直近イベントとして表示されません。すべてのイベントがこのスケジュールどおりに開始されることは<strong>保証されません</strong>; もし数多く (「直近イベントの最大表示件数」以上) のイベントが登録されている場合、時間が遅いイベントが表示されません。';
