...
$string['aftereachquestion'] = 'それぞれの問題を追加後';
$string['afternquestions'] = '問題 $a 問を追加後';
...
$string['attempt'] = '受験  $a';
$string['attemptalreadyclosed'] = 'この受験は、すでに終了しています。';
...
$string['filloutnumericalanswer'] = 'あなたは、少なくとも1つの答えおよび許容誤差を入力しました。最初の組み合わせの答えは、評点とフィードバックを決定するために使用されます。あなたが最後に答えの無いフィードバックを提供した場合、学生には解答が他のどの答えとも合致していない旨が表示されてしまいます。';
...
$string['reviewnotallowed'] = 'あなたは、この小テストに関する他のユーザの受験結果をレビューすることはできません。'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['qti2'] = 'IMS QTI 2.0フォーマット'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['blackboard_6'] = 'Blackboard V6+'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['existingcategory1'] = 'すでに登録されている定数、このカテゴリの他の問題でも使用'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['existingcategory2'] = 'すでに登録されているファイル、このカテゴリの他の問題でも使用'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['existingcategory3'] = 'すでに登録されているリンク、このカテゴリの他の問題でも使用'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['keptcategory1'] = '同一カテゴリの再利用可能な定数群を使用する'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['keptcategory2'] = '同一カテゴリの再利用可能なファイル群を使用する'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['keptcategory3'] = '同一カテゴリの再利用可能なリンク群を使用する'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['keptlocal1'] = '同一質問のプライベート定数群を使用する'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['keptlocal2'] = '同一質問のプライベートファイル群を使用する'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['keptlocal3'] = '同一質問のプライベートリンク群を使用する'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['newcategory1'] = '新しい定数群、このカテゴリの他の問題でも使用'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['newcategory2'] = '新しいファイル群、このカテゴリの他の問題でも使用'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['newcategory3'] = '新しいリンク群、このカテゴリの他の問題でも使用'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['newlocal1'] = '新しい定数群、この問題のみで使用'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['newlocal2'] = '新しいファイル群、この問題のみで使用'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
$string['newlocal3'] = '新しいリンク群、この問題のみで使用'; //TBD with Moodle 2.0 dev (Build: 20080821) (2008081900)
