<?PHP // $Id$ 
      // quiz.php - created with Moodle 2.0 dev (Build: 20080417) (2008030700)
...
$string['filloutthreequestions'] = '組み合わせの答えがある問題を、少なくとも3つ入力してください。答えと空白の問題を使用して、誤答を余分に提供することもできます。問題と答えの両方が空白のエントリは無視されます。';
...
$string['reviewnotallowed'] = 'あなたは、この小テストに関する他のユーザの受験結果をレビューすることはできません。';
...
$string['keptlocal1'] = '同一質問のプライベート定数群を使用する'; // TBD
$string['keptlocal2'] = '同一質問のプライベートファイル群を使用する'; // TBD
$string['keptlocal3'] = '同一質問のプライベートリンク群を使用する'; // TBD
