...
$string['alreadysubmitted'] = 'あなたは既に解答しているようです。';
...
$string['filloutoneanswer'] = '1つ以上の考えられる答えを入力してください。空白は使用できません。';
$string['filloutthreequestions'] = '組み合わせの答えがある問題を、少なくとも3つ入力してください。答えと空白の問題により、余分に誤答を提供することもできます。問題と答え両方が空白のエントリは無視されます。';
...
$string['fractionsaddwrong'] = 'あなたが選択したプラス評点の合計が、100%%に達していません。<br />現在の評点合計は $a%%　です。<br />戻って問題を修正しますか?';
$string['fractionsnomax'] = 'この問題で満点を取ることができるように、<br />答えの1つは 100%%でなければなりません。 <br />戻ってこの問題を修正しますか?';
...
$string['sortalpha'] = '問題名順';
$string['sortsubmit'] = '問題の並び替え';
$string['sorttypealpha'] = 'タイプ・問題名順';
