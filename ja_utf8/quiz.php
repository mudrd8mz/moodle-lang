...
$string['filloutnumericalanswer'] = 'あなたは、少なくとも1つの答えおよび許容誤差を入力しました。最初の組み合わせの答えは、点数とフィードバックを決定するために使用されます。あなたが最後に答えの無いフィードバックを提供した場合、学生には解答が他のどの答えとも合致していない旨が表示されてしまいます。';
