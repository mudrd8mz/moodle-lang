...
$string['existingcategory1'] = 'すでに登録されている定数、このカテゴリの他の問題でも使用'; //TBD with Moodle 2.0 dev (2007101508)
$string['existingcategory2'] = 'すでに登録されているファイル、このカテゴリの他の問題でも使用'; //TBD with Moodle 2.0 dev (2007101508)
$string['existingcategory3'] = 'すでに登録されているリンク、このカテゴリの他の問題でも使用'; //TBD with Moodle 2.0 dev (2007101508)
$string['keptcategory1'] = '同一カテゴリの再利用可能な定数群を使用する'; //TBD with Moodle 2.0 dev (2007101508)
$string['keptcategory2'] = '同一カテゴリの再利用可能なファイル群を使用する'; //TBD with Moodle 2.0 dev (2007101508)
$string['keptcategory3'] = '同一カテゴリの再利用可能なリンク群を使用する'; //TBD with Moodle 2.0 dev (2007101508)
$string['keptlocal1'] = '同一質問のプライベート定数群を使用する'; //TBD with Moodle 2.0 dev (2007101508)
$string['keptlocal2'] = '同一質問のプライベートファイル群を使用する'; //TBD with Moodle 2.0 dev (2007101508)
$string['keptlocal3'] = '同一質問のプライベートリンク群を使用する'; //TBD with Moodle 2.0 dev (2007101508)
$string['newcategory1'] = '新しい定数群、このカテゴリの他の問題でも使用'; //TBD with Moodle 2.0 dev (2007101508)
$string['newcategory2'] = '新しいファイル群、このカテゴリの他の問題でも使用'; //TBD with Moodle 2.0 dev (2007101508)
$string['newcategory3'] = '新しいリンク群、このカテゴリの他の問題でも使用'; //TBD with Moodle 2.0 dev (2007101508)
$string['newlocal1'] = '新しい定数群、この問題のみで使用'; //TBD with Moodle 2.0 dev (2007101508)
$string['newlocal2'] = '新しいファイル群、この問題のみで使用'; //TBD with Moodle 2.0 dev (2007101508)
$string['newlocal3'] = '新しいリンク群、この問題のみで使用'; //TBD with Moodle 2.0 dev (2007101508)
