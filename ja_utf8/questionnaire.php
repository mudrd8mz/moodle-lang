...
$string['possibleanswers'] = '可能性のある答えを入力してください (妥当な場合)。<tt>!その他</tt>のように、答えの前に「!」をつけることで、書き込むための空欄が、答えの後に追加されます。空白行は、削除されます。';
$string['precision'] = '精度';
...
$string['thank_body'] = 'あなたのブラウザの戻るボタンを使用しないでください。下記のリンクをクリックして、あなたが調査を開始した場所に戻ってください。';
