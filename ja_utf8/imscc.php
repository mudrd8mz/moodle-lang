<?PHP // $Id$ 
      // imscc.php - created with Moodle 2.0 dev (Build: 20091029) (2009102700)
...
$string['enable_cc_import_description'] = 'この設定では標準リストア機能を使用した、共通カートリッジ (IMS-CC) パッケージのインポートを有効にします。あなたのサーバに、PHP5、DOM、XSLおよびLIBXML (2.6.30またはそれ以上) 拡張モジュールがインストールされている必要があることに留意してください。';
