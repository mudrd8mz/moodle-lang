...
$string['gradeforstudentsassessment'] = '学生の評価作業に対する評定';
...
$string['numberofattachments'] = '提出課題に付けられる添付ファイル数';
...
$string['saveoverallocation'] = '割り当て回数過剰を許す度合レベルを保存';
...
$string['thegradeforthisassessmentis'] = 'この評価作業に対する評点は $a です。';
