...
$string['cannotcreatefield'] = '新しいフィールドの作成中にエラーが発生しました。';
...
$string['cannotsaveconfig'] = 'プラグイン「 $a->plugin 」の設定「 $a->name 」を「 $a->value 」として保存中に問題が発生しました。';
...
$string['cannotupdatecoursemodule'] = 'コースモジュールを更新できませんでした。';
$string['cannotupdatecustomprofile'] = 'ユーザカスタムレコードの更新中にエラーが発生しました。';
$string['cannotupdatefield'] = 'フィールドの更新中にエラーが発生しました。';
...
$string['cannotupdatemodcap'] = '$a のケイパビリティを更新できませんでした!';
...
$string['cannotupdatesecret'] = 'ユーザのシークレットストリングのリセット中にエラーが発生しました。';
...
$string['cannotviewprofile'] = 'あなたは、このユーザのプロファイルを閲覧できません。';
$string['cannotwritefile'] = 'ファイル「 $a 」に書き込めません。';
$string['cantunenrollfrommetacourse'] = 'あなたは、このメタコースから登録解除できません。';
...
$string['nopermissiontodelentry'] = 'あなたは、他のユーザのエントリを削除できません!';
$string['nopermissiontoeditcomment'] = 'あなたは、他のユーザのコメントを編集できません!';
...
$string['sessionnotwritable'] = 'セッションディレクトリに書き込みパーミッションの問題が見つかりました。<br /><br />サーバ管理者にご連絡ください。';
