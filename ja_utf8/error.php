...
$string['cannotedityourprofile'] = '申し訳ございません、自分のプロファイルは編集できません。';
...
$string['cannotupdatepasswordonextauth'] = '外部認証のパスワードを更新に失敗しました: $a 詳細はサーバログをご覧ください。';
...
$string['nofolder'] = '指令されたディレクトリはありません。';
