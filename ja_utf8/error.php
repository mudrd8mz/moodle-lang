...
$string['nostatstodisplay'] = '申し訳ございません、表示できるデータはありません。';
...
$string['statsnodata'] = 'そのコースおよび期間の組み合わせで、利用できるデータはありません。';
...
$string['unknowngroup'] = '不明なグループ「 $a 」';
$string['unknownrole'] = '不明なロール「 $a 」';
