...
$string['adminhelpassignsiteroles'] = '定義したサイト任務を特定のユーザに適用します。';
...
$string['adminhelpmanageroles'] = 'ユーザに適用する任務を作成および定義します。';
...
$string['assignsiteroles'] = 'サイト全体の任務の割り当て';
...
$string['manageroles'] = '任務およびパーミッション';
