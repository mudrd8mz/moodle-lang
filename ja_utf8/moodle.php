<?PHP // $Id$ 
      // moodle.php - created with Moodle 2.0 dev (Build: 20100118) (2010011400)
...
$string['youneedtoenrol'] = 'この操作を実行するには、コースに受講登録してください。';
...
$string['clicktohideshow'] = '展開または折りたたむには、ここをクリックしてください。'; // ORPHANED
...
$string['coursehelpexpirynotifystudents'] = '利用有効期間が設定された場合、ここでは、コースから受講登録解除される前に、学生が通知メールを受信するかどうか設定します。'; // ORPHANED
$string['coursehelpexpirythreshold'] = '利用有効期間が設定された場合、ここでは、学生がコースから受講登録解除される何日前に、通知メールが送信されるか設定します。'; // ORPHANED
$string['coursehelpforce'] = 'コース内のすべての活動でグループモードを強制します。'; // ORPHANED
$string['coursehelpnotify'] = '利用有効期間が設定された場合、ここでは、学生がコースから受講登録解除される前に、教師が通知メールを受信するかどうか設定します。'; // ORPHANED
...
$string['pageshouldredirect'] = 'このページは、自動的にリダイレクトされます。何も起こらない場合、下記の「続ける」リンクをクリックしてください。'; // ORPHANED
...
$string['windowclosing'] = 'このウィンドウは、自動的に閉じます。自動的に閉じない場合、ウィンドウを閉じてください。'; // ORPHANED
