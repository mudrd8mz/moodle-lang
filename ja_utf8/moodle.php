...
$string['edhelpcleanword'] = 'ここでは、Word特有のフォーマットをフィルタするかどうか設定します。';
...
$string['emaildisplayno'] = '全員から私のメールアドレスを隠します';
$string['emaildisplayyes'] = '全員に私のメールアドレスを公開します';
...
$string['forcepasswordchangehelp'] = '次のログイン時、ユーザに対してパスワードの変更を求めます。';
...
$string['frontpagedescriptionhelp'] = 'サイト説明は、フロントページに表示されます。';
...
$string['groupnonmembers'] = 'グループに属さない人';
...
$string['notifyloginfailuresmessagestart'] = '$a における前回通知以降のログイン失敗一覧です。';
...
$string['passwordforgotteninstructions'] = '最初に、あなたの詳細情報がデータベースに登録されている必要があります。あなたの「ユーザ名」<strong>または</strong>「登録したメールアドレス」を下記のテキストボックスに入力してください。両方を入力する必要はありません。';
...
$string['selectednowmove'] = '$a 個の移動対象ファイルが選択されました。<br />ファイルの移動先フォルダに移動して「ファイルをここに移動する」ボタンをクリックしてください。';
