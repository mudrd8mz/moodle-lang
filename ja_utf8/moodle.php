...
$string['errorwhenconfirming'] = 'エラーが発生したため、アカウントの認証は行われませんでした。メール本文のリンクをクリックして、このページにたどり着いた場合、リンクが記されている行が崩れていないか確認してください。正しくリンクを動作させるためにコピー＆ペーストを使用してください。';
$string['everybody'] = '全員';
...
<li type=disc>「登録キー」を入力する必要がある場合、先生があなたに教えた「登録キー」を入力してください。これでコースにアクセスできるようになります。</li>
...
$string['noreplybouncemessage'] = 'あなたは no-reply アドレスにメール返信しました。フォーラムの投稿に返信したい場合、メール返信する代わりにフォーラム $a で返信を投稿してください。
...
$string['payments'] = '支払い';
$string['paymentsorry'] = 'お支払いありがとうございます! 残念ですが、あなたの支払いおよびコース 「 $a->fullname 」 に入るための登録作業は完了してません。再度、支払いおよび登録作業を行ってください。引き続きエラーが表示される場合、$a->teacher またはサイト管理者にご連絡ください。';
...
$string['supplyinfo'] = 'あなたに関する情報を入力してください。';
...
まだプロフィールの編集が終わっていない場合、私たちが受講している皆さんのことを知ることができるように、コースの中でプロフィールページを編集してください:
