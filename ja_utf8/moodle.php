...
$string['deletecoursecheck'] = '本当にこのコースとコース内の全データを完全に削除してもよろしいですか?';
$string['deleted'] = '削除完了';
...
$string['messageselectadd'] = '追加 / メッセージを送信する';
...
$string['supplyinfo'] = 'あなた自身の情報を入力してください。';
...
$string['withselectedusers'] = '選択したユーザの ...';
