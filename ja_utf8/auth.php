...
$string['auth_nonedescription'] = 'ユーザはログインした後、外部サーバおよびメールによる確認なしで、アカウントを直ちに作成できます。このオプションを使用する場合、十分に注意してください - セキュリティおよび管理上の問題が発生する可能性があることを考えてください。';
...
$string['auth_pop3type'] = 'サーバタイプです。もし認証が必要な場合、pop3certを選択してください。';
...
$string['auth_updateremote_expl'] = '<p><b>外部データの更新:</b> この設定を有効にした場合、ユーザレコードが更新されるときに外部認証が更新されます。編集できるよう、フィールドのロックを解除する必要があります。</p>';
...
$string['errormaxconsecutiveidentchars'] = 'パスワードには、最大 $a 文字の連続した同一文字を使用する必要があります。';
...
$string['user_disablenotsupportusertype'] = 'auth: ldap user_disable() は、選択したユーザタイプをまだサポートしていません。';
