...
$string['auth_cas_changepasswordurl'] = 'パスワード変更のURL';
...
$string['auth_fieldlocks_help'] = '<p>ここでは、ユーザフィールドをロックすることができます。ユーザレコードを管理者が手動で編集する方法、または「ユーザのアップロード」機能を使ってユーザレコードをアップロードする方法をとっている場合に便利です。Moodleで必要なフィールドをロックする場合、ユーザアカウントを作成するときにそれらのデータを必ず提供してください。そうでない場合、アカウントを使用できなくなります。</p><p>このトラブルを避けるため、「空の場合はロックしない」に設定することを考慮してください。</p>';
...
$string['auth_pop3changepasswordurl_key'] = 'パスワード変更のURL';
