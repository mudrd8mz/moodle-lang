...
$string['auth_ldap_ad_create_req'] = 'Active Directoryに新しいアカウントを作成できません。アカウントを作成するためのすべての必要条件 (LDAPSコネクション、必要な権限を持ったbindユーザ等) に合致しているか確認してください。';
...
$string['auth_ldap_bind_pw'] = 'bindユーザのパスワード';
