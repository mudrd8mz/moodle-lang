...
$string['blocksaddedit'] = 'Προσθήκη/Τροποποίηση μπλοκ';
...
$string['coursehelpformat'] = 'Η κεντρική σελίδα του μαθήματος θα φαίνεται σε αυτό το φορμάτ.';
...
$string['uploadthisfile'] = 'Αποστολή του αρχείου (το όνομα να είναι σε λατινικούς χαρακτήρες)';
