...
$string['add'] = 'Προσθήκη';
$string['addactivity'] = 'Πρόσθεσε μια δραστηριότητα';
...
$string['addresource'] = 'Πρόσθεσε μια πηγή πληροφοριών...';
...
$string['adminhelpassignsiteroles'] = 'Εφάρμοσε ρόλους σε επίπεδο site σε συγκεκριμένους χρήστες';
...
$string['advancedfilter'] = 'Εξελιγμένη Αναζήτηση';
$string['again'] = 'πάλι';
$string['all'] = 'Όλα';
...
$string['allownone'] = 'Μην επιτρέπεις τίποτα';
...
$string['courseimportnotaught'] = 'Δεν είστε καθηγητής με δικαίωμα επεξεργασίας σε άλλο μάθημα. Δεν υπάρχουν μαθήματα να εισάγετε';
...
$string['defaultcourseteacherdescription'] = 'Οι καθηγητές μπορούν να κάνουν οτιδήποτε σε ένα μάθημα καθώς επίσης να αλλάξουν τις δραστηριότητες και τους βαθμούς των μαθητών.';
...
$string['expirynotify'] = 'Ενημέρωση για λήξη διάρκειας εγγραφής';
$string['expirynotifystudents'] = 'Ενημέρωσε τους μαθητές';
...
$string['force'] = 'Όρισε';
$string['forcelanguage'] = 'Όρισε αρχική γλώσσα';
$string['forceno'] = 'Μην ορίσεις';
$string['forcetheme'] = 'Όρισε θέμα';
...
$string['hiddensections'] = 'Κρυμένες περιοχές';
$string['hiddensectionscollapsed'] = 'Οι κρυμένες περιοχές εμφανίζονται σε συμπτηγμένη μορφή';
$string['hiddensectionsinvisible'] = 'Οι κρυμένες περιοχές είναι αόρατες';
...
$string['importactivities'] = 'Κάνε εισαγωγή δραστηριοτήτων από άλλο μάθημα';
...
$string['messageselectadd'] = 'Πρόσθεσε / στείλε μύνημα';
$string['min'] = 'λεπτό';
$string['mins'] = 'λεπτά';
...
$string['none'] = 'Κανένα';
$string['noneditingteacher'] = 'Καθηγητής περιορισμένων δυνατοτήτων';
$string['noneditingteacherdescription'] = 'Ο καθηγητής περιορισμένων δυνατοτήτων μπορεί να διδάξει μαθήματα και να βαθμολογήσει τους μαθητές αλλά δεν μπορεί να αλλάξει τις δραστηριότητες τους';
...
$string['passwordforgotten'] = 'Ξεχασμένος Κωδικός';
$string['passwordforgotteninstructions'] = 'Τα στοιχεία σας πρέπει να υπάρχουν στην βάση δεδομένων.Παρακαλώ, εισάγετε <strong>είτε</strong> το username ή το καταχωρημένο email σας στο κατάλληλο πεδίο. Δεν χρειάζεται να τα εισάγετε και τα δύο ταυτόχρονα.';
...
$string['selectall'] = 'Επελεξέ τα όλα';
...
$string['showreports'] = 'Δείξε αναφορά κίνησης';
...
$string['unknowncategory'] = '¶γνωστη κατηγορία';
...
$string['usersnoaccesssince'] = 'Αδρανής για περισσότερο από';
$string['userzones'] = 'Ζώνες χρηστών';
$string['usethiscourse'] = 'Χρησιμοποιήσε αυτό το μάθημα';
