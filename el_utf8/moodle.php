...
$string['adminhelpcourses'] = 'Δημιουργία μαθημάτων και τμημάτων';
...
$string['adminhelplogs'] = 'Προβολή των αρχείων καταγραφής της ηλεκτρονικής τάξης';
...
$string['block'] = 'Block';
$string['blockconfiga'] = 'Ρύθμιση ενός $a block';
$string['blockconfigbad'] = 'Αυτό το block δεν ρυθμιστεί σωστά.';
$string['blockdeleteconfirm'] = 'Είστε απόλυτα βέβαιος ότι θέλετε να διαγράψετε το block $a? Αυτό θα έχει σαν αποτέλεσμα την πλήρη διαγραφή όλων των πληροφοριών που σχετίζονται με τον λόγω block.';
$string['blockdeletefiles'] = 'Όλες οι πληροφορίες που αφορούν το block $a->block έχουν διαγραφεί. Για την πλήρη διαγραφή (με αυτόν τον τρόπο δεν είναι δυνατή η επανεγκατάσταση του block) του block θα πρέπει να διαγράψετε τον φάκελο $a->directory από τον διακομιστή.';
$string['blocks'] = 'Blocks';
$string['blocksaddedit'] = 'Προσθήκη/Τροποποίηση Block';
$string['blocksediton'] = 'Επεξεργασία block';
...
$string['chooseenrolmethod'] = 'Επιλογή plugin για τις εγγραφές';
...
$string['deletecategorycheck'] = 'Είστε απόλυτα βέβαιος ότι θέλετε να διαγράψετε το Τμήμα <b>\'$a\'</b>?<br /> Αυτό θα έχει σαν αποτέλεσμα την μεταφορά όλων των μαθημάτων στο Γενικό Τμήμα.';
...
$string['edhelpaspellpath'] = 'Για να χρησιμοποιήσετε τον ορθογραφικό έλεγχο στον επεξεργαστή κειμένου, θα πρέπει πρώτα να έχει εγκατασταθεί, στον διακομιστή, το <strong>aspell 0.50 (ή νεώτερη έκδοση)</strong>.';
$string['edhelpbgcolor'] = 'Χρώμα φόντου';
$string['edhelpenablespelling'] = 'Ενεργοποίηση του ορθογραφικού ελέγχου. Αν τον ενεργοποιήσετε θα πρέπει να εγκαταστήσετε, στον διακομιστή, το <strong>aspell</strong>.';
...
$string['enrolments'] = 'Τρόπος εγγραφής';
...
$string['forcepasswordchangehelp'] = 'Προτροπή προς τον φοιτητή για αλλαγή του κωδικού πρόβασης στην επόμενη σύνδεσή του';
...
$string['formatweekscss'] = 'Εβδομαδιαία μορφή (Χρήση CSS)';
...
$string['frontpagedescriptionhelp'] = 'Αυτήν η περιγραφή θα προβάλλεται στην πρώτη σελίδα.';
...
$string['functiondisabled'] = 'Αυτήν η λειτουργία είναι απενεργοποιημένη';
...
$string['gettheselogs'] = 'Προβολή της αναφοράς';
...
$string['groupinfopeople'] = 'Πληροφορίες για τους επιλεγμένες χρήστες';
...
$string['groupnonmembers'] = 'Χρήστε που δεν ανήκουν στην ομάδα';
$string['groupnotamember'] = 'Συγνώμη, αλλά δεν είστε μέλος αυτής της ομάδας';
$string['grouprandomassign'] = 'Τυχαία κατανομή όλων σε ομάδες';
...
$string['guestdescription'] = 'Οι επισκέπτες έχουν τα λιγότερα δυνατά δικαιώματα';
...
$string['healthproblemsdetected'] = 'Ανιχνεύθηκαν προβλήματα';
...
$string['includenoneusers'] = 'Να μην συμπεριλαμβάνονται οι χρήστες';
$string['includeuserfiles'] = 'Συμπερίληψη αρχείων χρηστών';
$string['info'] = 'Πληροφορίες';
$string['institution'] = 'Ινστιτούτο';
...
$string['liketologin'] = 'Θέλετε να συνδεθείτε τώρα στην ηλεκτρονική τάξη?';
...
<OL size=2>
   ...
   <li>Αφού έχετε συνδεθεί, μπορείτε να επιλέξτε το μάθημα στο οποίο θέλετε να εγγραφείτε. Αν σας ζητηθεί ένα \"κλειδί εγγραφής\" - χρησιμοποιήστε αυτό που σας έδωσε ο διδάσκοντας σας.
...
$string['messagedselectedusersfailed'] = 'Παρουσιάστηκε ένα σφάλμα με την αποστολή του μηνύματος στους επιλεγμένους χρήστες. <br /> Να σημειωθεί, ότι ορισμένοι από αυτούς μπορεί να έχουν λάβει το μήνυμα.';
...
$string['missingcategory'] = 'Πρέπει να επιλέξετε ένα τμήμα';
...
$string['missingreqreason'] = 'Λείπει ο λόγος';
...
Έχει δημιουργηθεί ένας καινούριος λογαριασμός χρήστη στο \'$a->sitename\' με ένα προσωρινό κωδικό πρόσβαση.
...
$string['requestedby'] = 'Η αίτηση έγνε από';
$string['requestreason'] = 'Σκοπός για την δημιουργία του μαθήματος';
...
$string['resortcoursesbyname'] = 'Εκ νέου αταξινόμηση μαθημάτων κατά όνομα';
$string['resource'] = 'Πόρος';
$string['resources'] = 'Πόροι';
$string['restore'] = 'Επαναφορά';
$string['restorecancelled'] = 'Η επαναφορά ακυρώθηκε';
$string['restorecoursenow'] = 'Επαναφορά του μαθήματος';
...
$string['settings'] = 'Ρυθμίσεις μαθήματος';
...
$string['site'] = 'Ηλεκτρονική τάξη';
$string['sitedefault'] = 'Προεπιλογή ηλ.τάξης';
$string['siteerrors'] = 'Λάθη ηλ.τάξης';
$string['sitefiles'] = 'Αρχεία ηλ.τάξης';
$string['sitelogs'] = 'Αρχεία καταγραφής ηλ.τάξης';
$string['sitenews'] = 'Νέα της ηλ.τάξης';
...
$string['statsreport2'] = 'Προβολές (από όλους)';
$string['statsreport3'] = 'Μηνύματα (από όλους)';
$string['statsreport4'] = 'Δραστηριότητα (από όλους)';
...
$string['statsreportactivity'] = 'Όλες οι δραστηριότητες (από όλους)';
...
$string['topic'] = 'Θέμα';
$string['topichide'] = 'Απόκρυψη του θέματος από τον/την $a';
...
$string['unenrolallstudentssure'] = 'Είστε απόλυτα βέβαιος ότι θέλετε να αφαιρέσετε όλους τους φοιτητές από το μάθημα?';
$string['unenrolme'] = '$a - ακύρωση της εγγραφής μου';
$string['unenrolsure'] = 'Είστε απόλυτα βέβαιος ότι θέλετε να ακυρώσετε την εγγραφή της/του $a από το μάθημα;';
