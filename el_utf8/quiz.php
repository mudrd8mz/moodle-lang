...
$string['addtoquiz'] = 'Πρόσθεσε στο κουίζ';
...
$string['alternativeunits'] = 'Εναλακτικές μονάδες';
...
$string['attemptselection'] = 'Επέλεξε ποιές προσπάθειες θα αναλυθούν ανά χρήστη';
...
$string['blackboard_6'] = 'Μαυροπίνακας V6+';
...
$string['categorymove'] = 'Η κατηγορία \'$a->name\' περιλαμβάνει $a->count ερωτήσεις. Παρακαλώ επέλεξε άλλη κατηγορία για να τις μετακινήσεις.';
...
$string['showhidden'] = 'Δείξε τις παλιές ερωτήσεις';
