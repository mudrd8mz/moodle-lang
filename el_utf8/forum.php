...
$string['addanewquestion'] = 'Πρόσθεση μιας νέας ερώτησης';
...
$string['allsubscribe'] = 'Γράψου σε όλα τα φόρουμς';
$string['allunsubscribe'] = 'Διαγράψου από όλα τα φόρουμς';
...
$string['disallowsubscribeteacher'] = 'Οι εγγραφές δεν επιτρέπονται (εξαιρούνται οι εκπαιδευτές)';
...
$string['forum:viewdiscussion'] = 'Δές συζητήσεις';
$string['forumintro'] = 'Εισαγωγή ομάδας συζητήσεων';
$string['forumname'] = 'Όνομα ομάδας συζητήσεων';
$string['forumposts'] = 'Δημοσιεύσεις ομάδας συζητήσεως';
$string['forums'] = 'Ομάδες συζητήσεων';
$string['forumsubjecthidden'] = 'Θέμα (κρυφό)';
...
$string['modulenameplural'] = 'Ομάδες συζήτησης';
...
$string['nopostdiscussion'] = 'Συγνώμη, δεν μπορείτε να δημοσιεύσετε σε αυτήν τη συζήτηση';
$string['nopostforum'] = 'Συγνώμη, δεν μπορείτε να δημοσιεύσετε σε αυτό το φόρουμ';
...
$string['posttoforum'] = 'Δημοσίευσε στο φόρουμ';
...
$string['searchphrase'] = 'Αυτή η φράση πρέπει να εμφανίζεται στο μήνυμα';
...
$string['seeallposts'] = 'Δές όλες τις δημοσιεύσεις από αυτόν το χρήστη';
...
$string['unreadpostsone'] = 'Μία μή αναγνωσμένη δημοσίευση';
$string['unsubscribe'] = 'Διαγραφείτε από αυτή την ομάδα συζητήσεων';
$string['unsubscribed'] = 'Αποχώρηση';
$string['unsubscribeshort'] = 'Αποχώρησε';
$string['yesforever'] = 'Ναί, για πάντα';
$string['yesinitially'] = 'Ναί, αρχικά';
$string['youratedthis'] = 'Το αξιολογήσατε';
$string['yournewquestion'] = 'Η νέα σου ερώτηση';
