...
$string['fixsetting'] = 'Παρακαλώ φτιάξτε τις ρυθμίσεις σας στο config.php: <p>Έχετε:</p> <p>\\$CFG->dirroot = \'$a->current\';</p> <p>αλλά θα έπρεπε να είναι:</p> <p>\\$CFG->dirroot = \'$a->found\';</p>';
...
$string['noactivityname'] = 'Το αντικείμενο σελίδας που πηγάζει από την page_generic_activity αλλά δεν έχει ορισμένο το $this->activityname';
...
$string['siteisnotdefined'] = 'Δεν έχει οριστεί ιστοχώρος!';
