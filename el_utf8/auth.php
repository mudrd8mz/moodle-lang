...
$string['alternateloginurl'] = 'Εναλλακτικής σελίδα σύνδεσης';
...
$string['auth_fieldlocks_help'] = '<p>Έχετε τη δυνατότητα να κλειδώσετε κάποια από τα πεδία που χρησιμοποιούνται στην φόρμα εγγραφής των χρηστών. Μ\' αυτόν τον τρόπο, γίνεται πιο εύκολη η συντήρηση της ηλεκτρονικής τάξης στην περίπτωση που ο διαχειριστής επεξεργάζεται χειροκίνητα τα στοιχεία των χρηστών.';
...
$string['chooseauthmethod'] = 'Μέθοδος πιστοποίησης:';
...
$string['passwordhandling'] = 'Χειρισμός του κωδικού πρόσβασης';
