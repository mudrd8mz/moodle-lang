<?PHP // $Id$ 
      // blog.php - created with Moodle 2.0 dev (Build: 20091021) (2009100605)
...
$string['configuseblogassociations'] = 'Permette agli utenti di associare gli interventi blog ai corsi ed ai moduli di attività.';
...
$string['associatewithcourse'] = 'Blog sul corso $a->coursename'; // ORPHANED
$string['associatewithmodule'] = 'Blog su $a->modtype: $a->modname'; // ORPHANED
$string['association'] = 'Associazione'; // ORPHANED
$string['blogaboutthis'] = 'Blog su $a->type'; // ORPHANED
$string['deleteblogassociations'] = 'Elimina associazioni blog'; // ORPHANED
$string['feedisinvalid'] = 'Il feed non è valido'; // ORPHANED
$string['feedisvalid'] = 'Il feed è valido'; // ORPHANED
$string['filtertags'] = 'Tag esterni'; // ORPHANED
$string['modulename'] = 'Blog'; // ORPHANED
$string['nopermissionstodeleteentry'] = 'Non hai i privilegi necessari per eliminare questo intervento'; // ORPHANED
$string['timefetched'] = 'Ultima sincronizzazione'; // ORPHANED
$string['valid'] = 'Valido'; // ORPHANED
$string['viewallmodentries'] = 'Tutti gli interventi su $a->type'; // ORPHANED
