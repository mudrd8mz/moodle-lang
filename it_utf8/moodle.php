<?PHP // $Id$ 
      // moodle.php - created with Moodle 2.0 dev (Build: 20081124) (2008112400)
...
$string['adminhelpedituser'] = 'Visualizza la lista e modifica gli utenti';
$string['adminhelpenrolments'] = 'Scegli la modalità interna o esterna per il controllo delle iscrizioni';
$string['adminhelpenvironment'] = 'Controllare se il vostro server è conforme ai requisiti della corrente o delle future installazioni';
...
$string['areyousuretorestorethis'] = 'Sei sicuro di voler ripristinare i dati?';
...
$string['backupuserfileshelp'] = 'Scegli quali file utente (es immagini profilo) devono essere incluse nei backup automatici';
...
$string['blockdeleteconfirm'] = 'Stai per eliminare il blocco \'$a\'. Questo eliminerà tutto quello che è associato a questo blocco nel database. Sei SICURO di voler continuare?';
$string['blockdeletefiles'] = 'Tutti i dati associati al blocco \'$a->block\' sono stati eliminati dal database. Per completare l\'eliminazione (e prevenire che il blocco si ri-installi da solo), devi eliminare questa directory dal tuo server: $a->directory';
...
$string['categorymodifiedcancel'] = 'La categoria è stata modificata! Annulla e prova ancora.';
...
$string['checkall'] = 'Controlla tutto';
$string['checkingbackup'] = 'Controllo backup';
...
$string['checknone'] = 'Controlla nulla';
...
$string['chooseenrolmethod'] = 'Metodo principale di iscrizione';
...
$string['confirmcheckfull'] = 'Sei assolutamente sicuro di voler confermare $a?';
...
$string['coursecategorydeleted'] = 'Categoria di corsi $a eliminata';
...
$string['courseenrolenddate'] = 'Data termine della iscrizione al corso';
$string['courseenrolstart'] = 'Apertura delle iscrizioni al corso';
$string['courseenrolstartdate'] = 'Data apertura iscrizioni al corso';
$string['coursefiles'] = 'File del corso';
$string['courseformatdata'] = 'Dati tipo di corso';
$string['courseformats'] = 'Tipologie di corso';
$string['coursegrades'] = 'Valutazioni corso';
$string['coursehelpcategory'] = 'Definisce in quale categoria sarà inserito il corso.';
$string['coursehelpenrollable'] = 'Definisce se gli studenti possono iscriversi spontaneamente al corso utilizzando il pluigin di default per l\'auto-iscrizione ai corsi.';
...
$string['coursehelpexpirynotifystudents'] = 'Se è stata stabilita una durata per l\'iscrizione al corso, tramite questa impostazione gli Studenti saranno avvertiti via email quando stanno per raggiungere il termine della durata della propria iscrizione.';
$string['coursehelpexpirythreshold'] = 'Se è stata stabilita una durata per l\'iscrizione al corso, tramite questa impostazione è possibile indicare quanti giorni prima della scadenza sarà inviata la notifica vie email.';
...
$string['coursehelpmaximumupload'] = 'Imposta la dimensione massima dei file che potranno essere caricati nel corso. La dimensione impostata qui non può essere più grande del limite impostato a livello di sito.';
...
$string['coursehelpnotify'] = 'Se è stata stabilita una durata per l\'iscrizione al corso, tramite questa impostazione i Docenti saranno avvertiti via email quando uno studente sta per raggiungere il termine della durata della propria iscrizione.';
...
$string['courseoverview'] = 'Sommario corso';
$string['courseoverviewgraph'] = 'Grafico sommario corso';
...
$string['courserequestsuccess'] = 'Richiesta del corso salvata Selezionare tutti gli elementi che devono essere mostrati come avanzati nella modifica degli elementi di valutazione.. Attendere una mail entro pochi giorni con la risposta';
...
$string['creatingblocksroles'] = 'Assegnazione e sostituzione dei ruoli a livello di blocco';
$string['creatingblogsinfo'] = 'Creazione info di blog';
$string['creatingcategoriesandquestions'] = 'Creazione categorie e domande';
$string['creatingcoursemodules'] = 'Creazione moduli corso';
$string['creatingcourseroles'] = 'Assegnazione e sostituzione dei ruoli a livello di corso';
...
$string['date'] = 'Data';
$string['datechanged'] = 'Data modificata';
...
$string['defaultcourseteacherdescription'] = 'I docenti possono fare tutto all\'interno di un corso, compresi la modifica delle attività e la valutazione degli studenti.';
...
$string['deletecategorycheck2'] = 'Se elimini questa categoria, devi decidere cosa fare con i corsi e le sottocategorie che essa contiene.';
...
$string['deletecoursecheck'] = 'Sei assolutamente sicuro di voler completare l\'eliminazione  di questo corso e di tutti i dati che contiene?';
$string['deleted'] = 'Eliminato';
$string['deletedactivity'] = 'Eliminato $a';
$string['deletedcourse'] = '$a è stato eliminato';
$string['deletednot'] = 'Non è stato possibile eliminare $a !';
$string['deletelogs'] = 'Elimina i logs';
$string['deleteselected'] = 'Elimina i selezionati';
$string['deleteselectedkey'] = 'Elimina chiave selezionata';
$string['deletingcourse'] = 'Eliminazione $a';
...
$string['editorfontsize'] = 'Dimensione carattere standard';
...
$string['forgottenduplicate'] = 'L\'indirizzo email è usato da più account, inserisci lo username';
...
$string['from'] = 'Da';
$string['frontpagecategorycombo'] = 'Lista combinata';
...
$string['frontpagedescriptionhelp'] = 'Questa descrizione del sito verrà mostrata sulla pagina principale.';
$string['frontpageformat'] = 'Formato pagina principale';
$string['frontpageformatloggedin'] = 'Formato pagina principale dopo il login';
...
$string['healthnoproblemsfound'] = 'Non c\'è alcun problema di salute!';
...
$string['helpinterestslist'] = 'Scrivi i tuoi interessi separati da una virgola';
...
$string['modulesetup'] = 'Impostazione tabelle del modulo';
$string['modulesuccess'] = '$a tabelle sono state impostate correttamente';
$string['moodledocs'] = 'Documentazione';
...
$string['participationreport'] = 'Rapporto partecipazione';
...
$string['publicdirectorytitle'] = 'Vedi la lista attuale di siti';
...
$string['secretalreadyused'] = 'Link di conferma cambio password già usato, password non modificata.';
$string['secs'] = 'secondi';
...
$string['selectnos'] = 'Selezionare tutti \'no\'';
$string['selectperiod'] = 'Selezionare periodo';
...
$string['sitefilesused'] = 'File di sito usati in questo corso';
...
$string['statsoff'] = 'Le statistiche non sono attualmente abilitate';
...
$string['statsreport14'] = 'Corsi con maggiore partecipazione (letture/scritture)';
$string['statsreport2'] = 'Letture (docenti e studenti)';
$string['statsreport3'] = 'Scritture (docenti e studenti)';
$string['statsreport4'] = 'Tutta l\'attività (docenti e studenti)';
$string['statsreport5'] = 'Tutta l\'attività studenti (letture e scritture)';
$string['statsreport7'] = 'Attività utenti (letture e scritture)';
...
$string['statsuserwrites'] = 'Scritture';
$string['statswrites'] = 'Scritture';
...
$string['writingscalesinfo'] = 'Scrittura informazioni sulle scale';
