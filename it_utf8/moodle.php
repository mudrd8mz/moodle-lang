...
$string['loginaspasswordexplain'] = '<p>&Egrave; necessario impostare la speciale \"password login come\" per utilizzare questa caratteristica.<br />Se non la conoscete, chiedete al vostro amministatore del server.</p>';
