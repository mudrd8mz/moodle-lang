<?PHP // $Id$ 
      // moodle.php - created with Moodle 2.0 dev (Build: 20081119) (2008111801)
...
$string['backupkeephelp'] = 'Quante versioni di backup vuoi conservare per ciascun corso? (quella più vecchia verrà  cancellata automaticamente)';
...
$string['moduledeleteconfirm'] = 'Stai per cancellare completamente il modulo \'$a\'. Questo cancellerà tutto ciò che nel database è associato al modulo. Sei SICURO di voler continuare?';
$string['moduledeletefiles'] = 'Tutti i dati associati con il modulo \'$a->module\' è stato cancellato dal database. Per completare la cancellazione (e prevenire che il modulo si re-installi automaticamente), devi ora cancellare questa directory dal tuo server: $a->directory';
