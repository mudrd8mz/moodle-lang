...
$string['binimgtoolarge'] = 'Il file dell\'immagine &egrave; troppo grande!';
$string['binnoimg'] = 'Questo &egrave; un formato di file inaccettabile!';
$string['browse'] = 'Naviga';
$string['canceledit'] = 'Annulla';
$string['cannotchangepage'] = 'Questa pagina non pu&ograve; essere modificata.';
...
$string['disabledpage'] = 'Questa pagina non &egrave; attualmente disponibile';
...
$string['editform1'] = 'Prova a non preoccuparti troppo della formattazione, pu&ograve; essere sempre migliorata in seguito.';
...
$string['invalidroot'] = 'Non sei autorizzato ad accedere alla pagina pricipale attuale per cui nessuna mappa del sito pu&ograve; essere creata.';
...
$string['mostoftenchangedpages'] = 'Pagine pi&ugrave; modificate';
$string['mostvisitedpages'] = 'Pagine pi&ugrave; visitate';
$string['newestpages'] = 'Pagine pi&ugrave; recenti';
...
$string['noregexp'] = 'Questo deve essere una stringa fissa (non si pu&ograve; usare * o un espressione regolare), nel migliore dei casi usa l\'indirizzo IP o il nome della macchina attaccante, ma non includere il numero di porta (perch&egrave; &egrave; incrementato ad ogni accesso http).';
$string['notadministratewiki'] = 'Non ti &egrave; permesso amministrare questo Wiki!';
$string['nothingtostrip'] = 'Non ci sono pagine con pi&ugrave; di una versione.';
$string['nowikicreated'] = 'Nulla &egrave; stato creato ancora per questo Wiki.';
$string['of'] = 'di';
...
$string['removenotice'] = 'Nota che solo le pagine non referenziate saranno elencate qui. E siccome il motore ewiki effettua solo una prova limitata se la pagina &egrave; referenziata qualcuna potrebbe mancare qui.<br /> Se hai svuotato una pagina prima, potrebbe essere ancora elencata qui comunque. Altre diagnostiche sulla base dati sono fatte.';
...
$string['thispageisntlinkedfromanywhereelse'] = 'Questa pagina non &egrave; collegata da nessuna parte.';
$string['updatedpages'] = 'Pagine aggiornate';
$string['updatedwikipages'] = 'Pagine wiki aggiornate';
$string['uplerror'] = 'Siamo spiacenti, ma qualcosa &egrave; andato storto durante il trasferimento del file.';
...
$string['uplok'] = 'Il tuo file &egrave; stato trasferito correttamente.';
$string['version'] = 'Versione';
$string['versionrangetoobig'] = 'Non &egrave; possibile cancellare tutte le versioni di una pagina! L\'ultima versione deve rimanere.';
...
$string['wikiexportcomment'] = 'Qui si pu&ograve; impostare le tue preferenze sull\'esportazione';
$string['wikilinkoptions'] = 'Opzioni di auto-collegamento Wiki';
$string['wikilinks'] = 'Collegamenti Wiki';
$string['wikiname'] = 'Nome pagina';
$string['wikistartederror'] = 'Esitono wiki - non &egrave; possibile canbiare.';
