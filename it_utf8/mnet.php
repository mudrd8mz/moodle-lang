...
$string['deleteoutoftime'] = 'L\'intervallo di tempo di 60 secondi per eliminare questa chiave è scaduto. Ricomincia di nuovo.';
$string['deleteuserrecord'] = 'SSO ACL: eliminazione iscrizione dell\'utente \'$a[0]\' per $a[1].';
$string['deletewrongkeyvalue'] = 'Si è verificato un errore. Se non stavi cercando di eliminare la chiave SSL del tuo server, è possibile che sei stato oggetto di un attacco hacker. Non è stata eseguita alcuna azione.';
...
$string['error7020'] = 'Questo errore di norma compare se il sito remoto ha creato un record per il tuo sito  usando una wwwroot errata, ad esempio, http://iltuosito.com invece di http://www.iltuosito.com. Dovresti contattare l\'amministratore del sito remoto e comunicargli la wwwroot giusta (è definita nella config.php) in modo che possa correggere il record del tuo host.';
$string['error7022'] = 'Il messaggio che hai inviato all\'host remoto è stato criptato ma non è stato firmato. Ciò è davvero insolito:  se il problema si dovesse verificare nuovamente, forse dovresti inserire un bug nel Tracker fornendo il maggior numero di informazioni possibile sulla  versione di Moodle in uso.';
...
$string['keydeleted'] = 'La tua chiave è stata eliminata e sostituita con una nuova.';
