...
$string['description'] = '<p>Si può usare un server LDAP per controllare le vostre iscrizioni. Viene presupposto che l\'albero LDAP contenga gruppi che corrispondano ai corsi, e che ognuno di questi gruppi/corsi abbia la sua istanza di appartenenza per corrispondere agli studenti.</p>
