...
Il compito &egrave; disponibile al link:

$a->url';
$string['emailteachermailhtml'] = '$a->username ha consegnato il suo compito per <i>\'$a->assignment\'</i><br /><br />Il compito &egrave; <a href=\"$a->url\">disponibile sul sito web</a>.';
$string['emailteachers'] = 'Avvisi ai docenti via email';
$string['emptysubmission'] = 'Non avete ancora inviato niente';
$string['existingfiledeleted'] = 'Il file esistente &egrave; stato cancellato: $a';
...
$string['uploaderror'] = 'Si &egrave; verificato un errore durante il salvataggio del file sul server.';
$string['uploadfailnoupdate'] = 'Il file &egrave; stato trasferito con successo ma non &egrave; stato possibile aggiornarlo!';
$string['uploadfiletoobig'] = 'Spiacenti, ma il file &egrave; troppo grande (il limite &egrave;  $a bytes)';
...
$string['uploadnotregistered'] = '\'$a\' &egrave; stato trasferito ma la registrazione non &egrave; avvenuta!';
