...
$string['arrangebuttonshorizontally'] = 'Posiziona i pulsanti di ramo orizzontalmente nella modalit&agrave;  diapositive?';
...
$string['canretake'] = 'Possibilit&agrave;  di riprovare la lezione';
...
$string['completethefollowingconditions'] = '&Egrave; necessario completare le seguenti condizioni nella lezione <b>$a</b> prima di poter procedere.';
...
$string['deadline'] = 'al';
$string['defaultessayresponse'] = 'Il tuo testo sar&agrave;  valutato dal docente del corso.';
...
$string['displayscorewithessays'] = 'Hai ottenuto $a->score su $a->tempmaxgrade per le domande valutate automaticamente.<br>Le tue $a->essayquestions domande di solo testo saranno valutate prossimamente e il voto aggiunto<br />nel tuo punteggio finale.<br /><br />La tua valutazione attuale senza le domande testo &egrave; $a->score su $a->grade';
$string['displayscorewithoutessays'] = 'Il tuo punteggio &egrave; $a->score (su $a->grade).';
...
$string['eolstudentoutoftime'] = 'Attenzione: Il tuo tempo per questa lezione &egrave; scaduto. L\'ultima risposta pu&ograve; non essere stata contata se data dopo lo scadere del tempo.';
...
$string['firstwrong'] = 'Sfortunatamente non puoi ottenere punti, perch&egrave; la tua risposta non &egrave; corretta. Vuoi continuare a provare per il solo piacere di imparare (ma non per migliorare il tuo punteggio)?';
...
$string['gradeis'] = 'Il voto &egrave; $a';
...
$string['lessonclosed'] = 'Questa lezione &egrave; stata chiusa il $a.';
...
$string['lessonopen'] = 'Questa lezione sar&agrave;  disponibile dal $a.';
$string['lessonopens'] = 'La lezione &egrave; disponibile';
...
$string['modattempts'] = 'Possibilit&agrave;  di rivedere la lezione';
...
$string['multianswer'] = 'Risposta multipla con pi&ugrave; scelte';
$string['multipleanswer'] = 'Risposta multipla';
$string['nameapproved'] = 'Nome accettato';
$string['namereject'] = 'Spiacente, il tuo nome &egrave; stato rifiutato dal filtro.<br />Prova un altro nome.';
$string['nextpage'] = 'Pagina seguente';
$string['noanswer'] = 'Non &egrave; stata data una risposta';
$string['noattemptrecordsfound'] = 'Nessun tentativo trovato: Nessun voto &egrave; stato dato';
...
$string['passwordprotectedlesson'] = '$a &egrave; una lezione protetta da password.';
$string['pleasecheckoneanswer'] = 'Scegli una risposta';
$string['pleasecheckoneormoreanswers'] = 'Scegli una o pi&ugrave; risposte';
...
$string['sanitycheckfailed'] = 'Controllo di correttezza fallito: Questo tentativo &egrave; stato cancellato';
...
$string['studentoutoftime'] = 'Attenzione: hai superato il tempo previsto per questa lezione. La tua ultima risposta non conta perch&egrave; &egrave; stata data dopo lo scadere del tempo. Clicca su Continua per terminare la lezione.';
$string['studentresponse'] = 'Risposta di {$a}';
$string['submitname'] = 'Immetti il nome';
$string['teacherjumpwarning'] = 'In questa lezione si sta utilizzando un salto a $a->cluster o un salto a $a->unseen.  Sar&agrave;  invece utilizzato il salto alla Pagina seguente.  Login come uno studente per verificare questi salti.';
$string['teacherongoingwarning'] = 'Il punteggio corrente &egrave; mostrato solamente agli studenti. Login come uno studente per verificare tale punteggio';
...
$string['youhaveseen'] = 'Hai gi&agrave;  visto pi&ugrave; di una pagina di questa lezione .<br />Vuoi iniziare dall\'ultima pagina visitata? ';
$string['youmadehighscore'] = 'Fatto sulla lista dei $a voti migliori.';
$string['youranswer'] = 'La tua risposta';
$string['yourcurrentgradeis'] = 'La tua attuale valutazione &egrave; $a';
$string['yourgradeisnow'] = 'La tua valutazione per la lezione &egrave; stata cambiata in $a';
