...
$string['cannotviewpostyet'] = 'Non è possibile ancora  leggere le domande degli altri studenti in questa discussione perché non avete ancora inviato messaggi';
$string['configcleanreadtime'] = 'L\'ora del giorno in cui vengono ripuliti i vecchi messaggi dalla tabella \'lettura\'.';
$string['configdisplaymode'] = 'La modalità  di visualizzazione di default per le discussioni se nessuna è impostata.';
...
$string['configlongpost'] = 'Ogni messaggio oltre questa lunghezza (escludendo l\'HTML) è considerato lungo.';
...
$string['configshortpost'] = 'Ogni messaggio sotto questa lunghezza (escludendo l\'HTML) è considerato corto.';
...
$string['emptymessage'] = 'Qualche è andato storto con il tuo messaggio. Forse lo hai lasciato in bianco, oppure l\'allegato era troppo grande.I tuoi cambiamenti NON sono stati salvati.';
...
$string['qandanotify'] = 'Questo è un forum Domande e Risposte. Per poter vedere le altre risposte a queste Domande, è necessario inviare prima la vostra Risposta.';
$string['rate'] = 'Vota';
...
$string['warnafter'] = 'Limite messaggi per avvertimento';
