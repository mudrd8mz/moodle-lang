...
$string['configreplytouser'] = 'Quando un messaggio del forum viene inviato via mail, deve contenere l\'indirizzo mail dell\'utente in modo che il ricevente possa replicare anche senza usare il forum? Se &egrave; impostato \"Si\" gli utenti possono scegliere nel loro profilo di mantenere il proprio indirizzo mail segreto.';
$string['configshortpost'] = 'Ogni messaggio sotto questa lunghezza (escludendo l\'HTML) &egrave; considerato corto.';
...
$string['deletedpost'] = 'Il messaggio &egrave; stato cancellato.';
...
$string['digestmailheader'] = 'Questa &egrave; le tua raccolta giornaliera di posta con i nuovi messaggi dai forum di $a->sitename. Se vuoi  cambiare le preferenze della mail dei forum, vai a $a->userprefs. ';
...
$string['discussionmoved'] = 'Questa discussione &egrave; stata spostata in \'$a\'';
...
$string['eachuserforum'] = 'Ogni persona pu&ograve; iniziare una discussione';
$string['edit'] = 'Modifica';
$string['editedby'] = 'Modificato da $a->name - $a->date';
$string['editing'] = 'Modifica';
$string['emptymessage'] = 'Qualche &egrave; andato storto con il tuo messaggio. Forse lo hai lasciato in bianco, oppure l\'allegato era troppo grande.I tuoi cambiamenti NON sono stati salvati.';
$string['everyonecanchoose'] = 'Tutti possono scegliere l\'iscrizione';
$string['everyoneissubscribed'] = 'Iscrizione obbligatoria a questo forum in quanto ci&ograve; &egrave; previsto dal docente';
...
$string['maxtimehaspassed'] = 'Spiacenti ma il tempo massimo concesso per modificare questo messaggio ($a) &egrave; trascorso!';
...
$string['modeflatnewestfirst'] = 'Mostra le repliche in formato lineare, con i messaggi pi&ugrave; recenti per prima';
$string['modeflatoldestfirst'] = 'Mostra le repliche in formato lineare, con i messaggi pi&ugrave; vecchi per prima';
...
$string['noguestpost'] = 'Spiacenti, agli ospiti non &egrave; concesso spedire messaggi.';
$string['noguestsubscribe'] = 'Spiacenti, agli ospiti non &egrave; concesso sottoscrivere l\'opzione \'Invia mesasaggi per e-mail\'.';
$string['noguesttracking'] = 'Spiacenti, agli ospiti non &egrave; concesso impostare opzioni di tracciamento.';
$string['nomorepostscontaining'] = 'Non sono stati trovati altri messaggi contenenti \'$a\'';
$string['nonews'] = 'Nessuna News &egrave; stata ancora spedita';
$string['noposts'] = 'Nessun messaggio';
$string['nopostscontaining'] = 'Nessun messaggio contenente \'$a\' &egrave; stato trovato';
...
$string['postadded'] = 'Il tuo messaggio &egrave; stato aggiunto con successo.<br />Hai $a  a disposizione se desideri apportare delle modifiche.';
$string['postincontext'] = 'Vedi questo messaggio nel contesto';
$string['postmailinfo'] = 'Questa &egrave; una copia del messaggio postato su $a .
...
$string['postupdated'] = 'Il tuo messaggio &egrave; stato aggiornato';
...
$string['prunedpost'] = 'Una nuova discussione &egrave; stata creata da quel messaggio';
...
$string['ratingonlyteachers'] = 'Solo $a pu&ograve; valutare i messaggi';
$string['ratingpublic'] = '$a pu&ograve; vedere le valutazioni di tutti';
$string['ratingpublicnot'] = '$a pu&ograve; vedere solo le sue valutazioni';
$string['ratings'] = 'Voti';
...
$string['search'] = 'Cerca';
$string['searchdatefrom'] = 'Messaggi devono essere pi&ugrave; nuovi di questo';
$string['searchdateto'] = 'Messaggi devono essere pi&ugrave; vecchi di questo';
$string['searchforumintro'] = 'Si prega di inserire i termini di ricerca in uno o pi&ugrave; d\'uno dei seguenti campi:';
...
$string['showsubscribers'] = 'Mostra/modifica chi &egrave; iscritto';
