...
$string['allowchoice'] = 'Rendi facoltativa l\'iscrizione al forum';
...
$string['allowsallsubscribe'] = 'Questo forum è ad iscrizione facoltativa';
$string['allowsdiscussions'] = 'Questo forum permette a tutti di iniziare una nuova discussione.';
$string['allsubscribe'] = 'Iscriviti a tutti i forum';
$string['allunsubscribe'] = 'Disiscriviti da tutti i forum';
...
$string['everyonecannowchoose'] = 'L\'iscrizione al forum è ora facoltativa per tutti';
$string['everyoneisnowsubscribed'] = 'L\'iscrizione al forum è ora obbligatoria per tutti';
$string['everyoneissubscribed'] = 'Forum ad iscrizione obbligatoria';
$string['existingsubscribers'] = 'Utenti iscritti';
$string['forcessubscribe'] = 'Questo forum è ad iscrizione obbligatoria';
$string['forcesubscribe'] = 'Rendi obbligatoria l\'iscrizione al forum';
$string['forcesubscribeq'] = 'Iscrizione obbligatoria';
$string['forum'] = 'Forum';
...
$string['messageprovider:digests'] = 'Raccolte forum iscritti';
$string['messageprovider:posts'] = 'Interventi forum iscritti';
...
$string['nopermissiontosubscribe'] = 'Non hai il permesso per vedere gli iscritti al forum';
...
$string['noquestions'] = 'Al momento questo forum non ha iscritti';
...
$string['nosubscribers'] = 'Al momento questo forum non ha iscritti';
...
$string['nownotsubscribed'] = 'L\'utente $a->name è stato disiscritto e NON riceverà più email dal forum \'$a->forum\'.';
$string['nownottracking'] = '$a->name non sta più tracciando \'$a->forum\'.';
$string['nowsubscribed'] = 'L\'utente $a->name è stato iscritto e riceverà email dal forum \'$a->forum\'.';
...
$string['postmailnow'] = '<p>L\' intervento sarà inviato immediatamente nelle email degli iscritti al forum.</p>';
...
$string['showsubscribers'] = 'Visualizza e modifica le iscrizioni al forum';
...
$string['subscribed'] = 'Iscrizione';
$string['subscribenone'] = 'Disiscrivi tutti da questo forum';
$string['subscribers'] = 'Iscritti';
$string['subscribersto'] = 'Iscritti al forum \'$a\'';
$string['subscribestart'] = 'Iscrivimi al forum e spediscimi copia degli interventi';
$string['subscribestop'] = 'Non iscrivermi al forum e non spedirmi copia degli interventi';
