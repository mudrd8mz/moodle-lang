...
$string['auth_cas_invalidcaslogin'] = 'Spiacente, il login &egrave; fallito - non potete essere autorizzati';
...
$string['auth_dbpasstype'] = 'Specifica il formato usato per il campo password. La criptatura MD5 &egrave; utile per connettersi con altre applicazioni web come PostNuke';
...
$string['auth_emaildescription'] = 'La conferma tramite email &egrave; il metodo di autenticazione di default. Quando l\'utente si iscrive, scegliendo il suo nome utente e la password, un email di conferma viene spedita all\'indirizzo di posta elettronica dell\'utente. Questa email contiene un link sicuro a una pagina dove l\'utente pu&ograve; confermare la sua iscrizione. Ai successivi login verranno controllati il nome utente e la password con i valori salvati nella base di dati di Moodle.';
$string['auth_emailtitle'] = 'Autenticazione via email';
$string['auth_fccreators'] = 'Elenca i gruppi dei membri abilitati alla creazione di nuovi corsi. Separa gruppi multipli con \';\'. I nomi devo essere scritti esattamente come sul server FirstClass. Il sistema &egrave; sensibile alla capitalizzazione. ';
...
$string['auth_ldap_gracelogins_desc'] = 'Abilita il supporto del gracelogin di LDAP. Dopo che  la password &egrave; scaduta l\'utente pu&ograve; accedere finch&egrave; il contatore gracelogin non &egrave; a 0. Abilitando questa impostazione viene mostrato il messaggio di garanzia d\'accesso se la passoword &egrave; scaduta.';
...
$string['auth_nntpport'] = 'Porta server (119 &egrave; la pi&ugrave; comune)';
$string['auth_nntptitle'] = 'Usa un server NNTP';
$string['auth_nonedescription'] = 'Gli utenti possono registrarsi e creare iscrizioni valide immediatamente, senza autenticazione di un server esterno e senza conferma tramite email. Fare attenzione ad usare questa opzione - riflettete sulla sicurezza e ai problemi di amministrazione che questa scelta pu&ograve; causare. ';
...
$string['stdchangepassword_explldap'] = 'Nota: Si raccomanda di utilizzare LDAP su una connessione criptata con SSL (ldaps://) se il server &egrave; remoto.';
