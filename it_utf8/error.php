...
$string['adminprimarynoedit'] = 'L\'amministratore principale non pu&ograve; essere modificato dagli altri';
$string['confirmsesskeybad'] = 'Spiacente, ma la vostra chiave di sessione non pu&ograve; essere confermata per completare questa operazione. Questa caratteristica di sicurezza previene l\'esecuzione accidentale o maligna di funzioni importanti effettuate a vostro nome. Assicuratevi di voler eseguire realmente questa funzione.';
$string['coursegroupunknown'] = 'Il corso corrisponde a un gruppo $a non specificato';
$string['errorcleaningdirectory'] = 'Si &egrave; verificato un errore svuotando la cartella \"$a\"';
$string['errorcopyingfiles'] = 'Si &egrave; verificato un errore copiando i file';
$string['errorcreatingdirectory'] = 'Si &egrave; verificato un errore creando la cartella \"$a\"';
$string['errorcreatingfile'] = 'Si &egrave; verificato un errore creando il file \"$a\"';
$string['erroronline'] = 'Errore alla linea $a';
$string['errorreadingfile'] = 'Si &egrave; verificato un errore leggendo il file \"$a\"';
...
$string['invalidxmlfile'] = '\"$a\" non &egrave; file XML valido';
$string['missingfield'] = 'Manca il campo \"$a\"';
$string['modulerequirementsnotmet'] = 'Il modulo \"$a->modulename\" ($a->moduleversion) non pu&ograve; essere installato. Richiede una versione pi&ugrave; aggiornata di Moodle (attualmente state usando $a->currentmoodle, mentre servirebbe $a->requiremoodle).';
$string['nonmeaningfulcontent'] = 'Contenuto senza significato';
$string['notavailable'] = 'Non &egrave; attualmente disponibile';
...
$string['processingstops'] = 'L\'elaborazione si &egrave; fermata qui. Rimangono dei record ignorati.';
