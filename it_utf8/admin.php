<?PHP // $Id$ 
      // admin.php - created with Moodle 2.0 dev (Build: 20081104) (2008101300)
...
$string['cannotdeleteqtypeinuse'] = 'Il tipo domanda \'$a\' non può essere cancellato. Ci sono domande di questo tipo nel banco delle domande.';
$string['cannotdeleteqtypeneeded'] = 'Il tipo domanda \'$a\' non può essere cancellato. Ci sono altri tipi domande istallati basati su di esso.';
...
$string['configallowoverride2'] = 'Seleziona i ruoli che possono essere modificati da ciascun ruolo della colonna sinistra.<br>Da notare che queste impostazioni si applicano solamente agli utenti che hanno i privilegi moodle/role:override oppure moodle/role:safeoverride.';
...
$string['configkeeptagnamecase'] = 'Marca questa opzione se vuoi che i nomi delle Tag mantengano i caratteri maiuscoli/minuscoli come definiti dall\'utente che li ha creati.';
...
$string['configusetags'] = 'Funzionalità delle Tags nel sito.';
...
$string['uninstallqtype'] = 'Disinstalla questo tipo domanda.';
...
$string['usersdeleted'] = 'Utenti cancellati';
