...
$string['configenablerssfeedsdisabled'] = 'Non è attiva poiché l\'generatore RSS è disabilitato in tutto il sito. Per attivarlo, andate in \'configura variabili\' nel pannello di Amministrazione.';
...
$string['configgradeexport'] = 'Scegliere quali formati di esportazione del registro delle valutazioni costituiscono i metodi principali per esportare le valutazioni. I plugins scelti saranno impostati e useranno un campo \"ultima esportazione\" per ogni valutazione. Per esempio, questo può far sì che records esportati siano identificati come \"nuovi\" o \"aggiornati\". Se non si è sicuri, lasciare non marcati tutti i box.';
...
$string['enablehtmlpurifier'] = 'Abilita Purifier HTML';
...
$string['gradeexport'] = 'Metodi principali di esportazione valutazioni';
...
$string['usetags'] = 'Abilita funzionalità Tag';
$string['uubulk'] = 'Seleziona per operazioni blocco';
...
$string['uunoemailduplicates'] = 'Impedisci indirizzi email duplicati';
$string['uuoptype'] = 'Tipo upload';
$string['uuoptype_addinc'] = 'Aggiungi tutti, se necessario con un contatore sugli username';
$string['uuoptype_addnew'] = 'Aggiungi solo i nuovi, salta utenti esistenti';
$string['uuoptype_addupdate'] = 'Aggiungi i nuovi e aggiorna utenti esistenti';
$string['uuoptype_update'] = 'Aggiorna solo utenti esistenti';
$string['uupasswordnew'] = 'Nuova password utente';
$string['uupasswordold'] = 'Password utente esistente';
$string['uupreprocessedcount'] = 'Numero di record preelaborati: $a';
$string['uuupdateall'] = 'Sostituisci con file e default';
$string['uuupdatefromfile'] = 'Sostituisci con file';
$string['uuupdatetype'] = 'Dettagli utente esistenti';
$string['validateerror'] = 'Questo valore non era valido:';
$string['verifychangedemail'] = 'Verifica il dominio quando si cambia l\'email';
