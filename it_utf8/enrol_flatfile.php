...
$string['description'] = 'Questo metodo controlla ripetutamente e elabora un file di testo scritto in un formato speciale e rintracciabile nel percorso specificato. Il file pu&ograve; avere un aspetto simile a questo:
<pre>
add, student, 5, CF101
add, teacher, 6, CF101
...
$string['filelockedmail'] = 'Il file di testo che stai utilizzando per le registrazioni ($a) non pu&ograve; essere rimosso dal processo di cron. Questo normalmente significa che i permessi sono sbagliati. Prego correggi i permessi in modo che Moodle possa cancellare il file, altrimenti potrebbe essere processano ripetutamente.';
