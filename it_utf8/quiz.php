...
$string['confirmstartlimit'] = 'Questo quiz ha un tempo limite ed &egrave; limitato a $a tentativi. Entrando nel quiz questo verr&agrave; contato come un tentativo. Sei sicuro di voler iniziare?';
$string['confirmstartnolimit'] = 'Questo quiz &egrave; limitato a $a tentativi. Entrando nel quiz questo verr&agrave; contato come un tentativo. Sei sicuro di voler iniziare?';
...
$string['temporaryblocked'] = 'Temporaneamente non vi &egrave; permesso ritentare il quiz.<br />Potrete tentare nuovamente al:';
$string['time'] = 'Ora';
$string['timecompleted'] = 'Completato';
$string['timedelay'] = 'Non vi &egrave; permesso accedere al quiz finch&eacute; non sar&agrave; passato il tempo per poter accedere a un altro quiz';
