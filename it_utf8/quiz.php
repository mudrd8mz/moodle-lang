<?PHP // $Id$ 
      // quiz.php - created with Moodle 2.0 dev (Build: 20081216) (2008121000)
...
$string['aftereachquestion'] = 'Dopo l\'aggiunta di ogni domanda';
$string['afternquestions'] = 'Dopo l\'aggiunta di $a domande';
$string['age'] = 'età';
$string['aiken'] = 'Aiken';
...
$string['aon'] = 'AON';
$string['areyousuredeleteselected'] = 'Confermi l\'eliminazione delle domande selezionate?';
...
$string['orderandpaging'] = 'Ordinamento e paginazione';
$string['orderingquiz'] = 'Ordinamento e paginazione';
...
$string['questionbankcontents'] = 'Contenuti Banco domande';
$string['questionbankmanagement'] = 'Gestione Banco domande';
...
$string['questionsperpageselected'] = 'E\' stato definito il numero di domande per pagina per cui la paginazione è al momento bloccata. Come risultato, i controlli per la paginazione sono stati disabilitati. Questo si può cambiare in $a.';
...
$string['shufflequestionsx'] = 'Domande in ordine casuale: $a';
