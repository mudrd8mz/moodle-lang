...
$string['alreadysubmitted'] = '&Egrave; probabile che tu abbia gi&agrave;  inviato questo tentativo';
$string['alternativeunits'] = 'Unit&agrave;  alternative';
...
$string['attemptincomplete'] = 'Quel tentativo (di $a) non &egrave; stato ancora completato.';
...
$string['attemptsexist'] = 'Questo quiz &egrave; gi&agrave;  stato tentato<br />Non puoi pi&ugrave; aggiungere o cancellare domande.';
...
$string['calculatedquestion'] = 'Domanda calcolata non supportata alla linea $a. La domanda sar&agrave;  ignorata.';
...
$string['categorynoedit'] = 'Non hai la facolt&agrave;  di aggiornare la categoria \'$a\'.';
$string['categoryupdated'] = 'La categoria &egrave; stata aggiornata con successo';
...
$string['confirmclose'] = 'Stai per completare questo tentativo. Una volta chiuso non potrai pi&ugrave; cambiare le tue risposte.';
...
$string['containercategorycreated'] = 'Questa categoria &egrave; stata creata per contenere tutte le originali categorie spostate a livello di sito a causa di quanto sotto specificato.';
...
$string['correctanswershows'] = 'La risposta corretta avr&agrave; ';
$string['corrresp'] = 'Risposta Corretta';
$string['countdown'] = 'Conto alla rovescia';
$string['countdownfinished'] = 'Il quiz &egrave; terminato, devi inviare le tue risposte ora.';
$string['countdowntenminutes'] = 'Il quiz terminer&agrave;  tra dieci minuti';
...
$string['downloadextra'] = '(il file &egrave; anche salvato nei files del corso nella cartella /quiz)';
$string['duplicateresponse'] = 'Questo invio &egrave; stato ignorato perch&egrave; hai  dato una risposta equivalente precedentemente.';
...
$string['existingcategory1'] = 'Un letterale da un insieme di letterali esistenti &egrave; stato usato anche da altre domande in questa categoria';
$string['existingcategory2'] = 'Un file da un insieme di file esistenti &egrave; stato  usato anche da altre domande in questa categoria ';
$string['existingcategory3'] = 'Un collegamento da un insieme di collegamenti esistenti &egrave; stato usato anche da altre domande in questa categoria';
...
$string['fractionsnomax'] = 'Una delle risposte deve essere 100%%, perch&egrave; sia<br />possibile una votazione piena per questa domanda.<br />Vuoi tornare indietro e correggere?';
...
$string['gradehighest'] = 'Voto pi&ugrave; alto';
$string['grademethod'] = 'Metodo di valutazione';
$string['gradingdetails'] = 'Valutazione di questo invio: $a->raw/$a->max. ';
$string['gradingdetailsadjustment'] = 'Tenendo conto delle penalit&agrave;  precedenti, questo d&agrave;  <strong>$a->cur/$a->max</strong>. ';
$string['gradingdetailspenalty'] = 'Questo invio ha ricevuto una penalit&agrave;  di $a. ';
...
$string['imagemissing'] = 'Immagine non disponibile alla linea $a. Il nome del file sar&agrave;  ignorato';
$string['importmax10error'] = 'C\'&egrave; un errore nella domanda. Non puoi avere pi&ugrave; di dieci risposte';
$string['importmaxerror'] = 'C&egrave; un errore nella domanda. Ci sono troppe risposte.';
$string['importminerror'] = 'C\'&egrave; un errore nella domanda. Non ci sono abbastanza risposte per questo tipo di domanda';
...
$string['invalidsource'] = 'Il sorgente non &egrave; accettato come valido.';
...
$string['lastanswer'] = 'La tua ultima risposta &egrave; stata';
...
$string['name'] = 'Nome';
$string['newattemptfail'] = 'Errore: Un nuovo tentativo del quiz non pu&ograve; iniziare';
$string['newcategory1'] = 'una lettera da un nuovo insieme di lettere che pu&ograve; essere usata anche da altre domande in questa categoria';
$string['newcategory2'] = 'un file da un nuovo insieme di files che pu&ograve; essere usato anche da altre domande in questa categoria';
$string['newcategory3'] = 'un link da un nuovo insieme di links che pu&ograve; essere usato anche da altre domande in questa categoria';
$string['newlocal1'] = 'una lettera da un nuovo insieme di lettere che sar&agrave;  usata solo da questa domanda';
$string['newlocal2'] = 'un file da un nuovo insieme di files che sar&agrave;  usato solo da questa domanda';
$string['newlocal3'] = 'un link da un nuovo insieme di links che sar&agrave;  usato solo da questa domanda';
$string['noanswers'] = 'Non &egrave; stata selezionata nessuna risposta!';
$string['noattempts'] = 'Nessun tentativo &egrave; stato fatto per questo quiz';
$string['noattemptstoshow'] = 'Non ci sono tentativi da mostrare';
$string['noconnection'] = 'Al momento non c\'&egrave; connessione con un web service che pu&ograve; elaborare questa domanda. Contatta il tuo amministratore di sistema';
$string['nodataset'] = 'niente - non &egrave; un metacarattere';
...
$string['notavailable'] = 'Spiacente, questo quiz non &egrave; disponibile';
$string['notavailabletostudents'] = 'Nota: Attualmente questo quiz non &egrave; disponibile agli studenti';
...
$string['notimedependentitems'] = 'Elementi dipendenti dal tempo non sono attualmente supportati dal modulo quiz. Nel frattempo si pu&ograve; fissare un limite di tempo per l\'intero quiz. Preferisci scegliere un elemento differente (o usare lo stesso l\'elemento corrente)?';
$string['numberabbr'] = '#';
...
$string['paragraphquestion'] = 'Domanda paragrafo non supportata alla linea $a. La domanda sar&agrave;  ignorata';
$string['parent'] = 'Superiore';
$string['partiallycorrect'] = 'Parzialmente corretto';
$string['passworderror'] = 'La password inserita non &egrave; corretta';
$string['penalty'] = 'Penalit&agrave; ';
$string['penaltyfactor'] = 'Fattore di penalit&agrave; ';
$string['penaltyscheme'] = 'Penalit&agrave; ';
$string['percentcorrect'] = 'Percentuale corretta';
$string['pleaseclose'] = 'La tua richiesta &egrave; stata elaborata. Ora puoi chiudere questa finestra';
...
$string['questioninuse'] = 'La domanda \'$a->questionname\' &egrave; attualmente usata in: <br />$a->quiznames<br />La domanda non sar&agrave;  cancellata da tali quiz ma solamante dalla categoria.';
$string['questionname'] = 'Nome della domanda';
$string['questionnametoolong'] = 'Nome domanda troppo lungo alla linea $a (255 caratteri max). Sar&agrave;  troncata.';
$string['questions'] = 'Domande';
$string['questionsinuse'] = '(* Le domande evidenziate con un asterisco sono gi&agrave;  utilizzate da qualche quiz. Le domande non saranno cancellate da tali quiz ma solamente dalla categoria.)';
...
$string['quizavailable'] = 'Il quiz &egrave; disponibile fino a: $a';
$string['quizclose'] = 'Chiusura';
$string['quizclosed'] = 'Il quiz &egrave; stato chiuso il $a';
$string['quizcloses'] = 'Quiz chiuso';
$string['quiznotavailable'] = 'Il quiz non sar&agrave;  disponibile fino a: $a';
...
$string['renderingserverconnectfailed'] = 'Il server $a non &egrave; riuscito ad elaborare una richiesta RQP. Controlla la correttezza del URL.';
...
$string['requirepasswordmessage'] = 'Per tentare questo quiz &egrave; necessario conoscere la password d\'accesso.';
...
$string['reviewafter'] = 'Permetti revisione dopo che il quiz &egrave; stato chiuso';
...
$string['reviewclosed'] = 'dopo che il quiz &egrave; stato chiuso';
...
$string['reviewopen'] = 'dopo, mentre il quiz &egrave; ancora aperto';
...
$string['serverinuse'] = 'Il server che stai per cancellare &egrave; l\'ultimo server $a e ci sono domande che non funzioneranno pi&ugrave; se cancelli questo server.';
...
$string['subneterror'] = 'Spiacente, questo quiz &egrave; bloccato in modo da essere accessibile solo da certi indirizzi di rete. Attualmente i tuo computer non &egrave; abilitato all\'utilizzo di questo quiz. ';
$string['subnetnotice'] = 'Questo quiz &egrave; bloccato in modo da essere accessibile solo da certi indirizzi di rete. Il tuo computer non &egrave; su una sotto-rete abilitata. Comunque come insegnante puoi vedere l\'anteprima.';
$string['substitutedby'] = 'sar&agrave;  sostituito da';
$string['time'] = 'Ora';
$string['timecompleted'] = 'Completato';
$string['timeleft'] = 'Tempo rimasto';
$string['timelimit'] = 'Tempo limite';
$string['timelimitexeeded'] = 'Spiacente! Il tempo per il quiz &egrave; esaurito!';
...
$string['toomanyrandom'] = 'Il numero di domande casuali richieste &egrave; maggiore di quello  delle domande contenute in questa categoria! ($a)';
$string['top'] = 'Top';
$string['true'] = 'Vero';
...
$string['unit'] = 'Unit&agrave; ';
$string['unknowntype'] = 'Tipo di domanda non supportato alla linea $a. La domanda sar&agrave;  ignorata';
$string['unsupportedformulafunction'] = 'La funzione $a non &egrave; supportata';
$string['unusedcategorydeleted'] = 'Questa categoria &egrave; stata soppressa perch&egrave;, dopo la cancellazione del corso, le domande in essa presenti non erano pi&ugrave; utilizzate da nessuno.';
$string['upgradesure'] = '<div style=\"color: red;\">In particolare il modulo quiz  eseguir&agrave;  cambiamenti importanti sulle tabelle dei quiz e questo aggiornamento software non &egrave; stato ancora sufficientemente testato. Si raccomanda di fare un backup delle tabelle prima di procedere.</div>';
$string['url'] = 'URL';
$string['usedcategorymoved'] = 'Questa categoria &egrave; stata spostata a livello di sito, perch&egrave;, dopo la cancellazione del corso, le domande in essa contenute erano utilizzate da altri quiz esistenti nel server.';
...
$string['yourfinalgradeis'] = 'Il tuo voto finale per questo quiz &egrave;: $a';
$string['zerosignificantfiguresnotallowed'] = 'La risposta giusta non pu&ograve; avere zero cifre significative!';
