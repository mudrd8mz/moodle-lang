<?PHP // $Id$ 
      // grades.php - created with Moodle 1.9.3+ (Build: 20081029) (2007101530)
...
$string['configcoursegradedisplaytype'] = 'Scegli il tipo di visualizzazione di default per questo corso. Puoi anche scegliere il valore di default del sito. Le valutazioni possono essere mostrate come veri voti, come percentuali (con riferimento alle valutazioni minime e massime) o come graduatorie letterali (A, B, C, ecc.). Scegliendo di utilizzare le graduatorie letterali, queste potranno essere personalizzate.';
...
graduatorie letterale corrisponde alla valutazione (se questo tipo di visualizzazione è usato).';
$string['configgradedisplaytype'] = 'Le valutazioni possono essere mostrate come effettive valutazioni, come percentuali (in riferimento alle minime e alle massime valutazioni) o come 
graduatorie letterali (A, B, C, ecc.)';
$string['configgradeexportdisplaytype'] = 'Le valutazioni possono essere mostrate come effettive valutazioni, come percentuali (in riferimento alle minime e alle massime valutazioni) o come 
graduatorie letterali (A, B, C, ecc.) durante l\'esportazione. Questa impostazione può essere sostituita durante l\'esportazione.';
...
$string['displaylettergrade'] = 'Visualizza graduatorie letterali';
...
$string['gradeboundary'] = 'Limite per il livello';
...
$string['gradeletternote'] = 'Per cancellare una graduatoria letterale eliminare il contenuto di <br /> una delle tre aree di testo e salvare le modifiche.';
$string['gradeletters'] = 'Graduatorie letterali';
...
$string['hiddenasdate'] = 'Mostra data invio per le valutazioni nascoste';
...
$string['letter'] = 'Livello';
$string['lettergrade'] = 'Livello';
$string['lettergradenonnumber'] = 'Il voto Basso e/o Alto non è numerico per';
$string['letters'] = 'Graduatorie letterali';
...
$string['neverdeletehistory'] = 'Non cancellare mai la storia';
...
$string['prefletters'] = 'Graduatorie letterali e limiti';
...
$string['reportsettings'] = 'Rapporti';
...
$string['weightorextracredit'] = 'Pesi o punti extra'; // ORPHANED
$string['weights'] = 'Pesi'; // ORPHANED
$string['weightsedit'] = 'Modifica pesi e punti extra'; // ORPHANED
