...
$string['aggregateextracreditmean'] = 'Valutazione media (con punti extra)';
...
$string['aggregateonlygradedhelp'] = 'Le valutazioni mancanti possono essere aggregate come voti più bassi oppure possono non essere aggregate.';
$string['aggregateoutcomes'] = 'Aggrega anche li obiettivi';
$string['aggregateoutcomeshelp'] = 'Aggregare anche gli obiettivi potrebbe non fornire il risultato desiderato, per cui si ha la possibilità di aggregarli oppure no.';
$string['aggregatesonly'] = 'Aggrega solamente';
$string['aggregatesubcats'] = 'Aggrega includendo le sotto categorie';
$string['aggregatesubcatshelp'] = 'L\'aggregazione di solito è fatta solo con i figli immediati, ma è anche possibile aggregare valutazioni in tutte le sotto categorie escludendo altre valutazioni aggregate.';
...
$string['configenableoutcomes'] = 'Abilitare gli Obiettivi (in inglese Outcome, chiamati anche Competenze, Standard, Criteri) significa che possono essere effettuate valutazioni utilizzando una o più scale collegate a definizioni di obiettivi. L\'abilitazione degli obiettivi rende possibile questo tipo di valutazione in tutto il sito.';
...
$string['droplowhelp'] = 'Se impostata, questa opzione fa scartare le N valutazioni più basse, dove N è il valore selezionato per questa opzione.';
...
$string['keephigh'] = 'Mantieni le più alte';
$string['keephighhelp'] = 'Se impostata, questa opzione farà tenere solo le N valutazioni più alte, dove N è il valore selezionato per questa opzione.';
$string['keymanager'] = 'Gestore chiave';
...
$string['lowest'] = 'Più basso';
$string['lowgradeletter'] = 'Min';
$string['manualitem'] = 'Elemento manuale';
$string['max'] = 'Più alto';
$string['maxgrade'] = 'Voto massimo';
$string['meanall'] = 'Tutte le valutazioni';
$string['meangraded'] = 'Non mancanti';
...
$string['nogradeletters'] = 'Valutazioni letterali non impostate';
