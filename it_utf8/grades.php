...
$string['aggregateweightedmean'] = 'Media pesata dei voti';
$string['aggregateweightedmean2'] = 'Media pesata semplice dei voti';
...
$string['averagesdisplaytype'] = 'Visualizzazione della colonna delle medie';
...
$string['configcoursegradedisplaytype'] = 'Scegli il tipo di visualizzazione di default per questo corso. Puoi anche optare per il default del sito. Le valutazioni possono essere mostrate come punteggio, come percentuali (con riferimento alle valutazioni minime e massime) o come graduatorie letterali (A, B, C, ecc.). Scegliendo di utilizzare le graduatorie letterali, queste potranno essere personalizzate.';
...
$string['configenableajax'] = 'Abilita AJAX al registro del valutatore, semplificando e accelerando le operazioni più comuni. E\' necessario che il browser dell\'utente supporti JavaScript.';
...
$string['configgradeexportdisplaytype'] = 'I voti possono essere esportati come punteggio, come percentuali (in riferimento alla valutazione minima e massima) o come graduatorie letterali (A, B, C, ecc.). Questa impostazione può essere modificata quando si configura l\'esportazione.';
...
$string['configmeanselection'] = 'E\' possibile scegliere come alcolare le medie d colonna, includendo oppure escludendo i voti non ancora presenti nel registro del valutatore.';
$string['configprofilereport'] = 'Il tipo di rapporto da mostrare nella pagina del profilo utente';
$string['configquickgrading'] = 'Questa opzione aggiunge una casella di input per ogni elemento presente nel registro del valutatore, permettendo di inserire p modificare più voti insieme. Cliccando sul pulsante Aggiorna le modifiche saranno tutte memorizzate.';
...
$string['configshowquickfeedback'] = 'Il feedback rapido aggiunge un area di input per ogni elemento presente nel registro del valutatore, permettendo di inserire o modificare più feedback insieme. Cliccando sul pulsante Aggiorna le modifiche saranno tutte memorizzate.';
...
$string['droplow'] = 'Scarta i voti peggiori';
$string['droplowhelp'] = 'Se impostate questa opzione verranno scartati gli N voti più bassi, dove N è il valore scelto.';
...
$string['gradeitemislocked'] = 'Questa attività risulta bloccata nel registro del valutatore. Le modifiche apportate alle valutazioni di questa attività non saranno riporatate nel registro del valutatore finché l\'attività non sarà sbloccata.';
...
$string['keephigh'] = 'Utilizza i voti migliori';
$string['keephighhelp'] = 'Se impostate questa opzione verranno utilizzate solamente gli N voti migliori, dove N è il valore scelto.';
...
$string['nogradeletters'] = 'Graduatorie letterali non impostate';
...
$string['rangesdisplaytype'] = 'Visualizzazione intervalli';
