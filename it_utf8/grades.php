<?PHP // $Id$ 
      // grades.php - created with Moodle 2.0 dev (Build: 20081103) (2008101300)
...
$string['addoutcomeitem'] = 'Aggiungi Obiettivo';
...
$string['aggregateonlygraded'] = 'Non aggregare le valutazioni mancanti';
$string['aggregateonlygradedhelp'] = 'Le valutazioni mancanti possono essere utilizzate come voti più bassi oppure possono non essere utilizzate.';
...
$string['aggregatesonly'] = 'Aggrega solamente';
$string['aggregatesubcats'] = 'Aggrega includendo le sottocategorie';
...
$string['aggregateweightedmean2'] = 'Media pesata semplice delle valutazioni';
...
$string['averagesdecimalpoints'] = 'Decimali nella colonna delle medie';
$string['averagesdisplaytype'] = 'Tipo visualizzazione della colonna delle medie';
...
$string['dropxlowest'] = 'Elimina X più basse';
$string['dropxlowestwarning'] = 'Nota: Se si utilizza Elimina X più basse, la valutazione assume che tutte gli elementi della corrispondente categoria hanno lo stesso valore per i punteggi. Se tali valori differiscono i risultati saranno imprevedibili';
...
$string['generalsettings'] = 'Impostazioni';
...
$string['gradecategorysettings'] = 'Categorie';
...
$string['gradeitemsettings'] = 'Elementi';
