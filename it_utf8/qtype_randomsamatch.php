...
$string['addmoreanswerblanks'] = 'Spazi per altre {no} risposte'; // ORPHANED
$string['answerno'] = 'Risposta <b>$a</b>'; // ORPHANED
$string['filloutoneanswer'] = 'Devi fornire almeno una risposta possibile. Le risposte lasciate vuote non saranno usate. \'*\' può essere usato come carattere jolly per accettare qualunque carattere. La prima risposta corrispondente sarà usata per determinare il punteggio e il feedback.'; // ORPHANED
