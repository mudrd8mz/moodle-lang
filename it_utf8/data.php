...
$string['advancedsearch'] = 'Maschera di ricerca';
...
$string['asearchtemplate'] = 'Modello Maschera di ricerca';
...
$string['defaultsortfield'] = 'Campo da utilizzare per l\'ordinamento default';
...
$string['fromfile'] = 'Importa da un file .zip';
...
$string['headerasearchtemplate'] = 'Definisce come apparirà la maschera di ricerca';
$string['headercsstemplate'] = 'Imposta un Foglio di stile CSS che verrà utilizzato con i Modelli di questo Database.';
$string['headerjstemplate'] = 'E\' possibile scrivere del codice Javascript che sarà usato nei Modelli';
...
$string['headersingletemplate'] = 'Imposta come apparirà l\'interfaccia di navigazione per la visualizzazione \"Dettagli\"';
