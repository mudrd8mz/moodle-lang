...
$string['defaultfieldenclosure'] = '(normalmente non è nessun carattere)';
$string['defaultsortfield'] = 'Campo da utilizzare per l\'ordinamento';
$string['delete'] = 'Cancella';
$string['deletecomment'] = 'Sei certo di voler cancellare questo commento?';
$string['deleted'] = 'cancellato';
$string['deletefield'] = 'Cancella un campo esistente';
$string['deletewarning'] = 'State per cancellare questa preimpostazione. Ne siete certi?';
...
$string['fieldallowautolink'] = 'Pernmetti che il campi sia collegato automaticamente';
...
$string['file'] = 'File';
$string['filtername'] = 'Link automatico al Database';
...
$string['insufficiententries'] = 'é necessario inserire un maggior numero di record per per poter visualizzare questo Database';
...
$string['multipletags'] = 'Tag multipli trovati! Il Modello di visualizzazione non é stato salvato';
...
$string['nofieldindatabase'] = 'Non ci sono campi definiti nella Database, si prega di inserirne qualcuno';
...
$string['rssglobaldisabled'] = 'Disabilitato. Controllare la configurazione delle variabili del sito';
