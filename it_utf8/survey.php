...
$string['attls13'] = 'Mi &egrave; pi&ugrave; facile provare a capire l\'opinione di qualcun altro che provare a valutarla.';
...
$string['attls15'] = 'Tendo a mettermi nei panni degli altri quando discutiamo, per capire perch&egrave; la pensano in quel modo.';
$string['attls15short'] = 'mettermi nei panni degli altri';
$string['attls16'] = 'Qualcuno potrebbe chiamare il mio modo di analizzare le cose \'mettere alla prova\' perch&egrave; cerco di prendere in considerazione tutti i casi.';
...
$string['attls17short'] = 'd&ograve; maggior importanza alla logica';
...
$string['attls8'] = 'Sono sempre interessato a conoscere perch&egrave; le persone dicono e credono nelle cose che fanno.';
$string['attls8short'] = 'Sapere perch&egrave; le persone agiscono';
$string['attls9'] = 'Spesso mi ritrovo a discutere con gli autori dei libri che leggo, cercando di dimostrare logicamente perch&egrave; hanno torto.';
$string['attls9short'] = 'discutere con gli autori';
$string['attlsintro'] = 'L\'obiettivo di questo sondaggio &egrave; aiutarci a valutare il tuo atteggiamento nei confronti del pensare e dell\'imparare.
...
$string['ciq1'] = 'In che momento in classe sei pi&ugrave; partecipe come studente?';
$string['ciq1short'] = 'Pi&ugrave; partecipe';
$string['ciq2'] = 'In che momento in classe sei meno partecipe come studente?';
$string['ciq2short'] = 'Meno partecipe';
$string['ciq3'] = 'Che azione da parte di chiunque nei forum trovi pi&ugrave; utile?';
$string['ciq3short'] = 'Momento utile';
$string['ciq4'] = 'Che azione da parte di chiunque nei forum trovi pi&ugrave; confusionaria?';
...
$string['colles2'] = 'quello che imparo &egrave; importante per la mia pratica professionale.';
...
$string['howlongoptions'] = 'meno di 1 min, 1-2 min,2-3 min,3-4 min,4-5-min,5-10 min, pi&ugrave; di 10 min';
...
$string['scaleagree5'] = 'Fortemente in disaccordo,Un p&ograve; in disaccordo,N&egrave; daccordo n&egrave; in disaccordo,Abbastanza daccordo,Completamente daccordo';
