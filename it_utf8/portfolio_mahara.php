<?PHP // $Id$ 
      // portfolio_mahara.php - created with Moodle 2.0 dev (Build: 20090410) (2009040100)


$string['err_invalidhost'] = 'Il plugin non è configurato correttamente, punta a un host ment non valido oppure eliminato. Questo plugin necessita di peer Moodle Networking che offrano il servizio SSO IDP e  accettino il servizio portfolio e SSO SP.';
...
$string['err_nomnethosts'] = 'Questo plugin necessita di peer Moodle Networking che offrano il servizio SSO IDP, accettino il servizio portfolio e SSO SP, e del plugin mnet di autenticazione. Qualsiasi istanza di questo plugin non sarà visibile fino alla abilitazione del Networking, quando potrete rendere nuovamente visibile il plugin manualmente.';
