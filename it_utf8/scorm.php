...
$string['datadir'] = 'Errore Filesystem: non &egrave; possibile creare la directory dei dati';
...
$string['gradehighest'] = 'Il voto pi&ugrave; alto';
...
$string['noprerequisites'] = 'Spiacente ma non &egrave; sono stati completati abbastanza prerequisiti per accedere a questo learning object';
...
$string['packagedir'] = 'Errore Filesystem: non &egrave; possibile creare la directory del pacchetto';
$string['packagefile'] = 'Non &egrave; stato specificato nessun pacchetto';
...
$string['position_error'] = 'It tag $a->tag non pu&ograve; essere figlio del tag $a->parent';
...
$string['validationtype'] = 'Questa impostazione abilita l\'utilizzo di una libreria DOMXML per validare il manifest. Se non conosci quale libreria &egrave; installata sul tuo server lascia la preselezione.';
$string['value'] = 'Valore';
$string['versionwarning'] = 'La versione del manifest &egrave; precedente alla 1.3, avviso rilevato al tag $a->tag';
