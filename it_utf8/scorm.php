<?PHP // $Id$ 
      // scorm.php - created with Moodle 2.0 dev (Build: 20090219) (2009021800)


$string['activation'] = 'Attivazione';
$string['activityloading'] = 'L\'attività partirà in';
$string['activitypleasewait'] = 'Caricamento in corso...';
$string['advanced'] = 'Parameteri';
$string['allowapidebug'] = 'Attiva l\'API di debug e tracing (Imposta la capture mask con apidebugmasjk)';
...
$string['display'] = 'Visualizza pacchetto';
...
$string['displaycoursestructure'] = 'Visualizza la struttura del corso';
...
$string['lastattemptlock'] = 'Blocca dopo il tentativo finale';
...
$string['noprerequisites'] = 'Spiacente, non hai soddisfatto un numero sufficiente di  prerequisiti per accedere a questo learning object';
...
$string['viewalluserreports'] = 'Mostra il report per $a utenti';
