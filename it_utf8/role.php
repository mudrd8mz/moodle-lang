<?PHP // $Id$ 
      // role.php - created with Moodle 2.0 dev (Build: 20090327) (2009032001)
...
$string['allowroletoassign'] = 'Consenti agli utenti con il ruolo $a->fromrole di attribuire il ruolo $a->targetrole';
...
$string['assignrolesrelativetothisuser'] = 'Attribuisci ruoli relativi a questo utente';
...
$string['globalroleswarning'] = 'ATTENZIONE! Qualsiasi ruolo attribuito agli utenti in questa pagina, sarà un ruolo globale, ossia valido in tutto il sito, inclusa la pagina principale, le categorie di corsi ed i corsi.';
$string['gotoassignroles'] = 'Vai alla attribuzione di ruoli per questo $a->contextlevel';
$string['gotoassignsystemroles'] = 'Vai alla attribuzione di ruoli di sistema';
...
$string['thisusersroles'] = 'Ruoli attribuiti all\'utente';
...
$string['xroleassignments'] = 'Ruoli attribuiti a $a';
