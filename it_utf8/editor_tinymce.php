...
$string['advanced:bullist_desc'] = 'Lista non ordinata';
...
$string['advanced:cleanup_desc'] = 'Pulisci codice disordinato';
$string['advanced:clipboard_msg'] = 'Copia/Taglia/Incolla non è disponibile in Mozilla e Firefox..
...
$string['advanced:custom1_desc'] = 'La tua descrizione personalizzata qui';
...
$string['advanced:font_size'] = 'Grandezza carattere';
...
$string['advanced:indent_desc'] = 'Sposta verso interno';
...
$string['advanced:link_desc'] = 'Inserisci/modifica collegamento';
$string['advanced:more_colors'] = 'Colori aggiuntivi';
$string['advanced:newdocument'] = 'Sei sicuro di voler cancellare tutti i contenuti?';
$string['advanced:newdocument_desc'] = 'Nuovo documento';
$string['advanced:numlist_desc'] = 'Lista ordinata';
$string['advanced:outdent_desc'] = 'Sposta verso esterno';
...
$string['advanced:unlink_desc'] = 'Togli collegamento';
...
$string['advanced_dlg:image_align'] = 'Allineamentot';
...
$string['advanced_dlg:image_align_textbottom'] = 'In basso al testo';
$string['advanced_dlg:image_align_texttop'] = 'In alto al testo';
...
$string['advanced_dlg:image_list'] = 'Lista immagini';
...
$string['advanced_dlg:link_is_email'] = 'L\'URL inserito sembra essere un indirizzo email. Aggiungere il necessario prefisso mailto: ?';
$string['advanced_dlg:link_is_external'] = 'L\'URL inserito sembra essere un link esterno. Aggiungere il necessario prefisso http:// ?';
$string['advanced_dlg:link_list'] = 'Lista collegamenti';
...
$string['advlink_dlg:encoding'] = 'Codifica carattere del target';
...
$string['advlink_dlg:target_langcode'] = 'Lingua del target';
...
$string['common:clipboard_msg'] = 'Copia/Taglia/Incolla non è disponibile in Mozilla e Firefox.\\nSi desidera avere maggiori informazioni su questo problema?';
$string['common:clipboard_no_support'] = 'Attualmente non supportato dal  browser in uso, usare le scorciatoie da tastiera.';
$string['common:close'] = 'Chiudi';
$string['common:edit_confirm'] = 'Usare la modalità WYSIWYG per questa textarea?';
$string['common:insert'] = 'Inserisci';
$string['common:invalid_data'] = 'Errore: valori inseriti non validi, sono marcati in rosso.';
$string['common:more_colors'] = 'Colori aggiuntivi';
$string['common:not_set'] = '-- Non impostato --';
$string['common:popup_blocked'] = 'Spiacente, ma il blocco delle popup ha disabilitato una finestra che fornisce funzionalità dell\'applicazione. Si deve disabilitare il blocco delle popup per questo sito per poter utlizzare appieno questo strumento.';
...
$string['emotions_dlg:tongue_out'] = 'Linguaccia';
...
$string['fullpage_dlg:appearance_marginprops'] = 'Margini body';
...
$string['fullpage_dlg:meta_index_follow'] = 'Indicizzare e seguire collegamenti';
$string['fullpage_dlg:meta_index_nofollow'] = 'Indicizzare e non segure collegamenti';
...
$string['fullpage_dlg:movedown'] = 'Sposta elemento selezionato in basso';
$string['fullpage_dlg:moveup'] = 'Sposta elemento selezionato in alto';
$string['fullpage_dlg:name'] = 'Nome';
$string['fullpage_dlg:properties'] = 'Proprietà';
$string['fullpage_dlg:rel'] = 'Rel';
$string['fullpage_dlg:remove'] = 'Rimuovi elemento selezionato';
...
$string['layer:backward_desc'] = 'Porta in sfondo';
...
$string['media_dlg:autogotourl'] = 'Vai a URL automatico';
...
$string['media_dlg:captioningid'] = 'Didascalia dell\'Id';
...
$string['media_dlg:endtime'] = 'Ora fine';
...
$string['media_dlg:flv_options'] = 'Opzioni video Flash';
$string['media_dlg:flv_scalemode'] = 'Scale mode';
$string['media_dlg:flv_showscalemodes'] = 'Mostra scale modes';
$string['media_dlg:flv_smoothvideo'] = 'Smooth video';
$string['media_dlg:flv_startimage'] = 'Immagine avvio';
$string['media_dlg:flv_starttime'] = 'Tempo avvio';
$string['media_dlg:fullscreen'] = 'Tutto schermo';
...
$string['media_dlg:playcount'] = 'Conteggio esecuzione';
$string['media_dlg:playeveryframe'] = 'Esegui ogni frame';
...
$string['media_dlg:targetcache'] = 'Cache del target';
...
$string['nonbreaking:nonbreaking_desc'] = 'Inserisci uno spazio';
...
$string['save:cancel_desc'] = 'Cancella tutte le modifiche';
...
$string['searchreplace_dlg:down'] = 'Indietro';
$string['searchreplace_dlg:findnext'] = 'Trova succ.';
...
$string['searchreplace_dlg:replaceall'] = 'Sost. tutto';
...
$string['searchreplace_dlg:up'] = 'Avanti';
$string['simple:bold_desc'] = 'Grassetto (Ctrl+B)';
$string['simple:bullist_desc'] = 'Lista non ordinata';
...
$string['style_dlg:background_repeat'] = 'Repetizione';
...
$string['style_dlg:border_tab'] = 'Bordi';
...
$string['style_dlg:box_tab'] = 'Contenitore';
$string['style_dlg:box_width'] = 'Larghezza';
$string['style_dlg:bullet_image'] = 'Immagine bullet';
...
$string['style_dlg:padding'] = 'Spazio dal bordo';
$string['style_dlg:placement'] = 'Piazzamento';
...
$string['style_dlg:text_none'] = 'nessuna';
...
$string['table_dlg:cell_limit'] = 'Superato il numero massimo di celle di {$cells}.';
...
$string['table_dlg:col_limit'] = 'Superato il numero massimo di colonne di {$cols}.';
$string['table_dlg:colgroup'] = 'Gruppo colonna';
...
$string['table_dlg:missing_scope'] = 'Sicuro di proseguire senza aver specificato uno scope per l\'intestazione di questa tabella? Senza di esso, potrebbe essere difficoltoso per alcuni utenti con disabilità capire il contenuto o i dati mostrati nella tabella.';
$string['table_dlg:row_all'] = 'Update tutte le righe della tabella';
$string['table_dlg:row_even'] = 'Aggiorna righe pari della tabella';
$string['table_dlg:row_limit'] = 'Superato il numero massimo di righe di {$rows}.';
...
$string['table_dlg:summary'] = 'Sommario';
...
$string['template_dlg:warning'] = 'Attenzione: Aggiornare un modello con un altro differente può causare perdite di dati.';
...
$string['xhtmlxtras:del_desc'] = 'Cancellamento';
...
$string['xhtmlxtras_dlg:attribute_option_ltr'] = 'Sinistra verso destra';
$string['xhtmlxtras_dlg:attribute_option_rtl'] = 'Destra verso sinistra';
$string['xhtmlxtras_dlg:events_tab'] = 'Eventi';
$string['xhtmlxtras_dlg:fieldset_attrib_tab'] = 'Attributi elemento';
$string['xhtmlxtras_dlg:fieldset_events_tab'] = 'Eventi elemento';
...
$string['xhtmlxtras_dlg:option_ltr'] = 'Sinistra verso destra';
$string['xhtmlxtras_dlg:option_rtl'] = 'Destra verso sinistra';
$string['xhtmlxtras_dlg:remove'] = 'Rimuovi';
$string['xhtmlxtras_dlg:title_abbr_element'] = 'Abbreviazione elemento';
$string['xhtmlxtras_dlg:title_acronym_element'] = 'Acronimo elemento';
$string['xhtmlxtras_dlg:title_cite_element'] = 'Citazione elemento';
$string['xhtmlxtras_dlg:title_del_element'] = 'Cancellazione elemento';
$string['xhtmlxtras_dlg:title_ins_element'] = 'Inserimento elemento';
