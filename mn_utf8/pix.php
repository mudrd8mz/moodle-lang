...
<?PHP // $Id$ 
      // pix.php - created with Moodle 1.5.4 + (2005060240)


$string['angry'] = 'ууртай ';
$string['approve'] = 'батлах ';
$string['biggrin'] = 'том жуумалзах ';
$string['blackeye'] = 'хөх нүд ';
$string['blush'] = 'ичих ';
$string['clown'] = 'алиалагч ';
$string['cool'] = 'хүйтэн ';
$string['dead'] = 'үхсэн ';
$string['evil'] = 'чөтгөр';
$string['kiss'] = 'үнсэх ';
$string['mixed'] = 'холимог';
$string['sad'] = 'уйтгартай ';
$string['shy'] = 'ичимхий';
$string['sleepy'] = 'нойрмог ';
$string['smiley'] = 'инээмсэглэл ';
$string['surprise'] = 'сюрприз';
$string['thoughtful'] = 'бодлогоширонгуй';
$string['tongueout'] = 'хэлээ гаргасан';
$string['wideeyes'] = 'бүлтийсэн нүд';
$string['wink'] = 'нүдээ ирмэх';
