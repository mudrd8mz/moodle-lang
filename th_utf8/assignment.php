...
$string['allowmultiple'] = 'อนุญาตให้ส่งหลายไฟล์';
...
$string['attachfile'] = 'ไฟล์แนบ';
$string['attachfiletoassignment'] = 'แนบไฟล์ลงไปในการบ้าน';
$string['availabledate'] = 'ส่งได้ตั้งแต่';
$string['backtoassignment'] = 'กลับไปยังการบ้าน';
$string['backtofeedback'] = 'กลับไปยังความคิดเห็น';
$string['choosereviewfile'] = 'เลือกไฟล์เพื่อทำการอัพโหลด';
...
$string['deletecheckfile'] = 'แน่ใจนะคะว่าต้องการลบไฟล์นี้';
$string['deleteednotification'] = 'ลบไฟล์เรียบร้อยแล้ว';
$string['deletefail'] = 'ไฟล์ต่อไปนี้ถูกลบเรียบร้อยแล้ว';
...
$string['removelink'] = 'เอาออก';
$string['responsefile'] = 'ไฟล์ที่ส่ง';
$string['responsesfromteacher'] = 'ไฟล์ตัวอย่างที่ส่งโดยอาจารย์';
$string['saveallfeedback'] = 'บันทึกความเห็นทั้งหมด';
$string['sendformarking'] = 'ส่งการบ้าน';
$string['step1'] = 'ขั้นที่ 1:';
$string['step2'] = 'ขั้นที่ 2 :';
...
$string['submissionstatus'] = 'สถานะการส่งงาน';
$string['submissionstatusblank'] = 'ไม่มี';
$string['submissionstatusdraft'] = 'ฉบับร่าง';
$string['submissionstatusmarked'] = 'ตรวจแล้ว';
$string['submissionstatusreturned'] = 'ส่งคืน';
$string['submissionstatussubmitted'] = 'ส่งแล้ว';
...
$string['uploadsuccessresponse'] = 'ไฟล์อัพโหลดสำเร็จแล้ว';
