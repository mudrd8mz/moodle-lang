...
$string['configprotectusernames'] = 'ตามค่าทั้งตั้งไว้ใน forget_password.php จะไม่มีการแสดงคำใบ้เพื่อให้สมาชิกเดาชื่อผู้ใช้หรือที่อยู่อีเมล';
...
$string['configsessioncookiepath'] = 'ถ้าต้องการเปลี่ยนค่าที่บราวเซอร์ส่ง cookies ไปเก็บไว้ท่านสามารถระบุไดเรกทอรีของเว็บไซต์ลงไปได้ หากไม่ระบุให้ใส่ค่าที่ตั้งไว้เป็น / ซึ่งก็จำทำงานได้เป็นปกติ';
...
$string['dbmigrate'] = 'การย้ายฐานข้อมูลมูเดิ้ล';
...
$string['dbmigrationdeprecateddb'] = '<font color=\"#ff0000\">ฐานข้อมูลนี้จะถูกย้ายไปยังฐานข้อมูลใหม่ที่ทำการเข้ารหัสแบบ utf8 กรุณาแก้ไขไฟล์ config.php และใช้ฐานข้อมูลใหม่นี้ในมูเดิ้ล</font>';
...
$string['mediapluginswfnote'] = 'เพื่อความปลอดภัยสำหรับการใช้งาน ผู้ใช้งานปกติไม่ควรเปิดให้มีการใช้งาน .swf ไฟลืแฟลช';
...
$string['nolangupdateneeded'] = 'ไฟล์ภาษาของท่าทั้งหมดเป็นปัจจุบันแล้ว ไม่จำเป็นต้องทำการอัพเดท';
...
$string['pgclusterdescription'] = 'เวอร์ชั่นของ PostgreSQL และ ค่าตัวแปรคลัสเตอร์สำหรับการออกคำสั่ง ถ้าหากท่านมีฐานข้อมูล PostgreSQL เพียงอันเดียวในระบบ หรือไม่มั่นใจให้ละค่านี้ไว้';
...
$string['remotelangnotavailable'] = 'ไม่สามารถติดตั้งภาษาที่ท่านต้องการได้อัตโนมัติเพราะมูเดิ้ลไม่สามารถติดต่อ download.moodle.org ได้ กรุณาดาวน์โหลด Zip ไฟล์จากรายการด้านล่างนี้จากนั้นสำเนาไฟล์ดังกล่าวไปยัง ไดเรกทอรี $a แล้วทำการ unzip';
