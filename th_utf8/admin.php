<?PHP // $Id$ 
      // admin.php - created with Moodle 2.0 dev (Build: 20090925) (2009091700)
...
$string['allowvisiblecoursesinhiddencategories'] = 'สามารถนำหลักสูตรที่เปิดสอนอยู่ไปเก็บไว้ในประเภทที่ซ่อนไว้ได้';
...
$string['changesitelang'] = 'เปลี่ยนภาษาที่ใช้ในเว็บไซต์';
...
$string['configallowunenroll'] = 'หากตั้งค่าเป็น \"ใช่\" นักเรียนจะสามารถลาออกจากหลักสูตรเมื่อไรก็ได้ตามความพอใจ หากเลือก \"ไม่\" เฉพาะอาจารย์และผู้ดูแลระบบเท่านั้นที่จะทำได้';
...
$string['configdebugstringids'] = 'ตัวเลือกนี้มีไว้สำหรับช่วยผู้แปลภาษา ซึ่งจะแสดงเฉพาะไฟล์ภาษาและหมายเลขของ string  การเปลี่ยนค่านี้จะมีผลเมื่อมีการโหลดครั้งต่อไป';
...
$string['configdisablecourseajax'] = 'ไม่ควรใช้ AJAX เมื่อทำการแก้ไขหน้ารายวิชาหลัก';
...
$string['configemoticons'] = 'เปลี่ยนชื่อโค้ดทางซ้ายมือให้ตรงกับรูปไอคอนด้านขวา หากต้องการเพิ่มไอคอนใหม่ให้เพิ่มคนและชื่อจากนั้นเพิ่มรูปภาพในรูปแบบของ name.gif ใน /pix/';
...
$string['configenablegroupings'] = 'การตั้งค่านี้เป็นการเปิดการใช้งานการจัดกลุ่ม';
...
$string['configexperimentalsplitrestore'] = 'หากเปิดใช้งาน , ระบบจะตรวจสอบค่า xml ของไฟล์ข้อมูลของรายวิชาที่ทำการสำรองข้อมูลเอาไว้ ว่ามีข้อผิดพลาดหรือไม่แล้วทำการแบ่งไฟล์ออกเป็นส่วนเล็ก ๆ เพื่อใช้ในขั้นตอนการสำรองข้อมูล จะช่วยเพิ่มประสิทธิภาพในการกู้คืนข้อมูลและระยะเวลาที่ใช้ในการกู้คืน โดยเฉพาะสำหรับไฟล์สำรองที่มีขนาดใหญ่';
...
$string['configextrauserselectorfields'] = 'เลือกฟิลด์ที่ต้องการค้นหาและแสดง นอกเหนือจาก ชื่อ นามสกุล เมื่อทำการเลือกสมาชิก ตัวอย่างเช่น เมื่อทำการกำหนดบทบาทหรือเมื่อจับกลุ่มสมาชิก เพื่อความปลอดภัย ไม่ควรเลือกใช้ฟิลด์ชื่อผู้ใช้';
...
$string['confighideactivitytypenavlink'] = 'เลือกว่าต้องการซ่อนลิงก์ของกิจกรรม ( เช่น แบบทดสอบ) ที่แสดงอยู่ในโมดูลกิจกรรม ไม่ให้ใครเห็นบ้าง';
...
$string['confignodefaultuserrolelists'] = 'การตั้งค่านี้เป็นการช่วย สมาชิกที่ประสบปัญหาการเข้าใช้งานในรายวิชา เนื่องจากฐานข้อมูลมีการเรียกใช้งาน get_course_user ซ้ำ ๆ หากได้รับผลกระทบจากการใช้งานดังกล่าวให้ตรวจสอบการตั้งค่านี้';
...
$string['configregenloginsession'] = 'ให้ระบบสร้างหมายเลขเซสชั่นใหม่สำหรับการเข้าสู่ระบบแต่ละครั้ง แนะนำให้ทำการตั้งค่านี้ แต่อาจไม่สามารถใช้งานได้สำหรับปลั๊กอินในการอนุมัติการใช้งานบางประเภท';
...
$string['configsendcoursewelcomemessage'] = 'หากเปิดการใช้งานสมาชิกจะได้รับข้อความต้อนรับผ่านอีเมลเมื่อมีการสมัครเข้าเรียนในรายวิชา';
...
$string['configstatscatdepth'] = 'ตรรกะที่ใช้ในการรับนักเรียนเข้าเรียนในรายวิชา ไม่สามารถเขียนทับค่านี้ได้และระบบมีการกำหนดค่าสูงสุดสำหรับจำนวนประเภทของรายวิชาหลักที่จะมีได้ ค่า ០ หมายถึง ให้ใช้งานการกำหนดบทบาทในระดับเว้บไซต์และระดับรายวิชา  ค่า 1 หมายถึง ใช้งานการกำหนดบทบาทในระดับประเภทของรายวิชาด้วย  ยิ่งมีการแสดงผลมากเท่าไหร่จำนวนเวลาที่ใช้ในการโหลดฐานข้อมูลก็มากเท่านั้น';
...
$string['defaulthtmleditor'] = 'HTML editor ที่ตั้งไว้';
...
$string['disablecourseajax'] = 'ปิดการใช้งานการแก้ไขรายวิชาโดยใช้  AJAX';
...
$string['enablegroupings'] = 'เปิดการใช้งานการแบ่งกลุ่ม';
...
$string['experimentalsplitrestore'] = 'การกู้คืนโหมดทดลอง (Experimental split restore)';
$string['extendedusernamechars'] = 'สามารถใช้อักขระพิเศษในชื่อผู้ใช้';
$string['extramemorylimit'] = 'เพิ่มความจำใน PHP memory limit';
$string['extrauserselectorfields'] = 'เมื่อทำการเลือกสมาชิก, ค้นหา และ แสดงผล';
...
$string['helpprofilefieldlink'] = 'สร้างลิงก์จากข้อมูลสมาชิก';
...
$string['hideactivitytypenavlink'] = 'ซ่อนแท็บกิจกรรม';
...
$string['invalidlangpack'] = 'ในการแก้ไขภาษานี้จำเป็นต้องนำไปวางไว้ในโฟลเดอร์ภาษา lang';
...
$string['ipwhitelist'] = 'IP ที่น่าเชื่อถือ';
$string['ipwhitelistdesc'] = 'ในกรณีที่ใส่หมายเลขไอพี เฉพาะหมายเลขไอพีนี้เท่านั้นที่จะสามารถใช้งานเว็บเซอร์วิสได้ ด้วยชื่อผู้ใชื <strong>$a->username</strong>';
...
$string['langlocalpackage'] = 'ภาษาที่ปรับแก้ในเครื่อง';
$string['langmasterenglish'] = 'ภาษาอังกฤษต้นฉบับ';
$string['langmasterpackage'] = 'ภาษาต้นฉบับ';
...
$string['langpackmaintaining'] = 'การแก้ไขภาษาต้นฉบับ';
...
$string['langrmyourself'] = 'เพื่อป้องกันข้อมูลสูญหาย จึงไม่สามารถเขียนทับไฟล์ lang.php ด้วยหน้าว่างได้ กรุณาลบไฟล์ออกเองหากต้องการลบทิ้ง';
...
$string['managews'] = 'จัดการเว็บเซอร์วิส';
...
$string['nodefaultuserrolelists'] = 'อย่าแสดงผลสมาชิกทั้งหมดในค่าที่ตั้งไว้';
...
$string['profilefieldtypecheckbox'] = 'กล่องสี่เหลี่ยม';
...
$string['regenloginsession'] = 'สร้างหมายเลขเซสชั่นใหม่หลังจากเข้าสู่ระบบ';
...
$string['stats'] = 'สถิติ';
$string['statscatdepth'] = 'จำนวนสูงสุดของประเภทหลัก';
...
$string['uucoursedefaultrole'] = 'บทบาทที่ตั้งไว้';
...
$string['uupreprocessedcount'] = 'จำนวนของบัญชีที่มีการดำเนินการแล้ว : $a';
...
$string['confighideactivitytypecrumb'] = 'เลือกว่าต้องการซ่อนกิจกรรมจากสมาชิกกลุ่มใดบ้าง'; // ORPHANED
$string['hideactivitytypecrumb'] = 'ซ่อนกิจกรรม'; // ORPHANED
