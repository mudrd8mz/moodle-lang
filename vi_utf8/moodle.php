...
$string['courseavailable'] = 'khóa học này có sẵn đối với các học viên';
$string['courseavailablenot'] = 'khóa học này thì không có sẵn đối với các học viên';
...
$string['currentcourseadding'] = 'khóa học hiện hành, thêm dữ liệu vào nó';
$string['currentcoursedeleting'] = 'khóa học hiện hành,xoá nó lần đầu';
...
$string['paymentsorry'] = 'Cám ơn về sự thanh toán của bạn! Không may sự thanh toán của bạn chưa được giải quyết một cách đầy đủ, và bạn chưa được đăng ký để vào khóa học \"$a->fullname\".  Vui lòng thử tiếp tục khóa học trong ít phút nữa, nhưng nếu bạn tiếp tục gặp phải vấn đề này thì vui lòng báo cho $a->teacher hoặc quản trị site';
