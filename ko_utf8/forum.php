<?PHP // $Id$ 
      // forum.php - created with Moodle 1.9 dev (2007070902)
...
$string['cannotadddiscussion'] = '이 포럼에 의견을 제시하려면 모둠의 구성원이 돠어야 합니다.';
$string['cannotviewpostyet'] = '게시물을 올리지 않았기 때문에 이 토론에서 다른 학생들의 질문을 읽을 수 없습니다.';
$string['configcleanreadtime'] = '\'읽기\'란의 오래된 게시물을 정리하는 시간';
...
$string['configenabletimedposts'] = '새 포럼의 토론을 게시할 때 게시 기간을 설정할 수 있게 허용하려면 \"예\"로 설정하시오.(아직 완전히 검증되지 않은 시험적 기능임)';
...
$string['configreplytouser'] = '포럼 게시글을 메일로 발송할 때, 포럼을 통해 답을 보는 대신 개인적으로 답장을 받기위한 게시자의 메일 주소를 포함시킬까요? 만약 \'예\'로 하더라도, 사용자는 자신의 메일 주소를 안전하게 지키기 위해 신상명세에서 이를 허용하지 않을 수 있습니다.';
