...
$string['alreadyfirstpost'] = '토론의 발제가 이미 되어있음';
...
$string['cannotaddteacherforumto'] = '본 강좌의 개요난에는 보조교사의 포럼을 추가할 수 없음';
...
$string['cannotmovenotvisible'] = '볼 수 없는 포럼';
$string['cannotmovetonotexist'] = '그 포럼으로는 옮길 수 없음 - 존재하지 않는 포럼!';
$string['cannotmovetonotfound'] = '강좌에서 대상 포럼을 찾을 수 없음';
$string['cannotpurgecachedrss'] = '정보원/발송지 포럼에 저장된 RSS 송출을 삭제할 수 없음 - 포럼 권한 파일을 점검할 것';
...
$string['configlogblocked'] = '포럼의 크론은 이메일을 막아놓은 이용자에게 메일을 보내기 위해 제한된 시도에 대한 기록을 남길 수 있다.';
...
$string['everyoneisnowsubscribed'] = '모든 사람이 이제 이 포럼을 구독하게 됨';
...
$string['noresult'] = '게시물 $a 에 대한 순위 없음';
