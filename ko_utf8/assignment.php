...
$string['helpupload'] = '<p>이 과제 유형은 학생들이 어떤 형태의 파일을 한개 혹은 여러 개 올리도록 허용합니다.</p>
<p>이는 여러분들이 제출하라고 요구한 문서 작성기에 의한 문서, 묶음 파일 등 어떤 형태라도 가능합니다.</p>
<p>이 유형은 종류를 막론하고 각 항목에 대한 평가를 올릴 수 있도록 허용합니다.</p>';
