...
$string['backupcontainexternal'] = '이 백업 파일에는 상관없는 외부의 무들 네트웍 호스트가 포함되어 있습니다.';
...
$string['cannotdeletedir'] = '($a) 삭제할 수 없음';
...
$string['cannotinsertrate'] = '새 순위($a->id = $a->rating)를 삽입할 수 없음';
...
$string['cannotoverridebaserole'] = '기본 역할 권한은 위임할 수 없음';
...
$string['cannotsaveconfig'] = '플러그인 \"$a->plugin\"에 대한 설정  \"$a->name\"를  \"$a->value\"로  저장하기 실패';
...
$string['cannotupdatecustomprofile'] = '사용자 추가 기록 갱신 오류';
$string['cannotupdatefield'] = '필드 갱신 오류';
...
$string['cannotusepage2'] = '죄송합니다만 이 화면은 사용할 수 없습니다.';
...
$string['csvloaderror'] = 'vcs 파일 탑재 중 오류 발생!';
...
$string['onlyeditingteachers'] = '편집기능을 부여받은 교수자만 그 일을 할 수 있습니다';
