...
$string['cannotinsertcategory'] = '이상한 오류. 범주를 입력할 수 없음';
$string['cannotinsertcomment'] = '새 논평을 넣을 수 없음';
...
$string['cannotsaveconfig'] = '\"$a->plugin\" 플러그인에 대한 설정  \"$a->name\" 값  \"$a->value\"를  저장하지 못함';
...
$string['cannotupdatecm'] = '강좌 모듈을 정확한 위치로 갱신할 수 없음';
...
$string['cannotupdatefield'] = '필드 갱신중 오류';
$string['cannotupdategroup'] = '모둠 갱신중 오류';
$string['cannotupdatelevel'] = '강좌모듈을 이동시켜 갱신할 수 없음';
...
$string['cannotupgradeblock'] = '시스템 블록 갱신 실패! (config 테이블의 판번호를 갱신할 수 없음)';
$string['cannotupgradecaps'] = '역할 시스템에 대한 핵심 권한을 갱신하는데 어려움이 있음';
