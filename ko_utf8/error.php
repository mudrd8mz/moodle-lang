...
$string['backupcontainexternal'] = '이 백업 파일에는 여기에 설정되어 있지 않은 외부의 무들 네트웍 호스트가 포함되어 있습니다.';
...
$string['cannotdownloadlanguageupdatelist'] = 'download.moodle.org에서 언어 갱신 목록을 다운로드 할 수 없습니다.';
...
$string['cantunenrollinthisrole'] = '현재의 역할로는 이 강좌에서 등록을 취소 할 수 없습니다.';
$string['cmunknown'] = '이 강좌 모듈을 찾을 수 없습니다.';
...
$string['coursegroupunknown'] = '모둠에 상응하는 강좌 $a 가 지정되 있지 않음.';
...
$string['filternotactive'] = '$a 필터는 활성화되어 있지 않음';
$string['filternotinstalled'] = '$a 필터는 설치되어 있지 않음';
...
$string['guestnoeditprofile'] = '손님은 개인정보를 편집할 수 없습니다.';
$string['guestnoeditprofileother'] = '손님의 개인정보는 편집할 수 없습니다.';
...
$string['moduledoesnotexist'] = '본 모듈의 인스턴스가 존재하지 않음';
...
$string['noinstances'] = '이 강좌에 $a 의 인스턴스가 없습니다.';
...
$string['scheduledbackupsdisabled'] = '예정된 백업이 서버관리자에 의해 비활성화 되었습니다.';
...
$string['usernotrenamedadmin'] = '관리자 계정을 이름변경 할 수 없습니다.';
