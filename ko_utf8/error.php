...
$string['listcantmoveleft'] = '상위가 없어서 항목을 왼페이지으로 옮기지 못 함.';
$string['listcantmoveright'] = '하위 항목으로 만들 항목이 없어서 항목을 오른페이지으로 옮길 수 없음. 주변의 하위 항목으로 이동하고 거기서 오른페이지으로 옮길 수 있음';
