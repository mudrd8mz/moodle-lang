<?PHP // $Id$ 
      // role.php - created with Moodle 2.0 dev (Build: 20081123) (2008112101)
...
$string['gotoassignroles'] = '역할 부여 화면으로 가기';
...
$string['incontext'] = '$a->context 의 <b>$a->role</b>';
...
$string['noassignmentsfound'] = '$a 는 부여받은 역할 없음';
...
$string['roles'] = '역할들';
$string['rolesreassigned'] = '재 부여된 역할들';
$string['rolesunassigned'] = '부여되지 않은 역할들';
...
$string['unassignasabove'] = '선택된 부여 역할 삭제';
$string['unassignerror'] = '$a->user 사용자를 $a->role 역할에서 해임하는 중 오류';
$string['unassignexplain'] = '위의 양식은 작업순서 상 혹은 수동으로 임무 부여된 역할의 해임에만 사용될 수 있습니다. CIRCE 혹은 메타코스를 통해 이루어진 임무부여는 변경할 수 없습니다.';
$string['undounassign'] = '이전 역할로 되돌림!';
