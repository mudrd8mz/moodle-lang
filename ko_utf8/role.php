...
$string['allowoverride'] = '역할 재설정 허용';
$string['assignglobalroles'] = '광범위 역할 부여';
...
$string['calendar:managegroupentries'] = '관리자 모둠 일정 입력항목';
...
$string['course:bulkmessaging'] = '여러 사람에게 페이지글 발송';
...
$string['deletecourseoverrides'] = '강좌에 모든 역할 재설정을 삭제';
$string['deletelocalroles'] = '모든 지역적인 역할 부여 삭제';
...
$string['globalroleswarning'] = '경고! 이 화면에서 사용자에게 부여한 역할은 초기화면뿐만 아니라 이 사이트 전체의 강좌에 적용됩니다.';
...
$string['localroles'] = '지역적으로 부여된 역할들';
...
$string['notset'] = '설정 안됨';
$string['overridepermissions'] = '재설정 허가';
$string['overridepermissionsin'] = '$a에서 재설정 허가';
...
$string['role:override'] = '다른 사람에게 권한 재설정 부여';
...
$string['site:manageblocks'] = '사이트 전체 블록 관리';
...
$string['site:sendmessage'] = '아무 사용자에게 메세지 보냄';
