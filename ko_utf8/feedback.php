...
$string['mapcourseinfo'] = '이것은 피드백 블럭을 사용하여 모든 강좌에서 사용할 수 있는 사이트 공용 피드백입니다. 그러나 배치를 통해 피드백이 표시될 수 있는 강좌를 제한할 수 있습니다. 강좌를 검색한 후 강좌를 이 피드백과 연결하십시요.';
$string['mapcoursenone'] = '아무 강좌도 연결되지 않았습니다. 피드백은 모든 강좌에서 사용가능합니다.';
$string['mapcourses'] = '피드백을 강좌에 연결';
$string['mappedcourses'] = '연결된 강좌';
$string['max_args_exceeded'] = '최대 6개의 인수를 처리할 수 있습니다만, 다음은. 너무 인수가 많습니다.';
$string['maximal'] = '최대의';
$string['mode'] = '모드';
...
$string['non_anonymous'] = '이름이 기록되며 답과 함께 제시될 것입니다.';
...
$string['switch_item_to_not_required'] = '전환: 반드시 답해야 하는 것은 아닙니다.';
$string['switch_item_to_required'] = '전환: 반드시 답해야 합니다.';
$string['template'] = '템플릿';
