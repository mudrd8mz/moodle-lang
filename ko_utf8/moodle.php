...
$string['adminhelpauthentication'] = '외부 데이터베이스나 다른 이용자 계정을 사용할 수 있음';
...
$string['backupincludemoduleshelp'] = '자동 백업에 강좌 모듈, 이용자 데이터 등을 포함시키길 원하는지 선택';
$string['backupincludemoduleuserdatahelp'] = '자동 백업에서 모듈의 이용자 데이터를 포함시킬지의 여부를 선택합니다.';
...
$string['backuplogshelp'] = '강좌 로그파일을 포함하여 백업하려면 \"예\"를 선택';
$string['backupmetacoursehelp'] = '메타코스의 정보를 포함하여 백업하려면 \"예\"를 선택';
$string['backupnameformat'] = '%%Y%%m%%d-%%H%%M';
$string['backupnoneusersinfo'] = '주의: 이용자 자료 없이(\"무 사용자\") 백업 하도록 선택하였습니다. 따라서 모든 모듈 백업이 \"이용자 없음\" 상태로 전환 되었습니다. \"연습\"과 \"상호평가\" 모듈은 이러한 백업 형태로는 저장될 수 없기 때문에, 이러한 두 모듈은 완전히 쓸 수 없게 됨을 염두에 두기 바랍니다.';
...
$string['backupsitefileshelp'] = '강좌에서 사용한 파일을 함께 백업하려면 \"예\"를 선택';
$string['backuptakealook'] = '$a 에서 백업 기록을 확인 하세요.';
$string['backupuserfileshelp'] = '이용자의 파일(사진 등)을 자동 백업에 포함시킬지 선택';
$string['backupusershelp'] = '서버의 모든 이용자를 포함시킬지, 각 강좌의 필수 이용자만 포함시킬지 선택';
...
$string['olduserdirectory'] = '오래된 사용자 디렉토리이며 더 이상 필요하지 않습니다. 안전하게 삭제할 수 있습니다. 포함되어 있던 파일들은 새 사용자 디렉토리에 복사되었습니다.';
...
$string['resetinfo'] = '이 페이지는 강좌의 활동과 다른 설정은 그대로 둔 채, 이용자 데이터를 삭제할 수 있도록 해 줍니다. 아래 항목을 선택하고 이페이지를 제출하면, 당신의 데이터가 선택한 강좌에서 영구히 삭제됨을 유의하시기 바랍니다!';
