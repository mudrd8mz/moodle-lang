...
$string['addedtogroupnotenrolled'] = '이 배움터에 등록하지 않았기에 $a 모둠에 추가하지 않음.';
...
$string['adminhelpcourses'] = '배움터와 범주를 설정하고 사람들을 참여시키며 유보된 과정을 고침';
...
$string['adminhelpsitesettings'] = '대문화면 모양 설정';
$string['adminhelpstickyblocks'] = '고정 블록 환경 설정';
$string['adminhelpthemes'] = '사이트 겉모습(색, 글꼴 등) 선택';
...
$string['administratordescription'] = '관리자들은 사이트의 모든 배움터에서 어떤 작업이라도 할 수 있습니다.';
...
$string['areyousuretorestorethisinfo'] = '이 과정의 말미에 이 백업자료를 기존의 배움터에 추가할 것인지, 아니면 완전히 새 배움터로 생성할 것인지를 선택하여야 합니다.';
$string['asc'] = '오름차순';
...
$string['assignstudentsnote'] = '주의: 만일 학생 스스로 이 배움터에 참여하는 것을 가능하게 해 놓았다면, 본 화면이 필요없을 수도 있습니다.';
...
$string['backupincludemoduleshelp'] = '자동 백업에 배움터 모듈, 사용자 데이터 등을 포함시키길 원하는지 선택';
...
$string['backuplogshelp'] = '배움터 로그파일을 포함하여 백업하려면 \"예\"를 선택하세요.';
...
$string['country'] = '국가';
$string['course'] = '배움터';
$string['courseapprovedemail'] = '요청한 교육과정 $a->name 을 개설할 수 있도록 승인되었으며 $a->teacher 이 되었습니다. 새 배움터로 접속하려면 $a->url 로 가십시오.';
...
$string['coursecategories'] = '배움터 목록';
...
$string['creatingblocksroles'] = '블록 수준의 역할부여 및 위임권 생성';
$string['creatingcategoriesandquestions'] = '범주와 문항 만들기';
$string['creatingcoursemodules'] = '배움터 모듈 만들기';
$string['creatingcourseroles'] = '배움터 수준의 역할부여 및 위임권 생성';
...
$string['creatinguserroles'] = '사용자 수준의 역할부여 및 위임권 생성';
...
$string['default'] = '기본값';
$string['defaultcoursefullname'] = '배움터 전체 이름';
$string['defaultcourseshortname'] = 'CF101';
$string['defaultcoursestudent'] = '학생';
$string['defaultcoursestudentdescription'] = '일반적으로 배움터 안에서 학생들의 활동은 제약을 받습니다.';
...
$string['defaultcourseteacherdescription'] = '배움터 안에서 교사는 학생의 등급을 매기거나 활동을 바꾸는 등, 거의 모든 일을 할 수 있습니다.';
...
$string['deletingexistingcoursedata'] = '배움터에 있는 데이터 지우기';
...
$string['emaildisplaycourse'] = '이메일 주소를 다른 배움터의 참여자에게만 공개 허용';
...
$string['enrolledincourse'] = '배움터 \"$a\" 에  등록함';
$string['enrolledincoursenot'] = '배움터 \"$a\" 에  등록하지 않음';
$string['enrollfirst'] = '당신은 사이트에서 활동을 시작하기 전에 미리 배움터에 등록해야합니다.';
...
$string['enrolmentplugins'] = '출석 플러그인';
...
$string['existingcoursedeleting'] = '존재하는 배움터, 먼저 삭제하기';
$string['existingcreators'] = '기존의 배움터 만든이';
...
$string['from'] = '부터';
$string['frontpagecategorycombo'] = '합쳐진 목록';
$string['frontpagecategorynames'] = '목록 보기';
$string['frontpagecourselist'] = '배움터 목록';
$string['frontpagedescription'] = '대문화면 설명';
$string['frontpagedescriptionhelp'] = '대문화면에 사이트에 대한 설명이 표시될 것 입니다.';
...
$string['fulllistofcourses'] = '배움터 마당';
...
$string['guestuserinfo'] = '대개의 배움터에서 읽기만 할 수 있는 계정입니다.';
...
$string['importdata'] = '가져올 배움터 정보';
$string['importdataexported'] = '배움터로부터 내보낸 정보를 성공적으로 불러들였습니다.<br />가져오기를 계속합니다.';
...
$string['managemetaexplan'] = '(출석상황이 다른 배움터로부터 이관되었다는 것을 의미합니다)';
...
$string['metanopotentialcourses'] = '배움터를 이용할 수 없습니다.';
$string['metapotentialcourses'] = '배움터 이용 가능';
$string['metaremovecourse'] = '배움터 제거';
$string['min'] = '분';
$string['mins'] = '분';
$string['minutes'] = '분간';
...
$string['movecourseto'] = '배움터를 다음으로 옮김 :';
...
$string['moveselectedcoursesto'] = '선택된 배움터를 옮김';
...
$string['none'] = '없음';
$string['noneditingteacher'] = '편집권한이 없는 교사';
$string['noneditingteacherdescription'] = '편집권한을 가지지 못한 교사는 배움터에서 평가를 하거나 가르칠 수는 있지만 활동을 고치지는 못합니다.';
...
$string['nostudentsyet'] = '아직 이 배움터에 등록한 학생이 없습니다.';
...
$string['personalprofile'] = '개인 신상명세';
$string['phone'] = '전화';
$string['phpinfo'] = 'PHP 정보';
$string['pictureof'] = '$a 의 사진';
...
$string['requireskey'] = '이 배움터는 등록키가 필요합니다.';
$string['requirespayment'] = '이 배움터는 수강하기위해 등록금이 필요함';
$string['reset'] = '초기화';
$string['resetcourse'] = '배움터 초기화';
$string['resetinfo'] = '이 페이지는 배움터의 활동들과 다른 설정은 그대로 두고 당신의 사용자 데이터를 삭제할 수 있도록 해 줍니다. 아래 항목을 선택하고 이페이지를 제출하면 당신의 데이터가 당신이 선택한 배움터에서 영구히 삭제됨을 유의하시기 바랍니다!';
...
$string['sitepartlist0'] = '사이트 참여자 목록을 보기 위해서는 사이트 교사의 자격이 있어야만 합니다.';
$string['sitepartlist1'] = '사이트 참여자 목록을 보기 위해서는 교사의 자격이 있어야만 합니다.';
$string['sites'] = '사이트';
...
$string['sizemb'] = 'MB';
$string['skipped'] = '생략';
$string['skiptomaincontent'] = '목차로 이동';
...
$string['statsreport11'] = '가장 활동적인 배움터';
$string['statsreport12'] = '가장 활동적인 배움터 (가중치)';
$string['statsreport13'] = '등록자수가 가장 많은 배움터';
$string['statsreport14'] = '보기 및 글쓰기가 가장 활발한 배움터';
...
$string['statsteacheractivity'] = '교사 활동';
$string['statsteacherreads'] = '교사 열람수';
$string['statsteacherwrites'] = '교사 게시물';
...
$string['updatemyprofile'] = '신상명세 수정';
...
$string['userprofilefor'] = '$a 에 대한 신상명세';
$string['users'] = '사용자';
