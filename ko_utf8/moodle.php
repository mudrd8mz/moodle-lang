...
$string['addedtogroup'] = '$a 모둠추가';
$string['addedtogroupnot'] = '$a 를 모둠으로 추가 하지 않음';
$string['addedtogroupnotenrolled'] = '이 강좌에 등록하지 않았기에 $a 모둠에 추가하지 않음.';
...
$string['adminhelpassigncreators'] = '생성자는 새로운 강좌를 생성하고 그 안에서 가르칠 수 있음';
$string['adminhelpassignsiteroles'] = '특정 사용자에게 지정한 역할을 적용함';
$string['adminhelpassignstudents'] = '강좌로 가서 학생들을 추가하기';
$string['adminhelpassignteachers'] = '강좌를 찾아 아이콘을 사용하여 선생님을 추가';
$string['adminhelpauthentication'] = '외부의 데이터베이스나 다른 사용자 계정을 사용할 수 있음';
...
$string['adminhelpcourses'] = '강좌와 범주를 설정하고 사람들을 참여시키며 유보된 과정을 고침';
...
$string['adminhelpmymoodle'] = '내 공부방 사용자를 위한 블럭 설정';
$string['adminhelpreports'] = '교육과정 순위 보기';
$string['adminhelpsitefiles'] = '서버에 올라온 파일 관리';
$string['adminhelpsitesettings'] = '초기화면 모양 설정';
$string['adminhelpstickyblocks'] = '고정 블록 환경 설정';
$string['adminhelpthemes'] = '사이트 꾸미기(색, 글꼴 등) 선택';
$string['adminhelpuploadusers'] = '텍스트 파일을 불러들여 새 사용자계정 추가';
...
$string['adminprimarynoedit'] = '초기 관리자의 암호는 변경할 수 없음';
$string['advanced'] = '고급';
...
$string['allmods'] = '모든 $a';
$string['allow'] = '허용';
$string['allowguests'] = '이 강좌는 손님 계정을 허용합니다.';
...
$string['assignsiteroles'] = '전 사이트를 관장하는 역할 부여';
$string['assignstudents'] = '소속된 학생들';
$string['assignstudentsnote'] = '주의: 만일 학생 스스로 이 강좌에 참여하는 것을 가능하게 해 놓았다면, 본 화면이 필요없을 수도 있습니다.';
...
$string['backupincludemoduleshelp'] = '자동 백업에 강좌 모듈, 사용자 데이터 등을 포함시키길 원하는지 선택';
$string['backupincludemoduleuserdatahelp'] = '자동 백업에서 모듈의 사용자 데이터를 포함시킬지의 여부를 선택합니다.';
$string['backupkeephelp'] = '강좌를 백업할 때 오래된 백업파일을 몇 개까지 서버에 보관할까요? (오래된 것은 자동으로 삭제됩니다.)';
$string['backuplogdetailed'] = '자세한 실행기록';
$string['backuploglaststatus'] = '지난 실행기록';
$string['backuplogshelp'] = '강좌 로그파일을 포함하여 백업하려면 \"예\"를 선택하세요.';
$string['backupmetacoursehelp'] = '이를 활성화 시키면, 메타코스의 정보를 포함하여 백업됩니다.';
$string['backupnameformat'] = '%%Y%%m%%d-%%H%%M';
$string['backupnoneusersinfo'] = '주의: \"무 사용자\"를 백업 하도록 선택하셨습니다. 따라서 모든 모듈 백업들이 \"사용자 없음\" 상태로 전환 되었습니다. \"연습\"과 \"상호평가\" 모듈을 바르게 사용하기 위해서는  이러한 형태의 백업은 바람직하지 않음을 염두에 두기 바랍니다.';
...
$string['backuproleassignments'] = '이 역할들에대해 백업 역할 부여';
$string['backupsavetohelp'] = '백업 파일을 저장할 전체 경로 입력<br />(기존 강좌 경로에 저장하려면 빈칸으로 둘 것)';
$string['backupschedulehelp'] = '자동백업 실시요일 선택';
$string['backupsitefileshelp'] = '이를 활성화하면 자동백업할 때, 강좌에서 사용한 파일은 함께 백업됩니다.';
$string['backuptakealook'] = '$a 에서 백업 기록을 확인 하세요.';
$string['backupuserfileshelp'] = '사용자의 파일을 자동 백업에 포함시킬지 선택하세요.';
$string['backupusershelp'] = '서버의 모든 사용자를 포함할 지, 각 강좌에 요구되는 사용자만 포함할지 선택하세요.';
...
$string['categoryupdated'] = '범주 \'$a\'가 갱신되었습니다.';
...
$string['city'] = '도시';
$string['clambroken'] = '관리자가 업로드파일에 대해 바이러스 체크를 활성화시킨 상태입니다만 설정제어에 문제가 있습니다.<br />당신의 파일 업로드는 실패했습니다. 관리자에게 그 사항을 알리고 고칠 수 있도록 메일을 보낸상태입니다.<br />다음에 업로드해 보십시오.';
...
$string['continue'] = '계속';
$string['continuetocourse'] = '강좌에 들어가려면 이곳을 누르세요';
$string['convertingwikitomarkdown'] = 'Wiki 를 Markdown 으로 변환';
$string['cookiesenabled'] = '당신의 브라우저에 쿠키가 가능하여야 합니다.';
...
$string['coursenotaccessible'] = '이 강좌는 공개되지 않음';
$string['courseoverview'] = '강좌 개요';
$string['courseoverviewgraph'] = '강좌 개요 그래프';
...
$a';
$string['courserejectreason'] = '강좌 개설이 거절된 개요<br />(이것은 신청자에게 이메일로 통보될 것입니다)';
$string['courserejectsubject'] = '당신의 강좌 개설 신청이 거부됨';
$string['courserequest'] = '개설 요청';
$string['courserequestdisabled'] = '죄송합니다, 요청된 강좌는 관리자에 의해 거부되었습니다.';
$string['courserequestfailed'] = '어떠한 이유로 인해 당신의 강좌 개설 요청이 저장되지 않았습니다.';
...
$string['courserequestsuccess'] = '당신의 개설 신청은 성공적으로 저장되었습니다. 그 결과가 며칠안에 이메일로 보내질 것입니다.';
$string['courserestore'] = '강좌 복원';
$string['courses'] = '강좌';
$string['coursescategory'] = '동일 범주의 강좌';
$string['coursespending'] = '유보되었던 강좌 승인';
$string['coursestaught'] = '내가 가르치는 강좌';
$string['courseupdates'] = '강좌 업데이트';
$string['courseuploadlimit'] = '강좌 업로드 제한';
$string['create'] = '새로 만들기';
$string['createaccount'] = '계정 만들기';
$string['createfolder'] = '$a 안에 새 폴더 만들기';
$string['createuserandpass'] = '새로운 아이디와 비밀번호 생성하기';
$string['createziparchive'] = '압축 파일 만들기';
$string['creatingblocks'] = '블럭 만들기';
$string['creatingblocksroles'] = '블록 수준의 역할부여 및 재설정권 생성';
...
$string['creatinguserroles'] = '사용자 수준의 역할부여 및 재설정권 생성';
...
$string['currentlocaltime'] = '현재의 지방시';
...
$string['emailpasswordconfirmmaybesent'] = '<p>만약 사용자ID나 이메일 주소가 정확하면 이메일이 발송될 것입니다.</p>
...
$string['enrolenddaterror'] = '등록기간의 마감날짜는 시작날짜보다 먼저일 수 없습니다.';
...
$string['enrollfirst'] = '당신은 사이트에서 활동을 시작하기 전에 미리 강좌에 등록해야합니다.';
...
$string['existingcourse'] = '존재하는 강좌';
$string['existingcourseadding'] = '존재하는 강좌, 데이터 추가하기';
...
$string['langltr'] = '왼페이지에서 오른페이지으로 쓰는 언어';
$string['langrtl'] = '오른페이지에서 왼페이지으로 쓰는 언어';
$string['language'] = '언어';
...
$string['loginsteps'] = '안녕하세요! 이 웹사이트를 충분히 이용하시려면 새로운 계정을 만들어야 합니다. 어떤 강좌는 등록키가 필요할 수도 있습니다.
   <ol>
   ...
   <li>등록이 완료되면 강좌를 충분히 이용할 수 있습니다.</li>
   </ol>';
...
$string['loginusing'] = '사용자아이디와 비밀번호를 사용하여 로그인하세요.';
$string['logout'] = '로그아웃';
$string['logoutconfirm'] = '로그아웃 하시겠습니까?';
$string['logs'] = '로그';
...
$string['messagedselectedusers'] = '이미 메세지를 받은 사용자를 선택하고 수령인 목록을 초기화합니다.';
$string['messagedselectedusersfailed'] = '메세지를 보내기위해 사용자를 선택하는중 오류가 발생했습니다. 누군가는 이메일을 이미 받았습니다.';
$string['messageselect'] = '이 사용자를 이메일 수신자으로 선택합니다.';
$string['messageselectadd'] = '추가 / 메세지 보내기';
$string['metaaddcourse'] = '이 과정을 추가함';
$string['metaalreadycourses'] = '강좌가 이미 지정됨';
$string['metaalreadyhascourses'] = '이 메타과정은 이미 하위과정이 있습니다.';
$string['metaalreadyhasenrolments'] = '이 강좌는 이미 정규 등록됨';
$string['metaalreadyinmeta'] = '이 강좌는 이미 메타코스와 분리됨';
...
$string['moveleft'] = '왼페이지으로 옮김';
$string['moveright'] = '오른페이지으로 옮김';
...
$string['newpasswordfromlost'] = '당신의 현재 비밀번호가 당신의 이메일로 전송될것이고 그 다음에 잊어버린 비밀번호 복구 프로세스 부분이 두 통의 이메일로 보내질 것입니다. 화면을 진행시키기 전에 당신이 받은 비밀번호로 대체하시기 바랍니다.';
...
대부분의 메일 프로그램에서는 이것이 당신이 클릭할 수 있는 파란색 링크로 표시됩니다. 만일 그렇지 않은 경우에는 주소를 웹브라우저 윈도우의 주소창에 복사하여 사용하십시요.
...
$string['noteuserschangednonetocourse'] = '주의: 사용자 데이터(활동, 파일, 메시지 등)를 복구할 때는 강좌의 사용자가 먼저 복구되어 있어야 합니다. 이 설정은 변경되었습니다.';
...
$string['nousersfound'] = '아무 사용자도 발견되지 않았음';
...
$string['olduserdirectory'] = '오래된 사용자 디렉토리이며 더 이상 필요하지 않습니다. 안전하게 삭제할 수 있습니다. 포함하고 있던 파일들은 새 사용자 디렉토리에 복사되었습니다.';
...
$string['payments'] = '지불';
$string['paymentsorry'] = '당신의 지불에 감사드립니다! 불행하게도 당신의 지불은 아직 완료되지 않았으며 강좌에 \"$a->fullname\" 로 완전히 등록되지 않았습니다. 몇 초 후에 계속 강좌 진입을 시도해 보시길 바랍니다. 만일 지속적으로 문제가 있다면 사이트 관리자나 $a->teacher 에게 연락하시기 바랍니다.';
$string['paymentthanks'] = '당신의 지불에 감사드립니다! 당신은 강좌 $a 에 정상적으로 등록되었습니다.<br />';
$string['people'] = '사용자';
...
$string['pluginchecknotice'] = '다음 표에는 현재 무들에 설치되어 있다고 인식된 모듈, 블록 그리고 필터가 나타나 있습니다. 여기에는 어느 것이 표준이고 어느 것이 비 표준인지도 나타나 있습니다. 무들의 갱신 과정을 계속하기 전에 모든 비 표준 플러그인은 가장 최신판으로 갱신되어야 하고 제대로 작동되는지 점검해야 합니다.';
...
$string['registrationcontactyes'] = '네, 무들 사용자 등록 양식을 제공해 주세요';
...
$string['resetinfo'] = '이 페이지는 강좌의 활동들과 다른 설정은 그대로 두고 당신의 사용자 데이터를 삭제할 수 있도록 해 줍니다. 아래 항목을 선택하고 이페이지를 제출하면 당신의 데이터가 당신이 선택한 강좌에서 영구히 삭제됨을 유의하시기 바랍니다!';
...
$string['restorecoursenow'] = '이 강좌를 지금 복구하기!';
...
$string['savechangesandreturntocourse'] = '변경사항 저장 후 강좌로 복귀';
$string['savedat'] = '다음에 저장됐음 :';
$string['savepreferences'] = '개인설정 저장';
$string['saveto'] = '저장하기';
$string['scale'] = '척도';
$string['scales'] = '척도';
$string['scalescustom'] = '개인설정 척도';
...
$string['scalestip'] = '개인설정 척도를 생성하기 위해서는 강좌 관리자 메뉴의 \'척도\'링크를 사용하세요.';
$string['schedule'] = '일정';
$string['scheduledbackupsinactive'] = '예정된 백업이 사이트 관리자에 의해 활성화되지 않았습니다.';
...
$string['statsnodata'] = '교육과정과 기간을 산출할 수 있도록 허용된 데이터가 없습니다';
$string['statsnodatauser'] = '교육과정과 사용자 그리고 기간을 산출할 수 있도록 허용된 데이터가 없습니다';
$string['statsoff'] = '통계가 활성화되어 있지 않습니다.';
...
$string['usersnoaccesssince'] = '이상 비활동중인 사용자 보기';
...
$string['wordforteachereg'] = '예: 선생님,교수자, 도우미,촉진자';
...
$string['youneedtoenrol'] = '그 활동을 하려면 이 강좌에 등록을 해야 합니다.';
