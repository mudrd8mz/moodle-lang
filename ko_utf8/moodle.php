...
$string['adminhelpcourses'] = '배움터와 범주를 설정하고 사람들을 참여시키기';
...
$string['adminhelpenvironment'] = '서버가 현재 혹은 미래의 설치필요조건에 맞는지 확인하시요.';
$string['adminhelpfailurelogs'] = '로그인  실패 기록 열기';
$string['adminhelphealthcenter'] = '자동으로 사이트의 문제를 점검';
...
$string['adminhelpmanagefilters'] = '텍스트 필터선택과 설정관리하기';
...
$string['adminhelpstickyblocks'] = '전역 블록 환경 설정';
$string['adminhelpthemes'] = '사이트 겉모습(테마) 선택하기';
...
$string['administrationsite'] = '사이트 관리자';
$string['administrator'] = '관리자';
$string['administratordescription'] = '관리자들은 사이트 내 모든 배움터에서 어떤 작업이라도 할 수 있습니다.';
...
$string['areyousuretorestorethisinfo'] = '이 과정이 지나면 백업 후 외부의 배움터에 첨가할 것인지, 아니면 완전히 새 배움터를 생성할 것인지 선택하여야 합니다.';
$string['assessment'] = '평가';
$string['assignadmins'] = '관리자 권한부여';
$string['assigncreators'] = '생성자 권한부여';
$string['assignsiteroles'] = '사이트 전체 역할 부여';
...
$string['backupexecuteathelp'] = '자동 백업 시작시간 선택';
...
$string['country'] = '국가';
$string['course'] = '배움터';
$string['courseapprovedemail'] = '요청한 교육과정 $a->name을 개설할 수 있도록 승인되었으며 $a->teacher 이 되었습니다. 새 교육과정으로 접속하려면 $a->url 로 가십시오.';
...
$a';
$string['courserejectreason'] = '이 교육과정 개설이 거절된 이유의 개요입니다.<br />(이 것은 신청자에게 이메일로 통보될 것입니다)';
$string['courserejectsubject'] = '당신의 교육과정 신청이 거부되었습니다.';
$string['courserequest'] = '개설 신청';
...
$string['databaseupgradeblocks'] = '현재 블럭버전은 $a 입니다.';
...
$string['deletecategorycheck'] = '<b>\'$a\'<b/> 범주를 완전히 삭제하시겠습니까? 상위 범주로 모든 코스가 이동하거나 여타 장소로 이동됩니다.';
...
$string['editgroupprofile'] = '모둠 프로필 고치기';
...
$string['enrolmentkeyfrom'] = '이 배움터는 \'등록키\'가 필요합니다.<br /> 참여키는 $a 에게서 받을 수 있습니다.';
...
$string['frontpageformatloggedin'] = '로그인 했을 때 첫 화면';
$string['frontpagenews'] = '새소식 보기';
$string['frontpagetopiconly'] = '토픽 보기';
...
$string['guestuserinfo'] = '어떤 배움터에서는 단지 읽기만 할 수 있는 계정입니다.';
$string['healthcenter'] = '안정성 점검 센터';
$string['healthproblemsdetected'] = '안정성 점검에서 문제가 발견돠었습니다!';
...
$string['htmleditordisabledadmin'] = '관리자가 HTML 편집기를 사용할 수 없도록 설정하였습니다.';
...
$string['importmetacoursenote'] = '메타 코스를 이용할때 이 폼을 이용하세요(출석상황도 같이 가져올 것입니다)';
$string['inactive'] = '비활동';
$string['include'] = '포함';
...
$string['metaalreadyhascourses'] = '이 meta과정은 이미 하위과정이 있습니다.';
...
$string['move'] = '옮기기';
$string['movecategoryto'] = '범주 다음으로 옮기기 :';
$string['movecourseto'] = '배움터 다음으로 옮기기 :';
...
$string['registrationcontactyes'] = '네, Moodle 사용자 등록 양식을 제공해 주세요';
...
$string['resetinfo'] = '이 페이지는 배움터에서 활동들과 다른 설정은 그대로 두고 당신의 데이터를 삭제할 수 있도록 해 줍니다. 아래 항목을 선택하고 이페이지를 제출하면 당신의 데이터가 당신이 선택한 배움터에서 영구히 삭제됨을 유의하시기 바랍니다!';
...
$string['scale'] = '척도';
$string['scales'] = '척도';
$string['scalescustom'] = '사용자 정의 척도';
$string['scalescustomcreate'] = '새로운 척도 추가';
$string['scalescustomno'] = '사용자 정의 척도가 생성되지 않았습니다.';
$string['scalesstandard'] = '표준 척도';
$string['scalestip'] = '사용자 정의 척도를 생성하기 위해서는 배움터 관리자 메뉴의 \'척도\'링크를 사용하세요.';
$string['schedule'] = '일정';
...
$string['unenrol'] = '탈퇴하다';
$string['unenrolallstudents'] = '모든 학생을 탈퇴시킴';
...
$string['warningdeleteresource'] = '주의: $a 가 자원에서 참조되었습니다. 그 자원을 갱신하고자 하십니까?';
