...
$string['adminhelpenvironment'] = '당신의 서버가 현재 혹은 미래의 설치필요조건에 맞는지 확인하시요.';
...
$string['backupnonisowarning'] = '경고: 이 백업은 Unicode 이전버전(1.6이전)으로 부터 입니다. Unicode 버전으로 복구할때 ASCII 문자 이외의 문자를 가지고 있으면 문제가 있을 수 있습니다. 이 백업을 올바르게 복구하기 위한 정보를 보기위해서는 <a href=\"http://docs.moodle.org/en/Backup_FAQ\">백업 FAQ</a> 를 참고하십시요.
';
...
$string['formatweekscss'] = '주별 포멧 - CSS/표없음';
...
$string['statsoff'] = '통계가 현재 활성화 되지 않았습니다.';
