...
$string['backupcoursefileshelp'] = '이 항목을 \"예\"로 해 놓으면, 강좌 파일을 자동 백업에 포함시킵니다.';
...
$string['backupincludemoduleshelp'] = '백업에 강좌 모듈, 이용자 데이터 등을 포함시킬지 여부 선택';
$string['backupincludemoduleuserdatahelp'] = '백업에 강좌 모듈, 이용자 데이터 등을 포함시킬지 여부 선택';
$string['backupkeephelp'] = '백업할 때 오래된 백업파일을 몇 개까지 서버에 보관할까요? (오래된 것은 자동으로 삭제됨)';
...
$string['backupnoneusersinfo'] = '주의: 이용자 자료를 제외시키고(\"무 사용자\") 백업 하도록 선택하였기 때문에, 모든 모듈 백업이 \"이용자 없음\" 상태로 전환 되었습니다. \"연습\"과 \"상호평가\" 모듈은 이러한 백업 형태로는 저장될 수 없기 때문에, 이 두 모듈은 전혀 쓸 수 없게 됨을 염두에 두기 바랍니다.';
...
$string['backuproleassignments'] = '이 역할들에 대한 부여 상황 백업';
...
$string['city'] = '도시';
$string['clambroken'] = '관리자가 업로드파일에 대해 바이러스 체크를 활성화시킨 상태입니다만 설정제어에 문제가 있습니다.<br />파일 올리기는 실패했습니다. 관리자에게 그 사항을 알리고 고칠 수 있도록 메일을 보낸 상태입니다.<br />다음에 업로드해 보십시오';
...
$string['country'] = '국가';
$string['course'] = '강좌';
$string['courseapprovedemail'] = '요청한 $a->name 강좌는 개설할 수 있도록 승인되었으며 $a->teacher 가 되었습니다. 새 강좌로 접속하려면 $a->url 로 가십시오.';
