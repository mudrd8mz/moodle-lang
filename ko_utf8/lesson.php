<?PHP // $Id$ 
      // lesson.php - created with Moodle 1.6 Beta 4 (2006042800)
...
$string['highscores'] = '최고 점수';
$string['hightime'] = '높은 시간';
$string['importcount'] = '$a 문제를 가져오기';
...
$string['lessonnotready'] = '이 레슨은 준비되지 않았습니다. $a 에게 연락하시오.';
$string['lessonopen'] = '이 학습과정은 $a 에 열릴 것입니다.';
$string['lessonopens'] = '학습 시작';
$string['lessonpagelinkingbroken'] = '첫번째 페이지가 발견되지 않았습니다. 레슨 페이지 링크가 끊어졌을 수 있습니다. 관리자에게 연락하십시요.';
...
$string['nocoursemods'] = '아무 활동이 발견되지 않음';
$string['noessayquestionsfound'] = '이 레슨에 에세이 질문이 발견되지 않음';
$string['nohighscores'] = '높은 점수 없음';
$string['nolessonattempts'] = '이 레슨에 대해 아무 시도도 없었음';
...
$string['noonehasanswered'] = '아무도 에세이 질문에 대답을 아직 하지 않았습니다.';
...
$string['viewreports'] = '$a->attempts 시도와 $a->student 완료한 학생보기';
