<?PHP // $Id$ 
      // grades.php - created with Moodle 1.9 Beta + (2007083100)
...
$string['aggregateoutcomes'] = '총계에 학업성과 포함';
$string['aggregateoutcomeshelp'] = '총계에 학업성과를 포함시키는 것이 원하는 총점을 제시하는 것은 아니기 때문에, 성과를 포함시킬지 혹은 제외시킬지는 선택 사항이다.';
...
$string['aggregationcoefhelp'] = '총계 산출시에 사용될 본 점수 항목의 가중치';
