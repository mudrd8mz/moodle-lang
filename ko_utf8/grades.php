...
$string['compact'] = '간결한';
$string['configaggregationposition'] = '실점수를 참조한 채점자 보고서 표에서 총 합계 열의 위치';
...
$string['configcoursegradedisplaytype'] = '이 강좌에 대한 성적의 기본 표시형식을 선택하세요. 사이트 기본값을 선택할 수 있습니다. 성적은 실점수, 백분율(최소,최대성적을 참조하여), 문자성적(A,B,C등)으로 보여질 수 있습니다. 문자를 선택하면 교수자가 성적문자 및 경계를 정의할 수 있습니다.';
...
$string['configgradedisplaytype'] = '성적은 실점수나 (최소 및 최대 성적을 참조한) 백분율 혹은 문자(A,B,C등)로 표시될 수 있다.';
