...
$string['aggregateonlygraded'] = '비어 있지 않은 성적만 집계';
$string['aggregateonlygradedhelp'] = '존재하지 않는 성적은 최소성적으로 처리되거나 집계에 포함되지 않습니다.';
$string['aggregateoutcomes'] = '총계에  학습성과 포함';
$string['aggregateoutcomeshelp'] = '총계에  학습성과를 포함시키는 것은 원하는 총점..., 따라서  학습성과를 제외시킬지 혹은 포함시킬지에 대한 선택권을';
$string['aggregatesonly'] = '총계만';
$string['aggregatesubcats'] = '하위 범주를 포함한 집계';
$string['aggregatesubcatshelp'] = '집계는 보통 하위범주에 대해서만 되어집니다. 다른 집계된 성적을 배제하고 모든 하위범주에서 성적을 집계하는 것이 가능합니다.';
$string['aggregatesum'] = '성적 합계';
$string['aggregateweightedmean'] = '성적의 가중 평균';
$string['aggregateweightedmean2'] = '간한하게 가중치 준 성적 평균';
$string['aggregation'] = '총계';
$string['aggregationcoef'] = '총계 계수';
$string['aggregationcoefextra'] = '가산 점수';
$string['aggregationcoefextrahelp'] = '집계중 이 성적항목에 대한 가산점수';
$string['aggregationcoefweight'] = '항목 가중치';
$string['aggregationcoefweighthelp'] = '다른 성적항목과 집계중에 이 성적항목에 있는 모든 성적에 가중치 적용';
$string['aggregationhelp'] = '강좌에서 모든 학습자들에 걸쳐 성적을 집계하는데 사용되는 전략';
...
$string['badgrade'] = '제공된 성적이 잘못 되었습니다.';
...
$string['configdisablegradehistory'] = '성적 관련 테이블에서 변화 이력 추적 비활성화하세요. 그러면 서버가 조금 빨라지며 데이터베이스에 공간을 보존할 것입니다.';
$string['configenableajax'] = '채점자 보고서에서 일반 동작을 간단히 하고 빠르게 하는 AJAX 기능 레이어 추가. 사용자 브라우저에서 자바스크립트가 켜져 있어야 함.';
$string['configenableoutcomes'] = '학습성과 지원(신뢰성, 목표, 기준 혹은 표준)이란  학습성과 지침에 따른 하나 혹은 여럿의 척도에 의거하여 성적을 산출한다는 것이다. 출력을 활성화하면 그러한 특별한 성적 산출을 사이트 전반에 걸쳐 가능하게 한다.';
$string['configexportdecimalpoints'] = '내보내기에 표시할 소수점 자리수. 내보내기 도중 덮어쓰기 될 수 있습니다.';
...
$string['configgradeexportdisplaytype'] = '성적은 내보내기에서 실제 점수나 백분율(최소 및 최대 성적을 참조하여) 혹은 문자(A,B,C등) 로 표시될 수 있습니다. 내보내기 도중 덮어쓰기 될 수 있습니다.';
$string['configgradehistorylifetime'] = '이것은 성적관련 테이블에서 변경 기록을 보존하고자 하는 시간을 명시합니다. 가능한 길게하는 것을 추천합니다. 성능문제가 있다거나 데이터베이스 공간이 부족한 경우 작은 값을 사용하세요.';
$string['configgradeitemadvanced'] = '성적항목을 편집할때 고급으로 표시되어야 만 할 모든 요소를 선택하세요.';
...
$string['configgradepublishing'] = '내보내기와 가져오기에서 출판 활성화: 내보내기된 성적은 URL을 접속하여 접근할 수 있습니다. 성적은 그러한 URL을 접근하여 가져올 수 있습니다.(다른 무들사이트에서 출판된 성적을 무들사이트에서 가져올 수 있음을 의미합니다) 기본적으로 관리자만 이 기능을 사용할 수 있습니다. 다른 역할에 요구되는 능력을 추가하기 전에 사용자를 교육시키십시요.(북마크 공유, 가속기 다운로드, IP제한 등의 위험)';
$string['confighiddenasdate'] = '사용자가 숨겨진 성적을 볼 수 없을때 \'-\'대신 제출일을 보여주세요.';
$string['confighideforcedsettings'] = '채점 UI에서 강제 설정을 보여주지 마세요.';
$string['configmeanselection'] = '열 평균에 어느 종류의 성적이 포함될지 선택. 점수가 없는 셀은 무시되거나 0으로 간주(기본 설정)될 수 있습니다.';
$string['configprofilereport'] = '사용자 개인 정보 페이지에 성적 보고서가 사용됨';
...
$string['configshowhiddenitems'] = '사용자가 moodle/grade:viewhidden 능력을 가지고 있지않을때라도 보고서에 숨겨진 항목을 보여주세요. 숨겨진 성적의 가시성은 이 설정에 영향받지 않습니다.';
...
$string['configshowuserimage'] = '채점자 보고서에서 이름 옆에 사용자의 개인정보 사진을 보여 줄지 여부';
...
$string['disablegradehistory'] = '성적 기록 비활성화';
...
$string['errornocourse'] = '강좌 정보를 얻을수 없습니다.';
...
$string['expand'] = '범주 확장';
$string['export'] = '내보내기';
$string['exportfeedback'] = '내보내기에서 의견을 포함';
...
$string['gradecategorysettings'] = '성적 범주 설정';
...
$string['gradehistorylifetime'] = '성적 기록 수명';
$string['gradeitem'] = '성적 항목';
$string['gradeitemaddusers'] = '성적에서 제외';
$string['gradeitemadvanced'] = '고급 성적 항목 옵션';
$string['gradeitemislocked'] = '이 활동은 성적표에서 잠겨 있습니다. 이 활동에서 성적에 가해진 변경들은 잠금이 해제되기 전까지는 성적표에 복사되지 않을 것입니다.';
...
$string['gradeoutcomeitem'] = '성적  학습성과 항목';
...
$string['hidden'] = '비공개';
$string['hiddenasdate'] = '감춰진 성적에 대한 제출일 보이기';
...
$string['linkedactivityhelp'] = '이 출력 항목과 연결된 선택적 활동';
$string['lock'] = '잠금';
$string['locked'] = '잠김';
...
$string['mode'] = '모드';
$string['morethanmax'] = '$a->itemname 에 대하여 $a->username 에게 입력된 성적은 최대 허용된 것보다 큽니다. allowed';
...
$string['noidnumber'] = 'id number가 없음';
...
$string['outcomestandardhelp'] = '모든 강좌에 대해 사이트 전체에 걸쳐 공용으로 쓸 수 있는 표준 출력';
...
$string['overriddennotice'] = '이 활동에 대한 최종 성적이 수동적으로 조정되었습니다.';
$string['overridesitedefaultgradedisplaytype'] = '사이트 기본 재설정';
$string['overridesitedefaultgradedisplaytypehelp'] = '채점표에서 성적표시를 위한 사이트 기본을 재설정을 활성화하기 위해서는 이 체크박스를 표시하세요. 이것은 성적문자와 경계를 마음대로 선택할 수 있도록 양식요소를 활성화 합니다.';
...
$string['profilereport'] = '사용자 개인정보 보고서';
...
$string['shownumberofgrades'] = '평균에서 성적의 수 보이기';
$string['showranges'] = '범위 보이기';
$string['showrank'] = '순위 보기';
$string['showuserimage'] = '개인정보 사진 보이기';
...
$string['left'] = '왼페이지'; // ORPHANED
$string['right'] = '오른페이지'; // ORPHANED
