...
$string['addoutcomeitem'] = '출력 항목 추가';
...
$string['aggregateoutcomes'] = '총계에 출력물 포함';
$string['aggregateoutcomeshelp'] = '총계에 출력물을 포함시키는 것은 원하는 총점..., 따라서 출력물을 제외시킬지 혹은 포함시킬지에 대한 선택권을';
...
$string['configenableoutcomes'] = '출력물 지원(신뢰성, 목표, 기준 혹은 표준)이란 출력 지침에 따른 하나 혹은 여럿의 척도에 의거하여 성적을 산출한다는 것이다. 출력을 활성화하면 그러한 특별한 성적 산출을 사이트 전반에 걸쳐 가능하게 한다.';
...
$string['editoutcomes'] = '출력 수정';
$string['edittree'] = '범주 편집';
$string['enableajax'] = 'AJAX 활성화';
$string['enableoutcomes'] = '출력 활성화';
$string['encoding'] = '엔코딩';
...
$string['gradeoutcomeitem'] = '성적 출력 항목';
...
$string['outcome'] = '결과';
$string['outcomecategory'] = '범주내 출력물 생성';
$string['outcomecategorynew'] = '새 범주';
$string['outcomecreate'] = '새 출력 추가';
$string['outcomeidhelp'] = '성적 항목을 나타내는 출력물';
$string['outcomeitem'] = '출력 항목';
$string['outcomeitemsedit'] = '출력 항목 수정';
$string['outcomename'] = '출력 명칭';
$string['outcomereport'] = '출력 보고서';
$string['outcomes'] = '산출물';
$string['outcomescourse'] = '배움터 출력물';
$string['outcomescoursecustom'] = '맞춤 출력(제거할 수 없음)';
$string['outcomescoursenotused'] = '표준 사용 안함';
$string['outcomescourseused'] = '표준 출력(제거할 수 없음)';
$string['outcomescustom'] = '맞춤 출력';
$string['outcomesstandard'] = '표준 출력';
$string['outcomesstandardavailable'] = '표준 출력 사용 가능';
$string['outcomestandard'] = '표준 출력';
$string['outcomestandardhelp'] = '모든 배움터에 대해 사이트 전체에 걸쳐 공용으로 쓸 수 있는 표준 출력';
