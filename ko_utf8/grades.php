...
$string['configgradedisplaytype'] = '성적은 실제 점수나 백분율(최소 및 최대 성적을 참조하여) 혹은 문자(A,B,C등) 로 표시될 수 있다.';
$string['configgradeexportdisplaytype'] = '성적은 내보내기에서 실제 점수나 백분율(최소 및 최대 성적을 참조하여) 혹은 문자(A,B,C등) 로 표시될 수 있다. 내보내기 도중 변경될 수 있다.';
...
$string['configquickfeedback'] = '일괄 채점은 한꺼번에 많은 점수를 편집할 수 있도록 채점자 보고서의 각 셀에 텍스트 입력난을 추가한다. 한번에 하나씩 저장하는 대신, 변경사항을 한꺼번에 저장하기 위해 갱신 버튼을 클릭할 수 있다.';
$string['configquickgrading'] = '일괄 피드백은 한꺼번에 많은 피드백을 편집할 수 있도록 채점자 보고서의 각 셀에 텍스트 입력난을 추가한다. 한번에 하나씩 저장하는 대신, 변경사항을 한꺼번에 저장하기 위해 갱신 버튼을 클릭할 수 있다.';
...
$string['configshowhiddenitems'] = '사용자가 moodle/grade:viewhidden 권한을 가지고 있지 않을 때라도 보고서에 숨겨진 항목을 보여준다. 비공개 성적의 가시성은 이 설정에 영향받지 않는다.';
...
$string['errornocategorizedid'] = '범주화 되지않은 아이디는 취할 수 없음';
...
$string['hidden'] = '비공개';
$string['hiddenasdate'] = '비공개 성적에 대한 제출일 보이기';
...
$string['profilereport'] = '이용자 개인정보 보고서';
...
$string['shownumberofgrades'] = '평균 점수 보이기';
...
$string['user'] = '이용자';
$string['userkeyhelp'] = '무들에 로그인 하지 않고 이 내보내기 플러그인에 의해 공개될 데이타에 대한 접근성을 사용자에게 주는 저장된 키를 선택하세요. 이 양식을 제출할때 새 키를 만들려면 \'새 사용자 키\'를 선택하세요.';
