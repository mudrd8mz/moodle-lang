...
$string['hideaverages'] = '평균 숨김';
$string['hidecalculations'] = '계산방법 숨김';
$string['hidecategory'] = '숨김';
$string['hideeyecons'] = '보기/숨기기 아이콘 숨김';
$string['hidefeedback'] = '의견 숨김';
$string['hidegroups'] = '모둠 숨김';
$string['hidelocks'] = '잠금 숨김';
