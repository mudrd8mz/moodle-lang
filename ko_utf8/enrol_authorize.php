...
$string['adminemailexpiredteacher'] = '만일 수동으로 수납할 수 있게 해서 선생님들이 공납금을 손수 관리한다면, 선생님들은 수강신청 파기에 대해 알 수 있어야만 합니다. 이 경우 각 배움터의 선생님들에게 얼마나 마감 기일이 남았는지에 대해 이메일로 일려줄 것입니다.';
...
$string['choosemethod'] = '만약 배움터 등록키를 안다면 그것을 여기에 입력하십시오. 그렇지 않다면 당신은 이 교육과정의 수강료를 납부해야만 합니다.';
