...
$string['adminhelpcapture'] = '수동으로 지불에 동의/거절하고자 할 뿐만 아니라 지불 취소를 방지하기 위해 예정된 획득 기능을 사용하고자 한다면 무엇을 해야 합니까?

-cron 설정
-an-review 검토
-an_capture_day 항목에 1에서 29까지 숫자 입력. 획득일 이전에 획득하지 않는한 카드정보는 획득될 것이며 과정에 등록될 것입니다.';
$string['adminhelpcapturetitle'] = '예정된 획득일';
$string['adminhelpreview'] = '어떻게 수동으로 지불을 승인/거부 할 수 있습니까?
-an_review를 체크하십시요.
-an_capture_day 항목에 \'0\'을 입력하시오.

어떻게 학생들이 카드번호를 입력하고 나서 바로 과정에 등록할 수 있읍니까?
-an_review를 체크해지 하십시요.
