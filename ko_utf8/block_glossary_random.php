<?PHP // $Id$ 
      // block_glossary_random.php - created with Moodle 1.7 dev (2006092800)


$string['addentry'] = '당신의 가장좋아하는 인용구를 첨가하세요!';
$string['askaddentry'] = '만약 학생들에게 입력사항을 자료집에 첨가하도록 허락한다면 이 문구와 함께 링크가 나타난다.';
$string['askinvisible'] = '만약 학생들이 자료집을 보거나 편집하지 못하게 하면, (링크없이) 아래 문구가 나타난다.';
$string['askviewglossary'] = '만약 학생들이 어휘해설 기입내용을 볼수는 있으나 입력할 수 없게 할 때는 링크와 함께 다음 문장이 나타난다.';
$string['blockname'] = '임의의 어휘해석 기입';
$string['intro'] = '이 강좌에 최소 한 항목 이상의 내용이 있는 자료집을 하나 이상 가지고 있어야만 한다. 그래야만 다음에 나오는 설정을 조정할 수 있다.';
$string['invisible'] = '(계속)';
...
$string['select_glossary'] = '이 자료집에서 내용 추출';
