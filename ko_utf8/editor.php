...
$string['justifyleft'] = '왼페이지 정렬';
$string['justifyright'] = '오른페이지 정렬';
$string['lang'] = '언어';
$string['layout'] = '지면배치';
$string['left'] = '문단을 왼페이지에 정렬';
$string['lefttoright'] = '왼페이지에서 오른페이지으로';
...
$string['right'] = '문단을 오른페이지에 정렬';
$string['righttoleft'] = '오른페이지에서 왼페이지으로';
$string['rows'] = '행';
