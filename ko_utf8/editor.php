<?PHP // $Id$ 
      // editor.php - created with Moodle 1.8 dev (2006102200)
...
$string['cut'] = '선택한 것 삭제';
$string['cutpastemozilla'] = '불행히도, 이 온라인 편집기에서는 일반적으로 쓰는 키보드 단축키(또는 심지어 붙여넣기 버튼)를 이용하여  문서를 붙여넣을 수 없다. 이것은 몇몇 버전의 Mozilla 와 Firefox 브라우저에서 만들어진 보안 기능 때문이다.<br /><br />
