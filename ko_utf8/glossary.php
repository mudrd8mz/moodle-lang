<?PHP // $Id$ 
      // glossary.php - created with Moodle 1.9 dev (2007071703)
...
$string['concept'] = '개념';
$string['concepts'] = '개념';
$string['configenablerssfeeds'] = '이 스위치는 모든 자료집에 대해 Rss로 송신할 수 있게 합니다. 하지만 각 자료집에 대해서는 여전히 수동으로 개별적인 내보냄 설정을 해 주어야만 합니다.';
...
$string['displayformatentrylist'] = '입력목록';
$string['displayformatfaq'] = '질의응답';
$string['displayformatfullwithauthor'] = '내 것만 전부';
$string['displayformatfullwithoutauthor'] = '남의 것만 전부';
$string['displayformats'] = '출력 양식';
$string['displayformatssetup'] = '포맷설정출력';
...
$string['entrysaved'] = '이 항목은 저장되어있음';
$string['entryupdated'] = '이 항목을 갱신함';
$string['entryusedynalink'] = '이 항목은 자동적으로 링크됨';
$string['errcannoteditothers'] = '다른 사람의 항목은 편집할 수 없습니다.';
$string['errconceptalreadyexists'] = '이 내용은 이미 있습니다. 이 자료집에서는 중복입력을 허용하지 않습니다.';
...
$string['usedynalink'] = '자료집 항목으로 자동 링크';
