...
$string['cnfallowcomments'] = '용어집의 항목들에 댓글 달기 허용을 기본값으로 설정할 것인지 설정하세요.';
$string['cnfallowdupentries'] = '용어집에 복사된 항목 허용을 기본값으로 설정할 것인지 설정하세요.';
$string['cnfapprovalstatus'] = '학생들이 올린 글을 기본적으로 승인할 것인지 설정하세요.';
$string['cnfcasesensitive'] = '만약 링크된 항목이 있다면 대,소문자를 구분하는 것을 기본값으로 설정할까요?';
$string['cnfdefaulthook'] = '용어집이 처음으로 보여질 때 기본적으로 보여줄 항목을 선택하세요.';
$string['cnfdefaultmode'] = '용어집이 처음으로 보여질 때 기본 프레임을 선택하세요.';
$string['cnffullmatch'] = '만약 링크된 항목이 있다면 기본값으로 내용의 대소문자에 일치하도록 설정할까요?';
$string['cnflinkentry'] = '항목이 자동적으로 링크되도록 기본값을 설정할까요?';
$string['cnflinkglossaries'] = '용어집이 자롱적으로 링크되도록 기본값을 설정할까요?';
$string['cnfrelatedview'] = '자동적인 링크와 항목 보기에 사용되는 표현 양식을 선택하세요.';
$string['cnfshowgroup'] = '모둠을 보이도록 설정할까요?';
...
$string['errconceptalreadyexists'] = '이 내용은 이미 있습니다. 이 용어집에서는 중복입력을 허용하지 않습니다.';
