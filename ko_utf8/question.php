...
$string['cannotcreaterelation'] = '자료묶음 $a[0] $a[1] 의 연계를 만들 수 없음';
$string['cannotfindquestionfile'] = '압축파일에서 문항 자료를 찾을 수 없음';
$string['cannotgetdsfordependent'] = '자료묶음이 필요한 문항에서 지정한 자료묶음을 찾을 수 없음!(문항: {$a[0]}, 자료묶음항목: {a[1]})';
$string['cannotgetdsforquestion'] = '계산형 문항에서 지정한 자료묶음을 얻을 수 없음! (문항: {$a})';
$string['cannotinsert'] = 'question_sessions에 삽입할 수 없음';
$string['cannotinsertitem'] = '$a[2] 에 자료묶음 항목 $a[0] 를 $a[1] 에 삽입할 수 없음';
...
$string['cwrqpfsinfo'] = '<p>무들 1.9판으로 판올림하는 과정에서 문항 범주를 다른 영역으로 구분할 것입니다. 대개의 문항 및 문항 범주는 공유상태가 변해야 할 것입니다. 드문 경우이긴 하겠지만 질문지(퀴즈)에 \'무작위\' 문항이 포함되어 있을 경우, 공유 혹은 비공유 범주 중에서 선택해야 할 필요가 있습니다. 이는 \'무작위\' 문항을 하위 범주에서 선택하게 할 때와, 하나 이상의 하위 범주가 질문이 만들어진 상위 범주와 서로 다른 공유 상태일 때 발생하게 됩니다.</p> 
...
$string['movingcategoryandfiles'] = '정말 {$a->name}범주로 옮기고 모든 하위 범주를 \"{$a->contextto}\" 영역으로 옮기겠습니까?<br /> 그리고 {$a->urlcount}개의 파일이 {$a->fromareaname} 속에 링크되어 있던데, 이들을 {$a->toareaname}로 이동시키거나 복사하겠습니까?';
$string['movingcategorynofiles'] = '정말 범주를 \"{$a->name}\"로 옮기고 모든 하위 범주를 \"{$a->contextto}\" 영역으로 옮기겠습니까?';
$string['movingquestions'] = '문제 및 파일 이동';
$string['movingquestionsandfiles'] = '정말 {$a->questions} 문항을 <strong>\"{$a->tocontext}\"</strong> 영역으로 옮기겠습니까? <br />{$a->urlcount} 개의 파일이 {$a->fromareaname} 속의 문제들과 링크되어 있던데, 이들을 {$a->toareaname}로 이동시키거나 복사하겠습니까?';
...
$string['novirtualquestion'] = '$a 문형과 유사 문형은 없음';
...
$string['wrongprefix'] = '형식이 잘못된 접두사 $a';
