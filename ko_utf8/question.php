...
$string['cannotmovecate'] = '범주 $a 를 이동할 수 없음. 이 맥락의 마지막 범주임';
...
$string['contexterror'] = '어떤 범주를 다른 맥락으로 옮기지 않는 한, 여기에 들어올 수 없습니다.';
...
$string['questionsrescuedfrom'] = '$a 맥락에서 문항 저장됨';
$string['questionsrescuedfrominfo'] = '이 문항들은 (어떤 것들은 감추어져 있을지 모르지만) 다른 활동 또는 퀴즈에서 여전히 쓰이고 있기 때문에 비록 맥락 $a 가 삭제됐다 하더라도 여전히 남아 있습니다.';
$string['questionuse'] = '이 활동에 질문 사용';
$string['shareincontext'] = '하위 범주 $a 와 공유';
$string['tofilecategory'] = '파일에 범주 기입';
$string['tofilecontext'] = '파일에 맥락 기입';
$string['unknown'] = '알수없음';
