<?PHP // $Id$ 
      // enrol_imsenterprise.php - created with Moodle 1.7 dev (2006091901)
...
$string['createnewcategories'] = '무들에 해당 배움터 범주가 없는 경우 새로운(감춰진) 배움터 범주 생성';
$string['createnewcourses'] = '무들에 해당과정이 없는 경우 새로운(감춰진) 배움터 생성';
...
$string['processphoto'] = '신상명세에 사용자 사진 추가';
