...
$string['addingquestions'] = '이곳에서 질문에 관계된 데이터베이스를 관리할 수 있습니다. 질문은 손쉽게 관리할 수 있게끔 범주별로 저장되고, 또한 당신이 \'공개\'를 한다면 선택한 배움터 혹은 다른 배움터에서도 그것을 사용할 수 있습니다.<br /><br />당신은 질문의 범주를 선택하거나 생성한 후 그것을 편집할 수 있습니다. 문제은행의 범주에 추가하기 위해 어떠한 질문이라도 선택할 수 있습니다.';
$string['addquestions'] = '질문 추가';
$string['addquestionstoquiz'] = '퀴즈에 질문 추가하기';
$string['addrandom'] = '$a에 임의 질문 추가';
...
$string['categorynamecantbeblank'] = '범주명은 비어서는 안됩니다.';
...
$string['continueattemptquiz'] = '마지막 시도 계속';
...
$string['deleteattemptcheck'] = '정말 이 시도를 취소하시겠습니까?';
...
$string['editingcalculated'] = '계산 문제 편집';
...
$string['false'] = '틀림';
$string['feedback'] = '피드백';
$string['feedbackerrorboundaryformat'] = '반응 등급 경계값은 반드시 퍼센트이거나 숫자이어야만 합니다. 입력한 $a 은 인식되지 않습니다.';
$string['feedbackerrorboundaryoutofrange'] = '반응 등급 경계값은 0~100%% 사이의 값을 가져야만 합니다. 입력한 $a 은 그 범위에 들지 않습니다.';
$string['feedbackerrorjunkinboundary'] = '반응 등급 경계값 칸은 빈틈없이 채워져야 합니다.';
$string['feedbackerrorjunkinfeedback'] = '빈칸을 남기지 말고 반응칸을 다 채워야만 합니다.';
$string['feedbackerrororder'] = '반응 등급 경계값은 높은 값이 먼저 나오게 순서대로 써야 합니다. 입력한 $a 는 순서가 맞지 않습니다.';
$string['file'] = '파일';
...
$string['matchgradeserror'] = '점수가 나열되지 않으면 오류';
$string['matchgradesnearest'] = '나열되어 있지 않으면 가까운 점수';
$string['max'] = '최대';
$string['min'] = '최소';
$string['minutes'] = '시간(분)';
