...
$string['addingquestions'] = '이곳에서 질문에 관계된 데이터베이스를 관리할 수 있습니다. 질문은 손쉽게 관리할 수 있게끔 범주안에 저장되고, 또한 당신이 \'공개\'를 한다면 선택한 배움터 혹은 다른 배움터에서도 그것을 사용할 수 있습니다.<br /><br />당신은 질문의 범주를 선택하거나 생성한 후 그것을 편집할 수 있습니다. 문제은행의 범주에 추가하기위해 어떠한 질문이라도 선택할 수 있습니다.';
...
$string['optional'] = '선택적';
$string['outof'] = '$a->maxgrade 를 초과하는 $a->grade';
...
$string['popupblockerwarning'] = '이 테스트 영역은 보안모드에서 작동중 입니다. 이는 퀴즈를 보안 창에서 구동할 필요가 있다는 것입니다. 브라우저의 팝업창 방지모드를 해제해 주시기 바랍니다.';
...
$string['questiondeleted'] = '이 질문은 삭제되었습니다. 교수자에게 연락하십시요.';
