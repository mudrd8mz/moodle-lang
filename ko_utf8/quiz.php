...
$string['cannotcreatepath'] = '경로가 생성될 수 없습니다($a)';
...
$string['createfirst'] = '우선 단답형 문제를 만들어야 합니다.';
...
$string['false'] = '틀림';
$string['feedback'] = '피드백';
$string['feedbackerrorboundaryformat'] = 'Feedback grade boundaries는 반드시 퍼센트이거나 숫자이어야만 합니다. 입력한 $a 은 인식되지 않습니다.';
$string['feedbackerrorboundaryoutofrange'] = 'Feedback grade boundaries는 0~100%% 사이의 값을 가져야만 합니다. 입력한 $a 은 그 범위에 들지 않습니다.';
$string['feedbackerrorjunkinboundary'] = 'Feedback grade boundary 칸은 빈틈없이 채워져야 합니다.';
$string['feedbackerrorjunkinfeedback'] = '빈칸을 남기지 말고 반응칸을 다 채워야만 합니다.';
$string['feedbackerrororder'] = 'Feedback grade boundaries는 높은 값이 먼저 나오게 순서대로 써야 합니다. 입력한 $a 는 순서가 맞지 않습니다.';
$string['file'] = '파일';
