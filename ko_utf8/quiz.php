...
$string['attemptsonly'] = '시도가 있는 학습자만 보기';
...
$string['blackboard_6'] = '블랙보드 6.0버전 이상';
$string['bothattempts'] = '시도를 한 학생과 하지 않은 학생 보여주기';
...
$string['changessaved'] = '채점 변경이 저장되었습니다.';
...
$string['commentorgrade'] = '논평하기 또는 채점덮어쓰기';
$string['comments'] = '논평';
...
$string['delay1'] = '첫번째 시도와 두번째 시도사이 경과 시간';
$string['delay2'] = '마지막 시도와의 경과 시간';
...
$string['exportingquestions'] = '질문이 파일로 내보내기 되고 있습니다.';
...
$string['filloutthreequestions'] = '정답을 포함해 적어도 3개의 답안을 작성해야 합니다. 빈칸으로 남겨진 답안은 사용되지 않습니다. You can provide extra wrong answers by giving an answer with a blank question. Entries where both the question and the answer are blank will be ignored.';
...
$string['formatnotfound'] = '가져오기/내보내기 형식 $a  가 발견되지 않았습니다.';
$string['formatnotimplemented'] = '이 형식은 정확하게 구현되지 않았습니다. 버그 보고서를 게시하십시요.';
...
$string['importfilearea'] = '과정 파일에 이미 있는 파일로부터 가져오기';
$string['importfileupload'] = '올려진 파일로부터 파일 가져오니';
$string['importfromthisfile'] = '이 파일로부터 가져오기';
$string['importingquestions'] = '파일로 부터 $a 질문들 가져오기';
...
$string['invalidnumericanswer'] = '입력한 답 가운데 하나는 유효한 숫자가 아닙니다.';
$string['invalidnumerictolerance'] = '입력한 유효숫자 중 하나는 유효한 숫자가 아닙니다.';
...
$string['matchgrades'] = '일치 점수';
$string['matchgradeserror'] = '점수가 나열되지 않으면 오류';
$string['matchgradesnearest'] = '나열되어 있지않으면 가까운 점수';
$string['max'] = '최대';
$string['min'] = '최소';
$string['minutes'] = '시간(분)';
...
$string['nocategory'] = '옳지 않거나 없는 분야가 명시됨';
...
$string['noquestionsinfile'] = '가져오기한 파일에 질문이 없습니다.';
...
$string['onlyteachersimport'] = '편집 권한이 있는 교수자만이 질문 가져오기를 할 수 있습니다.';
$string['optional'] = '선택의';
...
$string['shufflewithin'] = '질문들안에서 섞게';
