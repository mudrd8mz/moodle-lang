...
$string['addingquestions'] = '이곳에서 질문에 관계된 데이터베이스를 관리할 수 있습니다. 질문은 손쉽게 관리할 수 있게끔 범주별로 저장되고, 또한 \'공개\' 한다면 선택한 배움터 혹은 다른 배움터에서도 그것을 사용할 수 있습니다.<br /><br />질문의 범주를 선택하거나 생성한 후 그것을 편집할 수 있습니다. 문제은행의 범주에 추가하기 위해 어떠한 질문이라도 선택할 수 있습니다.';
$string['addquestions'] = '질문 추가';
$string['addquestionstoquiz'] = '질문 추가하기';
$string['addrandom'] = '$a 에 임의 질문 추가';
$string['addrandom1'] = '<< 추가';
$string['addrandom2'] = '임의의 질문';
$string['addselectedtoquiz'] = '선택 문항 퀴즈에 추가';
$string['addtoquiz'] = '퀴즈에 추가';
$string['affectedstudents'] = '영향받은 $a';
...
$string['attemptquiznow'] = 'i문제풀기 시작';
$string['attempts'] = '시도';
...
$string['calculatedquestion'] = '$a 에서 지원되지 않는 방정식 문제. 이 문제는 무시됩니다.';
...
$string['category'] = '범주';
$string['categoryadded'] = '범주 \'$a\' 가 첨가되었습니다';
...
$string['choosedatasetproperties'] = '자료집합 속성 선택';
...
$string['createmultiple'] = '여러 무작위 질문 추가';
...
$string['decimals'] = '$a 와 함께';
$string['default'] = '기본설정';
$string['defaultgrade'] = '문항 기본 점수';
$string['defaultinfo'] = '질문에 관한 기본 범주';
...
$string['editingmultianswer'] = 'Cloze형 문제 편집';
...
$string['editingrandomsamatch'] = '무작위 단답일치형 질문 편집';
...
$string['existingcategory1'] = '이 범주의 다른 질문에서도 사용된 문자구성표에 이미 존재하는 문자';
$string['existingcategory2'] = '이 범주의 다른 질문에서도 사용된 파일구성표에 이미 존재하는 파일';
$string['existingcategory3'] = '이 범주의 다른 질문에서도 사용된 링크구성표에 이미 존재하는 링크';
$string['export'] = '내보내기';
$string['exporterror'] = '내보내기 과정에서 오류가 발생하였습니다.';
$string['exportfilename'] = '퀴즈';
$string['exportingquestions'] = '질문을 파일로 내보내고 있습니다.';
...
$string['filloutnumericalanswer'] = '적어도 하나의 가능한 답과 유효숫자를 제공해야 합니다. 첫번째 일치하는 답은 점수를 매기고 피드백을 하는데 쓰입니다. 만일 끝까지 답은 하지 않은 채로 피드백만 한다면, 결국은 다른 어떤 답과도 일치하지 않은 학생의 응답이 보여질 것입니다.';
...
$string['filloutthreequestions'] = '적절한 답안과 함께 적어도 3개의 질문을 작성해야 합니다. 질문 없이 답을 제시함으로서 특별한 오답을 제공할 수도 있습니다. 질문과 답안이 없이 공백인 곳은 무시됩니다.';
...
$string['fractionsnomax'] = '정답은 100%%가 되어야 합니다.<br /> 그래야 이문제에 대해 등급 처리가 가능합니다.<br /> 이문제를 수정하기 위해 되돌아 가겠습니까?';
...
$string['importerror'] = '가져오기과정에서 오류가 발생하였습니다.';
...
$string['importmax10error'] = '질문에 오류가 있습니다. 당신은 열 개 이상의 답을 할 필요가 없습니다.';
...
$string['keptcategory1'] = '이전과 같은 범주의 재사용 가능한 문자열에서의 문자';
$string['keptcategory2'] = '이전과 같은 범주의 재사용 가능한 파일구성에서의 파일';
$string['keptcategory3'] = '이전과 같은 범주의 재사용 가능한 링크구성에서의 링크';
$string['keptlocal1'] = '문자는 예전에 개인적으로 사용되었던 것과 같은 것입니다.';
$string['keptlocal2'] = '파일은 예전에 개인적으로 사용되었던 것과 같은 것입니다.';
$string['keptlocal3'] = '링크는 예전에 개인적으로 사용되었던 것과 같은 것입니다.';
...
$string['missingquestion'] = '빠짐 : $a 줄 이후 문항 라벨';
...
$string['noessayquestionsfound'] = '수동으로 채점하는 질문이 발견되지 않았습니다.';
$string['nomatchinganswer'] = '질문 \'$a\'와 일치하는 답을 지정해야만 합니다.';
$string['nominal'] = 'Nominal';
$string['nomoreattempts'] = '더 이상 할 수 없습니다.';
$string['none'] = '없음';
...
$string['notenoughanswers'] = '이 유형의 질문들은 적어도 $a의 답안이 필요합니다.';
...
$string['onlyteachersimport'] = '편집 권한이 있는 사람만이 질문 가져오기를 할 수 있습니다.';
$string['optional'] = '선택적';
...
$string['popupblockerwarning'] = '테스트의 이 부분은 보안모드에 있습니다. 이것은 보안된 창에서 퀴즈를 풀어야 함을 의미합니다. 팝업 차단기를 해제해 주시기 바랍니다. 감사합니다.';
...
$string['temporaryblocked'] = '현재 당신은 일시적으로 퀴즈를 재시도 하도록 허용되지 않았습니다.<br /> 다음 시도를 이 날자에 할 수 있습니다:';
$string['time'] = '시간';
$string['timecompleted'] = '종료';
$string['timedelay'] = '다음 퀴즈를 시도하기전에 경과시간이 지나지 않았기 때문에 퀴즈를 하도록 허용되지 않았습니다.';
