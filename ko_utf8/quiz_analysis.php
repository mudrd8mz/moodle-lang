<?PHP // $Id$ 
      // quiz_analysis.php - created with Moodle 1.7 dev (2006092302)
...
$string['attemptselection'] = '사용자마다 분석할 시도';
$string['attemptsfirst'] = '첫번째 시도';
$string['attemptshighest'] = '최고 점수';
