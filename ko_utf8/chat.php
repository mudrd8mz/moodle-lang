<?PHP // $Id$ 
      // chat.php - created with Moodle 1.6 Beta 3 (2006042400)
...
$string['confignormalupdatemode'] = '대화방 갱신은 HTTP 1.1의 <em>Keep-Alive</em> 기능을 사용하면 좋습니다만 서버에 부담을 줍니다. 더 좋은 방법은 사용자들에게 갱신을 제공하기 위해 <em>Stream</em> 방법을 사용하는 것입니다. <em>Stream</em> 는 chatd 메쏘드처럼 아주 잘 돌아가지만 당신의 서버가 지원하지 않을 수도 있습니다.';
