...
$string['confignormalupdatemode'] = '대화방 갱신은 HTTP 1.1의 <em>Keep-Alive</em> 기능을 사용하면 좋습니다만 서버에 부담을 줍니다. 더 개선된 방법은 <em>Stream</em> 방법을 사용하는 것입니다. <em>Stream</em>은 chatd을 이용할 때처럼 아주 잘 작동하지만 서버가 지원하지 않을 수도 있습니다.';
