<?PHP // $Id$ 
      // dialogue.php - created with Moodle 1.6 Beta 3 (2006042400)
...
$string['close'] = '종료';
$string['closed'] = '종료됨';
$string['closeddialogues'] = '닫힌 대화방';
$string['confirmclosure'] = '당신은 $a 와의 대화를 종료 하려고 합니다. 한번 종료하면 다시 열 수 없습니다. 대화를 종료하면 지난 대화 내용을 볼 수는 있지만, 새로운 내용을 추가할 수는 없습니다.  이 대화를 정말로 종료할까요?';
$string['deleteafter'] = '지정일 후에 종료된 대화를 삭제함';
$string['dialogueclosed'] = '대화 종료됨';
$string['dialogueintro'] = '대화방 소개';
...
$string['notavailable'] = '손님은 대화방을 이용하실 수 없습니다.';
