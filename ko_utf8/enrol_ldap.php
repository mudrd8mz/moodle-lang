...
$string['description'] = '<p>LDAP서버를 이용하여 당신은 등록자를 관리할 수 있습니다. LDAP목차는 과목 내용(map)의 그룹을 포함하고 있고, 각각의 그룹/강좌은 학생들용 내용(mpa)의 회원제 접속허가를 가지고 있다고 가정할 수 있다.<p>
...
$string['enrol_ldap_autocreate'] = '만일 Moodle에 없는 배움터가 등록되면 자동으로 그 배움터를 생성할 것이다.';
$string['enrol_ldap_autocreation_settings'] = '배움터 자동 생성 설정';
...
$string['enrol_ldap_category'] = '자동 생성된 배움터의 범주';
...
<em>cn</em>나 <em>uid</em>. 만일 자동 배움터 생성기능을 사용하면 값을 수정하지 못하도록 해 놓기 바랍니다.';
$string['enrol_ldap_course_settings'] = '배움터 등록 설정';
...
$string['enrol_ldap_objectclass'] = '배움터 검색에 쓰인 objectClass. 일반적으로 \'posixGroup\'';
...
$string['enrol_ldap_student_contexts'] = '그룹과 학생들의 등록서류가 있는 곳의 내용 목록. 다음과 같이 \';\'으로 구분하여 적는다. 예를 들어: 
...
$string['enrol_ldap_teacher_contexts'] = '그룹과 선생들의 등록 서류가 있는 곳의 내용 목록.다음과 같이 \';\'으로 구분하여 적는다. 예를 들어: 
\'ou=courses,o=org; ou=others,o=org\'';
$string['enrol_ldap_teacher_memberattribute'] = '회원 속성, 사용자들이 (등록루) 그룹에속해 있다면
 . 대부분 \'member\'
나 \'memberUid\'.일것이다';
$string['enrol_ldap_teacher_settings'] = '선생 등록 설정';
$string['enrol_ldap_template'] = '선택 사항: 자동 생성 배움터는 그들의 설정값을 template 배움터에서 가져올 수 있다.';
