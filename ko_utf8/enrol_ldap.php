<?PHP // $Id$ 
      // enrol_ldap.php - created with Moodle 1.7 dev (2006091901)
...
$string['enrol_ldap_bind_dn'] = '만일 각 사용자를 찾기 위해 bind-user를 사용하고 싶다면 다음과 같이 설정하십시오. ex) \'cn=ldapuser,ou=public,o=org\'';
...
<em>cn</em>나 <em>uid</em>. 만일 자동 배움터 생성기능을 사용하면 값을 수정하지 못하도록 해 놓기를 바랍니다.';
...
$string['enrol_ldap_search_sub'] = '하부내용에서 모둠 구성원 찾기';
...
$string['enrol_ldap_template'] = '선택 사항: 자동 생성 배움터는 그들의 설정값을 template 코스에서 가져올 수 있다.';
