...
$string['description'] = '<p>LDAP서버를 이용하여 당신은 등록자를 관리할 수 있습니다. LDAP목차는 과목 내용(map)의 모둠을 포함하고 있고, 각각의 모둠/강좌은 학생들용 내용(mpa)의 회원제 접속허가를 가지고 있다고 가정할 수 있다.<p>
<p>또한 각 강좌는 LDAP의 구분에 의하여 나누어지고 각 모둠은 여러 개의 활동영역을 가지게 된다(<em>member</em> 혹은 <em>memberUid</em>) 그것은 각 유저마다 서로 다른 ID를 가지게 한다.</p>
...
<p>이 플러그인은 새 모둠이 LDAP에 들옥되면 자동적으로 새 강좌를 생성한다.</p>';
$string['enrol_ldap_autocreate'] = '만일 Moodle에 없는 강좌가 등록되면 자동으로 그 강좌를 생성할 것이다.';
...
$string['enrol_ldap_student_memberattribute'] = '회원 속성, 사용자들이 (등록루) 모둠에속해 있다면
 . 대부분 \'member\'
나 \'memberUid\'.일것이다';
...
\'ou=courses,o=org; ou=others,o=org\'';
$string['enrol_ldap_teacher_memberattribute'] = '회원 속성, 사용자들이 (등록루) 모둠에속해 있다면
 . 대부분 \'member\'
나 \'memberUid\'.일것이다';
$string['enrol_ldap_teacher_settings'] = '선생 등록 설정';
$string['enrol_ldap_template'] = '선택 사항: 자동 생성 강좌는 그들의 설정값을 template 강좌에서 가져올 수 있다.';
