...
$string['descriptionofexercise'] = '숙제(과제) 혹은 에세이 같은 기타 문서는 반드시 MS 워드 파일 혹은 HTML로 저장이 되어야 합니다. 이 파일은 숙제가 마감되는 $a 이전에 Exercise에 올려져야 합니다. 올려지는 파일은 다른 형식으로서 변형이 가능합니다만 이 경우 역시 MS 워드 파일 혹은 HTML의 형식으로 포맷이 되어야 하며 $a  전에 올려져야 합니다.';
...
$string['exercise:assess'] = '연습 내용 평가';
...
$string['modulenameplural'] = '평가과제모음';
