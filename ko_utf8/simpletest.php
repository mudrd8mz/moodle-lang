...
$string['moodleunittests'] = '무를 항목 점검 : $a';
$string['notice'] = '주의';
...
$string['summary'] = '{$a->run}/{$a->total} 사례 점검 완료 : <strong>{$a->passes}</strong> 사례 통과, <strong>{$a->fails}</strong> 사례 실패, <strong>{$a->exceptions}</strong> 사례가 제외 되었음.';
$string['thorough'] = '상세 점검(느릴 수 있음)';
$string['uncaughtexception'] = '알려지지 않은 예외항목인 [{$a->getMessage()}] 이 [{$a->getFile()}:{$a->getLine()}] 에서 발견되어 점검이 취소됨.';
$string['unittests'] = '항목 점검';
