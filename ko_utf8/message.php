...
$string['addsomecontacts'] = '다른 사람에게 메세지를 보내거나 이 페이지에 그들의 목록을 추가해 놓으려면 위의 <a href=\"$a\">서치탭</a>을 이용하세요';
...
$string['backupmessageshelp'] = '이를 활성화하면, 인스턴트메세지는 사이트 자동백업에 포함될 것 입니다.';
...
$string['messages'] = '메세지';
$string['messaging'] = '메세지 보내기';
$string['messagingdisabled'] = '이 사이트는 메세지 기능을 작동시키지 않았습니다. 대신 이메일로 보내질 것입니다.';
