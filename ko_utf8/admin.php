...
$string['configextendedusernamechars'] = '이 설정을 \"예\"로 놓으면 학생들은 사용자 아이디에 어떤 문자도 쓸 수 있다.(그들의 실제적 이름과는 관계가 없음을 주목하라) 기본 설정은 \"아니오\" 로서 사용자 ID에 영문자와 숫자를 조합한 것만이 허용된다.';
...
$string['configlangcache'] = '언어 메뉴의 임시 저장. 많은 메모리가 절약되고 처리 속도가 빨라질 것이다. 만약 이것을 활성화한다면 언어를 추가하거나 삭제한 후, 메뉴는 수 분 이내에 업데이트 될 것이다.';
...
$string['configstatsfirstrun'] = '이 곳에서는 cron이 통계를 처리한 후 얼마나 오래 기록을 유지하고 있어야 할지를 지정한다. 만일 매우 접속이 많거나 서버를 임대해 쓰는 경우, 통계처리에 걸리는 시간도 길고 부하도 많이 걸리기 때문에, 기록을 오래 유지시키는 일은 바람직하지 않다.(여기에서는 1 month = 28 days로 설정했고, 그래프와 보고에서는 1 month = 1 calendar month로 했음에 유의하라)';
...
$string['profileconfirmcategorydeletion'] = '상위 범주(혹은 최상위 범주의 아래)로 이동하게 될 $a 개의 항목이 범주 안에 있습니다.<br />그래도 이 범주를 삭제하시겠습니까?';
$string['profileconfirmfielddeletion'] = '삭제 될 $a 개의 사용자 기록이 이 항목에 있습니다.<br />그래도 이 항목을 삭제하시겠습니까?';
