...
$string['configenablerecordcache'] = '이것을 활성화하면, 데이터베이스에서 자료를 가져올 때 메모리 내부 기억내용을 활용할 수 있다. 이는 데이터베이스의 입출력이 향상될 수 있다는 것을 뜻하지만, 반면에 웹 서버의 메모리 용량을 다소 늘릴 필요가 있다. 일반적으로 여러분의 서버 메모리가 아주 작지 않은 한 이를 활성화시켜 놓을 것을 권장한다. 개발자가 어떤 종류의 성능 향상을 꾀하고자 할 때 이 설정을 무시하도록 프로그램할 경우도 있다.';
