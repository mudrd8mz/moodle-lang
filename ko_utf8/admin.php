...
$string['configallowoverride'] = '왼페이지의 역할이 각 칼럼의 역할에게 권한을 재설정할 수 있도록 허용';
$string['configallowunenroll'] = '만약 이것이 \"예\"로 설정된다면, 학생들은 스스로 강좌에서 언제든지 탈퇴할 수 있다. 반면에 \"아니오\"로 설정하면 선생님과 관리자에 의해서만 학생의 강좌 탈퇴여부가 결정되게 된다.';
...
$string['configallusersaresitestudents'] = '이 사이트의 초기화면의 활동에 대하여 모든 사용자가 학생으로 간주되도록 할 것인가? 만약 당신이 \"예\"라고 설정한다면 승인된 사용자 누구라도 다른 과정에 손쉽게 학생으로 참여할 수 있도록 허용된다. 만얀 당신이 \"아니오\"라고 한다면 사용자는 초기화면 활동의 특정 과정에만 참여하도록 제한될 것이다. 이 때는 관리자와 특별히 임명된 교수자만 초기화면에서 교수자로써 활동할 수 있다.';
$string['configauthenticationplugins'] = '사용하고자 하는 인증 플러그인을 선택하여 우선 순위로 나열하라. 자동 등록은 \'등록\'난에서 선택된 플러그인에 의해 처리될 것이다.(보통은 \'이메일\'인증)';
$string['configautolang'] = '브라우저 설정으로부터 기본 언어 검출. 비활성화된 경우 사이트 기본이 사용됨';
$string['configautologinguests'] = '어떤 강좌에 방문객이 접속했을 때 그들이 손님자격을 가지고 자동적으로 로그인이 되게 할 것인가?';
...
$string['langlocalpackage'] = '지역적인 변경';
...
$string['langpackwillbeupdated'] = '번역자들을 위한 안내: 업그레이드 도중 무들은 언어팩을 갱신할 것입니다. non-local 언어폴더에 있는 변경사항은 덮어쓰기 될 것입니다.';
...
$string['profilefields'] = '개인정보 항목 설정';
...
$string['uubulk'] = '대량 동작을 위한 선택';
$string['uubulkall'] = '모든 사용자들';
$string['uubulknew'] = '새 사용자들';
$string['uubulkupdated'] = '갱신된 사용자들';
...
$string['xmlstrictheaders'] = 'XML strict 헤더들';
