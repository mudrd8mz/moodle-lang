...
$string['configauthenticationplugins'] = '사용하고자 하는 인증 플러그인을 선택하여 우선 순위로 나열하십시오. 자동 등록은 \'등록\'난에서 선택된 플러그인에 의해 처리될 것입니다.(보통은 \'이메일\'인증)';
...
$string['configdebugdisplay'] = '이것을 켜두면 오류보고가 HTML문서로 보여집니다. 대체로 실용적이기는 하지만 XHTML, JS, 쿠키 및 HTTP 헤더를 깨지게 합니다. 이를 꺼 두면 오류보고는 추후에 디버그를 할 수 있도록 서버에 기록으로 남습니다. PHP의 error_log 로 기록위치를 설정할 수 있습니다.';
...
$string['deleteunconfirmed'] = '다음 이후에 인증되지 않은 사용자 삭제';
...
$string['plugins'] = '모듈';
$string['profilecategory'] = '신상명세 범주';
$string['profilecategoryname'] = '신상명세 범주명(유일해야 함)';
$string['profilecategorynamenotunique'] = '이 범주명은 이미 사용 중임';
...
$string['profilefields'] = '사용자 명세 항목들';
