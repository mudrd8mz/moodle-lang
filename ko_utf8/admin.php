...
$string['debug'] = '오류 알림';
$string['debugall'] = 'E_ALL: 모든 내용을 보여줌';
$string['debugdeveloper'] = 'DEVELOPER: 개발자들을 위한 특별한 오류보고';
$string['debugging'] = '오류잡기';
$string['debugminimal'] = 'MINIMAL: 치명적 오류만 보고';
$string['debugnone'] = '어떤 오류 내용도 보여주지 않음';
$string['debugnormal'] = 'NORMAL: 경고 및 주의사항 오류 보고';
$string['defaultallowedmodules'] = '허용되는 기본 모듈';
$string['defaultcourseroleid'] = '배움터에서의 사용자 기본 역활';
$string['defaultrequestcategory'] = '배움터에서 요구되는 기본 범주';
$string['defaultuserroleid'] = '모든 사용자에게 적용되는 기본 역할';
$string['deleteunconfirmed'] = '인증되지 않은 사용자 삭제';
$string['deleteuser'] = '사용자 식제';
$string['density'] = '밀도';
$string['denyemailaddresses'] = '이메일 도메인 거부';
$string['digestmailtime'] = '요약 이메일 발송 시간';
$string['displayloginfailures'] = '로그인 실패 보이기';
$string['docroot'] = '무들 문서창고 경로';
$string['doctonewwindow'] = '새 창으로 띄움';
...
$string['enablerssfeeds'] = 'RSS 취재 가능';
$string['enablestats'] = '통계수집 가능';
$string['enabletrusttext'] = '내용신뢰 가능';
...
$string['includemoduleuserdata'] = '사용자 데이터 모듈 포함';
...
$string['log'] = '기록들';
$string['loginhttps'] = '보안 로그인 사용';
$string['loglifetime'] = '기록 보유 시간';
$string['longtimenosee'] = '다음기간 이후로 배움터에서 사용자 퇴출';
$string['mail'] = '전자우편';
...
$string['maxeditingtime'] = '게시물 교정 최대 시간';
...
$string['restrictmodulesfor'] = '모듈 제한';
...
$string['sitesectionhelp'] = '이것을 켜 놓으면, 토픽 영역이 사이트 대문화면에 보일 것임';
