...
$string['allowuserblockhiding'] = '이용자에게 블럭감추기 허용';
...
$string['configallowuserblockhiding'] = '이용자들이 이 사이트의 블럭을 숨기거나 볼 수 있도록 허용하겠는가? 이 기능은 각각의 분리된 블럭을 기억하기 위해 자바 스크립트와 쿠키를 사용하며 이용자 화면에만 영향을 미친다.';
...
$string['configfiltermatchonepertext'] = '이 자동 링크 필터는 한 문서(예: 자원 블럭 등)중 첫번째 단어에 자동 링크를 시키고 나머지 것들은 모두 무시한다. 이 설정은 페이지별 필터 설정이 \"예\"이면 무시된다.';
