...
$string['configintrosite'] = '이 화면에서는 이 사이트의 명칭과 첫 화면에 대한 설정을 할 수 있다. 여러분은 언제라도 다시 홈 페이지의 관리 > 환경설정 > 사이트 설정 항목을 통해 이 곳으로 돌아와 이 설정들을 바꿀 수 있다.';
...
$string['debugerror'] = 'E_ERROR: 심각한 오류만 보여줌';
$string['debugging'] = '오류잡기';
$string['debugnone'] = '어떤 오류 내용도 보여주지 않음';
$string['debugnotice'] = 'E_NOTICE: 참고될만한 정보를 보여줌';
$string['debugparse'] = 'E_PARSE: 파싱오류를 보여줌';
$string['debugstrict'] = 'E_STRICT: 사소한 오류를 포함하여 모든 오류를 보여줌';
$string['debugwarning'] = 'E_WARNING: 심각한 경고만 보여줌';
