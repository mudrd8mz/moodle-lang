...
$string['configurationfileexist'] = '이미 설정파일이 존재합니다!';
...
$string['invalidargumenthelp'] = '오류 : 잘못된 인수< /br> 사용예 : $php cliupgrade.php OPTIONS< /br> 좀 더 자세한 내용은 --help 옵션을 사용';
...
$string['invalidvalueforlanguage'] = '--lang 옵션에 맞지 않는 값. 좀 더 자세한 내용은 --help 옵션을 사용';
...
$string['pdosqlite3'] = 'SQLite 3 (PDO) <b><strong class=\"errormsg\">실험적임! (상용서버에서는 사용하지 말 것)</strong></b>';
...
$string['upgradinglocaldb'] = '로칼 데이터베이스 갱신';
