...
$string['removenotice'] = '참조되지 않은 페이지 목록만이 여기에 있다는 것에 유의해라. 그리고 ewiki엔진 스스로가 오직 제한된 시험만을 했기 때문에 만약에 참조된 페이지가 존재한다면 그 것은 엔진이 놓진 것이다.<br />만약에 너가 그러나 페이지를 지우는 것을 먼저한다면, 이것은 여기에 역시 리스트 될 것이다. 다양한 다른  데이터베이스 진단법들이 만들어 진 것처럼.';
...
$string['status'] = '상태';
$string['strippagecheck'] = '이페이지의 옛버전들 제거 확인:';
