...
$string['confirmserverdelete'] = 'Ste si istý, že chcete odstrániť server <b>$a</b> zo zoznamu?';
...
$string['confirmstartattempttimelimit'] = 'Tento test má nastavený časový limit a počet pokusov je obmedzený na $a. Práve chete začať nový pokus. Chcete pokračovať?';
...
$string['dataitemneed'] = 'Pre vytvorenie platnej úlohy musíte vložit nejmenej jednu dátovú sadu.';
...
$string['deletequestionscheck'] = 'Si si absolútne istý že chceš zmazať nasledujúce otázky? <div>$a</div>';
...
$string['editingessay'] = 'Úprava úlohy s tvorenou odpoveďou';
...
$string['gradeessays'] = 'Oznámkovať tvorené odpovede';
...
$string['gradingdetailszeropenalty'] = 'Za odoslaný test Vám alebol pridelený žiaden trestný bod.';
...
$string['importmax10error'] = 'Chybná definícia úlohy: úloha nesmie obsahovať viac ako deseť odpovedí.';
...
$string['matchgrades'] = 'Prispôsobiť body:';
$string['matchgradeserror'] = 'Ak nie sú body uvedené, nahlásiť chybu';
$string['matchgradesnearest'] = 'Ak nie sú body uvedené, použiť najbližšiu hodnotu';
...
$string['nocategory'] = 'Nebyla určená kategória, alebo bola určená nesprávne.';
...
$string['noessayquestionsfound'] = 'Neboli nájdené žiadne ručne známkované úlohy.';
...
$string['zerosignificantfiguresnotallowed'] = 'Správne odpovede nemôžu mať nulové signifikantné číslice!';
