...
$string['qandanotify'] = 'Toto je fórum typu \'otázky a odpovede\'. Ak si chcete prezrieť odpovede na vložené otázky, musíte nejprv vložiť svoju odpoveď.';
...
$string['thisforumisthrottled'] = 'Do tohto fóra môžete v určenom časovom období vložiž iba obmezený počet príspevkov. Súčasné nastavenie je $a->blockafter príspevkov za $a->blockperiod.';
