...
$string['configcreatornewroleid'] = 'Táto rola je automaticky priraďovaná tvorcom v nových kurzech, ktoré vytvorí. Táto rola nie je priraďovaná v případě, že tvorca už má potrebné oprávnenia v nadradenom kontexte.';
...
$string['configenabletrusttext'] = 'Moodle štandardne filtruje akýkoľvek text zadaný používateľmi a snaží sa odstrániť potenciálne bezpečnostné riziká, medzi ktoré patia aj skripty, média, apod. Pomocou funkcie \"Dôveryhodný obsah\" môžete vybraným používateľom poskytnúť privilégium používať aj tieto pokročilé prvky bez ďalších zásahov. Nejprv je treba povoliť toto nastavenie a potom prideliť oprávnenie Dôveryhodný obsah (Trusted Content) vybraným roliam. Text, ktorý byl vytvorený alebo nahraný používateľom s takouto rolou, je potom označený ako dôveryhodný a nie je pred zobrazením filtrovaný.';
...
$string['configperfdebug'] = 'Vypisovanie údajov o výkonu vášho servera v zápätí štandardnej témy stránok.';
...
$string['configrcache'] = 'Používať vyrovnávaciu pamäť k dočasnému ukládaniu záznamov z databázy. Nezabudnite tiež nastaviť \"cachetype\".';
