...
$string['configdebugdisplay'] = 'Ak je zapnuté, zobrazujú sa chybové hlásenia ako súčasť HTML stránky. To je síce praktické, ale všeobecne môžu chybové hlásenia nabúravať XHTML, JavaScript, cookies a HTTP hlavičky. Pri vypnutí budú chybové hlásenia ukladané v protokolu webového serveru. Nastavenie PHP premenné error_log v súboru php.ini ovplyvňuje, aké informácie sú protokolované.';
...
$string['configdocroot'] = 'Cesta k dokumentácii Moodle. Upravte toto nastavenie, ak si prajete mať vlastné online dokumentáciu. Uistite sa, že vaša dokumentácia zachováva rovnaký formát ako http://docs.moodle.org.';
