...
$string['allowcoursethemes'] = 'Povoliť zmenu motívu v kurzoch';
...
$string['allowuserthemes'] = 'Povoliť používateľom zmenu motívu';
...
$string['autologinguests'] = 'Automaticky přihlasovať hostí';
...
$string['blockinstances'] = 'Inštancia';
$string['blockinstances'] = 'Výskyty';
$string['blockmultiple'] = 'Povoliť viac inštancií';
...
$string['confeditorhidebuttons'] = 'Vyberte tlačidlá, ktoré majú buť v HTML editore skryté.';
...
$string['configauthenticationplugins'] = 'Zvoľte spôsoby overovania používateľov a poradia, v akom budú použité. Ak sa používatelia registrujú sami, bude použitý spôsob uvedený v poli \"Registrácia používateľov\" nižšie (väčšínou sa používa overenie na základe emailu).';
...
$string['configcronremotepassword'] = 'Ak použijete toto nastavenie, bude pre volanie skriptu cron.php cez webové rozhranie nutné použiť heslo predávané ako parameter podlľa vzoru: <pre>http://moodle.nasaskola.sk/admin/cron.php?password=sezamotvorsa</pre> Ak necháte pole prázdne, bude možné volať skript cron.php aj bez hesla.';
...
$string['configdebugdisplay'] = 'Ak je zapnuté, zobrazujú sa chybové hlásenia ako súčásť HTML stránky. To je síce praktické, ale všeobecne môžu chybové hlásenia nabúravať XHTML, JavaScript, cookies a HTTP hlavičky. Pri vypnutí budú chybové hlásenia ukladané v protokolu webového serveru. Nastavenie PHP promenné error_log v súboru php.ini ovplyvňuje, aké informáce sú protokolované.';
...
$string['configdefaultuserroleid'] = 'Prihlásení používatelia získajú na úrovni celého serveru všetky oprávnenia vyplývajúce z uvedenej roly. Tieto oprávnenia budú PRIDANÉ k ostatným oprávneniac získaných z ďalších rol. Pomocou tohoto nastavenia zabezpečujete minimálne oprávnenia pre každého prihláseného používateľa, aby mohol robiť niečo zmysluplné (napr. čítať verejné diskusie, zobrazovať študijné materiály apod.). Východzie nastavenie je rola Hosťa.';
...
$string['configenableajax'] = 'Týmto povoľujete technológiu AJAX na úrovni celého serveru. Jedná sa o pokročilé rozhranie medzi prehliadčom a webovým serverom, ktoré využíva Javascript. Aj keď je tu AJAX povolený, používatelia si jeho použitie môžu vypnúť vo svojich profiloch.';
...
$string['configfrontpageloggedin'] = 'Přihláseným používateľom budú na titulnej stránke serveru zobrazené položky vybrané vyššie.';
...
$string['configguestroleid'] = 'Táto rola je automaticky priradzovaná hosťom. Dočasně je tiež priradzovaná používateľom pri vstupe do kurzu, do ktorého nie sú zapísaní a ktorý umožňuje vstup hosťom bez hesla. Overte si, že rola má nastavené oprávnenie moodle/legacy:guest a moodle/course:view';
...
$string['configsmartpix'] = 'Ak je zapnuté, vyhľadávajú sa ikony pomocou PHP skriptu nejprv v danej téme, potom vo všetkých nadradených témach a nakoniec v adresári /pix. Tým odpadá nutnosť kópií obrázkov vo všetkých témach, ale mierne sa zvyšuje záťaž.';
...
$string['configvariables'] = 'Obecné premenné';
...
$string['debug'] = 'Ladiace informáce';
$string['debugall'] = 'ALL: Zobrazovať všetky zmysluplné ladiace informace z PHP';
$string['debugdeveloper'] = 'DEVELOPER: extra informácie pre vývojárov Moodle';
$string['debugdisplay'] = 'Zobrazenie ladiacich informácií';
$string['debugging'] = 'Ladedie';
$string['debugminimal'] = 'MINIMAL: Zobrazovať iba fatálne chyby';
$string['debugnone'] = 'NONE: Nezobrazuj žiadne správy ani varovania';
$string['debugnormal'] = 'NORMAL: Zobrazuj chyby, varovania a upozornenia';
...
$string['doctonewwindow'] = 'Otvárať v novém okne';
...
$string['editorbackgroundcolor'] = 'Farva pozadia';
...
$string['editorkillword'] = 'Čistenia formátu z MS Word';
...
$string['enablestats'] = 'Povoliť statistiky';
...
$string['filtersettings'] = 'Nastavenia filtru';
$string['filteruploadedfiles'] = 'Filtrovať prenášané súbory';
$string['forcelogin'] = 'Vnutit prihlásenie';
...
$string['langlist'] = 'Ktoré jazyky zobrazovat v ponuke';
...
$string['longtimenosee'] = 'Vyškrtnúť používateľov u kurzov po';
...
$string['maxeditingtime'] = 'Časový imit pre úpravu vložených príspevkov';
...
$string['misc'] = 'Rôzne';
$string['mnetrestore_extusers'] = '<strong>Poznámka:</strong> Táto záloha obsahuje vzdialených používaľov siete Moodle Network. Vzdialené účty budú v priebehu tohto procesu obnovené.';
$string['mnetrestore_extusers_mismatch'] = '<strong>Poznámka:</strong> Táto záloha evidentne pochádza z odlišnej inštalácie Moodle a obsahuje vzdialené používaľské účty. Obnova týchto účtov sa nemusí podariť, táto operácia nie je podporovaná. Ak ste si istí, že záloha pochádza z této inštaláce, alebo môžete zaistiť, že sú správne nastavené všetky hostiteľské počítače v sieti Moodle Network, môžete sa aj napriek tomu pokúsiť o obnovu.';
$string['modulesecurity'] = 'Zabezpečenie modulu';
...
$string['mymoodleredirect'] = 'Vnútiť používaľom použitie stránky Môj Moodle';
...
$string['noreplyaddress'] = 'Adresa odosieľateľa automaticky generovaných správ';
$string['noresults'] = 'Bez výsledkov';
$string['notifications'] = 'Upozornenie';
$string['notifyloginfailures'] = 'Posielať neúspěšné prihlásenia emailem';
$string['notifyloginthreshold'] = 'Prah pre upozornenie emailem';
...
$string['pgclusterdescription'] = 'Parametre PostgreSQL version/cluster pre operácie z príkazového řriadku. Ak prevádzkujete iba jednu verziu PostgreSQL, alebo ak si nie ste istý, nechajte pole prázdne.';
...
$string['profileconfirmfielddeletion'] = 'Bolo nájdené $a záznamov, ktoré používajú toto pole. Informácia uložená v poli bude nenávratne stratená. Stále si prajete pole odstraniť?';
...
$string['profilevisibleprivate'] = 'Súkromé pole - viditeľné iba pre daného používateľa';
...
$string['restrictbydefault'] = 'Obmeziť ponuku implicitne';
$string['restrictmodulesfor'] = 'Obmezenie ponuky dostupných modulov';
...
$string['riskpersonal'] = 'Používatelia môžu získať prístup k súkromným informaciám iných používateľov';
...
$string['riskxss'] = 'Používatelia môžu pridávaž súbory či texty umožňujúce Cross-Site Scripting (XSS).';
...
$string['upgradesure'] = '<p>Vaše súbory v Moodle boli zmenené a Vy sa práve chystáte povýšiť Váš server na túto verziu:</p><p><b>$a</b></p><p>Ak to teraz začnete, už sa nemôžete vrátiť späť.</p><p>Ste si istý, že chcete povýšiť tento server na túto verziu?</p>';
$string['upgradingdata'] = 'Údaje sa aktualizujú';
$string['upgradinglogs'] = 'Záznamy sa aktualizujú';
$string['upwards'] = 'a vyšší';
$string['usehtmleditor'] = 'Použíť HTML editor';
