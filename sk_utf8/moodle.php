...
$string['adminhelphealthcenter'] = 'Automatická detekcia problémov na portáli';
...
$string['adminhelpmymoodle'] = 'Konfigurovať bloky môj moodle pre užívateľov';
...
$string['adminprimarynoedit'] = 'Nemôžete zmeniť heslo hlavného administrátora';
$string['advanced'] = 'Rozšírené';
$string['advancedfilter'] = 'Rozšírené vyhľadávanie';
$string['advancedsettings'] = 'Rozšírené nastavenia';
$string['again'] = 'opäť';
$string['aimid'] = 'AIM ID';
$string['ajaxno'] = 'Nie: používať základné web funkcie';
$string['ajaxuse'] = 'AJAX a Javascript';
$string['ajaxyes'] = 'Áno: používať pokročilé web funkcie';
$string['all'] = 'Všetko';
...
$string['backupschedulehelp'] = 'Zvoľte dni v týždni, kedy majú byť spúšťané automatizované zálohovania.';
...
$string['courserequestdetails'] = 'Podrobnosti o kurze, ktorý žiadate';
...
$string['courserequestreason'] = 'Dôvody pre žiadosť o kurz';
$string['courserequestsuccess'] = 'Vaša žiadosť bola úspešne uložená. O pár dní očakávajte mail s odpoveďou.';
...
Ak budú vaše problémy pokračovať, kontaktujte administrátora stránky.</p>';
...
$string['enroldate'] = 'Dátumy od-do';
$string['enrolenddate'] = 'Zápis do';
$string['enrolenddaterror'] = 'Koncový dátum zápisu nemôže byť skôr ako začiatočný';
$string['enrollable'] = 'Možnosť zápisu do kurzu';
$string['enrolledincourse'] = 'Zapísaný do kurzu \"$a\"';
$string['enrolledincoursenot'] = 'Nie ste zapísaný do kurzu \"$a\"';
$string['enrolledincoursenotrole'] = 'Chyba pri zápise do kurzu \"$a->course\" s rolou \"$a->role\"';
$string['enrolledincourserole'] = 'Zapísaný do kurzu \"$a->course\" s rolou \"$a->role\"';
...
$string['enrolmentkeyfromguest'] = 'Tento kurz vyžaduje \'prihlasovací kľúč\' - ako hosť<br />
ho musíte zadať vždy, keď vstupujete do kurzu. Mali by ste ho dostať od $a';
...
$string['enrolstartdate'] = 'Zápis od';
...
$string['expirynotify'] = 'Oznamovanie ukončenia zápisu';
$string['expirynotifyemail'] = 'Nasledovní študenti v tomto kurze budú odhlásení po presne $a->threshold dni/dňoch:

$a->current

Nasledovní študenti v tomto kurze budú odhlásení po menej ako $a->threshold dni/dňoch:

$a->past

Ak chcete predĺžiť čas ich zápisu, navštívte nasledovnú stránku:
$a->extendurl';
...
$string['extendenrol'] = 'Predĺžiť zapisovanie';
...
$string['formattopicsajax'] = 'Tématický formát - AJAX';
$string['formattopicscss'] = 'Tématický formát - CSS (bez tabuliek)';
...
$string['go'] = 'Ísť';
$string['gotoyourserver'] = '(Odkazy späť na váš server)';
...
$string['helpinterestslist'] = 'Vložte svoje záujmy oddelené čiarkami';
...
$string['importgroups'] = 'Importovať skupiny';
...
$string['metaalreadyhascourses'] = 'Tento meta kurz už obsahuje podradené kurzy';
$string['metaalreadyhasenrolments'] = 'Tento kurz už obsahuje normálne zápisy účastníkov';
...
Na začatie používania portálu \'$a->sitename\' sa prihláste na linke
$a->link

Najčastejšie v mailových programoch tento odkaz je modrý a môžete naň kliknúť. Ak sa to nedá, skopírujte si adresu do zadávacieho riadku Vašeho web prehliadača.
...
$string['notifyloginfailuresmessageend'] = 'Tieto záznamy o prihláseniach si môžete prezrieť na $a/course/report/log/index.php?id=1&amp;chooselog=1&amp;modid=site_errors.';
...
$string['pluginchecknotice'] = 'Nasledujúce tabuľky zobrazujú moduly, bloky a filtre ktoré boli nájdené vo vašej inštalácii Moodle. Zobrazujú, ktoré z nich sú štandardné a ktoré nie. Všetky neštandardné moduly by mali byť skontrolované a aktualizované na svoju najnovšiu verziu predtým, ako začne samotná aktualizácia Moodle.';
...
$string['statsreport8'] = 'Všetky používateľské aktivity';
...
$string['unenrol'] = 'Odstrániť z kurzu';
...
$string['unenrolroleusers'] = 'Odstrániť používateľov z kurzu';
...
$string['updatemymoodleon'] = 'Upraviť stránku';
