...
$string['clientshowchannellinklabel'] = 'Má byť zobrazený odkaz na pôvodné stránky (odkaz na kanál)? (Ak nie je odkaz v zdroji k dispozícii, nebude sa zobrazovať):';
$string['clientshowimagelabel'] = 'Zobraziť obrázok kanálu, ak je dostupný:';
...
$string['editrssblock'] = 'Upraviť RSS blok';
...
$string['feedsaddedit'] = 'Pridať/Upraviť zdroje noviniek';
$string['feedsconfigurenewinstance'] = 'Tento blok zatiaľ nemôže zobrazovať žiadny RSS zdroj. Najprv ho musíte nastaviť, kliknutím sem.';
