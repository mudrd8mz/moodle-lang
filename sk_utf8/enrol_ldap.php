...
$string['enrol_ldap_course_idnumber'] = 'Mapovanie jednoznačného identifikátora v LDAP, obyčajne  <em>cn</em> alebo <em>uid</em>. Odporúča sa \"uzamknúť\" túto hodnotu, ak používate automatické vytváranie kurzov.';
...
$string['enrol_ldap_memberattribute'] = 'Atribút členstva (member) v LDAP';
$string['enrol_ldap_objectclass'] = 'Na vyhľadávanie kurzov sa používa objectClass. Obyčajne \'posixGroup\'.';
$string['enrol_ldap_roles'] = 'Mapovanie rol';
