...
$string['cantunenrollfrommetacourse'] = '您無法從這個後設課程退選';
$string['cantunenrollinthisrole'] = '使用目前角色無法從這個課程退選';
...
$string['couldnotassignrole'] = '指定角色給您時發生了一個嚴重但是不明的錯誤發生';
...
$string['invalidrequest'] = '錯誤的請求';
$string['invalidrole'] = '錯誤的角色';
$string['invalidxmlfile'] = '\"$a\" 不是正確的XML檔案';
$string['loginasnoenrol'] = '您在課程 \"登入為\" 連線不能選課或退選';
$string['loginasonecourse'] = '您無法進入這個課程，您必須終止 \"登入為\" 連線來進入其他課程。';
...
$string['nocontext'] = '抱歉，那個課程不是個正確的意含';
$string['noinstances'] = '這個課程沒有 $a 實例！';
$string['nologinas'] = '您無法登入為那個使用者';
