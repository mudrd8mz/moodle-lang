<?PHP // $Id$ 
      // admin.php - created with Moodle 1.8.2+ (2007021520) by Eric Hsin
...
$string['allowcoursethemes'] = '允許課程自選佈景';
...
$string['choosefiletoedit'] = '從上面選擇要編輯的檔案';
...
$string['userrenamed'] = '使用者更名';
$string['users'] = '用戶';
$string['userscreated'] = '已建立(多個)使用者';
$string['usersrenamed'] = '已修改(多個)使用者';
$string['usersupdated'] = '已更新(多個)使用者資料';
