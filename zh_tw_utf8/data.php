...
$string['export'] = '匯出';
$string['exportaszip'] = '匯出成zip格式';
$string['exportedtozip'] = '暫時匯出成zip格式';
...
$string['latlongdownloadallhint'] = '下載所有資料的連結為 KML';
$string['latlongkmllabelling'] = '如何在 KML 檔案 (Google Earth) 標示項目';
...
$string['picture'] = '圖片';
$string['pleaseaddsome'] = '請在下面建立一些或是 <a href=\"$a\">選擇一個預設集合</a> 來開始。';
$string['presetinfo'] = '儲存為預設值將會發佈這個樣板，其他使用者可以在他們的資料庫中使用。';
$string['presets'] = '預設值';
