...
$string['confirm'] = '確認';
$string['confirmed'] = '您的註冊已經得到確認';
$string['confirmednot'] = '您的註冊尚未得到確認！';
$string['continue'] = '下一頁';
...
$string['formatweekscss'] = '週曆格式--CSS/No 表格';
...
$string['idnumber'] = '識別編號';
$string['idnumbercourse'] = '課程識別編號';
...
您在\'$a->sitename\' 網站的帳號，已經油系統重新設定一個新的臨時密碼
...
$string['sizemb'] = 'MB';
$string['skipped'] = '略過';
$string['skiptomaincontent'] = '跳到主要內容';
