...
$string['1hour'] = '1 小時';
$string['2hours'] = '2 小時';
$string['30minutes'] = '30 分鐘';
$string['6hours'] = '6 小時';
$string['acceptederror'] = '可接受的錯誤';
$string['action'] = '動作';
$string['adaptive'] = '適應模式';
$string['addcategory'] = '新增類別';
$string['addingquestions'] = '頁面的這一邊用來管理題庫。題目分門別類，以便管理。題庫中的題目可用於您的課程中的任何測驗。如果您選擇“公佈”它們，則甚至可用於其他課程。<br><br>您在選擇或創建類別後才能創建或編輯題目。您可以選擇任何題目加入到另一邊的測驗中。';
...
$string['comment'] = '意見';
$string['commentorgrade'] = '提供意見或是重新評分';
$string['comments'] = '意見';
$string['completedon'] = '完成';
$string['confirmclose'] = '您要結束此次作答，一但您結束作答，您就無法再變更您的答案了。';
$string['confirmserverdelete'] = '您確定要把伺服器b>$a</b>從此清單移除?';
$string['confirmstartattemptlimit'] = '本測驗只能使用 $a 次，存取測驗就算是一次，要開始嗎？';
$string['confirmstartattempttimelimit'] = '本測驗有時間限制而且只能使用 $a 次，存取測驗就算是一次，要開始嗎？';
$string['confirmstarttimelimit'] = '本測驗有時間限制，要開始嗎?';
...
$string['delay1'] = '第一與第二次測驗之間的延遲時間';
$string['delay2'] = '下一次測驗的延遲時間';
$string['deleteattemptcheck'] = '您確定要完全刪除這個測驗';
...
$string['editqcats'] = '編輯問題類別';
$string['editquestions'] = '編輯問題';
$string['editquiz'] = '編輯測驗卷';
$string['editquizquestions'] = '編輯測驗問題';
...
$string['exportingquestions'] = '問題已經匯出到檔案';
...
$string['filloutoneanswer'] = '您至少需要輸入一個答案。  沒有答案的題目無效。';
...
$string['formatnotfound'] = '匯入/匯出格式 $a 找不到';
$string['formatnotimplemented'] = '這個格式還沒支援，請回報這個問題。';
$string['fractionsaddwrong'] = '您所提供各選項分數總和並非 100%%， 而是 $a%%
<BR>請回去修正此題的錯誤分配?';
...
$string['generatevalue'] = '產生一個新數值介於';
$string['geometric'] = '幾何';
$string['gift'] = 'GIFT 格式';
$string['grade'] = '分數';
$string['gradeall'] = '全部評分';
$string['gradeaverage'] = '平均得分';
$string['gradeessays'] = '評論評分';
...
$string['importfilearea'] = '要匯入的檔案已經存在於課程中';
$string['importfileupload'] = '從上傳檔案匯入';
$string['importfromthisfile'] = '從這個檔案匯入';
...
$string['matcherror'] = '分數不符合評分選項 - 略過問題';
$string['matchgrades'] = '符合分數';
$string['matchgradeserror'] = '如果沒有列出分數就是錯誤';
$string['matchgradesnearest'] = '如果沒有列出就找最接近的分數';
$string['max'] = '最大';
$string['min'] = '最小';
$string['minutes'] = '分';
...
$string['nocommentsyet'] = '還沒有意見';
$string['noconnection'] = '目前能處理這個問題的Web服務無法連接，請與您的系系統理者聯繫 。';
$string['nodataset'] = '運算結果非真-它不是萬用字元';
$string['noessayquestionsfound'] = '找不到手動評分問題';
$string['nominal'] = '記名';
...
$string['noquestionsinfile'] = '匯入的檔案不包含任何題目';
...
$string['notimedependentitems'] = '測驗模組目前沒支援與時間有關的項目。工作時，設定整個測驗的時間限制。 您希望選擇一個不同的項目(還是不加理會使用當今的項目)嗎？';
$string['numattempts'] = '$a->studentnum $a->studentstring 已經嘗試 $a->attemptnum 次';
$string['numberabbr'] = '#';
$string['numerical'] = '算術';
...
$string['questions'] = '題目';
$string['questionsinclhidden'] = '題目（包含隱藏的）';
...
$string['readytosend'] = '準備送出作答結果等待評分。  您確定要繼續嗎?';
...
$string['serverinuse'] = '您正要刪除的伺服器是最後一個 $ a伺服器，
如果您刪除這台伺服器，將有無法正常工作的問題。';
$string['servers'] = '伺服器';
...
$string['sorttypealpha'] = '依據類型、名稱排列';
$string['startagain'] = '重新開始';
$string['startedon'] = '開始';
$string['subneterror'] = '抱歉，此測驗已經被鎖定，因此只可從某些位置存取。 目前您的電腦不在允許範圍內。';
$string['subnetnotice'] = '此測驗已經被鎖定，因此只可從某些位置存取。您的電腦不在一個允許的子網上。身為教師的您可允許預覽。';
$string['substitutedby'] = '將取代透過';
$string['temporaryblocked'] = '您暫時無法再次使用測驗 <br /> 下一次可以使用的時間為：';
$string['time'] = '時間';
$string['timecompleted'] = '完成';
$string['timedelay'] = '您現在無法使用測驗，因為在上次測驗之後需要等候一段時間。';
...
$string['upgradesure'] = '<div style=\"color: red;\">測驗模組將大幅變動目前的資料表，此升級還沒有被足夠測試。 您在進行之前強烈建議您備份資料表。 < /div>';
$string['url'] = '網址';
...
$string['warningmissingtype'] = '<p><b>這個題目類型還沒安裝，請提醒您的管理員。</b></p>';
$string['warningsdetected'] = '$a 警告發生。';
$string['webct'] = 'WebCT 格式';
$string['wheregrade'] = '我的分數在哪？';
