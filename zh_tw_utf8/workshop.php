...
$string['noteonassessmentelements'] = '注意，得分可分解為一些“評價項目”。。<BR> 這使評分變得容易且保持一致性。 <BR> 作為教師您須在佈置好作業之前添加這些項目。<BR> 點擊課程中的佈置作業，如果沒有指定過要素，您就會看到提示要求添加項目。<BR> 您可以使用編輯作業頁面來改變項目的數量。<BR> 具體要素本身在“作業管理”頁面中修改。';
...
$string['submitassignmentusingform'] = '用下面表單上傳您的作業';
$string['submitexample'] = '上傳範本';
$string['submitexampleassignment'] = '作業範本上傳';
$string['submitrevisedassignment'] = '用下面表單上傳您修改後的作業';
