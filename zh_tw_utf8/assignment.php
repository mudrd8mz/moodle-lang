...
$string['attachfiletoassignment'] = '附加檔案到作業中';
$string['availabledate'] = '開始於';
$string['backtoassignment'] = '回到作業';
$string['backtofeedback'] = '回到意見';
$string['choosereviewfile'] = '選擇要上傳的作業檔案：';
$string['comment'] = '評語';
$string['commentinline'] = '線上評論';
$string['configitemstocount'] = '學生繳交線上作業的一般計算數量';
$string['configmaxbytes'] = '本網站對所有作業的預設最大作業檔案上傳限制。';
$string['deletecheckfile'] = '您確定要刪除這個檔案？';
$string['deleteednotification'] = '檔案刪除了。';
$string['deletefail'] = '下面檔案無法刪除：';
...
$string['removelink'] = '移除';
$string['responsefile'] = '回應檔案：';
$string['responsesfromteacher'] = '教師上傳的回應檔案';
...
$string['submissionstatusblank'] = '空白';
$string['submissionstatusdraft'] = '草稿';
$string['submissionstatusmarked'] = '標示';
$string['submissionstatusreturned'] = '退回';
$string['submissionstatussubmitted'] = '已上傳';
...
$string['uploadsuccessresponse'] = '回應檔案上傳成功';
