...
$string['notdeployed'] = '尚未配置';
$string['note'] = '提示';
$string['notefile'] = '請利用 <A HREF=$a >檔案管理</A>上載檔案。 上載的檔案都會顯示在選單中';
$string['notypechosen'] = '請先選擇資源型態。 請回前頁重試一次。';
$string['packagechanged'] = 'IMS 內容包有異動';
$string['packagenotdeplyed'] = 'IMS 內容包還沒配置';
...
$string['preview'] = '預覽';
$string['previous'] = '上一頁';
$string['redeploy'] = '再次配置';
$string['repository'] = 'IMS 檔案庫';
...
$string['resourcetypeims'] = '新增 IMS 內容包';
...
$string['skipsubmenus'] = '略過子選單頁面';
$string['tableofcontents'] = '內容章節';
$string['upbutton'] = '向上';
$string['variablename'] = '變數名稱';
$string['viewims'] = '瀏覽IMS 內容包';
$string['vol'] = 'Vol';
