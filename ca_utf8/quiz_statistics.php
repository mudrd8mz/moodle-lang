<?PHP // $Id$ 
      // quiz_statistics.php - created with Moodle 1.9.1+ (Build: 20080618) (2007101514)
...
$string['calculatefrom'] = 'Calcula estadístiques de:';
$string['cic'] = 'Coeficient de consistència interna';
...
$string['noofallattempts'] = 'Nombre total d\'intents';
$string['nooffirstattempts'] = 'Nombre de primers intents';
$string['nostudentsingroup'] = 'Encara no hi ha estudiants en aquest grup';
$string['questionnumber'] = 'P.';
$string['questiontype'] = 'Tipus';
...
$string['standarderror'] = 'Error estàndard';
$string['statistics'] = 'Estadístiques';
$string['statsfor'] = 'Estadístiques: $a';
