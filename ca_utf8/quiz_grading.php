<?PHP // $Id$ 
      // quiz_grading.php - created with Moodle 1.9.1+ (Build: 20080618) (2007101514)
...
$string['gradeungraded'] = 'Qualifica tots els intents sense qualificar ($a)';
$string['grading'] = 'Qualificació manual';
$string['gradingall'] = 'Tots els intents ($a) d\'aquesta pregunta';
