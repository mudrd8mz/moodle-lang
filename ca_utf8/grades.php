...
$string['configdisablegradehistory'] = 'Inhabilita el seguiment històric de canvis en les taules de qualificacions. Pot accelerar una mica el servidor i conserva espai en la base de dades.';
...
$string['configrangesdisplaytype'] = 'Especifica com mostrar les gammes. Si seleccioneu Hereta, s\'utilitza el tipus de visualització de cada columna.';
