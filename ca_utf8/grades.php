...
$string['aggregateextracreditmeanall'] = 'Mitjana de totes les qualificacions (crèdits extra)';
$string['aggregatemaxall'] = 'Qualificació més alta de totes les qualificacions';
$string['aggregatemeanall'] = 'Mitjana de totes les qualificacions';
$string['aggregatemedianall'] = 'Mediana de totes les qualificacions';
$string['aggregateminall'] = 'Qualificació més baixa de totes les qualificacions';
