...
$string['gradetypehelp'] = 'Especifica el tipus de qualificació utilitzat: cap (no és possible qualificar), valor (habilita els paràmetres de qualificació màxima i mínima), escala (habilita el paràmetre escala) o text (només retroacció). Només es poden agregar els tipus de qualificació valor i escala. El tipus de qualificació d\'un element de qualificació basat en activitat es defineix a la pàgina d\'actualització de l\'activitat.';
