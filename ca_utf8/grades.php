...
$string['configquickfeedback'] = 'La retroacció ràpida afegeix un camp d\'entrada de text en cada casella de qualificació en l\'informe de qualificacions, de manera que podeu editar la retroacció de moltes qualificacions d\'una vegada. Després feu clic en el botó Actualitza per efectuar tots aquests canvis d\'una vegada, en lloc de fer-los un per un.';
