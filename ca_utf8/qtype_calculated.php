<?PHP // $Id$ 
      // qtype_calculated.php - created with Moodle 1.9 dev (2007062008)
...
$string['existingcategory1'] = 'un conjunt de dades compartit ja existent';
$string['keptcategory1'] = 'el mateix conjunt de dades compartit que abans';
$string['keptlocal1'] = 'el mateix conjunt de dades privat que abans';
...
$string['newcategory1'] = 'un nou conjunt de dades compartit';
$string['newlocal1'] = 'un nou conjunt de dades privat';
