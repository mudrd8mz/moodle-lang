...
$string['ccno'] = 'Número de la targeta de crèdit';
...
$string['description'] = 'El mòdul Authorize.net permet planificar cursos de pagament.  Si un curs és gratuït, no es demanarà als estudiants que facin el pagament. Existeix un cost per a tot el lloc el qual vostè pot fixar aquí com a valor per defecte per al lloc complet i, a més a més, una opció que permet fixar el cost de cada curs. El cost del curs substitueix  el cost del lloc.';
$string['enrolname'] = 'Passarel·la de targeta de crèdit Authorize.net';
