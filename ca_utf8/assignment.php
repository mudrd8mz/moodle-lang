...
$string['attachfiletoassignment'] = 'Adjunta fitxer/s a la tasca';
$string['availabledate'] = 'Disponible des de';
$string['backtoassignment'] = 'Torna a la tasca';
$string['backtofeedback'] = 'Torna a la retroacció';
$string['choosereviewfile'] = 'Trieu un fitxer per penjar com a revisió de la tasca';
...
$string['deletecheckfile'] = 'Segur que voleu suprimir aquest fitxer?';
$string['deleteednotification'] = 'S\'ha suprimit el fitxer.';
$string['deletefail'] = 'El fitxer següent no s\'ha suprimit:';
...
$string['late'] = '$a tard';
$string['markingsubmitnotification'] = 'El fitxer s\'ha tramès amb èxit perquè sigui avaluat.';
$string['maximumgrade'] = 'Nota màxima';
$string['maximumsize'] = 'Mida màxima';
$string['modulename'] = 'Tasca';
$string['modulenameplural'] = 'Tasques';
$string['namedeletefile'] = 'Esteu a punt de suprimir aquest fitxer:';
...
$string['nofilesforsubmit'] = 'No s\'ha trobat cap fitxer per trametre. Segur que n\'havíeu penjat un?';
$string['notgradedyet'] = 'No s\'ha qualificat encara';
$string['notsubmittedyet'] = 'No s\'ha tramès encara';
$string['onceassignmentsent'] = 'Després que envieu la tasca perquè sigui avaluada, ja no podreu adjuntar-hi ni suprimir cap fitxer.';
...
$string['removelink'] = 'Suprimeix';
$string['responsefile'] = 'Fitxer de resposta:';
$string['responsesfromteacher'] = 'Respostes penjades pel professor';
...
$string['submissionstatusblank'] = 'En blanc';
$string['submissionstatusdraft'] = 'Esborrany';
$string['submissionstatusmarked'] = 'Avaluada';
$string['submissionstatusreturned'] = 'Retornada';
$string['submissionstatussubmitted'] = 'Tramesa';
...
$string['uploadsuccessresponse'] = 'El fitxer de resposta s\'ha penjat amb èxit.';
