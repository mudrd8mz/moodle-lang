<?PHP // $Id$ 
      // mnet.php - created with Moodle 1.9 + (Build: 20080304) (2007101509)


$string['aboutyourhost'] = 'El vostre servidor';
$string['accesslevel'] = 'Control d\'accés';
...
$string['mnetsettings'] = 'Paràmetres de Moodle en Xarxa';
$string['mnetthemes'] = 'Temes';
$string['moodleloc'] = 'Ubicació de Moodle';
$string['net'] = 'Xarxa';
