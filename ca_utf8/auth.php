...
$string['auth_cas_broken_password'] = 'No podeu continuar sense canviar la contrasenya, però no existeix una pàgina per a canviar la contrasenya. Si us plau contacteu amb l\'administració d\'aquest servidor Moodle.';
