...
$string['bookmarkadded'] = 'S\'ha afegit l\'adreça';
$string['bookmarkalreadyexists'] = 'Aquesta pàgina ja era a les adreces d\'interès';
$string['bookmarkdeleted'] = 'S\'ha suprimit l\'adreça';
$string['bookmarkthispage'] = 'Afegeix a les adreces d\'interès';
...
$string['confignotloggedinroleid'] = 'Els usuaris que no hagin entrat seran tractats com si se\'ls hagués atorgat aquest rol al nivell del lloc. Generalment se\'ls dóna el rol Visitant, però igualment podríeu crear un rol que fos més o menys restrictiu. En tot cas, certes accions com ara enviar un missatge en un fòrum requereixen sempre que l\'usuari hagi entrat.';
...
$string['forceloginforprofiles'] = 'Obliga a entrar els usuaris per veure els perfils';
$string['forcetimezone'] = 'Imposa la zona horària per defecte';
$string['framename'] = 'Nom del marc';
$string['frontpage'] = 'Primera plana';
$string['frontpageloggedin'] = 'Elements de la primera plana si ha entrat';
...
$string['nobookmarksforuser'] = 'No teniu cap adreça d\'interès.';
...
$string['nonexistentbookmark'] = 'L\'adreça que heu sol·licitat no existeix.';
...
$string['notloggedinroleid'] = 'Rol de visitants';
...
$string['riskmanagetrust'] = 'Els usuaris podrien canviar paràmetres d\'altres usuaris';
...
$string['unbookmarkthispage'] = 'Suprimeix aquesta adreça d\'interès';
