...
$string['essay'] = 'Ensayo';
$string['essayemailmessage'] = '<p>Ensayo:<blockquote>$a->question</blockquote></p><p>Su respuesta:<blockquote><em>$a->response</em></blockquote></p><p>$a->comentarios del profesor:<blockquote><em>$a->comment</em></blockquote></p><p>Usted ha recibido $a->earned sobre un total de $a->outof en esta pregunta de ensayo.</p><p>Su calificación en la lección ha cambiado a $a->newgrade&#37;.</p>';
