...
$string['auth_remove_delete'] = 'Borrado completo interno';
$string['auth_remove_keep'] = 'Mantener memoria interna';
$string['auth_remove_suspend'] = 'Suspender memoria interna';
$string['auth_remove_user'] = 'Especifique qué hacer con una cuenta de usuario interna durante sincronización masiva cuando el usuario fue removido de la fuente externa. Únicamente los usuarios suspendidos son automáticamente revividos si ellos reaparecen en una fuente externa.';
$string['auth_remove_user_key'] = 'Usuario externo removido';
...
$string['errorminpasswordnonalphanum'] = 'Las contraseñas deben tener al menos $a caracter(es) alfanuméricos.';
