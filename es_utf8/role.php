<?PHP // $Id$ 
      // role.php - created with Moodle 1.6 (2006050506)


$string['allow'] = 'Permitir';
$string['assignroles'] = 'Asignar papeles';
...
$string['legacy:admin'] = 'PAPEL HEREDADO: Administrador';
$string['legacy:coursecreator'] = 'PAPEL HEREDADO: Creador de cursos';
$string['legacy:editingteacher'] = 'PAPEL HEREDADO: Profesor (editor)';
$string['legacy:guest'] = 'PAPEL HEREDADO: Invitado';
$string['legacy:student'] = 'PAPEL HEREDADO: Estudiante';
$string['legacy:teacher'] = 'PAPEL HEREDADO: Profesor (no editor)';
$string['nocapabilitiesincontext'] = 'Habilidades no disponibles en este contexto';
$string['overrideroles'] = 'Pasar por alto los papeles';
$string['potentialusers'] = '$a usuarios potenciales';
$string['prevent'] = 'Prevenir';
$string['prohibit'] = 'Prohibir';
$string['role:assign'] = 'Asignar papeles a los usuarios';
$string['role:manage'] = 'Crear y gestionar papeles';
$string['roletoassign'] = 'Papel a asignar';
