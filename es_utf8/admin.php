...
$string['configautolang'] = 'Detectar idioma por defecto desde el ajuste del navegador si se utiliza el valor por defecto deshabilitado del sitio.';
...
$string['xmlstrictheaders'] = 'Cabeceras XML estricto';
