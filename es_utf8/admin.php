...
$string['configenablerecordcache'] = 'Si escribe un número mayor que 0, se ejecutarán operaciones en la caché mientras se recupera información de la base de datos. Esto significa que la tasa de transferencia de la base de datos será mejor pero, por otro lado, los requerimientos de memoria del servidor se verán ligeramente incrementados. Generalmente, recomendamos valores en torno a 50 a menos que su servidor esté bajo de memoria. Algunos procesos pueden elegir pasar por alto esta opción, cuando el desarrollador tiene certeza de un incremento en el rendimiento.';
