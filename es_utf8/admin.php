...
$string['configdbsessions'] = 'Si elige esta opción, se usará la base de datos para almacenar información sobre las sesiones actuales. Esto es especialmente útil para sitios grandes u ocupados construidos sobre racimos (\'clusters\') de servidores. En la mayoría de los casos debería dejarse en blanco de modo que se use en su lugar el disco del servidor. Note que la modificación de este ajuste desconectará a todos los usuarios, incluído usted.';
...
$string['configdefaultallowedmodules'] = 'Para los cursos incluidos en la categoría anterior, ¿qué módulos desea que aparezcan por defecto <b>cuando se crea el curso</b>?';
...
$string['configrestrictbydefault'] = '¿Deberían los cursos nuevos incluidos en la categoría anterior tener sus módulos restringidos por defecto?';
...
$string['configsessioncookiepath'] = 'Si necesita cambiar el lugar al que los navegadores envían las cookies de Moodle, puede cambiar esta opción para especificar un subdirectorio de su sitio web. En otro caso, funcionará bien el \'/\' por defecto.';
...
$string['releasenoteslink'] = 'Si desea información sobre esta versión de Moodle, por favor vea <a target=\"_new\" href=\"$a\">Release Notes</a>';
...
$string['simpletest'] = 'Tests unitarios';
