...
$string['attachfiletoassignment'] = 'Adjuntar archivo(s) a la tarea';
$string['availabledate'] = 'Disponible en';
$string['backtoassignment'] = 'Volver a la Tarea';
$string['backtofeedback'] = 'Volver a la Retroalimentación';
$string['choosereviewfile'] = 'Seleccionar archivo a subir como revisión de la tarea:';
...
$string['deletecheckfile'] = '¿Está absolutamente seguro de que desea eliminar este archivo?';
$string['deleteednotification'] = 'El archivo ha sido eliminado.';
$string['deletefail'] = 'El siguiente archivo no ha sido eliminado:';
...
$a->url';
$string['emailteachermailgroup'] = 'El grupo $a->groupname $a->groupmembers ha actualizado el envío de su tarea \'$a->assignment\'
...
$string['emailteachermailhtmlgroup'] = 'El grupo $a->groupname $a->groupmembers ha actualizado el envío de su tarea <i>\'$a->assignment\'</i><br /><br />
Está disponible en el sitio web <a href=\"$a->url\"></a>.';
...
$string['helpuploadsinglegroup'] = '<p>Este tipo de tarea permite que cada participante suba un solo archivo, de cualquier tipo.</p> <p>Podría ser un documento hecho con Word, una imagen, una web comprimida, o cualquier otra cosa.</p> <p>El envío de este usuario es también remitido por todos los miembros del grupo a que dicho usuario pertenece. Si el curso no tiene grupos, toda la clase se considera como un grupo.</p>';
$string['late'] = '$a después';
$string['markingsubmitnotification'] = 'El archivo ha sido subido con éxito para su calificación.';
...
$string['namedeletefile'] = 'Está a punto de eliminar este archivo:';
...
$string['nofilesforsubmit'] = 'No se ha encontrado ningún archivo para remitir: ¿está seguro de que lo ha subido?';
...
$string['removelink'] = 'Quitar';
$string['responsefile'] = 'Archivo de respuesta:';
$string['responsesfromteacher'] = 'Respuestas subidas por el profesor';
...
$string['submissionstatusblank'] = 'En blanco';
$string['submissionstatusdraft'] = 'Borrador';
$string['submissionstatusmarked'] = 'Calificado';
$string['submissionstatusreturned'] = 'Devuelto';
...
$string['uploadsuccessresponse'] = 'Archivo de respuesta subido con éxito.';
