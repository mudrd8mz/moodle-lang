...
$string['alias'] = 'Palabra clave'; // ORPHANED
...
$string['date'] = 'fecha'; // ORPHANED
$string['defaulthook'] = '\'Hook\' por defecto'; // ORPHANED
$string['defaultmode'] = 'Modo por defecto'; // ORPHANED
$string['defaultsortkey'] = 'Clave de clasificación por defecto'; // ORPHANED
$string['defaultsortorder'] = 'Orden de clasificación por defecto'; // ORPHANED
$string['errdeltimeexpired'] = 'No puede eliminar esto: el tiempo ha expirado.'; // ORPHANED
$string['glossary:exportentry'] = 'Exportar una sola entrada'; // ORPHANED
$string['glossary:exportownentry'] = 'Exportar una sola entrada de las suyas'; // ORPHANED
$string['guestnoedit'] = 'Los invitados no pueden editar glosarios'; // ORPHANED
$string['includegroupbreaks'] = 'Incluir segmentaciones de grupo'; // ORPHANED
$string['invalidid'] = 'ID de glosario incorrecta'; // ORPHANED
$string['letter'] = 'letra'; // ORPHANED
$string['nopermissiontodelcomment'] = 'No puede eliminar los comentarios de otras personas.'; // ORPHANED
$string['nopermissiontodelinglossary'] = 'No puede agregar comentarios a este glosario.'; // ORPHANED
$string['nopermissiontoviewresult'] = 'Sólo puede mirar los resultados de sus propias entradas'; // ORPHANED
$string['popupformat'] = 'Formato \'popup\''; // ORPHANED
