...
$string['autonumbering'] = 'numeración automática de las preguntas'; // ORPHANED
$string['confirmdeleteentry'] = '¿Está seguro que quiere borrar esta entrada?'; // ORPHANED
$string['confirmdeleteitem'] = '¿Está seguro que quiere borrar este elemento?'; // ORPHANED
$string['confirmdeletetemplate'] = '¿Está seguro que quiere utilizar esta plantilla?'; // ORPHANED
...
$string['cannotunmap'] = 'Problema con la base de datos, imposible desasignar'; // ORPHANED
$string['cannotmapfeedback'] = 'Problema con la base de datos, imposible asignar encuesta al curso'; // ORPHANED
$string['cannotsavetempl'] = 'no se permite guardar plantillas'; // ORPHANED
$string['captchanotset'] = 'No se ha ajustado el Captcha.'; // ORPHANED
$string['feedback:receivemail'] = 'Recibir notificación por correo electrónico'; // ORPHANED
$string['feedback:viewanalysepage'] = 'Ver página de análisis después del envío'; // ORPHANED
$string['feedback_is_not_for_anonymous'] = 'la encuesta no es anónima'; // ORPHANED
$string['info'] = 'Información'; // ORPHANED
$string['infotype'] = 'Información Tipo'; // ORPHANED
$string['multichoice'] = 'Elección múltiple'; // ORPHANED
$string['multichoice_values'] = 'Valores elección múltiple'; // ORPHANED
$string['multichoicerated'] = 'Elección múltiple (clasificadas)'; // ORPHANED
$string['multichoicetype'] = 'Tipo elección múltiple'; // ORPHANED
$string['notavailable'] = 'esta encuesta no está disponible'; // ORPHANED
$string['responsetime'] = 'Hora de respuesta'; // ORPHANED
$string['show_analysepage_after_submit'] = 'Mostrar análisis tras el envío'; // ORPHANED
$string['site_after_submit'] = 'Sitio tras el envío'; // ORPHANED
$string['typemissing'] = 'valor ausente \"type\"'; // ORPHANED
