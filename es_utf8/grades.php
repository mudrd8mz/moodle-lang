...
$string['aggregationcoefextrasum'] = 'Actuar como crédito extra';
$string['aggregationcoefweight'] = 'Peso del elemento';
$string['aggregationhelp'] = 'Estrategia usada para agregrar calificaciones a todos los estudiantes de un curso.';
...
$string['configshowuseridnumber'] = 'Mostrar números ID del usuario como columna adicional';
...
$string['errornocategorisedid'] = 'No se ha podido conseguir un ID no categorizado';
...
$string['showuseridnumber'] = 'Mostrar número de identificación del usuario';
...
$string['unenrolledusersinimport'] = 'Esta importación ha incluido las siguientes calificaciones para los usuarios no matriculados actualmente en este curso: $a';
...
$string['verbosescales'] = 'Escalas verbales';
...
$string['aggregationcoefextrahelp'] = 'Crédito extra para este elemento de calificación durante la agregación'; // ORPHANED
$string['aggregationcoefweighthelp'] = 'Peso aplicado a todas las calificaciones en este elemento de calificación durante la agregación con los demás elementos de calificación.'; // ORPHANED
...
$string['aggregationcoefhelp'] = 'Peso aplicado a todas las calificaciones de este elemento durante la agregación con otros elementos de calificación.'; // ORPHANED
$string['addevent'] = 'Agregar elemento calificado'; // ORPHANED
$string['addgrade'] = 'Gestionar elementos calificados'; // ORPHANED
...
$string['exportlettershelp'] = 'Cuando los elementos usen letras en lugar de valores, se exportarán las letras en lugar de los valores reales.'; // ORPHANED
$string['gradebookstatswarning'] = 'Las estadísticas incluyen tareas incompletas que aparecen como \'-\' y se cuentan como 0'; // ORPHANED
$string['gradeeventname'] = 'Nombre del elemento calificado:'; // ORPHANED
...
$string['newevent'] = 'Agregar nuevo elemento calificado'; // ORPHANED
$string['nogradeitemsinanycategory'] = 'No hay categorías de calificación que incluyan elementos calificados'; // ORPHANED
