<?PHP // $Id$ 
      // qtype_multianswer.php - created with Moodle 1.9.3+ (Build: 20081126) (2007101532)


$string['addingmultianswer'] = 'Agregando respuestas anidadas (Cloze)';
...
$string['editingmultianswer'] = 'Editando respuestas anidadas (Cloze)';
