<?PHP // $Id$ 
      // grades.php - created with Moodle 1.9.5+ (Build: 20090916) (2007101551)
...
$string['aggregateextracreditmean'] = '平均分（附带额外奖励）';
$string['aggregatemax'] = '最高分';
$string['aggregatemean'] = '平均分';
$string['aggregatemedian'] = '成绩中值';
...
$string['aggregationcoefextrasumhelp'] = '在汇总时，该项目的成绩算作额外奖励。';
...
$string['configrangesdisplaytype'] = '指定如何显示分数段。如果选中继承，那么将使用每列自己的显示方式。';
$string['configshowactivityicons'] = '是否在活动名旁显示活动图标。';
$string['configshowaverages'] = '是否在每列中显示平均分。';
$string['configshowcalculations'] = '是否在每个成绩项和类别中显示计算器图标。图标的悬停信息会说明哪些列已经被计算。';
...
$string['gradepasshelp'] = '如果某个项目有个分数，用户必须不低于该分数才是通过，那么您可以在这里设置。';
...
$string['importcustom'] = '作为自定义成果导入（仅在课程中）';
...
$string['weightorextracredit'] = '权重或额外奖励';
$string['weights'] = '权重';
$string['weightsedit'] = '编辑权重和额外奖励';
$string['weightuc'] = '权重';
$string['writinggradebookinfo'] = '写成绩单设置';
$string['xml'] = 'XML';
$string['yes'] = '是';
$string['yourgrade'] = '您的成绩';
$string['errornocategorizedid'] = '无法获得未分类的id！'; // ORPHANED
