<?PHP // $Id$ 
      // assignment.php - created with Moodle 1.9.5 (Build: 20090520) (2007101550)


$string['allowdeleting'] = '是否允许学生删除作业';
$string['allowmaxfiles'] = '允许上传文件的最大数目';
$string['allownotes'] = '是否允许注释';
...
$string['enableemailnotification'] = '发送 E-mail 公告';
