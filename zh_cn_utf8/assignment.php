...
$string['helpupload'] = '<p>此类作业允许每个参与者以任何格式上传一个或多个文件。这些文件可能是word处理的文档、图片、zipped的网页或者任何您要求提交的内容。</p>
<p>此类作业也允许您上传多种响应文件。响应文件也可以是先前上交的，可以用于每个参与者的不同文件使用的。</p>
<p>参与者们也可以录入注释来描述提交的文件，声明状态或任何其它文本信息。</p>
<p>此类作业的提交必须是参与者手工定稿的。您可以在任何时间回顾当前的状态，未完成的作业会被标记为草稿。您可以把任何未打分的作业恢复成草稿的状态。</p>';
...
$string['notavailableyet'] = '对不起，此作业已经无效了。<br />将在给出的日期下显示出作业指令。';
$string['notes'] = '注释';
$string['notesempty'] = '未登录';
$string['notesupdateerror'] = '在更新注释时有错';
$string['notgradedyet'] = '没有评分';
$string['notsubmittedyet'] = '未交';
$string['onceassignmentsent'] = '一旦发送了为打分的作业，您将不再能删除或粘贴文件（或多个文件）了。您确定要继续吗？';
...
$string['submitedformarking'] = '为打分的作业已经提交了，而且不能再更新了';
$string['submitformarking'] = '为作业打分的最终提交';
$string['submitted'] = '已交';
