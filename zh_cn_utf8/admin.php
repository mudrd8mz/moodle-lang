<?PHP // $Id$ 
      // admin.php - created with Moodle 1.9 + (Build: 20080320) (2007101509)
...
$string['allowcategorythemes'] = '允许类别主题';
...
$string['blocksettings'] = '管理区块';
$string['bloglevel'] = '博客可见度';
...
$string['cfgwwwrootslashwarning'] = '您在config.php中定义的&#36;CFG->wwwroot不正确，您在该变量的末尾添加了一个“/”字符。请删除该字符，否则您会遇到一些奇怪的错误（如<a href=\'http://tracker.moodle.org/browse/MDL-11061\'>MDL-11061</a>）。';
$string['cfgwwwrootwarning'] = '您在config.php中定义的&#36;CFG->wwwroot不正确，它与您访问此页面的URL不匹配。请更正它，否则您会遇到一些奇怪的错误（如<a href=\'http://tracker.moodle.org/browse/MDL-11061\'>MDL-11061</a>）。';
$string['change'] = '修改';
$string['changesitelang'] = '修改站点语言';
$string['checkboxno'] = '否';
$string['checkboxyes'] = '是';
$string['choosefiletoedit'] = '从上面的方框中选择文件';
$string['clamfailureonupload'] = 'Clam AV失败时';
$string['cleanup'] = '清除';
$string['commonsettings'] = '常规设置';
$string['componentinstalled'] = '组件已安装';
$string['computedfromlogs'] = '从{$a}时的日志开始计算';
$string['confeditorhidebuttons'] = '请选择HTML编辑器中要隐藏的按钮。';
$string['configallowassign'] = '允许每栏左边的角色委派其它角色';
$string['configallowcategorythemes'] = '如果您开启此选项，则可以为不同的课程类别定义不同的模板。这将会影响到该类别中未设置模块的课程。注意：开启类别模板可能会影响系统性能。';
...
$string['configauthenticationplugins'] = '请选择您要使用的认证插件，前面的插件若认证成功，则不再进行后续的认证。用户注册由您在“注册”栏中选择的插件处理（通常是“email”）。';
$string['configautolang'] = '通过浏览器的设置检测缺省的语言，如果关闭，则使用站点缺省设置。';
$string['configautologinguests'] = '当访问者进入允许访客访问的课程时，是否自动以访客身份登录？';
$string['configbloglevel'] = '这项设定允许你限制能浏览博客的用户的级别。注意它们列出的是能浏览的用户的最大级别，而与发表者和发表的博客类型无关。如果不需要博客功能，您可以完全禁止它。';
$string['configcachetext'] = '对于较大的或者是开启了文本过滤器的站点，这个设置可以提高速度。在一段时间之内，已经处理过的文本的副本将会被保留。如果将这个值设得太小会减慢相应速度，但设定得太大也会使文本刷新缓慢。';
$string['configcachetype'] = '为Moodle选择某种类型的缓存区。在这里仅仅是配置缓存区选项，要让缓存区工作还必须激活rcache。<strong>仅仅</strong>当您要减轻数据库系统的负荷时才需要开启缓存──否则Moodle将会变慢。如果您使用的是单一服务器并安装了<em>支持内存共享</em>的eAccelerator或Turckmmcache，那么请选择“eaccelerator”。如果您使用的是多台服务器，并运行了一个或多个memcached守护进程，且安装了PHP-memcached扩展，请选择“memcached”，并配置下面的memcached选项。<br /><strong>注意：</strong>请仔细测试服务器性能──缓存机制有可能让您的网站变慢。在流量很大时，eAccelerator和memcached可能会由比较好的效果，但同时也会多占用Web服务器的CPU。';
...
$string['configcookiehttponly'] = '使用PHP 5.2.0中的新功能──浏览器只向真正的HTTP请求发送cookie，而不允许脚本语言访问它们。并不是所有的浏览器都支持此功能，且可能和当前的代码不兼容。这对于防止某些类型的XSS攻击是有帮助的。';
$string['configcookiesecure'] = '如果服务器只接收https请求，那么最好还是激活发送安全cookie的功能。如果激活此功能，请确定您的Web服务器不相应http请求，或对这些请求自动重定向到相应的https地址上。当<em>wwwroot</em>地址不是https://时，此选项自动关闭。';
...
$string['configcreatornewroleid'] = '这个角色会自动赋予新课程的创建者。如果该创建者已经在上一层中拥有相关权限则不再重复授权。';
$string['configcronclionly'] = '如果设定此选项，则cron脚本只能以命令行方式执行，而不能通过web运行。此选项会使下面的cron密码失效。';
$string['configcronremotepassword'] = '这意为着没有密码就不能通过web执行cron.php脚本，要执行它需使用如下含有密码的URL：<pre>
 http://site.example.com/admin/cron.php?password=opensesame</pre>如果此项为空，则不需要密码。';
...
$string['configdebugdisplay'] = '设定为开启，则会在HTML页面上显示错误报告。这很实用，但通常会破坏XHTML、JS、cookies和HTTP头。设定为关闭，这些内容会发送给服务器日志，这是一种更好的调试方式。PHP的error_log选项设定了这些日志发给谁。';
$string['configdebugsmtp'] = '当发送消息给SMTP服务器时，显示详细的调试信息。';
...
$string['configdefaultuserroleid'] = '对所有登陆的用户来说，在网站层，除了其它已经获得的角色，所有登陆的用户将会获得你这里指明的角色的能力。默认为访客角色。注意，此角色和他们所拥有的其它角色不冲突，这么做只是为了确保所有用户都可以在网站层做一些有用的事情（比如，阅读讨论区、资源等等）。';
...
$string['configdisablecourseajax'] = '当修改课程主页时不使用AJAX。';
$string['configdisableuserimages'] = '不允许用户修改个人信息中的照片项。';
...
$string['configeditordictionary'] = '当aspell的字典中不包含用户所使用的语言时，显示这个值。';
...
$string['configenablegroupings'] = '激活这个选项，可以将小组划分为组群。';
$string['configenablehtmlpurifier'] = '使用HTML Purifier代替KSES来净化不被信任的文本。HTML Purifier的开发很活跃、并且更加安全，但它也会占用更多资源。';
...
$string['configenablerssfeedsdisabled2'] = 'RSS种子已经在服务器级别被禁用。您需要首先在服务器/RSS中开启它。';
...
$string['configgeoipfile'] = 'GeoIP City二进制数据文件的位置。这个文件不是Moodle的一部分，您只能从<a href=\"http://www.maxmind.com/\">MaxMind</a>获取它。您可以购买商业版本，也可以使用免费的版本。<br />下载<a href=\"http://www.maxmind.com/download/geoip/database/GeoLiteCity.dat.gz\" >http://www.maxmind.com/download/geoip/database/GeoLiteCity.dat.gz</a>，并且将其解压到您的服务器的“{$a}”目录就可以了。';
$string['configgooglemapkey'] = '要使用Google Maps将IP地址可视化，您必须输入一个专用的密钥，您可以从<a href=\"http://code.google.com/apis/maps/signup.html\" >http://code.google.com/apis/maps/signup.html</a>获得免费的密钥。<br />您的网站URL是：{$a}';
$string['configgradebookroles'] = '此设置允许您控制谁可以出现在成绩单上。用户至少需要有课程中的一种角色才会显示在该课程的成绩单中。';
$string['configguestroleid'] = '这个角色被自动赋予访客用户。它也会被临时赋予那些进入无须访客密码的课程。请确认此角色拥有moodle/legacy:guest和moodle/course:view权限。';
...
$string['configintcachemax'] = '只对内部cache有效。在内存中保存的记录条数。建议取值：50。使用较低的值可以减少内存占用。';
...
$string['configiplookup'] = '当你点击诸如日志中的IP地址(例如34.12.222.93),你将会看到一副显示IP地址确切位置的地图。有多种插件可供选择，它们各有优缺点。';
$string['configkeeptagnamecase'] = '如果您希望标签的名称保持它原有的大小写形式，那么请选中此选项。';
...
$string['configlatinexcelexport'] = '选择输出Excel表格时使用的字符集';
...
$string['configmailnewline'] = '在邮件信息中使用的换行符。根据RFC 822bis，需要使用CRLF，有一些邮件服务器会自动将LF转换为CRLF，有一些邮件服务器会错误地将CRLF转换为CRCRLF，还有一些拒绝接收只包含LF的邮件（如qmail）。如果你碰到了无法发出邮件或者邮件内容多次换行的问题，可以试着改变这个选项。';
...
$string['configmemcachedhosts'] = '对memcached有效。以逗号分隔的运行memcached的主机名。使用IP地址可以避免DNS解析造成的延迟。在开机运行时添加/删除主机会造成memcached错误。';
$string['configmemcachedpconn'] = '对memcached有效。使用持久链接。请小心──在重启memcached守护进程时Apache/PHP会崩溃。';
$string['configmessaging'] = '是否应当开启在站点用户之间发送短消息的功能?';
$string['configminpassworddigits'] = '密码中至少包含几个数字';
$string['configminpasswordlength'] = '密码长度至少为多少';
$string['configminpasswordlower'] = '密码中至少包含多少个小写字母';
$string['configminpasswordnonalphanum'] = '密码中至少包含多少个非字母、数字的字符';
$string['configminpasswordupper'] = '密码中至少包含多少个大写字母';
$string['configmymoodleredirect'] = '如果开启，则当非管理员用户登录时，直接跳转到“我的Moodle”，并用“我的Moodle”替换掉站点首页。';
$string['confignonmetacoursesyncroleids'] = '缺省情况下，元课程的所有选课信息会和子课程同步。此处设定的角色将被从同步过程排除。';
...
$string['confignotloggedinroleid'] = '未登录的用户将被当作此角色。访客几乎始终是这里的最佳选择，但是您可能希望建立有更多或更少限制的角色。类似于发帖子这样的事情总是要求用户正确登录。';
$string['configopentogoogle'] = '如果使用该设置，Google将能够以访客的身份进入网站。通过Google搜索而来的访问者也可以以访客的身份登陆网站。这个选项仅对允许访客访问的课程有效。';
$string['configoverride'] = '在config.php中定义';
$string['configpasswordpolicy'] = '如果激活这个选项，Moodle就会根据一系列的规则检查密码的安全程度。使用下面的选项可以修改这些规则，如果将此选项设为“否”，则那些规则就不会起作用。';
...
$string['configproxypassword'] = '要访问internet代理服务器所需要的密码，如果没有请留空（需要PHP的cURL扩展模块）。';
$string['configproxyport'] = '如果此服务器需要使用代理计算机，那么在这里提供代理端口。';
$string['configproxytype'] = 'Web代理的类型（如果使用SOCKS代理，则需要PHP5的cURL扩展模块）。';
$string['configproxyuser'] = '要访问internet代理服务器所需要的用户名，如果没有请留空（需要PHP的cURL扩展模块）。';
...
$string['configrcache'] = '使用缓存来存储数据库记录。注意设定“cachetype”！';
$string['configrcachettl'] = '缓存记录存活时间。请使用一个较短的(&lt;15)的值。';
$string['configrecaptchaprivatekey'] = '您的Moodle服务器和recaptcha.net服务器之间通信所需要使用的字符串。访问 http://recaptcha.net 可获取。';
$string['configrecaptchapublickey'] = '在注册表单中显示reCAPTCHA元素所需要的字符串，由 http://recaptcha.net 生成。';
...
$string['configsmartpix'] = '开启此选项，则图标通过PHP脚本来获得，这个脚本会搜索当前的主题、然后是父主题，最后是Moodle的/pix文件夹。这样可以减少在主题间复制图标文件的麻烦，但会略微降低性能。';
$string['configsmtphosts'] = '填入一个或多个本地SMTP服务器全名(例如“mail.a.com”或“mail.a.com;mail.b.com”)，本系统将用它(们)发送邮件。如果留空不填，将使用PHP默认的方法发信。';
$string['configsmtpmaxbulk'] = '在每个SMTP会话中发送邮件的数目，将邮件分组发送可以提高发送的速度。将此选项设定为2以下的数值会强制系统每发送一封邮件都使用一个SMTP会话。';
...
$string['configusetags'] = '要开启整个站点的标签功能吗？';
$string['configvariables'] = '变量';
$string['configvisiblecourses'] = '按照通常的方式显示隐藏分类中的课程。';
$string['configwarning'] = '小心修改这些选项——不合法的值可能导致错误。';
$string['configxmlstrictheaders'] = '开启此选项，则服务器会为每个页面生成XML HTTP头信息和声明，相应的浏览器也会报告XHTML错误。这个选项对于开发者很有用。';
...
$string['creatornewroleid'] = '新课程中的创建者角色';
$string['cronclionly'] = '只以命令行方式运行cron';
$string['cronerrorclionly'] = '对不起，管理员禁止了对此页面的直接访问。';
$string['cronerrorpassword'] = '对不起，要访问此页面必须提供正确的密码。';
$string['cronremotepassword'] = '远程执行cron的密码';
$string['cronwarning'] = '<a href=\"cron.php\">cron.php维护脚本</a>已经有最少24个小时都没有运行过了。';
$string['csvdelimiter'] = 'CVS分隔符';
...
$string['defaultsettinginfo'] = '缺省: {$a}';
$string['defaultuserroleid'] = '所有用户的默认角色';
$string['defaultvalues'] = '缺省值';
$string['deleteerrors'] = '删除错误';
...
$string['disablecourseajax'] = '禁用以AJAX方式修改课程主页';
$string['disableuserimages'] = '禁用用户信息中的头像';
$string['displayloginfailures'] = '显示登陆失败信息给';
$string['docroot'] = 'Moodle Docs文档根';
$string['doctonewwindow'] = '在新窗口中打开';
$string['download'] = '下载';
$string['editennotallowed'] = '在此页面不能修改en_utf8语言──切换到local';
$string['edithelpdocs'] = '编辑帮助文档';
$string['editlang'] = '<br>修改</b>';
$string['editorbackgroundcolor'] = '背景颜色';
$string['editordictionary'] = '编辑器字典';
...
$string['editorspelling'] = '编辑器拼写';
$string['editorspellinghelp'] = '开启或关闭拼写检查功能。如果开启，服务器上必须安装<strong>aspell</strong>。';
$string['editstrings'] = '编辑字符串';
$string['emoticons'] = '表情';
$string['emptysettingvalue'] = '空的';
$string['enableajax'] = '激活AJAX';
$string['enablecourserequests'] = '可以课程申请';
$string['enableglobalsearch'] = '允许全局搜索';
$string['enablegroupings'] = '允许使用组群';
$string['enablehtmlpurifier'] = '使用HTML Purifier';
$string['enablerecordcache'] = '允许数据库缓存';
...
$string['filestoredin'] = '保存文件到文件夹：';
$string['filestoredinhelp'] = '文件保存的位置';
...
$string['filtersettingsgeneral'] = '常规的过滤器设置';
...
$string['googlemapkey'] = 'Google Maps API密钥';
$string['gotofirst'] = '跳转到第一个缺失的字符串';
$string['gradebook'] = '成绩单';
$string['gradebookroles'] = '有成绩的角色';
$string['gradeexport'] = '主要的成绩导出方式';
...
$string['hidefromall'] = '对所有用户隐藏';
$string['hidefromnone'] = '不对任何人隐藏';
...
$string['langlocalpackage'] = '本丢修改';
$string['langmasterenglish'] = '主英文包';
$string['langmasterpackage'] = '主语言包';
$string['langmenu'] = '显示语言菜单';
$string['langnoeditenglish'] = '无法覆盖基本的英文语言包。请切换语言目录以保存本地修改。';
$string['langpackinstalled'] = '语言包{$a}已成功安装';
$string['langpackmaintaining'] = '语言包维护';
...
$string['langpackwillbeupdated'] = '翻译们注意：在升级过程中，Moodle会尝试升级您的语言包。在非本地语言包中的数据都会被覆盖。';
$string['langrmyourself'] = '为防止数据丢失，lang.php不能覆盖已经存在的空文件。请先手工删除它。';
$string['languagesettings'] = '语言设置';
$string['langupdatecomplete'] = '语言包更新成功';
$string['latexpreamble'] = 'LaTeX前缀';
$string['latexsettings'] = 'LaTeX渲染器配置';
$string['latinexcelexport'] = 'Excel字符集';
$string['localetext'] = '全站的地区设置';
$string['localstringcustomization'] = '定制本地字符串';
$string['location'] = '位置';
$string['locationsettings'] = '位置设置';
$string['log'] = '日志';
$string['loginhttps'] = '使用HTTPS登录';
$string['loglifetime'] = '保留日志为';
$string['longtimenosee'] = '将用户从课程除名的期限为';
$string['longtimewarning'] = '<b>注意此过程会占用很长时间。</b>';
$string['mail'] = '邮件';
...
$string['memcachedhosts'] = 'memcached主机';
$string['memcachedpconn'] = 'memcached使用持久连接';
$string['messaging'] = '激活信息发送系统';
$string['minpassworddigits'] = '数字';
$string['minpasswordlength'] = '密码长度';
$string['minpasswordlower'] = '小写字母';
$string['minpasswordnonalphanum'] = '其它字符';
$string['minpasswordupper'] = '大写字母';
$string['misc'] = '五花八门';
$string['missinglangparent'] = '<em>$a->lang</em>的父语言<em>$a->parent</em>丢失。';
$string['mnetrestore_extusers'] = '<strong>注意：</strong>这个备份文件包含远程Moodle网络用户账号，在恢复时也会一同恢复。';
$string['mnetrestore_extusers_mismatch'] = '<strong>注意：</strong>这个备份文件看来是在另外一个Moodle上制作的，并包含了远程Moodle网络用户账号，这会导致恢复操作失败。此操作不被支持，如果您确信它是在这个Moodle上制作的，或者您确信所有的Moodle网络主机都以配置，您可以尝试着执行恢复操作。';
$string['modsettings'] = '管理活动';
$string['modulesecurity'] = '模块安全';
$string['multilangforceold'] = '强制使用老的multilang语法&lt;span&gt;，而不使用class=\"multilang\"和&lt;lang&gt;';
$string['multilangupgrade'] = 'Multilang升级';
$string['multilangupgradeinfo'] = '在1.8中，multilang过滤器的语法已经修改了，&lt;lang&gt;标签不再被支持。<br /><br />例如：&lt;span lang=\"en\" class=\"multilang\"&gt;Hello!&lt;/span&gt;&lt;span lang=\"es\"class=\"multilang\"&gt;Hola!&lt;/span&gt;<br /><br /><strong>您要将已有的文本升级为心的语法吗？</strong>';
$string['multilangupgradenotice'] = '您的网站正使用着老的multilang语法，建议您<a href=\"multilangupgrade.php\">升级</a>它。';
...
$string['numberofmissingstrings'] = '缺失的字符串：{$a}';
...
$string['pleaserefreshregistration'] = '您的站点已经在 moodle.org 注册，如果在您上次注册之后有重大更新，请您更新注册信息。';
$string['pleaseregister'] = '要删除此按钮，请注册您的站点。';
$string['plugins'] = '插件';
$string['profilecategory'] = '分类';
$string['profilecategoryname'] = '分类命令(必须是独特的)';
$string['profilecategorynamenotunique'] = '此分类名称已在使用中';
$string['profilecommonsettings'] = '常见设置';
$string['profileconfirmcategorydeletion'] = '有{$a}个字段将会被移动到上面的（或下面的）分类中。<br />您确信要删除此分类么？';
$string['profileconfirmfielddeletion'] = '有{$a}个与此字段相关的信息会被删除。<br />您确信要删除这个字段么？';
$string['profilecreatecategory'] = '创建新的个人信息分类';
$string['profilecreatefield'] = '创建新的个人信息字段';
$string['profilecreatenewcategory'] = '创建新分类';
$string['profilecreatenewfield'] = '创建新的“{$a}”个人信息字段';
$string['profiledefaultcategory'] = '其它字段';
$string['profiledefaultdata'] = '缺省值';
$string['profiledeletecategory'] = '删除分类';
$string['profiledeletefield'] = '删除一个字段';
$string['profiledescription'] = '字段描述';
$string['profileeditcategory'] = '修改分类：{$a}';
$string['profileeditfield'] = '修改个人信息字段：{$a}';
$string['profilefield'] = '个人信息字段';
$string['profilefieldcolumns'] = '列';
$string['profilefieldispassword'] = '这是密码字段吗？';
$string['profilefieldmaxlength'] = '最大长度';
$string['profilefieldrows'] = '行';
$string['profilefields'] = '用户信息字段';
$string['profilefieldsize'] = '显示尺寸';
$string['profilefieldtypemenu'] = '选择项';
$string['profilefieldtypetext'] = '输入项';
$string['profilefieldtypetextarea'] = '文本域';
$string['profileforceunique'] = '此数据是唯一的？';
$string['profileinvaliddata'] = '无效值';
$string['profilelocked'] = '锁定字段么？';
$string['profilemenudefaultnotinoptions'] = '缺省值并不在选项列表中';
$string['profilemenunooptions'] = '没有提供菜单项';
$string['profilemenuoptions'] = '菜单项(每行一个)';
$string['profilemenutoofewoptions'] = '您必须至少提供两项';
$string['profilename'] = '名称';
$string['profilenofieldsdefined'] = '未定义任何字段';
$string['profilerequired'] = '此字段是必须的吗';
$string['profileshortname'] = '简称';
$string['profileshortnamenotunique'] = '此简称已被使用';
$string['profilesignup'] = '在注册页面显示？';
$string['profilespecificsettings'] = '特别的选项';
$string['profilevisible'] = '此字段对谁可见';
$string['profilevisibleall'] = '对所有人';
$string['profilevisiblenone'] = '不可见';
$string['profilevisibleprivate'] = '对用户';
...
$string['question'] = '问题';
$string['questioncwqpfsok'] = '很好。在您的测验中没有同时从共享和非共享问题中随机抽取问题的题目。';
$string['rcache'] = '记录缓存';
$string['rcachettl'] = '记录缓存生存期';
$string['recaptchaprivatekey'] = 'ReCAPTCHA私钥';
$string['recaptchapublickey'] = 'ReCAPTCHA公钥';
...
$string['requiredtemplate'] = '必需的。您可以使用模板语法，如 %%l = lastname、%%f = firstname、%%u = username。在帮助文件中可以找到更详细的信息和例子。';
...
$string['tokenizerrecommended'] = '建议您安装PHP Tokenizer扩展──它可以增强Moodle网络功能。';
$string['unattendedoperation'] = '未被注意的操作';
...
$string['uploadpicture_baduserfield'] = '指定的用户属性不合法。请重试。';
$string['uploadpicture_cannotmovezip'] = '无法将zip文件移动到临时目录中。';
$string['uploadpicture_cannotprocessdir'] = '无法处理未打包(unzipped)的文件。';
$string['uploadpicture_cannotsave'] = '无法为用户{$a}保存图片，请检查原有的图片文件';
$string['uploadpicture_cannotunzip'] = '无法解压(unzip)图片文件。';
$string['uploadpicture_invalidfilename'] = '图片文件{$a}的文件名无效。跳过。';
$string['uploadpicture_overwrite'] = '覆盖已有的用户图片？';
$string['uploadpicture_usernotfound'] = '“{$a->userfield}“为“{$a->uservalue}”的用户不存在。跳过。';
$string['uploadpicture_userskipped'] = '跳过用户{$a}（他已经有头像了）。';
$string['uploadpicture_userupdated'] = '用户{$a}的头像已更新。';
$string['uploadpictures'] = '上传用户头像';
$string['uploaduserspreview'] = '上传用户预览';
$string['uploadusersresult'] = '上传用户结果';
$string['upwards'] = '向上';
$string['usehtmleditor'] = '使用HTML编辑器';
$string['useraccountupdated'] = '已更新用户数据';
$string['userbulk'] = '批量用户操作';
$string['userdeleted'] = '用户已删除';
$string['userlist'] = '浏览用户列表';
$string['userpolicies'] = '用户策略';
$string['userrenamed'] = '已修改用户名';
$string['users'] = '用户';
$string['userscreated'] = '已创建用户';
$string['usersdeleted'] = '已删除用户';
$string['usersrenamed'] = '已修改用户名';
$string['usersskipped'] = '已跳过用户';
$string['usersupdated'] = '已更新用户信息';
$string['usetags'] = '激活标签功能';
$string['uubulk'] = '为批量操作选择';
$string['uubulkall'] = '全部用户';
$string['uubulknew'] = '新用户';
$string['uubulkupdated'] = '更新用户';
$string['uucoursedefaultrole'] = '缺省课程角色';
$string['uunoemailduplicates'] = '防止电子邮件地址重复';
$string['uuoptype'] = '上传类型';
$string['uupasswordnew'] = '新的用户密码';
$string['uupasswordold'] = '已有的用户密码';
$string['uupreprocessedcount'] = '预处理的记录数：{$a}';
$string['uuupdateall'] = '已文件和缺省值覆盖';
$string['uuupdatefromfile'] = '已文件覆盖';
$string['validateerror'] = '此值无效：';
$string['warningcurrentsetting'] = '当前的值不合法：{$a}';
$string['webproxy'] = 'Web代理';
$string['webproxyinfo'] = '如果您的Moodle服务器不能直接访问因特网，请填写以下信息。在下载环境数据、语言包、RSS种子和时区信息等操作时需要访问因特网。<em>强烈建议您安装PHP的cURL扩展模块。</em>';
