...
$string['autologinguests'] = '自动登陆为访客';
...
$string['configenableajax'] = '此项设置允许您控制整个网站内AJAX(advanced client/server interfaces using Javascript)的使用。i此设置被允许后，用户仍可以在个人资料中进行选择，否则AJAX对每个人都是不可使用的。';
$string['configenablecourserequests'] = '开启这个选项，允许任何人申请创建新的课程。';
$string['configenableglobalsearch'] = '此设置使得可以在资源和活动中搜索全局文本，但是它不和PHP4兼容。';
$string['configenablerecordcache'] = '如果您使此项有效，那么在检索数据库信息期间会在内存进行缓存。这意味着您的数据库吞吐率将会更好，但是另一方面，您web服务器内存的要求将有少量增加。通常我们建议此项有效，除非您的服务器内存配置较低。当开发者确信能提升性能的时候，可能会在做一些处理时无视此选项。';
...
$string['configfrontpageloggedin'] = '当用户登陆后，选择的项将显示在网站的首页上。';
...
$string['defaultallowedmodules'] = '默认允许的模块';
...
$string['displayloginfailures'] = '显示登陆失败给';
...
$string['frontpage'] = '首页';
$string['frontpageloggedin'] = '登陆后的首页项';
...
$string['loglifetime'] = '保留日志';
$string['longtimenosee'] = '长时间未登录的用户';
$string['mail'] = '邮件';
...
$string['notifyloginfailures'] = '登陆失败发送到';
...
$string['restrictmodulesfor'] = '限制模块用于';
