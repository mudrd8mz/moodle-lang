...
$string['configenablerecordcache'] = '开启这个选项，那么在检索数据库信息期间会在内存进行缓存。这意味着您的数据库吞吐率将会更好，但是另一方面，您web服务器内存的要求将有少量增加。通常我们建议此项有效，除非您的服务器内存配置较低。当开发者确信能提升性能的时候，可能会在做一些处理时无视此选项。';
