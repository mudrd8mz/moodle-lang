...
$string['choosefiletoedit'] = '从上面选择文件编辑';
...
$string['filestoredinhelp'] = '将文件保存在';
...
$string['authsettings'] = '管理验证方式';
$string['autolang'] = '语言自动探测';
...
$string['configautolang'] = '如果禁用站点默认方式，系统将从浏览器设置中检测到默认语言。';
...
$string['configdisablecourseajax'] = '当编辑课程主页的时候不使用AJAX。';
$string['configdisableuserimages'] = '禁用用户修改个人照片。';
$string['configemoticons'] = '更改左边的代码，这些代码与右边表情名称相关。要添加新的表情，添加一行代码和一个名字（name），然后在 /pix/s目录中添加表情图片name.gif';
$string['configenablegroupings'] = '该设置启用组的分组功能。';
...
$string['configminpasswordupper'] = '密码至少要包含多少个大些字母。';
...
$string['hidefromall'] = '因此所有用户';
$string['hidefromnone'] = '因此没有任何人';
$string['hidefromstudents'] = '因此学生';
...
$string['langmasterenglish'] = '主要的英语包';
$string['langmasterpackage'] = '主要的语言包';
$string['langnoeditenglish'] = '不能覆盖基本的英语包，请切换语言目录到修改。';
...
$string['localstringcustomization'] = '本地字符串定制';
$string['mailnewline'] = 'mail中的换行符';
$string['minpassworddigits'] = '数字数目';
$string['minpasswordlength'] = '密码长度';
$string['minpasswordlower'] = '小写字母数';
$string['minpasswordnonalphanum'] = '非字母、数字的字符数';
$string['minpasswordupper'] = '大写字母数';
...
$string['uploadpicture_baduserfield'] = '制定的用户属性不可用，请再试一次。';
$string['uploadpicture_cannotmovezip'] = '不能删除zip文件至临时目录。';
$string['uploadpicture_cannotprocessdir'] = '不能解压文件。';
$string['uploadpicture_cannotsave'] = '不能保存用户{$a}的图片，请检查最初的图片文件。';
$string['uploadpicture_cannotunzip'] = '不能解压图片文件。';
$string['uploadpicture_invalidfilename'] = '图片文件{$a}名中包含不可用的字符，跳过。';
$string['uploadpicture_overwrite'] = '覆盖已经存在的用户图片吗？';
...
$string['uploadpicture_userupdated'] = '用户{$a}的图片已更新。';
$string['uploadpictures'] = '上传用户图片';
$string['uploaduserspreview'] = '上传用户预览';
$string['uploadusersresult'] = '上传用户结果';
$string['userbulk'] = '执行批量用户操作';
...
$string['webproxyinfo'] = '如果您的Moodle服务器不能通过Internet直接访问，填写下面的选项。对于数据文件、语言包、RSS种子、时区等的下载，Internet 访问是必须的。.<br /><em>推荐安装PHP cURL扩展</em>。';
