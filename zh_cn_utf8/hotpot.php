...
$string['abandoned'] = '放弃';
$string['addquizchain'] = '添加一系列测试';
$string['allusers'] = '全部的用户们';
...
$string['average'] = '平均';
$string['checks'] = '检查';
$string['clickreporting'] = '可以点击报告';
$string['clues'] = '提示';
$string['completed'] = '完成';
$string['configexcelencodings'] = '编码列表以逗号分割开，可以被强制转换成用于电子数据表程序用的特殊编码。比如Microsoft Excel需要\"SJIS\"为日语编码';
$string['configshowtimes'] = '程序报告占用的时间是否应该放在列表和报告中呢？这对你试图找出为什么服务器运行速度变慢是非常必要的。';
...
$string['giveup'] = '放弃';
$string['hints'] = '提示';
$string['hotpot:attempt'] = '尝试测试';
$string['hotpot:deleteattempt'] = '删除测试尝试';
$string['hotpot:grade'] = '修改成绩';
$string['hotpot:view'] = '使用测试';
$string['hotpot:viewreport'] = '浏览报告';
$string['hotpotcloses'] = '关闭随堂测试';
$string['hotpotopens'] = '打开随堂测试';
$string['ignored'] = '忽略';
...
$string['reportbutton'] = '生成报告';
$string['reportchanges'] = '更改';
$string['reportchecks'] = '阻止';
$string['reportclick'] = '点击痕迹报告';
