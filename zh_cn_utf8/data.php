<?PHP // $Id$ 
      // data.php - created with Moodle 1.6 Beta 4 (2006042800)


$string['action'] = '动作';
$string['add'] = '增加条目';
$string['addafield'] = '增加一个字段';
$string['addcomment'] = '增加评论';
$string['addtemplate'] = '增加模板';
$string['allowcomments'] = '允许评论';
$string['allowratings'] = '允许评级？';
$string['approve'] = '核准';
$string['ascending'] = '升序';
$string['atmaxentry'] = '此数据库条目数已经到达限制。';
...
$string['configenablerssfeeds'] = '这项变更可能会激活所有的数据库的RSS种子。您仍需要手动设置每个数据库。';
$string['confirmdeletefield'] = '您要删除这个字段，确定吗？';
$string['confirmdeleterecord'] = '您确定要删除这条记录？';
$string['csstemplate'] = 'CSS 模板';
$string['csvfile'] = 'CVS 文件';
$string['csvimport'] = 'CVS 文件导入';
$string['date'] = '日期';
$string['dateentered'] = '日期已输入';
$string['defaultfielddelimiter'] = '(缺省为逗号\",\")';
$string['defaultfieldenclosure'] = '缺省没有';
$string['defaultsortfield'] = '删除';
$string['delete'] = '删除';
...
$string['emptyadd'] = '模板为空，生成缺省模板...';
$string['emptyaddform'] = '您未填写任何字段';
$string['entries'] = '条目';
$string['entrysaved'] = '您的项目已保存';
...
$string['requiredentries'] = '需要记录';
$string['requiredentriestoview'] = '查看前需要记录';
