...
$string['export'] = '输出';
$string['exportaszip'] = '以zip格式输出';
$string['exportedtozip'] = '输出到临时的zip文件...';
...
$string['file'] = '文件';
$string['filesnotgenerated'] = '文件{$a}产生失败';
...
$string['jstemplate'] = 'Javascript模板';
$string['latitude'] = '纬度';
$string['latlong'] = '纬度／经度';
$string['latlongdownloadallhint'] = '把所有的条目链接下载为KML文件';
$string['latlongkmllabelling'] = '怎样在KML文件中标出内容（Google Earth）';
$string['latlonglinkservicesdisplayed'] = '要显示的Link-out服务';
...
$string['movezipfailed'] = '移动zip文件失败';
...
$string['type'] = '字段类型';
$string['undefinedprocessactionmethod'] = '在Data_Preset中处理行为\"{$a}\"没有定义';
...
$string['deletenotenrolled'] = '按没有选课的用户删除条目';
$string['entrieslefttoadd'] = '在查看其他参与者的条目前，您必须添加{$a}条目';
