<?PHP // $Id$ 
      // error.php - created with Moodle 1.9.5 (Build: 20090520) (2007101550)
...
$string['invalidadminsettingname'] = '无效的管($a)';
$string['invalidcontext'] = '无效的关联';
$string['invalidcourse'] = '无效课程';
$string['invalidcourseid'] = '课程 ID ($a) 无效';
...
$string['nostatstodisplay'] = '没有可显示的内容';
...
$string['pluginrequirementsnotmet'] = '插件“{$a->pluginname}”($a->pluginversion) 不能安装。需要新版本的 Mooodle（一般您用 {$a->currentmoodle} 的时候您需要 {$a->requiremoodle}）';
