<?PHP // $Id$ 
      // qtype_calculated.php - created with Moodle 1.9.5 (Build: 20090520) (2007101550)
...
$string['trueanswerinsidelimits'] = '正确的回答：';
$string['trueansweroutsidelimits'] = '<span class=\"error\">错误：{$a->correct} 在 {$a->true} 的限定之外。</span>';
