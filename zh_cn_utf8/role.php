...
$string['deletecourseoverrides'] = '在课程中删除所有角色覆盖';
$string['deletelocalroles'] = '删除所有本模块委派的角色';
...
$string['morethan'] = '更多{$a}';
$string['multipleroles'] = '多角色';
$string['notes:manage'] = '管理评语';
$string['notes:view'] = '查看评语';
$string['overridepermissions'] = '覆盖许可';
$string['overridepermissionsin'] = '在{$a}中覆盖许可';
...
$string['site:langeditlocal'] = '自定义本地翻译';
