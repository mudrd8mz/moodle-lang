...
$string['couldnotdeleteratings'] = '很抱歉，已经被评分的贴子不能删除';
$string['couldnotdeletereplies'] = '很抱歉，已经有跟贴的贴子不能删除';
...
$string['maxtimehaspassed'] = '很抱歉，编辑该贴的时间限制({$a})已过！';
$string['message'] = '正文';
...
$string['noguestpost'] = '很抱歉，访客不允许发贴';
...
$string['noviewdiscussionspermission'] = '你无权查看这个讨论区的话题';
