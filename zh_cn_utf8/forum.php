...
$string['noguestsubscribe'] = '很抱歉，系统不允许访客用email订阅讨论区的帖子。';
...
$string['nopostforum'] = '很抱歉，您不能在此论坛发帖子'; // ORPHANED

	  //翻译者：况亮
	  //Email：kuangliang12345@163.com
	  //Moodle 1.9 2008/04

$string['aggregateavg'] = '平均法';
$string['aggregatecount'] = '计数法';
$string['aggregatemax'] = '最大法';
$string['aggregatemin'] = '最小法';
$string['aggregatenone'] = '不计成绩';
$string['aggregatesum'] = '总和法';
$string['aggregatetype'] = '成绩汇总类型';
$string['cleanreadtime'] = '在旧帖中标记阅读时间';
$string['configlogblocked'] = '讨论区cron可能记录下拦截到的无效的用户email信息。';
$string['displaymode'] = '显示模式';
$string['lastpost'] = '最后的帖子';
$string['logblocked'] = '在日志中记录拦截的email';
$string['longpost'] = '长帖';
$string['manydiscussions'] = '每页讨论的话题数';
$string['oldpostdays'] = '多少天后可以阅读';
$string['replytouser'] = '使用email地址回复';
