...
$string['course'] = '课程';
$string['courseapprovedemail'] = '您申请的课程 {$a->name} 已经嗯被批准了，您现在已经是该课程的 {$a->teacher}。要访问您的新课程，请点击 {$a->url}。';
...
$string['passwordforgotteninstructions'] = '您的详细数据必须首先在用户数据库中找到。请在合适的方框输入您的moodle用户名和您注册的邮件地址中的<strong>任一个</strong>。没有必要都输入。';
$string['passwordnohelp'] = '无法获得帮助找到您丢失的密码。请联系您的moodle管理员';
...
$string['recentactivityreport'] = '最近的活动的完整报表...';
...
$string['resetinfo'] = '此页面允许您清空课程的用户数据并保留活动和其他设置。请对选择下面项并提交来自您所删除选择此课程的用户数据时，永远发出警告。';
...
$string['sizemb'] = 'MB';
$string['skipped'] = '跳过';
$string['skiptomaincontent'] = '跳转到主目录';
...
$string['writinggroupingsinfo'] = '写入分组信息';
...
$string['creatinggroupingsgroups'] = '在分组中创建组';
...
$string['helpinterestslist'] = '熟人您的兴趣（用半角英文逗号分隔）。';
...
$string['reload'] = '重新载入';
$string['remotemaharauser'] = '远程Mahara用户';
$string['resetcomponent'] = '组件';
$string['resetnotimplemented'] = '重置未执行的';
...
$string['used'] = '已使用';
$string['writinggroupingsgroupsinfo'] = '写入分组--组信息';
