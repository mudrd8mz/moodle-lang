...
$string['adminhelpassignadmins'] = '网站管理员可以做任何操作，而且可以访问站点内的任何地方';
$string['adminhelpassigncreators'] = '课程管理员可以创建多个新课程，并且教授这些课程';
$string['adminhelpassignsiteroles'] = '采用定义的网站角色来说明用户';
$string['adminhelpassignstudents'] = '进入一门课程，然后从网站管理员菜单中添加学生';
$string['adminhelpassignteachers'] = '利用图标给找到的课程添加教师';
$string['adminhelpauthentication'] = '可以使用内部网络帐户或者外部数据库';
$string['adminhelpbackup'] = '设定自动备份和备份的进度表';
$string['adminhelpconfiguration'] = '设定网站外观及工作参数';
$string['adminhelpconfigvariables'] = '设定影响网站通用操作的变量';
$string['adminhelpcourses'] = '定义课程及类别，并且为课程指派用户，编辑即将开始的课程';
$string['adminhelpeditorsettings'] = '为HTML编辑器设定基本属性';
$string['adminhelpedituser'] = '浏览用户帐号列表，并且编辑任意帐号';
...
$string['adminhelpmanageroles'] = '创建和定义可能用于用户的角色';
$string['adminhelpmymoodle'] = '为用户的“我的moodle”配置版块';
$string['adminhelpreports'] = '站点级报告';
$string['adminhelpsitefiles'] = '发布通用文件或者上传外部备份';
...
$string['adminhelpxmldbeditor'] = '只面向开发者的，编辑XMLDB文件的界面';
$string['administration'] = '管理';
$string['administrationsite'] = '网站管理';
$string['administrator'] = '管理员';
$string['administratordescription'] = '管理员通常可以在网站的所有课程中做任何事情';
$string['administrators'] = '管理员们';
$string['administratorsall'] = '全部管理员们';
$string['administratorsandteachers'] = '管理员们和教师们';
...
$string['alldays'] = '所有天数';
$string['allfieldsrequired'] = '所有必须的字段';
...
$string['areyousuretorestorethisinfo'] = '在此过程的稍后时候，您要选择把此备份添加到一门现有课程中，还是创建一门新课程。';
$string['assessment'] = '评价';
$string['assignadmins'] = '分配管理';
$string['assigncreators'] = '任命课程管理员';
$string['assignsiteroles'] = '指派网站范围的角色';
$string['assignstudents'] = '选课的学生们';
$string['assignstudentsnote'] = '注意：因为学生们可以自行选择此课程，所以可能不需要使用此页。';
$string['assignstudentspass'] = '您可能只需要通知学生此课程的选课密钥，当前设置为：“{$a}”';
...
$string['backupcancelled'] = '取消备份';
$string['backupcoursefileshelp'] = '如果能使用，那么课程文件将会被包含在自动备份中';
$string['backupdate'] = '备份日期';
$string['backupdatenew'] = '$a->TAG 现在是$a->weekday, $a->mday $a->month $a->year<br />';
$string['backupdateold'] = '$a->TAG 曾是$a->weekday, $a->mday $a->month $a->year';
...
$string['backupkeephelp'] = '您想要为每门课程保存多少最近的备份? (将会自动删除比较旧的备份)';
$string['backuplogdetailed'] = '详细的运行日志';
$string['backuploglaststatus'] = '最后的运行日志';
$string['backuplogshelp'] = '如果能使用，那么将会把课程日志包含在自动备份中';
$string['backupmetacoursehelp'] = '如果能使用，那么将会把(从选课数据继承的)元课程信息包含在自动备份中';
$string['backupnameformat'] = '%%Y%%m%%d-%%H%%M';
$string['backupnoneusersinfo'] = '注意: 您已选择了“不”备份用户，因此所有模块的备份都切换成“没有用户数据”的模式。请注意“练习”模块和“工作室”模块与此种备份不兼容，所以已经使它们完全不活动。';
$string['backupnonisowarning'] = '警告：此备份来自Moodle的非统一字符编码编准的版本（1.6版以前）。如果此备份包含任何非ISO-8859-1文本，那么当试图把此备份恢复成Moodle的非统一字符编码编准版本时，他们可能被破坏。请参考<a href=\"http://docs.moodle.org/en/Backup_FAQ\">Backup FAQ</a>中的Backup FAQ获取更多关于正确恢复备份的方法。';
$string['backuporiginalname'] = '备份名称';
$string['backupsavetohelp'] = '存放备份文件的位置的完整路径<br />(不填则保存在课程的默认目录中)';
$string['backupschedulehelp'] = '选择执行自动备份的星期号';
$string['backuptakealook'] = '请看一下如下目录中的备份日志: 
$a';
$string['backupuserfileshelp'] = '选择自动备份中是否包含用户文件(如用户图片)';
$string['backupusershelp'] = '选择希望包含的是服务器中的所有用户，还是只是每门课程需要的用户们';
...
$string['coursecategories'] = '课程类别们';
$string['coursecategory'] = '课程类别';
$string['coursecreators'] = '课程创建者';
$string['coursecreatorsdescription'] = '课程创建者可以创建新课程，并且可以教授这些新课程。';
...
$string['courses'] = '课程们';
$string['coursescategory'] = '同一类别的课程们';
...
$string['creatingmodroles'] = '创建模组层角色分配和替换';
...
$string['creatinguserroles'] = '创建用户层角色分配和替换';
...
如有疑问，请联系您的教师。';
$string['expirythreshold'] = '下限';
$string['explanation'] = '解释';
$string['extendenrol'] = '扩充人数';
$string['extendperiod'] = '已延长学时';
...
$string['frontpagedescriptionhelp'] = '此网站的描述将以首页的形式显示出来。';
...
$string['guest'] = '访客';
$string['guestdescription'] = '访客们拥有最小的权限，而且通常不能在任意地方录入文本。';
...
$string['hiddensections'] = '隐藏的主题';
$string['hiddensectionscollapsed'] = '以折叠方式显示隐藏的主题';
$string['hiddensectionsinvisible'] = '完全不显示隐藏的主题';
$string['hide'] = '隐藏';
...
$string['location'] = '来自';
$string['log_excel_date_format'] = 'XXXX年 XX月 XX日 小时：分钟';
...
$string['newusernewpasswordtext'] = '在“{$a->sitename}”上已经为你创建一个新帐户，新的临时密码已经发给你。';
$string['newusers'] = '新用户';
$string['next'] = '向后';
$string['no'] = '否';
$string['nobody'] = '没人';
...
$string['participationreport'] = '参与报告';
$string['password'] = '密码';
$string['passwordchanged'] = '密码已被更改';
$string['passwordconfirmchange'] = '确认密码更改';
$string['passwordextlink'] = '下面的链接提供恢复你忘记的密码。你将会退出Moodle.';
$string['passwordforgotten'] = '忘记了密码';
$string['passwordforgotteninstructions'] = '你的详细数据必须首先在用户数据库中找到。请在合适的方框输入你的moodle用户名和你注册的邮件地址中的<strong>任一个</strong>。没有必要都输入。';
$string['passwordnohelp'] = '无法获得帮助找到你丢失的密码。请联系你的moodle管理员';
...
$string['resetinfo'] = '此页面允许你清空课程的用户数据并保留活动和其他设置。请对选择下面项并提交来自你所删除选择此课程的用户数据时，永远发出警告。';
$string['resetstartdate'] = '重置开始日期';
$string['resettodefaults'] = '重置为缺省';
$string['resortcoursesbyname'] = '按名称对课程重新排序';
$string['resource'] = '资源';
$string['resources'] = '资源组';
$string['restore'] = '恢复';
...
$string['sitepartlist'] = '你没有获得许可来查看参与者列表';
...
$string['statsreads'] = '视图';
$string['statsreport1'] = '登陆';
$string['statsreport10'] = '活动用户';
$string['statsreport11'] = '最活跃的课程';
$string['statsreport12'] = '最活跃的课程（加权）';
$string['statsreport13'] = '最好的共享课程（选课）';
$string['statsreport14'] = '最好的共享课程（视图/摘要）';
$string['statsreport2'] = '视图（全部角色）';
$string['statsreport3'] = '摘要（全部角色）';
$string['statsreport4'] = '所有活动（全部角色）';
$string['statsreport5'] = '所有学生活动（视图和摘要）';
$string['statsreport7'] = '用户活动（视图和摘要）';
$string['statsreport8'] = '所有用户活动';
$string['statsreport9'] = '登陆（定位课程）';
$string['statsreportactivity'] = '所有活动（全部角色们）';
...
$string['statsuserreads'] = '视图';
$string['statsuserwrites'] = '摘要';
$string['statswrites'] = '摘要';
$string['status'] = '状态';
...
$string['switchrolereturn'] = '返回到我通常的角色中';
$string['switchroleto'] = '角色交换到。。。';
$string['tag'] = '标签';
