...
$string['activityweighted'] = '每个用户的活动报告';
$string['add'] = '添加';
...
$string['addedrecips'] = '已添加{$a}新的收件人';
...
$string['addnousersrecip'] = '添加还没有进入这个{$a}的用户到接受者名单';
...
$string['backupnonisowarning'] = '警告：此备份来自未编码的Moodle版本（pre 1.6）。如果此备份包含任何 non-ISO-8859-1文本，当你试着恢复此备份到此编码的Moodle版本时，他们可能被改动。';
...
$string['currentlyselectedusers'] = '但前已选用户';
...
$string['invalidfilename'] = '(无效文件名)';
$string['invalidlogin'] = '登录无效，请重试';
$string['ip_address'] = 'IP地址';
$string['jump'] = '跳';
$string['jumpto'] = '跳至...';
$string['keep'] = '保持';
$string['keepsearching'] = '保持搜索';
...
$string['selectnos'] = '选择所有\"NO\"';
$string['selectperiod'] = '选择学时';
...
$string['statsreport2'] = '视图（老师和学生）';
$string['statsreport3'] = '摘要';
$string['statsreport4'] = '所有活动（老师和学生）';
$string['statsreport5'] = '所有学生活动（视图和摘要）';
$string['statsreport6'] = '所有老师活动（视图和摘要）';
$string['statsreport7'] = '用户活动（视图和摘要）';
$string['statsreport8'] = '所有用户活动';
$string['statsreport9'] = '登陆（定位课程）';
$string['statsreportactivity'] = '所有活动（老师和学生）';
$string['statsreportforuser'] = '为';
$string['statsreportlogins'] = '登陆';
$string['statsreportreads'] = '视图（老师和学生）';
$string['statsreportstudentactivity'] = '所有学生活动（视图和摘要）';
$string['statsreportteacheractivity'] = '所有老师活动（视图和摘要）';
...
$string['usecharset'] = '使用字符集';
$string['usedinnplaces'] = '在{$a}处使用';
$string['usemessageform'] = '或者选择下面的步骤给选择用户发送消息';
$string['useothercharset'] = '使用其它字符集';
$string['user'] = '用户';
