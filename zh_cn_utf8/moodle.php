...
$string['defaultcourseteacherdescription'] = '教师可以在负责的课程中做任何事，包括改变活动和给学生打分。';
...
$string['guest'] = '访客';
$string['guestdescription'] = '访客拥有最小的权限，而且通常不能在任意地方录入文本。';
...
$string['newsitemsnumber'] = '显示新闻条目数';
$string['newuser'] = '新用户';
...
$string['switchrolereturn'] = '切换回我通常的角色';
$string['switchroleto'] = '角色切换到...';
$string['tag'] = '标签';
