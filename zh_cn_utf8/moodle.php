...
$string['adminhelpassigncreators'] = '课程管理员可以创建多个新课程，并且执教它们';
...
$string['administratordescription'] = '管理员可以对站点内的所有课程执行任何操作。';
...
$string['authenticateduser'] = '认证用户';
$string['authenticateduserdescription'] = '所有登录的用户';
$string['authentication'] = '身份认证';
$string['authenticationplugins'] = '认证插件';
...
$string['choose'] = '选择';
$string['chooseauthmethod'] = '选择认证插件';
...
$string['coursecreatorsdescription'] = '课程创建者可以创建新课程，并且可以任教。';
...
$string['courseoverviewgraph'] = '课程概览图';
...
不幸的是此站点的密码无法重设，请联系站点管理员 “{$a->admin}”。';
$string['emailpasswordchangeinfosubject'] = '{$a}：修改密码信息';
...
$string['forgottenduplicate'] = '此电子邮件地址被多个账号使用了，请输入用户名。';
...
$string['previous'] = '向前';
$string['previoussection'] = '前一节';
$string['primaryadminsetup'] = '设定管理员账号';
$string['profile'] = '信息概要';
...
$string['publicdirectorytitle'] = '查看当前的站点列表';
...
$string['secretalreadyused'] = '修改密码的链接已经用过了，没有修改密码。';
$string['secs'] = '秒';
$string['section'] = '文章';
$string['sections'] = '文章';
...
$string['showblockcourse'] = '显示包含版块的课程';
$string['showgrades'] = '显示成绩';
$string['showlistofcourses'] = '显示课程列表';
$string['showmodulecourse'] = '显示包含活动的课程';
$string['showonly'] = '只显示';
...
$string['sitepartlist'] = '你无权查看参加者名单';
$string['sitepartlist0'] = '只允许本站教师查看到站点参与者名单';
$string['sitepartlist1'] = '之允许教师查看站点参与者名单';
$string['sites'] = '站点';
...
$string['statsuserwrites'] = '帖子';
$string['statswrites'] = '帖子';
$string['status'] = '状态';
...
$string['writinggroupingsinfo'] = '写入群信息';
...
$string['youneedtoenrol'] = '为了执行此动作，你需要选修此课程。';
