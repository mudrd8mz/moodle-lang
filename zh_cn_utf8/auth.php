...
$string['auth_cas_baseuri_key'] = '基于URI';
$string['auth_cas_broken_password'] = '没有更改您的密码前您不能继续进行。没有可利用的页面更改密码，请与管理员联系。';
$string['auth_cas_cantconnect'] = 'CAS模块的部分LDAP不能连接上服务器：{$a}';
$string['auth_cas_casversion'] = '版本';
$string['auth_cas_changepasswordurl'] = '更改密码URL';
...
$string['auth_cas_logoutcas'] = '当与MOODLE的连接中断时，如果想从CAS退出，将此设置为“yes”。';
$string['auth_cas_logoutcas_key'] = '退出CAS';
$string['auth_cas_multiauth'] = '如果您想有多种身份验证方式（CAS+其他验证方式），将此设置为“yes”。';
$string['auth_cas_multiauth_key'] = '多种验证方式';
$string['auth_cas_port'] = 'CAS服务端口';
$string['auth_cas_port_key'] = '端口';
$string['auth_cas_proxycas'] = '如果在代理模式使用CAS，将此设置为“yes”。';
...
$string['auth_casdescription'] = '这个方法使用CAS服务器(中央认证服务)来认证Single Sing On(SSO)环境中的用户。您也可以使用LDAP认证。如果给定的用户名和密码在CAS中有效，Moodle会在数据库中创建信用户项目，并从LDAP中取出相应的属性。在后续的登录中，只检查用户名和密码。';
$string['auth_casnotinstalled'] = '不能使用CAS认证方式。PHP LDAP模块没有安装。';
...
$string['auth_dbchangepasswordurl_key'] = '更改密码URL';
$string['auth_dbdebugauthdb'] = '调试ADOdb';
$string['auth_dbdebugauthdbhelp'] = '调试ADOdb连接到外部数据库，登录时显示空页面。不符合站点要求。';
$string['auth_dbdeleteuser'] = '删除用户 {$a[0]} id {$a[1]}';
...
$string['auth_dbinsertuser'] = '已插入用户{$a[0]} id {$a[1]}';
...
$string['auth_dbsetupsqlhelp'] = '特定数据库设置SQL命令。过去常设置通信编码方式，例如MySQL和PostgreSQL：<em>SET NAMES \'utf8\'</em>';
$string['auth_dbsuspenduser'] = '暂停用户 {$a[0]} id {$a[1]}';
$string['auth_dbsuspendusererror'] = '暂停用户{$a}错误';
$string['auth_dbsybasequoting'] = '使用sybase引用';
$string['auth_dbsybasequotinghelp'] = 'Sybase风格，需要Oracle支持，MS SQL和一些其他的数据库，不要使用MySQL！';
...
$string['auth_dbupdatinguser'] = '更新用户{$a[0]} id {$a[1]}';
...
$string['auth_emailnoemail'] = '系统尝试发送给您一封Email，但是失败了！';
$string['auth_emailnoinsert'] = '不能将您的记录信息添加到数据库中!';
$string['auth_emailtitle'] = '基于电子邮件的身份验证';
$string['auth_fcchangepasswordurl'] = '更改密码URL';
...
$string['auth_imapchangepasswordurl_key'] = '更改密码URL';
...
$string['auth_imapnotinstalled'] = '不能使用IMAP认证方式。PHP中的IAMP模块没有安装。';
...
$string['auth_imaptype_key'] = 'IMAP类型';
...
$string['auth_ldap_changepasswordurl_key'] = '更改密码URL';
$string['auth_ldap_contexts'] = '用户背景列表。以‘;’分隔。例如：‘ou=users,o=org; ou=others,o=org’';
$string['auth_ldap_contexts_key'] = 'ldap情境';
...
$string['auth_ldap_ldap_encoding'] = '指定LDAP服务器的编码方式。多数可能是utf-8，MS AD V2使用默认的编码凡是cp1252，cp1250等。';
$string['auth_ldap_ldap_encoding_key'] = 'LDAP编码方式';
$string['auth_ldap_login_settings'] = '登录设置';
$string['auth_ldap_memberattribute'] = '可选的：指定从属于某个组的用户属性,一般是\'member\'';
$string['auth_ldap_memberattribute_isdn'] = '可选：覆盖属性数，0或1。';
$string['auth_ldap_memberattribute_isdn_key'] = '使用dn属性数';
$string['auth_ldap_memberattribute_key'] = '属性数';
$string['auth_ldap_noconnect'] = 'LDAP模块不能连接上服务器：{$a}';
$string['auth_ldap_noconnect_all'] = 'LDAP模块不能连接到任何服务器：{$a}';
$string['auth_ldap_noextension'] = '警告：PHP LDAP模块不能显示出来，请检查是否安装。';
$string['auth_ldap_objectclass'] = '可选的：指定objectClass以外的属性在ldap_user_type中搜索用户。通常您不需修改这个选项。';
$string['auth_ldap_objectclass_key'] = 'Idap对象类';
...
$string['auth_ldap_passtype'] = '指定在LDAP服务器中的新密码或者更改密码的格式。';
...
$string['auth_ldap_usertypeundefined'] = 'config.user_type没有定义或函数ldap_expirationtime2unix 不支持类型选择。';
$string['auth_ldap_usertypeundefined2'] = 'config.user_type 没有定义或函数ldap_unixi2expirationtime 不支持类型选择。';
...
$string['auth_ldapnotinstalled'] = '不能使用LDAP认证方式，PHP LDAP模块没有安装。';
...
$string['auth_mnet_rpc_negotiation_timeout'] = '认证的时间超过了XMLRPC传输的时间。';
$string['auth_mnetdescription'] = '通过在您的Moodle网络设置中允许用户通过信赖的主机认证。';
...
$string['auth_nntpchangepasswordurl_key'] = '更改密码URL';
...
$string['auth_nntpnotinstalled'] = '不能使用NNTP认证方式，PHP IMAP模块没有安装。';
$string['auth_nntpport'] = '服务器端口（通常是119）';
$string['auth_nntpport_key'] = '端口';
$string['auth_nntptitle'] = '使用一个NNTP服务器';
$string['auth_nologindescription'] = '辅助插件阻止用户登录到系统中，并且不发送Email到给任何用户。可以使用“延迟”用户帐号。';
$string['auth_nologintitle'] = '没有登录';
...
$string['auth_pop3changepasswordurl_key'] = '更改密码URL';
...
$string['auth_pop3mailbox_key'] = 'pop3邮箱';
$string['auth_pop3notinstalled'] = '不能使用POP3认证方式，PHP IMAP模块没有安装。';
...
$string['auth_shib_changepasswordurl'] = '更改密码URL';
...
$string['auth_sync_script'] = 'Cron同步脚本';
...
$string['nopasswordchangeforced'] = '在没有更新密码前，您不允许任何操作。如果登录不到一个可以修改密码的页面，请与管理员联系。';
...
$string['rpc_negotiation_timeout'] = 'RPC超时';
$string['selfregistration'] = '自己注册';
$string['selfregistration_help'] = '选择哪种认证插件用来处理用户的自己注册。';
$string['sha1'] = 'SHA-1哈希算法';
$string['shib_no_attributes_error'] = '您似乎正在使用Shibboleth认证，但是Moodle不接受用户的属性。请确认您的身份提供者激活了必要的属性({$a})，或者向这个服务器的网络管理员报表。';
$string['shib_not_all_attributes_error'] = 'Moodle需要Shibboleth属性，但是现在不存在这些属性。这些属性是: {$a}<br /> 请联系服务器的网络管理员或您的身份认证者。';
...
$string['auth_ldap_ad_create_req'] = '不能在活动目录中创建新帐户，确保您满足所有的正常运行的需求（LDAP连接，有足够的权限绑定用户等）。';
...
$string['auth_ldap_create_error'] = '在LDAP中创建用户发生错误';
...
$string['auth_ldap_no_mbstring'] = '在活动目录中创建用户时需要mbstring扩展支持。';
$string['auth_ldap_user_exists'] = 'LDAP用户名已存在';
$string['auth_ntlmsso'] = 'NTLM SSO';
$string['auth_ntlmsso_enabled'] = '设置为“是”将尝试用NTLM域进行单点登录。<strong>注意:</strong>还需要在web服务器上有额外的设置，具体查看<a href=\"http://docs.moodle.org/en/NTLM_authentication\">http://docs.moodle.org/en/NTLM_authentication</a>';
$string['auth_ntlmsso_enabled_key'] = '启用';
$string['auth_ntlmsso_subnet'] = '如果设置，它将仅用子网中的客户端尝试SSO，格式：xxx.xxx.xxx.xxx/子网掩码';
$string['auth_ntlmsso_subnet_key'] = '子网';
$string['auth_shib_no_organizations_warning'] = '如果想使用整合的WAYF服务，您必须提供一个独立的身份提供商列表，包括entityIDs，名称和可选的会话发起者';
...
$string['auth_shibboleth_login_long'] = '通过口令登录Moodle';
$string['auth_shibboleth_select_member'] = '我是成员之一';
$string['auth_shibboleth_select_organization'] = '对于通过口令惊醒验证，请在下拉列表中选择您所在的组织。';
$string['errorminpassworddigits'] = '密码至少要{$a}个数字。';
$string['errorminpasswordlength'] = '密码至少要{$a}个字符。';
$string['errorminpasswordlower'] = '密码至少要{$a}个小写字母。';
$string['errorminpasswordnonalphanum'] = '密码至少要{$a}个非字母、数字字符。';
$string['errorminpasswordupper'] = '密码至少要{$a}个小写字母。';
$string['forgottenpassword'] = '如果您在这里键入一个URL地址，该地址将会用来丢失密码的查找页面。';
$string['forgottenpasswordurl'] = '忘记的密码URL';
$string['ntlmsso_attempting'] = '尝试通过NTLM单点登录';
$string['ntlmsso_failed'] = '自动登录失败，尝试到普通登录页面登录。';
$string['ntlmsso_isdisabled'] = 'NTLM SSO被禁用';
