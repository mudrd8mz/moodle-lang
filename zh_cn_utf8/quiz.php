...
$string['close'] = '关闭窗口';
$string['closebeforeopen'] = '不能更新测验。您要在开始日期之前先指定结束日期。';
...
$string['false'] = '错';
$string['feedback'] = '反馈';
$string['feedbackerrorboundaryformat'] = '反馈分数界限必须是百分比数或者数字。你输入的界限值{$a}无法识别。';
$string['feedbackerrorboundaryoutofrange'] = '反馈分数界限必须在0%%%%和100%%%%之间。你输入的界限值超出范围。';
$string['feedbackerrorjunkinboundary'] = '您必须填写反馈分数界限框，不能留空。';
$string['feedbackerrorjunkinfeedback'] = '您必须填写反馈框，不能留空。';
$string['feedbackerrororder'] = '反馈分数界限必须按从高往低的顺序。你输入的值{$a}是无序的。';
$string['file'] = '文件';
...
$string['filloutthreequestions'] = '您必须填写至少三个有答案的题目。如果让题目为空，但是提供答案，那么这个答案将作为额外的错误答案。题目和答案都为空的条目将被忽略。';
...
$string['nomatchinganswer'] = '您必须给出一个答案，以匹配题目“{$a}”。';
$string['nominal'] = '额定误差';
...
$string['quiz:viewreports'] = '查看测验报告';
...
$string['subnetnotice'] = '很抱歉，本测验被锁定为只能从特定位置登录。现在，您的计算机不在允许的子网范围内。但作为教师，您可以浏览题目。';
