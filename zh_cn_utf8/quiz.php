...
$string['gift'] = 'GIFT格式';
$string['giftleftbraceerror'] = '无法找到 {';
$string['giftmatchingformat'] = '匹配题的答案格式不正确';
$string['giftnonumericalanswers'] = '没有找到';
$string['giftnovalidquestion'] = '没有找到合适的问题';
$string['giftqtypenotset'] = '问题类别没有设置';
$string['giftrightbraceerror'] = '无法找到 }';
$string['grade'] = '成绩';
...
$string['importerrorquestion'] = '导入题目错误';
...
$string['parent'] = '父类别';
$string['parsingquestions'] = '分析导入文件中的问题。';
...
$string['questionsinthisquiz'] = '此测验中的题目';
...
$string['quiz:ignoretimelimits'] = '忽略测验的时间限制';
...
$string['showquestiontext'] = '在问题列表中显示问题内容';
...
$string['xmlimportnoname'] = '在xml文件中缺少题目名称';
$string['xmlimportnoquestion'] = '在xml文件中缺少题目内容';
