...
$string['errormissingquestion'] = '错误：系统找不到id为{$a}的试题';
...
$string['feedbackerrorboundaryoutofrange'] = '反馈分数界限必须在0%%%%和100%%%%之间。您输入的界限值超出范围。';
...
$string['gift'] = 'GIFT格式';
$string['giftleftbraceerror'] = '不能找到{';
...
$string['giftrightbraceerror'] = '不能找到}';
$string['grade'] = '成绩';
...
$string['invalidcategory'] = '类别ID不可用';
...
$string['missingquestion'] = '行{$a}后缺少试题标记';
...
$string['warningmissingtype'] = '<p><b>这个试题是一个还没有安装在您moodle上的题型。<br />请给您的moodle管理员发出警报。</b></p>';
...
$string['quiz:emailconfirmsubmission'] = '当提交测验时获得email确认信息';
$string['quiz:emailnotifysubmission'] = '获得提交email通知';
