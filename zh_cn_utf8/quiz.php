...
$string['confirmstartattemptnotimelimit'] = '此测验没有时间限制。你想继续进行吗？';
$string['confirmstartlimit'] = '此测验有时间限制并限制{$a}次试答.进入这个测验将会记录一次试答。你想继续吗？';
$string['confirmstartnolimit'] = '此测验限制{$a}次试答。进入这个测验将会记录一次试答。你想继续吗？';
...
$string['literal'] = '文字';
$string['loguniform'] = '数字，来自loguniform（一种数学模型）';
...
$string['responses'] = '作答';
$string['results'] = '结果';
$string['reuseifpossible'] = '再利用以前取消的';
$string['review'] = '复习';
