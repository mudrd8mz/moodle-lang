...
$string['essay'] = '问答题';
$string['essayemailmessage'] = '<p>下文提示:<blockquote>{$a->question}</blockquote></p><p>你的回答:<blockquote><em>{$a->response}</em></blockquote></p><p>{$a->teacher}的评论:<blockquote><em>{$a->comment}</em></blockquote></p><p>你已经收到{$a->outof} 个这个短文问题中的{$a->earned }.</p><p>你这课的分数已经被修改到{$a->newgrade}%%.</p>';
$string['essayemailsubject'] = '{$a}问题的成绩';
$string['essays'] = '问答题';
...
$string['maxtimewarning'] = '你还有 {$a} 分钟来完成任务。';
...
$string['namereject'] = '很抱歉，你的名称被过滤器拒绝。<br/>请尝试其他的名字';
$string['nextpage'] = '下一页';
...
$string['numberofpagesviewednotice'] = '已回答题数:{$a->nquestions};(你至少要回答{$a->minquestions})';
...
$string['randompageinbranch'] = '分支中的随机问题';
$string['rank'] = '等级';
...
$string['reviewquestioncontinue'] = '继续下一个问题';
...
$string['topscorestitle'] = '课的{$a}个最高分。';
