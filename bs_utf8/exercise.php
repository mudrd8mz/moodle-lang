...
$string['assessmentmadebythe'] = 'Ocjenjivanje urađeno po $a';
$string['assessmentofthissubmission'] = 'Ocjena ove prijave';
$string['assessments'] = 'Ocjene';
$string['atthisstageyou'] = 'Kompletirali ste ocjenjivanje na ovom nivou.<br />Vezano uz to, možda želite provjeriti Vaš rad.<br /> Ako to želite uraditi, onda je korisno da provjerite i ocjenjivanje.<br /> To možete učiniti pritiskom na link ispod ovog teksta.';
$string['awaitingassessmentbythe'] = 'Očekivano ocjenjivanje po $a';
$string['clearlateflag'] = 'Obrišite zastavicu';
$string['comment'] = 'Komentar';
$string['comparisonofassessments'] = 'Upoređivanje ocjenjivanja';
...
$string['descriptionofexercise'] = 'U ovoj vježbi, student $a treba spojiti tačku A sa tačkom B, tako da linija ide preko $a. Takođe, mora se imati na umu da je i izrada grafičkog rješenja rađena u $a obavezna.';
$string['detailsofassessment'] = 'Detalji ocjenjivanja';
$string['displayoffinalgrades'] = 'Prikaz konačnih ocjena';
...
$string['edit'] = 'Uredite';
$string['editingassessmentelements'] = 'Uređivanje elemenata ocjenjivanja';
$string['element'] = 'Element';
$string['elementweight'] = 'Veličina elementa';
$string['enterpassword'] = 'Unesi šifru';
$string['entriessaved'] = 'Unosi sačuvani';
...
$string['late'] = 'Kasni';
$string['lax'] = 'Slab';
$string['leaguetable'] = 'Zajednička tabela podnešenih radova';
...
$string['managingassignment'] = 'Vođenje vježbe';
...
$string['noteonassessmentelements'] = 'Ocjenjivanje je podijeljeno u nekoliko \'Elemenata ocjenjivanja\'.Zbog toga je ocjenjivanje lakše i bolje.<br />Kao predavač, trebate dodati ove elemente prije pravljenja zadatka dostupnog studentima.<br /> To ćete uraditi tako što ćete pritiskom na zadatak u kursu, ako nema prisutnih elemenata, biti upitani da ih dodate.<br /> Možete promijeniti broj elemenata koristeći prikaz \'Uredite zadatak\' Elementi mogu biti promijenjeni iz prikaza \"Vođenje vježbe\". ';
$string['noteongradinggrade'] = 'Ova ocjena je mjerilo kako se dobro Vaše ocjenjivanje slaže sa ocjenjivanjem <br />
Vaš rad od $a. Što je veća ocjena to je bliža saobraznost.';
...
$string['numberofcriterionelements'] = 'Broj elemenata kriterija mora biti veći od jedan';
...
$string['optionaladjustment'] = 'Noebavezno prilagođavanje';
$string['overallgrade'] = 'Ukupna ocjena';
$string['passwordprotectedexercise'] = 'Vježba zaštićena šifrom';
$string['phase'] = 'Etapa';
...
$string['pleasesubmityourwork'] = 'Pošaljite rad koristeći ovu formu';
$string['pleaseusethisform'] = 'Ispunite ovu formu nakon završetka instrukcija <br /> u vježbi koja je prikazana ispod.';
$string['pleaseviewtheexercise'] = 'Pogledajte vježbu ispod tako što ćete pritisnuti naslov vježbe. Trebate slijediti uputstva u ovoj vježbi. Kad završite sa vježbom, pritisnite dugme u sandučetu ispod. Nakon toga dobićete instrukcije o narednim koracima.';
$string['poor'] = 'Loše';
...
$string['resubmitnote'] = '* znači da $a može vratiti nazad ovaj podnešeni materijal. <br /> Ova zastavica može se dati bilo kojem podnesku ponovnim ocjenjivanjem.';
$string['rubric'] = 'Crveno označen';
$string['savedok'] = 'Sačuvaj OK';
$string['saveentries'] = 'Unosi sačuvani';
$string['savemyassessment'] = 'Ssačuvaj moje procjene';
$string['saveweights'] = 'Ssačuvaj procjene';
$string['scale10'] = 'Rezultat je 10';
$string['scale100'] = 'Rezultat je 100';
$string['scale20'] = 'Rezultat je 20';
$string['scalecorrect'] = '2 poena Tačna /Netačna ocjena';
$string['scaleexcellent4'] = '4 poena Odličan/Vrlo loš rezultat';
$string['scaleexcellent5'] = '5 poena Odličan/Vrlo loš rezultat';
$string['scaleexcellent7'] = '7 poena Odličan/Vrlo loš rezultat';
...
$string['weightssaved'] = 'Sačuvaj procjene';
$string['weightsusedforoverallgrade'] = 'Procjene za konačno ocjenjivanje';
