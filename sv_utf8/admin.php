<?PHP // $Id$ 
      // admin.php - created with Moodle 1.9 Beta + (2007090600)


$string['accessdenied'] = 'Tillträde medgavs inte';
$string['accounts'] = 'Konton';
$string['addcounter'] = 'Lägg til räknare';
...
$string['configauthenticationplugins'] = 'Var snäll och välj de plugins som Du vill använda och arrangera dem i den ordning eDu vill att de ska användas.  Självregistrering kommer att hanteras av det plugin-program som är förvalt i kolumnen \'Registrering\' (vanligtvis e-post).';
...
$string['configenablegroupings'] = 'Den här inställningen aktiverar grupperande at grupper. (Detta är ännu inte implementerat fullt ut.';
...
$string['enablegroupings'] = 'Aktivera grupperingar';
...
$string['keeptagnamecase'] = 'bevara skftlägeskänslighet för namn på intressen';
...
$string['editlang'] = '<b>Redigera</b>'; // ORPHANED
