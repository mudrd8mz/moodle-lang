<?PHP // $Id$ 
      // bulkusers.php - created with Moodle 1.9 + (Build: 20080324) (2007101509)
...
$string['deleteall'] = 'Rensa alla användare'; // ORPHANED
$string['deletesel'] = 'Rensa bort urvalet av användare'; // ORPHANED
