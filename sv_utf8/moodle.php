...
$string['adminhelpstickyblocks'] = 'Konfigurera sädana permanenta block som gäller för hela Moodle.';
...
$string['none'] = 'Ingen';
$string['noneditingteacher'] = 'Icke-redigerande (distans)lärare/handledare/mentor osv';
