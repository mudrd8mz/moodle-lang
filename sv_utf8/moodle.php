...
$string['courserequestdisabled'] = 'Tyvärr, Din ansökan om en kurs har avslagits.'; // ORPHANED
$string['nostatstodisplay'] = 'Det finns tyvärr inga tillgängliga data att visa.'; // ORPHANED
