...
$string['mandatoryhdr'] = 'Yanıtlarda zorunlu joker kartlar mevcuttur';
$string['mustbenumeric'] = 'Buraya bir sayı girmelisiniz.';
$string['mustnotbenumeric'] = 'Bu bir sayı olamaz.';
$string['newcategory1'] = 'paylaşılmış yeni bir veri kümesi kullanılır';
$string['newlocal1'] = 'gizli yeni bir veri kümesi kullanılır';
