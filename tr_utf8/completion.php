...
$string['completion-alt-auto-n'] = 'Tamamlanmadı';
...
$string['completionenabled'] = 'Etkin kılındı, etkinlik ayarları üzerinden kontrol edin';
...
$string['csvdownload'] = 'Elektronik çizelge formatında indir (UTF-8 .csv)';
...
$string['help_completion'] = 'tamamlama izleme';
$string['help_completionexpected'] = 'tamamlamanın bitmesinin beklendiği tarih';
$string['help_completionlocked'] = 'kilitlenmiş tamamlama seçenekleri';
$string['help_completionview'] = 'tamamlamak için görüntülenmesi gerekiyor';
$string['progress'] = 'Öğrenci ilerlemesi';
$string['progress-title'] = '$a->user, $a->activity: $a->state $a->date';
$string['progresstrackedroles'] = 'İlerlemenin izlendiği roller';
