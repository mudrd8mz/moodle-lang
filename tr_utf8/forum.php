...
$string['blockafter'] = 'Bloklama için mesaj aralığı';
$string['blockperiod'] = 'Bloklama için süre';
$string['blockperioddisabled'] = 'Bloklama';
$string['bynameondate'] = 'yazan $a->name - $a->date';
$string['cannotviewpostyet'] = 'Bu tartışmada mesaj göndermediğinizden dolayı diğer öğrencilerin sorularını henüz okuyamazsınız.';
...
$string['forumbodyhidden'] = 'Bu tartışmada henüz mesaj göndermediğiniz için bu mesaja bakamazsınız.';
...
$string['qandanotify'] = 'Bu bir Soru/Cevap forumudur. Diğer yanıtları görmek için öncelikle cevabınızı göndermelisiniz.';
