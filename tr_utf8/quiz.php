...
$string['importfilearea'] = 'Alınan dosyadakiler zaten kurs dosyalarında...';
...
$string['unusedcategorydeleted'] = 'Kurs silindiği için bu kategori de silindi. Sunucudaki soruları artık kullanılmaz.';
$string['updatesettings'] = 'Sınav ayarlarını güncelle';
$string['url'] = 'URL';
$string['usedcategorymoved'] = 'Kurs silindiği için bu kategori site seviyesine taşındı. Soruları sunucuda, başka sınavlar tarafından kullanıldı.';
