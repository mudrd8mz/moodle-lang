...
$string['cannoteditafterattempts'] = 'Bu sorular uygulandığından dolayı soru ekleyemez veya çıkaramazsınız.';
...
$a->submissiontime tarihinde \'$a->coursename\' kursundaki \'$a->quizname\' sınavına katılımınız için teşekkür ederiz.

Bu e-posta, cevaplarınızın güvenle alındığını gösterir.
...
$a->studentname, \'$a->coursename\' kursundaki \'$a->quizname\' ($a->quizurl) sınavını tamamlamıştır.

Bu uygulamayı buradan inceleyebilirsiniz:
$a->quizreviewurl';
$string['emailnotifysubject'] = '$a->studentname, $a->quizname sınavını tamamladı';
...
$string['gradingmethod'] = 'Notl verme yöntemi: $a';
...
$string['openclosedatesupdated'] = 'Sınavı açma ve kapama tarihleri güncellendi';
...
$string['quizcloseson'] = 'Sınav bu tarihe kadar açıktır: $a';
$string['quiznotavailable'] = 'Sınav bu tarihe kadar açık değildir: $a';
$string['quizopen'] = 'Sınavı aç';
$string['quizopenedon'] = 'Bu sınav $a tarihinde açıldı';
...
$string['remove'] = 'Sil';
$string['removeallquizattempts'] = 'Bütün sınav uygulamarını sil';
...
$string['upgradesure'] = 'Sınav modülü, özellikle sınav tablolarında büyük bir değişiklik yapacak ve bu güncelleme yeterince test edilmedi. İşleme başlamadan önce veritabanı tablolarını yedeklemenizi şiddetle öneririz.';
$string['url'] = 'URL';
