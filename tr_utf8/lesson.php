...
$string['completethefollowingconditions'] = 'Devam etmeden önce <b>$a</b> dersindeki şartları yerine getirmelisiniz.';
$string['conditionsfordependency'] = 'Bağımlılık için şartlar';
...
$string['deleteattempts'] = 'Bu ders için öğrenci denemelerini sil (user id)';
...
$string['emailgradedessays'] = 'Değerlendirilen yazılılara email gönder';
...
$string['importquestions'] = 'Soru al';
...
$string['movedpage'] = 'Taşınmış sayfa';
...
$string['passwordprotectedlesson'] = '$a parola korumalı bir derstir.';
...
$string['redisplaypage'] = 'Sayfayı tekrargöster';
$string['report'] = 'Rapor';
...
$string['teacherongoingwarning'] = 'Sürekli not gösterimi sadece öğrenciler içindir. <br />Sürekli not gösterimini test etmek için öğrenci olarak giriş yapın';
...
$string['thefollowingpagesjumptothispage'] = 'Aşağıdaki sayfalar bu sayfaya atlıyor';
...
$string['waitpostscore'] = 'Yüksek puan gönderirilirken lütfen bekleyin...';
