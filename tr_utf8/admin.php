...
$string['unicoderequired'] = 'Bütün verilerinizi Unicode (UTF-8) olarak saklamanız gerekir. Yeni kurulumlar veritabanlarına varsayılan olarak Unicode karakter setinde işlem yapar. Güncelleme yapıyorsanız, UTF-8 Çevirim işlemini yapmanız gerekiyor (Yönetici sayfasına bakınız).';
$string['unicodeupgradenotice'] = 'Moodle 1.6\'da bütün dilleri UNICODE çevirdik. Bu sitede güncellemeyi tamamlamak ve veritabanınızdaki bütün verileri UNICODE (UTF-8) çevirmek için <a href=\"utfdbmigrate.php\">Çevirme Betiğini Şimdi Çalıştırın</a>!';
