...
$string['configcoursemanager'] = 'Bu ayar, kurs tanıtımında görünen kişiyi kontrol etmenize izin verir. Kullanıcılar bu kurs için kurs tanıtımında gösterilen rollerden en azından birine sahip olmalıdır.';
...
$string['configdefaultallowedmodules'] = 'Yukarıdaki kategoriye alınacak kurslar için, <b>Kurs oluşturulduğunda</b> hangi eklentilere izin verilmesini istiyorsunuz?';
...
$string['configdisablecourseajax'] = 'Ana kurs sayfalarını düzenlerken AJAX KULLANMA';
...
$string['configguestroleid'] = 'Bu rol otomatik olarak konuk kullanıcısına atanmıştır. Bu aynı zamanda, kayıtlı olmayan konuk kullanıcıların şifre olmaksızın kursa girmesine geçici olarak izin verir. Lütfen, rolün, moodle/legacy:guest ve moodle/course:view yetkilerine sahip olduğunu doğrulayın.';
...
$string['configmaxbytes'] = 'Bu siteye yüklenen dosyaların en fazla ne kadar boyutta olacağını belirtir. Bu ayar, PHP tarafından post_max_size ve upload_max_filesize ile, Apache tarafından LimitRequestBody ile sınırlandırılmıştır. Maxbytes sınırı ayrıca kurs ve eklenti seviyesinde de ayarlanabilir.';
...
$string['confignonmetacoursesyncroleids'] = 'Varsayılan olarak, alt kurslardaki bütün ders kayıtları metakurslara uyarlanacaktır. Burada seçilen roller, uyarlama aşamasına dahil edilmeyecektir.';
...
$string['configrestrictbydefault'] = 'Oluşturulacak yeni kurslar yukarıdaki kategoriye alınırsa bu kursların eklentileri sınırlandırılacak mı?';
$string['configrestrictmodulesfor'] = 'Bazı etkinlik eklentilerinin kapatılması için hangi kursların <b>ayarları</b> olacak? Bu ayarın sadece eğitimcilere uygulandığını dikkate alın, yöneticiler bir kursa herhangi bir etkinlik zaten ekleyebilirler.';
...
$string['configstatsuserthreshold'] = 'Buraya sıfırdan farklı sayısal olmayan bir değer girmeniz durumunda kursa kayıtlı kullanıcı sayısı (tüm roller) bu sayıdan azsa istatistiği ölçülecek kurslar yoksayılacaktır.';
...
$string['disablecourseajax'] = 'AJAX kurs düzenlemesini kapat';
...
$string['nonmetacoursesyncroleids'] = 'Metakurslara uyarlanmayan roller';
...
$string['uucoursedefaultrole'] = 'Varsayılan kurs rolü';
