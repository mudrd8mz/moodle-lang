...
$string['allowthemechangeonurl'] = 'URL ile tema değişimi izni';
...
$string['bloglevelupgrade'] = 'Blog görünürlük güncellemesi';
$string['bloglevelupgradenotice'] = 'Siteniz eski blog görünürlük ayarını kullanıyor. <a href=\"bloglevelupgrade.php\">Blog görünürlük güncellemesi</a> yapmanız tavsiye edilir.';
...
$string['clistatusdisabled'] = 'Durum: etkin değil';
...
$string['cliupgradefinished'] = 'Komut satırı güncellemesi başarıyla tamamlandı.';
...
$string['configallowthemechangeonurl'] = 'Bu ayarı etkinleştirirseniz, URL adresine theme={themename}&amp;sesskey={sesskey} eklenerek tema değiştirilebilir.';
...
$string['configauthenticationplugins'] = 'Lütfen kullanmak istediğiniz kimlik denetimi eklentilerini seçiniz ve bu eklentileri sıraya koyunuz. Kendi kendine kayıt, \'Kayıt\' sütununda seçilen eklentiye göre (genellikle \'email\') işleme alınacaktır.';
...
$string['configdeleteunconfirmed'] = 'Bu, email kimlik denetimini kullanıyorsanız, kullanıcının ne kadar sürede bu emali onaylaması gerektiğini belirtir. Bu süreden sonra, onaylanmamış eski hesaplar silinecektir.';
...
$string['confignavshowcategories'] = 'Gezinme bloklarında ve gezinme çubuğunda ders kategorilerini göster';
...
$string['configrequiremodintro'] = 'Kullanıcıların her etkinlik için açıklama girmesi zorunlu değilse bu seçeneği devre dışı bırakın.';
...
$string['excludeoldflashclients'] = 'Gerekli flash sürümü';
...
$string['navshowallcourses'] = 'Tüm kullanıcı derslerini göster';
$string['navshowcategories'] = 'Ders kategorilerini göster';
...
$string['regenloginsession'] = 'Oturum kimliğini giriş yapılırken tekrar oluştur';
...
$string['soaprecommended'] = 'İsteğe bağlı SOAP PHP eklentisinin kurulması, web servisleri ve bazı dağıtım eklentileri için faydalıdır.';
...
$string['upgrade197noticesubject'] = 'Moodle 1.9.7 güncellemesi güvenlik uyarıları';
$string['upgrade197salt'] = 'Şifre çalınma riskini en aza indirmek için, salt metin şifresi ayarlamanız şiddetle tavsiye edilir. <br />Ayrıntılar için <a href=\"$a\" target=\"_blank\">salt metin şifresi belgesine</a> bakınız.';
...
$string['ipwhitelist'] = 'IP akliste'; // ORPHANED
$string['ipwhitelistdesc'] = 'Boş değilken, yalnızca buradaki IP ayarları <strong>$a->username</strong> kullanıcı adlı web hizmetini kullanabilir'; // ORPHANED
$string['managews'] = 'Web hizmetlerini yönet'; // ORPHANED
$string['webserviceprotocols'] = 'Web servisi sunucuları'; // ORPHANED
$string['webservices'] = 'Web servisleri'; // ORPHANED
$string['webservicesystemsettings'] = 'genel ayarlar'; // ORPHANED
$string['webserviceusersettings'] = 'Web servisi kullanıcı ayarları'; // ORPHANED
