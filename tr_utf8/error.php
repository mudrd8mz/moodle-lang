<?PHP // $Id$ 
      // error.php - created with Moodle 2.0 dev (Build: 20091223) (2009112400)
...
$string['cannotdeletecategorycourse'] = '\'$a\' dersi silinirken hata oluştu.';
...
$string['cannotsetparentforcatoritem'] = 'Kategori veya ders ögesi için ana kategori ayarlanımıyor!';
...
$string['coursedoesnotbelongtocategory'] = 'Ders, bu kategoriye ait değil';
...
$string['ddldependencyerror'] = '$a->targettype \"$a->targetname\" düzenlenemiyor. $a->offendingtype \"$a->offendingname\" ile bağımlılık bulundu.';
...
$string['maxbytes'] = 'Bu dosya ayarlanan en fazla boyuttan daha büyük';
...
$string['modulerejectcomment'] = 'Eklenti bu yorumun eklenmesini reddediyor';
...
$string['nopermissiontoviewgrades'] = 'Notlara bakılamaz.';
...
$string['cannotaddmembergroupiddoesntexist'] = 'Üye grubunu ekleyemiyor: grup kimliği mevcut değil'; // ORPHANED
$string['cannotfindsite'] = 'Site düzeyindeki dersi bulamıyor'; // ORPHANED
$string['cannotupdatesecret'] = 'Kullanıcı gizli dizgisini yeniden ayarlamada hata'; // ORPHANED
$string['cannotupdatesubcate'] = 'Bir alt kategori güncellenemedi!'; // ORPHANED
$string['cannotupdateuser'] = 'Kullanıcı güncellenemedi'; // ORPHANED
$string['coursedoesntexistcannotcreategroup'] = 'Grup oluşturulamıyor: ders mevcut değil'; // ORPHANED
$string['groupiddoesntexistcannotdelete'] = 'Grup silinemiyor: grup kimliği yok'; // ORPHANED
$string['useriddoesntexist'] = 'Kullanıcı kimliği mevcut değil'; // ORPHANED
$string['userisnotaparticipant'] = 'Kullanıcı bir ders katılımcısı değil'; // ORPHANED
$string['usernotcreated'] = 'Kullanıcı oluşturulamadı'; // ORPHANED
$string['wscouldnotaddgroupmembernopermission'] = 'WS - Grup üyesi eklenemedi - İzin yok'; // ORPHANED
$string['wscouldnotcreateeuserindb'] = 'WS - Kullanıcı oluşturulamadı'; // ORPHANED
$string['wscouldnotcreateeusernopermission'] = 'WS - Kullanıcı oluşturulamadı - İzin yok'; // ORPHANED
$string['wscouldnotcreategroupnopermission'] = 'WS - Grup oluşturulamadı - İzin yok'; // ORPHANED
$string['wscouldnotdeletegroupnopermission'] = 'WS - Grup silinemedi - İzin yok'; // ORPHANED
$string['wscouldnotdeletenoexistinguser'] = 'WS - Kullanıcı silinemedi - Kullanıcı yok'; // ORPHANED
$string['wscouldnotdeleteusernopermission'] = 'WS - Kullanıcı silinemedi - İzin yok'; // ORPHANED
$string['wscouldnotgetgroupnopermission'] = 'WS - Grup alınamadı - İzin yok'; // ORPHANED
$string['wscouldnotremovegroupmembernopermission'] = 'WS - Grup üyesi silinemedi - İzin yok'; // ORPHANED
$string['wscouldnotupdatenoexistinguser'] = 'WS - Kullanıcı güncellenemedi - Kullanıcı yok'; // ORPHANED
$string['wscouldnotupdateuserindb'] = 'WS - Kullanıcı güncellenemedi'; // ORPHANED
$string['wscouldnotupdateusernopermission'] = 'WS - Kullanıcı güncellenemedi - İzin yok'; // ORPHANED
$string['wscouldnotvieweusernopermission'] = 'WS - Kullanıcıya bakılamadı - İzin yok'; // ORPHANED
