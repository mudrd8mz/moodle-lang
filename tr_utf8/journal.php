...
$string['mailsubject'] = 'Yazı geribildirimi';
$string['modulename'] = 'Yazı';
$string['modulenameplural'] = 'Yazılar';
$string['newjournalentries'] = 'Yeni yazı girişi';
$string['noentry'] = 'Boş';
$string['noratinggiven'] = 'Sınıflandırma yapılmadı';
$string['notopenuntil'] = 'Bu yazı, şu tarihe kadar açılmayacaktır';
$string['notstarted'] = 'Bu yazıya henüz başlamadınız';
$string['overallrating'] = 'Ayrıntılı sınıflandırma';
$string['rate'] = 'Sınıflandırma';
$string['saveallfeedback'] = 'Tüm geribildirimlerimi kaydet';
$string['startoredit'] = 'Yazıya başla veya düzenle';
$string['viewallentries'] = '$a\'in yazılarını göster';
