...
$string['customtitlelabel'] = 'Kişisel başlık (içerik tarafından sağlanmasını istiyorsanız boş bırakın):';
...
$string['numentries'] = 'Her içerikteki kayıt';
...
$string['shownumentrieslabel'] = 'Her blokta görünecek en fazla kayıt';
...
$string['submitters2'] = 'Gönderenler';
$string['timeout'] = 'RSS Zaman Aşımı';
$string['timeout2'] = 'Zaman Aşımı';
