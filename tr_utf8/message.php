...
$string['blocknoncontacts'] = 'Tanımadığım kullanıcıları engelle';
$string['cannotsavemessageprefs'] = 'Mesajlaşma seçenekleri kaydedilemedi';
...
$string['messageprovider:instantmessage'] = 'Kullanıcılar arası kişisel mesajlar';
...
$string['nomessages'] = 'Yeni mesaj yok';
...
$string['pagerefreshes'] = 'Bu sayfa her $a saniyede yenilenir';
$string['private_config'] = 'Mesaj penceresi aç';
$string['processortag'] = 'Hedef';
$string['providers_config'] = 'Gelen mesajlar için hedefleri yapılandır';
...
$string['showmessagewindow'] = 'Yeni mesaj aldığımda yeni pencere aç';
...
$string['general_config'] = 'Genel Seçenekler'; // ORPHANED
$string['processor_config'] = 'Hedef Yapılandırmaları'; // ORPHANED
