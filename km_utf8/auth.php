...
$string['actauthhdr'] = 'កម្មវិធី​ជំនួយ​ការ​ផ្ទៀងផ្ទាត់​ភាព​ត្រឹមត្រូវ​ដែល​​សកម្ម';
...
$string['forgottenpassword'] = 'ប្រសិន​បើ​អ្នក​បញ្ចូល URL នៅ​ទីនេះ វា​នឹង​ត្រូវ​បាន​ប្រើ​ជា​ទំព័រ​សង្គ្រោះ​ពាក្យសម្ងាត់​ដែល​បាត់​សម្រាប់​តំបន់​បណ្ដាញ​នេះ ។ វា​ត្រូវ​បាន​បម្រុង ទុក​សម្រាប់​តំបន់​បណ្ដាញ​ដែល​ពាក្យ​សម្ងាត់​ត្រូវ​បានគ្រប់គ្រង​ខាង​ក្រៅ Moodle ទាំង​ស្រុង ។ ទុក​វា​​ឲ្យ​ទទេ​ដើម្បី​ប្រើ​ការ​សង្គោះ​ពាក្យសម្ងាត់​លំនាំ​ដើម ។';
$string['forgottenpasswordurl'] = 'ពាក្យ​សម្ងាត់ URL ដែល​បាន​​ភ្លេច';
...
$string['auth_cas_logoutcas_key'] = 'ចេញ​ពី CAS';
$string['auth_cas_multiauth_key'] = 'ការ​ផ្ទៀងផ្ទាត់​ភាព​ត្រឹមត្រូវ​ច្រើន';
$string['auth_cas_proxycas'] = 'ប្តូរ​នេះ​ទៅ​ \'បាទ/ចាស\'\' ប្រសិន​បើ​ជា​អ្នក​ប្រើ​ CAS ក្នុង​របៀប​ប្រូកស៊ី';
$string['auth_cas_logoutcas'] = 'ប្តូរ​នេះ​ទៅ​ \'បាទ/ចាស\'\' ប្រសិន​បើជា​អ្នក​ចង់​ចេញ​ពី​ CAS ពេល​អ្នក​ផ្តាច់​ពី Moodle';
$string['auth_cas_multiauth'] = 'ប្តូរ​នេះ​ទៅ​ជា​ \'បាទ/ចាស\'\' ប្រសិន​បើ​ជា​អ្នក​ចង់​បាន​ការ​ផ្ទៀងផ្ទាត់​ភាព​ត្រឹមត្រូវ​ច្រើន (CAS + ការ​ផ្ទៀងផ្ទាត់​ភាព​ត្រឹមត្រូវ​ផ្សេង​ៗទៀត)';
$string['accesCAS'] = 'អ្នក​ប្រើ CAS';
$string['accesNOCAS'] = 'អ្នក​ប្រើ​ផ្សេង​ទៀត';
$string['CASform'] = 'ជម្រើស​​ផ្ទៀងផ្ទាត់​ភាព​ត្រឹមត្រូវ';
$string['auth_cas_logincas'] = 'ចូល​ដំណើរការ​ការ​តភ្ជាប់​ដែល​មាន​សុវត្ថិភាព';
...
$string['auth_ldap_attrcreators'] = 'បញ្ជី​នៃ​ក្រុម ឬ​បរិបទដែល​សមាជិក​ត្រូវ​បាន​អនុញ្ញាត​ឲ្យ​បង្កើត​គុណលក្ខណៈ ។ បំបែក​ពហុ​ក្រុម​ចេញ​ពី​គ្នា​​ដោយ​ប្រើ ';
$string['auth_ldap_attrcreators_key'] = 'ឧបករណ៍​​បង្កើត​គុណលក្ខណៈ';
...
$string['auth_ldap_groupecreators'] = 'បញ្ជី​នៃ​ក្រុម ឬ​បរិបទ​ដែល​សមាជិក​ត្រូវ​បាន​អនុញ្ញាត​ឲ្យ​បង្កើត​ក្រុម ។ បំបែកពហុ​ក្រុម​ចេញ​ពី​គ្នា​​ដោយ​ប្រើ ';
$string['auth_ldap_groupecreators_key'] = 'ឧបករណ៍​​បង្កើត​ក្រុម';
...
$string['auth_ntlmsso_enabled'] = 'កំណត់​ជា​បាទ ​ដើម្បី​ប៉ុនប៉ង​ការ​ចាប់​ផ្តើម​តែ​មួយ​ជាមួយ​ដែន NTLM ។ <strong>ចំណាំ ៖</strong> នេះ​ទាមទារ​ការ​រៀបចំ​បន្ថែម​នៅ​លើ​ម៉ាស៊ីន​បម្រើ​បណ្តាញ​ដើម្បី​ដំណើរ​ការ​បាន សូម​មើល <a href=\"http://docs.moodle.org/en/NTLM_authentication\">http://docs.moodle.org/en/NTLM_authentication</a>';
$string['auth_ntlmsso_subnet_key'] = 'សំណុំរង';
$string['auth_ntlmsso_subnet'] = 'ប្រសិន​បើ​បាន​កំណត់ វា​នឹង​ប៉ុនប៉ង​តែ​ SSO ប៉ុណ្ណោះ ជា​មួយ​ម៉ាស៊ីន​ភ្ញៀវ​នៅ​ក្នុង​សំណុំ​រង​នេះ ។ ទ្រង់ទ្រាយ ៖ xxx.xxx.xxx.xxx/bitmask';
$string['ntlmsso_attempting'] = 'កំពុង​ប៉ុនប៉ង​ការ​ចាប់​ផ្តើម​តែ​មួយ​តាម​រយៈ NTLM...';
$string['ntlmsso_failed'] = 'បាន​បរាជ័យ​ក្នុងកា​រចូល​ដោយ​ស្វ័យ​ប្រវត្តិ ព្យាយាម​ចូល​ទំព័រ​ធម្មតា...';
$string['ntlmsso_isdisabled'] = 'NTLM SSO មិន​​បាន​​អនុញ្ញាត ។';
...
$string['auth_passwordwillexpire'] = 'ពាក្យ​សម្ងាត់​របស់​អ្នក​នឹង​ផុត​កំណត់ ក្នុង​រយៈពេល $a ថ្ងៃ​ទៀត ។ តើ​អ្នក​ចង់​ផ្លាស់ប្ដូរ​ពាក្យ​សម្ងាត់​របស់អ្នក​​ឥឡូវ​នេះទេ ?';
...
$string['auth_shib_instructions'] = 'ប្រើ <a href=\"$a\">Shibboleth login</a> ដើម្បី​ចូល​ដំណើរ​ការ​តាម​រយៈ Shibboleth នៅពេលដែល​ស្ថាប័ន​របស់​អ្នក​គាំទ្រ​វា ។<br />បើមិន​ដូច្នោះ​ទេ ប្រើ​សំណុំ​បែបបទ​ចូល​ធម្មតា​ដែល​បង្ហាញ​នៅទីនេះ ។';
...
$string['auth_shibboleth_login_long'] = 'ចូល​ទៅ Moodle តាមរយៈ Shibboleth';
$string['auth_shibboleth_select_organization'] = 'សម្រាប់​ការ​ផ្ទៀងផ្ទាត់​ភាព​ត្រឹមត្រូវ​តាម​ Shibboleth សូម​ជ្រើស​អង្គការ​របស់​អ្នកពី​បញ្ជី​ទម្លាក់​ចុះ​ខាង​ក្រោម ៖';
$string['auth_shibboleth_contact_administrator'] = 'ក្នុង​ករណី​ដែល​អ្នក​មិន​បាន​ភ្ជាប់​​ជាមួយ​អង្គការ​ដែល​បាន​ផ្តល់​ឲ្យ​ទេ ហើយ​អ្នក​ត្រូវ​ការ​ចូល​ដំណើរការ​ទៅ​កាន់​វគ្គ​សិក្សា​នៅ​លើ​ម៉ាស៊ីន​បម្រើ​នេះ​ សូម​ទាក់ទង';
$string['auth_shibboleth_select_member'] = 'ខ្ញុំគឺ​ជា​សមាជិក​​របស់...';
$string['auth_shibboleth_errormsg'] = 'សូម​ជ្រើស​អង្គការ​ដែល​អ្នក​ជា​សមាជិក​ !';
$string['auth_shib_no_organizations_warning'] = 'ប្រសិន​បើ​​អ្នក​ចង់​ប្រើ​សេវា​របស់ WAYF ដែល​បាន​រួម​បញ្ចូល អ្នក​ត្រូវ​តែ​ផ្ដល់​នូវ​បញ្ជី​ដែល​បំបែក​ដោយ​សញ្ញា​ក្បៀស​នូវ​លេខសម្គាល់​ក្រុមហ៊ុន​ផ្ដល់​អត្តសញ្ញាណ ឈ្មោះ​របស់​៿ពួកគេ និង​ជា​ជម្រើស​កម្មវិធី​ចាប់ផ្ដើម​សម័យ ។';
