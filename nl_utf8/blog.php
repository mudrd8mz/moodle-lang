...
$string['addotags'] = 'Voeg labels toe';
$string['addptags'] = 'Voeg eigen labels toe';
$string['blockmenutitle'] = 'Blog menu';
$string['blocktagstitle'] = 'Bloglabels';
$string['blocktitle'] = 'Bloktitel voor bloglabels';
$string['blog'] = 'Blog';
$string['blogdeleteconfirm'] = 'Deze blog verwijderen?';
$string['blogpreferences'] = 'Blog voorkeuren';
$string['blogs'] = 'Blogs';
$string['blogtags'] = 'Bloglabels';
...
$string['norighttodeletetag'] = 'Je mag dit bloglabel niet verwijderen - $a';
$string['notallowedtoedit'] = 'Je mag deze tekst niet bewerken';
$string['numberofentries'] = 'Teksten: $a';
$string['numberoftags'] = 'Aantal te tonen labels';
...
$string['tagdatelastused'] = 'Laatst gebruiker datumlabel';
$string['tagsort'] = 'Sorteer het tonen van labels op';
$string['tagtext'] = 'Label tekst';
$string['timewithin'] = 'Toon labels gebruikt binnen zoveel dagen';
