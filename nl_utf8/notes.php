...
$string['abovenormal'] = 'hoger dan gemiddeld'; // ORPHANED
$string['belownormal'] = 'lager dan gemiddeld'; // ORPHANED
$string['high'] = 'veel'; // ORPHANED
$string['low'] = 'weinig'; // ORPHANED
$string['normal'] = 'normaal'; // ORPHANED
$string['rating'] = 'Beoordeling'; // ORPHANED
