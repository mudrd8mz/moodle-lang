...
$string['cannotdowngrade'] = 'Kan niet terugdraaien van from $a[0] to $a[1].';
...
$string['prefixcannotbeempty'] = 'Tabel prefix \"$a[0]\" kan voor je doeldatabank niet leeg zijn ($a[1])';
$string['prefixlimit'] = 'Tabel prefix \"$a\": de maximum toegelaten lengte voor Oracle Databanken is 2 tekens.';
