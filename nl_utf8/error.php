<?PHP // $Id$ 
      // error.php - created with Moodle 2.0 dev (Build: 20090313) (2009030501)
...
$string['modulerequirementsnotmet'] = 'De module \"$a->modulename\" ($a->moduleversion) kon niet geïnstalleerd worden. Een nieuwere versie van Moodle is vereist (je gebruikt nu $a->currentmoodle en je hebt $a->requiremoodle nodig).'; // ORPHANED
