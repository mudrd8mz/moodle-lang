...
$string['cannotinitpage'] = 'Kan pagina niet initialiseren, cursus id: $a';
...
$string['cannotinsertrate'] = 'Kon geen nieuwe beoordeling toevoegen ($a[0]=$a[1])';
...
$string['cannotsaveconfig'] = 'Fout bij het bewaren van de configuratie \"$a[0]\" als \"$a[1]\" voor plugin \"$a[2]\"';
...
$string['cannotunassigncap'] = 'Kon ongebruikte mogelijkheid (capability) $a[0] niet wegnemen van rol $a[1]';
...
$string['filemismatch'] = 'Non-core bestandsnaam fout. Het bestand \"$a[0]\" zou {$a[1]}{$a[2]}.php moeten zijn';
