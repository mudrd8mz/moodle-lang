...
$string['attachfile'] = 'Koppel een bestand';
$string['attachfiletoassignment'] = 'Koppel bestand(en) aan opdracht';
$string['availabledate'] = 'Beschikbaar vanaf';
$string['backtoassignment'] = 'Terug naar opdracht';
$string['backtofeedback'] = 'Terug naar feedback';
$string['choosereviewfile'] = 'Kies een bestand om te uploaden als commentaar bij de opdracht';
...
$string['deletecheckfile'] = 'Ben je er zeker van dat je dit bestand wil verwijderen?';
$string['deleteednotification'] = 'Bestand is verwijderd';
$string['deletefail'] = 'Het volgende bestand is NIET verwijderd:';
...
$string['late'] = '$a laat';
$string['markingsubmitnotification'] = 'Het insturen van het bestand voor je opdracht is gelukt.';
...
$string['namedeletefile'] = 'Je gaat volgend bestand verwijderen:';
...
$string['nofilesforsubmit'] = 'Er is geen bestand gevonden om in te sturen. Ben je er zeker van dat je er één geüpload hebt?';
...
$string['removelink'] = 'Verwijder';
$string['responsefile'] = 'Bestand met feedback:';
$string['responsesfromteacher'] = 'Bestanden door de leraar geüpload';
...
$string['submissionstatus'] = 'Status van insturen:';
$string['submissionstatusblank'] = 'Leeg';
$string['submissionstatusdraft'] = 'Kladwerk';
$string['submissionstatusmarked'] = 'Cijfer gegeven';
$string['submissionstatusreturned'] = 'Teruggegeven';
$string['submissionstatussubmitted'] = 'Ingestuurd';
...
$string['uploadsuccessresponse'] = 'Feedbackbestand met succes geüpload';
