...
$string['alreadygraded'] = 'Þessu verkefni hefur verið gefið einkunn og því ekki hægt að skila aftur.';
...
Þú getur nálgast endurgjöfina hér:

    $a->url';
$string['assignmentmailhtml'] = '$a->teacher hefur skráð endurgjöf vegna
    skila þinna á \'<i>$a->assignment</i>\'<br /><br />
...
$string['cannotdeletefiles'] = 'Ekki var hægt að eyða skrám þar sem villa kom upp';
...
$string['deleteallsubmissions'] = 'Eyða öllum verkefnaskilum';
...
$string['editmysubmission'] = 'Breyta verkefnaskilum';
$string['emailstudents'] = 'Senda nemendum boð í tölvupósti';
$string['emailteachermail'] = '$a->username hefur skilað/uppfært eftirfarandi verkefni: \'$a->assignment\'
Verkefnið er aðgengilegt hér $a->url';
$string['emailteachermailhtml'] = '$a->username hefur skilað/uppfært eftirfarandi verkefni: <i>\'$a->assignment\'</i><br/><br/>
Skráin er <a href=\"$a->url\">aðgengileg hér</a>.';
$string['emailteachers'] = 'Senda tölvupóst til kennara';
$string['emptysubmission'] = 'Þú hefur ekki skilað neinu ennþá';
$string['enableemailnotification'] = 'Senda skilaboð í tölvupósti';
$string['existingfiledeleted'] = 'Skránni $a hefur verið eytt';
$string['failedupdatefeedback'] = 'Ekki tókst að uppfæra endurgjöf fyrir $a';
$string['feedback'] = 'Endurgjöf';
$string['feedbackfromteacher'] = 'Endurgjöf frá $a';
$string['feedbackupdated'] = 'Endurgjöf uppfærð fyrir $a nemendur';
$string['finalize'] = 'Engin fleiri verkefnaskil';
$string['finalizeerror'] = 'Villa kom upp. Ekki var hægt að ljúka verkefnaskilum.';
$string['graded'] = 'Metið';
$string['guestnosubmit'] = 'því miður, gestanotendur hafa ekki heimild til að skila verkefnum';
$string['guestnoupload'] = 'Því miður, gestanotendur geta ekki sent inn skrár';
$string['helpoffline'] = '<p>Þetta fyrirkomulag á verkefnaskilum er hentugt þegar verkefnaskilin eiga sér stað utan Moodle, t.d. þegar þau eru ekki á rafrænu formi.</p><p>Nemendur geta séð lýsingu á verkefninu en hafa ekki kost á því að senda inn skrá. Einkunnagjöf er hefðbundin og nemendur fá senda tilkynningu í tölvupósti þegar kennari skráir einkunn í Moodle.</p>';
$string['helponline'] = '<p>Þessi tegund verkefnaskila gerir nemendum kleift að skila texta á Netinu og nota til þess hefðbundinn textaritil Moodle. Kennarar gefa einkunn og geta einnig bætt athugasemdum beint inn í textann.</p>';
$string['helpupload'] = '<p>Þessi tegund verkefnaskila heimilar hverjum nemanda að senda eina eða fleiri skrár til kennara af hvaða tegund sem er.</p>
...
$string['noattempts'] = 'Engin verkefnaskil';
$string['nofiles'] = 'Engum skrám var skilað';
$string['nofilesyet'] = 'Engum skrám hefur verið skilað';
$string['nomoresubmissions'] = 'Fleiri verkefnaskil eru ekki heimiluð';
$string['nosubmitusers'] = 'Engir notendur fundust sem hafa heimild til að skila þessu verkefni';
...
$string['overwritewarning'] = 'Aðvörun: ef þú skilar verkefninu aftur mun það koma í stað þess verkefnis sem fyrir er';
...
$string['showrecentsubmissions'] = 'Birta nýleg verkefnaskil';
...
$string['trackdrafts'] = 'Virkja \"Skila til kennara\"';
...
$string['unfinalizeerror'] = 'Villa kom upp. Ekki var hægt að breyta þessum verkefnaskilum í uppkast';
...
$string['uploadfailnoupdate'] = 'Sending skráar heppnaðist en ekki tókst að uppfæra verkefnaskil!';
$string['uploadfiletoobig'] = 'Því miður, þessi skrá er of stór (hámarksstærðin er $a bæti)';
