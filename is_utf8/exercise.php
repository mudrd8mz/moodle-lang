<?PHP // $Id$ 
      // exercise.php - created with Moodle 1.7 beta 2 (2006101003)


$string['absent'] = 'Fjarverandi';
...
$string['assess'] = 'Meta';
$string['assessed'] = 'Metið';
$string['assessment'] = 'Mat';
$string['assessmentby'] = 'Metið af $a';
$string['assessmentform'] = 'Matsform';
...
$string['correct'] = 'Rétt';
$string['count'] = 'Talning';
$string['criterion'] = 'Criterion';
$string['deadline'] = 'Skilafrestur';
$string['deadlineis'] = 'Skilafresturinn er: $a';
$string['delete'] = 'Eyða';
...
$string['enterpassword'] = 'Gefðu upp lykilorð';
...
$string['modulename'] = 'Æfing';
$string['modulenameplural'] = 'Æfingar';
...
$string['passwordprotectedexercise'] = 'Æfing varin með lykilorði';
$string['phase'] = 'Phase';
...
$string['usepassword'] = 'Nota lykilorð';
...
$string['wrongpassword'] = 'Rangt lykilorð fyrir þessa æfingu';
