...
$string['advanced:anchor_desc'] = 'Setja inn/breyta akkeri';
$string['advanced:backcolor_desc'] = 'Veldu bakgrunnslit';
$string['advanced:block'] = 'Format';
$string['advanced:blockquote'] = 'Blockquote';
$string['advanced:blockquote_desc'] = 'Blockquote';
$string['advanced:bold_desc'] = 'Feitletra (Ctrl+B)';
$string['advanced:bullist_desc'] = 'Bólulisti';
$string['advanced:charmap_delta_height'] = '';
$string['advanced:charmap_delta_width'] = '';
$string['advanced:charmap_desc'] = 'Setja inn tákn';
$string['advanced:cleanup_desc'] = 'Hreinsa skítugan kóða';
$string['advanced:clipboard_msg'] = 'Afrita/Klippa/Líma er ekki aðgengilegt í Mozilla og Firefox eins og er.\\nViltu fá nánari upplýsingar?';
$string['advanced:code'] = 'Kóði';
$string['advanced:code_desc'] = 'Breyta HTML kóða';
$string['advanced:colorpicker_delta_height'] = '';
$string['advanced:colorpicker_delta_width'] = '';
$string['advanced:copy_desc'] = 'Afrita';
$string['advanced:custom1_desc'] = 'Lýsingin þín hér';
...
$string['advanced:h1'] = 'Fyrirsögn 1';
$string['advanced:h2'] = 'Fyrirsögn 2';
$string['advanced:h3'] = 'Fyrirsögn 3';
$string['advanced:h4'] = 'Fyrirsögn 4';
$string['advanced:h5'] = 'Fyrirsögn 5';
$string['advanced:h6'] = 'Fyrirsögn 6';
$string['advanced:help_desc'] = 'Hjálp';
$string['advanced:hr_desc'] = 'Setja inn lárétta línu';
$string['advanced:image_delta_height'] = '';
$string['advanced:image_delta_width'] = '';
$string['advanced:image_desc'] = 'Setja inn/breyta mynd';
$string['advanced:image_props_desc'] = 'Stillingar myndar';
$string['advanced:indent_desc'] = 'Draga inn';
$string['advanced:italic_desc'] = 'Skáletra (Ctrl+I)';
$string['advanced:justifycenter_desc'] = 'Miðjujafna';
$string['advanced:justifyfull_desc'] = 'Jafna';
$string['advanced:justifyleft_desc'] = 'Vinstrijafna';
$string['advanced:justifyright_desc'] = 'Hægrijafna';
$string['advanced:link_delta_height'] = '';
$string['advanced:link_delta_width'] = '';
$string['advanced:link_desc'] = 'Setja inn/breyta hlekk';
$string['advanced:more_colors'] = 'Fleiri litir';
$string['advanced:newdocument'] = 'Ertu viss um að þú viljir hreinsa allt?';
$string['advanced:newdocument_desc'] = 'Nýtt skjal';
$string['advanced:numlist_desc'] = 'Númeraður listi';
$string['advanced:outdent_desc'] = 'Draga út';
$string['advanced:paragraph'] = 'Málsgrein';
$string['advanced:paste_desc'] = 'Líma';
$string['advanced:path'] = 'Slóð';
$string['advanced:pre'] = 'Forsniðið';
$string['advanced:redo_desc'] = 'Endurtaka (Ctrl+Y)';
$string['advanced:removeformat_desc'] = 'Hreinsa snið';
$string['advanced:samp'] = 'Kóðadæmi';
$string['advanced:striketrough_desc'] = 'Yfirstrika';
$string['advanced:style_select'] = 'Stílsnið';
$string['advanced:sub_desc'] = 'Subscript';
$string['advanced:sup_desc'] = 'Superscript';
$string['advanced:toolbar_focus'] = 'Hoppa í tólastiku - Alt+Q, Hoppa í ritil - Alt-Z, Hoppa í slóð - Alt-X';
$string['advanced:underline_desc'] = 'Undirstrika (Ctrl+U)';
$string['advanced:undo_desc'] = 'Taka til baka (Ctrl+Z)';
$string['advanced:unlink_desc'] = 'Afhlekkja';
$string['advanced:visualaid_desc'] = 'Toggle guidelines/invisible elements';
$string['advanced_dlg:about_author'] = 'Höfundur';
$string['advanced_dlg:about_general'] = 'Um';
$string['advanced_dlg:about_help'] = 'Hjálp';
$string['advanced_dlg:about_license'] = 'Leyfi';
$string['advanced_dlg:about_loaded'] = 'Viðbætur í notkun';
$string['advanced_dlg:about_plugin'] = 'Viðbætur';
$string['advanced_dlg:about_plugins'] = 'Viðbætur';
$string['advanced_dlg:about_title'] = 'Um TinyMCE';
$string['advanced_dlg:about_version'] = 'Útgáfa';
$string['advanced_dlg:anchor_name'] = 'Nafn akkeris';
$string['advanced_dlg:anchor_title'] = 'Setja inn/breyta akkeri';
$string['advanced_dlg:charmap_title'] = 'Veldu tákn';
$string['advanced_dlg:code_title'] = 'HTML kóða ritill';
$string['advanced_dlg:code_wordwrap'] = 'Word wrap';
$string['advanced_dlg:colorpicker_color'] = 'Litur:';
$string['advanced_dlg:colorpicker_name'] = 'Nafn:';
$string['advanced_dlg:colorpicker_named_tab'] = 'Nefndir';
$string['advanced_dlg:colorpicker_named_title'] = 'Nefndir litir';
$string['advanced_dlg:colorpicker_palette_tab'] = 'Litaspjald';
$string['advanced_dlg:colorpicker_palette_title'] = 'Litir litaspjalds';
$string['advanced_dlg:colorpicker_picker_tab'] = 'Veljari';
$string['advanced_dlg:colorpicker_picker_title'] = 'Litaveljari';
$string['advanced_dlg:colorpicker_title'] = 'Veldu lit';
$string['advanced_dlg:image_align'] = 'Jöfnun';
$string['advanced_dlg:image_align_baseline'] = 'Baseline';
$string['advanced_dlg:image_align_bottom'] = 'Botn';
$string['advanced_dlg:image_align_left'] = 'Vinstri';
$string['advanced_dlg:image_align_middle'] = 'Miðja';
$string['advanced_dlg:image_align_right'] = 'Hægri';
$string['advanced_dlg:image_align_textbottom'] = 'Botn texta';
$string['advanced_dlg:image_align_texttop'] = 'Toppur texta';
$string['advanced_dlg:image_align_top'] = 'Toppur';
$string['advanced_dlg:image_alt'] = 'Lýsing myndar';
$string['advanced_dlg:image_border'] = 'Rammi';
$string['advanced_dlg:image_dimensions'] = 'Stærðir';
$string['advanced_dlg:image_hspace'] = 'Lárétt loftun';
$string['advanced_dlg:image_list'] = 'Myndalisti';
$string['advanced_dlg:image_src'] = 'Slóð myndar';
$string['advanced_dlg:image_title'] = 'Setja inn/breyta mynd';
$string['advanced_dlg:image_vspace'] = 'Lóðrétt loftun';
$string['advanced_dlg:link_is_email'] = 'Slóðin sem þú slóst inn virðist vera netfang, viltu bæta við mailto: forskeytinu?';
$string['advanced_dlg:link_is_external'] = 'Slóðin sem þú slóst inn virðist vera utanaðkomandi, viltu bæta við http:// forskeytinu?';
$string['advanced_dlg:link_list'] = 'Hlekkjalisti';
$string['advanced_dlg:link_target'] = 'Target';
$string['advanced_dlg:link_target_blank'] = 'Opna hlekk í nýjum glugga';
$string['advanced_dlg:link_target_same'] = 'Opna hlekk í sama glugga';
$string['advanced_dlg:link_title'] = 'Setja inn/breyta hlekk';
$string['advanced_dlg:link_titlefield'] = 'Titill';
$string['advanced_dlg:link_url'] = 'Slóð hlekks';
$string['advhr:advhr_desc'] = 'Horizontal rule';
$string['advhr:delta_height'] = '';
$string['advhr:delta_width'] = '';
$string['advhr_dlg:noshade'] = 'Enginn skuggi';
$string['advhr_dlg:size'] = 'Hæð';
$string['advhr_dlg:width'] = 'Breidd';
$string['advimage:delta_height'] = '';
$string['advimage:delta_width'] = '';
$string['advimage:image_desc'] = 'Setja inn/breyta mynd';
$string['advimage_dlg:align'] = 'Jöfnun';
...
$string['advimage_dlg:alt'] = 'Lýsing';
$string['advimage_dlg:alt_image'] = 'Önnur mynd';
$string['advimage_dlg:border'] = 'Rammi';
$string['advimage_dlg:classes'] = 'Klasar';
$string['advimage_dlg:constrain_proportions'] = 'Halda hlutföllum';
$string['advimage_dlg:dialog_title'] = 'Insert/edit image';
$string['advimage_dlg:dimensions'] = 'Stærðir';
$string['advimage_dlg:example_img'] = 'Appearance preview image';
$string['advimage_dlg:general'] = 'Almennt';
$string['advimage_dlg:hspace'] = 'Lárétt loftun';
$string['advimage_dlg:id'] = 'Id';
$string['advimage_dlg:image_list'] = 'Image list';
$string['advimage_dlg:langcode'] = 'Kóði tungumáls';
$string['advimage_dlg:langdir'] = 'Átt tungumáls';
$string['advimage_dlg:list'] = 'Myndalisti';
$string['advimage_dlg:long_desc'] = 'Löng lýsing á hlekki';
$string['advimage_dlg:ltr'] = 'Vinstri til hægri';
$string['advimage_dlg:map'] = 'Image map';
$string['advimage_dlg:misc'] = 'Ýmislegt';
...
$string['advimage_dlg:mouseout'] = 'þegar mús fer af';
$string['advimage_dlg:mouseover'] = 'þegar mús er yfir';
$string['advimage_dlg:preview'] = 'Forskoðun';
$string['advimage_dlg:rtl'] = 'Hægri til vinstri';
$string['advimage_dlg:src'] = 'Slóð á mynd';
$string['advimage_dlg:style'] = 'Stíll';
$string['advimage_dlg:swap_image'] = 'Skipta mynd út';
$string['advimage_dlg:tab_advanced'] = 'Nánar';
$string['advimage_dlg:tab_appearance'] = 'Útlit';
$string['advimage_dlg:tab_general'] = 'Almennt';
$string['advimage_dlg:title'] = 'Titill';
$string['advimage_dlg:vspace'] = 'Lóðrétt loftun';
...
$string['common:apply'] = 'Staðfesta';
$string['common:browse'] = 'Gramsa';
$string['common:cancel'] = 'Hætta við';
$string['common:class_name'] = 'Klasi';
$string['common:clipboard_msg'] = 'Afrita/Klippa/Líma er ekki aðgengilegt í Mozilla og Firefox eins og er.\\nViltu fá nánari upplýsingar?';
$string['common:clipboard_no_support'] = 'Ekki stutt í þínum vefskoðara, notaður flýtilykla í staðinn.';
$string['common:close'] = 'Loka';
$string['common:edit_confirm'] = 'Viltu nota WYSIWYG ritil fyrir þetta textasvæði?';
$string['common:insert'] = 'Setja inn';
$string['common:invalid_data'] = 'Villa: Vitlaus gildi slegin inn, þau eru merkt með rauðu.';
$string['common:more_colors'] = 'Fleiri litir';
$string['common:not_set'] = '-- Ekki skilgreint --';
$string['common:popup_blocked'] = 'Afsakið, uppsprettuvörnin þín (popup blocker) hefur blokkað glugga sem er hluti af ritlinum. Þú verður að slökkva á uppsprettuvörn til að geta notað þennan ritil.';
$string['common:update'] = 'Uppfæra';
$string['contextmenu:align'] = 'Jöfnun';
$string['contextmenu:center'] = 'Miðja';
$string['contextmenu:full'] = 'Full';
$string['contextmenu:left'] = 'Vinstri';
$string['contextmenu:right'] = 'Hægri';
$string['directionality:ltr_desc'] = 'Frá vinstri til hægri';
$string['directionality:rtl_desc'] = 'Frá hægri til vinstri';
$string['emotions:delta_height'] = '';
$string['emotions:delta_width'] = '';
$string['emotions:emotions_desc'] = 'Broskarlar';
$string['emotions_dlg:cool'] = 'Töff';
$string['emotions_dlg:cry'] = 'Grátandi';
$string['emotions_dlg:desc'] = 'Broskarlar';
$string['emotions_dlg:embarassed'] = 'Skammast sín';
$string['emotions_dlg:foot_in_mouth'] = 'Fótur í munni';
$string['emotions_dlg:frown'] = 'Frown';
$string['emotions_dlg:innocent'] = 'Saklaus';
$string['emotions_dlg:kiss'] = 'Koss';
$string['emotions_dlg:laughing'] = 'Hlægjandi';
$string['emotions_dlg:money_mouth'] = 'Peningamunnur';
$string['emotions_dlg:sealed'] = 'Rennilásamunnur';
$string['emotions_dlg:smile'] = 'Bros';
$string['emotions_dlg:surprised'] = 'Hissa';
$string['emotions_dlg:title'] = 'Setja inn broskall';
$string['emotions_dlg:tongue_out'] = 'Tungan út';
$string['emotions_dlg:undecided'] = 'Óákveðinn';
$string['emotions_dlg:wink'] = 'Wink';
$string['emotions_dlg:yell'] = 'Öskrandi';
...
$string['iespell:download'] = 'ieSpell fannst ekki. Viltu setja það inn núna?';
$string['iespell:iespell_desc'] = 'Lesa yfir';
$string['insertdatetime:date_fmt'] = '%%Y-%%m-%%d';
$string['insertdatetime:day_long'] = 'Sunnudagur,Mánudagur,Þriðjudagur,Miðvikudagur,Fimmtudagur,Föstudagur,Laugardagur,Sunnudagur';
$string['insertdatetime:day_short'] = 'Sun,Mán,Þri,Mið,Fim,Fös,Lau,Sun';
$string['insertdatetime:insertdate_desc'] = 'Setja inn dagsetningu';
$string['insertdatetime:inserttime_desc'] = 'Setja inn tímasetningu';
$string['insertdatetime:months_long'] = 'Janúar,Febrúar,Mars,Apríl,Maí,Júní,Júlí,Ágúst,September,Október,Nóvember,Desember';
$string['insertdatetime:months_short'] = 'Jan,Feb,Mar,Apr,Maí,Jún,Júl,Ágs,Sep,Okt,Nóv,Des';
$string['insertdatetime:time_fmt'] = '%%H:%%M:%%S';
$string['layer:absolute_desc'] = 'Taka af/setja á absolute positioning';
$string['layer:backward_desc'] = 'Færa afturfyrir';
$string['layer:content'] = 'Nýtt lag...';
$string['layer:forward_desc'] = 'Færa framfyrir';
$string['layer:insertlayer_desc'] = 'Setja inn nýtt lag';
...
$string['nonbreaking:nonbreaking_desc'] = 'Setja inn bil staf';
...
$string['preview:preview_desc'] = 'Forskoða';
$string['print:print_desc'] = 'Prenta';
$string['save:cancel_desc'] = 'Hætta við allar breytingar';
$string['save:save_desc'] = 'Vista';
$string['searchreplace:delta_height'] = '';
$string['searchreplace:delta_width'] = '';
$string['searchreplace:replace_desc'] = 'Finna/Skipta út';
$string['searchreplace:search_desc'] = 'Finna';
$string['searchreplace_dlg:allreplaced'] = 'Öllum niðurstöðum leitar var skipt út.';
$string['searchreplace_dlg:direction'] = 'Átt';
$string['searchreplace_dlg:down'] = 'Niður';
$string['searchreplace_dlg:findnext'] = 'Finna næsta';
$string['searchreplace_dlg:findwhat'] = 'Finna hvað';
$string['searchreplace_dlg:mcase'] = 'Match case';
$string['searchreplace_dlg:notfound'] = 'Leitinni er lokið. Leitarstrengurinn fannst ekki.';
$string['searchreplace_dlg:replace'] = 'Skipta út';
$string['searchreplace_dlg:replace_title'] = 'Finna/Skipta út';
$string['searchreplace_dlg:replaceall'] = 'Skipta út öllu';
$string['searchreplace_dlg:replacewith'] = 'Skipta út með';
$string['searchreplace_dlg:search_title'] = 'Finna';
$string['searchreplace_dlg:searchnext_desc'] = 'Finna aftur';
$string['searchreplace_dlg:up'] = 'Upp';
$string['simple:bold_desc'] = 'Feitletra (Ctrl+B)';
$string['simple:bullist_desc'] = 'Bólulisti';
$string['simple:cleanup_desc'] = 'Hreinsa skítugan kóða';
$string['simple:italic_desc'] = 'Skáletra (Ctrl+I)';
$string['simple:numlist_desc'] = 'Númeraður listi';
$string['simple:redo_desc'] = 'Endurtaka (Ctrl+Y)';
$string['simple:striketrough_desc'] = 'Yfirstrika';
$string['simple:underline_desc'] = 'Undirstrika (Ctrl+U)';
$string['simple:undo_desc'] = 'Taka til baka (Ctrl+Z)';
