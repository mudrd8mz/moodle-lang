...
$string['addinganewto'] = 'Bæti $a->what við $a->to';
...
$string['advancedfilter'] = 'Ítarleit';
...
$string['creatingscales'] = 'Mynda einkunnaskala';
$string['creatingsections'] = 'Mynda hluta';
$string['creatingtemporarystructures'] = 'Bý til tímabundnar formgerðir';
$string['creatingusers'] = 'Mynda notendur';
$string['creatingxmlfile'] = 'Mynda XML skrá';
...
$string['enrolperiod'] = 'Skráningartímabil';
...
$string['leavetokeep'] = 'Skildu óútfyllt til að halda núverandi lykilorði';
...
$string['nofilesselected'] = 'Engar skrár hafa verið valdar til endurköllunar';
...
$string['restore'] = 'Endurkalla';
$string['restorecancelled'] = 'Endurköllun afturkölluð';
$string['restorecoursenow'] = 'Endurkalla áfanga núna!';
...
$string['statsreport6'] = 'Allar aðgerðir kennara';
...
Ágætt er að byrja á því að uppfæra notendaskilgreininguna þína þannig að við höfum sem áreiðanlegastar upplýsingar um þig:
  ...
  $a->profileurl';
$string['whattocallzip'] = 'Hvað viltu nefna .zip skránna?';
...
$string['youaregoingtorestorefrom'] = 'Þú ert að hefja ferli fyrir endursetningu';
