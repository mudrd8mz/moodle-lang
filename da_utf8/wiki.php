...
$string['errversionsave'] = 'Desværre, mens du rettede denne side er der en anden som har rettet og gemt nogen ændringer. Gå venligst tilbage til den forrige side, kopier dine ændringer til computerens udklipsholder og indsæt det igen efter at du har opdateret redigeringssiden.';
...
$string['lockcancelled'] = 'Der er nogle der har ophævet låsningen på den side du er ved at rette. Hvis du ønsker at beholde det du har skrevet skal du kopiere det før du trykker Annuller og forsøger at rette igen.';
...
$string['nojslockwarning'] = 'Da javascript er slået fra i din browser er det muligt at andre kan ændre denne side. Hvis det sker kan du ikke gemme dine rettelser. Du kan enten foretage hurtige rettelser eller slå javascript til i din browser og opdater siden igen.';
$string['nolinksfound'] = 'Ingen links fundet på siden';
$string['noregexp'] = 'Dette skal være en afsluttet tekst (du kan ikke bruge * eller regex). I bedste tilfælde så brug angriberens IP-adresse eller hostname, men ikke portnummeret, da det bliver ændret ved hver http-tilgang.';
...
$string['pagelocked'] = '<p><strong>Denne side bliver rettet af $a->name.</strong> rettelsen blev påbegyndt $a->since og der er stadig et windue åben af $a->seen</p><p>Du bliver nødt til at vente til de er færdige med at foretage rettelser før du kan rette denne side.</p>';
...
$string['reloadlinkdescription'] = 'Genindlæs siden så alt nyt indhold vises';
$string['reloadlinktext'] = 'Genindlæs siden';
$string['removenotice'] = 'Note: Kun sider der ikke bliver refereret til vil blive vist her. Men fordi wikisystemet kun udfører en begrænset test, kan det være at den har overset nogen af dem her<br />Ligeledes vil blanke sider også blive vist her. Desuden vil der blive udført diverse database check.';
...
$string['thispageisntlinkedfromanywhereelse'] = 'Der er ingen link til denne side.';
...
$string['wiki:overridelock'] = 'Ophæv låste sider';
$string['wiki:participate'] = 'Ret wikisider';
