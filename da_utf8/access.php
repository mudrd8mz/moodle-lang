...
$string['accesshelp'] = 'Tilgængelighedshjælp';
$string['accesskey'] = 'Genvejstast, $a';
$string['accessstatement'] = 'Tilgængelighedsbeskrivelse';
...
$string['tabledata'] = 'Datatabel, $a';
$string['tablelayout'] = 'Layouttabel, $a';
