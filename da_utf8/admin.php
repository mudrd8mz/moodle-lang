...
$string['configallowoverride'] = 'Tillad rollerne til venstre at overskrive rollerne i hver kolonne.';
...
$string['configallowusermailcharset'] = 'Ved at aktivere dette, vil hver bruger være i stand til at vælge sit karaktersæt til brug i e-mail til sig selv fra Moodle.';
...
$string['configbloglevel'] = 'Med denne indstilling kan du begrænse fra hvilket niveau brugerblogge kan ses på dette site. Note that they specify the maximum context of the VIEWER not the poster or the types of blog posts. Blogge kan også deaktiveres helt hvis dét er meningen.';
...
$string['configdebug'] = 'Denne indstilling forårsager at PHP\'s fejlrapportering vil vise advarsler som fejl. Dette er hovedsagligt en indstillings til brug for udviklere.';
...
$string['configenableajax'] = 'Denne indstilling tillader brugen af AJAX (avanceret asynkron client/server interface vha. Javascript og XML) på hele sitet. 
Hvis denne indstilling er aktiveret kan brugere stadig fravælge brugen af AJAX, men vil som standard være aktiv.';
$string['configenablecourserequests'] = 'Dette vil tillade at alle brugere kan ønske at et kursus bliver oprettet.';
...
$string['configfilterall'] = 'Filtrer alle strenge, inklusiv overskrifter, titler, navigationsbar og så videre. Dette er mest brugbart når man bruger et flersproget filter, ellers vil det blot belaste sitet mere uden væsentlig gavn.';
...
$string['configfiltermatchonepertext'] = 'Automatisk linkfilter vil kun generere et link for første ord der matcher filtret i hver tekstblok på siden, (f.eks. resource, sideblok). Hvis der er flere forekomster vil disse blive ignoreret. Denne indstilling vil blive ignoreret hvis \"En pr. side\" er aktiveret.';
...
$string['configfrontpageloggedin'] = 'De her valgte elementer vil blive vist på sitets forside, når der er en bruger der er logget ind.';
$string['configfullnamedisplay'] = 'Dette definerer hvordan en brugers fulde navne skal vises. For de fleste ensprogede sites vil den mest effektive indstilling være \"Fornavn + Efternavn\". Man kan vælge at skjule fornavnet helt eller lade det være op til sprogpakken. (nogle sprog har forskellige opsætninger)';
...
$string['configgradebookroles'] = 'Denne indstilling gør det muligt at kontrollere hvem der kan ses i karakterbogen. Brugere bliver nødt til at have mindst een af disse roller i et kursus for at blive vist i karakterbogen for det kursus.';
...
$string['configintroadmin'] = 'På denne side skal du konfigurere din administratorkonto med hvilken du vil have fuld kontrol over sitet. Vær sikker på at bruge et sikkert brugernavn og adgangskode samt en brugbar e-mail-adresse. Du kan oprette flere administratorkonti senere.';
...
$string['configiplookup'] = 'Når du klikker på en IP-adresse (ex. 34.12.222.93), som i loggen, vises et kort med et bud på hvor den IP kommer fra. Du kan vælge mellem forskellige plugin hertil, hver har deres fordele og ulemper.';
...
$string['configlangmenu'] = 'Skal der vises en generel sprogmenu på forsiden, loginsiden osv. Dette påvirker ikke brugerens mulighed for at vælge et sprog tilknyttet deres egen profil.';
...
$string['configmymoodleredirect'] = 'Denne indstilling sender ikke administratorer til /my Moodle når de er logget ind og erstatter topelementet i brødkrummelinkene til /my Moodle';
...
$string['configperfdebug'] = 'Hvis du aktiverer dette vil parsetiden blive vist i bunden af siden i standard temaet.';
...
$string['configrestrictmodulesfor'] = 'Hvilke kurser skulle have <b>muligheden</b> for at begrænse nogle aktivitetsmoduler? Bemærk at denne indstilling kun vil gælde lærere, administratorer kan stadig tilføje enhver aktivitet til et kursus.';
...
$string['configsectionrequestedcourse'] = 'Kursusforespørgsler';
...
$string['configsitepolicy'] = 'Hvis der er nogle regler som brugerne skal læse og acceptere før de kan bruge sitet skal URL\'en angives her, i modsat fald kan den være blank. URL\'en kan pege hvorhen det skal være - et bekvemt sted kunne være en uploadet fil som f.eks. http://yoursite/file.php/1/policy.html';
...
$string['dbmigrateconnecerror'] = 'Kunne ikke få forbindelse til den specificeret database';
...
$string['dbmigratewarning'] = 'Vær sikker på at du har taget backup af din Moodle-database inden du fortsætter. Hvis ikke du er sikker på hvordan du gør det, så kontakt din systemadministrator. Dit Moodle-site vil sættes i vedligeholdelsestilstand efter du har begyndt flytningen.';
...
$string['defaultuserroleid'] = 'Standardrolle for alle brugere';
...
$string['errors'] = 'Fejl';
$string['errorsetting'] = 'Kunne ikke gemme indstilling:';
$string['errorwithsettings'] = 'Nogle indstillinger kunne ikke ændres som følge af en fejl:';
...
$string['invalidsection'] = 'Ugyldigt sektion.';
...
$string['langimport'] = 'Sprog importerings utility';
...
$string['locationsettings'] = 'Lokations indstilling';
$string['log'] = 'Logs';
...
$string['maxeditingtime'] = 'Maksimal tid til at rette forumindlæg';
...
$string['modulesecurity'] = 'Moodlesikkerhed';
...
$string['notloggedinroleid'] = 'Rolle for gæster';
...
$string['quarantinedir'] = 'Karaktæne bibliotek';
...
$string['upgradesure'] = 'Moodles filer er blevet ændret sitet skal til at udføre en automatik opgradering af serveren til version <p><b>$a</b></p>
...
$string['userpolicies'] = 'Bruger retttigheder';
...
$string['validateerror'] = 'Denne værdi er ikke korrekt:';
