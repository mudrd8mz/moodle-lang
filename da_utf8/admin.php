...
$string['bloglevel'] = 'Blog synlighed';
...
$string['calendar_weekend'] = 'Weekend dage';
...
$string['componentinstalled'] = 'Installeret komponenter';
$string['confeditorhidebuttons'] = 'Vælg de knapper der skal skjules i HTML editoren.';
$string['configallowassign'] = 'Tillad rollerne til venstre at tildele roller i hver kolonne.';
...
$string['configallowoverride'] = 'Tillad rolle til venstre at overskrive rollerne i hver kolonne.';
...
$string['configallowusermailcharset'] = 'Ved at aktivere dette, vil hver bruger være i stand til at vælge sit karaktersæt til brug i emails til sig selv fra moodle.';
...
$string['configdigestmailtime'] = 'Folk som har valgt at få tilsendt akkumulerede e-mails vil højst få én e-mail om dagen. Denne indstilling er til at kontrollere på hvilket tidspunkt af dagen den vil blive sendt. (det næste cronjob efter det tidspunkt vil mailen blive afsendt)';
$string['configdisplayloginfailures'] = 'Dette vil vise information til udvalgte brugere om mislykkede forsøg på login.';
$string['configdoctonewwindow'] = 'Hvis du aktivere dette, vil links til Moodle Docs blive vist i et nyt vindue.';
$string['configeditorfontlist'] = 'Vælg de skrifttyper der skal vises i HTML editorens drop-down liste.';
$string['configenableajax'] = 'Denne indstilling tillader brugen af AJAX (advanceret asynkron client/server interface vha. Javascript og XML) over hele sitet. 
...
$string['configenableglobalsearch'] = 'Denne indstilling tillader global tekstsøgning i resourcer og aktiviteter. Denne indstilling er ikke kompatibel med PHP4.';
...
$string['configfilterall'] = 'Filtrer alle strenge, inklusiv overskrifter, titler, navigations bar og så videre. Dette er mest brugbart når man bruger et flersproget filter, ellers vil det blot belaste sitet mere uden væsentlig forandring.';
$string['configfiltermatchoneperpage'] = 'Automatiske linkfiltre vil kun generere et link for det første ord på hele siden der passer. Hvis der er flere der passer vil de blive ignoreret.';
$string['configfiltermatchonepertext'] = 'Automatisk linkfilter vil kun generere et link for første ord der passer filtret i hver tekstblok på siden, (f.eks. resource, sideblok). Hvis der er flere forekomster vil disse blive ignoreret. Denne indstilling vil blive ignoreret hvis \"En pr. side\" er aktiveret.';
...
$string['configfrontpageloggedin'] = 'De her valgte elementer vil blive vist på sitets forside, når der er en bruger derer logget ind.';
$string['configfullnamedisplay'] = 'Dette definerer hvordan en brugers fulde navne skal vises. For de fleste ensprogede sites vil den mest effekttive indstilling være \"Fornavn + Efternavn\". Man kan vælge at skjule fornavnet helt eller lade det være op til sprogpakken. (nogle sprog har forskellige opsætninger)';
...
$string['configintro'] = 'På denne side kan du specificere et antal konfigurationsvariabler for at hjælpe Moodle at fungere på din server. Som regel fungerer standardværdierne fint og du kan altid ændre på dem senere.';
$string['configintroadmin'] = 'På denne side skal du konfigurere din administratorkonto med hvilken du vil have fuld kontrol over sitet. Vær sikker på at bruge et sikkert brugernavn og adgangskode samt en brugbar e-mail-adresse. Du kan oprette flere administratorkontoer senere.';
...
$string['configsitepolicy'] = 'Hvis der er nogle regler som brugerne skal læse og acceptere før de kan bruge sitet skal URL\'en angives her, i modsat fald kan den være blank. URL\'en kan pege hvorhen det skal være - et bekvemt sted kunne være en uploadetfil som f.eks. http://yoursite/file.php/1/policy.html';
...
$string['configstartwday'] = 'Begyndelse på uge';
$string['configstatsfirstrun'] = 'Dette angiver hvor langt tilbage logfiler skal behandles <b>første gang</b> cronjobbet ønsker at generere statistikken. Hvis der er en del trafik og siden befinder sig på en delt server, er det ikke en god ide at gå for langt tilbage, da det godt kan tage en del tid og er ret resourcekrævende. (ifm. denne indstilling er 1 måned=28 dage. I grafer og rapporter er 1måned = 1 kalendermåned.)';
...
$string['editorfontfamily'] = 'Skrifttype gruppe';
...
$string['extendedusernamechars'] = 'Tillad udvidede karaktere i brugernavne';
...
$string['forcetimezone'] = 'Gennemtving satandard tidszone';
...
$string['invalidsection'] = 'Ugyldigt valg.';
...
$string['langupdatecomplete'] = 'Sproogpakkeopdatering er færdig';
$string['latexpreamble'] = 'LaTeX Preamble';
$string['latexsettings'] = 'LaTeX render indstillinger';
$string['localetext'] = 'Sitets lokations indstilling';
...
$string['mustenablestats'] = 'Statistik er ikke blevet aktiveret for dette site.';
$string['mymoodle'] = 'Min Moodle';
$string['mymoodleredirect'] = 'Tving brugere til at bruge Min Moodle';
$string['nobookmarksforuser'] = 'Du har ikke nogen bogmærker';
$string['nolangupdateneeded'] = 'Alle dine sprogpakker er opdateret, der er ikke grund til opdatering.';
$string['nonewsettings'] = 'Der er ikke blevet tilføjet nogle nye indstillinger ved denne opdatering';
...
$string['notifyloginfailures'] = 'Email fejlslagne logins til';
$string['notifyloginthreshold'] = 'Begrænsning for emailmeddelser';
...
$string['restrictmodulesfor'] = 'Begræns moduler som';
...
$string['riskpersonal'] = 'Brugere kunne opnå adgang til private informationer for andre brugere.';
...
$string['sitemaintenanceoff'] = 'Vedligeholdelses tilstand er afsluttet og sitet fungerer normalt igen.';
...
$string['themesettings'] = 'Tema indstillinger';
...
$string['unbookmarkthispage'] = 'Fjern bogmærke fra denne side';
