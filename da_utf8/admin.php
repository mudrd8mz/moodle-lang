...
$string['allowdeletes'] = 'Tillad at slette';
...
$string['configallowcategorythemes'] = 'Aktiverer du dette kan der vælges layout på kategoriniveau. Det vil påvirke alle underliggende kategorier og kurser, der ikke har specificeret deres eget layout. ADVARSEL: Aktivering af kategorilayouts kan påvirke performancen.';
$string['configallowcoursethemes'] = 'Hvis du accepterer dette kan man vælge layout for hvert kursus. Kursuslayoutet bliver brugt lige meget hvad der ellers er valgt som layout (sitewide, bruger eller sessionslayouts).';
...
$string['configallowuserswitchrolestheycantassign'] = 'Som standard kræves moodle/role:assign hvis brugere skal kunne skifte rolle. Hvis indstillingen aktiveres fjernes dette krav og dropdown-menuen \"Skift rolle til\" vil indeholde de roller der alene bestemmes af indstillingerne i tabellen \"Tillad rolletildeling\".
Det anbefales at indstillingerne i tabellen \"Tillad rolletildeling\" ikke gør det muligt for brugere at skifte til en rolle der giver dem flere rettigheder end de har i kraft af deres eksisterende rolle.';
$string['configallowuserthemes'] = 'Hvis du tillader dette kan brugerne selv vælge hvilket layout de vil bruge. Brugerlayoutet bliver brugt selvom der er valgt et andet på siden (dog ikke hvis der er valgt et andet layout på kurset).';
...
$string['configauthenticationplugins'] = 'Vælg de godkendelsesplugins du vil bruge og arranger dem i \"failthrough\"-orden.';
...
$string['configcookiesecure'] = 'Hvis serveren kun aksepterer https-forbindelser anbefales det at aktivere sikre cookies. Hvis aktiveret bør du sikre at webserveren ikke accepterer http:// eller er sat op til permanent at viderestille til https://. Når  <em>wwwroot</em>-adressen ikke starter med https:// deaktiveres denne indstilling automatisk.';
...
$string['configcronclionly'] = 'Hvis dette er aktiveret vil cronscriptet kun kunne køres fra en kommandolinje i stedet fra via webben. Dette tilsidesætter crons adgangskodeindstilling herunder.';
...
$string['configeditordictionary'] = 'Denne værdi bruges hvis aspell ikke har en ordbog på brugeren eget sprog.';
...
$string['configemoticons'] = 'Rediger koden til venstre der relaterer til navnet på smileyen til højre. Der kan tilføjes smileys ved at tilføje en kode og et navn og derpå tilføje et billede med navnemønsteret navn.gif i /pix/s.';
...
$string['configenablestats'] = 'Hvis du vælger \'ja\' her vil Moodles cronjob behandle og indsamle statistik. Afhængig af mængden af trafik til dit site kan dette tage et stykke tid. Hvis du aktiverer denne funktion kan du se grafer og statistik om hvert kursus eller for hele sitet.';
...
$string['configquarantinedir'] = 'Hvis du ønsker at clam Antivirus skal flytte inficerede filer til en karantænemappe skal det skrives her. Det skal være skrivbart for webserveren. Hvis du lader dette felt være blankt, eller skriver en sti der ikke findes eller ikke kan skrives til, vil inficerede filer blive slettet. Der skal ikke nogen skråstreg i slutningen af stien.';
...
$string['configthemelist'] = 'Hvis dette felt er blankt kan brugeren vælge mellem alle layouts. Du kan begrænse udvalget ved at skrive en kommasepareret liste af layouts her f.eks. standard,orangewhite.';
...
$string['datarootsecuritywarning'] = 'Din sitekonfiguration er muligvis ikke sikker. Kontroller venligst at datamappen ($a) ikke kan tilgås direkte fra internettet.';
...
$string['notifyloginthreshold'] = 'Begrænsning for e-mail-meddelelser';
...
$string['quarantinedir'] = 'Karaktænemappe';
...
$string['remotelangnotavailable'] = 'Moodle kunne ikke komme i forbindelse med download.moodle.org så den automatiske installation af sprogpakken kunne ikke gennemføres. Du bliver nødt til selv at downloade sprogpakken fra nedestående liste, og manuelt kopiere den til din $a mappe og udpakke den der.';
...
$string['systempaths'] = 'Systemmapper';
