<?PHP // $Id$ 
      // workshop.php - created with Moodle 1.9.3+ (Build: 20081025) (2007101530)
...
$string['agreetothisassessment'] = 'Accepter denne vurdering';
...
$string['detailsofassessment'] = 'Vurderingsdetaljer';
$string['disagreewiththisassessment'] = 'Uenig i denne vurdering';
$string['displayofcurrentgrades'] = 'Visning af nuværende karakterer';
$string['displayoffinalgrades'] = 'Vis endelig karakter';
$string['displayofgrades'] = 'Visning af karakterer';
...
$string['generalcomment'] = 'Generel kommentar';
$string['good'] = 'Godt';
...
$string['gradeofsubmission'] = 'Karakter for aflevering: $a';
...
$string['gradetable'] = 'Karaktertabel';
$string['gradingallassessments'] = 'Bedømmer alle vurderinger';
$string['gradinggrade'] = 'Bedøm karakter';
$string['gradingstrategy'] = 'Karaktergivningsstrategi';
...
$string['mail4'] = '\'$a\' har tilføjet en kommentar til opgaven';
...
$string['numberofassessmentsweighted'] = 'Antal vurderinger (vægtet): $a';
...
$string['phase4'] = 'Tillad $a vurderinger';
...
$string['pleaseassessyoursubmissions'] = 'Vurder dine afleveringer';
$string['poor'] = 'Ringe';
...
$string['submitassignment'] = 'Aflever opgave';
...
$string['submitexampleassignment'] = 'Aflever opgaveeksempel';
...
$string['uploadsuccess'] = 'Uploadet';
$string['usepassword'] = 'Benyt adgangskode';
$string['verylax'] = 'Ringe';
$string['verypoor'] = 'Meget ringe';
$string['verystrict'] = 'Meget nøjagtigt';
$string['view'] = 'Vis';
