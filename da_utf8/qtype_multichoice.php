...
$string['answernumbering'] = 'Antal valgmuligheder?';
$string['answernumbering123'] = '1., 2., 3., ...';
$string['answernumberingABCD'] = 'A., B., C., ...';
$string['answernumberingabc'] = 'a., b., c., ...';
$string['answernumberingnone'] = 'Ingen nummerering';
$string['answersingleno'] = 'Flere mulige svar';
$string['answersingleyes'] = 'Kun ét svar';
$string['choiceno'] = 'Valg $a';
...
$string['overallfeedback'] = 'Feedback til spørgsmålet';
$string['overallincorrectfeedback'] = 'Tilbagemelding for alle forkerte svar.';
$string['overallpartiallycorrectfeedback'] = 'Tilbagemelding for alle delvist korrekte svar.';
$string['partiallycorrectfeedback'] = 'Respons på delvis rigtigt svar';
