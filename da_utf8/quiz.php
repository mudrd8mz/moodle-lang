...
$string['addingessay'] = 'Tilføjer stil';
...
$string['addingquestions'] = 'Til venstre på siden er en liste med de spørgsmål der er i quizzen. Spørgsmålene ligger i kategorier ovenfor. Som udgangspunkt kan et spørgsmål kun bruges i det kursus det er oprettet i, med mindre du gør kategorien \'offentlig\', tilgængelig for andre kurser. <br /><br />Efter at du har oprettet eller valgt en kategori kan du rette/oprette spørgsmål i den kategori. Du kan så vælge de spørgsmål der skal med i quizzen.<br /> Du kan også oprette spørgsmål med \'tilfældige spørgsmål\' som vælger et tilfældigt spørgsmål fra en kategori. <br />Når spørgsmålene er i quizzen skal de tildeles et maks. antal points som gives for spørgsmålet hvis svaret er 100%% korrekt.';
$string['addingrandom'] = 'Tilføjer tilfældigt spørgsmål';
$string['addingrandomsamatch'] = 'Tilføjer tilfældigt match-spørgsmål (sammenpas)';
$string['addingshortanswer'] = 'Tilføjer et kort svars-spørgsmål';
$string['addingtruefalse'] = 'Tilføjer sandt/falskt-spørgsmål';
...
$string['attemptsallowed'] = 'Flere forsøg';
...
$string['editingessay'] = 'Redigerer stil';
...
$string['gradeessays'] = 'Vurder stile';
...
$string['questioninuse'] = 'Spørgsmålet \"$a\" er foreløbig brugt:';
...
$string['remove'] = 'Fjern';
$string['removeallquizattempts'] = 'Slet alle quiz-forsøg';
$string['rename'] = 'Omdøb';
