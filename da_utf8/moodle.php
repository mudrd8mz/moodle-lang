...
$string['admin'] = 'Admin';
$string['adminbookmarks'] = 'Bogmærker';
...
$string['enrolmentkeyfromguest'] = 'Dette kursus har en \'kursusnøgle\', <br />som du som gæst skal bruge hver gang du skal ind på kurset. <br />Nøglen fås hos $a';
$string['enrolmentkeyhint'] = 'Forkert kursusnøgle - prøv igen<br /> (Her er et vink - det starter med \"$a\")';
...
$string['loginsteps'] = 'For at få fuld adgang til systemet skal du oprette en personlig profil. Hvert enkelt kursus kan også have en \"kursusnøgle\", den skal du først bruge senere. <b>Sådan gør du:</b> <ol> <li>Udfyld <a href=\"$a\">Ny Profil</a> formularen med dine oplysninger.</li> <li>En e-mail vil derefter blive sendt til din e-mail-adresse.</li> <li>Læs din e-mail og klik på det medfølgende link.</li> <li>Din profil bliver bekræftet og du bliver logget ind.</li> <li>Vælg derefter det kursus, som du vil deltage i.</li> <li>Hvis du bliver bedt om en \"kursusnøgle\" - brug den, som du har fået tilsendt eller oplyst. Det vil give dig adgang til kurset.</li><br /> <li>Du har nu fuld adgang til kurset og fra nu af skal du kun at bruge brugernavn og adgangskode for at logge ind.</li> </ol>';
