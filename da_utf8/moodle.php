...
$string['backupsavetohelp'] = 'Angiv den fulde sti til den mappe backupfilerne skal gemmes i.<br />(Lad feltet være blankt hvis du vil bruge standardstien)Næste';
...
$string['blockdeletefiles'] = 'Alle data tilknyttet blokken \'$a->block\' er blevet slettet fra databasen. For at fuldføre sletningen (og forhindre at blokken reinstallererer sig selv), bør du nu slette denne mappe fra serveren: $a->directory';
...
$string['clamquarantinedirfailed'] = 'Kan ikke flytte filen til den specificerede karantænemappe, $a. Du bliver nødt til at tage dig af problemet, da formodede inficerede filer bliver slettet som det er nu.';
