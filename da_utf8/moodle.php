...
$string['adminhelpmanagefilters'] = 'Vælg tekstfilter og relaterede indstillinger';
...
$string['adminhelpreports'] = 'Siteniveau rapporter';
...
$string['again'] = 'igen';
$string['aimid'] = 'AIM ID';
$string['ajaxno'] = 'Nej: benyt basale webfunktioner';
$string['ajaxuse'] = 'AJAX og Javascript';
$string['ajaxyes'] = 'Ja: Benyt avancerede webfunktioner';
$string['all'] = 'Alle';
...
$string['backupdetails'] = 'Backupdetaljer';
...
$string['backuplogshelp'] = 'Vælg om du ønsker at inkludere kursuslogfiler i backuppen';
...
$string['backupnonisowarning'] = 'Advarsel: Denne backup er fra en non-unicode version af Moodle (før version 1.6). Hvis backuppen indeholder tegn udenfor ISO-8859-1 tegnsættet, kan de risikere at blive forvanskede hvis du prøver at genskabe dem i denne unicode version af Moodle. Se <a href=\"http://docs.moodle.org/en/Backup_FAQ\">Backup FAQ</a> for mere information om hvordan man genskaber og konverterer denne backup korrekt.';
$string['backuporiginalname'] = 'Backupnavn';
$string['backuproleassignments'] = 'Tag backup af disse tildelte roller';
$string['backupsavetohelp'] = 'Angiv den fulde sti til den mappe backupfilerne skal gemmes i.<br />(Lad feltet være blankt hvis du vil bruge standardstien)';
$string['backupschedulehelp'] = 'Vælg hvilke dage i ugen at der skal foretages automatisk backup.';
$string['backupsitefileshelp'] = 'Aktiverer du denne indstilling vil site-filer der bruges i kurser, blive inkluderet i den automatiske backup';
...
$string['backupusershelp'] = 'Vælg om du ønsker at inkludere alle brugere på serveren eller kun de nødvendige brugere i kurset i backup\'en';
...
$string['blockdeletefiles'] = 'Alle data tilknyttet blokken \'$a->block\' er blevet slettet fra databasen. For at fuldføre sletningen (og forhindre at blokken reinstallererer sig selv), bør du nu slette denne mappe fra din server: $a->directory';
...
$string['checkinginstances'] = 'Kontrollerer instanser';
...
$string['city'] = 'By';
$string['clambroken'] = 'Din administrator har aktiveret viruskontrol for upload af filer, men har miskonfigureret noget<br />Din fil blev IKKE uploadet korrekt. Administrator har fået tilsendt en mail så det kan blive rettet<br />Du kan måske prøve at uploade filen senere.';
...
$string['clamlostandactinglikevirus'] = 'Derudover er Moodle konfigureret til at hvis Clam AV fejler, skal uploadede filer betragtes som virus. Det betyder i praksis at ingen studerende kan uploade filer før problemet er ordnet.';
$string['clammovedfile'] = 'Filen er blevet flyttet til den specificerede karantænemappe. Filen ligger nu i $a';
$string['clammovedfilebasic'] = 'Filen er blevet flyttet til karantænemappen';
$string['clamquarantinedirfailed'] = 'Kan ikke flytte filen til den specificerede karantænemappe, $a. Du bliver nødt til at tage dig af problemet, da formodede inficerede filer ellers bliver slettet.';
...
$string['comparelanguage'] = 'Sammenlign og rediger i sprog';
...
$a';
$string['courserejectreason'] = 'Skriv venligst årsagen til afslaget på kurset<br />(Den vil blive e-mailet til ansøgeren)';
...
$string['courserequestdetails'] = 'Detaljer om kurset du anmoder om';
...
$string['directorypaths'] = 'Mappesti';
...
I de fleste mail-programmer vises linket med blå skrift som du bare kan klikke på. Hvis det ikke virker så kopier adressen over i adressefeltet i toppen af dit browservindue.
...
<p>Den indeholder simple instruktioner til hvordan du godkender og gennemfører ændringen af dit kodeord. Hvis det alligevel giver problemer kan du altid kontakte underviseren eller administratoren, der også kan ændre din adgangskode. (men ikke se det nuværende)</p>';
...
$string['enrolenddaterror'] = 'Tilmeldingsdatoen kan ikke være før startdatoen';
...
$string['enrolmentkeyfrom'] = 'Dette kursus kræver en \"tilmeldingsnøgle\" - en engangskode <br />som du skulle have fået af $a';
...
$string['enrolmentnointernal'] = 'Manuel tilmelding er ikke mulig';
...
$string['expirynotifyemail'] = 'De følgende studerendes deltagelsesperiode på dette kursus udløber efter nøjagtig $a->threshold dage:

$a->current

De følgende studerendes deltagelsesperiode på dette kursus udløber om mindre end $a->threshold dage:

$a->past

Du kan gå ind på den følgende side for at forlænge deres deltagelsesperiode:
$a->extendurl';
...
$string['formattopicscss'] = 'Emneformat - CSS/Ingen html-tabeller';
$string['formatweeks'] = 'Ugeformat';
$string['formatweekscss'] = 'Ugeformat - CSS/Ingen html-tabeller';
...
$string['groupextendenrol'] = 'Forlæng deltagelsesperioden for alle';
...
$string['helphtml'] = 'Hvordan man skriver html';
...
$string['helptext'] = 'at skrive tekst i editoren';
...
$string['hiddensectionscollapsed'] = 'Skjulte emner/uger er vist sammenklappet';
...
$string['htmleditoravailable'] = 'Richtext-editoren er tilgængelig';
$string['htmleditordisabled'] = 'Du har slået Richtext-editoren fra i din brugerprofil';
$string['htmleditordisabledadmin'] = 'Administratoren har slået Richtext-editoren fra på dette site';
$string['htmleditordisabledbrowser'] = 'Richtext-editoren kan ikke bruges, da du ikke bruger Internet Explorer 5.5 eller nyere versioner';
...
$string['importmetacoursenote'] = 'Brug denne formular til at føje kurser til dit metakursus (dette vil importere tilmeldingerne).';
...
$string['loginsteps'] = 'For at få fuld adgang til systemet skal du oprette en personlig profil. Hvert enkelt kursus kan også have en \"tilmeldingsnøgle\", den skal du først bruge senere. <b>Sådan gør du:</b> <ol> <li>Udfyld <a href=\"$a\">Ny Profil</a>-formularen med dine oplysninger.</li> <li>En e-mail vil derefter blive sendt til din e-mail-adresse.</li> <li>Læs din e-mail og klik på det medfølgende link.</li> <li>Din profil bliver bekræftet og du bliver logget ind.</li> <li>Vælg derefter det kursus, som du vil deltage i.</li> <li>Hvis du bliver bedt om en \"tilmeldingsnøgle\" skal du bruge den, som du har fået tilsendt eller oplyst. Det vil give dig adgang til kurset.</li><br /> <li>Du har nu fuld adgang til kurset og fra nu af skal du kun at bruge brugernavn og adgangskode for at logge ind.</li> </ol>';
$string['loginstepsnone'] = '<p>Hej!</p> <p>For at få fuld adgang til kurset er du nødt til at oprette en profil.</p> <p>Det du skal gøre er: <ol><li>Find på et brugernavn og en adgangskode du kan huske.</li> <li>Skrive det i loginfelterne: brugernavn og adgangskode.</li> <li>Da brugernavnet er nyt vil du få mulighed for at oprette en profil.</li></ol> </p> <p>Hvis andre allerede har valgt dit brugernavn, er du nødt til at prøve igen med et andet.</p>';
...
$string['metaalreadycourses'] = 'Allerede tilføjede kurser';
...
$string['missingrecaptchachallengefield'] = 'Mangler reCAPTCHA-felt';
...
$string['moduledeletefiles'] = 'Alle data der tilhører modulet \'$a->module\' er blevet slettet fra databasen. For at afslutte sletningen (og forhindre at de reinstallerer sig selv) bør du nu slette mappen \'$a->directory\' fra din server.';
...
$string['mustconfirm'] = 'Du skal bekræfte dit login';
...
$string['newpasswordfromlost'] = '<strong>NOTE:</strong> Din <strong>nuværende adgangskode</strong> er sendt til dig i den
<strong>anden</strong> af de to e-mails der er en del af glemt-adgangskode-processen. 
Vær sikker på at du har fået din nye adgangskode før du fortsætter med denne side.';
...
I de fleste mail-programmer kommer det op som et blåt link, som du kan klikke på. Hvis det ikke virker, kan du kopiere og indsætte URL\'en i adressefeltet i toppen af din browser. 
...
og du har fået tildelt en midlertidig adgangskode. 
...
I de fleste mail-programmer vises overstående link med blåt, der indikerer at du kan følge det ved at klikke på det. Hvis det ikke virker kan du kopiere det over i adressefeltet i en browser.
...
$string['noexistingadmins'] = 'Ingen eksisterende administratorer. En alvorlig fejl er opstået og du burde ikke have set denne meddelelse.';
...
$string['nopendingcourses'] = 'Der er ingen kurser der afventer godkendelse';
...
$string['nosuchemail'] = 'E-mail-adressen eksisterer ikke';
...
<p>Den nye adgangskode er genereret automatisk, så du vil måske
   <a href=\"=$a->link\">ændre den til noget, som du nemmere kan huske</a>.</p>';
...
$string['publicdirectory'] = 'Offentlig mappe';
...
$string['publicsitefileswarning2'] = 'Bemærk: Filer, der ses her, kan tilgås af enhver, der kender (eller gætter) URL\'en. Af sikkerhedsmæssige årsager anbefales det at alle backup-filer slettes efter de er gendannet.';
...
$string['restoretositeadding'] = 'Advarsel: Du er lige ved at gendanne til forsiden og tilføje data til det eksisterende indhold!';
...
$string['scalestip2'] = 'Opret en ny skala under punktet \"Point\" i kursets administrationsmenu, vælg \"Skalaer, Vis\" og klik på knappen: \"Tilføj ny skala\".';
...
$string['selectednowmove'] = '$a filer er bestemt til at skulle flyttes. Find destinationsmappen og tryk på \'Flyt filer hertil\'';
...
$string['uploadnofilefound'] = 'Ingen fil fundet - er du sikker på at du har valgt en at uploade? (måske var den for stor i forhold til en begrænsning?)';
...
$string['usernameexists'] = 'Dette brugernavn eksisterer allerede, vælg venligst et andet';
...
$string['userprofilefor'] = 'Brugerprofil for $a';
...
$string['warningdeleteresource'] = 'Advarsel: $a er refereret til som en ressource. Ønsker du at opdatere  ressourcen?';
...
$string['writingblogsinfo'] = 'Skriver bolgs-info';
...
$string['writinggroupingsinfo'] = 'Skriver gruppe-info';
