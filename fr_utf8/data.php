...
$string['csvimporthelptext'] = 'Le format de fichier attendu est un fichier texte comportant sur la première ligne la liste des noms des différents champs. Les données elles-mêmes sont placées sur les lignes suivantes, une fiche par ligne. Par défaut, le séparateur est une virgule et aucun identificateur de texte n\'est défini (les identificateurs de textes sont placés au début et à la fin d\'un champ, par exemple le caractère "). Les fiches sont séparées par des fins de lignes (générées habituellenent en tapant RETOUR ou ENTRÉE dans votre éditeur de texte). Les réglages par défauts peuvent être modifiés&nbsp;: le caractère de tabulation peut être spècifié ainsi \\\\t et les fins de lignes ainsi \\\\n. Actuellement, l\'utilitaire d\'importation ne fonctionne pas totalement pour les champs de types suivants&nbsp;: fichier, image, URL.';
$string['csvimporthelptitle'] = 'Aide&nbsp;: importer un fichier CSV dans le module Base de données';
...
$string['fielddelimiter'] = 'Séparateur de champs&nbsp;:';
