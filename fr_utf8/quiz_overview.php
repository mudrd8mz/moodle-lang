...
$string['regradealldrydogroup'] = 'Ré-évaluer les tentatives ($a->countregradeneeded) marquées comme devant être ré-évaluée dans le groupe «&nbsp;$a->groupname&nbsp;»';
$string['regradealldrygroup'] = 'Ré-évaluer complètement le group «&nbsp;$a->groupname&nbsp;» à blanc';
