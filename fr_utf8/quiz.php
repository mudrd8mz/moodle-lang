...
$string['confirmstartattemptlimit'] = 'Ce test est limité à $a tentatives. L\'accès au test sera compté comme une tentative. Voulez-vous continuer&nbsp;?';
...
$string['filloutoneanswer'] = 'Vous devez donner au moins une proposition.<br />Les propositions laissées vides ne seront pas prises en compte. Le caractère « * » peut être utilisé comme joker pour représenter n\'importe quel caractère. La première réponse correspondant au critère sera utilisée pour déterminer la note et le feedback.';
...
$string['reordertool'] = 'Afficher l\'outil de classement';
...
$string['shufflewithin'] = 'Mélanger parmi les questions';
