...
$string['addnewquestionsqbank'] = 'Ajouter des questions à la catégorie $a dans l\'outil «&nbsp;Contenu de la banque de questions&nbsp;» >>';
...
$string['addrandomquestiontoquiz'] = 'Ajouter question aléatoire au test $a';
...
$string['areyousuredeleteselected'] = 'Voulez-vous vraiment supprimer les questions sélectionnées&nbsp;?';
...
$string['basicideasofquiz'] = 'Idées de base pour faire des tests';
...
$string['cannoteditafterattempts'] = 'Vous ne pouvez pas ajouter ou retirer des questions, car il y a déjà des tentatives.';
...
$string['configpopup'] = 'Utiliser des astuces JavaScript pour essayer d\'empêcher le copier/coller, etc. durant les tentatives de tests.';
...
$string['fromcategory'] = 'Depuis la catégorie';
...
$string['moveselectedonpage'] = 'Déplacer les questions sélectionner vers la page';
...
$string['questionsperpageselected'] = 'Le nombre de questions par page a été spécifié, de sorte que la pagination est fixe. C\'est pourquoi les outils de pagination sont désactivés. Vous pouvez changer ceci dans ';
...
$string['shufflequestionsselected'] = '* Le mélange des questions a été indiqué, de sorte que l\'ordre des questions est aléatoire. C\'est pourquoi le bouton Réordonner les questions a été désactivé. Vous pouvez changer ceci dans ';
...
$string['totalpoints'] = 'Total des notes';
