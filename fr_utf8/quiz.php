...
$string['addnewquestionsqbank'] = 'Ajouter des questions à la catégorie $a dans l\'outil «&nbsp;Contenu de la banque de questions&nbsp;» $a->arrow';
...
$string['shufflequestionsselected'] = '* Le mélange des questions a été indiqué, de sorte que l\'ordre des questions est aléatoire. C\'est pourquoi le bouton Réordonner les questions a été désactivé. Vous pouvez changer ceci dans $a';
