...
$string['configgradeletter'] = 'Une lettre ou autre symbole utilisé pour représenter un intervalle de notes. Laissez ce champ vide pour utiliser les réglages par défaut du site (actuellement $a).';
...
$string['configstudentsperpage'] = 'Le nombre de participants à afficher par page dans le rapport de l\'évaluateur. Laissez ce champ vide pour utiliser le réglage par défaut du site (actuellement $a).';
