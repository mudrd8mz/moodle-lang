...
$string['configgrandtotalsdisplaytype'] = 'Les totaux généraux peuvent être affichés comme notes brutes ou comme pourcentages (par rapport aux notes maximale et minimale).';
...
$string['configshowcalculations'] = 'Afficher une icône de calculatrice à côté de chaque élément de note et chaque catégories, les bulles d\'aide sur les éléments calculés et un indicateur visuel montrant qu\'une colonne est calculée.';
...
$string['configshowgrandtotals'] = 'Afficher les totaux généraux dans le rapport de l\'évaluateur.';
...
$string['configshowfeedback'] = 'Afficher une icône de feedback (pour ajout/modification) à côté de chaque note&nbsp;?';
...
$string['showgrandtotals'] = 'Afficher les totaux généraux';
$string['sort'] = 'Trier';
