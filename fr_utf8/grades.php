...
$string['configgradedisplaytype'] = 'Les notes peuvent être affichées comme notes brutes ou comme pourcentages (relativement aux notes maximale et minimale).';
