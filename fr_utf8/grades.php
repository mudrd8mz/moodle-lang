...
$string['configaveragesdisplaytype'] = 'Les moyennes de colonnes peuvent être affichées comme notes brutes ou comme pourcentages (relativement aux notes maximale et minimale).';
