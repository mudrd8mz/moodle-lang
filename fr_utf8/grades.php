...
$string['configaveragesdisplaytype'] = 'Spécifie la façon d\'afficher les moyennes de chaque colonne dans le rapport de l\'évaluateur. La façon conseillée et proposée par défaut est «&nbsp;Hériter&nbsp;», qui vérifie d\'abord le type d\'affichage de chacune des colonnes, et si celui-ci n\'est pas spécifié, utilise le type d\'affichage général. Si vous indiquez «&nbsp;Brut&nbsp;» ou «&nbsp;Pourcentage&nbsp;», les réglages d\'affichage de chaque colonne sont ignorés.';
...
$string['hidecalculations'] = 'Cacher calculs';
$string['hidecategory'] = 'Caché';
$string['hideeyecons'] = 'Cacher icônes afficher/cacher';
$string['hideaverages'] = 'Cacher moyennes';
$string['hidegroups'] = 'Cacher groupes';
...
$string['showaverages'] = 'Afficher les moyennes de colonnes';
