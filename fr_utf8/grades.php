...
$string['confighiddenasdate'] = 'Si l\'utilisateur n\'a pas le droit de voir les notes cachées, afficher la date au lieu d\'un tiret.';
...
$string['hidden'] = 'Caché';
$string['hiddenasdate'] = 'Afficher la date pour les notes cachées';
