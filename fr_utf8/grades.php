...
$string['gradeitemislocked'] = 'La note de cette activité est verrouillée dans le carnet de notes. Si vous la ré-évaluez, les notes données à l\'activité seront différentes de celles indiquées dans le carnet de notes, et celles-ci ne seront pas modifiées. Voulez-vous vraiment effectuer une nouvelle évaluation&nbsp;?';
