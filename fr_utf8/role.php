...
$string['deleterolesure'] = '<p>Vouvlez-vous vraiment supprimer le rôle «&nbsp;$a->name ($a->shortname)&nbsp;»&nbsp;?</p><p>Ce rôle est actuellement attribué à $a->count utilisateurs.</p>';
...
$string['resetrolesure'] = '<p>Voulez-vous vraiment revenir aux réglages par défaut du rôle «&nbsp;$a->name ($a->shortname)&nbsp;»&nbsp;?</p><p>Ces réglages sont repris de l\'ancien rôle sélectionné.</p>';
