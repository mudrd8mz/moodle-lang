...
$string['hidden'] = 'Caché';
$string['highlightedcellshowsinherit'] = 'Les cellules en surbrillance dans le tableau ci-dessous indiquent s\'il y a lieu la permission qui sera héritée. À part les capacités dont vous voulez modifier les permissions, il est suggéré de laisser le tout sur Hériter.';
$string['highlightedcellshowsdefault'] = 'Les cellules en surbrillance dans le tableau ci-dessous indiquent la permission par défaut pour ce type de rôle.';
...
$string['notabletooverrideroleshere'] = 'Vous ne pouvez pas définir ici de permissions pour aucun rôle';
