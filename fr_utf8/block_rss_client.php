...
$string['addnewfeed'] = 'Ajouter un fil';
...
$string['editafeed'] = 'Modifier un fil';
$string['editfeeds'] = 'Modifier, s\'abonner ou se désabonner d\'un fil RSS/';
$string['editnewsfeeds'] = 'Modifier les fils RSS';
$string['editrssblock'] = 'Modifier le bloc manchette RSS';
$string['errorloadingfeed'] = 'Erreur lors du chargement de ce fil RSS ($a)';
$string['feed'] = 'Fil RSS';
...
$string['feedsconfigurenewinstance2'] = 'Cliquer l\'icône de modification ci-dessus pour configurer ce bloc afin d\'afficher des fils RSS.';
$string['feedstitle'] = 'Fils RSS';
$string['feedupdated'] = 'Le fil RSS a été modifié';
$string['feedurl'] = 'URL du fil';
$string['findmorefeeds'] = 'Rechercher d\'autres fils RSS';
$string['managefeeds'] = 'Gérer tous mes fils RSS';
$string['numentries'] = 'Articles par fil';
$string['nofeeds'] = 'Il n\'y a pas de fil RSS défini sur ce site.';
$string['pickfeed'] = 'Choisir un fil RSS';
$string['remotenewsfeed'] = 'Fils RSS distants';
...
$string['timeout'] = 'Durée en minutes avant l\'expiration d\'un fil RSS en cache. Cette durée définit le laps de temps minimal avant expiration. Le fil sera mis à jour lors de l\'exécution du cron après expiration. Valeur recommandée : 30 min ou plus.';
...
$string['viewfeed'] = 'Afficher le fil';
