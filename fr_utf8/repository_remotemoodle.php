...
$string['repositoryname'] = 'Fichiers sur Moodle distant';
$string['repositorydesc'] = 'Dépôt sur un serveur Moodle distant';
$string['notitle'] = 'Sans titre';
$string['peer'] = 'Pair';
$string['remember'] = 'Se souvenir de moi';
$string['emptyfilelist'] = 'Aucun fichier à afficher';
$string['remoterep_name'] = 'Dépôt Moodle distant';
$string['remoterep_description'] = 'Permettre la découverte du service<br /><br />';
