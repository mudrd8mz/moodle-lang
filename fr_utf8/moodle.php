...
$string['adminhelpassigncreators'] = 'Les créateurs de cours peuvent créer de nouveaux cours et y enseigner';
...
$string['backupnoneusersinfo'] = 'Remarque : vous avez choisi de ne sauvegarder aucun utilisateur. En conséquence, les sauvegardes de tous les modules ont été placées en mode « sans les données des utilisateurs ». Veuillez remarquer que les modules Exercice et Atelier ne sont pas compatibles avec ce type de sauvegarde. Ils ont donc été totalement exclus de la sauvegarde.';
...
$string['coursecreators'] = 'Créateurs de cours';
$string['coursecreatorsdescription'] = 'Les créateurs des cours peuvent créer de nouveaux cours et y enseigner.';
...
$string['coursehelpnumberweeks'] = 'Nombre de semaines ou de thèmes affichés sur la page principale du cours.';
...
$string['coursehelpmaximumupload'] = 'Définit la taille maximale de chaque fichier pouvant être déposé dans le cours par les étudiants. Le maximum est limité par un réglage analogue au niveau du site.';
...
$string['editorhelptopics'] = 'Thèmes de l\'aide de l\'éditeur.';
...
$string['enrolmentkeyfromguest'] = 'Ce cours nécessite une clef d\'inscription. En tant que visiteur anonyme,<br />vous devrez la saisir chaque fois que vous entrez dans le cours. Vous devez obtenir cette clef de $a';
...
$string['publicsitefileswarning3'] = 'Remarque : les fichiers déposés ici sont accessibles par tous ceux qui connaissent (ou devinent) l\'URL. Pour des raisons de sécurité, les fichiers de sauvegarde ne doivent être enregistré que dans le dossier sécurisé « backupdata ».';
