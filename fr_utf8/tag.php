...
$string['helprelatedtags'] = 'Tags reliés, séparées par des virgules';
$string['id'] = 'id';
...
$string['ptags'] = 'Tags personnels (séparées par des virgules)';
$string['relatedblogs'] = 'Articles de blog les plus récents avec le tag «&nbsp;$a&nbsp;»';
...
$string['tag'] = 'Tag';
$string['tagindex_coursetitle'] = 'Cours avec le tag «&nbsp;$a&nbsp;»';
