...
$string['check_passwordsaltmain_details'] = '<p>Il est fortement recommandé de définir un sel de mot de passe, qui réduit considérablement les possibilités de vol de mot de passe.<br />Pour définir un sel de mot de passe, ajouter la ligne ci-dessous à votre fichier config.php.</p><code>\$CFG->passwordsaltmain = \'une_très_longue_chaîne_de_caractères_aléatoires#@6&*1\';</code><p>La chaîne de caractères aléatoires doit être un mélange de lettres, de chiffres et d\'autres caractères.</p><p>Si vous modifiez votre sel de mot de passe, assurez vous de conserver l\'ancienne valeur dans le fichier config.php. Il peut y avoir 20 sels différents simultanément. Sans l\'ancienne valeur parmi tous les sels définis, certains utilisateurs ne pourront plus se connecter et verront leur mot de passe réinitialisé.<br /><code>\$CFG->passwordsaltalt1 = \'valeur_précédente_du_sel_de_mot_de_passe\';</code><br /></p>';
