...
$string['cannotmovecate'] = 'Impossible de déplacer la catégorie $newname. C\'est la dernière de ce contexte.';
...
$string['novirtualquestion'] = 'Il n\'y a pas de type de question virtuelle pour les questions de type $a';
