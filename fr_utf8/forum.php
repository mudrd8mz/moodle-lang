...
$string['configajaxrating'] = 'Une fois ce réglage activé, les utilisateurs peuvent évaluer les messages des forums avec AJAX (requiert l\'activation de AJAX pour le site et l\'utilisateur)';
...
$string['everyoneisnowsubscribed'] = 'Tout le monde est maintenant abonné à ce forum';
$string['existingsubscribers'] = 'Abonnés actuels';
$string['forcessubscribe'] = 'Tout le monde est obligatoirement abonné à ce forum';
...
$string['forum:startdiscussion'] = 'Commencer des discussions';
