...
$string['configajaxrating'] = 'Avbec ce réglage, les utilisateurs peuvent évaluer les messages des forums avec AJAX (requiert l\'activation de AJAX pour le site et l\'utilisateur)';
