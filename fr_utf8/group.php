...
$string['namingschemehelp'] = 'Utilisez le caractère «&nbsp;@&nbsp;» pour représenter la lettre du groupe (A-Z) ou «&nbsp;#&nbsp;» pour représenter le numéro du groupe';
...
$string['nosmallgroups'] = 'Évier le dernier petit groupe';
