...
$string['invalidnumkey'] = 'Le tableau $conditions ne doit pas contenir de clef numériques. Veuillez corriger le code&nbsp;!';
...
$string['invalidqueryparam'] = 'Erreur&nbsp;: nombre de paramètres incorrect dans la requête&nbsp;!';
...
$string['localfilecannotcreatefiledirs'] = 'Impossible de créer les dossiers de la collection locale de fichiers. Veuillez vérifier les permissions du dossier de données.';
$string['localfilecannotread'] = 'Impossible de lire le fichier. Soit il n\'existe pas, soit il y a un problème de permissions';
$string['localfilenotcreated'] = 'Impossible de créer le fichier «&nbsp;$a->contextid/$a->filearea/$a->itemid/$a->filepath/$a->filename&nbsp;»';
$string['localfileproblem'] = 'Exception inconnue en rapport avec les fichiers locaux ($a)';
...
$string['typenotimplement'] = 'À FAIRE&nbsp:: ce type n\'est pas implémenté';
