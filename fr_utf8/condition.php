...
$string['grade_atleast'] = 'doit être &ge;';
$string['grade_upto'] = 'et &lt;';
...
$string['requires_date'] = 'Non disponible avant le $a.';
$string['requires_date_before'] = 'Non disponible après le $a.';
