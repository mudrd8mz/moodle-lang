...
$string['configstripalltitletags'] = 'Par défaut, toutes les balises HTML sont retirées des titres de toutes les activités, messages, articles de blogs, etc. Désactivez cette option si vous voulez autoriser les balises HTML dans le nom des activités.';
