...
$string['allowuserswitchrolestheycantassign'] = 'Autoriser les utilisateurs sans la capacité d\'attribuer des rôles à basculer vers d\'autres rôles';
...
$string['configenablegroupings'] = 'Ce réglage active les groupements (groupes de groupes) et l\'option « Disponible pour les membres du groupe ». Les groupements sont standards à partir de la version 2.0 de Moodle.';
...
$string['configpasswordpolicy'] = 'Après activation de ce réglage, Moodle vérifiera si les mots de passe sont conformes aux règles définies. Utilisez les réglages ci-dessous pour spécifier vos règles (longueur, types des caractères, etc.)';
...
$string['enablegroupings'] = 'Activer les groupements et la fonctionnalité « Disponible pour les membres du groupe »';
...
$string['forceloginforprofileimage'] = 'Imposer la connexion pour voir les avatars des utilisateurs';
$string['forceloginforprofileimage_help'] = 'Si ce réglage est activé, les utilisateurs devront se connecter pour voir les avatars des utilisateurs et l\'avatar par défaut sera utilisé dans les messages envoyés par courriel.';
...
$string['intlrecommended'] = 'L\'installation de l\'extension Intl de PHP est utilisée pour améliorer le support de l\'internationalisation, par exemple pour les tris alphabétiques.';
...
$string['loginpasswordautocomplete'] = 'Empêcher le remplissage automatique du mot de passe dans le formulaire de connexion';
$string['loginpasswordautocomplete_help'] = 'La désactivation de ce réglage permet aux utilisateurs d\'enregistrer leur mot de passe dans le navigateur. Si le réglage est activé, le site ne passera plus la validation XHTML stricte.';
...
$string['soaprecommended'] = 'L\'installation de l\'extension PHP soap est utile pour les services web et d\'autres modules contribués.';
