...
$string['configlocale'] = 'Choisir un environnement pour l\'affichage des dates. Ce choix annulera le réglage automatique des formats pour toutes les langues du site (les noms des jours du calendrier ne seront pas affectés). Les données de cet environnement doivent être installées sur le serveur. Si vous ne savez pas quel environnement choisir, laissez ce champ vide.';
