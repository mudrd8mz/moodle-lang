...
$string['configdebugstringids'] = 'Ce réglage est destiné à aider les traducteurs de Moodle. Il indique le nom du fichier de langue ainsi que l\'identifiant de chaîne à côté de chaque chaîne de caractères affichée. Si vous modifiez ce réglage, le changement ne prendra pas effet sur la page indiquant « Modifications enregistrées », mais partout à partir de ce moment-là.';
