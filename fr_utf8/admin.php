...
$string['allowbeforeblock'] = 'La liste des adresses IP permises est traitée avant';
...
$string['allowbeforeblockdesc'] = 'Par défaut, la listes des adresses IP bloquées est traitée en premier. Lorsque cette option est activée, la liste des adresses IP autorisées sera traitée en premier.';
...
$string['configbloglevel'] = 'Ce réglage permet de restreindre le niveau auquel les blogs des utilisateurs peuvent être consultés sur ce site. Veuillez remarquer que ce réglage indique le contexte maximal de la personne qui CONSULTE le blog, et non l\'auteur, ni le type des messages de blog. Les blogs peuvent également être désactivés, si vous ne les voulez pas du tout.';
...
$string['configemailchangeconfirmation'] = 'Exige une confirmation par courriel lors du changement d\'adresse de courriel par les utilisateurs.';
...
$string['configforceloginforprofiles'] = 'L\'activation de ce réglage impose aux visiteurs de se connecter en tant qu\'utilisateur réel (pas invité) pour pouvoir consulter les profils des autres utilisateurs. Si vous le désactivez, il pourra arriver que certains utilisateurs utilisent leur profil pour y inclure de la publicité (spam) ou d\'autres contenus inadéquats, qui seront alors visible par tout le monde.';
...
$string['configsendcoursewelcomemessage'] = 'Si ce réglage est activé, les utilisateurs recevront un message de bienvenue après leur inscription dans un cours.';
...
$string['configstripalltitletags'] = 'Par défaut, toutes les balises HTML sont retirées des titres de toutes les activités, messages, articles de blogs, etc. Désactivez cette option si vous voulez autoriser les balises HTML dans les nom des activités.';
...
$string['stripalltitletags'] = 'Retirer les balises HTML de tous les titres';
