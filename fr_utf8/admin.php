...
$string['upgrade197notice'] = '<p>Moodle 1.9.7 comporte un certain nombre de correctifs de sécurité dans les mots de passe utilisateur et le processus de sauvegarde et restauration, afin de protéger les informations des utilisateurs sur votre site.<br />En conséquence, certains de vos réglages et permissions en lien avec les sauvegardes peuvent avoir été modifiés.<br />Veuillez consulter les <a href=\'http://docs.moodle.org/en/Moodle_1.9.7_release_notes\' target=\'_blank\'>Notes de mise à jour à Moodle 1.9.7</a> pour tous les détails.</p>';
$string['upgrade197noticesubject'] = 'Notes de sécurité liées à la mise à jour à Moodle 1.9.7';
$string['upgrade197salt'] = 'Il est également fortement recommandé de définir un sel de mot de passe afin de réduire de façon importante le risque de vol de mot de passe.<br />Veuillez vous référer au rapport de sécurité de Moodle pour plus d\'information à ce sujet. Le rapport de sécurité peut être affiché en vous connectant à votre site en tant qu\'administrateur et en consultant Administration du site -> Sécurité -> Règles du site';
