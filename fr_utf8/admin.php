...
$string['configstatscatdepth'] = 'Le code des statistiques utilise une logique simplifiée pour les inscriptions aux cours. Les dérogations sont ignorées et le nombre de catégories mères véfifiées est limité. Le nombre 0 signifie une détection directe des attributions de rôles au niveau du site et des cours. Le nombre 1 indique de détecter également les attributions de rôles dans la catégorie parente du cours, etc. Des nombres plus élevés génèrent une charge plus élevée de la base de données lors du calcul des statistiques.';
...
$string['configstatsmaxruntime2'] = 'Le traitement des statistiques peut être très intensif. Veuillez indiquée la durée maximale permise pour la récolte des statistiques d\'une journée. Le nombre maximum de jours traités durant l\'exécution d\'un cron est 3.';
