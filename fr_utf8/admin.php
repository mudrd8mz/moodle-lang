...
$string['configlocale'] = 'Indiquer un environnement <em>locale</em> pour l\'affichage des dates. Laissez ce champ vide, sauf si vous avez une très bonne raison de faire autrement. Si le champ est renseigné, l\'environnement spécifié sera utilisé pour toutes les langues du site et empêchera l\'adaptation automatique de l\'affichage des dates en fonction de la langue choisie par l\'utilisateur.';
