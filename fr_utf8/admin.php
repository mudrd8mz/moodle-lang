...
$string['enableallowedip'] = 'Activer la limitation des clients par adresse IP';
$string['enableallowedipdesc'] = 'Lorsque cette option est activée, seules les adresses IP de la liste des IP autorisées peuvent accéder au site et les adresses IP de la liste des IP bloquées ne peuvent pas accéder au site.';
...
$string['ipinblockedlist'] = 'Ce site n\'est actuellement pas accessible.';
$string['ipoutallowedlist'] = 'Ce site n\'est actuellement pas accessible.';
