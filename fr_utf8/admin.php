...
$string['configauthenticationplugins'] = 'Veuillez choisir les méthodes d\'authentification que vous voulez utiliser et les arranger dans l\'ordre de vérification désiré. L\'auto-enregistrement sera géré par la méthode sélectionnée dans le menu déroulant adéquat ci-dessous (c\'est habituellement «&nbsp;Authentification par courriel&nbsp;»).';
...
$string['curlrecommended'] = 'L\'installation de la bibliothèque optionnelle Curl est très recommandée, afin de pouvoir utiliser la fonctionnalité Réseau Moodle.';
