...
$string['iconvrequired'] = 'L\'installation de la bibliothèque ICONV est requise.';
...
$string['upgrade197salt'] = 'Il est également fortement recommandé de définir un sel de mot de passe afin de réduire de façon importante le risque de vol de mot de passe.<br />Veuillez vous référer à la <a href=\"$a\" target=\"_blank\">documentation sur le sel de mot de passe</a> pour plus d\'informations à ce sujet.';
