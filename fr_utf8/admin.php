...
$string['configeditordictionary'] = 'Cette valeur sera utilisée si aucun dictionnaire dans la langue de l\'utilisteur n\'est disponible pour aspell.';
...
$string['configmemcachedhosts'] = 'Lors de l\'utilisation de <i>memcached</i>. Liste des serveurs sur lesquels tourne le démon <i>memcached</i>, séparés par des virgules. Indiquer des adresses IP pour éviter les lenteurs du DNS. Si vous ajouter ou retirer des serveurs d\'une configuration en activité, <i>memcached</i> ne fonctionnera pas bien.';
$string['configmemcachedpconn'] = 'Lors de l\'utilisation de <i>memcached</i>. Utiliser des connexions persistentes. À utiliser avec circonspection&nbsp;: Apache/PHP peut se planter après redémarrage du démon <i>memcached</i>.';
