...
$string['configenablegroupings'] = 'Ce réglage active les groupements (groupes de groupes). L\'implémentation n\'est pas encore totalement terminée.';
...
$string['configgdversion'] = 'Indiquer la version de la librairie GD qui est installée. La version sélectionnée par défaut est celle qui a été détectée. Ne pas modifier cette valeur à moins de savoir réellement ce qui en découle.';
...
$string['configkeeptagnamecase'] = 'Cocher cette option si vous désirez que les noms des balises conservent leur casse originale, telle que saisie par les utilisateurs qui les crééent.';
...
$string['keeptagnamecase'] = 'Conserver la casse des balises';
...
$string['langpackupdated'] = 'Le paquetage de langue $a a été correctement mise à jour';
