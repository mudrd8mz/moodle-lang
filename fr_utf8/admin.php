...
$string['configextrauserselectorfields'] = 'Lors de la sélection d\'utilisateurs, par exemple lors de l\'attribution des rôles ou l\'ajout à des groupes, ces champs seront affichés dans la liste des utilisateurs et inclus dans les recherches en plus des noms complets. Pour des raisons de sécurité, il n\'est pas conseillé de cocher le nom d\'utilisateur.';
...
$string['configmemorylimit'] = 'Ce réglage spécifie la taille maximale de mémoire qu\'un script peut allouer. Cette option est appliquée aux scripts d\'indexation de la recherche, de sauvegarde et de restauration, ainsi qu\'au script admin/health.';
...
$string['memorylimit'] = 'Limite de mémoire PHP';
...
$string['webserviceprotocols'] = 'Serveurs services web';
$string['webservicesystemsettings'] = 'Réglages communs';
$string['webserviceusersettings'] = 'Réglages utilisateurs des services web';
