...
$string['configcachetype'] = 'Choisissez un type de cache pour Moodle. Cela ne configurera que la cache. N\'oubliez pas d\'activer <i>rcache</i> pour que le cache soit utilisé pour quelque chose. Cette option est à utiliser <strong>uniquement</strong> si vous devez réduire la charge sur le système de base de données. Si ce n\'est pas le cas, Moodle fonctionnera plus lentement. Les sites servant un trafic moyen verront une mélioration en utilisant l\'option «&nbsp;Interne&nbsp;». Si votre serveur web est installé avec eAccelerator ou Turckmmcache <em>avec les options de partage de mémoire activées,</em> essayez «&nbsp;eaccelerator&nbsp;». Si votre Moodle tourne sur plusieurs serveurs, qu\'un ou plusieurs démons memcached fonctionnent et que l\'extension PHP-memcached est activée, choisissez «&nbsp;memcached&nbsp;» et configurez les options memached ci-dessous.<br /><strong>Attention&nbsp;!:</strong> Effectuez des tests de performance en charge et modifez les réglages en conséquence&nbsp;: les caches peuvent rallentir votre serveur. Si votre serveur sert un trafic élevé, eAccelerator et memcached peuvent apporter le plus d\'amélioration, mais la charge en terme d\'utilisation des processeurs du serveur web augmentera.';
...
$string['configdefaultuserroleid'] = 'Tous les utilisateurs connectés auront les capacités du rôle spécifié ici, au niveau du site, EN PLUS de celles de tous les autres rôles qu\'ils ont déjà. Par défaut, il s\'agit du rôle «&nbsp;Invité&nbsp;». Il est à remarquer que cela n\'entrera pas en conflit avec les autres rôles disponibles&nbsp;: cela autorise simplement tous les utilisateurs à consulter les ressources, les messages des forums, etc. au niveau du site.';
...
$string['configmemcachedhosts'] = 'Pour memcached. Liste des serveurs sur lesquels tourne le démon memcached, séparés par des virgules. Indiquer des adresses IP pour éviter les lenteurs du DNS. Si vous ajouter ou retirer des serveurs d\'une configuration en activité, memcached ne fonctionnera pas bien.';
$string['configmemcachedpconn'] = 'Pour memcached. Utiliser des connexions persistentes. À utiliser avec circonspection&nbsp;: Apache/PHP peut se planter après redémarrage du démon memcached.';
...
$string['confignonmetacoursesyncroleids'] = 'Par défaut, toutes les inscriptions des cours fils sont synchronisés dans les méta-cours. Les rôles désignés ici ne seront pas inclus dans le processus de synchronisation.';
...
$string['configrcachettl'] = 'Durée de vie des enregistrements en cache, en secondes. Utiliser ici une valeur brève (&lt;15).';
...
$string['profilefieldtypemenu'] = 'Menu de choix';
...
$string['profilenofieldsdefined'] = 'Aucune champ n\'a été défini';
...
$string['profilevisiblenone'] = 'Pas visible';
