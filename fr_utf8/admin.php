...
$string['configextrauserselectorfields'] = 'Lors de la sélection d\'utilisateurs, par exemple lors de l\'attribution des rôles ou l\'ajout à des groupes, ces champs seront affichés dans la liste des utilisateurs et inclus dans les recherches. Pour des raisons de sécurité, il n\'est pas conseillé de cocher le nom d\'utilisateur.';
...
$string['configprofilesforenrolledusersonly'] = '<ul><li>Lors de l\'affichage du profil, si l\'identifiant de cours (courseid) n\'est pas défini (il s\'agit de l\'affichage public) ET si l\'utilisateur n\'est inscrit dans aucun cours ET si cette option est activée, la description du profil est remplacée par un texte générique.</li><li>Lors de la modification du profil, si la description est vide ET si l\'utilisateur n\'est inscrit dans aucun cours ET si cette option est activée, la description du profil n\'est pas affichée du tout.</li></ul>';
