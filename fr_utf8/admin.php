...
$string['configallowassign'] = 'Permettre aux rôles de la colonne de gauche d\'assigner les rôles de chaque colonne';
...
$string['configenabletrusttext'] = 'Par défaut, Moodle nettoie soigneusement tous les fichiers déposés et textes saisis par les utilisateurs, afin d\'en retirer les éventuels scripts, médias, etc. pouvant entraîner une faille de sécurité. Le système «&nbsp;Contenu fiable&mbsp;» vous permet de donner à certains utilisateurs en qui vous avez confiance la capacité d\'inclure sans interférence de tels éléments dans leurs contenus. Pour faire fonctionner ce système, veuillez d\'abord l\'activer ici, puis attribuer la capacité «&nbsp;Se fier aux contenus&nbsp;» à un rôle spécifique de Moodle. Les textes créés ou déposés par des utilisateurs ayant ce rôle seront marqués comme fiables et ne seront alors pas nettoyés avant leur affichage.';
