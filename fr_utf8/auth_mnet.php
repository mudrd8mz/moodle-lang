...
$string['sso_idp_description'] = 'La publication de ce service permet à vos utilisateurs d\'utiliser le site Moodle $a sans devoir s\'y reconnecter.<ul><li><em>Dépendance</em>&nbsp;: vous devez aussi vous <strong>abonner</strong> au service SSO (fournisseur de service) sur $a.</li></ul><br /> L\'abonnement à ce service permet à des utilisateurs authentifiés par le serveur $a d\'accéder à votre site devoir sans se reconnecter.<ul><li><em>Dépendance</em>&nbsp;: vous devez aussi <strong>publier</strong> le service SSO (fournisseur de service) de $a.</li></ul><br />';
