...
$string['overrideinfo'] = 'Vous pouvez passer ouvre le verrouillage d\'édition de cet utilisateur, mais il risque alors de perdre les modifications qu\'il a affectuées.';
...
$string['reloadlinkdescription'] = 'Rafraîchit la page, afin que les modifications soient affichées.';
$string['reloadlinktext'] = 'Rafraîchir l\'affichage';
