...
$string['displayhotpotnext'] = 'Afficher ensuite un test Hot Potatoes';
...
$string['hotpot:view'] = 'Utiliser les tests Hot Potatoes';
...
$string['quizunavailable'] = 'Le test n\'est pas disponible en ce moment';
