...
$string['hidetocdesc'] = 'Ce réglage détermine si par défaut la structure du cours (table des matières) doit être affichée ou non';
...
$string['popupblocked'] = 'Si une nouvelle fenêtre n\'apparaît pas, cliquez $a pour lancer l\'activité';
$string['popupblockedlinkname'] = 'ici';
