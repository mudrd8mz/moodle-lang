...
$string['adminhelpstickyblocks'] = '\'Sticky\' blokeaak Moodleren bidez konfiguratu';
...
$string['backupmetacoursehelp'] = 'Indarrean jarriz gero, metaikastaroaren informazioa (jasotako matrikulazioak) ziurtasun-kopia automatikoetan sartuko da';
...
$string['clammovedfile'] = 'El archivo ha sido movido al directorio de cuarentena que usted ha especificado, y su nueva ubicaci�n es $a';
...
<p>Mezu honek pasahitza-aldaketa egin eta baieztatzeko argibide erraz batzuk dauzka.
Arazorik bazenu, administrariarekin harremanetan jarrir.</p>';
...
<p>Pasahitz berria automatikoki sortu egin da.
...
$string['missingreqreason'] = 'Escribir: raz�n';
...
$string['noreplybouncemessage'] = '\'no-reply\' helbide batera erantzun duzu. Eztabaida-taldeko mezu bati erantzuten saiatu bazara, eztabaida taldeak erabili $a.
...
$string['sitepartlist1'] = 'Partaideen zerrenda ikusteko, guneko irakaslea izan behar duzu';
$string['sites'] = 'Guneak';
...
$string['statsreport2'] = 'Ikuspenak (irakasle eta ikaslea)';
$string['statsreport3'] = 'Mezuak (irakaslea eta ikasleak)';
$string['statsreport4'] = 'Aktibitate osoa (irakaslea eta ikasleak))';
$string['statsreport5'] = 'Ikaslearen aktibitate osoa (ikuspen eta mezuak)';
$string['statsreport6'] = 'Irakaslearen aktibitate osoa (ikuspen eta mezuak)';
...
$string['statsreportactivity'] = 'Aktibitate osoa (irakaslea eta ikasleak))';
$string['statsreportforuser'] = 'norentzat';
$string['statsreportlogins'] = 'Sarrerak';
$string['statsreportreads'] = 'Ikuspenak (irakasle eta ikaslea)';
$string['statsreportstudentactivity'] = 'Ikaslearen aktibitate osoa (ikuspen eta mezuak)';
$string['statsreportteacheractivity'] = 'Irakaslearen aktibitate osoa (ikuspen eta mezuak)';
$string['statsreporttype'] = 'Txosten mota';
$string['statsreportwrites'] = 'Mezuak (irakaslea eta ikasleak)';
...
$string['strftimedate'] = '%%Y(e)ko %%Bren %%d';
$string['strftimedateshort'] = '%%Bren %%d';
$string['strftimedatetime'] = '%%Y(e)ko %%Bren %%d, %%H:%%M';
$string['strftimedaydate'] = '%%A, %%Y(e)ko %%Bren %%d';
$string['strftimedaydatetime'] = '%%A, %%Y(e)ko %%Bren %%d, %%H:%%M';
$string['strftimedayshort'] = '%%A, %%Bren %%d';
$string['strftimedaytime'] = '%%a, %%H:%%M';
$string['strftimemonthyear'] = '%%Y(e)ko %%B';
$string['strftimerecent'] = '%%Bren %%d, %%H:%%M';
$string['strftimerecentfull'] = '%%a, %%Y(e)ko %%Bren %%d, %%H:%%M';
...
$string['teacherroles'] = '$a (r)en paperak';
