...
$string['add'] = 'Gehitu';
$string['addactivity'] = 'Jarduera gaineratu';
$string['addadmin'] = 'Administratzailea gaineratu';
$string['addcreator'] = 'Ikastaro sortzailea gaineratu';
$string['added'] = '$a gaineratuta';
$string['addedrecip'] = 'Hartzaile berria gaineratuta: $a';
$string['addedrecips'] = 'Hartzaile berriak gaineratuta:s $a';
$string['addedtogroup'] = 'Gaineratu talde honetara: $a';
$string['addedtogroupnot'] = 'Talde honetara gaineratu gabe: $a';
$string['addedtogroupnotenrolled'] = 'Talde honetara gaineratu gabe: $a. Ikastaro honetan izena eman gabea.';
$string['addinganew'] = '$a berri bat gaineratzen';
$string['addinganewto'] = '$a berri bat gaineratzen hona: $a';
$string['addingdatatoexisting'] = 'Datu berriak gaineratzen';
$string['addnewcategory'] = 'Kategoria berria gaineratu';
$string['addnewcourse'] = 'Ikastaro berria gaineratu';
$string['addnewuser'] = 'Erabiltzaile berria gaineratu';
$string['addnousersrecip'] = 'Honetan sartu ez diren erabiltzaileak hartzaileen zerrendara gaineratu: $a';
$string['addresource'] = 'Baliabidea gaineratu';
$string['address'] = 'Helbidea';
$string['addstudent'] = 'Ikaslea gaineratu';
$string['addteacher'] = 'Tutorea gaineratu';
$string['admin'] = 'Kudeatzailea';
$string['adminbookmarks'] = 'Kudeatzailearen markak';
...
$string['adminhelpassigncreators'] = 'Sortzaileek ikastaro berriak sor ditzakete eta horietan irakatsi';
...
$string['adminhelpassignteachers'] = 'Ikastaroa bilatu eta irudia erabili irakasleak gaineratzeko';
...
$string['adminhelphealthcenter'] = 'Gunearen arazoak automatikoki detektatu';
...
$string['adminhelpstickyblocks'] = '\'Sticky\' blokeak Moodleren bidez konfiguratu';
...
$string['adminhelpxmldbeditor'] = 'XMLDB fitxategiak editatzeko interfaza. Garatzaileentzat bakarrik.';
...
$string['adminprimarynoedit'] = 'Lehen administrarien pasahitza ezin duzu aldatu';
...
$string['aimid'] = 'ID AIM';
$string['ajaxno'] = 'Ez: erabili oinarrizko web ezaugarriak';
$string['ajaxuse'] = 'AJAX eta Javascript';
$string['ajaxyes'] = 'Bai: erabili web ezaugarri aurreratuak';
$string['all'] = 'Guztia(k)';
...
$string['alphanumerical'] = 'Alfabetoaren letrak eta zenbakiak, besterik ezin da erabili';
...
$string['backtoparticipants'] = 'Partaideen zerrendara itzuli';
...
$string['backupschedulehelp'] = 'Erabaki asteko zein egunetan egingo diren segurtasun-kopia automatikoak';
...
$string['clambroken'] = 'Zure administrariak igotako fitxategien birusen ikuskaketa indarrean jarri da, baina zerbait gaizki konfiguratuta dago.<br />Fitxategin EZIN izan dira igo. Zure administrariari mezua bidali zaio arazoa zuzen dezan.<br />Fitxategia beranduago igotzen saia zaitez, mesedez.';
...
$string['coresystem'] = 'Sistemaren muina';
$string['cost'] = 'Koste';
$string['costdefault'] = 'Lehenetsitako kostea';
$string['counteditems'] = '$a->count $a->items';
$string['country'] = 'Herria';
$string['course'] = 'Ikastaroa';
$string['courseapprovedemail'] = 'Eskatu duzun ikastaroa, $a->name, eta zu $a->teacher izendatua izan zara. Zure ikastaro berrira sartzeko hona joan: $a->url';
...
$string['coursecreatorsdescription'] = 'Ikastaro sortzaileek ikastaro berriak sor ditzakete eta horietan irakatsi';
...
$string['courseimportnotaught'] = 'Ez dirudi beste ikastaroetan edizio-baimenik duzunik (ezin duzu beste ikastaroetatik inportatu).';
...
$string['coursereject'] = 'Ikastaro-eskaera gaitzetsi';
...
$string['creatingblocksroles'] = 'Bloke mailako rol ezarpenak eta indargabetzeak sortzen';
...
$string['creatingcourseroles'] = 'Ikastaro mailako rol ezarpenak eta indargabetzeak sortzen';
...
$string['creatinguserroles'] = 'Erabiltzaile mailako rol ezarpenak eta indargabetzeak sortzen';
$string['creatingusers'] = 'Erabiltzaileak sortzen';
$string['creatingxmlfile'] = 'XML fitxategia sortzen';
$string['currency'] = 'Txanponak';
...
$string['defaultcourseteacherdescription'] = 'Tutoreek edozer egin dezakete ikastaro batean, baita ikasleen jarduerak eta kalifikazioak aldatu ere.';
...
$string['deselectall'] = 'Ez ezer aukeratu';
...
$string['edhelpbgcolor'] = 'Edizio-eremuaren hondo-kolorea definitu.<br />Balio onargarriak hauexek izan daitezke, adibidez: #ffffff o \'white\'';
$string['edhelpcleanword'] = 'Egokipen honek Wordeko formato-filtroa aktibatu edo desaktibatzen du.';
...
Prozesua bukatu eta pasahitz berria e-mailez jaso ahal izateko,
helbide honetara jo, mesedez:

$a->link

E-mail aplikazio gehienetan aurreko
...
$string['enrolenddate'] = 'Muga data';
$string['enrolenddaterror'] = 'Matrikulazio-bukaera da ezin da hasierakoa baina lehenagokoa';
$string['enrollable'] = 'Ikastaro irekia';
...
$string['enrolmentend'] = 'Matrikulazioa amaitzen da';
$string['enrolmentkey'] = 'Partaide giltza';
$string['enrolmentkeyfrom'] = 'Ikastaro honek \'Partaide giltza\' bat behar du. Matrikulatuta egon behar duzu sartu ahal izateko.<br>
$a (e)k bidali beharko zizukeen';
...
$string['enrolmentnointernal'] = 'Eskuko matrikulazioak ez daude indarrean';
$string['enrolmentnotyet'] = 'Barkatu, ezin duzu izena eman ikastaro honetan ondorengo datara arte: <br /> $a';
$string['enrolmentplugins'] = 'Matrikulazio-pluginak';
$string['enrolments'] = 'Izen-ematea';
$string['enrolmentstart'] = 'Matrikulazio hasia';
...
$string['enteremailaddress'] = 'Zeure helbide eltronikoa idatzi, mesedez. 
Pasahitz berria bidaliko dizugu .';
...
$string['expirynotify'] = 'Matrikulazioaren bukaera-dataren oharra';
$string['expirynotifyemail'] = 'Ikastaro honetako ikasle hauen matrikula egun hauek barru amaituko da:  $a->threshold :

$a->current

Ikastaro honetako ikasle hauen matrikula egun hauek baino lehenago amaituko da $a->threshold :

$a->past

Matrikula-epea luzatzeko helbide honetara joan behar duzu:
$a->extendurl';
...
$string['extendenrol'] = 'Matrikulazioa luzatu';
...
$string['firstdayofweek'] = 'Asteko lehen eguna';
...
$string['forcepasswordchangenotice'] = 'Jarraitzeko zure pasahitza aldatu.';
...
$string['formatscorm'] = 'SCORM formatua';
...
$string['formattopicsajax'] = 'Gai formatua - AJAX';
$string['formatweeks'] = 'Aste formatua';
$string['formatweekscss'] = 'Aste formatua - CSS/Taularik gabea';
$string['formatwiki'] = 'Wiki motako formatua';
$string['from'] = 'Nondik';
$string['frontpagecategorycombo'] = 'Combo zerrrenda';
...
Informazio zehatzagorako GNU lizentzia ikusi:
...
$string['healthproblemsolution'] = 'Osasun-arazoaren soluziobidea aurkitu da';
$string['healthreturntomain'] = 'Jarraitu';
$string['healthsolution'] = 'Soluzioa';
$string['help'] = 'Laguntza';
$string['helpemoticons'] = 'Irudiak erabili (emoticons)';
...
$string['importactivities'] = 'Beste ikastaroko baliabideak inportatu';
$string['importdata'] = 'Inportatu ikastaroko datuak';
$string['importdataexported'] = 'Ikastaroko datuak ongi esportatu dira.<br />Zure ikastarora inportatzen jarraitu.';
...
$string['importgroups'] = 'Taldeak inportatu';
$string['importmetacoursenote'] = 'Formulario hau zure metaikastarora ikastaroak inportatzeko erabili (matrikulak inportatuko dira)';
...
$string['includemodules'] = 'Moduloak sartu';
...
$string['includenoneusers'] = 'Erabiltzaileak ez sartu';
...
$string['liketologin'] = 'Erabiltzaile kontu osoarekin orain sartu nahi al duzu?';
...
$string['managemeta'] = 'Hau metaikastaroa al da?';
$string['managemetadisabled'] = 'Ikastaro hau metaikastaroa delako indargabetu da';
$string['managemetaexplan'] = '(Honek matrikulazioak beste ikastaroetatik heredatu direla esan nahi du)';
...
$string['messagedselectedusersfailed'] = 'Aukeratutako erabiltzaileei mezua bidaltzerakoan zerbait gaizki joan da. Baliteke batzuek mezua jaso izana.';
$string['messageselect'] = 'Erabiltzaile hau mezuaren hartzaile bezala aukeratu';
$string['messageselectadd'] = 'Mezua erantsi/bidali';
$string['metaaddcourse'] = 'Ikastaroa erantsi';
$string['metaalreadycourses'] = 'Ikastaro jadanik egokituak';
$string['metaalreadyhascourses'] = 'Metaikastaro honek bigarren mailako ikastaroak baditu.';
$string['metaalreadyhasenrolments'] = 'Metaikastaro honek ohiko matrikulazioak baditu.';
$string['metaalreadyinmeta'] = 'Ikastaro hau metaikastaro baten partea da.';
$string['metaassigncourses'] = 'Ikastaroak esleitu';
$string['metacourse'] = 'Metaikastaroa';
$string['metanoalreadycourses'] = 'Ez da ikastarorik esleitu';
...
$string['moduledeleteconfirm'] = '\'$a\' moduloa ezabatzear zaude. Ekintza horrek ikastaro horri dagokion guztia ezabatuko du datu-basetik. Jarraitu nahi duzula ZIUR al zaude?';
$string['moduledeletefiles'] = '\'$a->module\' moduloarekin lotutako datu guztiak datu-basetik ezabatu dira. Prozesua osatzeko (eta moduloak bere burua berriz ez instalatzeko) $a->directory direktorioa zure zerbitzaritik ezabatu behar duzu.';
...
$string['more'] = 'gehiago';
$string['moreinformation'] = 'Infomazio geiago errore honi buruz';
...
Horrela ez bada, helbidea kopiatu eta zure web nabigatzailearen goikaldean dagoen
...
$string['nomoreidnumber'] = 'Indentifikazio-zenbakirik ez da erabiltzen arazoak sahiesteko';
$string['none'] = 'Bat ere ez';
$string['noneditingteacher'] = 'Edizio-baimenik ez duen tutorea';
$string['noneditingteacherdescription'] = 'Editatzeko baimenik gabeko irakasleek ikastaroetan irakas dezakete eta ikasleak kalifikatu baina ezin dituzte jarduerak aldatu.';
...
$string['noreplybouncemessage'] = '\'no-reply\' helbide batera erantzun duzu. Eztabaida-taldeko mezu bati erantzuten saiatu bazara, $a eztabaida taldeak erabili.
...
$string['nostatstodisplay'] = 'Ez dago erakusteko daturik.';
...
$string['notenrollable'] = 'Oraingoz ikastaro honek ez du matrikulaziorik onartzen.';
...
$string['noteuserschangednonetocourse'] = 'Oharra: Ebiltzaileen datuak berrezarritakoan ikastaroetako erabiltzaileak ere berrezarri beharra dago (ekintza, fitxategi edo mezuetan). Konfigurazio hau zuretzat aldatu da.';
...
$string['notifyloginfailuressubject'] = '$a :: Sarrera okerren gastigua';
...
$string['passwordforgotteninstructions'] = 'Zure �abardurak lehenik erabiltzaile datu-basean bilatu behar dira. Zure erabiltzaile-izena edo e-mail helbidea idatzi dagokion lekuan idatzi, mesedez. Biak idaztea ez da beharrezkoa.';
$string['passwordnohelp'] = 'Ezin izan da galdu duzun pasahitza aurkitu. Moodleren administrariarekin harremanetan jarri, mesedez.';
...
$string['policyagree'] = 'Webgune honetan jarritu aurretik baldintzekin ados egon behar duzu. Ados al zaude?';
$string['policyagreement'] = 'Gunearen baldintzen akordioa';
$string['policyagreementclick'] = 'Gunearen baldintzak irakurtzeko klik egin';
...
$string['registrationcontactyes'] = 'Bai, Moodleren formularioa nahi dut nirekin harremanetan jar daitezen';
...
$string['registrationno'] = 'Ez dut e-mailez gastigurik jaso nahi';
$string['registrationsend'] = 'Nire erregistro-informazioa moodle.org-era bidali';
$string['registrationyes'] = 'Bai, gastiguak e-mailez bidal iezazkidazu';
$string['reject'] = 'Utzi';
$string['remove'] = 'Kendu';
...
$string['scheduledbackupstatus'] = 'Programatutako segurtasun-kopiaren egoera';
$string['screenshot'] = 'Pantailakada';
...
$string['selectall'] = 'Dena aukeratu';
$string['selectamodule'] = 'Baliabide-moduloren bat aukeratu, mesedez';
...
$string['showactions'] = 'Ekintzak erakutsi';
...
$string['statsreport5'] = 'Ikaslearen aktibitate osoa (ikuspen eta mezuak)';
$string['statsreport7'] = 'Erabiltzailearen aktibitatea (ikuspen eta mezuak)';
...
$string['strftimerecent'] = '%%bk %%d, %%H:%%M';
$string['strftimerecentfull'] = '%%a, %%Y(e)ko %%b %%d, %%H:%%M';
...
$string['studentviewoff'] = 'Ikasleen ikuspena indargabetu';
...
$string['toomanybounces'] = 'E-mail honetatik mezu asko bueltatu dira. Jarraitzeko <b>aldatu</b> behar duzu.';
...
$string['updatemymoodleoff'] = 'Modu arrunta';
$string['updatemymoodleon'] = 'Orri hau editatu';
...
$string['uploadoldfilesdeleted'] = 'Igoera-eremuko fitxategi zaharrak deuseztatu dira';
...
$string['usernameemailmatch'] = 'Erabiltzaile izena eta e-mail helbidea ez dagozkie erabiltzaile berari';
...
$string['virusfoundlateradminnolog'] = 'Kontuz administrari! Igotako $a->filename izeneko fitxategiak birusa dauka. Moodolek ezin izan dio fitxategia igorleari itzuli.
...
$string['virusplaceholder'] = 'Igotako fitxategiak birusak zituen eta ez da igo. Erabiltzaileari ohartarazi zaio.';
$string['visible'] = 'Ikusgarri';
...
$string['xmldbeditor'] = 'XMLDB editorea';
