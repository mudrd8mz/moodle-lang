...
$string['activityclipboard'] = 'Jarduera hau mugitzen: <b>$a</b>';
...
$string['adminhelpenrolments'] = 'Aukeratu barne edo kanpo moduak matrikulazioa kontrolatzeko';
...
$string['assignteachers'] = 'Tutoreak aukeratu';
...
$string['backuplogshelp'] = 'Aukeratuz gero, ikastaroen log-ak ere sartuko dira segurtasun-kopia automatikoetan.';
...
$string['backupnonisowarning'] = 'Kontuz: kopia hau Moodle bertsio ez Unicode (1.6aren aurretikoa) batetik dator. Kopiak ISO-8859-1 ez den edozein testu badu KALTETUA izan daiteke Moodle-ren Unicode bertsio honetara berreskuratzean.';
...
$string['chooseauthmethod'] = 'Aukeratu autenfikazio-plugina';
...
$string['clicktohideshow'] = 'Sakatu zabaltzeko edo estutzeko';
...
$string['copyinguserfiles'] = 'Erabiltzaile-fitxategiak kopiatzen';
...
$string['courseenrolend'] = 'Ikastaroan matrikulatzeko amaiera';
$string['courseenrolenddate'] = 'Ikastaroan matrikulatzeko amaiera-data';
$string['courseenrolstart'] = 'Ikastaroan matrikulatzeko hasiera';
$string['courseenrolstartdate'] = 'Ikastaroan matrikulatzeko hasiera-data';
...
$string['defaultcoursefullname'] = 'Ikastaroaren izen osoa 101';
...
$string['deleteallratings'] = 'Kalifikazio guztiak ezabatu';
...
$string['deleteselectedkey'] = 'Aukeratutako partaide-giltza ezabatu';
...
$string['duplicatingain'] = '$a->what $a->in-en bikoizten';
...
$string['editremoteprofile'] = 'Urruneko profila editatu';
...
$string['emailconfirmsent'] = '<P>E-posta mezu bat bidali dugu zure hurrengo helbide honetara: <B>$a</B>
   <P>Izena ematen amaitzeko argibide erraz batzuk ditu.
...
$string['enrolledincourse'] = '\"$a\" ikastaroan matrikulatuta';
$string['enrolledincoursenot'] = '\"$a\" ikastaroan matrikulatu gabe';
$string['enrolledincoursenotrole'] = 'Errorea \"$a->course\" ikastaroan \"$a->role\" rola ezartzean';
$string['enrolledincourserole'] = '\"$a->course\" ikastaroan \"$a->role\" rola ezarrita';
$string['enrollfirst'] = 'Ikastaroren batean matrikulatuta egon behar duzu web guneko jarduerak erabiltzeko';
$string['enrolme'] = 'Ikastaro honetan matrikulatu nahi dut';
$string['enrolmentconfirmation'] = 'Ikastaro honetan matrikulatzear zaude. Ziur al zaude?';
...
$string['enrolmentkeyfromguest'] = 'Ikastaro honek matrikulazio-giltza eskatzen du bisitari gisa sartzeko. Ikastaroan sartzen zaren lehen aldian idatzi behar duzu. $a-k bidali behar dizu.';
...
$string['enrolmentnotyet'] = 'Barkatu, ezin duzu matrikulatu ikastaro honetan ondorengo datara arte: <br /> $a';
...
$string['enteremailaddress'] = 'Zeure helbide elektronikoa idatzi, mesedez. Pasahitz berria bidaliko dizugu.';
...
$string['expirynotify'] = 'Matrikulazioaren amaiera-dataren oharra';
...
$string['formattopicscss'] = 'Gai-formatua - CSS/Taularik ez';
...
$string['go'] = 'Egin';
$string['gotoyourserver'] = '(Berriz ere zerbitzariarekin lotu)';
...
$string['helpemoticons'] = 'Emotikoneak erabili';
...
$string['helpinterestslist'] = 'Idatzi zure interesguneak komaz banatuta';
...
$string['hidesection'] = '$a atala ezkutatu';
$string['hidesettings'] = 'Ezarpenak ezkutatu';
$string['hidetopicfromothers'] = 'Ezkutatu gaia besteei';
$string['hideweekfromothers'] = 'Ezkutatu astea besteei';
...
$string['includeroleassignments'] = 'Rolak ezarri sartu';
...
$string['livelogs'] = 'Oraingo agerraldiak zuzenean';
$string['local'] = 'Lokala';
...
$string['messageselectadd'] = 'Gehitu/bidali mezua';
$string['metaaddcourse'] = 'Gehitu ikastaro hau';
$string['metaalreadycourses'] = 'Dagoeneko ikastaroak esleituta';
...
$string['moduleintro'] = 'Deskkribapena';
...
$string['plugincheck'] = 'Pluginak egiaztatu';
$string['pluginchecknotice'] = 'Ondorengo taulek zure Moodle instalazioan detektatu diren modulu, bloke eta iragazkiak erakusten dituzte;
Zein plugin dauden abiarazita eta zein ez adierazten dute. Plugin ez estandar guztiak probatu eta azken bertsioa eguneratuko da zure Moodle-ren eguneraketarekin jarraitu aurretik.';
...
$string['publicdirectorytitle'] = 'Guneen zerrenda ikusi';
...
$string['scheduledbackupsinactive'] = 'Programatutako segurtasun-kopiak gunearen kudeatzaileak gaitu ditu';
...
$string['showalltopics'] = 'Erakutsi gai guztiak';
$string['showallusers'] = 'Erakutsi erabiltzaile guztiak';
$string['showallweeks'] = 'Erakutsi aste guztiak';
...
$string['showmodulecourse'] = 'Erakutsi jarduera duten ikastaro-zerrenda';
...
$string['showtopicfromothers'] = 'Erakutsi gaia besteei';
$string['showweekfromothers'] = 'Erakutsi astea besteei';
...
$string['addblock'] = 'Blokea gehitu'; // ORPHANED
$string['addcomment'] = 'Iruzkina gehitu...'; // ORPHANED
$string['adddots'] = 'Gehitu...'; // ORPHANED
$string['deleteablock'] = 'Blokea ezabatu'; // ORPHANED
$string['path'] = 'Bidea'; // ORPHANED
$string['returntooriginaluser'] = '$a-ra itzuli'; // ORPHANED
$string['searchbyemail'] = 'Bilatu e-posta helbidearen arabera'; // ORPHANED
$string['searchbyusername'] = 'Bilatu erabiltzaile-izenaren arabera'; // ORPHANED
$string['selectedfile'] = 'Aukeratutako fitxategia'; // ORPHANED
$string['selectfiles'] = 'Aukeratutako fitxategiak'; // ORPHANED
$string['showcomments'] = 'Erakutsi/ezkutatu iruzkinak'; // ORPHANED
$string['url'] = 'URL'; // ORPHANED
$string['courserequestdisabled'] = 'Kudeatzaileak ikastaroen eskaera indargabetu du. Sentitzen dugu.'; // ORPHANED
$string['nostatstodisplay'] = 'Ez dago erakusteko daturik.'; // ORPHANED
$string['remotemaharauser'] = 'Urrutiko Mahara erabiltzailea'; // ORPHANED
