...
$string['addmynewentry'] = 'Nire sarrera berri bat erantsi';
$string['addsubject'] = 'Gaia erantsi';
$string['allowmultiple'] = 'Solaskide berarekin elkarrizketa bat baino gehiago ahalbidetu';
...
$string['maildefault'] = 'Berezko posta elektronikoa';
$string['mailnotification'] = 'Email bidezko oharra';
$string['modulename'] = 'Elkarrizketa';
$string['modulenameplural'] = 'Elkarrizketak';
$string['namehascloseddialogue'] = '$a (e)k elkarrizketa itxi du';
$string['newdialogueentries'] = 'Elkarrizketan interbentzio berriak';
$string['newentry'] = 'Interbentzio berria';
...
$string['pane2'] = '$a elkarrizketa solaskideen erantzunen zain dago';
$string['pane2one'] = 'Elkarrizketa bat solaskidearen erantzunaren zain dago';
$string['pane3'] = '$a elkarrizketa itxita';
$string['pane3one'] = 'Elkarrizketa bat itxita';
$string['seen'] = 'Data honetan ikusita: $a';
$string['sendmailmessages'] = 'Nire sarrera berriekin emailak bidali';
$string['status'] = 'Estatusa';
$string['studenttostudent'] = 'Ikasleak ikasleari';
$string['subject'] = 'Gaia';
$string['subjectadded'] = 'Gaia erantsi da';
$string['teachertostudent'] = 'Irakasleak ikasleari';
$string['typefirstentry'] = 'Lehenengo sarrera hemen idatzi';
$string['typefollowup'] = 'Jarraipena hemen idatzi';
$string['typeofdialogue'] = 'Elkarrizketa mota';
$string['typereply'] = 'Erantzuna hemen idatzi';
$string['viewallentries'] = 'Pertsona honen elkarrizketaren sarrerak ikusi: $a';
