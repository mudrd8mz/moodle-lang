...
$string['allowdeletes'] = 'Ezabatzen baimendu';
...
$string['cfgwwwrootwarning'] = 'Ez duzu egoki definitu &#36;CFG->wwwroot zure config.php fitxategian. Ez du adierazten orri honetarako sarbiderako erabiltzen ari zaren URLa. Mesedez zuzendu, edo honelako bug baten mezua sortuko zaizu <a href=\'http://tracker.moodle.org/browse/MDL-11061\'>MDL-11061</a>.';
...
$string['configallowassign'] = 'Ezkerreko rolei zutabe bakoitzeko rolak ezartzen utzi';
...
$string['configallowemailaddresses'] = 'E-mail helbideak domeinu partikularretara murriztu nahi badituzu, tarteek bananduta zerrenda itzazu. Beste domeinu guztiak gaitzetsik dira, adibidez, <strong>ourcollege.edu.au .gov.au</strong>';
...
$string['configallowuserblockhiding'] = 'Erabiltzaileek guneko aldeetako blokeak erakutsi eta ezkutatu ahal izatea nahi al duzu? Aukera honek Javascript eta cookies erabiltzen ditu blokeen egoera gogoratzeko, eta erabiltzaileek informazioa nola ikusiko duten zehazten du.';
...
$string['configenablegroupings'] = 'Ezarpen honek taldeen taldekatzeak gaitzen ditu';
...
$string['configlang'] = 'Aukera ezazue gune osoarekiko lehenetsitako hizkuntza. Erabiltzaileek beranduago aukera aldatu ahal izango dute.';
...
$string['configlocale'] = 'Gunearen kokapena aukeratu (honek hizkuntzaren formatan eta datetan eragina izango du). Datu horiek zure sistema eragilean ere instalatuta egon behar dute (ad., en_US edo esp_ESP). Zalantzan bazaude, zuriz utzi.';
...
$string['confignoreplyaddress'] = 'Batzuetan e-mailak erabiltzaileak bidaltzen ditu (ad., foro bateko mezuak). E-posta helbidea \"Norena\" gisa azalduko da hartzaileek zuzenean erantzuteko posibilitatea ez duten kasuetan (ad., erabiltzaileak bere helbidea ezkutatu nahi duenean).';
...
$string['configsessioncookie'] = 'Aukera honek Moodle-ko saioetako cookieren izena pertsonalizatzen du. Aukerazkoa da, eta praktikoa izaten da soilik zerbitzari berean Moodle-ko beste kopia bat egikaritzen ari denean cookieak nahas daitezkeelako.';
...
$string['datarootsecuritywarning'] = 'Zure gunearen konfigurazioa ez da, agian, segurua. Mesedez, ziurta ezazu zure sustrai-direktoriora ($a) ezin dela zuzenean web-etik heldu.';
...
$string['enablegroupings'] = 'Taldekatzeak gaitu';
$string['enablehtmlpurifier'] = 'HTML garbiltzailea gaitu';
...
$string['frontpagedefaultrole'] = 'Haisera-orriaren berezko rola';
...
$string['hideactivitytypenavlink'] = 'Jarduera-motaren araberako nabigazioa ezkutatu';
...
$string['importlangreminder'] = 'Datu-basearen migrazio-prozesua hasi da. Eguneraketa eraginkorra izateko <b>berriz sartu beharko dituzu sartzeko datuak</b>. Mesedez, instalatu unicode hizkuntza-paketeak lehen bailehen Kudeaketa->Hizkuntza->Hizkuntza paketeak-en datu-basearen migrazio-prozesua bukatu <b>ondoren</b>.';
...
$string['nomissingstrings'] = 'Ez dago itzuli gabeko katerik';
...
$string['profilefieldtypemenu'] = 'Aukera-menua';
$string['profilefieldtypetext'] = 'Testu-sarrera';
$string['profilefieldtypetextarea'] = 'Testuaren eremua';
...
$string['uuoptype_addupdate'] = 'Beeriak gehitu eta lehendik dauden erabiltzaileak eguneratu';
