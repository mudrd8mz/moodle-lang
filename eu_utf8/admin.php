...
$string['configcachetype'] = 'Aukeratu Moodle-rako katxe-mota. Honek katxea bakarrik konfiguratuko du; gogoratu katxea gaitu egin behar duzula zerbaitetarako erabilgarri izan dadin. Datu-basearen sistemaren karga arindu behar baduzu <strong>bakarrik</strong> erabili, bestela Moodle makalago ibiliko da. Erabilera handiegia ez duten guneak \'internal\' erabilita hobeto ibil daitezke. <em>Sare-memoria aukerak gaituta dituen eta </em>eAccelerator edo Turckmmcache instalatuta duen web-zerbitzari bakar batek \'eaccelerator\' probatu behar luke. Zerbitzari anitzeko konfigurazioa eta memcached memorian zerbitzu bat edo beste exekutatzen badituzu eta PHP-memcached luzapena baduzu, aukeratu \'memcached\' eta ezarri memcached aukerak beherago. <br /><strong>Oharra:</strong> ziurtatu karga eta ezarpen-errendimendua probatzeaz -- Katxeek makaldu egin dezakete zure gunea. Trafiko handiko egoeretan, eAccelerator eta memcached izan daitezke onenak, baina web-zerbitzariaren CPU-aren erabilerari kosto handia ezar diezaiokete.';
...
$string['configcurlcache'] = 'cURL katxearen biziraupena, segundutan.';
...
$string['configdebugdisplay'] = 'Aukera hau gaituz gero, erroreen txostena HTML orrira joango da. Praktikoa da baina, oro har, XHTML, JS, kukiak eta HTTP goiburuak apurtzen ditu. Aukera hau desgaituz gero, zerbitzariaren erregistroetara bidaliko da eta garbiketa hobeto egingo da. PHpren error_log ezarpenak zein erregistrotara doan kontrolatzen du.';
...
$string['confighideactivitytypenavlink'] = 'Aukeratu nori ezkutatu jardura-motarako esteka (adib., galdetegiak) jarduera-moduluetako nabigazioan.';
...
$string['configintcachemax'] = 'Barne-katxerako bakarrik. Katxean gordetzeko gehienezko erregistro-kopurua. Gomendatua: 50. Erabili balore txikiagoak memoriaren erabilera txikitzeko.';
...
$string['curlcache'] = 'cURl katxea TTL';
...
$string['intcachemax'] = 'Gehinezko barne-katxea';
...
$string['ipwhitelist'] = 'Ip zerrenda zuria';
$string['ipwhitelistdesc'] = 'Hutsik ez badago, hemen ezarritako IPak bakarrik iznago du aukera web-zerbitzua erabiltzeko erabiltzaile-izen honekin: <strong>$a->username</strong>';
...
$string['managews'] = 'Wen zerbitzuak kudeatu';
...
$string['profilefieldtypecheckbox'] = 'Kontrol-laukia';
...
$string['webserviceprotocols'] = 'Web-zerbitzuen zerbitzariak';
$string['webservices'] = 'Web-zerbitzuak';
$string['webservicesystemsettings'] = 'ezarpen komunak';
$string['webserviceusersettings'] = 'Web-zerbitzuaren erabiltzaileen ezarpenak';
...
$string['allcountrycodes'] = 'Herrialdeetako kode guztiak'; // ORPHANED
$string['allowthemechangeonurl'] = 'Itxurak URL-n aldatzea baimendu'; // ORPHANED
$string['condifmodeditdefaults'] = 'Hemen ezartzen dituzun baloreek definituko dituzte jarduera berria sortzen duzunean erabiliko den jardueraren ezarpenetarako formularioko berezko baloreak.'; // ORPHANED
$string['configallcountrycodes'] = 'Hainbat tokitan, erabiltzailearen profilean esaterako, aukeratzeko erabiliko den herrialdeen zerrenda da hau. Zuri utzita (berezkoa) Ingelesezko hizkuntza-pakete estandarreko countries.php fitxategiko zerrenda erabiliko da. ISo 3166-1-eko zerrenda da hau. Bestela, komaz banatuta zehaz dezakezu kodeen zerrenda, adibidez \'GB,FR,ES\'. Berririk gehitzen baduzu, kode ez estandarrak alegia, zure hizkuntza-paketeko countries.php fitxategira ere gehitu beharko dituzu.'; // ORPHANED
$string['configdebugpageinfo'] = 'Gaitu orriaren informazioa orri-oinean inprimatzea nahi baduzu.'; // ORPHANED
$string['configenablecomments'] = 'Gaitu iruzkinak'; // ORPHANED
$string['configrequiremodintro'] = 'Aukera hau desgaitu, erabiltzaileek jarduera bakoitzean deskribapena idaztera behartu nahi ez badituzu.'; // ORPHANED
$string['debugpageinfo'] = 'Orriaren informazioa erakutsi'; // ORPHANED
$string['debugstringids'] = 'Hizkuntza-kateen jatorria erakutsi'; // ORPHANED
$string['enablecomments'] = 'Iruzkinak gaitu'; // ORPHANED
$string['modeditdefaults'] = 'Berezko baloreak jardueren ezarpenetarako'; // ORPHANED
$string['plugin'] = 'Plugina'; // ORPHANED
$string['requiremodintro'] = 'Jardueraren deskribapena beharrezkoa da'; // ORPHANED
$string['uninstallplugin'] = 'Desinstalatu'; // ORPHANED
$string['useblogassociations'] = 'Asoziazioak gaitu'; // ORPHANED
