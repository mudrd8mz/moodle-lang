...
$string['configenablerecordcache'] = '0 baino zenbaki handiagoa idazten baduzu katxe-eragiketak egingo dira datu-basearen informazioa berreskuratzen den bitartean. Honek esan nahi du datu-basearen transferentzia-tasa hobea izango dela; baina, bestalde, handitu egingo dira zertxobait zerbitzariaren memoria-beharrak. Orokorrean, 50 inguruko balioa gomendatzen dugu zure zerbitzaria memorian baxu ez badabil behintzat. Zenbait prozesuk aukera honi jaramonik ez egitea erabaki dezakete, garatzaileak ziur dakienean erremendimendua handituko dela.';
$string['configenablerssfeeds'] = 'Aukera honek RSS kanaletarako sarbidea ahalbidetzen du. Edozein aldaketa ikusteko moduluetan ere RSS kanalak aktibatu behar dira (Admin - Konfiguraziora joan).';
...
$string['configenabletrusttext'] = 'Berez, erabiltzaileek idatzitako testua sakon garbituko du Moodle-k segurtasunerako arrisku izan daitekeen edozein \'script\', media e.a. ezabatzeko. Eduki fidagarriaren sistemarekin zure konfidantza duten erabiltzaile jakinei edukietan ezaugarri aurreratu horiek sartzeko baimena ematen diezu, interferentziarik gabe. Sistema gaitzeko, ezarpen hau gaitu behar duzu lehenik eta ondoren eduki fidagarri baimena eman Moodle-ren rol zehatz bati. Erabiltzaile horiek sortu edo igotako testuak fidagarri gisa markatuko dira eta ez dira garbiketa prozesutik pasako erakutsi aurretik.';
...
$string['configintro'] = 'Orri honetan Moodle-k zure zerbitzarian egokiro lan egiten laguntzen duten aldagai-kopuru bat zehaz dezakezu. Horrek ez zaitu gehiegi kezkatu behar: lehenetsitako baloreek ongi funtzionatuko dute eta, hala ere, orri honetara nahi duzunean itzul zaitezke ezarpenak aldatzeko.';
...
$string['confignotloggedinroleid'] = 'Gunean autentifikatu gabeko erabiltzaileak gunearen kontestuan rol hau izango balute bezala arituko dira. \'Bisitaria\' zuk nahi duzuna da hemen, baina agian rol mugatzaileagoak sortu nahiko dituzu. Mezuak bidaltzea bezalako kontuek erabiltzailea behar bezala autentifika dadin eskatzen dute.';
...
$string['enablerecordcache'] = 'Erregistro-katxea gaitu';
...
$string['importlangreminder'] = 'Datu-basearen migrazio-prozesua hasi da. Eguneraketa eraginkorra izateko <b>berriz sartu beharko dituzu sartzeko datuak</b>. Mesedez, instalatu unicode hizkuntza-paketeak lehen bait lehen Kudeaketa->Hizkuntza->Hizkuntza paketeak-en datu-basearen migrazio-prozesua bukatu <b>ondoren</b>.';
...
$string['invalidsection'] = 'Atalak ezegokia';
...
$string['loglifetime'] = 'Mantendu erregistroak ondorengoentzako:';
...
$string['nonexistentbookmark'] = 'Eskatutako marka ez dago';
...
$string['sessiontimeout'] = 'Gehinezko denbora';
$string['showblocksonmodpages'] = 'Blokeak modulu-orrietan erakutsi';
$string['simpletest'] = 'Test unitarioak';
...
$string['statsmaxruntime'] = 'Exekutatzeko gehinezko denbora';
