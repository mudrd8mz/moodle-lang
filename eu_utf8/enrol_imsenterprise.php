...
$string['cronfrequency'] = 'Prozesamendu-frekuentzia';
$string['deleteusers'] = 'Erabiltzaile-kontuak ezabatu IMS datuetan zehazten denean';
$string['description'] = 'Metodo honek hainbatetan prozesatu eta konprobatuko du era berezian formateatutako testu-fitxategi bat zuk zehaztutako lekuan.Fitxategiak pertsona, talde eta partaidetza <a href=\'../help.php?module=enrol/imsenterprise&file=formatoverview.html\' target=\'_blank\'> IMS Enterprise zehaztasunak </a> izan behar ditu.';
$string['doitnow'] = 'Exekutatu oraintxe bertan IMS Enterprise inportazioa';
$string['enrolname'] = 'IMS Enterprise fitxategia';
...
$string['mailadmins'] = 'Administrazaileari emailez jakinarazi';
$string['mailusers'] = 'Erabiltzaileei emailez jakinarazi';
