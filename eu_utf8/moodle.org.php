...
$string['namecommunity'] = 'Komunitatea';
$string['namecontact'] = 'Harremanetarako';
$string['namedevelopment'] = 'Garapena';
$string['namedocumentation'] = 'Dokumentazioa';
$string['namedownloads'] = 'Jaitsi';
$string['nameevents'] = 'Ekitaldiak';
$string['nameforums'] = 'Foroak';
...
$string['supportforums'] = '<h3>Komunitatearen eztabaida-foroak</h3>
Erabiltzaile-komunitate handia eta anitza du Moodle-k laguntzeko Moodle.org-eko eztabaida-foroen bitartez
<ul>
<li><a href=\"http://moodle.org/course/view.php?id=5\">Using Moodle</a> - nazioarteko eztabaida orokorrak ingelesez</li>
...
$string['aboutfurther'] = 'Informazio gehiagorako, baita Moodle-ren filosofiaren zehaztasun eta oinarrietarako ere, begiratu <a href=\"http://docs.moodle.org/eu/Moodle-ri_buruz\">Moodle Doc-ak</a>..
Moodle-ren demostrazio oso baterako, mesedez begiratu <a href=\"http://demo.moodle.org/\">Moodle Demonstrations-a</a>'; // ORPHANED
$string['aboutways'] = 'Moodle proiektuaren gakoa irakasleei ikaskuntza sustatu eta kudeatzeko tresnarik onenak eskaintzea da, baina Moodle erabiltzeko era asko dago:
<ul>
<li>Moodle-k hainbat eta hainbat eginkizun eta ehundaka eta milaka ikasleren lana kalifikatzeko aukera ematen du, eta era berean erabil daiteke lehen hezkuntzan zein hezkuntza informalerako.</li>
<li>Hainbat erakundek erabiltzen du plataforma gisa era errazean on-line ikastaroak gidatzeko, eta beste askok aurrez-aurreko ikastaroen osagarri gisa (blended learning) erabiltzen dute besterik gabe.</li>
<li>Moodle-ren erabiltzaile askok jarduera-modulu asko erabiltzea dute gogoko (besteak beste, Foroak, Wikiak, Datu-baseak) ikasgai jakin baten inguruko ikaskuntza-komunitate kolaboratibo aberatsak sortzeko (giza-konstruktibismoaren arabera), eta beste batzuk, berriz, nahiago dute ikasleei edukiak eskaintzeko erabiltzea Moodle (SCORM pakete estandarrak, kasu) eta ikaskuntza ebaluatu eginkizunak eta galdetegiak erabilita.</li>
</ul>'; // ORPHANED
$string['communitychannels'] = 'Hainbat eratan har dezakezu parte Moodle komunitatean moodle.org-en:
<ul>
<li>Hartu parte nazioarteko eztabaidetan <a href=\"http://moodle.org/course/view.php?id=5\">Using Moodle-n</a>, ingelesez. Foro hau gune egokia da galderak egiteko eta doaneko laguntza jasotzeko. Badugu informazio gehiagorako ingelesezko <a href=\"http://moodle.org/course/view.php?id=55\"> Moodle Lounge</a> txat informala ere.</li>
<li>Hartu parte bestelako eztabaida-taldeetako batean, bai <a href=\"http://moodle.org/course/category.php?id=1\">bestelako gaietarako</a> eta baita <a href=\"http://moodle.org/course/category.php?id=3\">bestelako hizkuntzetan</a>.</li>
<li>Prestatu Moodlemoot!-en bat</li>
<li>Lagundu gure on-line dokumentazioa idazten eta editatzen: <a href=\"http://docs.moodle.org/eu\">Moodle Doc-ak</a>.</li>
<li>Lagundu konprobatzen eta bidali bug-ak <a href=\"http://tracker.moodle.org/\">Moodle Tracker-en bidez</a> (begiratu <a href=\"http://docs.moodle.org/en/Tracker\"> Tracker-en sarrera</a>)</li>
<li>Garatu Moodle-rako kode berria (begiratu <a href=\"http://moodle.org/development\">Garatzaileen orria</a></li>
<li>Hartu parte Moodle-ren itzulpenean (begiratu <a href=\"http://docs.moodle.org/eu/Itzulpena\">itzultzaileentzako informazioa</a>)</li>
<li>Eman <a href=\"http://moodle.org/donations\">diru-laguntza</a> proiekturako!</li>
</ul>'; // ORPHANED
$string['communitystart'] = 'Hemen aritzeko, lehenik Moodle.org-n kontua sortu behar duzu <a href=\"http://moodle.org/login/signup.php\">kontu berrirako formularioa</a> zure datuekin beteta'; // ORPHANED
$string['contactcommercial'] = 'Helburu komertzialetarako, jarri harremanetan <a href=\"http://moodle.com/helpdesk\">Moodle Helpdesk-ekin</a> hemen <a href=\"http://moodle.com/\">moodle.com</a> edo zure inguruko Moodle Partner-arekin'; // ORPHANED
...
$string['namehome'] = 'Hasiera-orria'; // ORPHANED
$string['supportdocs'] = '<h3>Dokumentazioa</h3>
<p>Mesedez, hasi gure <a href=\"http://docs.moodle.org/eu/Azala\">dokumentaziorako wikia</a> begiratuz, batez ere <a href=\"http://docs.moodle.org/eu/Kategoria:FAQ\">Maiz egiten diren galderak</a>.</p>
<p>Badira, bestalde, <a href=\"http://docs.moodle.org/overview/\">dokumentazio-wikiak beste hizkuntzetan ere</a>.</p>

<p>Zure Moodle gunean kudeatzaile edo irakasle gisa sartutakoan garrantzizko dokumentazioa eskuratzeko, erabili orri bakoitzaren beheko aldean dagoen \"Moodle Doc-ak orri honetarako\" esteka.</p>'; // ORPHANED
$string['supporturl'] = 'http://moodle.org/course/view.php?id=5'; // ORPHANED
