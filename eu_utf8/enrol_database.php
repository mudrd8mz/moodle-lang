...
$string['student_r_userfield'] = 'Ikasleen urrutiko matrikulazio taularen izena non erabiltzailearen IDa aurkitzea espero dugun.';
$string['student_table'] = 'Ikasleen matrikulazioak metatzen diren taularen izena.';
$string['teacher_coursefield'] = 'Ikastaroaren ID aurkitzea espero dugun irakaslearen matrikulazio-taularen eremuaren izena.';
