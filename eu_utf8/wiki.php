<?PHP // $Id$ 
      // wiki.php - created with Moodle 1.8.4+ (2007021541)
...
$string['cannotchangepage'] = 'Orri hau ezin da moldatu.';
...
$string['versionrangetoobig'] = 'Ezin duzu orri baten bertsio guztiak ezabatu. Azken bertsioa mantenduko da.';
