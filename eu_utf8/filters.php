...
$string['actfilterhdr'] = 'Indarrean dauden iragazkiak (ORed elkarrekin)';
...
$string['isbetween'] = '$a[0] eta $a[1]-ren artekoa';
...
$string['removeall'] = 'Ezabatu dena';
$string['removeselected'] = 'Ezabatu aukeratutakoa';
$string['setfilter'] = 'Iragazkia findu';
