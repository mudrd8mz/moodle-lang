...
$string['auth_cas_create_user'] = 'Moodle-ren datu-basean CASen bidez onartutako erabiltzaileak erantsi nahi badituzu aktibatu. Bestela, Moodleren datu-basean honez gero dauden erabiltzaileek soilik izango dute sarbidea.';
...
$string['auth_dbextrafields'] = 'Eremu hauek aukerazkoak dira.  Moddle erabiltzaileen eremu batzuk hemen zehaztutako <B>kanpoko datu-base eremuetatik</B> aurrez betetzea erabaki dezakezu. <P>Hutsik uzten badituzu, lehenetsitako balioak erabiliko dira.<P>Edozein kasutan, erabiltzaileek eremu guztiak editatzeko aukera izango dute behin saioa hasita.';
...
$string['auth_emaildescription'] = 'e-postaz berrestea da lehenetsitako autentifikazio metodoa.  Erabiltzaileak izena ematen duenean, bere izen eta pasahitza aukeratuz, konfirmazio ePosta mezu bat bidaltzen zaio erabiltzailearen ePostara.  ePosta Mezu honek, erabiltzaileei kontua berresteko aukera emango dien orri batera lotura zihur bat du. Hurrengoetan saioa hasteko izen eta pasahitza Moodle datu-basean dauden balioekin konparatzea nahikoa da.';
...
Emandako erabiltzaile izen eta pasahitza baliozkoak badira, Moodle-k erabiltzaile   sarrera berri bat sortuko du bere datu-basean. Modulu honek erabiltzaile atributuak LDAP zerbitzaritik irakurri ditzazke eta eremuak Moodlen bete.  Hurrengo saio hasieretan soilik izen eta pasahitza egiaztatuko dira.';
...
$string['stdchangepassword_expl'] = 'Kanpoko autentifikazio-sistemak Moodlen pasahitz aldaketa ahalbidetzen badu, Bai aukera ezazu. Ezarpen honek \'URL pasahitza aldatu\' gainditzen du.';
