...
$string['adminemailexpired'] = 'Hau \'Eskuko kobrantza\' egiteko baliagarria da. Kudeatzaileei <b>$a</b> egun lehenago ohartarazten zaie ordainketa-muga iristsiko dela.';
...
$string['adminemailexpiredteacher'] = 'Eskuko kobrantza ezarri baduzu (goialdean ikusi) eta irakasleek ordainketak kudea baditzakete, beraiei ere bukatzear dauden ordainketa-epeez informa dakieke. Horrek ikastaroetako irakasleei e-mail bana bidaliko die pendiente dauden ordainketez informatzeko.';
...
$string['avsa'] = 'Helbidea (kalea) egokia da, baina postakodea ez';
...
$string['avsn'] = 'Helbidea (kalea) eta postakodea ez dira egokiak';
...
$string['avsw'] = '9 digitoko postakodea egokia da, helbidea (kalea) ez';
$string['avsx'] = 'Helbidea (kalea) eta 9 digitoko postakodea egokiak dira';
$string['avsy'] = 'Helbidea (kalea) eta 5 digitoko postakodea egokiak dirah';
$string['avsz'] = '5 digitoko postakodea egokia da, helbidea (kalea) ez';
...
$string['ccexpired'] = 'Kreditu-txartela kadukatua';
...
$string['echeckabacode'] = 'Banketxe ABA zenbakia';
...
$string['missingzip'] = 'Postakodea falta da';
