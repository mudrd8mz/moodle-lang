...
$string['casesensitive'] = 'Letra larriak eta txikiak bereiziz';
...
$string['feedbackerrorboundaryformat'] = 'Atzera-elikaduraren kalifikazioaren mugak ehunekoa edo zenbakia izan behar du. $a mugan sartu den balorea ezin da onartu.';
$string['feedbackerrorboundaryoutofrange'] = 'Atzera-elikaduraren kalifikazioaren mugak %%0 eta %%100en artean egon behar du. $a mugan sartu den muga ez dago horien artean.';
$string['feedbackerrorjunkinboundary'] = 'Atzera-elikaduraren kalifikazioaren mugen atalak hutsunerik gabe bete behar dituzu.';
$string['feedbackerrorjunkinfeedback'] = 'Atzera-elikadura atalak hutsunerik gabe bete behar dituzu.';
$string['feedbackerrororder'] = 'Atzera-elikaduraren kalifikazioaren mugek ordenatuta joan behar dute, altuenetik hasita. $a mugan sartutako balorea ez dago ordenean.';
