...
$string['addmoreoverallfeedbacks'] = 'Gehitu {ez} feedback-etarako eremu gehiagok';
...
$string['caseno'] = 'Ez, letra larriak eta txikiak ez dira bereiziko';
...
$string['giftleftbraceerror'] = 'Ez da { aurkitu';
...
$string['questionsperpage'] = 'Gehienezko galdera- kopurua orriko';
...
$string['addingcalculated'] = 'Kalkulatutako galdera gehitzen'; // ORPHANED
$string['addingdescription'] = 'Deskribapena gehitzen'; // ORPHANED
$string['addingessay'] = 'Entsegua gehitzen'; // ORPHANED
$string['addingmatch'] = 'Enuntziatuak lotzeko galdera gehitzen'; // ORPHANED
$string['addingmultianswer'] = 'Galdera txertatua (Cloze) gehitzen'; // ORPHANED
$string['addingmultichoice'] = 'Aukera anitzeko galdera gehitzen'; // ORPHANED
$string['addingnumerical'] = 'Zenbakizko galdera gehitzen'; // ORPHANED
$string['addingquestion'] = 'Galdera gehitzen'; // ORPHANED
$string['addingrandom'] = 'Ausazko galdera gehitzen'; // ORPHANED
$string['addingrandomsamatch'] = 'Erantzun laburrak ausaz lotzeko galdera gehitzen'; // ORPHANED
$string['addingshortanswer'] = 'Erantzun laburreko galdera gehitzen'; // ORPHANED
$string['addingtruefalse'] = 'Egia/gezurreko galdera gehitzen'; // ORPHANED
$string['attemptsdeleted'] = 'Galdetegiaren saiakerak ezabatu dira'; // ORPHANED
$string['deletingquestionattempts'] = 'Galderaren saiakerak ezabatzen'; // ORPHANED
$string['finishreview'] = 'Berrikusketa amaitu'; // ORPHANED
$string['gradesdeleted'] = 'Galdetegiaren kalifikazioak ezabatu dira'; // ORPHANED
$string['removeallquizattempts'] = 'Galdetegiari erantzuteko saiakera guztiak ezabatu'; // ORPHANED
$string['timelimitmin'] = 'Denbora-muga (minututan)'; // ORPHANED
