...
$string['backtofeedback'] = 'Atzeraelikadurara itzuli';
$string['choosereviewfile'] = 'Igotzeko fitxategia aukeratu zereginaren berrikusketa gisa';
...
$string['deletecheckfile'] = 'Benetan ziur al zaude fitxategi hau ezabatu nahi duzula?';
$string['deleteednotification'] = 'Fitxategia ezabatu egin da';
$string['deletefail'] = 'Ondorengo fitxategia ez da ezabatu';
...
$string['helpupload'] = '<p> Zeregin mota honek edozein motatako fitxategi bat edo gehiago igotzeko aukera ematen dio parte hartzaile bakoitzari.</p>
...
$string['markingsubmitnotification'] = 'Fitxategia egoki igo da kalifikatzeko';
...
$string['namedeletefile'] = 'Fitxategi hau ezabatzeko zorian zaude:';
...
$string['nofilesforsubmit'] = 'Ez da bildatzeko fitxategirik aurkitu: ziur al zaude igo duzula?';
...
$string['preventlate'] = 'Ez utzi bidalketarik bidaltzen epez kanpo';
$string['quickgrade'] = 'Utzi kalifikazio arinak jartzen';
$string['removelink'] = 'Kendu';
$string['responsefile'] = 'Erantzun-fitxategia';
$string['responsesfromteacher'] = 'Iraskasleak igotako erantzunak';
$string['saveallfeedback'] = 'Nire erantzun guztiak gorde';
$string['sendformarking'] = 'Kalifikatzeko bidali';
$string['step1'] = '1. pausua';
$string['step2'] = '2. pausua';
...
$string['submissionstatus'] = 'Bidalketa-egoera';
$string['submissionstatusblank'] = 'Zurian';
$string['submissionstatusdraft'] = 'Zirriborroa';
$string['submissionstatusmarked'] = 'Kalifikatuta';
$string['submissionstatusreturned'] = 'Itzulita';
$string['submissionstatussubmitted'] = 'Bidalita';
...
$string['typeonline'] = 'Online testua';
...
$string['uploadsuccessresponse'] = 'Erantzun-fitxategia egoki igo da';
