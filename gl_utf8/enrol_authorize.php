<?PHP // $Id$ 
      // enrol_authorize.php - created with Moodle 1.8.3 + (2007021532)


$string['adminacceptccs'] = 'Que tipos de tarxetas de crédito se aceptan?';
$string['adminaccepts'] = 'Seleccione os métodos de pagamento permitidos e os seus tipos';
$string['adminauthcode'] = 'Se unha tarxeta de crédito de usuario non pode ser capturada directamente na Internet, obteña o código de autorización no teléfono do banco do usuario.';
...
$string['adminemailexpiredsort'] = 'Cando o número de pedidos pendentes caduca son enviados aos profesores por correo electrónico. Cal é o importante?';
...
$string['adminneworder'] = 'Querido administrador,
  ...
  Se a captación programada está activa, a tarxeta de crédito será captada en $a->captureon
  e o usuario matricularase no curso; doutra maneira caducará
  en $a->expireon e non poderá ser capturada despois deste día.
...
$string['adminreview'] = 'Revisar o pedido antes de procesar a tarxeta de crédito.';
...
$string['avsa'] = 'O enderezo (rúa) coincide, o código postal non';
$string['avsb'] = 'Información do enderezo non fornecida';
$string['avse'] = 'Erro no sistema de verificación de enderezo';
$string['avsg'] = 'Non é unha tarxeta emitida por un banco dos EUA.';
$string['avsn'] = 'Non coinciden o enderezo (rúa) nin o código postal';
$string['avsp'] = 'Sistema de verificación de enderezo non aplicable';
$string['avsr'] = 'Tentalo de novo. Sistema non dispoñible ou tempo esgotado';
$string['avsresult'] = 'Resultado AVS: $a';
$string['avss'] = 'Servizo non proporcionado polo emisor';
$string['avsu'] = 'A información do enderezo non está dispoñible';
$string['avsw'] = 'O código postal de 9 díxitos coincide, o enderezo (rúa) non';
$string['avsx'] = 'O enderezo (rúa) e o código postal de 9 díxitos coinciden';
$string['avsy'] = 'O enderezo (rúa) e o código postal de 5 díxitos coinciden';
$string['avsz'] = 'O código postal de 5 díxitos coincide, o enderezo (rúa) non';
...
$string['captureyes'] = 'A tarxeta de crédito será capturada e o estudante matricularase no curso. Está certo?';
$string['ccexpire'] = 'Data de caducidade';
$string['ccexpired'] = 'A tarxeta de crédito caducou';
$string['ccinvalid'] = 'Número de tarxeta non válido';
$string['ccno'] = 'Número da tarxeta de credito';
$string['cctype'] = 'Tipo de tarxeta de crédito';
$string['ccvv'] = 'Verificación da tarxeta';
$string['ccvvhelp'] = 'Mire a parte de atrás da tarxeta (3 últimos díxitos)';
...
$string['httpsrequired'] = 'Lamentamos informar de que a súa solicitude non pode ser procesada agora. A configuración do sitio non pode ser configurada correctamente.<br /><br />Non introduza o número da tarxeta de crédito a non ser que vexa un cadeado amarelo no explorador. Se aparece o símbolo, significa que a páxina cifra todos os datos enviados entre o cliente e o servidor. Entón a transacción de información entre os dous computadores é protexida, por tanto o  número da súa tarxeta de crédito non pode ser capturado na Internet.';
...
$string['logindesc'] = 'Esta opción debe estar ACTIVADA. <br /><br />Asegúrese de que activou <a href=\"$a->url\">loginhttps </a> en Administración >> Variables >> Seguranza.<br /><br />Activando isto fará que Moodle utilice unha conexión segura https para as páxinas de acceso e pagamento.';
$string['logininfo'] = 'O nome de acceso, o contrasinal e a chave de transacción non son mostrados por precaucións de seguranza. Non é preciso entrar de novo se antes ten configurados eses campos. Verá un texto verde á esquerda da caixa se xa foron configurados algúns campos. Se introduce eses campos por primeira vez, o nome de acceso (*) é obrigatorio e debe introducir <strong>calquera</strong> chave de transacción (#1) <strong>ou</strong> o contrasinal (#2) na caixa apropiada. Recomendámoslle que introduza a súa chave de transacción por precaucións de seguranza. Se desexa eliminar o actual contrasinal, marque a caixa de verificación.';
...
$string['nameoncard'] = 'Titular da tarxeta';
$string['new'] = 'Novo';
...
Existen $a->count echeques pendentes de verificar electronicamente e debería cargar un ficheiro csv para obter os usuarios inscritos.
...
$string['reason17'] = 'O comerciante non acepta este tipo de tarxeta de crédito.';
...
$string['reason27'] = 'O resultado da transacción nun AVS non coincide. O enderezo fornecido non coincide co enderezo de facturación do titular da tarxeta.';
$string['reason28'] = 'O comerciante non acepta este tipo de tarxeta de crédito.';
...
$string['reason43'] = 'O comerciante foi configurado incorrectamente no procesador. Contacte co Fornecedor do servizo comercial.';
$string['reason44'] = 'Esta transacción foi rexeitada. Produciuse un erro no código da tarxeta!';
$string['reason45'] = 'Esta transacción foi rexeitada. Erro no código da tarxeta/filtro AVS!';
$string['reason47'] = 'A cantidade obrigatoria acordada non pode ser maior que a cantidade orixinal autorizada.';
$string['reason5'] = 'É necesario introducir unha cantidade válida.';
...
$string['testwarning'] = 'Captación/cancelación/crédito parecen estar a funcionar en modo de probas, mais non se actualizou ou inseriu ningún rexistro na base de datos.';
...
$string['usingccmethod'] = 'Inscribir con <a href=\"$a->url\"><strong>tarxeta de crédito</strong></a>';
