...
$string['authmnetautoadddisabled'] = 'Os <em>usuarios engadidos automaticamente</em> no plugin de autenticación da rede de Moodle está <strong>desactivado</strong>.';
...
$string['illegalchar-host'] = 'O seu nome de servidor contén o carácter non permitido: $a';
$string['illegalchar-moodlehome'] = 'A súa localización de Moodle contén caracteres non permitidos';
...
$string['moodleloc'] = 'Localización Moodle';
$string['net'] = 'Rede';
...
$string['nohostid'] = 'Esta páxina require un ID de servidor que ten que ser un enteiro.';
$string['noipmatch'] = 'O enderezo de máquina remota <br /><em>$a[0]</em><br />non coincide co que está rexistrado:<br /><em>$a[1]</em>.';
...
$string['on'] = 'Activado';
$string['otherenrolledusers'] = 'Outros usuarios inscritos';
...
$string['remoteenrolhosts_desc'] = 'Inscribir e dar de baixa usuarios da súa instalación de Moodle nos servidores Moodle que permiten facelo a través do plugin de inscrición da rede Moodle.';
