...
$string['adminseesall'] = 'O adminstrador visualiza todo';
...
$string['badwordsconfig'] = 'Introduza a lista de palabras incorrectas separadas por vírgulas.';
...
$string['calendar_weekend'] = 'Días do fin de semana';
...
$string['configdigestmailtime'] = 'Ás persoas que escolleron recibir o correo electrónico en forma de resumo enviaráselle diariamente. Esta configuración controla o momento do día en que se envía o resumo (o cron executado despois desa hora será quen o envíe)';
...
$string['configenablestats'] = 'Se activa esta función, a tarefa de cron do Moodle procesará os accesos e entradas dalgunhas estatísticas. Dependendo da cantidade de tráfico do seu sitio, pode demorar un pouco. Activándoa poderá ver algúns gráficos interesantes e estatísticas sobre os seus cursos, ou sobre o sitio Web enteiro.';
...
$string['configfiltermatchonepertext'] = 'Os filtros de ligazón automática só xeran unha ligazón para a primeira instancia dun texto igual encontrado en cada elemento do texto na páxina, (p.ex. recursos, bloque). Todos os outros serán ignorados. Esta configuración ignórase cando a configuración Un por páxina esta definida como <i>Si</i>.';
$string['configfilteruploadedfiles'] = 'Procesa co filtro todos os ficheiros de texto e de HTML cargados antes de mostralos; só ficheiros HTML cargados ou ningúns.';
$string['configforcelogin'] = 'Normalmente, a páxina principal do sitio e as listaxes de curso (mais non os cursos) poden ser visualizadas sen rexistrarse no sitio. Se desexa obrigar ás persoas a rexistrarse antes de facer NADA no sitio debe activar esta configuración.';
$string['configforceloginforprofiles'] = 'Active esta configuración para facer que as persoas entren cunha conta verdadeira (non de convidados) antes de permitirlle ver as páxinas do perfil de usuario. Por defecto, está desactivado (falso) para que os posibles estudantes poidan ver os profesores de cada curso, mais isto significa tamén que os motores de busca Web poden velos.';
...
$string['configidnumber'] = 'Esta opción especifica se (a) Non se pedirá un número de identificación aos usuarios, (b) se preguntará aos usuarios un número de identificación mais poden deixalo en branco ou (c) se preguntará aos usuarios un número de identificación e non poden deixalo en branco. Se é dado, o número de identificación do usuario móstrase no seu perfil.';
...
$string['configintro'] = 'Nesta páxina pode especificar un número de variables de configuración que axudarán a facer que o Moodle funcione ben no seu servidor. Non se preocupe demasiado por isto. Por defecto funcionarán ben e pode voltar a esta páxina despois e modificar estas configuracións.';
...
$string['configintrosite'] = 'Esta páxina permite configurar a páxina principal e o nome deste novo sitio. Pode voltar aquí despois para modificar en calquera momento estas configuracións utilizando os menús de administración.';
...
$string['configlookahead'] = 'Días a contar a partir de hoxe';
...
$string['configmymoodleredirect'] = 'Esta configuración obriga a redirixir o acceso de non-administradores para /meu  e substitúe o menú de navegación superior por /meu';
...
$string['configproxyhost'] = 'Se este <b>servidor</b> precisa utilizar un proxy (Ex: un firewall) para acceder á Internet, entón introduza aquí o nome do servidor e o porto. No caso contrario déixeo en branco.';
...
$string['configslasharguments'] = 'Os ficheiros (imaxes, ficheiros cargados, etc) son fornecidos por un script que utiliza argumentos slash (a segunda opción aquí). Esta método permite que os ficheiros sexan máis facilmente colocados en caché nos exploradores web, servidores proxy, etc. Infelizmente, algúns servidores PHP non permiten este método, por iso se ten problemas para ver ficheiros cargados ou imaxes (ex: imaxes do usuario), defina esta variable na primeira opción.';
...
$string['configstatsmaxruntime'] = 'O procesamento de estatísticas pode ser moi intenso, por iso utilice unha combinación deste campo e o seguinte para especificar cando será executado e canto tempo demorará.';
...
$string['configteacherassignteachers'] = 'Deberán os profesores ter permiso para designar outros profesores para os seus cursos? Se Non, entón só os cresdores dos cursos e os administradores poderán designar profesores.';
...
$string['cronerrorclionly'] = 'O acceso á Internet para esta páxina foi desactivado polo administrador.';
...
$string['debugall'] = 'TODO: Mostra todas as mensaxes de depuración PHP razonables';
...
$string['forcetimezone'] = 'Facer obrigatoria o fuso horario predefinida';
...
$string['nonewsettings'] = 'No se engadiron novas configuracións durante esta actualización';
...
$string['pathtopgdumpinvalid'] = 'Camiño inválido para pg_dump, calquera camiño errado ou non executable';
...
$string['pathtopsqlinvalid'] = 'Camiño inválido para psql, calquera camiño errado ou non executable';
...
$string['profilespecificsettings'] = 'Configuración especifica';
...
$string['remotelangnotavailable'] = 'Non podemos facer a instalación do paquete de idioma debido a que o Moodle non consigue conectarse con download.moodle.org. Por favor, descargue os ficheiros comprimidos da lista de abaixo, cópieos no directorio $a e descomprímaos manualmente.';
...
$string['riskspam'] = 'Os usuarios poden enviar spam para os usuarios do sitio ou para outro';
...
$string['tabselectedtofront'] = 'Nas táboas con separadores, as filas que teñan o separador seleccionado deverán colocarse diante';
...
$string['timezonenotforced'] = 'Os usuarios poden escoller a súa propia zona horaria';
...
$string['unicodeupgradenotice'] = 'Na versión 1.6 de Moodle migramos todos os idiomas para Unicode. Para completar a actualización deste sitio, precisa convertir toda a súa base de datos para Unicode (UTF-8) utilizando a nosa escrita de migración. <a href=\"utfdbmigrate.php\">Prema aquí para executar agora a escrita de migración</a>!';
...
$string['upgradesettingsintro'] = 'A configuración mostrada abaixo engadíuse durante a última actualización de Moodle. Faga algunhas modificacións necesarias por defecto e, a seguir, prema Gardar configuración na parte inferior desta páxina.';
...
Despois de facelo non pode voltar atrás. <br /><br />
