<?PHP // $Id$ 
      // block_rss_client.php - created with Moodle 1.8.3 + (2007021532)
...
$string['feedstitle'] = 'Fontes RSS remotas';
...
$string['remotenewsfeed'] = 'Fonte de noticias remota';
...
$string['submitters'] = 'A quen se lle permitirá definir novas fontes RSS? As fontes definidas están dispoñibles para calquera páxina do sitio.';
$string['timeout'] = 'Tempo de espera do bloque RSS';
...
$string['validatefeed'] = 'Validar fonte';
