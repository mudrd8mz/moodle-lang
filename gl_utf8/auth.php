<?PHP // $Id$ 
      // auth.php - created with Moodle 1.8.3 + (2007021532)
...
$string['auth_fieldlock_expl'] = '<p><b>Bloquear valor:</b> Se está activado, previrá que os usuarios e administradores de Moodle editen un campo directamente. Utilice esta opción se está a manter estes datos no sistema de autorización externo. </p>';
...
$string['auth_mnetdescription'] = 'Os usuarios son autenticados de acordo coa Web de confianza definida na configuración da rede Moodle.';
...
$string['auth_nologintitle'] = 'Non hai sesión';
...
$string['auth_remove_keep'] = 'Manter interna';
$string['auth_remove_suspend'] = 'Suspender interna';
$string['auth_remove_user'] = 'Especifique que facer cunha conta de usuario interna durante unha sincronización masiva cando o usuario foi borrado da fonte externa. Só os usuarios suspendidos son retomados automaticamente se reaparecen nunha fonte externa.';
$string['auth_remove_user_key'] = 'Usuario externo borrado';
...
$string['auth_sync_script'] = 'Script de sincronización do Cron';
$string['auth_updatelocal'] = 'Actualización local';
$string['auth_updatelocal_expl'] = '<p><b>Actualización local:</b> Se está activada, o campo será actualizado (desde autenticación externa) cada vez que o usuario acceda ou haxa unha sincronización de usuario. Os campos definidos cunha actualización local deben ser bloqueados.</p>';
...
$string['errorpasswordupdate'] = 'Erro ao actualizar contrasinal, o contrasinal non cambiou';
$string['forcechangepassword'] = 'Obrigar a modificar o contrasinal';
$string['forcechangepassword_help'] = 'Obrigar os usuarios a modificar o contrasinal nos seus próximos accesos a Moodle.';
$string['forcechangepasswordfirst_help'] = 'Obrigar os usuarios a modificar o contrasinal no seu primeiro acceso a Moodle.';
...
$string['nopasswordchange'] = 'O contrasinal non pode cambiarse';
$string['nopasswordchangeforced'] = 'Non pode seguir sen cambiar o seu contrasinal, no entanto non hai ningunha páxina dispoñible para cambialo. Por favor, contacte co seu administrador de Moodle.';
