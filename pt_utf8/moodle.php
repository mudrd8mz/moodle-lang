...
$string['adminhelpmymoodle'] = 'Configurar os blocos \"o meu moodle\" para utilizadores';
...
$string['adminhelpstickyblocks'] = 'Configurar blocos largos persistentes do moodle';
...
$string['allchanges'] = 'Todas as laterações';
...
$string['backupactivehelp'] = 'Escolha se deverão ser feitas ou não cópias de segurança automatizadas.';
...
$string['courseapprovedemail'] = 'A disciplina que pediu, $a->name, foi aprovada e já foi registado como docente dessa disciplina. Para aceder a sua nova disciplina, visite $a->url';
...
$string['courseimportnotaught'] = 'Não parece ser um docente com privilegios de edição em nenhuma outra disciplina e, por tanto, não pode importar dados de outras disciplinas.';
...
$string['creatingblocksroles'] = 'Criando atribuição de papeis e revogações ao nível de blocos.';
...
$string['creatingcourseroles'] = 'Criaando atribuição de papeis e revogações ao nível de disciplinas.';
...
$string['creatingmodroles'] = 'Criando atribuição de papeis e revogações ao nível de módulos.';
...
$string['creatinguserroles'] = 'Criar atribuição de papeis e revogações ao nível de utilizadores.';
...
$string['defaultcoursestudentdescription'] = 'Os alunos geralmente têm menos privilegios dentro de uma disciplina.';
...
$string['deletecategorycheck'] = 'Tem a certeza absoluta que quer apagar completamtene esta categoria <b>\'$a\'</b>?<br />As disciplinas nessa categoria serão deslocadas para a categoria superior, se existir, ou para a categoria Geral.';
