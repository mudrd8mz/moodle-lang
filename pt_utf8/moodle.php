...
$string['activityclipboard'] = 'Deslocando esta actividade: <b>$a</b>';
...
$string['addsubcategory'] = 'Adicionar uma sub-categoria';
$string['addteacher'] = 'Adicionar professor';
$string['admin'] = 'Administrador';
$string['adminbookmarks'] = 'Gestão de favoritos';
...
$string['courseapprovedemail'] = 'A disciplina que pediu, $a->name, foi aprovada e já foi registado como docente dessa disciplina. Para aceder à sua nova disciplina, visite $a->url';
...
$string['courseimportnotaught'] = 'Não parece ser um docente com privilegios de edição em nenhuma outra disciplina e, portanto, não pode importar dados de outras disciplinas.';
...
$string['courserequestdisabled'] = 'Lamentamos, mas o pedido de disciplinas foi desactivado pelo administrador.';
...
$string['creatingsections'] = 'A criat secções';
...
$string['defaultcourseteacherdescription'] = 'Os docentes podem fazer qualquer coisa dentro de uma disciplina, incluindo alteração das actividades e avaliação dos alunos.';
...
$string['enrolme'] = 'moInscreva-me nesta disciplina';
...
$string['guestdescription'] = 'Os visitantes têm privilegios mínimos, e habitualmente não podem escrever texto em nenhuma parte.';
...
$string['lookback'] = 'Ver para atrás';
...
Na maior parte dos programas de correio electrónico o apontador anterior deverá aparecer sublinhado permitindo-lhe visitar essa página com um simples clic. Se isso não funcionar, copie o endereço para o campo de endereços no topo do seu browser.
...
$string['none'] = 'Nenhum';
$string['noneditingteacher'] = 'Docente não editor';
$string['noneditingteacherdescription'] = 'Os docentes não editores poderão leccionar numa disciplina e atribuir classificações aos alunos, mas não poderão modificar as actividades.';
...
$string['nosite'] = 'Não foi possível encontrar a disciplina do nivel do servidor.';
$string['nostatstodisplay'] = 'Lamentamos, mas não existem dados disponíveis para apresentar.';
...
$string['paymentpending'] = '(<small><b><u>$a</u></b> pendentes</small>)';
...
$string['show'] = 'Mostrar';
$string['showactions'] = 'Mostrar acções';
...
$string['skiptomaincontent'] = 'Avançar para o conteúdo principal';
...
$string['statsnodatauser'] = 'Não existem dados disponíves para essa combinação de disciplina, utilizador e período.';
...
$string['statsreport2'] = 'Consultas (docentes e alunos)';
$string['statsreport3'] = 'Contribuições (docentes e alunos)';
$string['statsreport4'] = 'Toda a actividade (docentes e alunos)';
...
$string['statsreportactivity'] = 'Toda a actividade (docentes e alunos)';
...
$string['statsteacheractivity'] = 'Actividade de docentes';
$string['statsteacherreads'] = 'Consultas de docentes';
$string['statsteacherwrites'] = 'Contribuições de docentes';
...
$string['statsuserreads'] = 'Consultas';
$string['statsuserwrites'] = 'Contribuições';
$string['statswrites'] = 'Contribuições';
...
$string['writinggroupingsinfo'] = 'Escrevendo informação de agrupações';
...
$string['back'] = 'Regressar'; // ORPHANED
$string['backuproleassignments'] = 'Incluir atribuições para estes cargos na cópia de segurança'; // ORPHANED
$string['backupsitefileshelp'] = 'Se for activado, os ficheiros do sítio usados em disciplinas serão íncluidos nas cópias de segurança automáticas'; // ORPHANED
$string['categoryname'] = 'Nome da categoria'; // ORPHANED
$string['categoryupdated'] = 'A categoria \'$a\' foi actualizada'; // ORPHANED
$string['confirmcheckfull'] = 'Tem certeza absoluta que quer confirmar $a'; // ORPHANED
$string['copyingsitefiles'] = 'A copiar ficheiros do sítio usados na disciplina'; // ORPHANED
$string['courseenrolenddate'] = 'Fim do período de inscrição'; // ORPHANED
$string['courseenrolstartdate'] = 'Início do período de inscrição'; // ORPHANED
$string['creatinggroupingsgroups'] = 'A adicionar grupos ao agrupamento'; // ORPHANED
$string['editcategorysettings'] = 'Editar definições da categoria'; // ORPHANED
$string['editcategorythis'] = 'Editar esta categoria'; // ORPHANED
$string['emailpasswordchangeinfodisabled'] = 'Viva $a->firstname,

Alguém (provavelmente você) pediu uma nova senha para a sua conta em \'$a->sitename\'.

Desafortunadamente, a sua conta neste sítio foi desactivada e não pode ser activada novamente; por favor entre em contacto com o administrador do sítio, $a->admin'; // ORPHANED
$string['enrolledincoursenotrole'] = 'Erro na inscrição em \"$a->course\" como \"$a->role\"'; // ORPHANED
$string['enrolledincourserole'] = 'Inscrito em \"$a->course\" como \"$a->role\"'; // ORPHANED
$string['formattopicscss'] = 'Formato tópicos - CSS sem tabelas'; // ORPHANED
$string['general'] = 'Geral'; // ORPHANED
$string['gotoyourserver'] = '(aponta de volta para o seu servidor)'; // ORPHANED
$string['groupextendenrol'] = 'Estender inscrições de todos'; // ORPHANED
$string['healthnoproblemsfound'] = 'Não foi encontrado nenhum problema de saúde!'; // ORPHANED
$string['helpinterestslist'] = 'Introduça os seus interesses, separados por vírgulas'; // ORPHANED
$string['idnumbertaken'] = 'Este número de identificação já está a ser usado'; // ORPHANED
$string['includeroleassignments'] = 'Incluir cargos atribuidos'; // ORPHANED
$string['includesitefiles'] = 'Incluir ficheiros do sítio usados nesta disciplina'; // ORPHANED
$string['interests'] = 'Interesses'; // ORPHANED
$string['interestslist'] = 'Lista de interesses'; // ORPHANED
$string['nologsfound'] = 'Não foram encontrados registos de actividade'; // ORPHANED
$string['nousersfound'] = 'Nenhum utilizador encontrado'; // ORPHANED
$string['olduserdirectory'] = 'Este é o ANTIGO directório de utilizadores, que já não é necessário. Pode apagá-lo sem problemas. Os ficheiros nele contidos foram copiados para o NOVO directório.'; // ORPHANED
$string['parentcategory'] = 'Categoria ascendente'; // ORPHANED
$string['policyaccept'] = 'Compreendo e concordo'; // ORPHANED
$string['remotemaharauser'] = 'Utilizador Mahara remoto'; // ORPHANED
$string['scalestandard'] = 'Escala padrão'; // ORPHANED
$string['scheduledbackupsinactive'] = 'O administrador do sítio não tem activado cópias de segurança programadas'; // ORPHANED
