...
$string['configcoursemanager'] = 'Estas configurações permitem ao utilizador controlar quem aparece na descrição da disciplina. Os utilizadores necessitam de ter pelo menos um destes cargos na descrição da disciplina daquela disciplina.';
...
$string['configcronclionly'] = 'Se esta opção está seleccionada, então \"cron\" script só pode ser corrido através da linha de comandos em vez da Web. Isto sobrepõe a palavra-chave \"cron\" indicada anteriormente.';
$string['configcronremotepassword'] = 'Isto significa que o script \"cron.php\" ão pode ser corrido através de browser de Internet sem fornecer a palavra-chave usando o seguinte tipo de URL: <pre> http://site.example.com/admin/cron.php?password=opensesame </pre>. Se for deixado em branco, então nenhuma palavra-chave será necessária.';
...
$string['configguestroleid'] = 'Este cargo é automaticamente atribuído ao utilizador \"Visitante\". Também é atribuído a utilizadores não validados, quando estes entram numa disciplina que permite acesso a \"Guests\" sem palavras-chaves. Verifique sempre se o cargo tem permissões de visitante no moodle/legacy e de ver no moodle/course.';
...
$string['confignonmetacoursesyncroleids'] = 'Por defeito, todas as inscrições ás opções de uma disciplina são sincronizadas em meta-disciplinas. Cargos que são escolhidos aqui não são incluídos no processo de sincronização.';
...
$string['configopentogoogle'] = 'Se activar esta definição, o Google terá permissão para entrar no seu site como visitante. Adicionalmente, qualquer pessoa que entre no seu site através de uma pesquisa Google entrará nele como visitante. Repare que só dará acesso a Disciplinas que já permitam acesso a visitantes.';
...
$string['configpathtodu'] = 'Caminho para o du. Provavelmente algo do tipo /usr/bin/du. Se dar o caminho, as páginas que mostrem conteúdos de directórios irão aparecer muito mais depressa em directórios com muitos ficheiros.';
...
$string['cronerrorpassword'] = 'Não tem palavra chave válida para aceder a esta página.';
$string['cronremotepassword'] = 'Palavra chave do cron para acesso remoto.';
