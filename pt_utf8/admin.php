...
$string['addcounter'] = 'Adicionar contador no fim';
...
$string['choosefiletoedit'] = 'Escolha ficheiro a editar';
...
$string['configlatinexcelexport'] = 'Seleccione a codificação para exportar para o Excel';
...
$string['configminpassworddigits'] = 'As palavras chave deverão ter, no mínimo, este número de dígitos.';
...
$string['configvisiblecourses'] = 'Apresentar normalmente as disciplinas em categorias ocultas';
...
$string['creatornewroleid'] = 'Papel dos criadores nas novas disciplinas';
$string['cronclionly'] = 'Execução do cron unicamente a partir da linha de comandos';
$string['cronerrorclionly'] = 'Lamentamos, mas o acesso Internet a esta página foi desactivado pelo administrador.';
$string['cronerrorpassword'] = 'Lamentamos, mas não deu uma palavra chave válida para aceder a esta página';
$string['cronremotepassword'] = 'Palavra chave para acesso remoto ao cron';
...
$string['debugdisplay'] = 'Mostrar mensagens de depuração';
...
$string['debugsmtp'] = 'Depurar envio de correio electrónico';
...
$string['editorspelling'] = 'Corrector ortográfico do editor';
$string['editorspellinghelp'] = 'Activar ou desactivar correcção ortográfica. Quando for activada, o programa <strong>aspell</strong> deverá ser instalado no servidor.';
...
$string['enablehtmlpurifier'] = 'Actirifivar purificador de HTML';
...
$string['filecreated'] = 'Criado novo ficheiro';
$string['filestoredin'] = 'Gravar ficheiro no directório:';
$string['filestoredinhelp'] = 'Onde será gravado o ficheiro';
...
$string['frontpagedefaultrole'] = 'Papel, por omissão, na página principal';
$string['frontpageloggedin'] = 'Itens na página principal, quando autenticado';
$string['frontpagerestore'] = 'Recuperação da página principal';
$string['frontpageroles'] = 'Papeis para a página principal';
...
$string['guestroleid'] = 'Papel para os visitantes';
...
$string['latinexcelexport'] = 'Codificação do Excel';
...
$string['memcachedpconn'] = 'uso de ligações persistentes no memcache';
$string['messaging'] = 'Habilitar sistema de envio de mensagens';
$string['minpassworddigits'] = 'Dígitos';
$string['minpasswordlength'] = 'Tamanho da palavra chave';
...
$string['multilangupgrade'] = 'Actualização do multi-língua';
...
$string['newusernamehandling'] = 'Tratamento de nomes de novos utilizadores repetidos';
...
$string['passwordpolicy'] = 'Política de Palavras Chave';
...
$string['profilecategoryname'] = 'Nome da categoria (deverá ser único)';
$string['profilecategorynamenotunique'] = 'Esta categoria já está a ser usada';
$string['profilecommonsettings'] = 'Configurações comuns';
$string['profilecreatecategory'] = 'Criar nova categoria de perfil';
$string['profilecreatefield'] = 'Criar novo campo do perfil:';
$string['profilecreatenewcategory'] = 'Criar nova categoria';
$string['profilecreatenewfield'] = 'A criar um novo campo do perfil: \"$a\"';
$string['profiledefaultcategory'] = 'Outros campos';
$string['profiledefaultdata'] = 'Valor por omissão';
$string['profiledeletecategory'] = 'A apagar categoria';
$string['profiledeletefield'] = 'A apagar campo';
$string['profiledescription'] = 'Descrição do campo';
$string['profileeditcategory'] = 'A editar categoria: $a';
$string['profileeditfield'] = 'A editar campo do perfil: $a';
...
$string['profilefields'] = 'Campos do perfil de utilizador';
$string['profilefieldsize'] = 'Tamanho da parte apresentada';
$string['profilefieldtypemenu'] = 'Menu de opções';
...
$string['profileinvaliddata'] = 'Valor não válido';
...
$string['profilemenunooptions'] = 'Não foi dada nenhuma opção para o menu';
$string['profilemenuoptions'] = 'Opções para o menu (uma por linha)';
$string['profilemenutoofewoptions'] = 'Deverá dar pelo menos duas opções para o menu';
$string['profilename'] = 'Nome';
$string['profilenofieldsdefined'] = 'Não têm sido definidos campos';
...
$string['xmlstrictheaders'] = 'Cabeçalhos XML estrictos';
