...
$string['configdoctonewwindow'] = 'Se activar esta opção, os vínculos para os Documentos do Moodle serão mostrados numa nova janela.';
...
$string['configfiltermatchoneperpage'] = 'Os filtros de ligação automática apenas irão gerar um vínculo para a primeira instância de um texto igual encontrado na página completa. Todos os outros serão ignorados.';
$string['configfiltermatchonepertext'] = 'Os filtros de ligação automática apenas irão gerar um vínculo para a primeira instância de um texto igual encontrado em cada pedaço de texto (Ex: Recurso, bloco) nessa página. Todos os outros serão ignorados. Esta definição será ignorada se a definição Um por Página estiver definida para <i>Sim</i>.';
...
$string['confighideactivitytypenavlink'] = 'Seleccione a que utilizadores não será apresentado o vínculo de tipo de actividade (por exemplo, testes) na navegação apresentada para os módulos de actividades.';
...
$string['configintrosite'] = 'Esta página permitir-lhe-à configurar a página principal e o nome do seu novo sítio. Poderá cá voltar depois para alterar essas definições utilizando o vínculo \'Configuração\' na página inicial.';
...
$string['configsupportpage'] = 'Este endereço Web será divulgado aos utilizadores deste sítio, como o endereço de contacto para pedidos de ajuda (por exemplo, quando os utilizadores criarem as suas próprias contas). Se este endereço estiver em branco, não será dado nenhum vínculo para ajuda.';
...
$string['lang16notify'] = 'A partir da versão 1.6, Moodle permite instalar e actualizar pacotes linguísticos directamente do servidor download.moodle.org, usando vínculo que se segue';
