...
$string['autolang'] = 'Autodetecção da língua';
...
$string['cfgwwwrootslashwarning'] = 'A variável $CFG->wwwroot está mal definida no seu ficheiro de configuração config.php. Foi incluida uma barra \'/\' no fim. Por favor retire a barra, para evitar problemas estranhos como  <a href=\'http://tracker.moodle.org/browse/MDL-11061\'>MDL-11061</a>';
$string['cfgwwwrootwarning'] = 'A variável $CFG->wwwroot está mal definida no seu ficheiro de configuração config.php. Não concide com o URL que está a usar para aceder a esta página. Por favor corrija o URL, para evitar problemas estranhos como  <a href=\'http://tracker.moodle.org/browse/MDL-11061\'>MDL-11061</a>';
...
$string['configenablerssfeedsdisabled2'] = 'As listagens RSS estão desactivadas a nível do servidor. Precisa aactivá-las primeiro em Servidor/RSS.';
...
$string['configgeoipfile'] = 'Localização do ficheiro binário de dados do GeopIP City. Este ficheiro não faz parte da distribuição do Moodle e deverá ser obtido por separado em <a href=\"http://www.maxmind.com/\">MaxMind</a>.<br />Poderá ou comprar uma versão comercial, ou usar a versão livre, descarregando <a href=\"http://www.maxmind.com/download/geoip/database/GeoLiteCity.dat.gz\" >http://www.maxmind.com/download/geoip/database/GeoLiteCity.dat.gz</a> e extraíndo o seu conteúdo no directório \"$a\" no seu servidor.';
$string['configgooglemapkey'] = 'Precisa de uma chave especial para usar o Google Maps para vizualizar a localização de endereços IP. Chave essa que pode ser obtida gratuitamente em <a href=\"http://code.google.com/apis/maps/signup.html\" >http://code.google.com/apis/maps/signup.html</a>.<br />O URL do seu sítio Web é: $a';
...
$string['confighideactivitytypenavlink'] = 'Seleccione a que utilizadores não será apresentado o paontador de tipo de actividade (por exemplo, testes) na navegação apresentada para os módulos de actividades.';
...
$string['configproxypassword'] = 'Senha necessária para acceder à Internet através do proxy, se for necessária, ou vazío se não for necessária (será necessária a extensão cURL do PHP)';
...
$string['configproxyuser'] = 'Nome de utilizador necessário para acceder à Internet através do proxy, se for necessário, ou vazío se não for necessária (será necessária a extensão cURL do PHP)';
...
$string['configxmlstrictheaders'] = 'Se activar esta opção, cada página será produzida com cabeçalho e pólogo XML, para que os navegadores mostrem quaisquer erros de XHTML. Isso só será útil para os programadores.';
...
$string['disablecourseajax'] = 'Deactivar o AJAX na edição da disciplina';
...
$string['emptysettingvalue'] = 'Vazío';
...
$string['iplookupinfo'] = 'Por omissão, usa o servidor livre do NetGeo (a base de dados geogáficos da Internet) para procurar endereços IP; desafortunadamente, essa base de dados deixou de ser actualizada e poderá devolver dados <em>completamente incorrectos</em>.
Recomenda-se instalar uma cópia local da base de dados livre do GeoLite City da MaxMind.<br />
A localização dos endereços IP é apresentrada num mapa simples ou usando Google Maps. Por favor repare que precisa de uma conta no Google e terá que fazer um pedido de uma chave para o Google Maps API para activar os mapas interactivos.';
...
$string['langpackwillbeupdated'] = 'Nota para os traductores: Durante a actualização, o Moodle tentará actualizar o seu pacote linguístico. As suas alterações em pastas não locais serão sbore escritas.';
...
$string['rowpreviewnum'] = 'Previsualizar linhas';
...
$string['uploaduserspreview'] = 'Enviar previsualização de utilizadores';
...
$string['uuupdatetype'] = 'Promenores de utilizador existente';
...
$string['webproxyinfo'] = 'Preencha as seguintes definições se o seu servidor Moodle não poder aceder à Interner directamente. O acesso à Internet é necessário para descarregar dados do ambieente, pacotes linguísticos, fusos horários, etc.<br /><em>Recomenda-se vivamente usar a extensão cURL do PHP.</em>';
