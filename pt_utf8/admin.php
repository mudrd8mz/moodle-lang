...
$string['configtimezone'] = 'Pode definir a zona horária por defeito aqui. Apenas é a zona horária por DEFEITO para mostrar datas - cada utilizador poderá alterar a sua definindo-a no seu Perfil. \"Server Time\" aqui fará com que o Moodle utilize as definições do sistema operativo do servidor por defeito, mas \"Server Time\" nos perfis dos utilizadores fará utilizar por defeito as definições dos utilizadores. Os trabalhos do cron que estejam dependentes de uma hora do dia vão utilizar esta Zona Horária.';
...
$string['pathtopgdump'] = 'Caminho para o programa <i>pg_dump</i>';
