...
$string['configallowoverride'] = 'Permitir que os cargos no lado esquerdo revogem os cargos em cada coluna.';
...
$string['configauthenticationplugins'] = 'Por Favor, escolha os plugins de autenticação que deseja usar e arranje-os pela ordem pretendida. Registo automático vai ser atribuído pelo plugin escolhido na coluna de \'Registo\' (normalmente email).';
...
$string['configdbsessions'] = 'Se activa, esta definição utilizará a Base de Dados para guardar a informação sobre sessões correntes. É especialmente útil para sites grandes/muito carregados ou sites construídos sobre clusters de servidores. Para a maioria dos sítios dever-se-á deixar inactivo para que seja utilizado o disco do servidor. Repare que alterando esta definição agora irá provocar a saída de todos os utilizadores actuais (e de si tmabém). Se estiver a usar MySQL, verifique no ficheiro my.cnf (ou my.ini) que \'max_allowed_packet\' tenha um valor de, pelo menos, 40 M.';
...
$string['configdebugsmtp'] = 'Acciona (verbose debug information) durante o envio de mensagens de email para o servidor SMTP.';
...
$string['configdefaultuserroleid'] = 'A todos os utilizadores autenticados serão atribuidas as permissões do cargo que indicar aqui, ao nível do sítio, JUNTO com quaisquer outras permissões que esse utilizador possuir. O cargo por omissão é Visitante. Repare que isso não entrará em conflicto com outros cargos que os utilizadores tiverem; simplesmente garante que os utilizadores possam fazer qualquer coisa útil no sítio (por exemplo, ler mensagens nos fóruns, ver recursos, etc).';
...
$string['configdocroot'] = 'Define o caminho para os Documentos do Moodle. Pode alterá-lo se desejar ter a sua própria documentação online. Contudo, se o alterar, verifique que o novo caminho respeita o formato necessário, como http://docs.moodle.org';
...
$string['configintroadmin'] = 'Nesta página deverá configurar a sua conta de Administrador principal que lhe dará um controlo total ao longo do site. Não se esqueça de dar um nome de utilizador e senha seguros, tal como um endereço de correio válido. Poderá criar mais contas de Administrador posteriormente.';
...
$string['configmemcachedhosts'] = 'Para \"Memcached\". Listas separadas dos hosts por \";\" que estejam a correr o \"Memcache Daemon\". Use endereços IP para evitar excesso de carga no serviço de DNS. \"Memcached\" não funciona correctamente se usar adiciona/remove hosts num programa de configuração.';
...
$string['configproxyhost'] = 'Se este <b>servidor</b> precisar de proxy (Ex: uma firewall) para aceder à Internet, coloque aqui o nome do servidor proxy e a respectiva porta. Caso contrário deixe em branco.';
...
$string['debugsmtp'] = 'Depuração de erros no envio de email.';
...
$string['longtimewarning'] = '<b> Tome nota que este processo pode demorar muito tempo. </b>';
...
$string['misc'] = 'Outros';
$string['mnetrestore_extusers'] = '<strong> Nota: </strong> Esta cópia de segurança contém as contas de utilizadores remotos do Moodle Network que vão ser restauradas como parte do processo.';
$string['mnetrestore_extusers_mismatch'] = '<strong> Nota: </strong> Esta cópia de segurança aparentemente origina de uma instalação diferente do Moodle e contém as contas de utilizadores remotos da rede Moodle que falham a restaurar. Esta operação não é suportada. Se tem a certeza que foi criada nesta instalação do Moodle, ou se garantir que todos os hosts da rede Moodle necessários, pode querer tentar então restaurar.';
...
$string['multilangupgradenotice'] = 'O seu site está provavelmente a usar uma versão antiga do multilang. É recomendado uma <a href=\"multilangupgrade.php\"> actualização da multilang</a>.';
...
$string['nonmetacoursesyncroleids'] = 'Cargos que não estão sincronizados com metadisciplinas.';
...
$string['smartpix'] = 'Procura inteligente de ícons';
...
$string['unattendedoperation'] = 'Operação não atendida';
...
$string['allowcategorythemes'] = 'Permitir temas de categorias'; // ORPHANED
$string['allowdeletes'] = 'Permitir apagar'; // ORPHANED
$string['cfgwwwrootslashwarning'] = 'A variável $CFG->wwwroot está mal definida no seu ficheiro de configuração config.php. Foi incluida uma barra \'/\' no fim. Por favor retire a barra, para evitar problemas estranhos como  <a href=\'http://tracker.moodle.org/browse/MDL-11061\'>MDL-11061</a>'; // ORPHANED
$string['cfgwwwrootwarning'] = 'A variável $CFG->wwwroot está mal definida no seu ficheiro de configuração config.php. Não concide com o URL que está a usar para aceder a esta página. Por favor corrija o URL, para evitar problemas estranhos como  <a href=\'http://tracker.moodle.org/browse/MDL-11061\'>MDL-11061</a>'; // ORPHANED
$string['configallowcategorythemes'] = 'Se activar esta opção, os temas poderão ser definidos a nível das categorias. Essa definição será usada em todas as disciplinas e subcategorias, a menos que tenham definido o seu próprio tema. ATENÇÃO: O uso de temas para as categorias pode piorar o desempenho.'; // ORPHANED
$string['configdisableuserimages'] = 'Desactivar a opção dos utilizadores para mudarem a imagem no seu perfil.'; // ORPHANED
$string['configenablegroupings'] = 'Esta opção permite o agrupamento de grupos.'; // ORPHANED
$string['configenablehtmlpurifier'] = 'Usar o purificador de HTML em vez do KSES para limpar texto que possa ser inseguro. O purificador de HTML está a ser desenvolvido activamente e, por tanto, deverá ser mas seguro, mas utiliza mais recursos. O código html resultante poderá ter algumas diferenças visuais. Repare que as etiquetas object e embed não podem ser activadas, e não há suporte para etiquetas MathML nem para as antigas etiquetas lang.'; // ORPHANED
$string['configgradeexport'] = 'Escolha o formato para os seus principais métodos de exportação de notas. Os plugins seleccionados serão configurados e usados no campo \"ultima exportação\" de cada nota. Por exemplo, isto poderá fazer com que os registos exportados sejam identificados como \"novos\" ou \"actualizados\". Se não tiver a certeza do uso desta opção, não a seleccione.'; // ORPHANED
$string['confighideactivitytypenavlink'] = 'Seleccione a que utilizadores não será apresentado o paontador de tipo de actividade (por exemplo, testes) na navegação apresentada para os módulos de actividades.'; // ORPHANED
$string['configkeeptagnamecase'] = 'Seleccione esta opção se quiser que as etiquetas mantenham o mesmo tipo de letra (maiúsculas ou minúsculas) com que forem criadas.'; // ORPHANED
$string['configminpassworddigits'] = 'As senhas deverão ter, no mínimo, este número de dígitos.'; // ORPHANED
$string['configminpasswordlength'] = 'As senhas deverão ter pelo menos este número de caracteres.'; // ORPHANED
$string['configminpasswordlower'] = 'As senhas deverão ter pelo menos este número de letras minúsculas.'; // ORPHANED
$string['configminpasswordnonalphanum'] = 'As senhas deverão ter pelo menos este número de caracteres não alfanuméricos.'; // ORPHANED
$string['configminpasswordupper'] = 'As senhas deverão ter pelo menos este número de letras maiúsculas.'; // ORPHANED
$string['confignodefaultuserrolelists'] = 'Esta opção impede que qualquer utilizador seja tetornado da base de dados devido ao uso de funções desactualizadas como get_course, etc., para a disciplina do sítio, se o cargo por omissão permitir essa acesso. Seleccione esta opção se estiver a sofrer problemas de desempenho.'; // ORPHANED
$string['configpasswordpolicy'] = 'Se esta opção for activada, o Moodle verificará as senhas de acordo com um procedimento de validação de senhas. Use as configurações abaixo para definir esse procedimento (serão ignoradas se escolher \'Não\' aqui).'; // ORPHANED
$string['configsupportemail'] = 'Este endereço de correio electrónico será divulgado aos utilizadores deste sítio, como o endereço de contacto para pedidos de ajuda (por exemplo, quando os utilizadores criarem as suas próprias contas). Se este endereço estiver em branco, não será dado nenhum contacto para ajuda.'; // ORPHANED
$string['configsupportname'] = 'Este é o nome da pessoa ou entidade que oferece ajuda através do endereço web ou de correio divulgado para esse fim.'; // ORPHANED
$string['configsupportpage'] = 'Este endereço Web será divulgado aos utilizadores deste sítio, como o endereço de contacto para pedidos de ajuda (por exemplo, quando os utilizadores criarem as suas próprias contas). Se este endereço estiver em branco, não será dado nenhum apontador para ajuda.'; // ORPHANED
$string['configusetags'] = 'Deverá ser activada a funcionalidade de palavras chave em todo o sítio?'; // ORPHANED
$string['configxmlstrictheaders'] = 'Se activar esta opção, cada página será produzida com cabeçalho e pólogo XML, para que os navegadores mostrem quaisquer erros de XHTML. Isso só será útil para os programadores.'; // ORPHANED
$string['csvdelimiter'] = 'Delimitador CSV'; // ORPHANED
$string['defaultvalues'] = 'Valores por omissão'; // ORPHANED
$string['deleteerrors'] = 'Apagar erros'; // ORPHANED
$string['disableuserimages'] = 'Desactivar imagens no perfil dos utilizadores'; // ORPHANED
$string['editingnoncorelangfile'] = 'Está a tentar modificar a tradução de um módulo ou plugin adicional. As traduções de módulos adicionais  só poderão ser guardadas na sua pasta _local. Seria melhor que deslocasse o ficheiro com a tradução para o directório lang do módulo e/ou enviasse uma cópia para o responsável por esse módulo.'; // ORPHANED
$string['enablegroupings'] = 'Activar agrupamentos'; // ORPHANED
$string['enablehtmlpurifier'] = 'Activar purificador de HTML'; // ORPHANED
$string['encoding'] = 'Codificação'; // ORPHANED
$string['frontpagedefaultrole'] = 'Cargo, por omissão, na página principal'; // ORPHANED
$string['frontpagequestions'] = 'Perguntas da página principal'; // ORPHANED
$string['gradeexport'] = 'Método primário de exportação de notas'; // ORPHANED
$string['hideactivitytypenavlink'] = 'Ocultar a navegação de tipo de actividade'; // ORPHANED
$string['hidefromall'] = 'Ocultar a todos os utilizadores'; // ORPHANED
$string['hidefromnone'] = 'Não ocultar a ninguém'; // ORPHANED
$string['hidefromstudents'] = 'Ocultar aos alunos'; // ORPHANED
$string['keeptagnamecase'] = 'Manter maiúsculas/minúsculas no nome da etiqueta'; // ORPHANED
$string['langnoeditenglish'] = 'Não é possível modificar o pacote linguístico básico em inglês. Por favor mude de directório lang para fazer alterações locais.'; // ORPHANED
$string['langpackmaintaining'] = 'Manutenção do pacote linguístico'; // ORPHANED
$string['langpackwillbeupdated'] = 'Nota para os traductores: Durante a actualização, o Moodle tentará actualizar o seu pacote linguístico. As suas alterações em pastas não locais serão sbore escritas.'; // ORPHANED
$string['localstringcustomization'] = 'Adaptação local de mensagens de texto'; // ORPHANED
$string['minpassworddigits'] = 'Dígitos'; // ORPHANED
$string['minpasswordlength'] = 'Tamanho da senha'; // ORPHANED
$string['minpasswordlower'] = 'Letras minúsculas'; // ORPHANED
$string['minpasswordnonalphanum'] = 'Caracteres não alfanuméricos'; // ORPHANED
$string['minpasswordupper'] = 'Letras maiúsculas'; // ORPHANED
$string['nochanges'] = 'Sem alterações'; // ORPHANED
$string['nodefaultuserrolelists'] = 'Não responda com todos os utilizadores com o cargo por omissão'; // ORPHANED
$string['nomissingstrings'] = 'Não existem frases em falta'; // ORPHANED
$string['numberofmissingstrings'] = 'Numero de frases em falta: $a'; // ORPHANED
$string['numberofstrings'] = 'Número total de frases: $a->strings<br />Em falta: $a->missing ($a->missingpercent %%%%%%%%%%%%%%%%)'; // ORPHANED
$string['passwordpolicy'] = 'Política de senhas'; // ORPHANED
$string['pleaserefreshregistration'] = 'O seu sítio foi registado em moodle.org, considere a possibilidade de actualizar esse registo se houver alterações significativas desde a sua última actualização a $a'; // ORPHANED
$string['profilefieldcolumns'] = 'Colunas'; // ORPHANED
$string['profilefieldrows'] = 'Linhas'; // ORPHANED
$string['profilefieldtypetextarea'] = 'Bloco de texto'; // ORPHANED
$string['profileforceunique'] = 'A data deverá ser única?'; // ORPHANED
$string['profilesignup'] = 'Mostrar na página de registo?'; // ORPHANED
...
$string['requiredtemplate'] = 'Necessário. Pode usar aqui a sintaxe de templates (%%%%%%%%%%%%%%%%l = apelido, %%%%%%%%%%%%%%%%f = nome, %%%%%%%%%%%%%%%%u = nome de utilizador). Veja mais pormenores e exemplos na ajuda.'; // ORPHANED
$string['rowpreviewnum'] = 'Previsualizar linhas'; // ORPHANED
$string['sectionerror'] = 'Erro em secção!'; // ORPHANED
$string['serverlimit'] = 'Limite de servidor'; // ORPHANED
$string['supportemail'] = 'Correio electrónico para pedidos de ajuda'; // ORPHANED
$string['supportname'] = 'Pessoa o entidade que recebe pedidos de ajuda'; // ORPHANED
$string['supportpage'] = 'Página de pedidos de ajuda'; // ORPHANED
$string['uploaduserspreview'] = 'Enviar previsualização de utilizadores'; // ORPHANED
$string['uploadusersresult'] = 'Enviar resultados de utilizadores'; // ORPHANED
$string['userbulk'] = 'Acções de blocos de utilizadores'; // ORPHANED
$string['userdeleted'] = 'Utilizador eliminado'; // ORPHANED
$string['usersdeleted'] = 'Utilizadores eliminados'; // ORPHANED
$string['usersskipped'] = 'Utilizadores ignorados'; // ORPHANED
$string['usetags'] = 'Activar funcionalidade de palavras chave'; // ORPHANED
$string['uubulk'] = 'Seleccionar para operações em massa'; // ORPHANED
$string['uubulkall'] = 'Todos os utilizadores'; // ORPHANED
$string['uubulknew'] = 'Novos utilizadores'; // ORPHANED
$string['uubulkupdated'] = 'Utilizadores actualizados'; // ORPHANED
$string['uucoursedefaultrole'] = 'Cargo por omissão na disciplina'; // ORPHANED
$string['uucsvline'] = 'linha CSV'; // ORPHANED
$string['uulegacy1role'] = '(Aluno original) tipo=1'; // ORPHANED
$string['uulegacy2role'] = '(Professor original) tipo=2'; // ORPHANED
$string['uulegacy3role'] = '(Professor não editor original) tipo=3'; // ORPHANED
$string['uunoemailduplicates'] = 'Impedir duplicação de endereços de correio'; // ORPHANED
$string['uuoptype'] = 'Tipo de envio'; // ORPHANED
$string['uuoptype_addinc'] = 'Adicionar todos e juntar contador aos nomes de utilizador, se for preciso'; // ORPHANED
$string['uuoptype_addnew'] = 'Adicionar apenas os novos, ignorando utilizadores já existentes.'; // ORPHANED
$string['uuoptype_addupdate'] = 'Adicionar os novos, actualizando os utilizadores já existentes'; // ORPHANED
$string['uuoptype_update'] = 'Apenas actualizar os utilizadores já existentes'; // ORPHANED
$string['uupasswordnew'] = 'Nova senha de utilizador'; // ORPHANED
$string['uupasswordold'] = 'Senha de utilizador existente'; // ORPHANED
$string['uupreprocessedcount'] = 'Número de registos processados: $a'; // ORPHANED
$string['uuupdateall'] = 'Substituir com ficheiro e valores por omissão'; // ORPHANED
$string['uuupdatefromfile'] = 'Substituir com ficheiro'; // ORPHANED
$string['uuupdatemissing'] = 'Preencher o que faltar a partir do ficheiro e dos valores por omissão'; // ORPHANED
$string['uuupdatetype'] = 'Promenores de utilizador existente'; // ORPHANED
$string['xmlstrictheaders'] = 'Cabeçalhos XML estrictos'; // ORPHANED
