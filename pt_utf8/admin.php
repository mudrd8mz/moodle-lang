...
$string['configproxypassword'] = 'Senha necessária para acceder à Internet através do proxy, se for necessária, ou vazio se não for necessária (será necessária a extensão cURL do PHP)';
...
$string['configproxyuser'] = 'Nome de utilizador necessário para acceder à Internet através do proxy, se for necessário, ou vazio se não for necessária (será necessária a extensão cURL do PHP)';
