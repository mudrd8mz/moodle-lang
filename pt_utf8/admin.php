...
$string['badwordsconfig'] = 'Escreva a sua lista de mãs palavras, separada por vírgulas.';
$string['cachetext'] = 'Tempo de vida da cache de texto';
$string['calendarsettings'] = 'Calendário';
$string['change'] = 'mudar';
$string['changesitelang'] = 'Mudar a língua do sítio';
$string['configlang'] = 'Seleccione uma língua por omissão para o sítio. Cada utilizador poderá posteriormente seleccionar a sua língua.';
