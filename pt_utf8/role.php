...
$string['legacy:user'] = 'LEGADO DE ATRIBUIÇÕES: Utilizador autenticado';
...
$string['resetrolesure'] = 'Tem a certeza que quer restaurar o cargo \"$a->name ($a->shortname)\" para o cargo definido por defeito? ?<p></p> Os restauros são retirados ca capacidade do legado seleccionado  ($a->legacytype).';
...
$string['role:unassignself'] = 'Mudar o papel atribuido a si próprio';
...
$string['tag:create'] = 'Criar novos separadores';
$string['tag:edit'] = 'Editar separadores existentes';
$string['tag:editblocks'] = 'Editar blocos nas páginas de separadores';
$string['tag:manage'] = 'Gerir todos os separadores';
$string['user:changeownpassword'] = 'Mudar a sua própria palavra chave';
