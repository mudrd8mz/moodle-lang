...
$string['deletesubmissionwarning'] = 'Atenção: existem $a apreciações associadas a este envio.<br />Recomenda-se que este envio NÃo seja apagado.';
...
$string['enterpassword'] = 'Insira a palavra chave';
...
$string['maximumgradeforsubmissions'] = 'Nota máxima para os envios: $a';
...
$string['noteongradinggrade'] = 'Esta nota mede a conncordância entre a sua própria avaliação do seu trabalho e a avaliação feita pelo(a) $a. Quanto maior a nota, maior será a concordância.';
...
$string['passwordprotectedexercise'] = 'Exercício protegido por palavra chave';
$string['phase'] = 'Fase';
...
$string['wrongpassword'] = 'Palavra chave errada para este exercício';
