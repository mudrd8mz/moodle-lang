...
$string['mustbeteacher'] = 'O acesso a esta página está reservado aos docentes';
...
$string['unicodeupgradeerror'] = 'Desculpe, mas a sua base de dados não se encontra com codificação \"UNICODE\", e esta versão do Moodle não tem a opção para migrar a sua base de dados para \"UNICODE\". Por favor, 
actualize para Moodle 1.7.x primeiro e execute a migração \"UNICODE\" a partir da página Admin. Depois de isso estar feito, deve conseguir migrar para Moodle $a';
