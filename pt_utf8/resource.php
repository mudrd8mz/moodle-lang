...
$string['autofilerename'] = 'Actualizar o vínculo se o ficheiro for renomeado';
...
$string['configpopupdirectories'] = 'As novas janelas que sejam criadas deverão apresentar, por omissão, o vínculo que localiza a página dentro da estrutura do sítio?';
...
$string['configwebsearch'] = 'Quando se inserir uma URL, por exemplo uma página web ou um vínculo, esta URL será apresentada aos utilizadores para lhes ajudar a procurar o URL desejado.';
...
$string['directlink'] = 'Vínculo direito para este ficheiro';
...
$string['newdirectories'] = 'Mostrar os vínculos de directórios';
...
$string['resourcetypefile'] = 'Vínculo para ficheiro ou página';
