...
$string['alreadygraded'] = 'O seu trabalho já foi avaliado, pelo que já não o pode enviar novamente';
...
O comentário encontra-se anexo no fim do seu trabalho:
...
$string['emailstudents'] = 'Enviar anúncios a alunos pelo correio electrónico';
$string['emailteachermail'] = '$a->username actualizou o trabalho enviado para \'$a->assignment\'
...
$string['emailteachers'] = 'Enviar anúncios para os professores pelo correio electrónico';
$string['emptysubmission'] = 'Ainda não enviou nada';
$string['enableemailnotification'] = 'Enviar emails de notificação';
...
$string['finalizeerror'] = 'Ocorreu um erro e não foi possível completar a sua transmissão';
...
$string['helponline'] = '<p>Este tipo de trabalho requer que os utilizadores editem um texto, utilizando as ferramentas de edição normais. Os professores poderão avaliá-los via Web, podendo também adicionar comentários ou fazer alterações.</p><p>(Se estiver familiarizado com versões antigas do Moodle, este tipo de trabalho faz precisamente a mesma coisa que o antigo módulo \'Journal\'.)</p>';
$string['helpupload'] = '<p>Este tipo de trabalho permite os alunos enviem um ou vários ficheiros em qualquer formato. Os ficheiros podem ser documento de processador de texto, imagens, várias páginas Web num ficheiro zip, ou qualquer outra coisa que lhes peça para enviar.</p>
...
<p>Os participantes também podem introduzir a descrição dos ficheiros enviados, relatórios de progresso, ou qualquer outro texto informativo.</p>
...
$string['notesupdateerror'] = 'Erro na actualização das notas';
$string['notgradedyet'] = 'Ainda não avaliado';
$string['notsubmittedyet'] = 'Ainda não enviado';
$string['onceassignmentsent'] = 'Uma vez for enviado este trabalho, para ser avaliado, não poderá apagá-lo nem juntar mais ficheiros anexos. Quer continuar?';
...
$string['submitedformarking'] = 'O trabalho já foi enviado para avaliação e não pode ser actualizado.';
...
$string['unfinalizeerror'] = 'Ocorreu um erro e não foi possível reverter essa transmissão para rascunho';
