...
$string['auth_cas_broken_password'] = 'Não pode prosseguir sem modificar a sua palavra chave, no entanto não existe nenhuma página disponível para o fazer. Contacte por favor o Administrador do Moodle.';
$string['auth_cas_cantconnect'] = 'A parte LDAP do módulo CAS não consegue ligar ao servidor.';
$string['auth_cas_casversion'] = 'Versão';
$string['auth_cas_changepasswordurl'] = 'URL para modificar palavra chave\'';
...
$string['auth_changepasswordhelp_expl'] = 'Mostrar ajuda de perca de palavra chave aos utilizadores que perderam a sua palavra chave $a. Será mostrada também ou em vez do <strong>URL para Mudar Palavra Chave</strong> ou a mudança de palavra chave interna do Moodle.';
...
$string['auth_dbchangepasswordurl_key'] = 'URL para mudar a palavra chave';
...
$string['auth_dbfieldpass_key'] = 'Campo de palavra chave';
...
$string['auth_dbpass_key'] = 'Palavra chave';
...
$string['auth_dbpasstype_key'] = 'Formato da palavra chave';
$string['auth_dbreviveduser'] = 'Utilizador reativado $a[0] id $a[1]';
...
$string['auth_dbsybasequoting'] = 'Usar notas da \"sybase\"';
...
$string['auth_fcchangepasswordurl'] = 'URL para mudar a palavra chave';
...
$string['auth_fcpasswd_key'] = 'Palavra chave';
...
$string['auth_imapchangepasswordurl_key'] = 'URL para mudar a palavra chave';
...
$string['auth_ldap_bind_pw_key'] = 'Palavra chave';
$string['auth_ldap_bind_settings'] = 'Definições do bind';
$string['auth_ldap_changepasswordurl_key'] = 'URL para mudar a palavra chave';
...
$string['auth_ldap_expiration_desc'] = 'Seleccione Não para desactivar a verificação de palavra chave expirada ou a leitura directa da data de expiração da palavra chave a partir do LDAP';
$string['auth_ldap_expiration_key'] = 'Expiração';
$string['auth_ldap_expiration_warning_desc'] = 'Número de dias antes do aviso de expiração da palavra chave ser activado';
$string['auth_ldap_expiration_warning_key'] = 'Aviso de expiração';
$string['auth_ldap_expireattr_desc'] = 'Opcional: tem prioridade sobre o atributo LDAP que armazena data de expiração da palavra chave.';
...
$string['auth_ldap_gracelogins_desc'] = 'Active a ajuda de entrada de graça LDAP. Após a palavra chave ter expirado, o utilizador poderá efectuar a autenticação até que a contagem de entradas de graça seja 0. Ao activar esta definição, será mostrada uma mensagem grace login se a Palavra-Chave expirar.';
...
$string['auth_ldap_ldap_encoding'] = 'Especificar a codificação usada pelo servidor LDAP. Muito provavelmente utf-8, MS ADv2 usam plataformas de codificação por omissão tais como cp1252, cp1250, etc.';
...
$string['auth_ldap_passtype'] = 'Formato das palavras chave novas ou modificadas no servidor LDAP.';
$string['auth_ldap_passtype_key'] = 'Formato da palavra chave';
...
$string['auth_ldap_preventpassindb_key'] = 'Esconder palavra chave';
...
$string['auth_nntpchangepasswordurl_key'] = 'URL para mudar a palavra chave';
...
$string['auth_nologindescription'] = 'Plugin auxiliar que pode impedri que um utilizador entre no sistema, descartando todo o correio que for enviado para esse utilizador. Pode ser usado para <em>suspender</em> contas de utilizadores.';
...
$string['auth_pop3changepasswordurl_key'] = 'URL para mudar a palavra chave';
...
$string['auth_radiuschangepasswordurl_key'] = 'URL para mudar a palavra chave';
...
$string['auth_shib_changepasswordurl'] = 'URL para mudar a palavra chave';
...
$string['auto_add_remote_users'] = 'Adicionar automáticamente utilizadores remotos';
...
$string['errorminpassworddigits'] = 'A palavra chave deverá ter pelo menos $a algarismo(s)';
$string['errorminpasswordlength'] = 'A palavra chave deverá ter pelo menos $a caracteres.';
$string['errorminpasswordlower'] = 'A palavra chave deverá ter pelo menos $a letra(s) minúscula(s).';
$string['errorminpasswordnonalphanum'] = 'A palavra chave deverá ter pelo menos $a caracteres(s) não alfanumérico(s).';
$string['errorminpasswordupper'] = 'A palavra chave deverá ter pelo menos $a letra(s) maiúscula(s).';
$string['errorpasswordupdate'] = 'Erro actualizando palavra chave, palavra chave não modificada';
$string['forcechangepassword'] = 'Obrigar a alterar palavra chave';
$string['forcechangepassword_help'] = 'Obrigar os utilizadores a alterar a palavra chave na sua próxima entrada no Moodle.';
$string['forcechangepasswordfirst_help'] = 'Obrigar os utilizadores a alterar a palavra chave na sua primeira entrada no Moodle.';
$string['forgottenpassword'] = 'Se inserir aqui um URL, será usado neste sítio como página para recuperação de palavras chaves. Este campo foi criado para sítios onde as palavras chaves são controladas em forma externa ao Moodle. Deixe em branco se quiser usar a página de recuperação de palavra chave própria do Moodle.';
$string['forgottenpasswordurl'] = 'URL para recuperação de palavra chave';
...
$string['nopasswordchange'] = 'A palavra chave não pode ser modificada.';
$string['nopasswordchangeforced'] = 'Não consegue prosseguir sem modificar a palavra chave, entretanto não existe nenhuma página disponível para a mudar. Por favor contacte o Administrador do sítio Moodle.';
...
$string['passwordhandling'] = 'Tratamento do campo de palavra chave';
