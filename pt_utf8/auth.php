...
$string['auth_changepasswordhelp_expl'] = 'Mostrar ajuda de perca de senha aos utilizadores que perderam a sua senha $a. Será mostrada também ou em vez do <strong>URL para Mudar Senha</strong> ou a mudança de senha interna do Moodle.';
$string['auth_changepasswordurl'] = 'URL para alterar Senha';
$string['auth_changepasswordurl_expl'] = 'Especifique o URL a enviar aos utilizadores que perderam a sua $a senha. Defina <strong> a página standard para mudar a senha a utilizar</strong> para <strong>Não</strong>';
...
$string['auth_dbchangepasswordurl_key'] = 'URL para mudar a senha';
...
$string['auth_fcchangepasswordurl'] = 'URL para mudar a senha';
...
$string['auth_imapchangepasswordurl_key'] = 'URL para mudar a senha';
...
$string['auth_ldap_changepasswordurl_key'] = 'URL para mudar a senha';
...
$string['auth_ldap_gracelogins_desc'] = 'Active a ajuda de entrada de graça LDAP. Após a senha ter expirado, o utilizador poderá efectuar a autenticação até que a contagem de entradas de graça seja 0. Ao activar esta definição, será mostrada uma mensagem grace login se a Palavra-Chave expirar.';
...
$string['auth_pop3changepasswordurl_key'] = 'URL para mudar a senha';
...
$string['auth_updateremote_expl'] = '<p><b>Update externo:</b> Se activo, a autorização externa será actualizada quando o registo do uti lizador for actualizado. Os campos deverão estar desbloquados para que sejam permitidas edições.</p>';
