...
$string['auth_cas_invalidcaslogin'] = 'Descuple, a sua entrada falhou - não pode ser autorizado';
...
$string['auth_shib_instructions_help'] = 'Aqui deverá fornecer as instruções a explicar o Shibboleth aos seus utilizadores. Serão mostradas na página de login, na secção de instruções. As instruções deverão incluir um link para \"<b>$a</b>\" para os utilizadores clicarem quando quiserem entrar no sítio.';
