...
$string['auth_emaildescription'] = 'Confirmação via correio electrónico é o método de autenticação padrão. Quando o utilizador se inscrever, após ter escolhido o nome de utilizador e senha, será-lhe enviada uma mensagem de confirmação para o seu endereço de correio electrónico. Essa mensagem contem um vínculo seguro para uma página onde o utilizador pode confirmar a sua conta. Quando o utilizador entrar no futuro o seu nome de utilizador e senha serão conferidos na base de dados do Moodle.';
...
$string['auth_nologindescription'] = 'Plugin auxiliar que pode impedir que um utilizador entre no sistema, descartando todo o correio que for enviado para esse utilizador. Pode ser usado para <em>suspender</em> contas de utilizadores.';
