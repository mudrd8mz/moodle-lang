...
$string['allowsallsubscribe'] = 'Este fórum permite a todos obtar por subscrever ou não';
...
$string['configenabletimedposts'] = 'Seleccione \'Sim\' se quiser permitir fixar períodos de publicação nos envios para o fórum (isto está em fase experimental e ainda a ser testado)';
...
$string['forum:viewhiddentimedposts'] = 'Ver mensangens caducadas ocultas';
...
$string['openmode0'] = 'Não permitir iniciar temas nem responder';
$string['openmode1'] = 'Não permitir iniciar temas, mas permitir responder';
$string['openmode2'] = 'Permitir iniciar temas e responder';
