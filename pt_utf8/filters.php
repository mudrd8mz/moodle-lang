<?PHP // $Id$ 
      // filters.php - created with Moodle 1.7.1+ (2006101010)
...
$string['anyrole'] = 'qualquer cargo';
$string['anyvalue'] = 'qualquer valor';
$string['categoryrole'] = 'Cargo na categoria';
$string['contains'] = 'contém';
$string['courserole'] = 'Cargo na disciplina';
...
$string['datelabelisbetween'] = '$a->label é entre $a->after e $a->before';
...
$string['isafter'] = 'é posterior a';
$string['isanyvalue'] = 'tem qualqer valor';
$string['isbefore'] = 'é anterior a';
...
$string['removeselected'] = 'Retirar os seleccionados';
